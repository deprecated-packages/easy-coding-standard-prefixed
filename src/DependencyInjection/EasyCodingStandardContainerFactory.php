...
{
    public function createFromFromInput(\_PhpScoper842c7347e6be\Symfony\Component\Console\Input\InputInterface $input) : \_PhpScoper842c7347e6be\Psr\Container\ContainerInterface
    {
    ...
    public function createFromFromBootstrapConfigs(\Symplify\SetConfigResolver\ValueObject\Bootstrap\BootstrapConfigs $bootstrapConfigs) : \_PhpScoper842c7347e6be\Psr\Container\ContainerInterface
    {
