...
final class RemoveExcludedCheckersCompilerPass implements \_PhpScoperb6d4bd368bd9\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
     ...
     */
    private function getExcludedCheckersFromParameterBag(\_PhpScoperb6d4bd368bd9\Symfony\Component\DependencyInjection\ParameterBag\ParameterBagInterface $parameterBag) : array
    {
        $excludedCheckers = [];
