...
use _PhpScoperd8b0b9452568\Composer\XdebugHandler\XdebugHandler;
...
final class EasyCodingStandardConsoleApplication extends \Symplify\SymplifyKernel\Console\AbstractSymplifyConsoleApplication
{
    ...
    public function doRun(\_PhpScoperd8b0b9452568\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoperd8b0b9452568\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        // @fixes https://github.com/rectorphp/rector/issues/2205
        $isXdebugAllowed = $input->hasParameterOption('--xdebug');
        if (!$isXdebugAllowed && !\defined('PHPUNIT_COMPOSER_INSTALL')) {
            $xdebugHandler = new \_PhpScoperd8b0b9452568\Composer\XdebugHandler\XdebugHandler('ecs', '--ansi');
            $xdebugHandler->check();
            unset($xdebugHandler);
        }
    ...
    public function renderThrowable(\Throwable $throwable, \_PhpScoperd8b0b9452568\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
    ...
    protected function getDefaultInputDefinition() : \_PhpScoperd8b0b9452568\Symfony\Component\Console\Input\InputDefinition
    {
        $inputDefinition = parent::getDefaultInputDefinition();
        $this->addExtraOptions($inputDefinition);
        return $inputDefinition;
    }
    private function shouldPrintMetaInformation(\_PhpScoperd8b0b9452568\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function addExtraOptions(\_PhpScoperd8b0b9452568\Symfony\Component\Console\Input\InputDefinition $inputDefinition) : void
    {
        $inputDefinition->addOption(new \_PhpScoperd8b0b9452568\Symfony\Component\Console\Input\InputOption(\Symplify\EasyCodingStandard\ValueObject\Option::XDEBUG, null, \_PhpScoperd8b0b9452568\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Allow running xdebug'));
        $inputDefinition->addOption(new \_PhpScoperd8b0b9452568\Symfony\Component\Console\Input\InputOption(\Symplify\EasyCodingStandard\ValueObject\Option::DEBUG, null, \_PhpScoperd8b0b9452568\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Run in debug mode (alias for "-vvv")'));
    }
}
