...
final class SetsReporter
{
    ...
    public function __construct(\_PhpScoper13160cf3462c\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
