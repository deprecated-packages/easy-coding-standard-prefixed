...
final class ECSConfigsResolver
{
    ...
    public function resolveFromInput(\_PhpScoper7d3888cf4297\Symfony\Component\Console\Input\InputInterface $input) : \Symplify\SetConfigResolver\ValueObject\Bootstrap\BootstrapConfigs
    {
        $configFileInfos = [];
