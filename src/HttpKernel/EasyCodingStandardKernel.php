...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper2fe14d6302bc\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper2fe14d6302bc\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper2fe14d6302bc\Symfony\Component\Config\Loader\DelegatingLoader
    {
