...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper470d6df94ac0\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper470d6df94ac0\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper470d6df94ac0\Symfony\Component\Config\Loader\DelegatingLoader
    {
