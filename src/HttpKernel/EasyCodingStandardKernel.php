...
use _PhpScoper92feab6bddf8\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper92feab6bddf8\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper92feab6bddf8\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper92feab6bddf8\Symfony\Component\Config\Loader\DelegatingLoader
    {
