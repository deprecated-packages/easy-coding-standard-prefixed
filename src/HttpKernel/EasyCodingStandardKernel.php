...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoperddde3ba4aebc\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoperddde3ba4aebc\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoperddde3ba4aebc\Symfony\Component\Config\Loader\DelegatingLoader
    {
