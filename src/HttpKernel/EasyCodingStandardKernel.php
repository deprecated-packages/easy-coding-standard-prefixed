...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScopera749ac204cd2\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScopera749ac204cd2\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScopera749ac204cd2\Symfony\Component\Config\Loader\DelegatingLoader
    {
