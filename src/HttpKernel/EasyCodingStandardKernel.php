...
use _PhpScoper190659c42b56\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper190659c42b56\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper190659c42b56\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper190659c42b56\Symfony\Component\Config\Loader\DelegatingLoader
    {
