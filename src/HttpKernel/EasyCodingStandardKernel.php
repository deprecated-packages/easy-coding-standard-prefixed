...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoperc753ccca5a0c\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoperc753ccca5a0c\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoperc753ccca5a0c\Symfony\Component\Config\Loader\DelegatingLoader
    {
