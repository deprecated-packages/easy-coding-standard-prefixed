...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper8e2d8a2760d1\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper8e2d8a2760d1\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper8e2d8a2760d1\Symfony\Component\Config\Loader\DelegatingLoader
    {
