...
use _PhpScopere015d8a3273c\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScopere015d8a3273c\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScopere015d8a3273c\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScopere015d8a3273c\Symfony\Component\Config\Loader\DelegatingLoader
    {
