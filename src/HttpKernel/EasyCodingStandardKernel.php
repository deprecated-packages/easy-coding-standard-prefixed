...
use _PhpScoper589e8c04a9ef\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper589e8c04a9ef\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper589e8c04a9ef\Symfony\Component\Config\Loader\DelegatingLoader
    {
