...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper7cef7256eba6\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper7cef7256eba6\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper7cef7256eba6\Symfony\Component\Config\Loader\DelegatingLoader
    {
