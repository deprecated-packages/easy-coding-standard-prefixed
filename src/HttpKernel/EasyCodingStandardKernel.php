...
use _PhpScoper83a475a0590e\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper83a475a0590e\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper83a475a0590e\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper83a475a0590e\Symfony\Component\Config\Loader\DelegatingLoader
    {
