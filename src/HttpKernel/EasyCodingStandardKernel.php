...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper967c4b7e296e\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper967c4b7e296e\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper967c4b7e296e\Symfony\Component\Config\Loader\DelegatingLoader
    {
