...
use _PhpScoper39d23eef9a06\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper39d23eef9a06\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper39d23eef9a06\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper39d23eef9a06\Symfony\Component\Config\Loader\DelegatingLoader
    {
