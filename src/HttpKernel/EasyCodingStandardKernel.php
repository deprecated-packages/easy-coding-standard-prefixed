...
use _PhpScoper7145e5e87de5\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper7145e5e87de5\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper7145e5e87de5\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper7145e5e87de5\Symfony\Component\Config\Loader\DelegatingLoader
    {
