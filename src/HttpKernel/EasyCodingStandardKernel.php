...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper06c66bea2cf6\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper06c66bea2cf6\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper06c66bea2cf6\Symfony\Component\Config\Loader\DelegatingLoader
    {
