...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper5a9febfbbe05\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper5a9febfbbe05\Symfony\Component\Config\Loader\DelegatingLoader
    {
