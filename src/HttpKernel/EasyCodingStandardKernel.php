...
use _PhpScopercf327c47dfc5\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScopercf327c47dfc5\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScopercf327c47dfc5\Symfony\Component\Config\Loader\DelegatingLoader
    {
