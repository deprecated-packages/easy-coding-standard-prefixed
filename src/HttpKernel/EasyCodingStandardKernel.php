...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper0f5cd390c37a\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper0f5cd390c37a\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper0f5cd390c37a\Symfony\Component\Config\Loader\DelegatingLoader
    {
