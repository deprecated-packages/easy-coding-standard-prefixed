...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper3e1e0e5bb8ef\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper3e1e0e5bb8ef\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper3e1e0e5bb8ef\Symfony\Component\Config\Loader\DelegatingLoader
    {
