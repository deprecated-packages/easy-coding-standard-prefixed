...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoperb09c3ec8e01a\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoperb09c3ec8e01a\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoperb09c3ec8e01a\Symfony\Component\Config\Loader\DelegatingLoader
    {
