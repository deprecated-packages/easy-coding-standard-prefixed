...
use _PhpScoper2b44cb0c30af\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper2b44cb0c30af\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper2b44cb0c30af\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper2b44cb0c30af\Symfony\Component\Config\Loader\DelegatingLoader
    {
