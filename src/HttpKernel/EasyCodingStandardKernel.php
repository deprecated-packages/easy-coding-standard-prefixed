...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper279cf54b77ad\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper279cf54b77ad\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper279cf54b77ad\Symfony\Component\Config\Loader\DelegatingLoader
    {
