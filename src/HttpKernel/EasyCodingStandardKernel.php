...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScopercda2b863d098\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScopercda2b863d098\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScopercda2b863d098\Symfony\Component\Config\Loader\DelegatingLoader
    {
