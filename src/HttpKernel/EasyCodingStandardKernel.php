...
use _PhpScoper3d04c8135695\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper3d04c8135695\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper3d04c8135695\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper3d04c8135695\Symfony\Component\Config\Loader\DelegatingLoader
    {
