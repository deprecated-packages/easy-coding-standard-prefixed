...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper70072c07b02b\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper70072c07b02b\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper70072c07b02b\Symfony\Component\Config\Loader\DelegatingLoader
    {
