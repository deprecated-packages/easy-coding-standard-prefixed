...
use _PhpScoper61bdb485188f\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper61bdb485188f\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper61bdb485188f\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper61bdb485188f\Symfony\Component\Config\Loader\DelegatingLoader
    {
