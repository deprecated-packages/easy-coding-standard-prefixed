...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper21763e6c7ac4\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper21763e6c7ac4\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper21763e6c7ac4\Symfony\Component\Config\Loader\DelegatingLoader
    {
