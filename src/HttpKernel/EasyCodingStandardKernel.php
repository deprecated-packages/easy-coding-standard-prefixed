...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper1103e00fb46b\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper1103e00fb46b\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper1103e00fb46b\Symfony\Component\Config\Loader\DelegatingLoader
    {
