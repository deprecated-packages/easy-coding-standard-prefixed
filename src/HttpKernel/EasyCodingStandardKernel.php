...
use _PhpScoper48b5ec5b60cf\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper48b5ec5b60cf\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper48b5ec5b60cf\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper48b5ec5b60cf\Symfony\Component\Config\Loader\DelegatingLoader
    {
