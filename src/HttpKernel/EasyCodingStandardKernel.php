...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper3d6b50c3ca2f\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper3d6b50c3ca2f\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper3d6b50c3ca2f\Symfony\Component\Config\Loader\DelegatingLoader
    {
