...
use _PhpScoper75713bc3e278\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper75713bc3e278\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper75713bc3e278\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper75713bc3e278\Symfony\Component\Config\Loader\DelegatingLoader
    {
