...
use _PhpScoper133be48300f9\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper133be48300f9\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper133be48300f9\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper133be48300f9\Symfony\Component\Config\Loader\DelegatingLoader
    {
