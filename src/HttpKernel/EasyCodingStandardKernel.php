...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper2a8ad010dfbd\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper2a8ad010dfbd\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper2a8ad010dfbd\Symfony\Component\Config\Loader\DelegatingLoader
    {
