...
use _PhpScoper4848279dba07\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper4848279dba07\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper4848279dba07\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper4848279dba07\Symfony\Component\Config\Loader\DelegatingLoader
    {
