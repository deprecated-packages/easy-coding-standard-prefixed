...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper836bc32aecc2\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper836bc32aecc2\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper836bc32aecc2\Symfony\Component\Config\Loader\DelegatingLoader
    {
