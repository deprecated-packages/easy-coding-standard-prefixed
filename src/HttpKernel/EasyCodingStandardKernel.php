...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScopercb576ca159b5\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScopercb576ca159b5\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScopercb576ca159b5\Symfony\Component\Config\Loader\DelegatingLoader
    {
