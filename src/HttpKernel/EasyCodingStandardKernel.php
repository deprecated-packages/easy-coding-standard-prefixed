...
use _PhpScoper880bfa4d8b51\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper880bfa4d8b51\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper880bfa4d8b51\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper880bfa4d8b51\Symfony\Component\Config\Loader\DelegatingLoader
    {
