...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoperb6d4bd368bd9\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoperb6d4bd368bd9\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoperb6d4bd368bd9\Symfony\Component\Config\Loader\DelegatingLoader
    {
