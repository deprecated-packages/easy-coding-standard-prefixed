...
use _PhpScoper7f41430b5328\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle;
...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper7f41430b5328\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper7f41430b5328\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper7f41430b5328\Symfony\Component\Config\Loader\DelegatingLoader
    {
