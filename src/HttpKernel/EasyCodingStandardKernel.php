...
final class EasyCodingStandardKernel extends \Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    public function registerBundles() : iterable
    {
        ...
        if ($this->environment === 'test') {
            $bundles[] = new \_PhpScoper229e8121cf9f\Migrify\PhpConfigPrinter\Bundle\PhpConfigPrinterBundle();
        }
        return $bundles;
    }
    /**
     ...
     */
    protected function getContainerLoader(\_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\ContainerInterface $container) : \_PhpScoper229e8121cf9f\Symfony\Component\Config\Loader\DelegatingLoader
    {
