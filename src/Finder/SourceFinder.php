...
final class SourceFinder
{
    ...
    private function processDirectory(string $directory) : array
    {
        ...
        $finder = \_PhpScoperd8048db577a9\Symfony\Component\Finder\Finder::create()->files()->name($normalizedFileExtensions)->in($directory)->exclude('vendor')->size('> 0')->sortByName();
