...
final class SourceFinder
{
    ...
    private function processDirectory(string $directory) : array
    {
        ...
        $finder = \_PhpScoper0ba97041430d\Symfony\Component\Finder\Finder::create()->files()->name($normalizedFileExtensions)->in($directory)->exclude('vendor')->size('> 0')->sortByName();
