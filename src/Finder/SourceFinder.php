...
final class SourceFinder
{
    ...
    private function processDirectory(string $directory) : array
    {
        ...
        $finder = \_PhpScoper457dd3bd73ba\Symfony\Component\Finder\Finder::create()->files()->name($normalizedFileExtensions)->in($directory)->exclude('vendor')->size('> 0')->sortByName();
