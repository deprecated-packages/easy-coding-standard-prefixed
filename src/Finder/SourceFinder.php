...
final class SourceFinder
{
    ...
    private function processDirectory(string $directory) : array
    {
        ...
        $finder = \_PhpScoperc8fea59b0cb1\Symfony\Component\Finder\Finder::create()->files()->name($normalizedFileExtensions)->in($directory)->exclude('vendor')->size('> 0')->sortByName();
