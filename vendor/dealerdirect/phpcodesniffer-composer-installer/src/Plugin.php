 ...
 * @license MIT
 */
namespace _PhpScoperb458b528613f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperb458b528613f\Composer\Composer;
use _PhpScoperb458b528613f\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperb458b528613f\Composer\IO\IOInterface;
use _PhpScoperb458b528613f\Composer\Package\AliasPackage;
use _PhpScoperb458b528613f\Composer\Package\PackageInterface;
use _PhpScoperb458b528613f\Composer\Package\RootPackageInterface;
use _PhpScoperb458b528613f\Composer\Plugin\PluginInterface;
use _PhpScoperb458b528613f\Composer\Script\Event;
use _PhpScoperb458b528613f\Composer\Script\ScriptEvents;
use _PhpScoperb458b528613f\Composer\Util\Filesystem;
use _PhpScoperb458b528613f\Composer\Util\ProcessExecutor;
...
use _PhpScoperb458b528613f\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperb458b528613f\Composer\Plugin\PluginInterface, \_PhpScoperb458b528613f\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperb458b528613f\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperb458b528613f\Composer\Composer $composer, \_PhpScoperb458b528613f\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperb458b528613f\Composer\Composer $composer, \_PhpScoperb458b528613f\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperb458b528613f\Composer\Composer $composer, \_PhpScoperb458b528613f\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperb458b528613f\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperb458b528613f\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperb458b528613f\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperb458b528613f\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperb458b528613f\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperb458b528613f\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperb458b528613f\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperb458b528613f\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperb458b528613f\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperb458b528613f\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperb458b528613f\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperb458b528613f\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperb458b528613f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperb458b528613f\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
