 ...
 * @license MIT
 */
namespace _PhpScoperd675aaf00c76\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
use _PhpScoperd675aaf00c76\Composer\Util\Filesystem;
use _PhpScoperd675aaf00c76\Composer\Util\ProcessExecutor;
use _PhpScoperd675aaf00c76\Symfony\Component\Finder\Finder;
 ...
 */
class Plugin implements \_PhpScoperd675aaf00c76\Composer\Plugin\PluginInterface, \_PhpScoperd675aaf00c76\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperd675aaf00c76\Composer\Script\Event $event)
    {
        $io = $event->getIO();
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperd675aaf00c76\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperd675aaf00c76\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperd675aaf00c76\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperd675aaf00c76\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperd675aaf00c76\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperd675aaf00c76\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperd675aaf00c76\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperd675aaf00c76\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperd675aaf00c76\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperd675aaf00c76\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperd675aaf00c76\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperd675aaf00c76\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperd675aaf00c76\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperd675aaf00c76\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
