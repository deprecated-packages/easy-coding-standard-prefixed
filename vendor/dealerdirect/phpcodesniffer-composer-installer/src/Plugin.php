 ...
 * @license MIT
 */
namespace _PhpScoper224ae0b86670\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper224ae0b86670\Composer\Composer;
use _PhpScoper224ae0b86670\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper224ae0b86670\Composer\IO\IOInterface;
use _PhpScoper224ae0b86670\Composer\Package\AliasPackage;
use _PhpScoper224ae0b86670\Composer\Package\PackageInterface;
use _PhpScoper224ae0b86670\Composer\Package\RootPackageInterface;
use _PhpScoper224ae0b86670\Composer\Plugin\PluginInterface;
use _PhpScoper224ae0b86670\Composer\Script\Event;
use _PhpScoper224ae0b86670\Composer\Script\ScriptEvents;
use _PhpScoper224ae0b86670\Composer\Util\Filesystem;
use _PhpScoper224ae0b86670\Composer\Util\ProcessExecutor;
use _PhpScoper224ae0b86670\Symfony\Component\Finder\Finder;
...
use _PhpScoper224ae0b86670\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper224ae0b86670\Composer\Plugin\PluginInterface, \_PhpScoper224ae0b86670\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper224ae0b86670\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper224ae0b86670\Composer\Composer $composer, \_PhpScoper224ae0b86670\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper224ae0b86670\Composer\Composer $composer, \_PhpScoper224ae0b86670\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper224ae0b86670\Composer\Composer $composer, \_PhpScoper224ae0b86670\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper224ae0b86670\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper224ae0b86670\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper224ae0b86670\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper224ae0b86670\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper224ae0b86670\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper224ae0b86670\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper224ae0b86670\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper224ae0b86670\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper224ae0b86670\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper224ae0b86670\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper224ae0b86670\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper224ae0b86670\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper224ae0b86670\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper224ae0b86670\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
