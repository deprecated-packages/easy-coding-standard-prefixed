 ...
 * @license MIT
 */
namespace _PhpScopera23ebff5477f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScopera23ebff5477f\Composer\Composer;
use _PhpScopera23ebff5477f\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScopera23ebff5477f\Composer\IO\IOInterface;
use _PhpScopera23ebff5477f\Composer\Package\AliasPackage;
use _PhpScopera23ebff5477f\Composer\Package\PackageInterface;
use _PhpScopera23ebff5477f\Composer\Package\RootPackageInterface;
use _PhpScopera23ebff5477f\Composer\Plugin\PluginInterface;
use _PhpScopera23ebff5477f\Composer\Script\Event;
use _PhpScopera23ebff5477f\Composer\Script\ScriptEvents;
use _PhpScopera23ebff5477f\Composer\Util\Filesystem;
use _PhpScopera23ebff5477f\Composer\Util\ProcessExecutor;
use _PhpScopera23ebff5477f\Symfony\Component\Finder\Finder;
...
use _PhpScopera23ebff5477f\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScopera23ebff5477f\Composer\Plugin\PluginInterface, \_PhpScopera23ebff5477f\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScopera23ebff5477f\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScopera23ebff5477f\Composer\Composer $composer, \_PhpScopera23ebff5477f\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScopera23ebff5477f\Composer\Composer $composer, \_PhpScopera23ebff5477f\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScopera23ebff5477f\Composer\Composer $composer, \_PhpScopera23ebff5477f\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScopera23ebff5477f\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScopera23ebff5477f\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScopera23ebff5477f\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScopera23ebff5477f\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScopera23ebff5477f\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScopera23ebff5477f\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScopera23ebff5477f\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScopera23ebff5477f\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScopera23ebff5477f\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScopera23ebff5477f\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScopera23ebff5477f\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScopera23ebff5477f\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScopera23ebff5477f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScopera23ebff5477f\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
