 ...
 * @license MIT
 */
namespace _PhpScoper3d04c8135695\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
use _PhpScoper3d04c8135695\Symfony\Component\Finder\Finder;
...
class Plugin implements \Composer\Plugin\PluginInterface, \Composer\EventDispatcher\EventSubscriberInterface
{
    ...
    {
        $finder = new \_PhpScoper3d04c8135695\Symfony\Component\Process\PhpExecutableFinder();
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper3d04c8135695\Symfony\Component\Finder\Finder();
    ...
    private function getPHPCodingStandardPackages()
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\Composer\Package\PackageInterface $package) {
            ...
            return $package->getType() === \_PhpScoper3d04c8135695\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
