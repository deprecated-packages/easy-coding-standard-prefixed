 ...
 * @license MIT
 */
namespace _PhpScoperac4e86be08e5\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperac4e86be08e5\Composer\Composer;
use _PhpScoperac4e86be08e5\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperac4e86be08e5\Composer\IO\IOInterface;
use _PhpScoperac4e86be08e5\Composer\Package\AliasPackage;
use _PhpScoperac4e86be08e5\Composer\Package\PackageInterface;
use _PhpScoperac4e86be08e5\Composer\Package\RootPackageInterface;
use _PhpScoperac4e86be08e5\Composer\Plugin\PluginInterface;
use _PhpScoperac4e86be08e5\Composer\Script\Event;
use _PhpScoperac4e86be08e5\Composer\Script\ScriptEvents;
use _PhpScoperac4e86be08e5\Composer\Util\Filesystem;
use _PhpScoperac4e86be08e5\Composer\Util\ProcessExecutor;
use _PhpScoperac4e86be08e5\Symfony\Component\Finder\Finder;
...
use _PhpScoperac4e86be08e5\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperac4e86be08e5\Composer\Plugin\PluginInterface, \_PhpScoperac4e86be08e5\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperac4e86be08e5\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperac4e86be08e5\Composer\Composer $composer, \_PhpScoperac4e86be08e5\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperac4e86be08e5\Composer\Composer $composer, \_PhpScoperac4e86be08e5\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperac4e86be08e5\Composer\Composer $composer, \_PhpScoperac4e86be08e5\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperac4e86be08e5\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperac4e86be08e5\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperac4e86be08e5\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperac4e86be08e5\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperac4e86be08e5\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperac4e86be08e5\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperac4e86be08e5\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperac4e86be08e5\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperac4e86be08e5\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperac4e86be08e5\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperac4e86be08e5\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperac4e86be08e5\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperac4e86be08e5\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperac4e86be08e5\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
