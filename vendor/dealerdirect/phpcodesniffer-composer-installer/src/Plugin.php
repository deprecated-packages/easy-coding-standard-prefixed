 ...
 * @license MIT
 */
namespace _PhpScopera238de2e9b5a\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
class Plugin implements \Composer\Plugin\PluginInterface, \Composer\EventDispatcher\EventSubscriberInterface
{
    ...
    {
        $finder = new \_PhpScopera238de2e9b5a\Symfony\Component\Process\PhpExecutableFinder();
    ...
    private function getPHPCodingStandardPackages()
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\Composer\Package\PackageInterface $package) {
            ...
            return $package->getType() === \_PhpScopera238de2e9b5a\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
