 ...
 * @license MIT
 */
namespace _PhpScoper17bb67c99ade\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper17bb67c99ade\Composer\Composer;
use _PhpScoper17bb67c99ade\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper17bb67c99ade\Composer\IO\IOInterface;
use _PhpScoper17bb67c99ade\Composer\Package\AliasPackage;
use _PhpScoper17bb67c99ade\Composer\Package\PackageInterface;
use _PhpScoper17bb67c99ade\Composer\Package\RootPackageInterface;
use _PhpScoper17bb67c99ade\Composer\Plugin\PluginInterface;
use _PhpScoper17bb67c99ade\Composer\Script\Event;
use _PhpScoper17bb67c99ade\Composer\Script\ScriptEvents;
use _PhpScoper17bb67c99ade\Composer\Util\Filesystem;
use _PhpScoper17bb67c99ade\Composer\Util\ProcessExecutor;
use _PhpScoper17bb67c99ade\Symfony\Component\Finder\Finder;
...
use _PhpScoper17bb67c99ade\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper17bb67c99ade\Composer\Plugin\PluginInterface, \_PhpScoper17bb67c99ade\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper17bb67c99ade\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper17bb67c99ade\Composer\Composer $composer, \_PhpScoper17bb67c99ade\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper17bb67c99ade\Composer\Composer $composer, \_PhpScoper17bb67c99ade\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper17bb67c99ade\Composer\Composer $composer, \_PhpScoper17bb67c99ade\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper17bb67c99ade\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper17bb67c99ade\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper17bb67c99ade\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper17bb67c99ade\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper17bb67c99ade\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper17bb67c99ade\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper17bb67c99ade\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper17bb67c99ade\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper17bb67c99ade\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper17bb67c99ade\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper17bb67c99ade\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper17bb67c99ade\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper17bb67c99ade\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper17bb67c99ade\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
