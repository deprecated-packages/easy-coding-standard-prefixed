 ...
 * @license MIT
 */
namespace _PhpScoperb83706991c7f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
use _PhpScoperb83706991c7f\Composer\Util\Filesystem;
use _PhpScoperb83706991c7f\Composer\Util\ProcessExecutor;
use _PhpScoperb83706991c7f\Symfony\Component\Finder\Finder;
 ...
 */
class Plugin implements \_PhpScoperb83706991c7f\Composer\Plugin\PluginInterface, \_PhpScoperb83706991c7f\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperb83706991c7f\Composer\Script\Event $event)
    {
        $io = $event->getIO();
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperb83706991c7f\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperb83706991c7f\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperb83706991c7f\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperb83706991c7f\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperb83706991c7f\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperb83706991c7f\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperb83706991c7f\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperb83706991c7f\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperb83706991c7f\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperb83706991c7f\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperb83706991c7f\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperb83706991c7f\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperb83706991c7f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperb83706991c7f\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
