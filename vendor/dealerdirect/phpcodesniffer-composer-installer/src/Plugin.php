 ...
 * @license MIT
 */
namespace _PhpScoperc753ccca5a0c\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
use _PhpScoperc753ccca5a0c\Composer\Util\Filesystem;
use _PhpScoperc753ccca5a0c\Composer\Util\ProcessExecutor;
use _PhpScoperc753ccca5a0c\Symfony\Component\Finder\Finder;
...
use _PhpScoperc753ccca5a0c\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperc753ccca5a0c\Composer\Plugin\PluginInterface, \_PhpScoperc753ccca5a0c\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperc753ccca5a0c\Composer\Script\Event $event)
    {
        $io = $event->getIO();
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperc753ccca5a0c\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperc753ccca5a0c\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperc753ccca5a0c\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperc753ccca5a0c\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperc753ccca5a0c\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperc753ccca5a0c\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperc753ccca5a0c\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperc753ccca5a0c\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperc753ccca5a0c\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperc753ccca5a0c\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperc753ccca5a0c\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperc753ccca5a0c\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperc753ccca5a0c\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperc753ccca5a0c\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
