 ...
 * @license MIT
 */
namespace _PhpScoper48b5ec5b60cf\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper48b5ec5b60cf\Composer\Composer;
use _PhpScoper48b5ec5b60cf\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper48b5ec5b60cf\Composer\IO\IOInterface;
use _PhpScoper48b5ec5b60cf\Composer\Package\AliasPackage;
use _PhpScoper48b5ec5b60cf\Composer\Package\PackageInterface;
use _PhpScoper48b5ec5b60cf\Composer\Package\RootPackageInterface;
use _PhpScoper48b5ec5b60cf\Composer\Plugin\PluginInterface;
use _PhpScoper48b5ec5b60cf\Composer\Script\Event;
use _PhpScoper48b5ec5b60cf\Composer\Script\ScriptEvents;
use _PhpScoper48b5ec5b60cf\Composer\Util\Filesystem;
use _PhpScoper48b5ec5b60cf\Composer\Util\ProcessExecutor;
use _PhpScoper48b5ec5b60cf\Symfony\Component\Finder\Finder;
 ...
 */
class Plugin implements \_PhpScoper48b5ec5b60cf\Composer\Plugin\PluginInterface, \_PhpScoper48b5ec5b60cf\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper48b5ec5b60cf\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper48b5ec5b60cf\Composer\Composer $composer, \_PhpScoper48b5ec5b60cf\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper48b5ec5b60cf\Composer\Composer $composer, \_PhpScoper48b5ec5b60cf\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper48b5ec5b60cf\Composer\Composer $composer, \_PhpScoper48b5ec5b60cf\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper48b5ec5b60cf\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper48b5ec5b60cf\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper48b5ec5b60cf\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper48b5ec5b60cf\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper48b5ec5b60cf\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper48b5ec5b60cf\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper48b5ec5b60cf\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper48b5ec5b60cf\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper48b5ec5b60cf\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper48b5ec5b60cf\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper48b5ec5b60cf\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper48b5ec5b60cf\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper48b5ec5b60cf\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper48b5ec5b60cf\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
