 ...
 * @license MIT
 */
namespace _PhpScoperbcc0395698f8\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperbcc0395698f8\Composer\Composer;
use _PhpScoperbcc0395698f8\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperbcc0395698f8\Composer\IO\IOInterface;
use _PhpScoperbcc0395698f8\Composer\Package\AliasPackage;
use _PhpScoperbcc0395698f8\Composer\Package\PackageInterface;
use _PhpScoperbcc0395698f8\Composer\Package\RootPackageInterface;
use _PhpScoperbcc0395698f8\Composer\Plugin\PluginInterface;
use _PhpScoperbcc0395698f8\Composer\Script\Event;
use _PhpScoperbcc0395698f8\Composer\Script\ScriptEvents;
use _PhpScoperbcc0395698f8\Composer\Util\Filesystem;
use _PhpScoperbcc0395698f8\Composer\Util\ProcessExecutor;
use _PhpScoperbcc0395698f8\Symfony\Component\Finder\Finder;
...
use _PhpScoperbcc0395698f8\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperbcc0395698f8\Composer\Plugin\PluginInterface, \_PhpScoperbcc0395698f8\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperbcc0395698f8\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperbcc0395698f8\Composer\Composer $composer, \_PhpScoperbcc0395698f8\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperbcc0395698f8\Composer\Composer $composer, \_PhpScoperbcc0395698f8\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperbcc0395698f8\Composer\Composer $composer, \_PhpScoperbcc0395698f8\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperbcc0395698f8\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperbcc0395698f8\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperbcc0395698f8\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperbcc0395698f8\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperbcc0395698f8\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperbcc0395698f8\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperbcc0395698f8\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperbcc0395698f8\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperbcc0395698f8\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperbcc0395698f8\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperbcc0395698f8\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperbcc0395698f8\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperbcc0395698f8\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperbcc0395698f8\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
