 ...
 * @license MIT
 */
namespace _PhpScopercae980ebf12d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScopercae980ebf12d\Composer\Composer;
use _PhpScopercae980ebf12d\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScopercae980ebf12d\Composer\IO\IOInterface;
use _PhpScopercae980ebf12d\Composer\Package\AliasPackage;
use _PhpScopercae980ebf12d\Composer\Package\PackageInterface;
use _PhpScopercae980ebf12d\Composer\Package\RootPackageInterface;
use _PhpScopercae980ebf12d\Composer\Plugin\PluginInterface;
use _PhpScopercae980ebf12d\Composer\Script\Event;
use _PhpScopercae980ebf12d\Composer\Script\ScriptEvents;
use _PhpScopercae980ebf12d\Composer\Util\Filesystem;
use _PhpScopercae980ebf12d\Composer\Util\ProcessExecutor;
use _PhpScopercae980ebf12d\Symfony\Component\Finder\Finder;
 ...
 */
class Plugin implements \_PhpScopercae980ebf12d\Composer\Plugin\PluginInterface, \_PhpScopercae980ebf12d\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScopercae980ebf12d\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScopercae980ebf12d\Composer\Composer $composer, \_PhpScopercae980ebf12d\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScopercae980ebf12d\Composer\Composer $composer, \_PhpScopercae980ebf12d\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScopercae980ebf12d\Composer\Composer $composer, \_PhpScopercae980ebf12d\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScopercae980ebf12d\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScopercae980ebf12d\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScopercae980ebf12d\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScopercae980ebf12d\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScopercae980ebf12d\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScopercae980ebf12d\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScopercae980ebf12d\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScopercae980ebf12d\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScopercae980ebf12d\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScopercae980ebf12d\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScopercae980ebf12d\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScopercae980ebf12d\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScopercae980ebf12d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScopercae980ebf12d\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
