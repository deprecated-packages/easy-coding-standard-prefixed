 ...
 * @license MIT
 */
namespace _PhpScoperb26833cc184d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperb26833cc184d\Composer\Composer;
use _PhpScoperb26833cc184d\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperb26833cc184d\Composer\IO\IOInterface;
use _PhpScoperb26833cc184d\Composer\Package\AliasPackage;
use _PhpScoperb26833cc184d\Composer\Package\PackageInterface;
use _PhpScoperb26833cc184d\Composer\Package\RootPackageInterface;
use _PhpScoperb26833cc184d\Composer\Plugin\PluginInterface;
use _PhpScoperb26833cc184d\Composer\Script\Event;
use _PhpScoperb26833cc184d\Composer\Script\ScriptEvents;
use _PhpScoperb26833cc184d\Composer\Util\Filesystem;
use _PhpScoperb26833cc184d\Composer\Util\ProcessExecutor;
use _PhpScoperb26833cc184d\Symfony\Component\Finder\Finder;
...
use _PhpScoperb26833cc184d\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperb26833cc184d\Composer\Plugin\PluginInterface, \_PhpScoperb26833cc184d\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperb26833cc184d\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperb26833cc184d\Composer\Composer $composer, \_PhpScoperb26833cc184d\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperb26833cc184d\Composer\Composer $composer, \_PhpScoperb26833cc184d\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperb26833cc184d\Composer\Composer $composer, \_PhpScoperb26833cc184d\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperb26833cc184d\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperb26833cc184d\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperb26833cc184d\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperb26833cc184d\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperb26833cc184d\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperb26833cc184d\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperb26833cc184d\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperb26833cc184d\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperb26833cc184d\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperb26833cc184d\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperb26833cc184d\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperb26833cc184d\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperb26833cc184d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperb26833cc184d\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
