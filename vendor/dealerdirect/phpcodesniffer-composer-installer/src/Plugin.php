 ...
 * @license MIT
 */
namespace _PhpScoperae959d396e95\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperae959d396e95\Composer\Composer;
use _PhpScoperae959d396e95\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperae959d396e95\Composer\IO\IOInterface;
use _PhpScoperae959d396e95\Composer\Package\AliasPackage;
use _PhpScoperae959d396e95\Composer\Package\PackageInterface;
use _PhpScoperae959d396e95\Composer\Package\RootPackageInterface;
use _PhpScoperae959d396e95\Composer\Plugin\PluginInterface;
use _PhpScoperae959d396e95\Composer\Script\Event;
use _PhpScoperae959d396e95\Composer\Script\ScriptEvents;
use _PhpScoperae959d396e95\Composer\Util\Filesystem;
use _PhpScoperae959d396e95\Composer\Util\ProcessExecutor;
use _PhpScoperae959d396e95\Symfony\Component\Finder\Finder;
...
use _PhpScoperae959d396e95\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperae959d396e95\Composer\Plugin\PluginInterface, \_PhpScoperae959d396e95\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperae959d396e95\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperae959d396e95\Composer\Composer $composer, \_PhpScoperae959d396e95\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperae959d396e95\Composer\Composer $composer, \_PhpScoperae959d396e95\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperae959d396e95\Composer\Composer $composer, \_PhpScoperae959d396e95\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperae959d396e95\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperae959d396e95\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperae959d396e95\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperae959d396e95\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperae959d396e95\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperae959d396e95\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperae959d396e95\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperae959d396e95\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperae959d396e95\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperae959d396e95\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperae959d396e95\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperae959d396e95\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperae959d396e95\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperae959d396e95\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
