 ...
 * @license MIT
 */
namespace _PhpScoperaad82bb90a86\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
use _PhpScoperaad82bb90a86\Symfony\Component\Finder\Finder;
...
class Plugin implements \Composer\Plugin\PluginInterface, \Composer\EventDispatcher\EventSubscriberInterface
{
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperaad82bb90a86\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperaad82bb90a86\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\Composer\Package\PackageInterface $package) {
            if ($package instanceof \Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperaad82bb90a86\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
