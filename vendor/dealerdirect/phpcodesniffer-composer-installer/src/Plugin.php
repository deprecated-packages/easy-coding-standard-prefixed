 ...
 * @license MIT
 */
namespace _PhpScoper61bdb485188f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper61bdb485188f\Composer\Composer;
use _PhpScoper61bdb485188f\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper61bdb485188f\Composer\IO\IOInterface;
use _PhpScoper61bdb485188f\Composer\Package\AliasPackage;
use _PhpScoper61bdb485188f\Composer\Package\PackageInterface;
use _PhpScoper61bdb485188f\Composer\Package\RootPackageInterface;
use _PhpScoper61bdb485188f\Composer\Plugin\PluginInterface;
use _PhpScoper61bdb485188f\Composer\Script\Event;
use _PhpScoper61bdb485188f\Composer\Script\ScriptEvents;
use _PhpScoper61bdb485188f\Composer\Util\Filesystem;
use _PhpScoper61bdb485188f\Composer\Util\ProcessExecutor;
use _PhpScoper61bdb485188f\Symfony\Component\Finder\Finder;
...
use _PhpScoper61bdb485188f\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper61bdb485188f\Composer\Plugin\PluginInterface, \_PhpScoper61bdb485188f\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper61bdb485188f\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper61bdb485188f\Composer\Composer $composer, \_PhpScoper61bdb485188f\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper61bdb485188f\Composer\Composer $composer, \_PhpScoper61bdb485188f\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper61bdb485188f\Composer\Composer $composer, \_PhpScoper61bdb485188f\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper61bdb485188f\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper61bdb485188f\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper61bdb485188f\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper61bdb485188f\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper61bdb485188f\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper61bdb485188f\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper61bdb485188f\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper61bdb485188f\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper61bdb485188f\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper61bdb485188f\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper61bdb485188f\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper61bdb485188f\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper61bdb485188f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper61bdb485188f\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
