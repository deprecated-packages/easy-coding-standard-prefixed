 ...
 * @license MIT
 */
namespace _PhpScoperfcf15c26e033\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperfcf15c26e033\Composer\Composer;
use _PhpScoperfcf15c26e033\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperfcf15c26e033\Composer\IO\IOInterface;
use _PhpScoperfcf15c26e033\Composer\Package\AliasPackage;
use _PhpScoperfcf15c26e033\Composer\Package\PackageInterface;
use _PhpScoperfcf15c26e033\Composer\Package\RootPackageInterface;
use _PhpScoperfcf15c26e033\Composer\Plugin\PluginInterface;
use _PhpScoperfcf15c26e033\Composer\Script\Event;
use _PhpScoperfcf15c26e033\Composer\Script\ScriptEvents;
use _PhpScoperfcf15c26e033\Composer\Util\Filesystem;
use _PhpScoperfcf15c26e033\Composer\Util\ProcessExecutor;
use _PhpScoperfcf15c26e033\Symfony\Component\Finder\Finder;
...
use _PhpScoperfcf15c26e033\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperfcf15c26e033\Composer\Plugin\PluginInterface, \_PhpScoperfcf15c26e033\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperfcf15c26e033\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperfcf15c26e033\Composer\Composer $composer, \_PhpScoperfcf15c26e033\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperfcf15c26e033\Composer\Composer $composer, \_PhpScoperfcf15c26e033\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperfcf15c26e033\Composer\Composer $composer, \_PhpScoperfcf15c26e033\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperfcf15c26e033\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperfcf15c26e033\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperfcf15c26e033\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperfcf15c26e033\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperfcf15c26e033\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperfcf15c26e033\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperfcf15c26e033\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperfcf15c26e033\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperfcf15c26e033\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperfcf15c26e033\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperfcf15c26e033\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperfcf15c26e033\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperfcf15c26e033\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperfcf15c26e033\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
