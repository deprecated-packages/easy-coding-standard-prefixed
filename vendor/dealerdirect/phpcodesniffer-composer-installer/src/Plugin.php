 ...
 * @license MIT
 */
namespace _PhpScopercda2b863d098\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScopercda2b863d098\Composer\Composer;
use _PhpScopercda2b863d098\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScopercda2b863d098\Composer\IO\IOInterface;
use _PhpScopercda2b863d098\Composer\Package\AliasPackage;
use _PhpScopercda2b863d098\Composer\Package\PackageInterface;
use _PhpScopercda2b863d098\Composer\Package\RootPackageInterface;
use _PhpScopercda2b863d098\Composer\Plugin\PluginInterface;
use _PhpScopercda2b863d098\Composer\Script\Event;
use _PhpScopercda2b863d098\Composer\Script\ScriptEvents;
use _PhpScopercda2b863d098\Composer\Util\Filesystem;
use _PhpScopercda2b863d098\Composer\Util\ProcessExecutor;
use _PhpScopercda2b863d098\Symfony\Component\Finder\Finder;
...
use _PhpScopercda2b863d098\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScopercda2b863d098\Composer\Plugin\PluginInterface, \_PhpScopercda2b863d098\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScopercda2b863d098\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScopercda2b863d098\Composer\Composer $composer, \_PhpScopercda2b863d098\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScopercda2b863d098\Composer\Composer $composer, \_PhpScopercda2b863d098\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScopercda2b863d098\Composer\Composer $composer, \_PhpScopercda2b863d098\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScopercda2b863d098\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScopercda2b863d098\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScopercda2b863d098\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScopercda2b863d098\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScopercda2b863d098\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScopercda2b863d098\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScopercda2b863d098\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScopercda2b863d098\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScopercda2b863d098\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScopercda2b863d098\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScopercda2b863d098\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScopercda2b863d098\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScopercda2b863d098\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScopercda2b863d098\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
