 ...
 * @license MIT
 */
namespace _PhpScoper836bc32aecc2\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper836bc32aecc2\Composer\Composer;
use _PhpScoper836bc32aecc2\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper836bc32aecc2\Composer\IO\IOInterface;
use _PhpScoper836bc32aecc2\Composer\Package\AliasPackage;
use _PhpScoper836bc32aecc2\Composer\Package\PackageInterface;
use _PhpScoper836bc32aecc2\Composer\Package\RootPackageInterface;
use _PhpScoper836bc32aecc2\Composer\Plugin\PluginInterface;
use _PhpScoper836bc32aecc2\Composer\Script\Event;
use _PhpScoper836bc32aecc2\Composer\Script\ScriptEvents;
use _PhpScoper836bc32aecc2\Composer\Util\Filesystem;
use _PhpScoper836bc32aecc2\Composer\Util\ProcessExecutor;
use _PhpScoper836bc32aecc2\Symfony\Component\Finder\Finder;
...
use _PhpScoper836bc32aecc2\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper836bc32aecc2\Composer\Plugin\PluginInterface, \_PhpScoper836bc32aecc2\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper836bc32aecc2\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper836bc32aecc2\Composer\Composer $composer, \_PhpScoper836bc32aecc2\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper836bc32aecc2\Composer\Composer $composer, \_PhpScoper836bc32aecc2\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper836bc32aecc2\Composer\Composer $composer, \_PhpScoper836bc32aecc2\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper836bc32aecc2\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper836bc32aecc2\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper836bc32aecc2\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper836bc32aecc2\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper836bc32aecc2\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper836bc32aecc2\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper836bc32aecc2\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper836bc32aecc2\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper836bc32aecc2\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper836bc32aecc2\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper836bc32aecc2\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper836bc32aecc2\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper836bc32aecc2\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper836bc32aecc2\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
