 ...
 * @license MIT
 */
namespace _PhpScoper069ebd53a518\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
use _PhpScoper069ebd53a518\Composer\Util\Filesystem;
use _PhpScoper069ebd53a518\Composer\Util\ProcessExecutor;
 ...
 */
class Plugin implements \_PhpScoper069ebd53a518\Composer\Plugin\PluginInterface, \_PhpScoper069ebd53a518\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper069ebd53a518\Composer\Script\Event $event)
    {
        $io = $event->getIO();
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper069ebd53a518\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper069ebd53a518\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper069ebd53a518\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper069ebd53a518\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper069ebd53a518\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper069ebd53a518\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper069ebd53a518\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper069ebd53a518\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper069ebd53a518\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper069ebd53a518\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper069ebd53a518\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper069ebd53a518\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper069ebd53a518\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
