 ...
 * @license MIT
 */
namespace _PhpScoperc75fd40d7a6e\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperc75fd40d7a6e\Composer\Composer;
use _PhpScoperc75fd40d7a6e\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperc75fd40d7a6e\Composer\IO\IOInterface;
use _PhpScoperc75fd40d7a6e\Composer\Package\AliasPackage;
use _PhpScoperc75fd40d7a6e\Composer\Package\PackageInterface;
use _PhpScoperc75fd40d7a6e\Composer\Package\RootPackageInterface;
use _PhpScoperc75fd40d7a6e\Composer\Plugin\PluginInterface;
use _PhpScoperc75fd40d7a6e\Composer\Script\Event;
use _PhpScoperc75fd40d7a6e\Composer\Script\ScriptEvents;
use _PhpScoperc75fd40d7a6e\Composer\Util\Filesystem;
use _PhpScoperc75fd40d7a6e\Composer\Util\ProcessExecutor;
use _PhpScoperc75fd40d7a6e\Symfony\Component\Finder\Finder;
...
use _PhpScoperc75fd40d7a6e\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperc75fd40d7a6e\Composer\Plugin\PluginInterface, \_PhpScoperc75fd40d7a6e\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperc75fd40d7a6e\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperc75fd40d7a6e\Composer\Composer $composer, \_PhpScoperc75fd40d7a6e\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperc75fd40d7a6e\Composer\Composer $composer, \_PhpScoperc75fd40d7a6e\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperc75fd40d7a6e\Composer\Composer $composer, \_PhpScoperc75fd40d7a6e\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperc75fd40d7a6e\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperc75fd40d7a6e\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperc75fd40d7a6e\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperc75fd40d7a6e\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperc75fd40d7a6e\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperc75fd40d7a6e\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperc75fd40d7a6e\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperc75fd40d7a6e\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperc75fd40d7a6e\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperc75fd40d7a6e\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperc75fd40d7a6e\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperc75fd40d7a6e\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperc75fd40d7a6e\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperc75fd40d7a6e\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
