 ...
 * @license MIT
 */
namespace _PhpScopera1a51450b61d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScopera1a51450b61d\Composer\Composer;
use _PhpScopera1a51450b61d\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScopera1a51450b61d\Composer\IO\IOInterface;
use _PhpScopera1a51450b61d\Composer\Package\AliasPackage;
use _PhpScopera1a51450b61d\Composer\Package\PackageInterface;
use _PhpScopera1a51450b61d\Composer\Package\RootPackageInterface;
use _PhpScopera1a51450b61d\Composer\Plugin\PluginInterface;
use _PhpScopera1a51450b61d\Composer\Script\Event;
use _PhpScopera1a51450b61d\Composer\Script\ScriptEvents;
use _PhpScopera1a51450b61d\Composer\Util\Filesystem;
use _PhpScopera1a51450b61d\Composer\Util\ProcessExecutor;
use _PhpScopera1a51450b61d\Symfony\Component\Finder\Finder;
...
use _PhpScopera1a51450b61d\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScopera1a51450b61d\Composer\Plugin\PluginInterface, \_PhpScopera1a51450b61d\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScopera1a51450b61d\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScopera1a51450b61d\Composer\Composer $composer, \_PhpScopera1a51450b61d\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScopera1a51450b61d\Composer\Composer $composer, \_PhpScopera1a51450b61d\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScopera1a51450b61d\Composer\Composer $composer, \_PhpScopera1a51450b61d\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScopera1a51450b61d\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScopera1a51450b61d\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScopera1a51450b61d\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScopera1a51450b61d\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScopera1a51450b61d\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScopera1a51450b61d\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScopera1a51450b61d\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScopera1a51450b61d\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScopera1a51450b61d\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScopera1a51450b61d\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScopera1a51450b61d\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScopera1a51450b61d\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScopera1a51450b61d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScopera1a51450b61d\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
