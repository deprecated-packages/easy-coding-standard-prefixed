 ...
 * @license MIT
 */
namespace _PhpScoper49c742f5a4ee\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper49c742f5a4ee\Composer\Composer;
use _PhpScoper49c742f5a4ee\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper49c742f5a4ee\Composer\IO\IOInterface;
use _PhpScoper49c742f5a4ee\Composer\Package\AliasPackage;
use _PhpScoper49c742f5a4ee\Composer\Package\PackageInterface;
use _PhpScoper49c742f5a4ee\Composer\Package\RootPackageInterface;
use _PhpScoper49c742f5a4ee\Composer\Plugin\PluginInterface;
use _PhpScoper49c742f5a4ee\Composer\Script\Event;
use _PhpScoper49c742f5a4ee\Composer\Script\ScriptEvents;
use _PhpScoper49c742f5a4ee\Composer\Util\Filesystem;
use _PhpScoper49c742f5a4ee\Composer\Util\ProcessExecutor;
use _PhpScoper49c742f5a4ee\Symfony\Component\Finder\Finder;
...
use _PhpScoper49c742f5a4ee\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper49c742f5a4ee\Composer\Plugin\PluginInterface, \_PhpScoper49c742f5a4ee\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper49c742f5a4ee\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper49c742f5a4ee\Composer\Composer $composer, \_PhpScoper49c742f5a4ee\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper49c742f5a4ee\Composer\Composer $composer, \_PhpScoper49c742f5a4ee\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper49c742f5a4ee\Composer\Composer $composer, \_PhpScoper49c742f5a4ee\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper49c742f5a4ee\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper49c742f5a4ee\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper49c742f5a4ee\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper49c742f5a4ee\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper49c742f5a4ee\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper49c742f5a4ee\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper49c742f5a4ee\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper49c742f5a4ee\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper49c742f5a4ee\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper49c742f5a4ee\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper49c742f5a4ee\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper49c742f5a4ee\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper49c742f5a4ee\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper49c742f5a4ee\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
