 ...
 * @license MIT
 */
namespace _PhpScoperfd70a7e8e84f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperfd70a7e8e84f\Composer\Composer;
use _PhpScoperfd70a7e8e84f\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperfd70a7e8e84f\Composer\IO\IOInterface;
use _PhpScoperfd70a7e8e84f\Composer\Package\AliasPackage;
use _PhpScoperfd70a7e8e84f\Composer\Package\PackageInterface;
use _PhpScoperfd70a7e8e84f\Composer\Package\RootPackageInterface;
use _PhpScoperfd70a7e8e84f\Composer\Plugin\PluginInterface;
use _PhpScoperfd70a7e8e84f\Composer\Script\Event;
use _PhpScoperfd70a7e8e84f\Composer\Script\ScriptEvents;
use _PhpScoperfd70a7e8e84f\Composer\Util\Filesystem;
use _PhpScoperfd70a7e8e84f\Composer\Util\ProcessExecutor;
use _PhpScoperfd70a7e8e84f\Symfony\Component\Finder\Finder;
...
use _PhpScoperfd70a7e8e84f\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperfd70a7e8e84f\Composer\Plugin\PluginInterface, \_PhpScoperfd70a7e8e84f\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperfd70a7e8e84f\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperfd70a7e8e84f\Composer\Composer $composer, \_PhpScoperfd70a7e8e84f\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperfd70a7e8e84f\Composer\Composer $composer, \_PhpScoperfd70a7e8e84f\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperfd70a7e8e84f\Composer\Composer $composer, \_PhpScoperfd70a7e8e84f\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperfd70a7e8e84f\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperfd70a7e8e84f\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperfd70a7e8e84f\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperfd70a7e8e84f\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperfd70a7e8e84f\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperfd70a7e8e84f\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperfd70a7e8e84f\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperfd70a7e8e84f\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperfd70a7e8e84f\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperfd70a7e8e84f\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperfd70a7e8e84f\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperfd70a7e8e84f\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
