 ...
 * @license MIT
 */
namespace _PhpScoperbd5c5a045153\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperbd5c5a045153\Composer\Composer;
use _PhpScoperbd5c5a045153\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperbd5c5a045153\Composer\IO\IOInterface;
use _PhpScoperbd5c5a045153\Composer\Package\AliasPackage;
use _PhpScoperbd5c5a045153\Composer\Package\PackageInterface;
use _PhpScoperbd5c5a045153\Composer\Package\RootPackageInterface;
use _PhpScoperbd5c5a045153\Composer\Plugin\PluginInterface;
use _PhpScoperbd5c5a045153\Composer\Script\Event;
use _PhpScoperbd5c5a045153\Composer\Script\ScriptEvents;
use _PhpScoperbd5c5a045153\Composer\Util\Filesystem;
use _PhpScoperbd5c5a045153\Composer\Util\ProcessExecutor;
use _PhpScoperbd5c5a045153\Symfony\Component\Finder\Finder;
...
use _PhpScoperbd5c5a045153\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperbd5c5a045153\Composer\Plugin\PluginInterface, \_PhpScoperbd5c5a045153\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperbd5c5a045153\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperbd5c5a045153\Composer\Composer $composer, \_PhpScoperbd5c5a045153\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperbd5c5a045153\Composer\Composer $composer, \_PhpScoperbd5c5a045153\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperbd5c5a045153\Composer\Composer $composer, \_PhpScoperbd5c5a045153\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperbd5c5a045153\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperbd5c5a045153\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperbd5c5a045153\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperbd5c5a045153\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperbd5c5a045153\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperbd5c5a045153\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperbd5c5a045153\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperbd5c5a045153\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperbd5c5a045153\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperbd5c5a045153\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperbd5c5a045153\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperbd5c5a045153\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperbd5c5a045153\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperbd5c5a045153\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
