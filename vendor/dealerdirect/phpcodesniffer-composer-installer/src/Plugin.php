 ...
 * @license MIT
 */
namespace _PhpScoperfcce67077a55\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperfcce67077a55\Composer\Composer;
use _PhpScoperfcce67077a55\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperfcce67077a55\Composer\IO\IOInterface;
use _PhpScoperfcce67077a55\Composer\Package\AliasPackage;
use _PhpScoperfcce67077a55\Composer\Package\PackageInterface;
use _PhpScoperfcce67077a55\Composer\Package\RootPackageInterface;
use _PhpScoperfcce67077a55\Composer\Plugin\PluginInterface;
use _PhpScoperfcce67077a55\Composer\Script\Event;
use _PhpScoperfcce67077a55\Composer\Script\ScriptEvents;
use _PhpScoperfcce67077a55\Composer\Util\Filesystem;
use _PhpScoperfcce67077a55\Composer\Util\ProcessExecutor;
use _PhpScoperfcce67077a55\Symfony\Component\Finder\Finder;
...
use _PhpScoperfcce67077a55\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperfcce67077a55\Composer\Plugin\PluginInterface, \_PhpScoperfcce67077a55\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperfcce67077a55\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperfcce67077a55\Composer\Composer $composer, \_PhpScoperfcce67077a55\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperfcce67077a55\Composer\Composer $composer, \_PhpScoperfcce67077a55\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperfcce67077a55\Composer\Composer $composer, \_PhpScoperfcce67077a55\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperfcce67077a55\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperfcce67077a55\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperfcce67077a55\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperfcce67077a55\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperfcce67077a55\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperfcce67077a55\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperfcce67077a55\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperfcce67077a55\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperfcce67077a55\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperfcce67077a55\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperfcce67077a55\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperfcce67077a55\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperfcce67077a55\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperfcce67077a55\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
