 ...
 * @license MIT
 */
namespace _PhpScoper578a67c80b2b\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper578a67c80b2b\Composer\Composer;
use _PhpScoper578a67c80b2b\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper578a67c80b2b\Composer\IO\IOInterface;
use _PhpScoper578a67c80b2b\Composer\Package\AliasPackage;
use _PhpScoper578a67c80b2b\Composer\Package\PackageInterface;
use _PhpScoper578a67c80b2b\Composer\Package\RootPackageInterface;
use _PhpScoper578a67c80b2b\Composer\Plugin\PluginInterface;
use _PhpScoper578a67c80b2b\Composer\Script\Event;
use _PhpScoper578a67c80b2b\Composer\Script\ScriptEvents;
use _PhpScoper578a67c80b2b\Composer\Util\Filesystem;
use _PhpScoper578a67c80b2b\Composer\Util\ProcessExecutor;
use _PhpScoper578a67c80b2b\Symfony\Component\Finder\Finder;
...
use _PhpScoper578a67c80b2b\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper578a67c80b2b\Composer\Plugin\PluginInterface, \_PhpScoper578a67c80b2b\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper578a67c80b2b\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper578a67c80b2b\Composer\Composer $composer, \_PhpScoper578a67c80b2b\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper578a67c80b2b\Composer\Composer $composer, \_PhpScoper578a67c80b2b\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper578a67c80b2b\Composer\Composer $composer, \_PhpScoper578a67c80b2b\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper578a67c80b2b\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper578a67c80b2b\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper578a67c80b2b\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper578a67c80b2b\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper578a67c80b2b\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper578a67c80b2b\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper578a67c80b2b\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper578a67c80b2b\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper578a67c80b2b\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper578a67c80b2b\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper578a67c80b2b\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper578a67c80b2b\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper578a67c80b2b\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper578a67c80b2b\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
