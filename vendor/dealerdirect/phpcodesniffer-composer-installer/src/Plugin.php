 ...
 * @license MIT
 */
namespace _PhpScopera37d6fb0b1ab\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScopera37d6fb0b1ab\Composer\Composer;
use _PhpScopera37d6fb0b1ab\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScopera37d6fb0b1ab\Composer\IO\IOInterface;
use _PhpScopera37d6fb0b1ab\Composer\Package\AliasPackage;
use _PhpScopera37d6fb0b1ab\Composer\Package\PackageInterface;
use _PhpScopera37d6fb0b1ab\Composer\Package\RootPackageInterface;
use _PhpScopera37d6fb0b1ab\Composer\Plugin\PluginInterface;
use _PhpScopera37d6fb0b1ab\Composer\Script\Event;
use _PhpScopera37d6fb0b1ab\Composer\Script\ScriptEvents;
use _PhpScopera37d6fb0b1ab\Composer\Util\Filesystem;
use _PhpScopera37d6fb0b1ab\Composer\Util\ProcessExecutor;
use _PhpScopera37d6fb0b1ab\Symfony\Component\Finder\Finder;
...
use _PhpScopera37d6fb0b1ab\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScopera37d6fb0b1ab\Composer\Plugin\PluginInterface, \_PhpScopera37d6fb0b1ab\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScopera37d6fb0b1ab\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScopera37d6fb0b1ab\Composer\Composer $composer, \_PhpScopera37d6fb0b1ab\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScopera37d6fb0b1ab\Composer\Composer $composer, \_PhpScopera37d6fb0b1ab\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScopera37d6fb0b1ab\Composer\Composer $composer, \_PhpScopera37d6fb0b1ab\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScopera37d6fb0b1ab\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScopera37d6fb0b1ab\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScopera37d6fb0b1ab\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScopera37d6fb0b1ab\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScopera37d6fb0b1ab\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScopera37d6fb0b1ab\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScopera37d6fb0b1ab\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScopera37d6fb0b1ab\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScopera37d6fb0b1ab\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScopera37d6fb0b1ab\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScopera37d6fb0b1ab\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScopera37d6fb0b1ab\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScopera37d6fb0b1ab\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScopera37d6fb0b1ab\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
