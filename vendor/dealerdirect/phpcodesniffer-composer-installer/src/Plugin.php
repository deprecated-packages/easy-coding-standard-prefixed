 ...
 * @license MIT
 */
namespace _PhpScoper279cf54b77ad\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper279cf54b77ad\Composer\Composer;
use _PhpScoper279cf54b77ad\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper279cf54b77ad\Composer\IO\IOInterface;
use _PhpScoper279cf54b77ad\Composer\Package\AliasPackage;
use _PhpScoper279cf54b77ad\Composer\Package\PackageInterface;
use _PhpScoper279cf54b77ad\Composer\Package\RootPackageInterface;
use _PhpScoper279cf54b77ad\Composer\Plugin\PluginInterface;
use _PhpScoper279cf54b77ad\Composer\Script\Event;
use _PhpScoper279cf54b77ad\Composer\Script\ScriptEvents;
use _PhpScoper279cf54b77ad\Composer\Util\Filesystem;
use _PhpScoper279cf54b77ad\Composer\Util\ProcessExecutor;
use _PhpScoper279cf54b77ad\Symfony\Component\Finder\Finder;
...
use _PhpScoper279cf54b77ad\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper279cf54b77ad\Composer\Plugin\PluginInterface, \_PhpScoper279cf54b77ad\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper279cf54b77ad\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper279cf54b77ad\Composer\Composer $composer, \_PhpScoper279cf54b77ad\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper279cf54b77ad\Composer\Composer $composer, \_PhpScoper279cf54b77ad\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper279cf54b77ad\Composer\Composer $composer, \_PhpScoper279cf54b77ad\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper279cf54b77ad\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper279cf54b77ad\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper279cf54b77ad\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper279cf54b77ad\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper279cf54b77ad\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper279cf54b77ad\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper279cf54b77ad\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper279cf54b77ad\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper279cf54b77ad\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper279cf54b77ad\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper279cf54b77ad\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper279cf54b77ad\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper279cf54b77ad\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper279cf54b77ad\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
