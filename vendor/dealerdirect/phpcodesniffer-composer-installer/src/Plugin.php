 ...
 * @license MIT
 */
namespace _PhpScoperbaf90856897c\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperbaf90856897c\Composer\Composer;
use _PhpScoperbaf90856897c\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperbaf90856897c\Composer\IO\IOInterface;
use _PhpScoperbaf90856897c\Composer\Package\AliasPackage;
use _PhpScoperbaf90856897c\Composer\Package\PackageInterface;
use _PhpScoperbaf90856897c\Composer\Package\RootPackageInterface;
use _PhpScoperbaf90856897c\Composer\Plugin\PluginInterface;
use _PhpScoperbaf90856897c\Composer\Script\Event;
use _PhpScoperbaf90856897c\Composer\Script\ScriptEvents;
use _PhpScoperbaf90856897c\Composer\Util\Filesystem;
use _PhpScoperbaf90856897c\Composer\Util\ProcessExecutor;
use _PhpScoperbaf90856897c\Symfony\Component\Finder\Finder;
...
use _PhpScoperbaf90856897c\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperbaf90856897c\Composer\Plugin\PluginInterface, \_PhpScoperbaf90856897c\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperbaf90856897c\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperbaf90856897c\Composer\Composer $composer, \_PhpScoperbaf90856897c\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperbaf90856897c\Composer\Composer $composer, \_PhpScoperbaf90856897c\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperbaf90856897c\Composer\Composer $composer, \_PhpScoperbaf90856897c\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperbaf90856897c\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperbaf90856897c\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperbaf90856897c\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperbaf90856897c\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperbaf90856897c\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperbaf90856897c\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperbaf90856897c\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperbaf90856897c\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperbaf90856897c\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperbaf90856897c\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperbaf90856897c\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperbaf90856897c\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperbaf90856897c\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperbaf90856897c\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
