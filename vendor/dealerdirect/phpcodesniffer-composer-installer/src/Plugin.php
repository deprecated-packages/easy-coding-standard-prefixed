 ...
 * @license MIT
 */
namespace _PhpScoper21fff473f90a\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper21fff473f90a\Composer\Composer;
use _PhpScoper21fff473f90a\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper21fff473f90a\Composer\IO\IOInterface;
use _PhpScoper21fff473f90a\Composer\Package\AliasPackage;
use _PhpScoper21fff473f90a\Composer\Package\PackageInterface;
use _PhpScoper21fff473f90a\Composer\Package\RootPackageInterface;
use _PhpScoper21fff473f90a\Composer\Plugin\PluginInterface;
use _PhpScoper21fff473f90a\Composer\Script\Event;
use _PhpScoper21fff473f90a\Composer\Script\ScriptEvents;
use _PhpScoper21fff473f90a\Composer\Util\Filesystem;
use _PhpScoper21fff473f90a\Composer\Util\ProcessExecutor;
use _PhpScoper21fff473f90a\Symfony\Component\Finder\Finder;
...
use _PhpScoper21fff473f90a\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper21fff473f90a\Composer\Plugin\PluginInterface, \_PhpScoper21fff473f90a\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper21fff473f90a\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper21fff473f90a\Composer\Composer $composer, \_PhpScoper21fff473f90a\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper21fff473f90a\Composer\Composer $composer, \_PhpScoper21fff473f90a\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper21fff473f90a\Composer\Composer $composer, \_PhpScoper21fff473f90a\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper21fff473f90a\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper21fff473f90a\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper21fff473f90a\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper21fff473f90a\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper21fff473f90a\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper21fff473f90a\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper21fff473f90a\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper21fff473f90a\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper21fff473f90a\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper21fff473f90a\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper21fff473f90a\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper21fff473f90a\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper21fff473f90a\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper21fff473f90a\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
