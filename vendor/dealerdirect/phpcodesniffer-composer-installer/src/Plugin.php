 ...
 * @license MIT
 */
namespace _PhpScoper528afa732cbd\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper528afa732cbd\Composer\Composer;
use _PhpScoper528afa732cbd\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper528afa732cbd\Composer\IO\IOInterface;
use _PhpScoper528afa732cbd\Composer\Package\AliasPackage;
use _PhpScoper528afa732cbd\Composer\Package\PackageInterface;
use _PhpScoper528afa732cbd\Composer\Package\RootPackageInterface;
use _PhpScoper528afa732cbd\Composer\Plugin\PluginInterface;
use _PhpScoper528afa732cbd\Composer\Script\Event;
use _PhpScoper528afa732cbd\Composer\Script\ScriptEvents;
use _PhpScoper528afa732cbd\Composer\Util\Filesystem;
use _PhpScoper528afa732cbd\Composer\Util\ProcessExecutor;
use _PhpScoper528afa732cbd\Symfony\Component\Finder\Finder;
...
use _PhpScoper528afa732cbd\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper528afa732cbd\Composer\Plugin\PluginInterface, \_PhpScoper528afa732cbd\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper528afa732cbd\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper528afa732cbd\Composer\Composer $composer, \_PhpScoper528afa732cbd\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper528afa732cbd\Composer\Composer $composer, \_PhpScoper528afa732cbd\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper528afa732cbd\Composer\Composer $composer, \_PhpScoper528afa732cbd\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper528afa732cbd\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper528afa732cbd\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper528afa732cbd\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper528afa732cbd\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper528afa732cbd\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper528afa732cbd\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper528afa732cbd\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper528afa732cbd\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper528afa732cbd\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper528afa732cbd\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper528afa732cbd\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper528afa732cbd\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper528afa732cbd\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper528afa732cbd\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
