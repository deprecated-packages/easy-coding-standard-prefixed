 ...
 * @license MIT
 */
namespace _PhpScoperfab1bfb7ec99\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperfab1bfb7ec99\Composer\Composer;
use _PhpScoperfab1bfb7ec99\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperfab1bfb7ec99\Composer\IO\IOInterface;
use _PhpScoperfab1bfb7ec99\Composer\Package\AliasPackage;
use _PhpScoperfab1bfb7ec99\Composer\Package\PackageInterface;
use _PhpScoperfab1bfb7ec99\Composer\Package\RootPackageInterface;
use _PhpScoperfab1bfb7ec99\Composer\Plugin\PluginInterface;
use _PhpScoperfab1bfb7ec99\Composer\Script\Event;
use _PhpScoperfab1bfb7ec99\Composer\Script\ScriptEvents;
use _PhpScoperfab1bfb7ec99\Composer\Util\Filesystem;
use _PhpScoperfab1bfb7ec99\Composer\Util\ProcessExecutor;
use _PhpScoperfab1bfb7ec99\Symfony\Component\Finder\Finder;
...
use _PhpScoperfab1bfb7ec99\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperfab1bfb7ec99\Composer\Plugin\PluginInterface, \_PhpScoperfab1bfb7ec99\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperfab1bfb7ec99\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperfab1bfb7ec99\Composer\Composer $composer, \_PhpScoperfab1bfb7ec99\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperfab1bfb7ec99\Composer\Composer $composer, \_PhpScoperfab1bfb7ec99\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperfab1bfb7ec99\Composer\Composer $composer, \_PhpScoperfab1bfb7ec99\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperfab1bfb7ec99\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperfab1bfb7ec99\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperfab1bfb7ec99\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperfab1bfb7ec99\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperfab1bfb7ec99\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperfab1bfb7ec99\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperfab1bfb7ec99\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperfab1bfb7ec99\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperfab1bfb7ec99\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperfab1bfb7ec99\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperfab1bfb7ec99\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperfab1bfb7ec99\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperfab1bfb7ec99\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperfab1bfb7ec99\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
