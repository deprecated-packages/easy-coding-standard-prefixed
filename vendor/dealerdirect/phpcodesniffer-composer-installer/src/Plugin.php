 ...
 * @license MIT
 */
namespace _PhpScoper167729fa1dde\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper167729fa1dde\Composer\Composer;
use _PhpScoper167729fa1dde\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper167729fa1dde\Composer\IO\IOInterface;
use _PhpScoper167729fa1dde\Composer\Package\AliasPackage;
use _PhpScoper167729fa1dde\Composer\Package\PackageInterface;
use _PhpScoper167729fa1dde\Composer\Package\RootPackageInterface;
use _PhpScoper167729fa1dde\Composer\Plugin\PluginInterface;
use _PhpScoper167729fa1dde\Composer\Script\Event;
use _PhpScoper167729fa1dde\Composer\Script\ScriptEvents;
use _PhpScoper167729fa1dde\Composer\Util\Filesystem;
use _PhpScoper167729fa1dde\Composer\Util\ProcessExecutor;
use _PhpScoper167729fa1dde\Symfony\Component\Finder\Finder;
...
use _PhpScoper167729fa1dde\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper167729fa1dde\Composer\Plugin\PluginInterface, \_PhpScoper167729fa1dde\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper167729fa1dde\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper167729fa1dde\Composer\Composer $composer, \_PhpScoper167729fa1dde\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper167729fa1dde\Composer\Composer $composer, \_PhpScoper167729fa1dde\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper167729fa1dde\Composer\Composer $composer, \_PhpScoper167729fa1dde\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper167729fa1dde\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper167729fa1dde\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper167729fa1dde\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper167729fa1dde\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper167729fa1dde\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper167729fa1dde\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper167729fa1dde\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper167729fa1dde\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper167729fa1dde\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper167729fa1dde\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper167729fa1dde\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper167729fa1dde\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper167729fa1dde\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper167729fa1dde\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
