 ...
 * @license MIT
 */
namespace _PhpScoperad4b7e2c09d8\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperad4b7e2c09d8\Composer\Composer;
use _PhpScoperad4b7e2c09d8\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperad4b7e2c09d8\Composer\IO\IOInterface;
use _PhpScoperad4b7e2c09d8\Composer\Package\AliasPackage;
use _PhpScoperad4b7e2c09d8\Composer\Package\PackageInterface;
use _PhpScoperad4b7e2c09d8\Composer\Package\RootPackageInterface;
use _PhpScoperad4b7e2c09d8\Composer\Plugin\PluginInterface;
use _PhpScoperad4b7e2c09d8\Composer\Script\Event;
use _PhpScoperad4b7e2c09d8\Composer\Script\ScriptEvents;
use _PhpScoperad4b7e2c09d8\Composer\Util\Filesystem;
use _PhpScoperad4b7e2c09d8\Composer\Util\ProcessExecutor;
use _PhpScoperad4b7e2c09d8\Symfony\Component\Finder\Finder;
...
use _PhpScoperad4b7e2c09d8\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperad4b7e2c09d8\Composer\Plugin\PluginInterface, \_PhpScoperad4b7e2c09d8\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperad4b7e2c09d8\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperad4b7e2c09d8\Composer\Composer $composer, \_PhpScoperad4b7e2c09d8\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperad4b7e2c09d8\Composer\Composer $composer, \_PhpScoperad4b7e2c09d8\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperad4b7e2c09d8\Composer\Composer $composer, \_PhpScoperad4b7e2c09d8\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperad4b7e2c09d8\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperad4b7e2c09d8\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperad4b7e2c09d8\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperad4b7e2c09d8\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperad4b7e2c09d8\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperad4b7e2c09d8\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperad4b7e2c09d8\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperad4b7e2c09d8\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperad4b7e2c09d8\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperad4b7e2c09d8\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperad4b7e2c09d8\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperad4b7e2c09d8\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperad4b7e2c09d8\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperad4b7e2c09d8\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
