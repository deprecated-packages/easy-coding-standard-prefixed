 ...
 * @license MIT
 */
namespace _PhpScoper64a921a5401b\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper64a921a5401b\Composer\Composer;
use _PhpScoper64a921a5401b\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper64a921a5401b\Composer\IO\IOInterface;
use _PhpScoper64a921a5401b\Composer\Package\AliasPackage;
use _PhpScoper64a921a5401b\Composer\Package\PackageInterface;
use _PhpScoper64a921a5401b\Composer\Package\RootPackageInterface;
use _PhpScoper64a921a5401b\Composer\Plugin\PluginInterface;
use _PhpScoper64a921a5401b\Composer\Script\Event;
use _PhpScoper64a921a5401b\Composer\Script\ScriptEvents;
use _PhpScoper64a921a5401b\Composer\Util\Filesystem;
use _PhpScoper64a921a5401b\Composer\Util\ProcessExecutor;
use _PhpScoper64a921a5401b\Symfony\Component\Finder\Finder;
...
use _PhpScoper64a921a5401b\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper64a921a5401b\Composer\Plugin\PluginInterface, \_PhpScoper64a921a5401b\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper64a921a5401b\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper64a921a5401b\Composer\Composer $composer, \_PhpScoper64a921a5401b\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper64a921a5401b\Composer\Composer $composer, \_PhpScoper64a921a5401b\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper64a921a5401b\Composer\Composer $composer, \_PhpScoper64a921a5401b\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper64a921a5401b\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper64a921a5401b\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper64a921a5401b\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper64a921a5401b\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper64a921a5401b\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper64a921a5401b\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper64a921a5401b\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper64a921a5401b\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper64a921a5401b\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper64a921a5401b\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper64a921a5401b\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper64a921a5401b\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper64a921a5401b\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper64a921a5401b\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
