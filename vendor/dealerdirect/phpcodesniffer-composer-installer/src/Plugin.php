 ...
 * @license MIT
 */
namespace _PhpScoperfb2c402b972b\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperfb2c402b972b\Composer\Composer;
use _PhpScoperfb2c402b972b\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperfb2c402b972b\Composer\IO\IOInterface;
use _PhpScoperfb2c402b972b\Composer\Package\AliasPackage;
use _PhpScoperfb2c402b972b\Composer\Package\PackageInterface;
use _PhpScoperfb2c402b972b\Composer\Package\RootPackageInterface;
use _PhpScoperfb2c402b972b\Composer\Plugin\PluginInterface;
use _PhpScoperfb2c402b972b\Composer\Script\Event;
use _PhpScoperfb2c402b972b\Composer\Script\ScriptEvents;
use _PhpScoperfb2c402b972b\Composer\Util\Filesystem;
use _PhpScoperfb2c402b972b\Composer\Util\ProcessExecutor;
...
use _PhpScoperfb2c402b972b\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperfb2c402b972b\Composer\Plugin\PluginInterface, \_PhpScoperfb2c402b972b\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperfb2c402b972b\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperfb2c402b972b\Composer\Composer $composer, \_PhpScoperfb2c402b972b\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperfb2c402b972b\Composer\Composer $composer, \_PhpScoperfb2c402b972b\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperfb2c402b972b\Composer\Composer $composer, \_PhpScoperfb2c402b972b\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperfb2c402b972b\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperfb2c402b972b\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperfb2c402b972b\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperfb2c402b972b\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperfb2c402b972b\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperfb2c402b972b\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperfb2c402b972b\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperfb2c402b972b\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperfb2c402b972b\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperfb2c402b972b\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperfb2c402b972b\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperfb2c402b972b\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperfb2c402b972b\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
