 ...
 * @license MIT
 */
namespace _PhpScoper2b44cb0c30af\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
use _PhpScoper2b44cb0c30af\Symfony\Component\Finder\Finder;
...
class Plugin implements \Composer\Plugin\PluginInterface, \Composer\EventDispatcher\EventSubscriberInterface
{
    ...
    {
        $finder = new \_PhpScoper2b44cb0c30af\Symfony\Component\Process\PhpExecutableFinder();
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper2b44cb0c30af\Symfony\Component\Finder\Finder();
    ...
    private function getPHPCodingStandardPackages()
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\Composer\Package\PackageInterface $package) {
            ...
            return $package->getType() === \_PhpScoper2b44cb0c30af\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
