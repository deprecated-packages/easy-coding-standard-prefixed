 ...
 * @license MIT
 */
namespace _PhpScoperb44a315fec16\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
use _PhpScoperb44a315fec16\Composer\Util\Filesystem;
use _PhpScoperb44a315fec16\Composer\Util\ProcessExecutor;
use _PhpScoperb44a315fec16\Symfony\Component\Finder\Finder;
 ...
 */
class Plugin implements \_PhpScoperb44a315fec16\Composer\Plugin\PluginInterface, \_PhpScoperb44a315fec16\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperb44a315fec16\Composer\Script\Event $event)
    {
        $io = $event->getIO();
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperb44a315fec16\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperb44a315fec16\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperb44a315fec16\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperb44a315fec16\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperb44a315fec16\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperb44a315fec16\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperb44a315fec16\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperb44a315fec16\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperb44a315fec16\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperb44a315fec16\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperb44a315fec16\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperb44a315fec16\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperb44a315fec16\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperb44a315fec16\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
