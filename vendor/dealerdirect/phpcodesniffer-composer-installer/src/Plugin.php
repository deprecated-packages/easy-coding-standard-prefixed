 ...
 * @license MIT
 */
namespace _PhpScoper269dc521b0fa\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper269dc521b0fa\Composer\Composer;
use _PhpScoper269dc521b0fa\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper269dc521b0fa\Composer\IO\IOInterface;
use _PhpScoper269dc521b0fa\Composer\Package\AliasPackage;
use _PhpScoper269dc521b0fa\Composer\Package\PackageInterface;
use _PhpScoper269dc521b0fa\Composer\Package\RootPackageInterface;
use _PhpScoper269dc521b0fa\Composer\Plugin\PluginInterface;
use _PhpScoper269dc521b0fa\Composer\Script\Event;
use _PhpScoper269dc521b0fa\Composer\Script\ScriptEvents;
use _PhpScoper269dc521b0fa\Composer\Util\Filesystem;
use _PhpScoper269dc521b0fa\Composer\Util\ProcessExecutor;
use _PhpScoper269dc521b0fa\Symfony\Component\Finder\Finder;
...
use _PhpScoper269dc521b0fa\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper269dc521b0fa\Composer\Plugin\PluginInterface, \_PhpScoper269dc521b0fa\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper269dc521b0fa\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper269dc521b0fa\Composer\Composer $composer, \_PhpScoper269dc521b0fa\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper269dc521b0fa\Composer\Composer $composer, \_PhpScoper269dc521b0fa\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper269dc521b0fa\Composer\Composer $composer, \_PhpScoper269dc521b0fa\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper269dc521b0fa\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper269dc521b0fa\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper269dc521b0fa\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper269dc521b0fa\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper269dc521b0fa\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper269dc521b0fa\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper269dc521b0fa\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper269dc521b0fa\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper269dc521b0fa\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper269dc521b0fa\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper269dc521b0fa\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper269dc521b0fa\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper269dc521b0fa\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper269dc521b0fa\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
