 ...
 * @license MIT
 */
namespace _PhpScoperd8b12759ee0d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperd8b12759ee0d\Composer\Composer;
use _PhpScoperd8b12759ee0d\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperd8b12759ee0d\Composer\IO\IOInterface;
use _PhpScoperd8b12759ee0d\Composer\Package\AliasPackage;
use _PhpScoperd8b12759ee0d\Composer\Package\PackageInterface;
use _PhpScoperd8b12759ee0d\Composer\Package\RootPackageInterface;
use _PhpScoperd8b12759ee0d\Composer\Plugin\PluginInterface;
use _PhpScoperd8b12759ee0d\Composer\Script\Event;
use _PhpScoperd8b12759ee0d\Composer\Script\ScriptEvents;
use _PhpScoperd8b12759ee0d\Composer\Util\Filesystem;
use _PhpScoperd8b12759ee0d\Composer\Util\ProcessExecutor;
use _PhpScoperd8b12759ee0d\Symfony\Component\Finder\Finder;
...
use _PhpScoperd8b12759ee0d\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperd8b12759ee0d\Composer\Plugin\PluginInterface, \_PhpScoperd8b12759ee0d\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperd8b12759ee0d\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperd8b12759ee0d\Composer\Composer $composer, \_PhpScoperd8b12759ee0d\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperd8b12759ee0d\Composer\Composer $composer, \_PhpScoperd8b12759ee0d\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperd8b12759ee0d\Composer\Composer $composer, \_PhpScoperd8b12759ee0d\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperd8b12759ee0d\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperd8b12759ee0d\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperd8b12759ee0d\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperd8b12759ee0d\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperd8b12759ee0d\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperd8b12759ee0d\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperd8b12759ee0d\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperd8b12759ee0d\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperd8b12759ee0d\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperd8b12759ee0d\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperd8b12759ee0d\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperd8b12759ee0d\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperd8b12759ee0d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperd8b12759ee0d\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
