 ...
 * @license MIT
 */
namespace _PhpScoper745103eaabcd\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper745103eaabcd\Composer\Composer;
use _PhpScoper745103eaabcd\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper745103eaabcd\Composer\IO\IOInterface;
use _PhpScoper745103eaabcd\Composer\Package\AliasPackage;
use _PhpScoper745103eaabcd\Composer\Package\PackageInterface;
use _PhpScoper745103eaabcd\Composer\Package\RootPackageInterface;
use _PhpScoper745103eaabcd\Composer\Plugin\PluginInterface;
use _PhpScoper745103eaabcd\Composer\Script\Event;
use _PhpScoper745103eaabcd\Composer\Script\ScriptEvents;
use _PhpScoper745103eaabcd\Composer\Util\Filesystem;
use _PhpScoper745103eaabcd\Composer\Util\ProcessExecutor;
use _PhpScoper745103eaabcd\Symfony\Component\Finder\Finder;
...
use _PhpScoper745103eaabcd\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper745103eaabcd\Composer\Plugin\PluginInterface, \_PhpScoper745103eaabcd\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper745103eaabcd\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper745103eaabcd\Composer\Composer $composer, \_PhpScoper745103eaabcd\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper745103eaabcd\Composer\Composer $composer, \_PhpScoper745103eaabcd\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper745103eaabcd\Composer\Composer $composer, \_PhpScoper745103eaabcd\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper745103eaabcd\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper745103eaabcd\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper745103eaabcd\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper745103eaabcd\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper745103eaabcd\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper745103eaabcd\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper745103eaabcd\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper745103eaabcd\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper745103eaabcd\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper745103eaabcd\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper745103eaabcd\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper745103eaabcd\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper745103eaabcd\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper745103eaabcd\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
