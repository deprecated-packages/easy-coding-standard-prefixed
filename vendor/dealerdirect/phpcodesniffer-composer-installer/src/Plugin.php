 ...
 * @license MIT
 */
namespace _PhpScoperfabf55fef6b7\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperfabf55fef6b7\Composer\Composer;
use _PhpScoperfabf55fef6b7\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperfabf55fef6b7\Composer\IO\IOInterface;
use _PhpScoperfabf55fef6b7\Composer\Package\AliasPackage;
use _PhpScoperfabf55fef6b7\Composer\Package\PackageInterface;
use _PhpScoperfabf55fef6b7\Composer\Package\RootPackageInterface;
use _PhpScoperfabf55fef6b7\Composer\Plugin\PluginInterface;
use _PhpScoperfabf55fef6b7\Composer\Script\Event;
use _PhpScoperfabf55fef6b7\Composer\Script\ScriptEvents;
use _PhpScoperfabf55fef6b7\Composer\Util\Filesystem;
use _PhpScoperfabf55fef6b7\Composer\Util\ProcessExecutor;
use _PhpScoperfabf55fef6b7\Symfony\Component\Finder\Finder;
...
use _PhpScoperfabf55fef6b7\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperfabf55fef6b7\Composer\Plugin\PluginInterface, \_PhpScoperfabf55fef6b7\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperfabf55fef6b7\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperfabf55fef6b7\Composer\Composer $composer, \_PhpScoperfabf55fef6b7\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperfabf55fef6b7\Composer\Composer $composer, \_PhpScoperfabf55fef6b7\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperfabf55fef6b7\Composer\Composer $composer, \_PhpScoperfabf55fef6b7\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperfabf55fef6b7\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperfabf55fef6b7\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperfabf55fef6b7\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperfabf55fef6b7\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperfabf55fef6b7\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperfabf55fef6b7\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperfabf55fef6b7\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperfabf55fef6b7\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperfabf55fef6b7\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperfabf55fef6b7\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperfabf55fef6b7\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperfabf55fef6b7\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperfabf55fef6b7\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperfabf55fef6b7\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
