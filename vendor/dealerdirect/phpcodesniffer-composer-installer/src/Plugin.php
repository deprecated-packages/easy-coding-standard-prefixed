 ...
 * @license MIT
 */
namespace _PhpScoper83a475a0590e\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;
...
use _PhpScoper83a475a0590e\Symfony\Component\Finder\Finder;
...
class Plugin implements \Composer\Plugin\PluginInterface, \Composer\EventDispatcher\EventSubscriberInterface
{
    ...
    {
        $finder = new \_PhpScoper83a475a0590e\Symfony\Component\Process\PhpExecutableFinder();
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper83a475a0590e\Symfony\Component\Finder\Finder();
    ...
    private function getPHPCodingStandardPackages()
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\Composer\Package\PackageInterface $package) {
            ...
            return $package->getType() === \_PhpScoper83a475a0590e\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
