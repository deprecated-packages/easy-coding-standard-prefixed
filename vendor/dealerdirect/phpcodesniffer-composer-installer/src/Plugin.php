 ...
 * @license MIT
 */
namespace _PhpScoperdf6a0b341030\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperdf6a0b341030\Composer\Composer;
use _PhpScoperdf6a0b341030\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperdf6a0b341030\Composer\IO\IOInterface;
use _PhpScoperdf6a0b341030\Composer\Package\AliasPackage;
use _PhpScoperdf6a0b341030\Composer\Package\PackageInterface;
use _PhpScoperdf6a0b341030\Composer\Package\RootPackageInterface;
use _PhpScoperdf6a0b341030\Composer\Plugin\PluginInterface;
use _PhpScoperdf6a0b341030\Composer\Script\Event;
use _PhpScoperdf6a0b341030\Composer\Script\ScriptEvents;
use _PhpScoperdf6a0b341030\Composer\Util\Filesystem;
use _PhpScoperdf6a0b341030\Composer\Util\ProcessExecutor;
use _PhpScoperdf6a0b341030\Symfony\Component\Finder\Finder;
...
use _PhpScoperdf6a0b341030\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperdf6a0b341030\Composer\Plugin\PluginInterface, \_PhpScoperdf6a0b341030\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperdf6a0b341030\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperdf6a0b341030\Composer\Composer $composer, \_PhpScoperdf6a0b341030\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperdf6a0b341030\Composer\Composer $composer, \_PhpScoperdf6a0b341030\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperdf6a0b341030\Composer\Composer $composer, \_PhpScoperdf6a0b341030\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperdf6a0b341030\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperdf6a0b341030\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperdf6a0b341030\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperdf6a0b341030\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperdf6a0b341030\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperdf6a0b341030\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperdf6a0b341030\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperdf6a0b341030\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperdf6a0b341030\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperdf6a0b341030\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperdf6a0b341030\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperdf6a0b341030\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperdf6a0b341030\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperdf6a0b341030\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
