 ...
 * @license MIT
 */
namespace _PhpScoper04022cd986ec\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper04022cd986ec\Composer\Composer;
use _PhpScoper04022cd986ec\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper04022cd986ec\Composer\IO\IOInterface;
use _PhpScoper04022cd986ec\Composer\Package\AliasPackage;
use _PhpScoper04022cd986ec\Composer\Package\PackageInterface;
use _PhpScoper04022cd986ec\Composer\Package\RootPackageInterface;
use _PhpScoper04022cd986ec\Composer\Plugin\PluginInterface;
use _PhpScoper04022cd986ec\Composer\Script\Event;
use _PhpScoper04022cd986ec\Composer\Script\ScriptEvents;
use _PhpScoper04022cd986ec\Composer\Util\Filesystem;
use _PhpScoper04022cd986ec\Composer\Util\ProcessExecutor;
use _PhpScoper04022cd986ec\Symfony\Component\Finder\Finder;
...
use _PhpScoper04022cd986ec\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper04022cd986ec\Composer\Plugin\PluginInterface, \_PhpScoper04022cd986ec\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper04022cd986ec\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper04022cd986ec\Composer\Composer $composer, \_PhpScoper04022cd986ec\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper04022cd986ec\Composer\Composer $composer, \_PhpScoper04022cd986ec\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper04022cd986ec\Composer\Composer $composer, \_PhpScoper04022cd986ec\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper04022cd986ec\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper04022cd986ec\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper04022cd986ec\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper04022cd986ec\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper04022cd986ec\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper04022cd986ec\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper04022cd986ec\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper04022cd986ec\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper04022cd986ec\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper04022cd986ec\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper04022cd986ec\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper04022cd986ec\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper04022cd986ec\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper04022cd986ec\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
