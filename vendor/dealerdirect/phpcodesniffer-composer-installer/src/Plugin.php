 ...
 * @license MIT
 */
namespace _PhpScoperfaaf57618f34\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperfaaf57618f34\Composer\Composer;
use _PhpScoperfaaf57618f34\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperfaaf57618f34\Composer\IO\IOInterface;
use _PhpScoperfaaf57618f34\Composer\Package\AliasPackage;
use _PhpScoperfaaf57618f34\Composer\Package\PackageInterface;
use _PhpScoperfaaf57618f34\Composer\Package\RootPackageInterface;
use _PhpScoperfaaf57618f34\Composer\Plugin\PluginInterface;
use _PhpScoperfaaf57618f34\Composer\Script\Event;
use _PhpScoperfaaf57618f34\Composer\Script\ScriptEvents;
use _PhpScoperfaaf57618f34\Composer\Util\Filesystem;
use _PhpScoperfaaf57618f34\Composer\Util\ProcessExecutor;
use _PhpScoperfaaf57618f34\Symfony\Component\Finder\Finder;
...
use _PhpScoperfaaf57618f34\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperfaaf57618f34\Composer\Plugin\PluginInterface, \_PhpScoperfaaf57618f34\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperfaaf57618f34\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperfaaf57618f34\Composer\Composer $composer, \_PhpScoperfaaf57618f34\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperfaaf57618f34\Composer\Composer $composer, \_PhpScoperfaaf57618f34\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperfaaf57618f34\Composer\Composer $composer, \_PhpScoperfaaf57618f34\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperfaaf57618f34\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperfaaf57618f34\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperfaaf57618f34\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperfaaf57618f34\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperfaaf57618f34\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperfaaf57618f34\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperfaaf57618f34\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperfaaf57618f34\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperfaaf57618f34\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperfaaf57618f34\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperfaaf57618f34\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperfaaf57618f34\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperfaaf57618f34\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperfaaf57618f34\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
