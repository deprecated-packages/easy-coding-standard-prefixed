 ...
 * @license MIT
 */
namespace _PhpScopera4be459e5e3d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScopera4be459e5e3d\Composer\Composer;
use _PhpScopera4be459e5e3d\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScopera4be459e5e3d\Composer\IO\IOInterface;
use _PhpScopera4be459e5e3d\Composer\Package\AliasPackage;
use _PhpScopera4be459e5e3d\Composer\Package\PackageInterface;
use _PhpScopera4be459e5e3d\Composer\Package\RootPackageInterface;
use _PhpScopera4be459e5e3d\Composer\Plugin\PluginInterface;
use _PhpScopera4be459e5e3d\Composer\Script\Event;
use _PhpScopera4be459e5e3d\Composer\Script\ScriptEvents;
use _PhpScopera4be459e5e3d\Composer\Util\Filesystem;
use _PhpScopera4be459e5e3d\Composer\Util\ProcessExecutor;
use _PhpScopera4be459e5e3d\Symfony\Component\Finder\Finder;
 ...
 */
class Plugin implements \_PhpScopera4be459e5e3d\Composer\Plugin\PluginInterface, \_PhpScopera4be459e5e3d\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScopera4be459e5e3d\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScopera4be459e5e3d\Composer\Composer $composer, \_PhpScopera4be459e5e3d\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScopera4be459e5e3d\Composer\Composer $composer, \_PhpScopera4be459e5e3d\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScopera4be459e5e3d\Composer\Composer $composer, \_PhpScopera4be459e5e3d\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScopera4be459e5e3d\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScopera4be459e5e3d\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScopera4be459e5e3d\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScopera4be459e5e3d\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScopera4be459e5e3d\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScopera4be459e5e3d\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScopera4be459e5e3d\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScopera4be459e5e3d\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScopera4be459e5e3d\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScopera4be459e5e3d\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScopera4be459e5e3d\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScopera4be459e5e3d\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScopera4be459e5e3d\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScopera4be459e5e3d\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
