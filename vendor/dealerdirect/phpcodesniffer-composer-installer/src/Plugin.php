 ...
 * @license MIT
 */
namespace _PhpScoper967d20dce97a\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper967d20dce97a\Composer\Composer;
use _PhpScoper967d20dce97a\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper967d20dce97a\Composer\IO\IOInterface;
use _PhpScoper967d20dce97a\Composer\Package\AliasPackage;
use _PhpScoper967d20dce97a\Composer\Package\PackageInterface;
use _PhpScoper967d20dce97a\Composer\Package\RootPackageInterface;
use _PhpScoper967d20dce97a\Composer\Plugin\PluginInterface;
use _PhpScoper967d20dce97a\Composer\Script\Event;
use _PhpScoper967d20dce97a\Composer\Script\ScriptEvents;
use _PhpScoper967d20dce97a\Composer\Util\Filesystem;
use _PhpScoper967d20dce97a\Composer\Util\ProcessExecutor;
use _PhpScoper967d20dce97a\Symfony\Component\Finder\Finder;
...
use _PhpScoper967d20dce97a\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper967d20dce97a\Composer\Plugin\PluginInterface, \_PhpScoper967d20dce97a\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper967d20dce97a\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper967d20dce97a\Composer\Composer $composer, \_PhpScoper967d20dce97a\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper967d20dce97a\Composer\Composer $composer, \_PhpScoper967d20dce97a\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper967d20dce97a\Composer\Composer $composer, \_PhpScoper967d20dce97a\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper967d20dce97a\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper967d20dce97a\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper967d20dce97a\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper967d20dce97a\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper967d20dce97a\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper967d20dce97a\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper967d20dce97a\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper967d20dce97a\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper967d20dce97a\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper967d20dce97a\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper967d20dce97a\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper967d20dce97a\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper967d20dce97a\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper967d20dce97a\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
