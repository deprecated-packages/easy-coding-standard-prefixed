 ...
 * @license MIT
 */
namespace _PhpScoperdeea1786e972\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperdeea1786e972\Composer\Composer;
use _PhpScoperdeea1786e972\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperdeea1786e972\Composer\IO\IOInterface;
use _PhpScoperdeea1786e972\Composer\Package\AliasPackage;
use _PhpScoperdeea1786e972\Composer\Package\PackageInterface;
use _PhpScoperdeea1786e972\Composer\Package\RootPackageInterface;
use _PhpScoperdeea1786e972\Composer\Plugin\PluginInterface;
use _PhpScoperdeea1786e972\Composer\Script\Event;
use _PhpScoperdeea1786e972\Composer\Script\ScriptEvents;
use _PhpScoperdeea1786e972\Composer\Util\Filesystem;
use _PhpScoperdeea1786e972\Composer\Util\ProcessExecutor;
use _PhpScoperdeea1786e972\Symfony\Component\Finder\Finder;
...
use _PhpScoperdeea1786e972\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperdeea1786e972\Composer\Plugin\PluginInterface, \_PhpScoperdeea1786e972\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperdeea1786e972\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperdeea1786e972\Composer\Composer $composer, \_PhpScoperdeea1786e972\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperdeea1786e972\Composer\Composer $composer, \_PhpScoperdeea1786e972\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperdeea1786e972\Composer\Composer $composer, \_PhpScoperdeea1786e972\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperdeea1786e972\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperdeea1786e972\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperdeea1786e972\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperdeea1786e972\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperdeea1786e972\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperdeea1786e972\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperdeea1786e972\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperdeea1786e972\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperdeea1786e972\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperdeea1786e972\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperdeea1786e972\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperdeea1786e972\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperdeea1786e972\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperdeea1786e972\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
