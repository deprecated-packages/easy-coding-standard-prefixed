 ...
 * @license MIT
 */
namespace _PhpScoper2f75f00bf6fa\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoper2f75f00bf6fa\Composer\Composer;
use _PhpScoper2f75f00bf6fa\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoper2f75f00bf6fa\Composer\IO\IOInterface;
use _PhpScoper2f75f00bf6fa\Composer\Package\AliasPackage;
use _PhpScoper2f75f00bf6fa\Composer\Package\PackageInterface;
use _PhpScoper2f75f00bf6fa\Composer\Package\RootPackageInterface;
use _PhpScoper2f75f00bf6fa\Composer\Plugin\PluginInterface;
use _PhpScoper2f75f00bf6fa\Composer\Script\Event;
use _PhpScoper2f75f00bf6fa\Composer\Script\ScriptEvents;
use _PhpScoper2f75f00bf6fa\Composer\Util\Filesystem;
use _PhpScoper2f75f00bf6fa\Composer\Util\ProcessExecutor;
use _PhpScoper2f75f00bf6fa\Symfony\Component\Finder\Finder;
...
use _PhpScoper2f75f00bf6fa\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoper2f75f00bf6fa\Composer\Plugin\PluginInterface, \_PhpScoper2f75f00bf6fa\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoper2f75f00bf6fa\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoper2f75f00bf6fa\Composer\Composer $composer, \_PhpScoper2f75f00bf6fa\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoper2f75f00bf6fa\Composer\Composer $composer, \_PhpScoper2f75f00bf6fa\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoper2f75f00bf6fa\Composer\Composer $composer, \_PhpScoper2f75f00bf6fa\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoper2f75f00bf6fa\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoper2f75f00bf6fa\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoper2f75f00bf6fa\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoper2f75f00bf6fa\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoper2f75f00bf6fa\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoper2f75f00bf6fa\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoper2f75f00bf6fa\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoper2f75f00bf6fa\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoper2f75f00bf6fa\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoper2f75f00bf6fa\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoper2f75f00bf6fa\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoper2f75f00bf6fa\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoper2f75f00bf6fa\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoper2f75f00bf6fa\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
