 ...
 * @license MIT
 */
namespace _PhpScoperea337ed74749\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperea337ed74749\Composer\Composer;
use _PhpScoperea337ed74749\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperea337ed74749\Composer\IO\IOInterface;
use _PhpScoperea337ed74749\Composer\Package\AliasPackage;
use _PhpScoperea337ed74749\Composer\Package\PackageInterface;
use _PhpScoperea337ed74749\Composer\Package\RootPackageInterface;
use _PhpScoperea337ed74749\Composer\Plugin\PluginInterface;
use _PhpScoperea337ed74749\Composer\Script\Event;
use _PhpScoperea337ed74749\Composer\Script\ScriptEvents;
use _PhpScoperea337ed74749\Composer\Util\Filesystem;
use _PhpScoperea337ed74749\Composer\Util\ProcessExecutor;
use _PhpScoperea337ed74749\Symfony\Component\Finder\Finder;
...
use _PhpScoperea337ed74749\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperea337ed74749\Composer\Plugin\PluginInterface, \_PhpScoperea337ed74749\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperea337ed74749\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperea337ed74749\Composer\Composer $composer, \_PhpScoperea337ed74749\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperea337ed74749\Composer\Composer $composer, \_PhpScoperea337ed74749\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperea337ed74749\Composer\Composer $composer, \_PhpScoperea337ed74749\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperea337ed74749\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperea337ed74749\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperea337ed74749\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperea337ed74749\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperea337ed74749\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperea337ed74749\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperea337ed74749\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperea337ed74749\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperea337ed74749\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperea337ed74749\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperea337ed74749\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperea337ed74749\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperea337ed74749\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperea337ed74749\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
