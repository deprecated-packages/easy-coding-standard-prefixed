 ...
 * @license MIT
 */
namespace _PhpScoperd35c27cd4b09\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use _PhpScoperd35c27cd4b09\Composer\Composer;
use _PhpScoperd35c27cd4b09\Composer\EventDispatcher\EventSubscriberInterface;
use _PhpScoperd35c27cd4b09\Composer\IO\IOInterface;
use _PhpScoperd35c27cd4b09\Composer\Package\AliasPackage;
use _PhpScoperd35c27cd4b09\Composer\Package\PackageInterface;
use _PhpScoperd35c27cd4b09\Composer\Package\RootPackageInterface;
use _PhpScoperd35c27cd4b09\Composer\Plugin\PluginInterface;
use _PhpScoperd35c27cd4b09\Composer\Script\Event;
use _PhpScoperd35c27cd4b09\Composer\Script\ScriptEvents;
use _PhpScoperd35c27cd4b09\Composer\Util\Filesystem;
use _PhpScoperd35c27cd4b09\Composer\Util\ProcessExecutor;
use _PhpScoperd35c27cd4b09\Symfony\Component\Finder\Finder;
...
use _PhpScoperd35c27cd4b09\Symfony\Component\Process\PhpExecutableFinder;
/**
 * PHP_CodeSniffer standard installation manager.
 *
 * @author Franck Nijhof <franck.nijhof@dealerdirect.com>
 */
class Plugin implements \_PhpScoperd35c27cd4b09\Composer\Plugin\PluginInterface, \_PhpScoperd35c27cd4b09\Composer\EventDispatcher\EventSubscriberInterface
{
     ...
     * @throws RuntimeException
     */
    public static function run(\_PhpScoperd35c27cd4b09\Composer\Script\Event $event)
    {
        $io = $event->getIO();
     ...
     * @throws RuntimeException
     */
    public function activate(\_PhpScoperd35c27cd4b09\Composer\Composer $composer, \_PhpScoperd35c27cd4b09\Composer\IO\IOInterface $io)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\_PhpScoperd35c27cd4b09\Composer\Composer $composer, \_PhpScoperd35c27cd4b09\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\_PhpScoperd35c27cd4b09\Composer\Composer $composer, \_PhpScoperd35c27cd4b09\Composer\IO\IOInterface $io)
    {
    }
    /**
    ...
    private function init()
    {
        ...
        $this->processExecutor = new \_PhpScoperd35c27cd4b09\Composer\Util\ProcessExecutor($this->io);
        $this->filesystem = new \_PhpScoperd35c27cd4b09\Composer\Util\Filesystem($this->processExecutor);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return array(\_PhpScoperd35c27cd4b09\Composer\Script\ScriptEvents::POST_INSTALL_CMD => array(array('onDependenciesChangedEvent', 0)), \_PhpScoperd35c27cd4b09\Composer\Script\ScriptEvents::POST_UPDATE_CMD => array(array('onDependenciesChangedEvent', 0)));
    }
    /**
    ...
    {
        $finder = new \_PhpScoperd35c27cd4b09\Symfony\Component\Process\PhpExecutableFinder();
        ...
        $command = \_PhpScoperd35c27cd4b09\Composer\Util\ProcessExecutor::escape($phpPath) . $phpArgs . ' -d allow_url_fopen=' . \_PhpScoperd35c27cd4b09\Composer\Util\ProcessExecutor::escape(\ini_get('allow_url_fopen')) . ' -d disable_functions=' . \_PhpScoperd35c27cd4b09\Composer\Util\ProcessExecutor::escape(\ini_get('disable_functions')) . ' -d memory_limit=' . \_PhpScoperd35c27cd4b09\Composer\Util\ProcessExecutor::escape(\ini_get('memory_limit'));
        return $command;
    }
    /**
    ...
    private function updateInstalledPaths()
    {
        ...
        $finder = new \_PhpScoperd35c27cd4b09\Symfony\Component\Finder\Finder();
    ...
    {
        $codingStandardPackages = \array_filter($this->composer->getRepositoryManager()->getLocalRepository()->getPackages(), function (\_PhpScoperd35c27cd4b09\Composer\Package\PackageInterface $package) {
            if ($package instanceof \_PhpScoperd35c27cd4b09\Composer\Package\AliasPackage) {
                return \false;
            }
            return $package->getType() === \_PhpScoperd35c27cd4b09\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer\Plugin::PACKAGE_TYPE;
        });
        if (!$this->composer->getPackage() instanceof \_PhpScoperd35c27cd4b09\Composer\Package\RootPackageInterface && $this->composer->getPackage()->getType() === self::PACKAGE_TYPE) {
