...
use const _PhpScoper2f75f00bf6fa\T_ARRAY_HINT;
use const T_BREAK;
...
use const _PhpScoper2f75f00bf6fa\T_DOC_COMMENT_CLOSE_TAG;
...
use const _PhpScoper2f75f00bf6fa\T_DOC_COMMENT_TAG;
use const _PhpScoper2f75f00bf6fa\T_DOC_COMMENT_WHITESPACE;
use const T_EXIT;
use const _PhpScoper2f75f00bf6fa\T_FN;
use const T_FUNCTION;
use const T_INTERFACE;
use const _PhpScoper2f75f00bf6fa\T_NAME_FULLY_QUALIFIED;
use const _PhpScoper2f75f00bf6fa\T_NAME_QUALIFIED;
use const _PhpScoper2f75f00bf6fa\T_NAME_RELATIVE;
use const T_NS_SEPARATOR;
use const _PhpScoper2f75f00bf6fa\T_PARENT;
use const _PhpScoper2f75f00bf6fa\T_PHPCS_DISABLE;
use const _PhpScoper2f75f00bf6fa\T_PHPCS_ENABLE;
use const _PhpScoper2f75f00bf6fa\T_PHPCS_IGNORE;
use const _PhpScoper2f75f00bf6fa\T_PHPCS_IGNORE_FILE;
use const _PhpScoper2f75f00bf6fa\T_PHPCS_SET;
use const T_RETURN;
use const _PhpScoper2f75f00bf6fa\T_SELF;
use const T_STRING;
use const T_THROW;
use const T_TRAIT;
...
class TokenHelper
{
     ...
     * @var (int|string)[]
     */
    public static $nameTokenCodes = [\T_NS_SEPARATOR, \T_STRING];
    /** @var (int|string)[] */
    public static $typeKeywordTokenCodes = [\T_CLASS, \T_TRAIT, \T_INTERFACE];
    /** @var (int|string)[] */
    public static $ineffectiveTokenCodes = [\T_WHITESPACE, \T_COMMENT, \T_DOC_COMMENT, \T_DOC_COMMENT_OPEN_TAG, \T_DOC_COMMENT_CLOSE_TAG, \T_DOC_COMMENT_STAR, \T_DOC_COMMENT_STRING, \T_DOC_COMMENT_TAG, \T_DOC_COMMENT_WHITESPACE, \T_PHPCS_DISABLE, \T_PHPCS_ENABLE, \T_PHPCS_IGNORE, \T_PHPCS_IGNORE_FILE, \T_PHPCS_SET];
    /** @var (int|string)[] */
    public static $inlineCommentTokenCodes = [\T_COMMENT, \T_PHPCS_DISABLE, \T_PHPCS_ENABLE, \T_PHPCS_IGNORE, \T_PHPCS_IGNORE_FILE, \T_PHPCS_SET];
    /**
     * @deprecated Use TokenHelper::getTypeHintTokenCodes()
     * @var (int|string)[]
     */
    public static $typeHintTokenCodes = [\T_NS_SEPARATOR, \T_STRING, \T_SELF, \T_PARENT, \T_ARRAY_HINT, \T_CALLABLE];
    /** @var (int|string)[] */
    public static $earlyExitTokenCodes = [\T_RETURN, \T_CONTINUE, \T_BREAK, \T_THROW, \T_EXIT];
    /** @var (int|string)[] */
    public static $functionTokenCodes = [\T_FUNCTION, \T_CLOSURE, \T_FN];
    /**
    ...
    {
        /** @var int|false $token */
        $token = $phpcsFile->findNext($types, $startPointer, $endPointer, \true);
        return $token === \false ? null : $token;
    }
    /**
     * @param File $phpcsFile
    ...
    {
        /** @var int|false $token */
        $token = $phpcsFile->findNext($types, $startPointer, $endPointer, \false, null, \true);
        return $token === \false ? null : $token;
    }
    /**
     * @param File $phpcsFile
    ...
    {
        /** @var int|false $token */
        $token = $phpcsFile->findNext($types, $startPointer, $endPointer, \true, null, \true);
        return $token === \false ? null : $token;
    }
    /**
     * @param File $phpcsFile
     ...
     * @return int|null
     */
    public static function findPreviousContent(\PHP_CodeSniffer\Files\File $phpcsFile, $types, string $content, int $startPointer, ?int $endPointer = null) : ?int
    {
        /** @var int|false $token */
    ...
    {
        /** @var int|false $token */
        $token = $phpcsFile->findPrevious($types, $startPointer, $endPointer, \true);
        return $token === \false ? null : $token;
    }
    /**
     * @param File $phpcsFile
    ...
    {
        /** @var int|false $token */
        $token = $phpcsFile->findPrevious($types, $startPointer, $endPointer, \false, null, \true);
        return $token === \false ? null : $token;
    }
    /**
     * @param File $phpcsFile
     ...
     * @return int
     */
    public static function findFirstTokenOnLine(\PHP_CodeSniffer\Files\File $phpcsFile, int $pointer) : int
    {
        if ($pointer === 0) {
            return $pointer;
        }
     ...
     * @return int
     */
    public static function findLastTokenOnLine(\PHP_CodeSniffer\Files\File $phpcsFile, int $pointer) : int
    {
        $tokens = $phpcsFile->getTokens();
        $line = $tokens[$pointer]['line'];
        do {
     ...
     * @return int
     */
    public static function findFirstNonWhitespaceOnLine(\PHP_CodeSniffer\Files\File $phpcsFile, int $pointer) : int
    {
        if ($pointer === 0) {
            return $pointer;
        }
     ...
     * @return int|null
     */
    public static function findFirstNonWhitespaceOnNextLine(\PHP_CodeSniffer\Files\File $phpcsFile, int $pointer) : ?int
    {
     ...
     * @return int|null
     */
    public static function findFirstNonWhitespaceOnPreviousLine(\PHP_CodeSniffer\Files\File $phpcsFile, int $pointer) : ?int
    {
    ...
    public static function getTypeHintTokenCodes() : array
    {
        ...
        if ($typeHintTokenCodes === null) {
            $typeHintTokenCodes = \array_merge(self::getNameTokenCodes(), [\T_SELF, \T_PARENT, \T_ARRAY_HINT, \T_CALLABLE]);
        }
