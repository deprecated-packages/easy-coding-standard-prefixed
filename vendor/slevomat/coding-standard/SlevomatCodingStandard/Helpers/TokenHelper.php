...
use const _PhpScopera238de2e9b5a\T_ARRAY_HINT;
use const T_BREAK;
...
use const _PhpScopera238de2e9b5a\T_DOC_COMMENT_CLOSE_TAG;
...
use const _PhpScopera238de2e9b5a\T_DOC_COMMENT_TAG;
...
use const _PhpScopera238de2e9b5a\T_PARENT;
use const _PhpScopera238de2e9b5a\T_PHPCS_DISABLE;
use const _PhpScopera238de2e9b5a\T_PHPCS_ENABLE;
use const _PhpScopera238de2e9b5a\T_PHPCS_IGNORE;
use const _PhpScopera238de2e9b5a\T_PHPCS_IGNORE_FILE;
use const _PhpScopera238de2e9b5a\T_PHPCS_SET;
use const T_RETURN;
use const _PhpScopera238de2e9b5a\T_SELF;
use const T_STRING;
use const T_THROW;
use const T_TRAIT;
