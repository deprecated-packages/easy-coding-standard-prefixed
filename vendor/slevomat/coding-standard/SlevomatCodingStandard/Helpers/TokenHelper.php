...
use const _PhpScoper3e1e0e5bb8ef\T_ARRAY_HINT;
use const T_BREAK;
...
use const _PhpScoper3e1e0e5bb8ef\T_PARENT;
use const _PhpScoper3e1e0e5bb8ef\T_PHPCS_DISABLE;
use const _PhpScoper3e1e0e5bb8ef\T_PHPCS_ENABLE;
use const _PhpScoper3e1e0e5bb8ef\T_PHPCS_IGNORE;
use const _PhpScoper3e1e0e5bb8ef\T_PHPCS_IGNORE_FILE;
use const _PhpScoper3e1e0e5bb8ef\T_PHPCS_SET;
use const T_RETURN;
use const _PhpScoper3e1e0e5bb8ef\T_SELF;
use const T_STRING;
use const T_THROW;
use const T_TRAIT;
