...
use const _PhpScoper6d28bdf6a7f9\T_ARRAY_HINT;
use const T_BREAK;
...
use const _PhpScoper6d28bdf6a7f9\T_NAME_FULLY_QUALIFIED;
use const _PhpScoper6d28bdf6a7f9\T_NAME_QUALIFIED;
use const _PhpScoper6d28bdf6a7f9\T_NAME_RELATIVE;
use const T_NS_SEPARATOR;
use const _PhpScoper6d28bdf6a7f9\T_PARENT;
use const _PhpScoper6d28bdf6a7f9\T_PHPCS_DISABLE;
use const _PhpScoper6d28bdf6a7f9\T_PHPCS_ENABLE;
use const _PhpScoper6d28bdf6a7f9\T_PHPCS_IGNORE;
use const _PhpScoper6d28bdf6a7f9\T_PHPCS_IGNORE_FILE;
use const _PhpScoper6d28bdf6a7f9\T_PHPCS_SET;
use const T_RETURN;
use const _PhpScoper6d28bdf6a7f9\T_SELF;
use const T_STRING;
use const T_THROW;
use const T_TRAIT;
