...
use const _PhpScoper6250f8d25076\T_ARRAY_HINT;
use const T_BREAK;
...
use const _PhpScoper6250f8d25076\T_DOC_COMMENT_CLOSE_TAG;
...
use const _PhpScoper6250f8d25076\T_DOC_COMMENT_TAG;
use const _PhpScoper6250f8d25076\T_DOC_COMMENT_WHITESPACE;
use const T_EXIT;
use const _PhpScoper6250f8d25076\T_FN;
use const T_FUNCTION;
use const T_INTERFACE;
use const _PhpScoper6250f8d25076\T_NAME_FULLY_QUALIFIED;
use const _PhpScoper6250f8d25076\T_NAME_QUALIFIED;
use const _PhpScoper6250f8d25076\T_NAME_RELATIVE;
use const T_NS_SEPARATOR;
use const _PhpScoper6250f8d25076\T_PARENT;
use const _PhpScoper6250f8d25076\T_PHPCS_DISABLE;
use const _PhpScoper6250f8d25076\T_PHPCS_ENABLE;
use const _PhpScoper6250f8d25076\T_PHPCS_IGNORE;
use const _PhpScoper6250f8d25076\T_PHPCS_IGNORE_FILE;
use const _PhpScoper6250f8d25076\T_PHPCS_SET;
use const T_RETURN;
use const _PhpScoper6250f8d25076\T_SELF;
use const T_STRING;
use const T_THROW;
use const T_TRAIT;
