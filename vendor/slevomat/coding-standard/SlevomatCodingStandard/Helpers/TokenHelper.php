...
use const _PhpScoperedc2e0c967db\T_ARRAY_HINT;
use const T_BREAK;
...
use const _PhpScoperedc2e0c967db\T_PARENT;
use const _PhpScoperedc2e0c967db\T_PHPCS_DISABLE;
use const _PhpScoperedc2e0c967db\T_PHPCS_ENABLE;
use const _PhpScoperedc2e0c967db\T_PHPCS_IGNORE;
use const _PhpScoperedc2e0c967db\T_PHPCS_IGNORE_FILE;
use const _PhpScoperedc2e0c967db\T_PHPCS_SET;
use const T_RETURN;
use const _PhpScoperedc2e0c967db\T_SELF;
use const T_STRING;
use const T_THROW;
use const T_TRAIT;
