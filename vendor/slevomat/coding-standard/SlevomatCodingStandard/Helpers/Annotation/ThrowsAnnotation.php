...
use _PhpScoper38a7d00685f8\PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode;
...
class ThrowsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper38a7d00685f8\PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper38a7d00685f8\PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode
    {
