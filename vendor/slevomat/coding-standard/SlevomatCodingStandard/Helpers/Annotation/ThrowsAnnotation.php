...
use _PhpScoper7c1f54fd2f3a\PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode;
...
class ThrowsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper7c1f54fd2f3a\PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper7c1f54fd2f3a\PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode
    {
