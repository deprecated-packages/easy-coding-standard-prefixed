...
use _PhpScoper16399a42e87c\PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode;
...
class ThrowsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper16399a42e87c\PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper16399a42e87c\PHPStan\PhpDocParser\Ast\PhpDoc\ThrowsTagValueNode
    {
