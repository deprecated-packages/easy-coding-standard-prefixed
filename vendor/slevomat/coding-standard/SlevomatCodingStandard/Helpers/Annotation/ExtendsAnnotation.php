...
use _PhpScoper47644ab3aa9a\PHPStan\PhpDocParser\Ast\PhpDoc\ExtendsTagValueNode;
...
class ExtendsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper47644ab3aa9a\PHPStan\PhpDocParser\Ast\PhpDoc\ExtendsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper47644ab3aa9a\PHPStan\PhpDocParser\Ast\PhpDoc\ExtendsTagValueNode
    {
