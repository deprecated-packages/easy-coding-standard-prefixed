...
use _PhpScoper880bfa4d8b51\PHPStan\PhpDocParser\Ast\PhpDoc\ExtendsTagValueNode;
...
class ExtendsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper880bfa4d8b51\PHPStan\PhpDocParser\Ast\PhpDoc\ExtendsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper880bfa4d8b51\PHPStan\PhpDocParser\Ast\PhpDoc\ExtendsTagValueNode
    {
