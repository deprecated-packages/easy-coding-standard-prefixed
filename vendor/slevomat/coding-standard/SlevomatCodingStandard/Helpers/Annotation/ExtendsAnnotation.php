...
use _PhpScopera1a51450b61d\PHPStan\PhpDocParser\Ast\PhpDoc\ExtendsTagValueNode;
...
class ExtendsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScopera1a51450b61d\PHPStan\PhpDocParser\Ast\PhpDoc\ExtendsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScopera1a51450b61d\PHPStan\PhpDocParser\Ast\PhpDoc\ExtendsTagValueNode
    {
