...
use _PhpScoper9d73a84b09ad\PHPStan\PhpDocParser\Ast\PhpDoc\ReturnTagValueNode;
...
class ReturnAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper9d73a84b09ad\PHPStan\PhpDocParser\Ast\PhpDoc\ReturnTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper9d73a84b09ad\PHPStan\PhpDocParser\Ast\PhpDoc\ReturnTagValueNode
    {
