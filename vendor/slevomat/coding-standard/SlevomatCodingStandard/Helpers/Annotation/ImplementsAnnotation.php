...
use _PhpScoperf3f1be0d8a30\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode;
...
class ImplementsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoperf3f1be0d8a30\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoperf3f1be0d8a30\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode
    {
    ...
    public function getType() : \_PhpScoperf3f1be0d8a30\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode
    {
        $this->errorWhenInvalid();
