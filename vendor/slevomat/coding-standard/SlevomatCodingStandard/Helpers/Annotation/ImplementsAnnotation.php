...
use _PhpScoper14cb6de5473d\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode;
...
class ImplementsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper14cb6de5473d\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper14cb6de5473d\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode
    {
