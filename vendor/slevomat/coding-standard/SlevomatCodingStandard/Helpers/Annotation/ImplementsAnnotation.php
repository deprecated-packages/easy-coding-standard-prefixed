...
use _PhpScoperc64a4ac1af35\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode;
...
class ImplementsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoperc64a4ac1af35\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoperc64a4ac1af35\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode
    {
    ...
    public function getType() : \_PhpScoperc64a4ac1af35\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode
    {
        $this->errorWhenInvalid();
