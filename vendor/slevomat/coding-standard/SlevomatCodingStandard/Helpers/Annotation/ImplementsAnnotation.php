...
use _PhpScoper528afa732cbd\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode;
...
class ImplementsAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper528afa732cbd\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper528afa732cbd\PHPStan\PhpDocParser\Ast\PhpDoc\ImplementsTagValueNode
    {
    ...
    public function getType() : \_PhpScoper528afa732cbd\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode
    {
        $this->errorWhenInvalid();
