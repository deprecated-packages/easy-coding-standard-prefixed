...
use _PhpScoperac4e86be08e5\PHPStan\PhpDocParser\Ast\PhpDoc\PropertyTagValueNode;
...
class PropertyAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoperac4e86be08e5\PHPStan\PhpDocParser\Ast\PhpDoc\PropertyTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoperac4e86be08e5\PHPStan\PhpDocParser\Ast\PhpDoc\PropertyTagValueNode
    {
