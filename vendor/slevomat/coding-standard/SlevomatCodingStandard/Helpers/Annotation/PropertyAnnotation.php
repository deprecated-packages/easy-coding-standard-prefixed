...
use _PhpScoperdf15f2b748e9\PHPStan\PhpDocParser\Ast\PhpDoc\PropertyTagValueNode;
...
class PropertyAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoperdf15f2b748e9\PHPStan\PhpDocParser\Ast\PhpDoc\PropertyTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoperdf15f2b748e9\PHPStan\PhpDocParser\Ast\PhpDoc\PropertyTagValueNode
    {
