...
use _PhpScoper28ab463fc3ba\PHPStan\PhpDocParser\Ast\PhpDoc\VarTagValueNode;
...
class VariableAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper28ab463fc3ba\PHPStan\PhpDocParser\Ast\PhpDoc\VarTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper28ab463fc3ba\PHPStan\PhpDocParser\Ast\PhpDoc\VarTagValueNode
    {
