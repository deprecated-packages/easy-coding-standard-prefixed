...
use _PhpScoper544eb478a6f6\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode;
...
class ParameterAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper544eb478a6f6\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper544eb478a6f6\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode
    {
