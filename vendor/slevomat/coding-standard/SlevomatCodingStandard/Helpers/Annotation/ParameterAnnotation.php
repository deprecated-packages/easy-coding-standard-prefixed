...
use _PhpScoperfab1bfb7ec99\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode;
...
class ParameterAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoperfab1bfb7ec99\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoperfab1bfb7ec99\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode
    {
     ...
     */
    public function getType() : \_PhpScoperfab1bfb7ec99\PHPStan\PhpDocParser\Ast\Type\TypeNode
    {
        $this->errorWhenInvalid();
