...
use _PhpScoper7108c819f5c5\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode;
...
class ParameterAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper7108c819f5c5\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper7108c819f5c5\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode
    {
