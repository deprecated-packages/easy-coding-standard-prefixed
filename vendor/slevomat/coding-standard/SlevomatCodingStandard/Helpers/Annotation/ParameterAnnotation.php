...
use _PhpScopera4fc793dae73\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode;
...
class ParameterAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScopera4fc793dae73\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScopera4fc793dae73\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode
    {
     ...
     */
    public function getType() : \_PhpScopera4fc793dae73\PHPStan\PhpDocParser\Ast\Type\TypeNode
    {
        $this->errorWhenInvalid();
