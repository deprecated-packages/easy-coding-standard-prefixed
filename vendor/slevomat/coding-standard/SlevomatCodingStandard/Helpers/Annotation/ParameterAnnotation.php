...
use _PhpScoperfb2c402b972b\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode;
...
class ParameterAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoperfb2c402b972b\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoperfb2c402b972b\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode
    {
