...
use _PhpScoperb26833cc184d\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode;
...
class MixinAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoperb26833cc184d\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode $contentNode)
    {
        if ($name !== '@mixin') {
    ...
    public function getContentNode() : \_PhpScoperb26833cc184d\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode
    {
