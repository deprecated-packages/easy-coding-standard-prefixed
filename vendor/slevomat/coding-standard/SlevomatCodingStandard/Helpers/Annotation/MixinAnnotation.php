...
use _PhpScopera88a8b9f064a\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode;
...
class MixinAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScopera88a8b9f064a\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode $contentNode)
    {
        if ($name !== '@mixin') {
    ...
    public function getContentNode() : \_PhpScopera88a8b9f064a\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode
    {
