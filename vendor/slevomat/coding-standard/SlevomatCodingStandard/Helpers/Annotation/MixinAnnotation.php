...
use _PhpScoper967d20dce97a\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode;
...
class MixinAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper967d20dce97a\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode $contentNode)
    {
        if ($name !== '@mixin') {
    ...
    public function getContentNode() : \_PhpScoper967d20dce97a\PHPStan\PhpDocParser\Ast\PhpDoc\MixinTagValueNode
    {
