...
use _PhpScoper908feaf49cd8\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode;
...
class UseAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper908feaf49cd8\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper908feaf49cd8\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode
    {
