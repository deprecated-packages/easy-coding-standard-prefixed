...
use _PhpScoper9ef667a5e42c\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode;
...
class UseAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper9ef667a5e42c\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper9ef667a5e42c\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode
    {
