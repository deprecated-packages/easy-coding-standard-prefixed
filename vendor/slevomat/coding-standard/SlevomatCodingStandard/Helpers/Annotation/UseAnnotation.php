...
use _PhpScoperdaf95aff095b\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode;
...
class UseAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoperdaf95aff095b\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoperdaf95aff095b\PHPStan\PhpDocParser\Ast\PhpDoc\UsesTagValueNode
    {
