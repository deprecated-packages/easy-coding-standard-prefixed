...
use _PhpScoperf62d28230928\PHPStan\PhpDocParser\Ast\PhpDoc\TemplateTagValueNode;
...
class TemplateAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoperf62d28230928\PHPStan\PhpDocParser\Ast\PhpDoc\TemplateTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoperf62d28230928\PHPStan\PhpDocParser\Ast\PhpDoc\TemplateTagValueNode
    {
    ...
    public function getBound() : ?\_PhpScoperf62d28230928\PHPStan\PhpDocParser\Ast\Type\TypeNode
    {
        $this->errorWhenInvalid();
