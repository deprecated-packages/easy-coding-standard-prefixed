...
use _PhpScoper6207116d4311\PHPStan\PhpDocParser\Ast\PhpDoc\TemplateTagValueNode;
...
class TemplateAnnotation extends \SlevomatCodingStandard\Helpers\Annotation\Annotation
{
    ...
    private $contentNode;
    public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?\_PhpScoper6207116d4311\PHPStan\PhpDocParser\Ast\PhpDoc\TemplateTagValueNode $contentNode)
    {
    ...
    public function getContentNode() : \_PhpScoper6207116d4311\PHPStan\PhpDocParser\Ast\PhpDoc\TemplateTagValueNode
    {
    ...
    public function getBound() : ?\_PhpScoper6207116d4311\PHPStan\PhpDocParser\Ast\Type\TypeNode
    {
        $this->errorWhenInvalid();
