...
use const _PhpScoperbd5c5a045153\T_CLOSE_PARENTHESIS;
use const _PhpScoperbd5c5a045153\T_CLOSE_SHORT_ARRAY;
use const T_COALESCE;
use const _PhpScoperbd5c5a045153\T_COLON;
...
use const _PhpScoperbd5c5a045153\T_FALSE;
use const _PhpScoperbd5c5a045153\T_INLINE_ELSE;
use const _PhpScoperbd5c5a045153\T_INLINE_THEN;
use const T_INT_CAST;
use const T_LNUMBER;
use const T_LOGICAL_AND;
use const T_LOGICAL_OR;
use const T_LOGICAL_XOR;
use const _PhpScoperbd5c5a045153\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScoperbd5c5a045153\T_NULL;
...
use const _PhpScoperbd5c5a045153\T_PLUS;
use const T_RETURN;
use const _PhpScoperbd5c5a045153\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoperbd5c5a045153\T_TRUE;
