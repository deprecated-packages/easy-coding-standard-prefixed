...
use const _PhpScoper0d0ee1ba46d4\T_COLON;
...
use const _PhpScoper0d0ee1ba46d4\T_FALSE;
use const _PhpScoper0d0ee1ba46d4\T_INLINE_ELSE;
...
use const _PhpScoper0d0ee1ba46d4\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScoper0d0ee1ba46d4\T_NULL;
...
use const _PhpScoper0d0ee1ba46d4\T_PLUS;
use const T_RETURN;
use const _PhpScoper0d0ee1ba46d4\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoper0d0ee1ba46d4\T_TRUE;
