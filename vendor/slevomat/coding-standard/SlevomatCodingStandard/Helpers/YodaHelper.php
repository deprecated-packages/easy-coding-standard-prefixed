...
use const _PhpScoperedc2e0c967db\T_CLOSE_SHORT_ARRAY;
use const T_COALESCE;
use const _PhpScoperedc2e0c967db\T_COLON;
...
use const _PhpScoperedc2e0c967db\T_FALSE;
use const _PhpScoperedc2e0c967db\T_INLINE_ELSE;
...
use const _PhpScoperedc2e0c967db\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScoperedc2e0c967db\T_NULL;
...
use const _PhpScoperedc2e0c967db\T_PLUS;
use const T_RETURN;
use const _PhpScoperedc2e0c967db\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoperedc2e0c967db\T_TRUE;
