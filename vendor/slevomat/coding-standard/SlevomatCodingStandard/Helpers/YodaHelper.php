...
use const _PhpScoperac4e86be08e5\T_COLON;
...
use const _PhpScoperac4e86be08e5\T_FALSE;
...
use const _PhpScoperac4e86be08e5\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScoperac4e86be08e5\T_NULL;
use const T_OBJECT_CAST;
use const _PhpScoperac4e86be08e5\T_OPEN_PARENTHESIS;
use const _PhpScoperac4e86be08e5\T_OPEN_SHORT_ARRAY;
use const T_OPEN_TAG;
use const _PhpScoperac4e86be08e5\T_PLUS;
use const T_RETURN;
use const _PhpScoperac4e86be08e5\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoperac4e86be08e5\T_TRUE;
