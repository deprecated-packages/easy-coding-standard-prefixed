...
use const _PhpScoperc8b83ee8976a\T_CLOSE_SHORT_ARRAY;
use const T_COALESCE;
use const _PhpScoperc8b83ee8976a\T_COLON;
...
use const _PhpScoperc8b83ee8976a\T_FALSE;
use const _PhpScoperc8b83ee8976a\T_INLINE_ELSE;
use const _PhpScoperc8b83ee8976a\T_INLINE_THEN;
use const T_INT_CAST;
use const T_LNUMBER;
use const T_LOGICAL_AND;
use const T_LOGICAL_OR;
use const T_LOGICAL_XOR;
use const _PhpScoperc8b83ee8976a\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScoperc8b83ee8976a\T_NULL;
...
use const _PhpScoperc8b83ee8976a\T_PLUS;
use const T_RETURN;
use const _PhpScoperc8b83ee8976a\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoperc8b83ee8976a\T_TRUE;
