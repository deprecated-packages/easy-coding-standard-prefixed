...
use const _PhpScopera238de2e9b5a\T_COLON;
...
use const _PhpScopera238de2e9b5a\T_FALSE;
...
use const _PhpScopera238de2e9b5a\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScopera238de2e9b5a\T_NULL;
use const T_OBJECT_CAST;
use const _PhpScopera238de2e9b5a\T_OPEN_PARENTHESIS;
use const _PhpScopera238de2e9b5a\T_OPEN_SHORT_ARRAY;
use const T_OPEN_TAG;
use const _PhpScopera238de2e9b5a\T_PLUS;
use const T_RETURN;
use const _PhpScopera238de2e9b5a\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScopera238de2e9b5a\T_TRUE;
