...
use const _PhpScoper3e8786a75afe\T_CLOSE_PARENTHESIS;
use const _PhpScoper3e8786a75afe\T_CLOSE_SHORT_ARRAY;
use const T_COALESCE;
use const _PhpScoper3e8786a75afe\T_COLON;
...
use const _PhpScoper3e8786a75afe\T_FALSE;
use const _PhpScoper3e8786a75afe\T_INLINE_ELSE;
...
use const _PhpScoper3e8786a75afe\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScoper3e8786a75afe\T_NULL;
use const T_OBJECT_CAST;
use const _PhpScoper3e8786a75afe\T_OPEN_PARENTHESIS;
use const _PhpScoper3e8786a75afe\T_OPEN_SHORT_ARRAY;
use const T_OPEN_TAG;
use const _PhpScoper3e8786a75afe\T_PLUS;
use const T_RETURN;
use const _PhpScoper3e8786a75afe\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoper3e8786a75afe\T_TRUE;
