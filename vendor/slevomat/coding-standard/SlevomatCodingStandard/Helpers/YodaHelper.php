...
use const _PhpScoper8e2d8a2760d1\T_CLOSE_SHORT_ARRAY;
use const T_COALESCE;
use const _PhpScoper8e2d8a2760d1\T_COLON;
...
use const _PhpScoper8e2d8a2760d1\T_FALSE;
use const _PhpScoper8e2d8a2760d1\T_INLINE_ELSE;
...
use const _PhpScoper8e2d8a2760d1\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScoper8e2d8a2760d1\T_NULL;
...
use const _PhpScoper8e2d8a2760d1\T_PLUS;
use const T_RETURN;
use const _PhpScoper8e2d8a2760d1\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoper8e2d8a2760d1\T_TRUE;
