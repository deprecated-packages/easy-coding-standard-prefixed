...
use const _PhpScoper2fe14d6302bc\T_CLOSE_SHORT_ARRAY;
use const T_COALESCE;
use const _PhpScoper2fe14d6302bc\T_COLON;
...
use const _PhpScoper2fe14d6302bc\T_FALSE;
use const _PhpScoper2fe14d6302bc\T_INLINE_ELSE;
...
use const _PhpScoper2fe14d6302bc\T_MINUS;
...
use const _PhpScoper2fe14d6302bc\T_PLUS;
use const T_RETURN;
use const _PhpScoper2fe14d6302bc\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoper2fe14d6302bc\T_TRUE;
