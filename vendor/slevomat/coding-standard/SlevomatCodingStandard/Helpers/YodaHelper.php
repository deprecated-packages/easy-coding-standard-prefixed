...
use const _PhpScoper92597f5b42a7\T_CLOSE_SHORT_ARRAY;
use const T_COALESCE;
use const _PhpScoper92597f5b42a7\T_COLON;
...
use const _PhpScoper92597f5b42a7\T_FALSE;
use const _PhpScoper92597f5b42a7\T_INLINE_ELSE;
use const _PhpScoper92597f5b42a7\T_INLINE_THEN;
...
use const _PhpScoper92597f5b42a7\T_NULL;
use const T_OBJECT_CAST;
use const _PhpScoper92597f5b42a7\T_OPEN_PARENTHESIS;
...
use const _PhpScoper92597f5b42a7\T_TRUE;
