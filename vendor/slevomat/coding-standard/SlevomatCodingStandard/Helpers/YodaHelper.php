...
use const _PhpScoperfacc742d2745\T_COLON;
...
use const _PhpScoperfacc742d2745\T_FALSE;
...
use const _PhpScoperfacc742d2745\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScoperfacc742d2745\T_NULL;
use const T_OBJECT_CAST;
use const _PhpScoperfacc742d2745\T_OPEN_PARENTHESIS;
use const _PhpScoperfacc742d2745\T_OPEN_SHORT_ARRAY;
use const T_OPEN_TAG;
use const _PhpScoperfacc742d2745\T_PLUS;
use const T_RETURN;
use const _PhpScoperfacc742d2745\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoperfacc742d2745\T_TRUE;
