...
use const _PhpScoper0f5cd390c37a\T_CLOSE_PARENTHESIS;
use const _PhpScoper0f5cd390c37a\T_CLOSE_SHORT_ARRAY;
use const T_COALESCE;
use const _PhpScoper0f5cd390c37a\T_COLON;
...
use const _PhpScoper0f5cd390c37a\T_FALSE;
use const _PhpScoper0f5cd390c37a\T_INLINE_ELSE;
use const _PhpScoper0f5cd390c37a\T_INLINE_THEN;
use const T_INT_CAST;
use const T_LNUMBER;
use const T_LOGICAL_AND;
use const T_LOGICAL_OR;
use const T_LOGICAL_XOR;
use const _PhpScoper0f5cd390c37a\T_MINUS;
use const T_NS_SEPARATOR;
use const _PhpScoper0f5cd390c37a\T_NULL;
use const T_OBJECT_CAST;
use const _PhpScoper0f5cd390c37a\T_OPEN_PARENTHESIS;
use const _PhpScoper0f5cd390c37a\T_OPEN_SHORT_ARRAY;
use const T_OPEN_TAG;
use const _PhpScoper0f5cd390c37a\T_PLUS;
use const T_RETURN;
use const _PhpScoper0f5cd390c37a\T_SEMICOLON;
use const T_STRING;
use const T_STRING_CAST;
use const _PhpScoper0f5cd390c37a\T_TRUE;
