...
{
    public static function isParameter(\PHP_CodeSniffer\Files\File $phpcsFile, int $variablePointer) : bool
    {
        ...
        return \in_array($tokens[$parenthesisOwnerPointer]['code'], \SlevomatCodingStandard\Helpers\TokenHelper::$functionTokenCodes, \true);
    }
}
