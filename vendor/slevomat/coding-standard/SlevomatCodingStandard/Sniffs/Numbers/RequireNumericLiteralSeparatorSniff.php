...
use const T_DNUMBER;
use const T_LNUMBER;
class RequireNumericLiteralSeparatorSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
     ...
     */
    public function process(\PHP_CodeSniffer\Files\File $phpcsFile, $numberPointer) : void
    {
        ...
        $regexp = '~(?:^\\d{' . \SlevomatCodingStandard\Helpers\SniffSettingsHelper::normalizeInteger($this->minDigitsBeforeDecimalPoint) . '}|\\.\\d{' . \SlevomatCodingStandard\Helpers\SniffSettingsHelper::normalizeInteger($this->minDigitsAfterDecimalPoint) . '})~';
