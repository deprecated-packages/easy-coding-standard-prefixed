...
use const T_LNUMBER;
use const T_SWITCH;
class DisallowContinueWithoutIntegerOperandInSwitchSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
     ...
     */
    public function process(\PHP_CodeSniffer\Files\File $phpcsFile, $continuePointer) : void
    {
        $tokens = $phpcsFile->getTokens();
        $operandPointer = \SlevomatCodingStandard\Helpers\TokenHelper::findNextEffective($phpcsFile, $continuePointer + 1);
