...
use function strlen;
class RequireSingleLineConditionSniff extends \SlevomatCodingStandard\Sniffs\ControlStructures\AbstractLineCondition
{
    public const CODE_REQUIRED_SINGLE_LINE_CONDITION = 'RequiredSingleLineCondition';
    /** @var int */
    public $maxLineLength = 120;
    /** @var bool */
    public $alwaysForSimpleConditions = \true;
    /**
    ...
    public function process(\PHP_CodeSniffer\Files\File $phpcsFile, $controlStructurePointer) : void
    {
        ...
        $isSimpleCondition = \SlevomatCodingStandard\Helpers\TokenHelper::findNext($phpcsFile, \PHP_CodeSniffer\Util\Tokens::$booleanOperators, $parenthesisOpenerPointer + 1, $parenthesisCloserPointer) === null;
