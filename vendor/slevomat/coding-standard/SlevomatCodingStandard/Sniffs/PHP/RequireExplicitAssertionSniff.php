...
class RequireExplicitAssertionSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    public function process(\PHP_CodeSniffer\Files\File $phpcsFile, $docCommentOpenPointer) : void
    {
        ...
        foreach (\array_reverse($variableAnnotations) as $variableAnnotation) {
            ...
            if ($variableAnnotationType instanceof \_PhpScoperbaf90856897c\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode || $variableAnnotationType instanceof \_PhpScoperbaf90856897c\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode) {
    ...
    private function isValidTypeNode(\_PhpScoperbaf90856897c\PHPStan\PhpDocParser\Ast\Type\TypeNode $typeNode) : bool
    {
     ...
     * @return string
     */
    private function createAssert(string $variableName, \_PhpScoperbaf90856897c\PHPStan\PhpDocParser\Ast\Type\TypeNode $typeNode) : string
    {
        $conditions = [];
        if ($typeNode instanceof \_PhpScoperbaf90856897c\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode || $typeNode instanceof \_PhpScoperbaf90856897c\PHPStan\PhpDocParser\Ast\Type\ThisTypeNode) {
        ...
        $operator = $typeNode instanceof \_PhpScoperbaf90856897c\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode ? '&&' : '||';
     ...
     * @return string[]
     */
    private function createConditions(string $variableName, \_PhpScoperbaf90856897c\PHPStan\PhpDocParser\Ast\Type\TypeNode $typeNode) : array
    {
        if ($typeNode instanceof \_PhpScoperbaf90856897c\PHPStan\PhpDocParser\Ast\Type\ThisTypeNode) {
