...
use const _PhpScoperef870243cfdb\T_BITWISE_AND;
use const _PhpScoperef870243cfdb\T_BITWISE_OR;
use const _PhpScoperef870243cfdb\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScoperef870243cfdb\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScoperef870243cfdb\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoperef870243cfdb\T_DOLLAR;
...
use const _PhpScoperef870243cfdb\T_MODULUS;
use const _PhpScoperef870243cfdb\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoperef870243cfdb\T_STRING_CONCAT;
use const T_UNSET;
