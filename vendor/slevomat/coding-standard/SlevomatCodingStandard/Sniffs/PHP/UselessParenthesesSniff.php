...
use const _PhpScopera9d6b451df71\T_BITWISE_OR;
use const _PhpScopera9d6b451df71\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScopera9d6b451df71\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScopera9d6b451df71\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScopera9d6b451df71\T_DOLLAR;
...
use const _PhpScopera9d6b451df71\T_MODULUS;
use const _PhpScopera9d6b451df71\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScopera9d6b451df71\T_STRING_CONCAT;
use const T_UNSET;
