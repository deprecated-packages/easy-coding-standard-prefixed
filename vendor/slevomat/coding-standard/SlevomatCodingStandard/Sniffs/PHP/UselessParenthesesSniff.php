...
use const _PhpScoper4f985154d5a0\T_BITWISE_OR;
use const _PhpScoper4f985154d5a0\T_BITWISE_XOR;
...
use const _PhpScoper4f985154d5a0\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoper4f985154d5a0\T_DOLLAR;
...
use const _PhpScoper4f985154d5a0\T_MODULUS;
use const _PhpScoper4f985154d5a0\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoper4f985154d5a0\T_STRING_CONCAT;
use const T_UNSET;
