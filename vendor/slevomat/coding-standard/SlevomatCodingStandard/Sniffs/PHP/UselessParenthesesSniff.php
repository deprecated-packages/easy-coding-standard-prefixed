...
use const _PhpScoperedc2e0c967db\T_BITWISE_OR;
use const _PhpScoperedc2e0c967db\T_BITWISE_XOR;
...
use const _PhpScoperedc2e0c967db\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoperedc2e0c967db\T_DOLLAR;
...
use const _PhpScoperedc2e0c967db\T_MODULUS;
use const _PhpScoperedc2e0c967db\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoperedc2e0c967db\T_STRING_CONCAT;
use const T_UNSET;
