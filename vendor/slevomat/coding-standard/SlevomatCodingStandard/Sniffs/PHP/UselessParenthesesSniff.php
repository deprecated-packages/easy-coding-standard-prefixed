...
use const _PhpScoperc64a4ac1af35\T_BITWISE_OR;
use const _PhpScoperc64a4ac1af35\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScoperc64a4ac1af35\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScoperc64a4ac1af35\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoperc64a4ac1af35\T_DOLLAR;
...
use const _PhpScoperc64a4ac1af35\T_MODULUS;
use const _PhpScoperc64a4ac1af35\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoperc64a4ac1af35\T_STRING_CONCAT;
use const T_UNSET;
