...
use const _PhpScoperc75fd40d7a6e\T_BITWISE_OR;
use const _PhpScoperc75fd40d7a6e\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScoperc75fd40d7a6e\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScoperc75fd40d7a6e\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoperc75fd40d7a6e\T_DOLLAR;
...
use const _PhpScoperc75fd40d7a6e\T_MODULUS;
use const _PhpScoperc75fd40d7a6e\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoperc75fd40d7a6e\T_STRING_CONCAT;
use const T_UNSET;
