...
use const _PhpScoperfd70a7e8e84f\T_BITWISE_OR;
use const _PhpScoperfd70a7e8e84f\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScoperfd70a7e8e84f\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScoperfd70a7e8e84f\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoperfd70a7e8e84f\T_DOLLAR;
...
use const _PhpScoperfd70a7e8e84f\T_MODULUS;
use const _PhpScoperfd70a7e8e84f\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoperfd70a7e8e84f\T_STRING_CONCAT;
use const T_UNSET;
