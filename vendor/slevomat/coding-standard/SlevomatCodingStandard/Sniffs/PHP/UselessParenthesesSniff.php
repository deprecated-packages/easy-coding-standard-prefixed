...
use const _PhpScoperddde3ba4aebc\T_BITWISE_OR;
use const _PhpScoperddde3ba4aebc\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScoperddde3ba4aebc\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScoperddde3ba4aebc\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoperddde3ba4aebc\T_DOLLAR;
...
use const _PhpScoperddde3ba4aebc\T_MODULUS;
use const _PhpScoperddde3ba4aebc\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoperddde3ba4aebc\T_STRING_CONCAT;
use const T_UNSET;
