...
use const _PhpScoperd301db66c80c\T_BITWISE_OR;
use const _PhpScoperd301db66c80c\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScoperd301db66c80c\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScoperd301db66c80c\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoperd301db66c80c\T_DOLLAR;
...
use const _PhpScoperd301db66c80c\T_MODULUS;
use const _PhpScoperd301db66c80c\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoperd301db66c80c\T_STRING_CONCAT;
use const T_UNSET;
