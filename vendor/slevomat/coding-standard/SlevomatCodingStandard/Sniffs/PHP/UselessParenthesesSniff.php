...
use const _PhpScoper4298f97f3cb3\T_BITWISE_OR;
use const _PhpScoper4298f97f3cb3\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScoper4298f97f3cb3\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScoper4298f97f3cb3\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoper4298f97f3cb3\T_DOLLAR;
...
use const _PhpScoper4298f97f3cb3\T_MODULUS;
use const _PhpScoper4298f97f3cb3\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoper4298f97f3cb3\T_STRING_CONCAT;
use const T_UNSET;
