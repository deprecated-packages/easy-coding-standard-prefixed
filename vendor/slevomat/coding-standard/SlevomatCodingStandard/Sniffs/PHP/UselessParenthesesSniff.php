...
use const _PhpScopera4be459e5e3d\T_BITWISE_OR;
use const _PhpScopera4be459e5e3d\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScopera4be459e5e3d\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScopera4be459e5e3d\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScopera4be459e5e3d\T_DOLLAR;
...
use const _PhpScopera4be459e5e3d\T_MODULUS;
use const _PhpScopera4be459e5e3d\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScopera4be459e5e3d\T_STRING_CONCAT;
use const T_UNSET;
