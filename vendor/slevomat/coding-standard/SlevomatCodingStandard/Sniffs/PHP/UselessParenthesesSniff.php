...
use const _PhpScoperb458b528613f\T_BITWISE_AND;
use const _PhpScoperb458b528613f\T_BITWISE_OR;
use const _PhpScoperb458b528613f\T_BITWISE_XOR;
use const T_BOOL_CAST;
use const _PhpScoperb458b528613f\T_BOOLEAN_NOT;
use const T_CASE;
use const T_CLONE;
...
use const _PhpScoperb458b528613f\T_DIVIDE;
use const T_DNUMBER;
use const _PhpScoperb458b528613f\T_DOLLAR;
...
use const _PhpScoperb458b528613f\T_MODULUS;
use const _PhpScoperb458b528613f\T_MULTIPLY;
use const T_NEW;
...
use const _PhpScoperb458b528613f\T_STRING_CONCAT;
use const T_UNSET;
