...
use const _PhpScoper5cb8aea05893\T_BINARY_CAST;
...
class TypeCastSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    private const INVALID_CASTS = ['binary' => null, 'boolean' => 'bool', 'double' => 'float', 'integer' => 'int', 'real' => 'float', 'unset' => null];
    /**
     * @return array<int, (int|string)>
     */
    public function register() : array
    {
        return [\T_STRING_CAST, \T_BOOL_CAST, \T_DOUBLE_CAST, \T_INT_CAST, \T_UNSET_CAST, \T_BINARY_CAST];
    }
    /**
    ...
    public function process(\PHP_CodeSniffer\Files\File $phpcsFile, $pointer) : void
    {
        ...
        if ($castNameLower === 'binary') {
            ...
            $end = \SlevomatCodingStandard\Helpers\TokenHelper::findNextEffective($phpcsFile, $pointer + 1);
