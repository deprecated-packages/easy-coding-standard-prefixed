...
use const _PhpScoperf62d28230928\T_HEREDOC;
...
class RequireNowdocSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
     ...
     */
    public function process(\PHP_CodeSniffer\Files\File $phpcsFile, $heredocStartPointer) : void
    {
        $tokens = $phpcsFile->getTokens();
        $heredocEndPointer = \SlevomatCodingStandard\Helpers\TokenHelper::findNext($phpcsFile, \T_END_HEREDOC, $heredocStartPointer + 1);
        $heredocContentPointers = \SlevomatCodingStandard\Helpers\TokenHelper::findNextAll($phpcsFile, \T_HEREDOC, $heredocStartPointer + 1, $heredocEndPointer);
