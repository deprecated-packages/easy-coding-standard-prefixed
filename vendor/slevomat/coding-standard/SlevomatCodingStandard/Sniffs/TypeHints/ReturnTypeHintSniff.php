...
class ReturnTypeHintSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    private function checkFunctionTypeHint(\PHP_CodeSniffer\Files\File $phpcsFile, int $functionPointer, ?\SlevomatCodingStandard\Helpers\ReturnTypeHint $returnTypeHint, ?\SlevomatCodingStandard\Helpers\Annotation\ReturnAnnotation $returnAnnotation, array $prefixedReturnAnnotations) : void
    {
        ...
        $isAnnotationReturnTypeVoid = $returnTypeNode instanceof \_PhpScoper629192f0909b\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode && \strtolower($returnTypeNode->name) === 'void';
        ...
        if ($returnTypeNode instanceof \_PhpScoper629192f0909b\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
        ...
        } elseif ($returnTypeNode instanceof \_PhpScoper629192f0909b\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode || $returnTypeNode instanceof \_PhpScoper629192f0909b\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode) {
        ...
        if ($originalReturnTypeNode instanceof \_PhpScoper629192f0909b\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
            $nullableReturnTypeHint = \true;
        }
     ...
     */
    private function getReturnTypeNode(?\SlevomatCodingStandard\Helpers\Annotation\ReturnAnnotation $returnAnnotation) : ?\_PhpScoper629192f0909b\PHPStan\PhpDocParser\Ast\Type\TypeNode
    {
