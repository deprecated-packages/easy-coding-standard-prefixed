...
use _PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode;
use _PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode;
...
use _PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode;
...
class DisallowArrayTypeHintSyntaxSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
                    ...
                    foreach ($this->getArrayTypeNodes($annotationType) as $arrayTypeNode) {
                        ...
                        if ($unionTypeNode !== null) {
                            ...
                            if ($genericIdentifier !== null) {
                                $genericTypeNode = new \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode(new \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode($genericIdentifier), [$this->fixArrayNode($arrayTypeNode->type)]);
                                ...
                                $genericTypeNode = new \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode(new \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode('array'), [$this->fixArrayNode($arrayTypeNode->type)]);
     ...
     */
    public function getArrayTypeNodes(\_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\TypeNode $typeNode) : array
    {
        ...
        foreach ($arrayTypeNodes as $arrayTypeNode) {
            if (!$arrayTypeNode->type instanceof \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode) {
                continue;
            }
    ...
    private function fixArrayNode(\_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\TypeNode $node) : \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\TypeNode
    {
        if (!$node instanceof \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode) {
            return $node;
        }
        return new \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode(new \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode('array'), [$this->fixArrayNode($node->type)]);
    }
    /**
     ...
     */
    private function findUnionTypeThatContainsArrayType(\_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode $arrayTypeNode, array $unionTypeNodes) : ?\_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode
    {
    ...
    private function findGenericIdentifier(\PHP_CodeSniffer\Files\File $phpcsFile, \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\TypeNode $typeNode, \SlevomatCodingStandard\Helpers\Annotation\Annotation $annotation) : ?string
    {
        if (!$typeNode instanceof \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode) {
        ...
        if ($typeNode->types[0] instanceof \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode && $typeNode->types[1] instanceof \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode && $this->isTraversableType(\SlevomatCodingStandard\Helpers\TypeHintHelper::getFullyQualifiedTypeHint($phpcsFile, $annotation->getStartPointer(), $typeNode->types[1]->name))) {
            return $typeNode->types[1]->name;
        }
        if ($typeNode->types[1] instanceof \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode && $typeNode->types[0] instanceof \_PhpScoper9885c8c176c7\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode && $this->isTraversableType(\SlevomatCodingStandard\Helpers\TypeHintHelper::getFullyQualifiedTypeHint($phpcsFile, $annotation->getStartPointer(), $typeNode->types[0]->name))) {
