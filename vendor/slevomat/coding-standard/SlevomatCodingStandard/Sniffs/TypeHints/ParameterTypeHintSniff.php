...
use _PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode;
use _PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode;
use _PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\CallableTypeNode;
use _PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\ConstTypeNode;
...
use _PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode;
use _PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode;
use _PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\ThisTypeNode;
...
use const _PhpScoperc8fea59b0cb1\T_BITWISE_AND;
...
class ParameterTypeHintSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    private function checkTypeHints(\PHP_CodeSniffer\Files\File $phpcsFile, int $functionPointer, array $parametersTypeHints, array $parametersAnnotations, array $prefixedParametersAnnotations) : void
    {
        ...
        foreach ($parametersWithoutTypeHint as $parameterName) {
            ...
            if ($parameterTypeNode instanceof \_PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode && \strtolower($parameterTypeNode->name) === 'null') {
                continue;
            }
            $originalParameterTypeNode = $parameterTypeNode;
            if ($parameterTypeNode instanceof \_PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
            ...
            if (\SlevomatCodingStandard\Helpers\AnnotationTypeHelper::containsOneType($parameterTypeNode)) {
            ...
            } elseif ($parameterTypeNode instanceof \_PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode || $parameterTypeNode instanceof \_PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode) {
                ...
                foreach ($parameterTypeNode->types as $typeNode) {
                    ...
                    if (!$typeNode instanceof \_PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode && !$typeNode instanceof \_PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode && $isTraversable) {
            ...
            if ($originalParameterTypeNode instanceof \_PhpScoperc8fea59b0cb1\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
                $nullableParameterTypeHint = \true;
            }
