...
class ParameterTypeHintSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    private function checkTypeHints(\PHP_CodeSniffer\Files\File $phpcsFile, int $functionPointer, array $parametersTypeHints, array $parametersAnnotations, array $prefixedParametersAnnotations) : void
    {
        ...
        foreach ($parametersWithoutTypeHint as $parameterName) {
            ...
            if ($parameterTypeNode instanceof \_PhpScoper39d23eef9a06\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode && \strtolower($parameterTypeNode->name) === 'null') {
                continue;
            }
            $originalParameterTypeNode = $parameterTypeNode;
            if ($parameterTypeNode instanceof \_PhpScoper39d23eef9a06\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
            ...
            } elseif ($parameterTypeNode instanceof \_PhpScoper39d23eef9a06\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode || $parameterTypeNode instanceof \_PhpScoper39d23eef9a06\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode) {
            ...
            if ($originalParameterTypeNode instanceof \_PhpScoper39d23eef9a06\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
                $nullableParameterTypeHint = \true;
            }
