...
use _PhpScoperbc5235eb86f3\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode;
...
use _PhpScoperbc5235eb86f3\PHPStan\PhpDocParser\Ast\Type\ConstTypeNode;
...
use const _PhpScoperbc5235eb86f3\T_BITWISE_AND;
...
class ParameterTypeHintSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    private function checkTypeHints(\PHP_CodeSniffer\Files\File $phpcsFile, int $functionPointer, array $parametersTypeHints, array $parametersAnnotations, array $prefixedParametersAnnotations) : void
    {
        ...
        foreach ($parametersWithoutTypeHint as $parameterName) {
            ...
            if ($parameterTypeNode instanceof \_PhpScoperbc5235eb86f3\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode && \strtolower($parameterTypeNode->name) === 'null') {
                continue;
            }
            $originalParameterTypeNode = $parameterTypeNode;
            if ($parameterTypeNode instanceof \_PhpScoperbc5235eb86f3\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
            ...
            if (\SlevomatCodingStandard\Helpers\AnnotationTypeHelper::containsOneType($parameterTypeNode)) {
            ...
            } elseif ($parameterTypeNode instanceof \_PhpScoperbc5235eb86f3\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode || $parameterTypeNode instanceof \_PhpScoperbc5235eb86f3\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode) {
                ...
                foreach ($parameterTypeNode->types as $typeNode) {
                    ...
                    if (!$typeNode instanceof \_PhpScoperbc5235eb86f3\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode && !$typeNode instanceof \_PhpScoperbc5235eb86f3\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode && $isTraversable) {
            ...
            if ($originalParameterTypeNode instanceof \_PhpScoperbc5235eb86f3\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
                $nullableParameterTypeHint = \true;
            }
