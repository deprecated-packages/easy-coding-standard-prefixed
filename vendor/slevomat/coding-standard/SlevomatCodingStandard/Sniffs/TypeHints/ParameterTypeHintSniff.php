...
use _PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode;
use _PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode;
use _PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\CallableTypeNode;
use _PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\ConstTypeNode;
...
use _PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode;
use _PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode;
use _PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\ThisTypeNode;
...
class ParameterTypeHintSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    private function checkTypeHints(\PHP_CodeSniffer\Files\File $phpcsFile, int $functionPointer, array $parametersTypeHints, array $parametersAnnotations, array $prefixedParametersAnnotations) : void
    {
        ...
        foreach ($parametersWithoutTypeHint as $parameterName) {
            ...
            if ($parameterTypeNode instanceof \_PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode && \strtolower($parameterTypeNode->name) === 'null') {
                continue;
            }
            $originalParameterTypeNode = $parameterTypeNode;
            if ($parameterTypeNode instanceof \_PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
            ...
            if (\SlevomatCodingStandard\Helpers\AnnotationTypeHelper::containsOneType($parameterTypeNode)) {
            ...
            } elseif ($parameterTypeNode instanceof \_PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode || $parameterTypeNode instanceof \_PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode) {
                ...
                foreach ($parameterTypeNode->types as $typeNode) {
                    ...
                    if (!$typeNode instanceof \_PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode && !$typeNode instanceof \_PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode && $isTraversable) {
            ...
            if ($originalParameterTypeNode instanceof \_PhpScoperca8ca183ac38\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
                $nullableParameterTypeHint = \true;
            }
