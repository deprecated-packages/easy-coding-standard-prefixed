...
use _PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode;
use _PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode;
use _PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\CallableTypeNode;
use _PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\ConstTypeNode;
...
use _PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode;
use _PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode;
use _PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\ThisTypeNode;
...
use const _PhpScoper5ea36b274140\T_BITWISE_AND;
...
class ParameterTypeHintSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    private function checkTypeHints(\PHP_CodeSniffer\Files\File $phpcsFile, int $functionPointer, array $parametersTypeHints, array $parametersAnnotations, array $prefixedParametersAnnotations) : void
    {
        ...
        foreach ($parametersWithoutTypeHint as $parameterName) {
            ...
            if ($parameterTypeNode instanceof \_PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode && \strtolower($parameterTypeNode->name) === 'null') {
                continue;
            }
            $originalParameterTypeNode = $parameterTypeNode;
            if ($parameterTypeNode instanceof \_PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
            ...
            if (\SlevomatCodingStandard\Helpers\AnnotationTypeHelper::containsOneType($parameterTypeNode)) {
            ...
            } elseif ($parameterTypeNode instanceof \_PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode || $parameterTypeNode instanceof \_PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode) {
                ...
                foreach ($parameterTypeNode->types as $typeNode) {
                    ...
                    if (!$typeNode instanceof \_PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode && !$typeNode instanceof \_PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode && $isTraversable) {
            ...
            if ($originalParameterTypeNode instanceof \_PhpScoper5ea36b274140\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
                $nullableParameterTypeHint = \true;
            }
