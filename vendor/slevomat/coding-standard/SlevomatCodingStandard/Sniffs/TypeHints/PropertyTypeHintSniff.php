...
class PropertyTypeHintSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
    ...
    private function checkTypeHint(\PHP_CodeSniffer\Files\File $phpcsFile, int $propertyPointer, ?\SlevomatCodingStandard\Helpers\PropertyTypeHint $propertyTypeHint, ?\SlevomatCodingStandard\Helpers\Annotation\VariableAnnotation $propertyAnnotation, array $prefixedPropertyAnnotations) : void
    {
        ...
        if (\SlevomatCodingStandard\Helpers\AnnotationTypeHelper::containsOneType($typeNode)) {
        ...
        } elseif ($typeNode instanceof \_PhpScoperecb978830f1e\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode || $typeNode instanceof \_PhpScoperecb978830f1e\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode) {
            ...
            foreach ($typeNode->types as $innerTypeNode) {
                ...
                if (!$innerTypeNode instanceof \_PhpScoperecb978830f1e\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode && !$innerTypeNode instanceof \_PhpScoperecb978830f1e\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode && $isTraversable) {
        ...
        if ($originalTypeNode instanceof \_PhpScoperecb978830f1e\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode) {
            $nullableTypeHint = \true;
        }
