...
use function uasort;
use function usort;
use const _PhpScoperfabf55fef6b7\T_DOC_COMMENT_OPEN_TAG;
use const _PhpScoperfabf55fef6b7\T_DOC_COMMENT_STAR;
use const _PhpScoperfabf55fef6b7\T_DOC_COMMENT_STRING;
use const _PhpScoperfabf55fef6b7\T_DOC_COMMENT_WHITESPACE;
