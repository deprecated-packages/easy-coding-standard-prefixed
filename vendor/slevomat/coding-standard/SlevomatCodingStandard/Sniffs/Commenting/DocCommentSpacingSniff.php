...
use function uasort;
use function usort;
use const _PhpScoper5a9febfbbe05\T_DOC_COMMENT_OPEN_TAG;
use const _PhpScoper5a9febfbbe05\T_DOC_COMMENT_STAR;
use const _PhpScoper5a9febfbbe05\T_DOC_COMMENT_STRING;
use const _PhpScoper5a9febfbbe05\T_DOC_COMMENT_WHITESPACE;
