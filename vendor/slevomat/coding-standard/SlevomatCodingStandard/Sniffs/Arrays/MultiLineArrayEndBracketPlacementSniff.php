...
class MultiLineArrayEndBracketPlacementSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
     ...
     */
    public function process(\PHP_CodeSniffer\Files\File $phpcsFile, $arrayStart) : void
    {
        ...
        $nextArrayStart = \SlevomatCodingStandard\Helpers\TokenHelper::findNextEffective($phpcsFile, $arrayStart + 1, $arrayEnd);
