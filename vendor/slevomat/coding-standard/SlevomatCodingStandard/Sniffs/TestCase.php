 ...
 * @codeCoverageIgnore
 */
abstract class TestCase extends \_PhpScoper9ef667a5e42c\PHPUnit\Framework\TestCase
{
    /**
    ...
    protected static function assertAllFixedInFile(\PHP_CodeSniffer\Files\File $phpcsFile) : void
    {
        ...
        self::assertStringEqualsFile(\preg_replace('~(\\.php)$~', '_PhpScoper9ef667a5e42c\\.fixed\\1', $phpcsFile->getFilename()), $phpcsFile->fixer->getContents());
    }
