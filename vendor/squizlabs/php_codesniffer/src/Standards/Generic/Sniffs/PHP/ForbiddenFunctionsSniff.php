...
class ForbiddenFunctionsSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
     ...
     */
    public $forbiddenFunctions = ['sizeof' => 'count', 'delete' => 'unset'];
    /**
    ...
    public function process(\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $ignore = [\T_DOUBLE_COLON => \true, \T_OBJECT_OPERATOR => \true, \T_FUNCTION => \true, \T_CONST => \true, \T_PUBLIC => \true, \T_PRIVATE => \true, \T_PROTECTED => \true, \T_AS => \true, \T_NEW => \true, \T_INSTEADOF => \true, \T_NS_SEPARATOR => \true, \T_IMPLEMENTS => \true];
        ...
        if ($tokens[$prevToken]['code'] === \T_NS_SEPARATOR) {
            $prevToken = $phpcsFile->findPrevious(\T_WHITESPACE, $prevToken - 1, null, \true);
