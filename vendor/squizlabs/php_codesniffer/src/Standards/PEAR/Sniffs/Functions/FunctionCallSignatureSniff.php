...
class FunctionCallSignatureSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
     ...
     * @var boolean
     */
    public $allowMultipleArguments = \true;
    /**
    ...
    public function process(\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($this->isMultiLineCall($phpcsFile, $stackPtr, $openBracket, $tokens) === \true) {
    ...
    public function processSingleLineCall(\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $openBracket, $tokens)
    {
        ...
        $next = $phpcsFile->findNext(\T_WHITESPACE, $openBracket + 1, $closer, \true);
        if ($next === \false) {
        ...
        if ($requiredSpacesAfterOpen === 0 && $tokens[$openBracket + 1]['code'] === \T_WHITESPACE) {
            ...
            if ($requiredSpacesAfterOpen > 0) {
                ...
                if ($spaceAfterOpen !== $requiredSpacesAfterOpen) {
                    ...
                    $data = [$requiredSpacesAfterOpen, $spaceAfterOpen];
            ...
            if ($fix === \true) {
                ...
                if ($spaceBeforeClose === 0) {
                    ...
                    if ($spaceBeforeClose === 'newline') {
                        ...
                        $prevNonWhitespace = $phpcsFile->findPrevious(\T_WHITESPACE, $closer - 1, null, \true);
    ...
    public function processMultiLineCall(\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $openBracket, $tokens)
    {
        ...
        if ($tokens[$next]['line'] === $tokens[$openBracket]['line']) {
            ...
            if ($fix === \true) {
                $phpcsFile->fixer->addContent($openBracket, $phpcsFile->eolChar . \str_repeat(' ', $foundFunctionIndent + $this->indent));
            }
        }
        $closeBracket = $tokens[$openBracket]['parenthesis_closer'];
        ...
        if ($tokens[$prev]['line'] === $tokens[$closeBracket]['line']) {
            ...
            if ($fix === \true) {
                $phpcsFile->fixer->addContentBefore($closeBracket, $phpcsFile->eolChar . \str_repeat(' ', $foundFunctionIndent + $this->indent));
            }
        }
        ...
        $i = $phpcsFile->findNext(\T_WHITESPACE, $openBracket + 1, null, \true);
            ...
            if ($tokens[$i]['line'] !== $lastLine) {
                ...
                if ($tokens[$i]['line'] !== $tokens[$openBracket]['line']) {
                    ...
                    if ($tokens[$i]['code'] === \T_WHITESPACE) {
                        $nextCode = $phpcsFile->findNext(\T_WHITESPACE, $i + 1, $closeBracket + 1, \true);
                    ...
                    if ($foundIndent < $expectedIndent || $inArg === \false && $expectedIndent !== $foundIndent) {
                        ...
                        if ($fix === \true) {
                            ...
                            if ($foundIndent === 0) {
                                ...
                                if (isset($tokens[$i + 1]['scope_opener']) === \true) {
                ...
                if ($this->allowMultipleArguments === \false) {
                    ...
                    if ($tokens[$i]['line'] === $tokens[$next]['line']) {
                        ...
                        if ($fix === \true) {
                            ...
                            $phpcsFile->fixer->addContentBefore($next, $phpcsFile->eolChar . \str_repeat(' ', $foundFunctionIndent + $this->indent));
                            $phpcsFile->fixer->endChangeset();
                        }
                    }
                }
