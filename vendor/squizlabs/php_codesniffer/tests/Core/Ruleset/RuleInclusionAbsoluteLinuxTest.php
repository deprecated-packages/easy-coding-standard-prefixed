...
class RuleInclusionAbsoluteLinuxTest extends \_PhpScoper64e7ad844899\PHPUnit\Framework\TestCase
{
    /**
     * The Ruleset object.
     *
    ...
    public function testLinuxStylePathRuleInclusion()
    {
        ...
        $this->assertSame('PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterNotSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterNot']);
