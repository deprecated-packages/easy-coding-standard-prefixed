...
class RuleInclusionAbsoluteWindowsTest extends \_PhpScoper86aa49a51982\PHPUnit\Framework\TestCase
{
    /**
     * The Ruleset object.
     *
    ...
    public function setUp()
    {
        ...
        $config = new \PHP_CodeSniffer\Config(["--standard={$this->standard}"]);
        $this->ruleset = new \PHP_CodeSniffer\Ruleset($config);
    }
    //end setUp()
    /**
     * Reset ruleset file.
