...
class DefaultKeywordTest extends AbstractMethodUnitTest
{
    ...
    {
        return ['simple_match_default' => ['/* testSimpleMatchDefault */'], 'match_default_in_switch_case_1' => ['/* testMatchDefaultNestedInSwitchCase1 */'], 'match_default_in_switch_case_2' => ['/* testMatchDefaultNestedInSwitchCase2 */'], 'match_default_in_switch_default' => ['/* testMatchDefaultNestedInSwitchDefault */'], 'match_default_containing_switch' => ['/* testMatchDefault */'], 'match_default_with_nested_long_array_and_default_key' => ['/* testMatchDefaultWithNestedLongArrayWithClassConstantKey */', 'DEFAULT'], 'match_default_with_nested_long_array_and_default_key_2' => ['/* testMatchDefaultWithNestedLongArrayWithClassConstantKeyLevelDown */', 'DEFAULT'], 'match_default_with_nested_short_array_and_default_key' => ['/* testMatchDefaultWithNestedShortArrayWithClassConstantKey */', 'DEFAULT'], 'match_default_with_nested_short_array_and_default_key_2' => ['/* testMatchDefaultWithNestedShortArrayWithClassConstantKeyLevelDown */', 'DEFAULT'], 'match_default_in_long_array' => ['/* testMatchDefaultNestedInLongArray */', 'DEFAULT'], 'match_default_in_short_array' => ['/* testMatchDefaultNestedInShortArray */', 'DEFAULT']];
    }
    ...
    {
        return ['simple_switch_default' => ['/* testSimpleSwitchDefault */', 1, 4], 'simple_switch_default_with_curlies' => [
            ...
            12,
            6,
        ], 'switch_default_toplevel' => ['/* testSwitchDefault */', 1, 43], 'switch_default_nested_in_match_case' => ['/* testSwitchDefaultNestedInMatchCase */', 1, 20], 'switch_default_nested_in_match_default' => ['/* testSwitchDefaultNestedInMatchDefault */', 1, 18]];
    }
