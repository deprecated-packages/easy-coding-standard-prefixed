...
use _PhpScoper967c4b7e296e\PHPUnit\TextUI\TestRunner;
use _PhpScoper967c4b7e296e\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper967c4b7e296e\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper967c4b7e296e\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
