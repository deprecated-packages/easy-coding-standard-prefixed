...
use _PhpScoper2a48669dad72\PHPUnit\TextUI\TestRunner;
use _PhpScoper2a48669dad72\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper2a48669dad72\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper2a48669dad72\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
