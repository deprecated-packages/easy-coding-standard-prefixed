...
use _PhpScoper7145e5e87de5\PHPUnit\TextUI\TestRunner;
use _PhpScoper7145e5e87de5\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper7145e5e87de5\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper7145e5e87de5\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
