...
use _PhpScoper2fe14d6302bc\PHPUnit\TextUI\TestRunner;
use _PhpScoper2fe14d6302bc\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper2fe14d6302bc\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper2fe14d6302bc\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
