...
use _PhpScoper797695bcfb1f\PHPUnit\TextUI\TestRunner;
use _PhpScoper797695bcfb1f\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper797695bcfb1f\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper797695bcfb1f\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
