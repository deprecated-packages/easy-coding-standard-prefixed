...
use _PhpScoperaba240c3d5f1\PHPUnit\TextUI\TestRunner;
use _PhpScoperaba240c3d5f1\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperaba240c3d5f1\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperaba240c3d5f1\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
