...
use _PhpScoper59da9ac954a6\PHPUnit\TextUI\TestRunner;
use _PhpScoper59da9ac954a6\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper59da9ac954a6\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper59da9ac954a6\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
