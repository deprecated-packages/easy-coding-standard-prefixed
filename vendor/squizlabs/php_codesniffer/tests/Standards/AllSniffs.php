...
use _PhpScoper6dbb854503f8\PHPUnit\TextUI\TestRunner;
use _PhpScoper6dbb854503f8\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper6dbb854503f8\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper6dbb854503f8\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
