...
use _PhpScoper35ec99c463ee\PHPUnit\TextUI\TestRunner;
use _PhpScoper35ec99c463ee\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper35ec99c463ee\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper35ec99c463ee\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
