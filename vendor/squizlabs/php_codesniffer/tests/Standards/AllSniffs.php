...
use _PhpScoper68a3a2539032\PHPUnit\TextUI\TestRunner;
use _PhpScoper68a3a2539032\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper68a3a2539032\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper68a3a2539032\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
