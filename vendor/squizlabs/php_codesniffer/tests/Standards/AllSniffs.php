...
use _PhpScoperab9510cd5d97\PHPUnit\TextUI\TestRunner;
use _PhpScoperab9510cd5d97\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperab9510cd5d97\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperab9510cd5d97\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
