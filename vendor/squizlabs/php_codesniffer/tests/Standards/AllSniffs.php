...
use _PhpScoperb09c3ec8e01a\PHPUnit\TextUI\TestRunner;
use _PhpScoperb09c3ec8e01a\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperb09c3ec8e01a\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperb09c3ec8e01a\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
