...
use _PhpScoper8db4616aa69d\PHPUnit\TextUI\TestRunner;
use _PhpScoper8db4616aa69d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper8db4616aa69d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper8db4616aa69d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
