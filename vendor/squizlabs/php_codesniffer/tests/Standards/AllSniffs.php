...
use _PhpScoperd301db66c80c\PHPUnit\TextUI\TestRunner;
use _PhpScoperd301db66c80c\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperd301db66c80c\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperd301db66c80c\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
