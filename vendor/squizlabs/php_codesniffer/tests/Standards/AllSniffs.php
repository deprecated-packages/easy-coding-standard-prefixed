...
use _PhpScoperd4937ee9b515\PHPUnit\TextUI\TestRunner;
use _PhpScoperd4937ee9b515\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperd4937ee9b515\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperd4937ee9b515\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
