...
use _PhpScoper246d7c16d32f\PHPUnit\TextUI\TestRunner;
use _PhpScoper246d7c16d32f\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper246d7c16d32f\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper246d7c16d32f\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
