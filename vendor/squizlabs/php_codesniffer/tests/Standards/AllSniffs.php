...
use _PhpScoperf3d5f0921050\PHPUnit\TextUI\TestRunner;
use _PhpScoperf3d5f0921050\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperf3d5f0921050\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperf3d5f0921050\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
