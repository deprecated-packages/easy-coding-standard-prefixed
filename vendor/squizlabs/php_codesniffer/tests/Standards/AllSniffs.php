...
use _PhpScoper4e2df00556a9\PHPUnit\TextUI\TestRunner;
use _PhpScoper4e2df00556a9\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper4e2df00556a9\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper4e2df00556a9\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
