...
use _PhpScoperc7096eb2567d\PHPUnit\TextUI\TestRunner;
use _PhpScoperc7096eb2567d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc7096eb2567d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc7096eb2567d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
