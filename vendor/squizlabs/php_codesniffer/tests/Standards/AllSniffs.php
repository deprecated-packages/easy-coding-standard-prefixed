...
use _PhpScoperac4e86be08e5\PHPUnit\TextUI\TestRunner;
use _PhpScoperac4e86be08e5\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperac4e86be08e5\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperac4e86be08e5\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
