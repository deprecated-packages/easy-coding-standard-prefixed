...
use _PhpScoper246d3630afdd\PHPUnit\TextUI\TestRunner;
use _PhpScoper246d3630afdd\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper246d3630afdd\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper246d3630afdd\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
