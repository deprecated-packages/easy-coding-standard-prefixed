...
use _PhpScoper06c66bea2cf6\PHPUnit\TextUI\TestRunner;
use _PhpScoper06c66bea2cf6\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper06c66bea2cf6\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper06c66bea2cf6\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
