...
use _PhpScoper6b644dbe715d\PHPUnit\TextUI\TestRunner;
use _PhpScoper6b644dbe715d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper6b644dbe715d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper6b644dbe715d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
