...
use _PhpScoper9ef667a5e42c\PHPUnit\TextUI\TestRunner;
use _PhpScoper9ef667a5e42c\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper9ef667a5e42c\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper9ef667a5e42c\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
