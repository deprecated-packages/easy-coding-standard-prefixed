...
use _PhpScoper2d2a405cc0f8\PHPUnit\TextUI\TestRunner;
use _PhpScoper2d2a405cc0f8\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper2d2a405cc0f8\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper2d2a405cc0f8\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
