...
use _PhpScoper5465fda93cc7\PHPUnit\TextUI\TestRunner;
use _PhpScoper5465fda93cc7\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper5465fda93cc7\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper5465fda93cc7\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
