...
use _PhpScoper4298f97f3cb3\PHPUnit\TextUI\TestRunner;
use _PhpScoper4298f97f3cb3\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper4298f97f3cb3\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper4298f97f3cb3\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
