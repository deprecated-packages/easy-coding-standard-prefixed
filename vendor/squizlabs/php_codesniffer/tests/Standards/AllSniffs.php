...
use _PhpScoper5cb8aea05893\PHPUnit\TextUI\TestRunner;
use _PhpScoper5cb8aea05893\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper5cb8aea05893\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper5cb8aea05893\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
