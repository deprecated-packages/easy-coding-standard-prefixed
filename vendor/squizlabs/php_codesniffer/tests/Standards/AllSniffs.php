...
use _PhpScoper269dc521b0fa\PHPUnit\TextUI\TestRunner;
use _PhpScoper269dc521b0fa\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper269dc521b0fa\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper269dc521b0fa\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
