...
use _PhpScoper21763e6c7ac4\PHPUnit\TextUI\TestRunner;
use _PhpScoper21763e6c7ac4\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper21763e6c7ac4\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper21763e6c7ac4\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
