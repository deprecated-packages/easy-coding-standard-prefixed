...
use _PhpScoper065e4ba46e6d\PHPUnit\TextUI\TestRunner;
use _PhpScoper065e4ba46e6d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper065e4ba46e6d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper065e4ba46e6d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
