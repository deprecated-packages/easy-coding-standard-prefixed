...
use _PhpScoper18bd934c069f\PHPUnit\TextUI\TestRunner;
use _PhpScoper18bd934c069f\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper18bd934c069f\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper18bd934c069f\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
