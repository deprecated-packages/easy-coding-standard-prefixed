...
use _PhpScoperf3f1be0d8a30\PHPUnit\TextUI\TestRunner;
use _PhpScoperf3f1be0d8a30\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperf3f1be0d8a30\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperf3f1be0d8a30\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
