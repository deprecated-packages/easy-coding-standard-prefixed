...
use _PhpScoper5a9febfbbe05\PHPUnit\TextUI\TestRunner;
use _PhpScoper5a9febfbbe05\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper5a9febfbbe05\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper5a9febfbbe05\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
