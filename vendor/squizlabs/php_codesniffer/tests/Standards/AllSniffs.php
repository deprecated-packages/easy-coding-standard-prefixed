...
use _PhpScoperca8ca183ac38\PHPUnit\TextUI\TestRunner;
use _PhpScoperca8ca183ac38\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperca8ca183ac38\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperca8ca183ac38\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
