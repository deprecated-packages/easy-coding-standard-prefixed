...
use _PhpScoper57272265e1c9\PHPUnit\TextUI\TestRunner;
use _PhpScoper57272265e1c9\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper57272265e1c9\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper57272265e1c9\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
