...
use _PhpScoper21fff473f90a\PHPUnit\TextUI\TestRunner;
use _PhpScoper21fff473f90a\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper21fff473f90a\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper21fff473f90a\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
