...
use _PhpScoperc5bee3a837bb\PHPUnit\TextUI\TestRunner;
use _PhpScoperc5bee3a837bb\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc5bee3a837bb\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc5bee3a837bb\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
