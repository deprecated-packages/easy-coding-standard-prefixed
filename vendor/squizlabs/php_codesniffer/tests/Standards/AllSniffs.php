...
use _PhpScoperfab1bfb7ec99\PHPUnit\TextUI\TestRunner;
use _PhpScoperfab1bfb7ec99\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperfab1bfb7ec99\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperfab1bfb7ec99\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
