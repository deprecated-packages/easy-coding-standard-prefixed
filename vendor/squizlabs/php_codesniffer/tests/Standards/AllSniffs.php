...
use _PhpScoperd79d87c3336e\PHPUnit\TextUI\TestRunner;
use _PhpScoperd79d87c3336e\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperd79d87c3336e\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperd79d87c3336e\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
