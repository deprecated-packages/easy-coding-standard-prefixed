...
use _PhpScoper4a718ec9156e\PHPUnit\TextUI\TestRunner;
use _PhpScoper4a718ec9156e\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper4a718ec9156e\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper4a718ec9156e\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
