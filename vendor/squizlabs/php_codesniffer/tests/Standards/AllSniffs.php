...
use _PhpScoper78af57a363a0\PHPUnit\TextUI\TestRunner;
use _PhpScoper78af57a363a0\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper78af57a363a0\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper78af57a363a0\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
