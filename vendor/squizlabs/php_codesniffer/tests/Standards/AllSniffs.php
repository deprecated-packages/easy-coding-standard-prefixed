...
use _PhpScoper3e7ab659bd82\PHPUnit\TextUI\TestRunner;
use _PhpScoper3e7ab659bd82\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper3e7ab659bd82\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper3e7ab659bd82\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
