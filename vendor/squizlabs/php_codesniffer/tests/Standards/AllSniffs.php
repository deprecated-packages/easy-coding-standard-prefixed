...
use _PhpScoperfabf55fef6b7\PHPUnit\TextUI\TestRunner;
use _PhpScoperfabf55fef6b7\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperfabf55fef6b7\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperfabf55fef6b7\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
