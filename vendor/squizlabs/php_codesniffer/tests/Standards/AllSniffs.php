...
use _PhpScoperb730595bc9f4\PHPUnit\TextUI\TestRunner;
use _PhpScoperb730595bc9f4\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperb730595bc9f4\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperb730595bc9f4\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
