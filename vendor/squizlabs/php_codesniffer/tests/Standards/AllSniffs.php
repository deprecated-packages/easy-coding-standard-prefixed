...
use _PhpScoper8163b0b2b8f3\PHPUnit\TextUI\TestRunner;
use _PhpScoper8163b0b2b8f3\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper8163b0b2b8f3\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper8163b0b2b8f3\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
