...
use _PhpScoper2f04ef4e8878\PHPUnit\TextUI\TestRunner;
use _PhpScoper2f04ef4e8878\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper2f04ef4e8878\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper2f04ef4e8878\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
