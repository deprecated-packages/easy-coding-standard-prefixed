...
use _PhpScoper7d3888cf4297\PHPUnit\TextUI\TestRunner;
use _PhpScoper7d3888cf4297\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper7d3888cf4297\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper7d3888cf4297\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
