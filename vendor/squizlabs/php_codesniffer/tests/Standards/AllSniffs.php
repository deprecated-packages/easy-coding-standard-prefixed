...
use _PhpScoperd3d57724c802\PHPUnit\TextUI\TestRunner;
use _PhpScoperd3d57724c802\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperd3d57724c802\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperd3d57724c802\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
