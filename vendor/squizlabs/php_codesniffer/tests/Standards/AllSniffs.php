...
use _PhpScoper776637f3d3c3\PHPUnit\TextUI\TestRunner;
use _PhpScoper776637f3d3c3\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper776637f3d3c3\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper776637f3d3c3\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
