...
use _PhpScoper86aebf8cf357\PHPUnit\TextUI\TestRunner;
use _PhpScoper86aebf8cf357\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper86aebf8cf357\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper86aebf8cf357\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
