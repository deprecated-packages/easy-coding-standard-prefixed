...
use _PhpScopera51a90153f58\PHPUnit\TextUI\TestRunner;
use _PhpScopera51a90153f58\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopera51a90153f58\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopera51a90153f58\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
