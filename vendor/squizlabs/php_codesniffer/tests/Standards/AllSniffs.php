...
use _PhpScoper9acecd3612c5\PHPUnit\TextUI\TestRunner;
use _PhpScoper9acecd3612c5\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper9acecd3612c5\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper9acecd3612c5\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
