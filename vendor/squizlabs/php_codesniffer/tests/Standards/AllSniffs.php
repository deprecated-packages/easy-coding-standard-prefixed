...
use _PhpScoperc75fd40d7a6e\PHPUnit\TextUI\TestRunner;
use _PhpScoperc75fd40d7a6e\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc75fd40d7a6e\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc75fd40d7a6e\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
