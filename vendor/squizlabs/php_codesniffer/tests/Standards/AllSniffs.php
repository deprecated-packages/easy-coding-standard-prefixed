...
use _PhpScoperddde3ba4aebc\PHPUnit\TextUI\TestRunner;
use _PhpScoperddde3ba4aebc\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperddde3ba4aebc\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperddde3ba4aebc\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
