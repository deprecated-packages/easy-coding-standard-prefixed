...
use _PhpScoperb6ccec8ab642\PHPUnit\TextUI\TestRunner;
use _PhpScoperb6ccec8ab642\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperb6ccec8ab642\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperb6ccec8ab642\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
