...
use _PhpScoperd4c5032f0671\PHPUnit\TextUI\TestRunner;
use _PhpScoperd4c5032f0671\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperd4c5032f0671\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperd4c5032f0671\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
