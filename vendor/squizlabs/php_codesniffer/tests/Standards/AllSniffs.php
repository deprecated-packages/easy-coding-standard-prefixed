...
use _PhpScoper92597f5b42a7\PHPUnit\TextUI\TestRunner;
use _PhpScoper92597f5b42a7\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper92597f5b42a7\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper92597f5b42a7\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
