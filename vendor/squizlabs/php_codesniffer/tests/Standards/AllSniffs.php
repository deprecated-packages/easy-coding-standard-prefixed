...
use _PhpScoper0b185984cfb7\PHPUnit\TextUI\TestRunner;
use _PhpScoper0b185984cfb7\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper0b185984cfb7\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper0b185984cfb7\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
