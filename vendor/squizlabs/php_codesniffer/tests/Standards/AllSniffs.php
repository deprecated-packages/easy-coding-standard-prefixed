...
use _PhpScoperda2604e33acb\PHPUnit\TextUI\TestRunner;
use _PhpScoperda2604e33acb\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperda2604e33acb\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperda2604e33acb\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
