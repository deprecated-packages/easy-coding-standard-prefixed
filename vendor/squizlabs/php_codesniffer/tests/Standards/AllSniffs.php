...
use _PhpScoper528afa732cbd\PHPUnit\TextUI\TestRunner;
use _PhpScoper528afa732cbd\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper528afa732cbd\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper528afa732cbd\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
