...
use _PhpScoper2f75f00bf6fa\PHPUnit\TextUI\TestRunner;
use _PhpScoper2f75f00bf6fa\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper2f75f00bf6fa\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper2f75f00bf6fa\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
