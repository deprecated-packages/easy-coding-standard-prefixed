...
use _PhpScoper60081b922775\PHPUnit\TextUI\TestRunner;
use _PhpScoper60081b922775\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper60081b922775\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper60081b922775\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
