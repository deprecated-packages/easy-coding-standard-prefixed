...
use _PhpScoper6db4fde00cda\PHPUnit\TextUI\TestRunner;
use _PhpScoper6db4fde00cda\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper6db4fde00cda\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper6db4fde00cda\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
