...
use _PhpScoper592524ba34f0\PHPUnit\TextUI\TestRunner;
use _PhpScoper592524ba34f0\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper592524ba34f0\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper592524ba34f0\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
