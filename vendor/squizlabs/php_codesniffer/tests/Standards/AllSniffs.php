...
use _PhpScoper839420027581\PHPUnit\TextUI\TestRunner;
use _PhpScoper839420027581\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper839420027581\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper839420027581\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
