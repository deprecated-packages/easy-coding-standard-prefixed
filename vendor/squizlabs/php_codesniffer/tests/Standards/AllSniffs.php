...
use _PhpScopera9d6b451df71\PHPUnit\TextUI\TestRunner;
use _PhpScopera9d6b451df71\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopera9d6b451df71\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopera9d6b451df71\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
