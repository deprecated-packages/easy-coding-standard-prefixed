...
use _PhpScoper9b9ddfd01528\PHPUnit\TextUI\TestRunner;
use _PhpScoper9b9ddfd01528\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper9b9ddfd01528\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper9b9ddfd01528\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
