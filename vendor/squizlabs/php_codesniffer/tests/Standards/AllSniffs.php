...
use _PhpScoper224ae0b86670\PHPUnit\TextUI\TestRunner;
use _PhpScoper224ae0b86670\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper224ae0b86670\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper224ae0b86670\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
