...
use _PhpScoperf3dc21757def\PHPUnit\TextUI\TestRunner;
use _PhpScoperf3dc21757def\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperf3dc21757def\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperf3dc21757def\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
