...
use _PhpScoper96382aaac118\PHPUnit\TextUI\TestRunner;
use _PhpScoper96382aaac118\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper96382aaac118\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper96382aaac118\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
