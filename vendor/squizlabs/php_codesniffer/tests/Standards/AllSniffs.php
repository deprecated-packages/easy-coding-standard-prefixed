...
use _PhpScoperf361a7d70552\PHPUnit\TextUI\TestRunner;
use _PhpScoperf361a7d70552\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperf361a7d70552\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperf361a7d70552\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
