...
use _PhpScoper326af2119eba\PHPUnit\TextUI\TestRunner;
use _PhpScoper326af2119eba\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper326af2119eba\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper326af2119eba\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
