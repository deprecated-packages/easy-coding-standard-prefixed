...
use _PhpScoper9f8d5dcff860\PHPUnit\TextUI\TestRunner;
use _PhpScoper9f8d5dcff860\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper9f8d5dcff860\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper9f8d5dcff860\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
