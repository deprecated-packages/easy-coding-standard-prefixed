...
use _PhpScoper02b5d1bf8fec\PHPUnit\TextUI\TestRunner;
use _PhpScoper02b5d1bf8fec\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper02b5d1bf8fec\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper02b5d1bf8fec\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
