...
use _PhpScoper0ba97041430d\PHPUnit\TextUI\TestRunner;
use _PhpScoper0ba97041430d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper0ba97041430d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper0ba97041430d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
