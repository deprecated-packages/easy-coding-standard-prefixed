...
use _PhpScopere205696a9dd6\PHPUnit\TextUI\TestRunner;
use _PhpScopere205696a9dd6\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopere205696a9dd6\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopere205696a9dd6\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
