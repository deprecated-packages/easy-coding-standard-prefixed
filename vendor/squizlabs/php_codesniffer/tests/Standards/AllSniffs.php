...
use _PhpScoper75713bc3e278\PHPUnit\TextUI\TestRunner;
use _PhpScoper75713bc3e278\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper75713bc3e278\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper75713bc3e278\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
