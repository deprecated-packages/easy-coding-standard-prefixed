...
use _PhpScoper4848279dba07\PHPUnit\TextUI\TestRunner;
use _PhpScoper4848279dba07\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper4848279dba07\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper4848279dba07\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
