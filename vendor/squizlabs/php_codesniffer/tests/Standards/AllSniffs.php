...
use _PhpScoper31ba553edf97\PHPUnit\TextUI\TestRunner;
use _PhpScoper31ba553edf97\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper31ba553edf97\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper31ba553edf97\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
