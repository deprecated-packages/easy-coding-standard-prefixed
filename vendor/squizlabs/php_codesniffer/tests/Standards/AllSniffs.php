...
use _PhpScoper23ef26a4fb01\PHPUnit\TextUI\TestRunner;
use _PhpScoper23ef26a4fb01\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper23ef26a4fb01\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper23ef26a4fb01\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
