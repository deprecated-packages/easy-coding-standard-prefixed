...
use _PhpScoper4edd80b4ab80\PHPUnit\TextUI\TestRunner;
use _PhpScoper4edd80b4ab80\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper4edd80b4ab80\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper4edd80b4ab80\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
