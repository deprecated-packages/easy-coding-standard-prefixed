...
use _PhpScoperc753ccca5a0c\PHPUnit\TextUI\TestRunner;
use _PhpScoperc753ccca5a0c\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc753ccca5a0c\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc753ccca5a0c\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
