...
use _PhpScoperaac5f7c652e4\PHPUnit\TextUI\TestRunner;
use _PhpScoperaac5f7c652e4\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperaac5f7c652e4\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperaac5f7c652e4\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
