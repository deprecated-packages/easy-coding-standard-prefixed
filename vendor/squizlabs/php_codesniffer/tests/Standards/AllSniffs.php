...
use _PhpScoper83b3b9a317c0\PHPUnit\TextUI\TestRunner;
use _PhpScoper83b3b9a317c0\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper83b3b9a317c0\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper83b3b9a317c0\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
