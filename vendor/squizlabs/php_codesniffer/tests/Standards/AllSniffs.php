...
use _PhpScoperb6d4bd368bd9\PHPUnit\TextUI\TestRunner;
use _PhpScoperb6d4bd368bd9\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperb6d4bd368bd9\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperb6d4bd368bd9\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
