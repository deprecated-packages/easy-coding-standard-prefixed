...
use _PhpScoperdf15f2b748e9\PHPUnit\TextUI\TestRunner;
use _PhpScoperdf15f2b748e9\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperdf15f2b748e9\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperdf15f2b748e9\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
