...
use _PhpScopereb8678af2407\PHPUnit\TextUI\TestRunner;
use _PhpScopereb8678af2407\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopereb8678af2407\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopereb8678af2407\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
