...
use _PhpScoper6207116d4311\PHPUnit\TextUI\TestRunner;
use _PhpScoper6207116d4311\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper6207116d4311\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper6207116d4311\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
