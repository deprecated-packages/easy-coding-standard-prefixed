...
use _PhpScoper89c09b8e7101\PHPUnit\TextUI\TestRunner;
use _PhpScoper89c09b8e7101\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper89c09b8e7101\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper89c09b8e7101\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
