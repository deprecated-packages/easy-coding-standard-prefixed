...
use _PhpScopere24d949bf310\PHPUnit\TextUI\TestRunner;
use _PhpScopere24d949bf310\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopere24d949bf310\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopere24d949bf310\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
