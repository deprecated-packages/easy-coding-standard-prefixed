...
use _PhpScoper80dbed43490f\PHPUnit\TextUI\TestRunner;
use _PhpScoper80dbed43490f\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper80dbed43490f\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper80dbed43490f\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
