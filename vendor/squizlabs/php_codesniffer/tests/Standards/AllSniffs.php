...
use _PhpScoperc64a4ac1af35\PHPUnit\TextUI\TestRunner;
use _PhpScoperc64a4ac1af35\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc64a4ac1af35\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc64a4ac1af35\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
