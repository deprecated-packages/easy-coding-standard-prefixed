...
use _PhpScoper64ca614e27fd\PHPUnit\TextUI\TestRunner;
use _PhpScoper64ca614e27fd\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper64ca614e27fd\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper64ca614e27fd\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
