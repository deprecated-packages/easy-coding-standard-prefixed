...
use _PhpScoperf77bffce0320\PHPUnit\TextUI\TestRunner;
use _PhpScoperf77bffce0320\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperf77bffce0320\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperf77bffce0320\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
