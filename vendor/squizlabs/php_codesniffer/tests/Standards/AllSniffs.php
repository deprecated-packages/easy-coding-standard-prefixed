...
use _PhpScopercb576ca159b5\PHPUnit\TextUI\TestRunner;
use _PhpScopercb576ca159b5\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopercb576ca159b5\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopercb576ca159b5\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
