...
use _PhpScoperbc5235eb86f3\PHPUnit\TextUI\TestRunner;
use _PhpScoperbc5235eb86f3\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperbc5235eb86f3\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperbc5235eb86f3\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
