...
use _PhpScopera609aff833be\PHPUnit\TextUI\TestRunner;
use _PhpScopera609aff833be\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopera609aff833be\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopera609aff833be\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
