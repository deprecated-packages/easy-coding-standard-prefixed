...
use _PhpScoper86aa49a51982\PHPUnit\TextUI\TestRunner;
use _PhpScoper86aa49a51982\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper86aa49a51982\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper86aa49a51982\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
