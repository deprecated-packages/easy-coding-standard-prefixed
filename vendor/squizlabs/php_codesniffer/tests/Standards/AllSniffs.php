...
use _PhpScoper255a4eaff575\PHPUnit\TextUI\TestRunner;
use _PhpScoper255a4eaff575\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper255a4eaff575\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper255a4eaff575\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
