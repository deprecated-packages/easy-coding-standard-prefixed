...
use _PhpScopera1a51450b61d\PHPUnit\TextUI\TestRunner;
use _PhpScopera1a51450b61d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopera1a51450b61d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopera1a51450b61d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
