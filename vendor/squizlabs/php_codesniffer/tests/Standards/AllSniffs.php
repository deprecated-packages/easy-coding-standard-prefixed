...
use _PhpScopercda2b863d098\PHPUnit\TextUI\TestRunner;
use _PhpScopercda2b863d098\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopercda2b863d098\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopercda2b863d098\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
