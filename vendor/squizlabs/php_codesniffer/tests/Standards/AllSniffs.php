...
use _PhpScoperc7c7dddc9238\PHPUnit\TextUI\TestRunner;
use _PhpScoperc7c7dddc9238\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc7c7dddc9238\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc7c7dddc9238\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
