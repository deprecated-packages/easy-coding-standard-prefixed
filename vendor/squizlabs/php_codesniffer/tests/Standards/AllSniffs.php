...
use _PhpScoper32136251d417\PHPUnit\TextUI\TestRunner;
use _PhpScoper32136251d417\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper32136251d417\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper32136251d417\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
