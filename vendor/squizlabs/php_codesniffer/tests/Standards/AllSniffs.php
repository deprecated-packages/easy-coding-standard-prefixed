...
use _PhpScoper48800f361566\PHPUnit\TextUI\TestRunner;
use _PhpScoper48800f361566\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper48800f361566\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper48800f361566\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
