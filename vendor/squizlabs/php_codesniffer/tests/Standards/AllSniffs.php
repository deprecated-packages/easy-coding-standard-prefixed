...
use _PhpScoper92feab6bddf8\PHPUnit\TextUI\TestRunner;
use _PhpScoper92feab6bddf8\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper92feab6bddf8\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper92feab6bddf8\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
