...
use _PhpScoper61bdb485188f\PHPUnit\TextUI\TestRunner;
use _PhpScoper61bdb485188f\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper61bdb485188f\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper61bdb485188f\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
