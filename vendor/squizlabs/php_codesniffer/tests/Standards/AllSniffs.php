...
use _PhpScoper5e5ebcdbebdf\PHPUnit\TextUI\TestRunner;
use _PhpScoper5e5ebcdbebdf\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper5e5ebcdbebdf\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper5e5ebcdbebdf\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
