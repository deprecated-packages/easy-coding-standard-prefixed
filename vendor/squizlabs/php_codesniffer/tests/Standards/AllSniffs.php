...
use _PhpScoperea337ed74749\PHPUnit\TextUI\TestRunner;
use _PhpScoperea337ed74749\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperea337ed74749\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperea337ed74749\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
