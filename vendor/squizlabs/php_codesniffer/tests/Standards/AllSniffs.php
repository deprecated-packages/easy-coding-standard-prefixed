...
use _PhpScoperf5c57eca8aae\PHPUnit\TextUI\TestRunner;
use _PhpScoperf5c57eca8aae\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperf5c57eca8aae\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperf5c57eca8aae\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
