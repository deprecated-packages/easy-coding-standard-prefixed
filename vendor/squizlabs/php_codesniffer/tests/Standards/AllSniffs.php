...
use _PhpScoperc4ea0f0bd23f\PHPUnit\TextUI\TestRunner;
use _PhpScoperc4ea0f0bd23f\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc4ea0f0bd23f\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc4ea0f0bd23f\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
