...
use _PhpScoper59558822d8c7\PHPUnit\TextUI\TestRunner;
use _PhpScoper59558822d8c7\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper59558822d8c7\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper59558822d8c7\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
