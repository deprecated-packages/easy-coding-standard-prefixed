...
use _PhpScoper9613f3fac51d\PHPUnit\TextUI\TestRunner;
use _PhpScoper9613f3fac51d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper9613f3fac51d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper9613f3fac51d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
