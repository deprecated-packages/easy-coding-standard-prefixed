...
use _PhpScoper167729fa1dde\PHPUnit\TextUI\TestRunner;
use _PhpScoper167729fa1dde\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper167729fa1dde\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper167729fa1dde\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
