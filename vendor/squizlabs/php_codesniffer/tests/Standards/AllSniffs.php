...
use _PhpScoper3e8786a75afe\PHPUnit\TextUI\TestRunner;
use _PhpScoper3e8786a75afe\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper3e8786a75afe\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper3e8786a75afe\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
