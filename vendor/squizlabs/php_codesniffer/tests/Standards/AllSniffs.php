...
use _PhpScoper37a255897161\PHPUnit\TextUI\TestRunner;
use _PhpScoper37a255897161\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper37a255897161\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper37a255897161\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
