...
use _PhpScoperecb978830f1e\PHPUnit\TextUI\TestRunner;
use _PhpScoperecb978830f1e\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperecb978830f1e\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperecb978830f1e\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
