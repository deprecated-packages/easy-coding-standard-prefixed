...
use _PhpScoperf523baae4f87\PHPUnit\TextUI\TestRunner;
use _PhpScoperf523baae4f87\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperf523baae4f87\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperf523baae4f87\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
