...
use _PhpScoper7cef7256eba6\PHPUnit\TextUI\TestRunner;
use _PhpScoper7cef7256eba6\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper7cef7256eba6\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper7cef7256eba6\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
