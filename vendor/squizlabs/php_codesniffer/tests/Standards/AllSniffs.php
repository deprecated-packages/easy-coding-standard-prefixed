...
use _PhpScoper4cd05b62e9f1\PHPUnit\TextUI\TestRunner;
use _PhpScoper4cd05b62e9f1\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper4cd05b62e9f1\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper4cd05b62e9f1\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
