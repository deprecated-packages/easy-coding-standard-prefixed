...
use _PhpScoperf65af7a6d9a0\PHPUnit\TextUI\TestRunner;
use _PhpScoperf65af7a6d9a0\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperf65af7a6d9a0\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperf65af7a6d9a0\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
