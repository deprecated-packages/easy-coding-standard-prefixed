...
use _PhpScoper069ebd53a518\PHPUnit\TextUI\TestRunner;
use _PhpScoper069ebd53a518\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper069ebd53a518\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper069ebd53a518\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
