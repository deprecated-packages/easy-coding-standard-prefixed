...
use _PhpScoper992f4af8b9e0\PHPUnit\TextUI\TestRunner;
use _PhpScoper992f4af8b9e0\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper992f4af8b9e0\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper992f4af8b9e0\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
