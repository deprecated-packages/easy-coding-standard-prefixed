...
use _PhpScopercae980ebf12d\PHPUnit\TextUI\TestRunner;
use _PhpScopercae980ebf12d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopercae980ebf12d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopercae980ebf12d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
