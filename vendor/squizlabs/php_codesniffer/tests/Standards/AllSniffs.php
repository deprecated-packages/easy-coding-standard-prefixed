...
use _PhpScopercb217fd4e736\PHPUnit\TextUI\TestRunner;
use _PhpScopercb217fd4e736\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopercb217fd4e736\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopercb217fd4e736\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
