...
use _PhpScoper8cb97064581a\PHPUnit\TextUI\TestRunner;
use _PhpScoper8cb97064581a\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper8cb97064581a\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper8cb97064581a\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
