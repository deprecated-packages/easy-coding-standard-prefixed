...
use _PhpScoper4972b76c81a2\PHPUnit\TextUI\TestRunner;
use _PhpScoper4972b76c81a2\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper4972b76c81a2\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper4972b76c81a2\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
