...
use _PhpScopere66f4b626446\PHPUnit\TextUI\TestRunner;
use _PhpScopere66f4b626446\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopere66f4b626446\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopere66f4b626446\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
