...
use _PhpScoper04022cd986ec\PHPUnit\TextUI\TestRunner;
use _PhpScoper04022cd986ec\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper04022cd986ec\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper04022cd986ec\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
