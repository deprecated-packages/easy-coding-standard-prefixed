...
use _PhpScoper47644ab3aa9a\PHPUnit\TextUI\TestRunner;
use _PhpScoper47644ab3aa9a\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper47644ab3aa9a\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper47644ab3aa9a\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
