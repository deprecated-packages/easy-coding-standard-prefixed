...
use _PhpScoper544eb478a6f6\PHPUnit\TextUI\TestRunner;
use _PhpScoper544eb478a6f6\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper544eb478a6f6\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper544eb478a6f6\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
