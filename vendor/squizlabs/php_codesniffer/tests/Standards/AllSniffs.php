...
use _PhpScoper21c6ce8bfe5d\PHPUnit\TextUI\TestRunner;
use _PhpScoper21c6ce8bfe5d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper21c6ce8bfe5d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper21c6ce8bfe5d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
