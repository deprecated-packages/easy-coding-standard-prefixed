...
use _PhpScopercf909b66eba8\PHPUnit\TextUI\TestRunner;
use _PhpScopercf909b66eba8\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopercf909b66eba8\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopercf909b66eba8\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
