...
use _PhpScopera09818bc50da\PHPUnit\TextUI\TestRunner;
use _PhpScopera09818bc50da\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopera09818bc50da\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopera09818bc50da\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
