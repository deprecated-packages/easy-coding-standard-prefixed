...
use _PhpScoperfaaf57618f34\PHPUnit\TextUI\TestRunner;
use _PhpScoperfaaf57618f34\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperfaaf57618f34\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperfaaf57618f34\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
