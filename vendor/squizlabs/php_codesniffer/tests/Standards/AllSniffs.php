...
use _PhpScoper14cb6de5473d\PHPUnit\TextUI\TestRunner;
use _PhpScoper14cb6de5473d\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper14cb6de5473d\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper14cb6de5473d\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
