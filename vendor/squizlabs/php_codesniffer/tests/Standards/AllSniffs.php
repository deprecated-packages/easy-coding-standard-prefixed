...
use _PhpScoper418afc2f157c\PHPUnit\TextUI\TestRunner;
use _PhpScoper418afc2f157c\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper418afc2f157c\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper418afc2f157c\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
