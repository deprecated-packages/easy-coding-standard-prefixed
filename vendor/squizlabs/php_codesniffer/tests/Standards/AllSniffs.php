...
use _PhpScoper6224e3b16fcc\PHPUnit\TextUI\TestRunner;
use _PhpScoper6224e3b16fcc\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper6224e3b16fcc\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper6224e3b16fcc\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
