...
use _PhpScoper326bba7310a2\PHPUnit\TextUI\TestRunner;
use _PhpScoper326bba7310a2\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper326bba7310a2\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper326bba7310a2\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
