...
use _PhpScoper614deab2c612\PHPUnit\TextUI\TestRunner;
use _PhpScoper614deab2c612\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper614deab2c612\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper614deab2c612\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
