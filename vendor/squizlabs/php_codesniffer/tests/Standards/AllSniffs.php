...
use _PhpScoper48b5ec5b60cf\PHPUnit\TextUI\TestRunner;
use _PhpScoper48b5ec5b60cf\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper48b5ec5b60cf\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper48b5ec5b60cf\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
