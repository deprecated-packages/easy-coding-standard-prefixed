...
use _PhpScoperfacc742d2745\PHPUnit\TextUI\TestRunner;
use _PhpScoperfacc742d2745\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperfacc742d2745\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperfacc742d2745\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
