...
use _PhpScoper133be48300f9\PHPUnit\TextUI\TestRunner;
use _PhpScoper133be48300f9\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper133be48300f9\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper133be48300f9\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
