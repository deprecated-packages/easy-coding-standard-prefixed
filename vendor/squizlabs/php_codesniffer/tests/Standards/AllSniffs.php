...
use _PhpScoper589e8c04a9ef\PHPUnit\TextUI\TestRunner;
use _PhpScoper589e8c04a9ef\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper589e8c04a9ef\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper589e8c04a9ef\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
