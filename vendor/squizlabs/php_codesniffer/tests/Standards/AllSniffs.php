...
use _PhpScoper8de082cbb8c7\PHPUnit\TextUI\TestRunner;
use _PhpScoper8de082cbb8c7\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper8de082cbb8c7\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper8de082cbb8c7\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
