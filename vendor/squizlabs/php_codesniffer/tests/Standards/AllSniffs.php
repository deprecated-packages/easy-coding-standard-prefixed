...
use _PhpScoperf3db63c305b2\PHPUnit\TextUI\TestRunner;
use _PhpScoperf3db63c305b2\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperf3db63c305b2\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperf3db63c305b2\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
