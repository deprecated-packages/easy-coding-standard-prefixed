...
use _PhpScoper63567e560066\PHPUnit\TextUI\TestRunner;
use _PhpScoper63567e560066\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper63567e560066\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper63567e560066\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
