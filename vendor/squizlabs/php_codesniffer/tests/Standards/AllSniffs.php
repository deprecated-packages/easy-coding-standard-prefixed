...
use _PhpScoperb458b528613f\PHPUnit\TextUI\TestRunner;
use _PhpScoperb458b528613f\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperb458b528613f\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperb458b528613f\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
