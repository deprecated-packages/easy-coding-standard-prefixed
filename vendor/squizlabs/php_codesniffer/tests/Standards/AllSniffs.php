...
use _PhpScopera749ac204cd2\PHPUnit\TextUI\TestRunner;
use _PhpScopera749ac204cd2\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopera749ac204cd2\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopera749ac204cd2\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
