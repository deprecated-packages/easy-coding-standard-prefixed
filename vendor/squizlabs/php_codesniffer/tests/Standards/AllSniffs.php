...
use _PhpScoperba5852cc6147\PHPUnit\TextUI\TestRunner;
use _PhpScoperba5852cc6147\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperba5852cc6147\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperba5852cc6147\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
