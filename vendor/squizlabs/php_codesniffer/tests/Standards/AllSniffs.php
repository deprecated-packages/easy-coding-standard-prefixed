...
use _PhpScoper880bfa4d8b51\PHPUnit\TextUI\TestRunner;
use _PhpScoper880bfa4d8b51\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper880bfa4d8b51\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper880bfa4d8b51\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
