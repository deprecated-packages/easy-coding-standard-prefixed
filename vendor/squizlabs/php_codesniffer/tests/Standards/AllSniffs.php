...
use _PhpScoper470d6df94ac0\PHPUnit\TextUI\TestRunner;
use _PhpScoper470d6df94ac0\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper470d6df94ac0\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper470d6df94ac0\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
