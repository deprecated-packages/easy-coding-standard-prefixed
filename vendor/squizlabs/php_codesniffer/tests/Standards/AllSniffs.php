...
use _PhpScoperdeea1786e972\PHPUnit\TextUI\TestRunner;
use _PhpScoperdeea1786e972\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperdeea1786e972\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperdeea1786e972\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
