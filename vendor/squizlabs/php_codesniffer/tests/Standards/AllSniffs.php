...
use _PhpScoperdf6a0b341030\PHPUnit\TextUI\TestRunner;
use _PhpScoperdf6a0b341030\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperdf6a0b341030\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperdf6a0b341030\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
