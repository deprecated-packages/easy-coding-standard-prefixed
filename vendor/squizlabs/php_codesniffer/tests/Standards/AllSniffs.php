...
use _PhpScoper3a22e8e0bd94\PHPUnit\TextUI\TestRunner;
use _PhpScoper3a22e8e0bd94\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper3a22e8e0bd94\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper3a22e8e0bd94\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
