...
use _PhpScoper6250f8d25076\PHPUnit\TextUI\TestRunner;
use _PhpScoper6250f8d25076\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper6250f8d25076\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper6250f8d25076\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
