...
use _PhpScoper0f5cd390c37a\PHPUnit\TextUI\TestRunner;
use _PhpScoper0f5cd390c37a\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper0f5cd390c37a\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper0f5cd390c37a\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
