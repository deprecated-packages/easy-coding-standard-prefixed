...
use _PhpScopera3425146d487\PHPUnit\TextUI\TestRunner;
use _PhpScopera3425146d487\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopera3425146d487\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopera3425146d487\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
