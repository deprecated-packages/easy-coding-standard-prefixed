...
use _PhpScoper5ea36b274140\PHPUnit\TextUI\TestRunner;
use _PhpScoper5ea36b274140\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper5ea36b274140\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper5ea36b274140\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
