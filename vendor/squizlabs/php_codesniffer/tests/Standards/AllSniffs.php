...
use _PhpScoper2a8ad010dfbd\PHPUnit\TextUI\TestRunner;
use _PhpScoper2a8ad010dfbd\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper2a8ad010dfbd\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper2a8ad010dfbd\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
