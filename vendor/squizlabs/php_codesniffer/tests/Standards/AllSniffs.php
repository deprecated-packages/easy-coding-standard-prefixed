...
use _PhpScoperb44a315fec16\PHPUnit\TextUI\TestRunner;
use _PhpScoperb44a315fec16\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperb44a315fec16\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperb44a315fec16\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
