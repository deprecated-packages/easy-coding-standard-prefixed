...
use _PhpScoperc8fea59b0cb1\PHPUnit\TextUI\TestRunner;
use _PhpScoperc8fea59b0cb1\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc8fea59b0cb1\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc8fea59b0cb1\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
