...
use _PhpScoper57c79939064b\PHPUnit\TextUI\TestRunner;
use _PhpScoper57c79939064b\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper57c79939064b\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper57c79939064b\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
