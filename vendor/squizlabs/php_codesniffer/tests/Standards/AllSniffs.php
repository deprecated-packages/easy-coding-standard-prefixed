...
use _PhpScoper6ec31b85adcf\PHPUnit\TextUI\TestRunner;
use _PhpScoper6ec31b85adcf\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper6ec31b85adcf\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper6ec31b85adcf\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
