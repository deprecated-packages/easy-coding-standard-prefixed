...
use _PhpScoper5813f9b171f8\PHPUnit\TextUI\TestRunner;
use _PhpScoper5813f9b171f8\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper5813f9b171f8\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper5813f9b171f8\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
