...
use _PhpScoper0d0ee1ba46d4\PHPUnit\TextUI\TestRunner;
use _PhpScoper0d0ee1ba46d4\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper0d0ee1ba46d4\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper0d0ee1ba46d4\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
