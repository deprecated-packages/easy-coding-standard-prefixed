...
use _PhpScoper38a7d00685f8\PHPUnit\TextUI\TestRunner;
use _PhpScoper38a7d00685f8\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper38a7d00685f8\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper38a7d00685f8\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
