...
use _PhpScoperc8b83ee8976a\PHPUnit\TextUI\TestRunner;
use _PhpScoperc8b83ee8976a\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc8b83ee8976a\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc8b83ee8976a\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
