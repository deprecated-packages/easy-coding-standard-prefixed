...
use _PhpScoper971ef29294dd\PHPUnit\TextUI\TestRunner;
use _PhpScoper971ef29294dd\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper971ef29294dd\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper971ef29294dd\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
