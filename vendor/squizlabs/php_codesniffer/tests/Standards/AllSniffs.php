...
use _PhpScoper836bc32aecc2\PHPUnit\TextUI\TestRunner;
use _PhpScoper836bc32aecc2\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper836bc32aecc2\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper836bc32aecc2\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
