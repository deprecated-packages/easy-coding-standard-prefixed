...
use _PhpScoperc83f84c90b60\PHPUnit\TextUI\TestRunner;
use _PhpScoperc83f84c90b60\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoperc83f84c90b60\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoperc83f84c90b60\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
