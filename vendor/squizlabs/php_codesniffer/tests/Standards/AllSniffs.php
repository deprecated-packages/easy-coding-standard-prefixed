...
use _PhpScoper908feaf49cd8\PHPUnit\TextUI\TestRunner;
use _PhpScoper908feaf49cd8\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper908feaf49cd8\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper908feaf49cd8\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
