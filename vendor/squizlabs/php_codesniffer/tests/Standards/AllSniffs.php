...
use _PhpScopera189153e1f79\PHPUnit\TextUI\TestRunner;
use _PhpScopera189153e1f79\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopera189153e1f79\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopera189153e1f79\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
