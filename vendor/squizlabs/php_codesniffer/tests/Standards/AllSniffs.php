...
use _PhpScoper3ba93baeac18\PHPUnit\TextUI\TestRunner;
use _PhpScoper3ba93baeac18\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper3ba93baeac18\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper3ba93baeac18\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
