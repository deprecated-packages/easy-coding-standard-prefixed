...
use _PhpScoper58a0a169dcfb\PHPUnit\TextUI\TestRunner;
use _PhpScoper58a0a169dcfb\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper58a0a169dcfb\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper58a0a169dcfb\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
