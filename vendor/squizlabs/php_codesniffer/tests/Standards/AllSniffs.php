...
use _PhpScoper1e80a2e03314\PHPUnit\TextUI\TestRunner;
use _PhpScoper1e80a2e03314\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper1e80a2e03314\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper1e80a2e03314\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
