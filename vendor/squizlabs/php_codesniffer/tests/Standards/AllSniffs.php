...
use _PhpScopera1f11cc38772\PHPUnit\TextUI\TestRunner;
use _PhpScopera1f11cc38772\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScopera1f11cc38772\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScopera1f11cc38772\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
