...
use _PhpScoper457dd3bd73ba\PHPUnit\TextUI\TestRunner;
use _PhpScoper457dd3bd73ba\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper457dd3bd73ba\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper457dd3bd73ba\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
