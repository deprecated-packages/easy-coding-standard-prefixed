...
use _PhpScoper3fa05b4669af\PHPUnit\TextUI\TestRunner;
use _PhpScoper3fa05b4669af\PHPUnit\Framework\TestSuite;
class AllSniffs
{
    /**
    ...
    {
        \_PhpScoper3fa05b4669af\PHPUnit\TextUI\TestRunner::run(self::suite());
    }
    //end main()
    /**
    ...
    public static function suite()
    {
        ...
        $suite = new \_PhpScoper3fa05b4669af\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
