...
class ValidatePEARPackageXML
{
    ...
    public function __construct()
    {
        ...
        $allFiles = (new \PHP_CodeSniffer\Tests\FileList($this->projectRoot, $this->projectRoot))->getList();
    ...
    protected function checkContents()
    {
         ...
         */
        $srcFiles = (new \PHP_CodeSniffer\Tests\FileList($this->projectRoot . 'src/', $this->projectRoot, '`\\.(css|fixed|inc|js|php|xml)$`Di'))->getList();
        $testsFiles = (new \PHP_CodeSniffer\Tests\FileList($this->projectRoot . 'tests/', $this->projectRoot, '`\\.(css|inc|js|php|xml)$`Di'))->getList();
    ...
    protected function checkPHPRelease()
    {
         ...
         */
        $testFiles = (new \PHP_CodeSniffer\Tests\FileList($this->projectRoot . 'tests/', $this->projectRoot, '`\\.(inc|php|js|css|xml)$`Di'))->getList();
 ...
 * Validate the PHP_CodeSniffer PEAR package.xml file.
 */
\class_alias('_PhpScoper21763e6c7ac4\\ValidatePEARPackageXML', 'ValidatePEARPackageXML', \false);
//end class
