 ...
 */
class ListCommand extends \_PhpScoperb44a315fec16\Symfony\Component\Console\Command\Command
{
    /**
     * {@inheritdoc}
     */
...
EOF
    ...
    private function createDefinition() : \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\InputDefinition
    {
        return new \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\InputDefinition([new \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\InputArgument('namespace', \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The namespace name'), new \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\InputOption('raw', null, \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command list'), new \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\InputOption('format', null, \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt')]);
    }
}
