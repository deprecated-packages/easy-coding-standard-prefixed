 ...
 */
class HelpCommand extends \_PhpScoperd79d87c3336e\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
    ...
    protected function configure()
    {
        ...
        $this->setName('help')->setDefinition([new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputArgument('command_name', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The command name', 'help'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('format', null, \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('raw', null, \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command help')])->setDescription('Displays help for a command')->setHelp(<<<'EOF'
...
EOF
    ...
    public function setCommand(\_PhpScoperd79d87c3336e\Symfony\Component\Console\Command\Command $command)
    {
