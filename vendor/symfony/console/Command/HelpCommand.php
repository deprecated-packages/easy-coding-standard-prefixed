...
use _PhpScoperd2a667bd5a98\Symfony\Component\Console\Helper\DescriptorHelper;
 ...
 */
class HelpCommand extends \_PhpScoperd2a667bd5a98\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
...
EOF
    ...
    public function setCommand(\_PhpScoperd2a667bd5a98\Symfony\Component\Console\Command\Command $command)
    {
