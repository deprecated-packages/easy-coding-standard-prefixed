...
use _PhpScoper82a1412fb847\Symfony\Component\Console\Helper\DescriptorHelper;
 ...
 */
class HelpCommand extends \_PhpScoper82a1412fb847\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
...
EOF
    ...
    public function setCommand(\_PhpScoper82a1412fb847\Symfony\Component\Console\Command\Command $command)
    {
