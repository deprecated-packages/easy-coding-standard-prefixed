...
use _PhpScoper96c81c3c1716\Symfony\Component\Console\Helper\DescriptorHelper;
 ...
 */
class HelpCommand extends \_PhpScoper96c81c3c1716\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
...
EOF
    ...
    public function setCommand(\_PhpScoper96c81c3c1716\Symfony\Component\Console\Command\Command $command)
    {
