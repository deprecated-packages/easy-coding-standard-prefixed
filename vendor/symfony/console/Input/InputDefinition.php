...
class InputDefinition
{
    ...
    public function setDefinition(array $definition)
    {
        ...
        foreach ($definition as $item) {
            if ($item instanceof \_PhpScoper82a1412fb847\Symfony\Component\Console\Input\InputOption) {
                $options[] = $item;
            } else {
                $arguments[] = $item;
            }
     ...
     */
    public function addArgument(\_PhpScoper82a1412fb847\Symfony\Component\Console\Input\InputArgument $argument)
    {
     ...
     */
    public function addOption(\_PhpScoper82a1412fb847\Symfony\Component\Console\Input\InputOption $option)
    {
