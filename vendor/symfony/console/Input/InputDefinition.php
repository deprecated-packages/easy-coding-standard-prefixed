...
class InputDefinition
{
    ...
    public function setDefinition(array $definition)
    {
        ...
        foreach ($definition as $item) {
            if ($item instanceof \_PhpScoper7e6a1331d94a\Symfony\Component\Console\Input\InputOption) {
                $options[] = $item;
            } else {
                $arguments[] = $item;
            }
     ...
     */
    public function addArgument(\_PhpScoper7e6a1331d94a\Symfony\Component\Console\Input\InputArgument $argument)
    {
     ...
     */
    public function addOption(\_PhpScoper7e6a1331d94a\Symfony\Component\Console\Input\InputOption $option)
    {
