...
class InputDefinition
{
    ...
    public function setDefinition(array $definition)
    {
        ...
        foreach ($definition as $item) {
            if ($item instanceof \_PhpScoper2dc059b3a969\Symfony\Component\Console\Input\InputOption) {
                $options[] = $item;
            } else {
                $arguments[] = $item;
            }
     ...
     */
    public function addArgument(\_PhpScoper2dc059b3a969\Symfony\Component\Console\Input\InputArgument $argument)
    {
     ...
     */
    public function addOption(\_PhpScoper2dc059b3a969\Symfony\Component\Console\Input\InputOption $option)
    {
