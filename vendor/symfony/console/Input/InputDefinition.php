...
class InputDefinition
{
    ...
    public function setDefinition(array $definition)
    {
        ...
        foreach ($definition as $item) {
            if ($item instanceof \_PhpScoperc2b2a9bb0e13\Symfony\Component\Console\Input\InputOption) {
                $options[] = $item;
            } else {
                $arguments[] = $item;
            }
     ...
     */
    public function addArgument(\_PhpScoperc2b2a9bb0e13\Symfony\Component\Console\Input\InputArgument $argument)
    {
     ...
     */
    public function addOption(\_PhpScoperc2b2a9bb0e13\Symfony\Component\Console\Input\InputOption $option)
    {
