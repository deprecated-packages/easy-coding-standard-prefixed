...
class InputDefinition
{
    ...
    public function setDefinition(array $definition)
    {
        ...
        foreach ($definition as $item) {
            if ($item instanceof \_PhpScopera9d6a31d814c\Symfony\Component\Console\Input\InputOption) {
                $options[] = $item;
            } else {
                $arguments[] = $item;
            }
     ...
     */
    public function addArgument(\_PhpScopera9d6a31d814c\Symfony\Component\Console\Input\InputArgument $argument)
    {
     ...
     */
    public function addOption(\_PhpScopera9d6a31d814c\Symfony\Component\Console\Input\InputOption $option)
    {
