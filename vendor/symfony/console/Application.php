 ...
 */
namespace _PhpScoperef2f7aa3581e\Symfony\Component\Console;

use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Command\Command;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Command\HelpCommand;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Command\ListCommand;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Command\SignalableCommandInterface;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Event\ConsoleCommandEvent;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Event\ConsoleErrorEvent;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Event\ConsoleSignalEvent;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Exception\CommandNotFoundException;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Exception\ExceptionInterface;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Exception\LogicException;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Exception\NamespaceNotFoundException;
...
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Helper\DebugFormatterHelper;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Helper\FormatterHelper;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Helper\Helper;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Helper\HelperSet;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Helper\ProcessHelper;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Helper\QuestionHelper;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Input\ArgvInput;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Input\ArrayInput;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Input\InputArgument;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Input\InputAwareInterface;
...
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Output\ConsoleOutput;
...
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use _PhpScoperef2f7aa3581e\Symfony\Component\Console\Style\SymfonyStyle;
use _PhpScoperef2f7aa3581e\Symfony\Component\ErrorHandler\ErrorHandler;
...
class Application implements ResetInterface
{
    ...
    public function __construct(string $name = 'UNKNOWN', string $version = 'UNKNOWN')
    {
        ...
        $this->terminal = new \_PhpScoperef2f7aa3581e\Symfony\Component\Console\Terminal();
        ...
        try {
            ...
            if (!($e instanceof CommandNotFoundException && !$e instanceof NamespaceNotFoundException) || 1 !== \count($alternatives = $e->getAlternatives()) || !$input->isInteractive()) {
                if (null !== $this->dispatcher) {
                    ...
                    $this->dispatcher->dispatch($event, \_PhpScoperef2f7aa3581e\Symfony\Component\Console\ConsoleEvents::ERROR);
    ...
    protected function doRunCommand(Command $command, InputInterface $input, OutputInterface $output)
    {
            ...
            if ($this->dispatcher) {
                foreach ($this->signalsToDispatchEvent as $signal) {
                    ...
                    $this->signalRegistry->register($signal, function ($signal, $hasNext) use($event) {
                        $this->dispatcher->dispatch($event, \_PhpScoperef2f7aa3581e\Symfony\Component\Console\ConsoleEvents::SIGNAL);
        ...
        $e = null;
        try {
            $this->dispatcher->dispatch($event, \_PhpScoperef2f7aa3581e\Symfony\Component\Console\ConsoleEvents::COMMAND);
        ...
        $this->dispatcher->dispatch($event, \_PhpScoperef2f7aa3581e\Symfony\Component\Console\ConsoleEvents::TERMINATE);
        if (null !== $e) {
            throw $e;
        }
        return $event->getExitCode();
