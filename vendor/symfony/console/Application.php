...
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Command\HelpCommand;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Command\ListCommand;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Command\SignalableCommandInterface;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
...
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Exception\CommandNotFoundException;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Exception\ExceptionInterface;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Exception\LogicException;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Exception\RuntimeException;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Formatter\OutputFormatter;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Helper\DebugFormatterHelper;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Helper\FormatterHelper;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Helper\Helper;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Helper\HelperSet;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Helper\ProcessHelper;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Helper\QuestionHelper;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Input\ArgvInput;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Input\ArrayInput;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Input\InputArgument;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Input\InputAwareInterface;
...
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Output\ConsoleOutput;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Output\ConsoleOutputInterface;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Output\OutputInterface;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Console\Style\SymfonyStyle;
use _PhpScopera22bb3f4d7b7\Symfony\Component\ErrorHandler\ErrorHandler;
use _PhpScopera22bb3f4d7b7\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
...
class Application implements ResetInterface
{
    ...
    public function __construct(string $name = 'UNKNOWN', string $version = 'UNKNOWN')
    {
        ...
        $this->terminal = new \_PhpScopera22bb3f4d7b7\Symfony\Component\Console\Terminal();
        ...
        try {
            ...
            if (!($e instanceof CommandNotFoundException && !$e instanceof NamespaceNotFoundException) || 1 !== \count($alternatives = $e->getAlternatives()) || !$input->isInteractive()) {
                if (null !== $this->dispatcher) {
                    ...
                    $this->dispatcher->dispatch($event, \_PhpScopera22bb3f4d7b7\Symfony\Component\Console\ConsoleEvents::ERROR);
    ...
    protected function doRunCommand(Command $command, InputInterface $input, OutputInterface $output)
    {
            ...
            if ($this->dispatcher) {
                foreach ($this->signalsToDispatchEvent as $signal) {
                    ...
                    $this->signalRegistry->register($signal, function ($signal, $hasNext) use($event) {
                        $this->dispatcher->dispatch($event, \_PhpScopera22bb3f4d7b7\Symfony\Component\Console\ConsoleEvents::SIGNAL);
        ...
        $e = null;
        try {
            $this->dispatcher->dispatch($event, \_PhpScopera22bb3f4d7b7\Symfony\Component\Console\ConsoleEvents::COMMAND);
        ...
        $this->dispatcher->dispatch($event, \_PhpScopera22bb3f4d7b7\Symfony\Component\Console\ConsoleEvents::TERMINATE);
        if (null !== $e) {
            throw $e;
        }
        return $event->getExitCode();
