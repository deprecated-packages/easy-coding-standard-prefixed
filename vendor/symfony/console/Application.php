...
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Command\HelpCommand;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Command\ListCommand;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Command\SignalableCommandInterface;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
...
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Exception\CommandNotFoundException;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Exception\ExceptionInterface;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Exception\LogicException;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Exception\RuntimeException;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Formatter\OutputFormatter;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Helper\DebugFormatterHelper;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Helper\FormatterHelper;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Helper\Helper;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Helper\HelperSet;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Helper\ProcessHelper;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Helper\QuestionHelper;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Input\ArgvInput;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Input\ArrayInput;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Input\InputArgument;
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Input\InputAwareInterface;
...
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\Output\ConsoleOutput;
...
use _PhpScoper8a8080b03ed6\Symfony\Component\Console\SignalRegistry\SignalRegistry;
...
use _PhpScoper8a8080b03ed6\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use _PhpScoper8a8080b03ed6\Symfony\Contracts\Service\ResetInterface;
/**
...
class Application implements ResetInterface
{
    ...
    public function __construct(string $name = 'UNKNOWN', string $version = 'UNKNOWN')
    {
        ...
        $this->terminal = new \_PhpScoper8a8080b03ed6\Symfony\Component\Console\Terminal();
        ...
        try {
            ...
            if (!($e instanceof CommandNotFoundException && !$e instanceof NamespaceNotFoundException) || 1 !== \count($alternatives = $e->getAlternatives()) || !$input->isInteractive()) {
                if (null !== $this->dispatcher) {
                    ...
                    $this->dispatcher->dispatch($event, \_PhpScoper8a8080b03ed6\Symfony\Component\Console\ConsoleEvents::ERROR);
    ...
    protected function doRunCommand(Command $command, InputInterface $input, OutputInterface $output)
    {
            ...
            if ($this->dispatcher) {
                foreach ($this->signalsToDispatchEvent as $signal) {
                    ...
                    $this->signalRegistry->register($signal, function ($signal, $hasNext) use($event) {
                        $this->dispatcher->dispatch($event, \_PhpScoper8a8080b03ed6\Symfony\Component\Console\ConsoleEvents::SIGNAL);
        ...
        $e = null;
        try {
            $this->dispatcher->dispatch($event, \_PhpScoper8a8080b03ed6\Symfony\Component\Console\ConsoleEvents::COMMAND);
        ...
        $this->dispatcher->dispatch($event, \_PhpScoper8a8080b03ed6\Symfony\Component\Console\ConsoleEvents::TERMINATE);
        if (null !== $e) {
            throw $e;
        }
        return $event->getExitCode();
