 ...
 */
namespace _PhpScopereb9508917a55\Symfony\Component\Console;

use _PhpScopereb9508917a55\Symfony\Component\Console\Command\Command;
use _PhpScopereb9508917a55\Symfony\Component\Console\Command\HelpCommand;
use _PhpScopereb9508917a55\Symfony\Component\Console\Command\ListCommand;
use _PhpScopereb9508917a55\Symfony\Component\Console\Command\SignalableCommandInterface;
use _PhpScopereb9508917a55\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use _PhpScopereb9508917a55\Symfony\Component\Console\Event\ConsoleCommandEvent;
use _PhpScopereb9508917a55\Symfony\Component\Console\Event\ConsoleErrorEvent;
use _PhpScopereb9508917a55\Symfony\Component\Console\Event\ConsoleSignalEvent;
use _PhpScopereb9508917a55\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use _PhpScopereb9508917a55\Symfony\Component\Console\Exception\CommandNotFoundException;
use _PhpScopereb9508917a55\Symfony\Component\Console\Exception\ExceptionInterface;
use _PhpScopereb9508917a55\Symfony\Component\Console\Exception\LogicException;
use _PhpScopereb9508917a55\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use _PhpScopereb9508917a55\Symfony\Component\Console\Exception\RuntimeException;
use _PhpScopereb9508917a55\Symfony\Component\Console\Formatter\OutputFormatter;
use _PhpScopereb9508917a55\Symfony\Component\Console\Helper\DebugFormatterHelper;
use _PhpScopereb9508917a55\Symfony\Component\Console\Helper\FormatterHelper;
use _PhpScopereb9508917a55\Symfony\Component\Console\Helper\Helper;
use _PhpScopereb9508917a55\Symfony\Component\Console\Helper\HelperSet;
use _PhpScopereb9508917a55\Symfony\Component\Console\Helper\ProcessHelper;
use _PhpScopereb9508917a55\Symfony\Component\Console\Helper\QuestionHelper;
use _PhpScopereb9508917a55\Symfony\Component\Console\Input\ArgvInput;
use _PhpScopereb9508917a55\Symfony\Component\Console\Input\ArrayInput;
use _PhpScopereb9508917a55\Symfony\Component\Console\Input\InputArgument;
use _PhpScopereb9508917a55\Symfony\Component\Console\Input\InputAwareInterface;
use _PhpScopereb9508917a55\Symfony\Component\Console\Input\InputDefinition;
...
use _PhpScopereb9508917a55\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use _PhpScopereb9508917a55\Symfony\Component\Console\Style\SymfonyStyle;
use _PhpScopereb9508917a55\Symfony\Component\ErrorHandler\ErrorHandler;
use _PhpScopereb9508917a55\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
...
class Application implements ResetInterface
{
    ...
    public function __construct(string $name = 'UNKNOWN', string $version = 'UNKNOWN')
    {
        ...
        $this->terminal = new \_PhpScopereb9508917a55\Symfony\Component\Console\Terminal();
        ...
        try {
            ...
            if (!($e instanceof CommandNotFoundException && !$e instanceof NamespaceNotFoundException) || 1 !== \count($alternatives = $e->getAlternatives()) || !$input->isInteractive()) {
                if (null !== $this->dispatcher) {
                    ...
                    $this->dispatcher->dispatch($event, \_PhpScopereb9508917a55\Symfony\Component\Console\ConsoleEvents::ERROR);
    ...
    protected function doRunCommand(Command $command, InputInterface $input, OutputInterface $output)
    {
            ...
            if ($this->dispatcher) {
                foreach ($this->signalsToDispatchEvent as $signal) {
                    ...
                    $this->signalRegistry->register($signal, function ($signal, $hasNext) use($event) {
                        $this->dispatcher->dispatch($event, \_PhpScopereb9508917a55\Symfony\Component\Console\ConsoleEvents::SIGNAL);
        ...
        $e = null;
        try {
            $this->dispatcher->dispatch($event, \_PhpScopereb9508917a55\Symfony\Component\Console\ConsoleEvents::COMMAND);
        ...
        $this->dispatcher->dispatch($event, \_PhpScopereb9508917a55\Symfony\Component\Console\ConsoleEvents::TERMINATE);
        if (null !== $e) {
            throw $e;
        }
        return $event->getExitCode();
