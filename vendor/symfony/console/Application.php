 ...
 */
namespace _PhpScoper130a9a1cd4a2\Symfony\Component\Console;

use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Command\Command;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Command\HelpCommand;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Command\ListCommand;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Command\SignalableCommandInterface;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Event\ConsoleCommandEvent;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Event\ConsoleErrorEvent;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Event\ConsoleSignalEvent;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Exception\CommandNotFoundException;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Exception\ExceptionInterface;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Exception\LogicException;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Exception\NamespaceNotFoundException;
...
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Helper\DebugFormatterHelper;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Helper\FormatterHelper;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Helper\Helper;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Helper\HelperSet;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Helper\ProcessHelper;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Helper\QuestionHelper;
...
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Input\InputArgument;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Input\InputAwareInterface;
...
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Output\ConsoleOutput;
...
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Console\Style\SymfonyStyle;
use _PhpScoper130a9a1cd4a2\Symfony\Component\ErrorHandler\ErrorHandler;
use _PhpScoper130a9a1cd4a2\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use _PhpScoper130a9a1cd4a2\Symfony\Contracts\Service\ResetInterface;
/**
...
class Application implements ResetInterface
{
    ...
    public function __construct(string $name = 'UNKNOWN', string $version = 'UNKNOWN')
    {
        ...
        $this->terminal = new \_PhpScoper130a9a1cd4a2\Symfony\Component\Console\Terminal();
        ...
        try {
            ...
            if (!($e instanceof CommandNotFoundException && !$e instanceof NamespaceNotFoundException) || 1 !== \count($alternatives = $e->getAlternatives()) || !$input->isInteractive()) {
                if (null !== $this->dispatcher) {
                    ...
                    $this->dispatcher->dispatch($event, \_PhpScoper130a9a1cd4a2\Symfony\Component\Console\ConsoleEvents::ERROR);
    ...
    protected function doRunCommand(Command $command, InputInterface $input, OutputInterface $output)
    {
            ...
            if ($this->dispatcher) {
                foreach ($this->signalsToDispatchEvent as $signal) {
                    ...
                    $this->signalRegistry->register($signal, function ($signal, $hasNext) use($event) {
                        $this->dispatcher->dispatch($event, \_PhpScoper130a9a1cd4a2\Symfony\Component\Console\ConsoleEvents::SIGNAL);
        ...
        $e = null;
        try {
            $this->dispatcher->dispatch($event, \_PhpScoper130a9a1cd4a2\Symfony\Component\Console\ConsoleEvents::COMMAND);
        ...
        $this->dispatcher->dispatch($event, \_PhpScoper130a9a1cd4a2\Symfony\Component\Console\ConsoleEvents::TERMINATE);
        if (null !== $e) {
            throw $e;
        }
        return $event->getExitCode();
