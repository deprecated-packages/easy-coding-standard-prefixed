 ...
 */
namespace _PhpScoper589e8c04a9ef\Symfony\Component\Console\DependencyInjection;

use _PhpScoper589e8c04a9ef\Symfony\Component\Console\Command\Command;
use _PhpScoper589e8c04a9ef\Symfony\Component\Console\CommandLoader\ContainerCommandLoader;
 ...
 */
class AddConsoleCommandPass implements \_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($commandServices as $id => $tags) {
            ...
            if (isset($tags[0]['command'])) {
                ...
                if (!$r->isSubclassOf(\_PhpScoper589e8c04a9ef\Symfony\Component\Console\Command\Command::class)) {
                    throw new \_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The service "%s" tagged "%s" must be a subclass of "%s".', $id, $this->commandTag, \_PhpScoper589e8c04a9ef\Symfony\Component\Console\Command\Command::class));
                }
            ...
            $lazyCommandRefs[$id] = new \_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\TypedReference($id, $class);
            $aliases = [];
            foreach ($tags as $tag) {
        ...
        $container->register($this->commandLoaderServiceId, \_PhpScoper589e8c04a9ef\Symfony\Component\Console\CommandLoader\ContainerCommandLoader::class)->setPublic(\true)->setArguments([\_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\Compiler\ServiceLocatorTagPass::register($container, $lazyCommandRefs), $lazyCommandMap]);
