 ...
 */
namespace _PhpScopercf327c47dfc5\Symfony\Component\Console\DependencyInjection;

use _PhpScopercf327c47dfc5\Symfony\Component\Console\Command\Command;
use _PhpScopercf327c47dfc5\Symfony\Component\Console\CommandLoader\ContainerCommandLoader;
 ...
 */
class AddConsoleCommandPass implements \_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($commandServices as $id => $tags) {
            ...
            if (isset($tags[0]['command'])) {
                ...
                if (!$r->isSubclassOf(\_PhpScopercf327c47dfc5\Symfony\Component\Console\Command\Command::class)) {
                    throw new \_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The service "%s" tagged "%s" must be a subclass of "%s".', $id, $this->commandTag, \_PhpScopercf327c47dfc5\Symfony\Component\Console\Command\Command::class));
                }
            ...
            $lazyCommandRefs[$id] = new \_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\TypedReference($id, $class);
            $aliases = [];
            foreach ($tags as $tag) {
        ...
        $container->register($this->commandLoaderServiceId, \_PhpScopercf327c47dfc5\Symfony\Component\Console\CommandLoader\ContainerCommandLoader::class)->setPublic(\true)->setArguments([\_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\Compiler\ServiceLocatorTagPass::register($container, $lazyCommandRefs), $lazyCommandMap]);
