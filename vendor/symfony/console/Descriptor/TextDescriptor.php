 ...
 * @internal
 */
class TextDescriptor extends \_PhpScoper82a1412fb847\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(Application $application, array $options = [])
    {
        ...
        if (isset($options['raw_text']) && $options['raw_text']) {
            ...
            foreach ($namespaces as $namespace) {
                ...
                if (!$describedNamespace && \_PhpScoper82a1412fb847\Symfony\Component\Console\Descriptor\ApplicationDescription::GLOBAL_NAMESPACE !== $namespace['id']) {
                    $this->writeText("\n");
