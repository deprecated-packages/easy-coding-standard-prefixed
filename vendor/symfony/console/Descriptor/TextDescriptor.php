 ...
 */
namespace _PhpScoper08fb1f8a2f44\Symfony\Component\Console\Descriptor;

use _PhpScoper08fb1f8a2f44\Symfony\Component\Console\Application;
 ...
 * @internal
 */
class TextDescriptor extends \_PhpScoper08fb1f8a2f44\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(Application $application, array $options = [])
    {
        ...
        $description = new \_PhpScoper08fb1f8a2f44\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace);
        if (isset($options['raw_text']) && $options['raw_text']) {
            ...
            foreach ($namespaces as $namespace) {
                ...
                if (!$describedNamespace && \_PhpScoper08fb1f8a2f44\Symfony\Component\Console\Descriptor\ApplicationDescription::GLOBAL_NAMESPACE !== $namespace['id']) {
                    $this->writeText("\n");
