 ...
 * @internal
 */
class XmlDescriptor extends \_PhpScoperd2a667bd5a98\Symfony\Component\Console\Descriptor\Descriptor
{
    ...
    public function getApplicationDocument(Application $application, string $namespace = null) : \DOMDocument
    {
        ...
        $description = new \_PhpScoperd2a667bd5a98\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
