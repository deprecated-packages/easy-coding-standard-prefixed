 ...
 * @internal
 */
class XmlDescriptor extends \_PhpScoper91fe47cd7f25\Symfony\Component\Console\Descriptor\Descriptor
{
    ...
    public function getApplicationDocument(Application $application, string $namespace = null) : \DOMDocument
    {
        ...
        $description = new \_PhpScoper91fe47cd7f25\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
