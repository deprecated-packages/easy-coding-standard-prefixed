 ...
 * @internal
 */
class XmlDescriptor extends \_PhpScoper99c9619a6243\Symfony\Component\Console\Descriptor\Descriptor
{
    ...
    public function getApplicationDocument(Application $application, string $namespace = null) : \DOMDocument
    {
        ...
        $description = new \_PhpScoper99c9619a6243\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
