 ...
 * @internal
 */
class XmlDescriptor extends \_PhpScoper757c066053f8\Symfony\Component\Console\Descriptor\Descriptor
{
    ...
    public function getApplicationDocument(Application $application, string $namespace = null) : \DOMDocument
    {
        ...
        $description = new \_PhpScoper757c066053f8\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
