 ...
 * @internal
 */
class XmlDescriptor extends \_PhpScoper971ef29294dd\Symfony\Component\Console\Descriptor\Descriptor
{
    public function getInputDefinitionDocument(\_PhpScoper971ef29294dd\Symfony\Component\Console\Input\InputDefinition $definition) : \DOMDocument
    {
    ...
    public function getCommandDocument(\_PhpScoper971ef29294dd\Symfony\Component\Console\Command\Command $command) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    public function getApplicationDocument(\_PhpScoper971ef29294dd\Symfony\Component\Console\Application $application, string $namespace = null) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \_PhpScoper971ef29294dd\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\_PhpScoper971ef29294dd\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\_PhpScoper971ef29294dd\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
