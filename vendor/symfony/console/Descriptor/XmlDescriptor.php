 ...
 * @internal
 */
class XmlDescriptor extends \_PhpScopere050faf861e6\Symfony\Component\Console\Descriptor\Descriptor
{
    public function getInputDefinitionDocument(\_PhpScopere050faf861e6\Symfony\Component\Console\Input\InputDefinition $definition) : \DOMDocument
    {
    ...
    public function getCommandDocument(\_PhpScopere050faf861e6\Symfony\Component\Console\Command\Command $command) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    public function getApplicationDocument(\_PhpScopere050faf861e6\Symfony\Component\Console\Application $application, string $namespace = null) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \_PhpScopere050faf861e6\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\_PhpScopere050faf861e6\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\_PhpScopere050faf861e6\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
