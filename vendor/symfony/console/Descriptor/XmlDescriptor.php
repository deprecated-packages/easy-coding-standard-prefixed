 ...
 * @internal
 */
class XmlDescriptor extends \_PhpScopera658fe86acec\Symfony\Component\Console\Descriptor\Descriptor
{
    ...
    public function getApplicationDocument(Application $application, string $namespace = null) : \DOMDocument
    {
        ...
        $description = new \_PhpScopera658fe86acec\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
