 ...
 * @internal
 */
class XmlDescriptor extends \_PhpScoperfb0714773dc5\Symfony\Component\Console\Descriptor\Descriptor
{
    public function getInputDefinitionDocument(\_PhpScoperfb0714773dc5\Symfony\Component\Console\Input\InputDefinition $definition) : \DOMDocument
    {
    ...
    public function getCommandDocument(\_PhpScoperfb0714773dc5\Symfony\Component\Console\Command\Command $command) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    public function getApplicationDocument(\_PhpScoperfb0714773dc5\Symfony\Component\Console\Application $application, string $namespace = null) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \_PhpScoperfb0714773dc5\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\_PhpScoperfb0714773dc5\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\_PhpScoperfb0714773dc5\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
