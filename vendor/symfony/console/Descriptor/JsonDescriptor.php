 ...
 * @internal
 */
class JsonDescriptor extends \_PhpScoperf62d28230928\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(\_PhpScoperf62d28230928\Symfony\Component\Console\Application $application, array $options = [])
    {
        ...
        $description = new \_PhpScoperf62d28230928\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\_PhpScoperf62d28230928\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\_PhpScoperf62d28230928\Symfony\Component\Console\Input\InputOption $option) : array
    {
    ...
    private function getInputDefinitionData(\_PhpScoperf62d28230928\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\_PhpScoperf62d28230928\Symfony\Component\Console\Command\Command $command) : array
    {
        $command->getSynopsis();
