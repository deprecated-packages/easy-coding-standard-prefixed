 ...
 * @internal
 */
class JsonDescriptor extends \_PhpScoper971ef29294dd\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(\_PhpScoper971ef29294dd\Symfony\Component\Console\Application $application, array $options = [])
    {
        ...
        $description = new \_PhpScoper971ef29294dd\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\_PhpScoper971ef29294dd\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\_PhpScoper971ef29294dd\Symfony\Component\Console\Input\InputOption $option) : array
    {
    ...
    private function getInputDefinitionData(\_PhpScoper971ef29294dd\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\_PhpScoper971ef29294dd\Symfony\Component\Console\Command\Command $command) : array
    {
