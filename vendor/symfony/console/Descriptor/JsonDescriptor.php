 ...
 * @internal
 */
class JsonDescriptor extends \_PhpScoper9907e2e69ce3\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(Application $application, array $options = [])
    {
        ...
        $description = new \_PhpScoper9907e2e69ce3\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
