 ...
 * @internal
 */
class JsonDescriptor extends \_PhpScoper08fb1f8a2f44\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(Application $application, array $options = [])
    {
        ...
        $description = new \_PhpScoper08fb1f8a2f44\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
