 ...
 * @internal
 */
class JsonDescriptor extends \_PhpScoperc95ae4bf942a\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(\_PhpScoperc95ae4bf942a\Symfony\Component\Console\Application $application, array $options = [])
    {
        ...
        $description = new \_PhpScoperc95ae4bf942a\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\_PhpScoperc95ae4bf942a\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\_PhpScoperc95ae4bf942a\Symfony\Component\Console\Input\InputOption $option) : array
    {
    ...
    private function getInputDefinitionData(\_PhpScoperc95ae4bf942a\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\_PhpScoperc95ae4bf942a\Symfony\Component\Console\Command\Command $command) : array
    {
        $command->getSynopsis();
