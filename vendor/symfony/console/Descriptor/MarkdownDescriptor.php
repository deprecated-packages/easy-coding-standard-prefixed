 ...
 * @internal
 */
class MarkdownDescriptor extends \_PhpScopera22bb3f4d7b7\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(Application $application, array $options = [])
    {
        ...
        foreach ($description->getNamespaces() as $namespace) {
            if (\_PhpScopera22bb3f4d7b7\Symfony\Component\Console\Descriptor\ApplicationDescription::GLOBAL_NAMESPACE !== $namespace['id']) {
                $this->write("\n\n");
