 ...
 * @internal
 */
class MarkdownDescriptor extends \_PhpScopera658fe86acec\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(Application $application, array $options = [])
    {
        ...
        foreach ($description->getNamespaces() as $namespace) {
            if (\_PhpScopera658fe86acec\Symfony\Component\Console\Descriptor\ApplicationDescription::GLOBAL_NAMESPACE !== $namespace['id']) {
                $this->write("\n\n");
