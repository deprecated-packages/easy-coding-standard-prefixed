 ...
 * @internal
 */
class MarkdownDescriptor extends \_PhpScoper08fb1f8a2f44\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(Application $application, array $options = [])
    {
        ...
        foreach ($description->getNamespaces() as $namespace) {
            if (\_PhpScoper08fb1f8a2f44\Symfony\Component\Console\Descriptor\ApplicationDescription::GLOBAL_NAMESPACE !== $namespace['id']) {
                $this->write("\n\n");
