 ...
 * @internal
 */
class MarkdownDescriptor extends \_PhpScopercfeba9d8ad31\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeApplication(Application $application, array $options = [])
    {
        ...
        foreach ($description->getNamespaces() as $namespace) {
            if (\_PhpScopercfeba9d8ad31\Symfony\Component\Console\Descriptor\ApplicationDescription::GLOBAL_NAMESPACE !== $namespace['id']) {
                $this->write("\n\n");
