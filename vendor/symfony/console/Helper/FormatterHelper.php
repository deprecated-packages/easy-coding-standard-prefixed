 ...
 */
class FormatterHelper extends \_PhpScoperd8048db577a9\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoperd8048db577a9\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
