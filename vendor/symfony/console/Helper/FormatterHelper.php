 ...
 */
class FormatterHelper extends \_PhpScoperf5c57eca8aae\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoperf5c57eca8aae\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
