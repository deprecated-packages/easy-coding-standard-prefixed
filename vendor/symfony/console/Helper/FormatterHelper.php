 ...
 */
class FormatterHelper extends \_PhpScoperc98ae2003489\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoperc98ae2003489\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
