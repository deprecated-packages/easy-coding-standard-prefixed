 ...
 */
class FormatterHelper extends \_PhpScoper70d1796231ae\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper70d1796231ae\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
