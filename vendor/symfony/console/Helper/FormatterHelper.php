 ...
 */
class FormatterHelper extends \_PhpScopere050faf861e6\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScopere050faf861e6\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
