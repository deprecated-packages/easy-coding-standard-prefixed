 ...
 */
class FormatterHelper extends \_PhpScopera1f11cc38772\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScopera1f11cc38772\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
