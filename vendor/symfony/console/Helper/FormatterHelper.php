 ...
 */
class FormatterHelper extends \_PhpScoperf3dc21757def\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoperf3dc21757def\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
