 ...
 */
class FormatterHelper extends \_PhpScoper5f6e904600e7\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper5f6e904600e7\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
