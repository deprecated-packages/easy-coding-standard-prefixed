 ...
 */
class FormatterHelper extends \_PhpScoper86aa49a51982\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper86aa49a51982\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
