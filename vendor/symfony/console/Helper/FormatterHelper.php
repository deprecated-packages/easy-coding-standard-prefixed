 ...
 */
class FormatterHelper extends \_PhpScoper9a024705919c\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper9a024705919c\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
