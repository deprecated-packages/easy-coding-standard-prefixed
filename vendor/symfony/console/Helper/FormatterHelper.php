 ...
 */
class FormatterHelper extends \_PhpScoper457dd3bd73ba\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper457dd3bd73ba\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
