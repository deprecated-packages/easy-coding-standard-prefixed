 ...
 */
class FormatterHelper extends \_PhpScoper08686b2277af\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper08686b2277af\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
