 ...
 */
class FormatterHelper extends \_PhpScoperfb0714773dc5\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoperfb0714773dc5\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
