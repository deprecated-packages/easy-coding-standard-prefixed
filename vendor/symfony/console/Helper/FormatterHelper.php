 ...
 */
class FormatterHelper extends \_PhpScoper3f3a54dd086f\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper3f3a54dd086f\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
