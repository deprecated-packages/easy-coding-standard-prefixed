 ...
 */
class FormatterHelper extends \_PhpScoper82aa0193482e\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper82aa0193482e\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
