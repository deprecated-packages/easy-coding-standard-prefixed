 ...
 */
class FormatterHelper extends \_PhpScoper255a4eaff575\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper255a4eaff575\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
