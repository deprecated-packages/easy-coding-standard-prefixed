 ...
 */
class FormatterHelper extends \_PhpScopera609aff833be\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScopera609aff833be\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
