 ...
 */
class FormatterHelper extends \_PhpScoper971ef29294dd\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper971ef29294dd\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
