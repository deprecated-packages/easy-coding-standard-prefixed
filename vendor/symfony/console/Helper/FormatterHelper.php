 ...
 */
class FormatterHelper extends \_PhpScoper10b1b2c5ca55\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper10b1b2c5ca55\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
