 ...
 */
class FormatterHelper extends \_PhpScoper14718bfcc75e\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper14718bfcc75e\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
