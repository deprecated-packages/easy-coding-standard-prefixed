 ...
 */
class FormatterHelper extends \_PhpScoperf523baae4f87\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoperf523baae4f87\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
