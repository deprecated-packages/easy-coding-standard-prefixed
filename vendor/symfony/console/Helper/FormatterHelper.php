 ...
 */
class FormatterHelper extends \_PhpScoper6a8174766bf7\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper6a8174766bf7\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
