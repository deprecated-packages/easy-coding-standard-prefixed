 ...
 */
class FormatterHelper extends \_PhpScoperb0c6500a504c\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoperb0c6500a504c\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
