 ...
 */
class FormatterHelper extends \_PhpScoper86aebf8cf357\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper86aebf8cf357\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
