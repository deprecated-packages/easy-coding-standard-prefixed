 ...
 */
class FormatterHelper extends \_PhpScoper1ed8518cf1bf\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper1ed8518cf1bf\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
