 ...
 */
class FormatterHelper extends \_PhpScoper8a7636b3fdaf\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper8a7636b3fdaf\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
