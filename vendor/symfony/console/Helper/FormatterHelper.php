 ...
 */
class FormatterHelper extends \_PhpScoper7b319b4d8e1c\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper7b319b4d8e1c\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
