 ...
 */
class FormatterHelper extends \_PhpScoper4fc0030e9d22\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper4fc0030e9d22\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
