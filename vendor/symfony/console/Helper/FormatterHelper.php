 ...
 */
class FormatterHelper extends \_PhpScoper246d3630afdd\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper246d3630afdd\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
