 ...
 */
class FormatterHelper extends \_PhpScoper6b644dbe715d\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper6b644dbe715d\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
