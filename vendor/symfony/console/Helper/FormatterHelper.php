 ...
 */
class FormatterHelper extends \_PhpScoper0c0702cca4ac\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper0c0702cca4ac\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
