 ...
 */
class FormatterHelper extends \_PhpScoperf361a7d70552\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoperf361a7d70552\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
