 ...
 */
class FormatterHelper extends \_PhpScoper2f04ef4e8878\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper2f04ef4e8878\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
