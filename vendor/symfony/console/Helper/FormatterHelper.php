 ...
 */
class FormatterHelper extends \_PhpScoper8cb97064581a\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper8cb97064581a\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
