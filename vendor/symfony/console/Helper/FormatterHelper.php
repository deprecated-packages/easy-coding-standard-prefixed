 ...
 */
class FormatterHelper extends \_PhpScoperd47a2fa2a77e\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoperd47a2fa2a77e\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
