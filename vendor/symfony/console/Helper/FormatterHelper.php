 ...
 */
class FormatterHelper extends \_PhpScoper7d3888cf4297\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper7d3888cf4297\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
