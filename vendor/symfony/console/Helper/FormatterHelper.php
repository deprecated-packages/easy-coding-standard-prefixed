 ...
 */
class FormatterHelper extends \_PhpScopera909b9d9be2e\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScopera909b9d9be2e\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
