 ...
 */
class FormatterHelper extends \_PhpScoper488221d5cc83\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper488221d5cc83\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
