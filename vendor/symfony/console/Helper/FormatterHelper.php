 ...
 */
class FormatterHelper extends \_PhpScoper35ec99c463ee\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper35ec99c463ee\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
