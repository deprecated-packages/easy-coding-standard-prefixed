 ...
 */
class FormatterHelper extends \_PhpScoper57c79939064b\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper57c79939064b\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
