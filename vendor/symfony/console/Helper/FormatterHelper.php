 ...
 */
class FormatterHelper extends \_PhpScoper0ba97041430d\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScoper0ba97041430d\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
