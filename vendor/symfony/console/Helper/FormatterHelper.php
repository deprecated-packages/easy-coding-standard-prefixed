 ...
 */
class FormatterHelper extends \_PhpScopercd2fc5ef50ef\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \_PhpScopercd2fc5ef50ef\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
