...
class TableCell
{
    ...
    public function __construct(string $value = '', array $options = [])
    {
        ...
        if (isset($options['style']) && !$options['style'] instanceof \_PhpScoperfde42a25c345\Symfony\Component\Console\Helper\TableCellStyle) {
    ...
    public function getStyle() : ?\_PhpScoperfde42a25c345\Symfony\Component\Console\Helper\TableCellStyle
    {
