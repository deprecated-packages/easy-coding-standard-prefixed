...
class TableCell
{
    ...
    public function __construct(string $value = '', array $options = [])
    {
        ...
        if (isset($options['style']) && !$options['style'] instanceof \_PhpScoperd2a667bd5a98\Symfony\Component\Console\Helper\TableCellStyle) {
    ...
    public function getStyle() : ?\_PhpScoperd2a667bd5a98\Symfony\Component\Console\Helper\TableCellStyle
    {
