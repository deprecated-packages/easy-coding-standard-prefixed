...
class TableCell
{
    ...
    public function __construct(string $value = '', array $options = [])
    {
        ...
        if (isset($options['style']) && !$options['style'] instanceof \_PhpScoper653866602a9e\Symfony\Component\Console\Helper\TableCellStyle) {
    ...
    public function getStyle() : ?\_PhpScoper653866602a9e\Symfony\Component\Console\Helper\TableCellStyle
    {
