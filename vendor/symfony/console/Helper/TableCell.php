...
class TableCell
{
    ...
    public function __construct(string $value = '', array $options = [])
    {
        ...
        if (isset($options['style']) && !$options['style'] instanceof \_PhpScopereb9508917a55\Symfony\Component\Console\Helper\TableCellStyle) {
    ...
    public function getStyle() : ?\_PhpScopereb9508917a55\Symfony\Component\Console\Helper\TableCellStyle
    {
