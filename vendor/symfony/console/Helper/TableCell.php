...
class TableCell
{
    ...
    public function __construct(string $value = '', array $options = [])
    {
        ...
        if (isset($options['style']) && !$options['style'] instanceof \_PhpScopercae9e6ab5cea\Symfony\Component\Console\Helper\TableCellStyle) {
    ...
    public function getStyle() : ?\_PhpScopercae9e6ab5cea\Symfony\Component\Console\Helper\TableCellStyle
    {
