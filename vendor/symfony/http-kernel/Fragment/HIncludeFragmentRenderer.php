...
use _PhpScopercc9aec205203\Twig\Environment;
/**
 * Implements the Hinclude rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HIncludeFragmentRenderer extends \_PhpScopercc9aec205203\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
     ...
     */
    public function __construct(\_PhpScopercc9aec205203\Twig\Environment $twig = null, \_PhpScopercc9aec205203\Symfony\Component\HttpKernel\UriSigner $signer = null, string $globalDefaultTemplate = null, string $charset = 'utf-8')
    {
        $this->twig = $twig;
    ...
    public function render($uri, \_PhpScopercc9aec205203\Symfony\Component\HttpFoundation\Request $request, array $options = [])
    {
        ...
        return new \_PhpScopercc9aec205203\Symfony\Component\HttpFoundation\Response(\sprintf('<hx:include src="%s"%s>%s</hx:include>', $uri, $renderedAttributes, $content));
    }
    /**
     * {@inheritdoc}
     */
