...
use _PhpScoper807f8e74693b\Twig\Environment;
/**
 * Implements the Hinclude rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HIncludeFragmentRenderer extends \_PhpScoper807f8e74693b\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
     ...
     */
    public function __construct(\_PhpScoper807f8e74693b\Twig\Environment $twig = null, \_PhpScoper807f8e74693b\Symfony\Component\HttpKernel\UriSigner $signer = null, string $globalDefaultTemplate = null, string $charset = 'utf-8')
    {
        $this->twig = $twig;
    ...
    public function render($uri, \_PhpScoper807f8e74693b\Symfony\Component\HttpFoundation\Request $request, array $options = [])
    {
        ...
        return new \_PhpScoper807f8e74693b\Symfony\Component\HttpFoundation\Response(\sprintf('<hx:include src="%s"%s>%s</hx:include>', $uri, $renderedAttributes, $content));
    }
    /**
     * {@inheritdoc}
     */
