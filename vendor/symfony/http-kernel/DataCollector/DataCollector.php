...
use _PhpScoperba24099fc6fd\Symfony\Component\VarDumper\Caster\CutStub;
 ...
 */
abstract class DataCollector implements \_PhpScoperba24099fc6fd\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface
{
    /**
     * @var array|Data
     */
    ...
    {
        if ($var instanceof \_PhpScoperba24099fc6fd\Symfony\Component\VarDumper\Cloner\Data) {
            return $var;
        }
        if (null === $this->cloner) {
            $this->cloner = new \_PhpScoperba24099fc6fd\Symfony\Component\VarDumper\Cloner\VarCloner();
    ...
    {
        $casters = ['*' => function ($v, array $a, \_PhpScoperba24099fc6fd\Symfony\Component\VarDumper\Cloner\Stub $s, $isNested) {
            if (!$v instanceof \_PhpScoperba24099fc6fd\Symfony\Component\VarDumper\Cloner\Stub) {
                foreach ($a as $k => $v) {
                    if (\is_object($v) && !$v instanceof \DateTimeInterface && !$v instanceof \_PhpScoperba24099fc6fd\Symfony\Component\VarDumper\Cloner\Stub) {
                        $a[$k] = new \_PhpScoperba24099fc6fd\Symfony\Component\VarDumper\Caster\CutStub($v);
                    }
                }
            }
            return $a;
        }] + \_PhpScoperba24099fc6fd\Symfony\Component\VarDumper\Caster\ReflectionCaster::UNSET_CLOSURE_FILE_INFO;
        return $casters;
    }
    /**
     * @return array
