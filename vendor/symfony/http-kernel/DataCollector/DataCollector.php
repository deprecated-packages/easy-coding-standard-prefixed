...
use _PhpScoperdc8fbcd7c69d\Symfony\Component\VarDumper\Caster\CutStub;
 ...
 */
abstract class DataCollector implements \_PhpScoperdc8fbcd7c69d\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface
{
    /**
     * @var array|Data
     */
    ...
    {
        if ($var instanceof \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarDumper\Cloner\Data) {
            return $var;
        }
        if (null === $this->cloner) {
    ...
    {
        $casters = ['*' => function ($v, array $a, \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarDumper\Cloner\Stub $s, $isNested) {
            if (!$v instanceof \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarDumper\Cloner\Stub) {
                foreach ($a as $k => $v) {
                    if (\is_object($v) && !$v instanceof \DateTimeInterface && !$v instanceof \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarDumper\Cloner\Stub) {
                        $a[$k] = new \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarDumper\Caster\CutStub($v);
                    }
                }
            }
            return $a;
        }] + \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarDumper\Caster\ReflectionCaster::UNSET_CLOSURE_FILE_INFO;
        return $casters;
    }
    /**
     * @return array
