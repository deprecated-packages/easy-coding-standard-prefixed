...
use _PhpScoperc5bee3a837bb\Symfony\Component\VarDumper\Caster\CutStub;
use _PhpScoperc5bee3a837bb\Symfony\Component\VarDumper\Caster\ReflectionCaster;
 ...
 */
abstract class DataCollector implements \_PhpScoperc5bee3a837bb\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface
{
    /**
     * @var array|Data
     */
    ...
    {
        if ($var instanceof \_PhpScoperc5bee3a837bb\Symfony\Component\VarDumper\Cloner\Data) {
            return $var;
        }
        if (null === $this->cloner) {
            $this->cloner = new \_PhpScoperc5bee3a837bb\Symfony\Component\VarDumper\Cloner\VarCloner();
    ...
    {
        $casters = ['*' => function ($v, array $a, \_PhpScoperc5bee3a837bb\Symfony\Component\VarDumper\Cloner\Stub $s, $isNested) {
            if (!$v instanceof \_PhpScoperc5bee3a837bb\Symfony\Component\VarDumper\Cloner\Stub) {
                foreach ($a as $k => $v) {
                    if (\is_object($v) && !$v instanceof \DateTimeInterface && !$v instanceof \_PhpScoperc5bee3a837bb\Symfony\Component\VarDumper\Cloner\Stub) {
                        $a[$k] = new \_PhpScoperc5bee3a837bb\Symfony\Component\VarDumper\Caster\CutStub($v);
                    }
                }
            }
            return $a;
        }] + \_PhpScoperc5bee3a837bb\Symfony\Component\VarDumper\Caster\ReflectionCaster::UNSET_CLOSURE_FILE_INFO;
        return $casters;
    }
    /**
     * @return array
