...
use _PhpScoperad4b7e2c09d8\Symfony\Component\VarDumper\Caster\CutStub;
 ...
 */
abstract class DataCollector implements \_PhpScoperad4b7e2c09d8\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface
{
    /**
     * @var array|Data
     */
    ...
    {
        if ($var instanceof \_PhpScoperad4b7e2c09d8\Symfony\Component\VarDumper\Cloner\Data) {
            return $var;
        }
        if (null === $this->cloner) {
    ...
    {
        $casters = ['*' => function ($v, array $a, \_PhpScoperad4b7e2c09d8\Symfony\Component\VarDumper\Cloner\Stub $s, $isNested) {
            if (!$v instanceof \_PhpScoperad4b7e2c09d8\Symfony\Component\VarDumper\Cloner\Stub) {
                foreach ($a as $k => $v) {
                    if (\is_object($v) && !$v instanceof \DateTimeInterface && !$v instanceof \_PhpScoperad4b7e2c09d8\Symfony\Component\VarDumper\Cloner\Stub) {
                        $a[$k] = new \_PhpScoperad4b7e2c09d8\Symfony\Component\VarDumper\Caster\CutStub($v);
                    }
                }
            }
            return $a;
        }] + \_PhpScoperad4b7e2c09d8\Symfony\Component\VarDumper\Caster\ReflectionCaster::UNSET_CLOSURE_FILE_INFO;
        return $casters;
    }
    /**
     * @return array
