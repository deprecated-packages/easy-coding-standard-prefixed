...
use _PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag;
 ...
 */
class RequestDataCollector extends \_PhpScopere015d8a3273c\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \_PhpScopere015d8a3273c\Symfony\Component\EventDispatcher\EventSubscriberInterface, \_PhpScopere015d8a3273c\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    ...
    public function collect(\_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\Request $request, \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if ($response->isRedirect()) {
            $response->headers->setCookie(new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\Cookie('sf_redirect', \json_encode(['token' => $response->headers->get('x-debug-token'), 'route' => $request->attributes->get('_route', 'n/a'), 'method' => $request->getMethod(), 'controller' => $this->parseController($request->attributes->get('_controller')), 'status_code' => $statusCode, 'status_text' => \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\Response::$statusTexts[(int) $statusCode]]), 0, '/', null, $request->isSecure(), \true, \false, 'lax'));
        }
    ...
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_request']->getValue());
    }
    public function getRequestQuery()
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_query']->getValue());
    }
    public function getRequestFiles()
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_files']->getValue());
    }
    public function getRequestHeaders()
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_headers']->getValue());
    }
    public function getRequestServer($raw = \false)
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_server']->getValue($raw));
    }
    public function getRequestCookies($raw = \false)
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_cookies']->getValue($raw));
    }
    public function getRequestAttributes()
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_attributes']->getValue());
    }
    public function getResponseHeaders()
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_headers']->getValue());
    }
    public function getResponseCookies()
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_cookies']->getValue());
    }
    ...
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\HttpFoundation\ParameterBag($this->data['dotenv_vars']->getValue());
    }
    /**
     * Gets the route name.
     *
    ...
    {
        return [\_PhpScopere015d8a3273c\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER => 'onKernelController', \_PhpScopere015d8a3273c\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
    /**
     * {@inheritdoc}
     */
