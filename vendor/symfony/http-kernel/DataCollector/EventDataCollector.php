...
use _PhpScoperd47a2fa2a77e\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher;
 ...
 * @final
 */
class EventDataCollector extends \_PhpScoperd47a2fa2a77e\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \_PhpScoperd47a2fa2a77e\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $dispatcher;
    private $requestStack;
    private $currentRequest;
    public function __construct(\_PhpScoperd47a2fa2a77e\Symfony\Contracts\EventDispatcher\EventDispatcherInterface $dispatcher = null, \_PhpScoperd47a2fa2a77e\Symfony\Component\HttpFoundation\RequestStack $requestStack = null)
    {
    ...
    {
        $this->data = [];
        if ($this->dispatcher instanceof \_PhpScoperd47a2fa2a77e\Symfony\Contracts\Service\ResetInterface) {
            $this->dispatcher->reset();
        }
    }
    public function lateCollect()
    {
        if ($this->dispatcher instanceof \_PhpScoperd47a2fa2a77e\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher) {
