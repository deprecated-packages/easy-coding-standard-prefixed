...
use _PhpScoperfb0714773dc5\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher;
 ...
 * @final
 */
class EventDataCollector extends \_PhpScoperfb0714773dc5\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \_PhpScoperfb0714773dc5\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $dispatcher;
    private $requestStack;
    private $currentRequest;
    public function __construct(\_PhpScoperfb0714773dc5\Symfony\Contracts\EventDispatcher\EventDispatcherInterface $dispatcher = null, \_PhpScoperfb0714773dc5\Symfony\Component\HttpFoundation\RequestStack $requestStack = null)
    {
    ...
    {
        $this->data = [];
        if ($this->dispatcher instanceof \_PhpScoperfb0714773dc5\Symfony\Contracts\Service\ResetInterface) {
            $this->dispatcher->reset();
        }
    }
    public function lateCollect()
    {
        if ($this->dispatcher instanceof \_PhpScoperfb0714773dc5\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher) {
