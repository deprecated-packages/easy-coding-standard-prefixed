 ...
 */
class ExceptionDataCollector extends \_PhpScoper21fff473f90a\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScoper21fff473f90a\Symfony\Component\HttpFoundation\Request $request, \_PhpScoper21fff473f90a\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoper21fff473f90a\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
