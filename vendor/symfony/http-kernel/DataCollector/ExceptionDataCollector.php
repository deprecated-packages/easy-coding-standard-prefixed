 ...
 */
class ExceptionDataCollector extends \_PhpScoperdf6a0b341030\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScoperdf6a0b341030\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperdf6a0b341030\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoperdf6a0b341030\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
