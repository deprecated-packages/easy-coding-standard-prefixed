 ...
 */
class ExceptionDataCollector extends \_PhpScoper9ef667a5e42c\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScoper9ef667a5e42c\Symfony\Component\HttpFoundation\Request $request, \_PhpScoper9ef667a5e42c\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoper9ef667a5e42c\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
