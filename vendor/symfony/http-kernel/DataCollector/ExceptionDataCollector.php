 ...
 */
class ExceptionDataCollector extends \_PhpScoper79449c4e744b\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScoper79449c4e744b\Symfony\Component\HttpFoundation\Request $request, \_PhpScoper79449c4e744b\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoper79449c4e744b\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
