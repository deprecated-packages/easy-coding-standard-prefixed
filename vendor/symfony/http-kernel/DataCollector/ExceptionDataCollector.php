 ...
 */
class ExceptionDataCollector extends \_PhpScoperfcf15c26e033\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScoperfcf15c26e033\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperfcf15c26e033\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoperfcf15c26e033\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
