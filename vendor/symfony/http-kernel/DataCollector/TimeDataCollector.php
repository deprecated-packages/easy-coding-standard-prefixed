...
use _PhpScoperc4ea0f0bd23f\Symfony\Component\Stopwatch\StopwatchEvent;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 *
 * @final
 */
class TimeDataCollector extends \_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $kernel;
    protected $stopwatch;
    public function __construct(\_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\KernelInterface $kernel = null, \_PhpScoperc4ea0f0bd23f\Symfony\Component\Stopwatch\Stopwatch $stopwatch = null)
    {
        $this->kernel = $kernel;
    ...
    public function collect(\_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        $this->data = ['token' => $response->headers->get('X-Debug-Token'), 'start_time' => $startTime * 1000, 'events' => [], 'stopwatch_installed' => \class_exists(\_PhpScoperc4ea0f0bd23f\Symfony\Component\Stopwatch\Stopwatch::class, \false)];
    }
    /**
     * {@inheritdoc}
     */
