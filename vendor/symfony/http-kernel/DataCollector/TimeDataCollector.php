...
use _PhpScoperfcee700af3df\Symfony\Component\Stopwatch\StopwatchEvent;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 *
 * @final
 */
class TimeDataCollector extends \_PhpScoperfcee700af3df\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \_PhpScoperfcee700af3df\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $kernel;
    protected $stopwatch;
    public function __construct(\_PhpScoperfcee700af3df\Symfony\Component\HttpKernel\KernelInterface $kernel = null, \_PhpScoperfcee700af3df\Symfony\Component\Stopwatch\Stopwatch $stopwatch = null)
    {
        $this->kernel = $kernel;
    ...
    public function collect(\_PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        $this->data = ['token' => $response->headers->get('X-Debug-Token'), 'start_time' => $startTime * 1000, 'events' => [], 'stopwatch_installed' => \class_exists(\_PhpScoperfcee700af3df\Symfony\Component\Stopwatch\Stopwatch::class, \false)];
    }
    /**
     * {@inheritdoc}
     */
