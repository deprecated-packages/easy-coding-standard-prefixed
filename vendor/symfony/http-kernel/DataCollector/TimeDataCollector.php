 ...
 */
class TimeDataCollector extends \_PhpScoperc95ae4bf942a\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \_PhpScoperc95ae4bf942a\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $kernel;
    protected $stopwatch;
    public function __construct(\_PhpScoperc95ae4bf942a\Symfony\Component\HttpKernel\KernelInterface $kernel = null, \_PhpScoperc95ae4bf942a\Symfony\Component\Stopwatch\Stopwatch $stopwatch = null)
    {
        $this->kernel = $kernel;
    ...
    public function collect(\_PhpScoperc95ae4bf942a\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperc95ae4bf942a\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        $this->data = ['token' => $response->headers->get('X-Debug-Token'), 'start_time' => $startTime * 1000, 'events' => [], 'stopwatch_installed' => \class_exists(\_PhpScoperc95ae4bf942a\Symfony\Component\Stopwatch\Stopwatch::class, \false)];
    }
    /**
     * {@inheritdoc}
     */
