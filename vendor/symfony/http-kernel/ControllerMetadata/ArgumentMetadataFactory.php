...
use _PhpScoper78e1a27e740b\Symfony\Component\HttpKernel\Exception\InvalidMetadataException;
/**
 * Builds {@see ArgumentMetadata} objects based on the given Controller.
 *
 * @author Iltar van der Berg <kjarli@gmail.com>
 */
final class ArgumentMetadataFactory implements \_PhpScoper78e1a27e740b\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactoryInterface
{
    /**
     * {@inheritdoc}
     */
    public function createArgumentMetadata($controller) : array
    {
        ...
        foreach ($reflection->getParameters() as $param) {
            ...
            $arguments[] = new \_PhpScoper78e1a27e740b\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata($param->getName(), $this->getType($param, $reflection), $param->isVariadic(), $param->isDefaultValueAvailable(), $param->isDefaultValueAvailable() ? $param->getDefaultValue() : null, $param->allowsNull(), $attribute);
        }
        return $arguments;
    }
    /**
