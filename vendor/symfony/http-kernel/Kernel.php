...
use _PhpScopera22bb3f4d7b7\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator;
use _PhpScopera22bb3f4d7b7\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper;
use _PhpScopera22bb3f4d7b7\Symfony\Component\Config\ConfigCache;
...
use _PhpScopera22bb3f4d7b7\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
...
use _PhpScopera22bb3f4d7b7\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use _PhpScopera22bb3f4d7b7\Symfony\Component\DependencyInjection\Loader\DirectoryLoader;
use _PhpScopera22bb3f4d7b7\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use _PhpScopera22bb3f4d7b7\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use _PhpScopera22bb3f4d7b7\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use _PhpScopera22bb3f4d7b7\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
use _PhpScopera22bb3f4d7b7\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
...
use _PhpScopera22bb3f4d7b7\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use _PhpScopera22bb3f4d7b7\Symfony\Component\HttpKernel\Config\FileLocator;
use _PhpScopera22bb3f4d7b7\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use _PhpScopera22bb3f4d7b7\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
 ...
 */
abstract class Kernel implements \_PhpScopera22bb3f4d7b7\Symfony\Component\HttpKernel\KernelInterface, \_PhpScopera22bb3f4d7b7\Symfony\Component\HttpKernel\RebootableInterface, \_PhpScopera22bb3f4d7b7\Symfony\Component\HttpKernel\TerminableInterface
{
    /**
     * @var BundleInterface[]
     */
    ...
    public function terminate(Request $request, Response $response)
    {
        ...
        if ($this->getHttpKernel() instanceof \_PhpScopera22bb3f4d7b7\Symfony\Component\HttpKernel\TerminableInterface) {
    ...
    protected function getContainerBuilder()
    {
        ...
        if (\class_exists(\_PhpScopera22bb3f4d7b7\ProxyManager\Configuration::class) && \class_exists(RuntimeInstantiator::class)) {
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass)
    {
        ...
        if (\class_exists(\_PhpScopera22bb3f4d7b7\ProxyManager\Configuration::class) && \class_exists(ProxyDumper::class)) {
