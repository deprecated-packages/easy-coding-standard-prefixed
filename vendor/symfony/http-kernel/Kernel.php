...
use _PhpScoperc7a2896cc805\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator;
use _PhpScoperc7a2896cc805\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper;
use _PhpScoperc7a2896cc805\Symfony\Component\Config\ConfigCache;
...
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
...
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Loader\DirectoryLoader;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
...
use _PhpScoperc7a2896cc805\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use _PhpScoperc7a2896cc805\Symfony\Component\HttpKernel\Config\FileLocator;
use _PhpScoperc7a2896cc805\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use _PhpScoperc7a2896cc805\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
 ...
 */
abstract class Kernel implements \_PhpScoperc7a2896cc805\Symfony\Component\HttpKernel\KernelInterface, \_PhpScoperc7a2896cc805\Symfony\Component\HttpKernel\RebootableInterface, \_PhpScoperc7a2896cc805\Symfony\Component\HttpKernel\TerminableInterface
{
    /**
     * @var BundleInterface[]
     */
    ...
    public function terminate(Request $request, Response $response)
    {
        ...
        if ($this->getHttpKernel() instanceof \_PhpScoperc7a2896cc805\Symfony\Component\HttpKernel\TerminableInterface) {
     ...
     * {@inheritdoc}
     */
    public function handle(Request $request, int $type = \_PhpScoperc7a2896cc805\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, bool $catch = \true)
    {
        if (!$this->booted) {
    ...
    {
        $class = static::class;
        $class = \false !== \strpos($class, "@anonymous\x00") ? \get_parent_class($class) . \str_replace('.', '_', ContainerBuilder::hash($class)) : $class;
    ...
    protected function getContainerBuilder()
    {
        ...
        if (\class_exists(\_PhpScoperc7a2896cc805\ProxyManager\Configuration::class) && \class_exists(RuntimeInstantiator::class)) {
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass)
    {
        ...
        if (\class_exists(\_PhpScoperc7a2896cc805\ProxyManager\Configuration::class) && \class_exists(ProxyDumper::class)) {
