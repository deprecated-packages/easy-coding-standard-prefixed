...
use _PhpScopercfeba9d8ad31\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator;
use _PhpScopercfeba9d8ad31\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper;
use _PhpScopercfeba9d8ad31\Symfony\Component\Config\ConfigCache;
...
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
...
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Loader\DirectoryLoader;
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
...
use _PhpScopercfeba9d8ad31\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use _PhpScopercfeba9d8ad31\Symfony\Component\HttpKernel\Config\FileLocator;
use _PhpScopercfeba9d8ad31\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use _PhpScopercfeba9d8ad31\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
 ...
 */
abstract class Kernel implements \_PhpScopercfeba9d8ad31\Symfony\Component\HttpKernel\KernelInterface, \_PhpScopercfeba9d8ad31\Symfony\Component\HttpKernel\RebootableInterface, \_PhpScopercfeba9d8ad31\Symfony\Component\HttpKernel\TerminableInterface
{
    /**
     * @var BundleInterface[]
     */
    ...
    public function terminate(Request $request, Response $response)
    {
        ...
        if ($this->getHttpKernel() instanceof \_PhpScopercfeba9d8ad31\Symfony\Component\HttpKernel\TerminableInterface) {
    ...
    protected function getContainerBuilder()
    {
        ...
        if (\class_exists(\_PhpScopercfeba9d8ad31\ProxyManager\Configuration::class) && \class_exists(RuntimeInstantiator::class)) {
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass)
    {
        ...
        if (\class_exists(\_PhpScopercfeba9d8ad31\ProxyManager\Configuration::class) && \class_exists(ProxyDumper::class)) {
