...
use _PhpScoperff1e514762b4\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator;
use _PhpScoperff1e514762b4\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper;
use _PhpScoperff1e514762b4\Symfony\Component\Config\ConfigCache;
...
use _PhpScoperff1e514762b4\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
...
use _PhpScoperff1e514762b4\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use _PhpScoperff1e514762b4\Symfony\Component\DependencyInjection\Loader\DirectoryLoader;
use _PhpScoperff1e514762b4\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use _PhpScoperff1e514762b4\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use _PhpScoperff1e514762b4\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use _PhpScoperff1e514762b4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
use _PhpScoperff1e514762b4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
...
use _PhpScoperff1e514762b4\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use _PhpScoperff1e514762b4\Symfony\Component\HttpKernel\Config\FileLocator;
use _PhpScoperff1e514762b4\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use _PhpScoperff1e514762b4\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
 ...
 */
abstract class Kernel implements \_PhpScoperff1e514762b4\Symfony\Component\HttpKernel\KernelInterface, \_PhpScoperff1e514762b4\Symfony\Component\HttpKernel\RebootableInterface, \_PhpScoperff1e514762b4\Symfony\Component\HttpKernel\TerminableInterface
{
    /**
     * @var BundleInterface[]
     */
    ...
    public function terminate(Request $request, Response $response)
    {
        ...
        if ($this->getHttpKernel() instanceof \_PhpScoperff1e514762b4\Symfony\Component\HttpKernel\TerminableInterface) {
     ...
     * {@inheritdoc}
     */
    public function handle(Request $request, int $type = \_PhpScoperff1e514762b4\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, bool $catch = \true)
    {
        if (!$this->booted) {
    ...
    protected function getContainerBuilder()
    {
        ...
        if (\class_exists(\_PhpScoperff1e514762b4\ProxyManager\Configuration::class) && \class_exists(RuntimeInstantiator::class)) {
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass)
    {
        ...
        if (\class_exists(\_PhpScoperff1e514762b4\ProxyManager\Configuration::class) && \class_exists(ProxyDumper::class)) {
