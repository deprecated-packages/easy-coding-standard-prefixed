 ...
 */
namespace _PhpScoperd2a667bd5a98\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \_PhpScoperd2a667bd5a98\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\_PhpScoperd2a667bd5a98\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\_PhpScoperd2a667bd5a98\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScoperd2a667bd5a98\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \_PhpScoperd2a667bd5a98\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \_PhpScoperd2a667bd5a98\Symfony\Component\HttpKernel\Profiler\Profile($token);
