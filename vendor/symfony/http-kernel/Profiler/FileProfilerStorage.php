 ...
 */
namespace _PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \_PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\_PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\_PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \_PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \_PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\Profiler\Profile($token);
