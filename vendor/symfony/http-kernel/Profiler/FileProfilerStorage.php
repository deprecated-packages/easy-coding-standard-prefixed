 ...
 */
namespace _PhpScoperf3f1be0d8a30\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \_PhpScoperf3f1be0d8a30\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read($token) : ?\_PhpScoperf3f1be0d8a30\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\_PhpScoperf3f1be0d8a30\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScoperf3f1be0d8a30\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \_PhpScoperf3f1be0d8a30\Symfony\Component\HttpKernel\Profiler\Profile($token);
