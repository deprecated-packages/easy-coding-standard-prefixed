 ...
 */
namespace _PhpScoperd675aaf00c76\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \_PhpScoperd675aaf00c76\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read($token) : ?\_PhpScoperd675aaf00c76\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\_PhpScoperd675aaf00c76\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScoperd675aaf00c76\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \_PhpScoperd675aaf00c76\Symfony\Component\HttpKernel\Profiler\Profile($token);
