 ...
 */
namespace _PhpScoperc64a4ac1af35\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \_PhpScoperc64a4ac1af35\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read($token) : ?\_PhpScoperc64a4ac1af35\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\_PhpScoperc64a4ac1af35\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScoperc64a4ac1af35\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \_PhpScoperc64a4ac1af35\Symfony\Component\HttpKernel\Profiler\Profile($token);
