 ...
 */
class FileProfilerStorage implements \_PhpScoper83b3b9a317c0\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
    ...
    public function write(\_PhpScoper83b3b9a317c0\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScoper83b3b9a317c0\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \_PhpScoper83b3b9a317c0\Symfony\Component\HttpKernel\Profiler\Profile($token);
