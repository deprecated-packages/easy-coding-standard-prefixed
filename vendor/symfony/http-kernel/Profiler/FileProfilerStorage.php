 ...
 */
namespace _PhpScopera37d6fb0b1ab\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \_PhpScopera37d6fb0b1ab\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read($token) : ?\_PhpScopera37d6fb0b1ab\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\_PhpScopera37d6fb0b1ab\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScopera37d6fb0b1ab\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \_PhpScopera37d6fb0b1ab\Symfony\Component\HttpKernel\Profiler\Profile($token);
