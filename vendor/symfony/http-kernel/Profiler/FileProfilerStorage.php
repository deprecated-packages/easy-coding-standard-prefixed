 ...
 */
namespace _PhpScopere7e518ee6a5b\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \_PhpScopere7e518ee6a5b\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\_PhpScopere7e518ee6a5b\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\_PhpScopere7e518ee6a5b\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScopere7e518ee6a5b\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \_PhpScopere7e518ee6a5b\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \_PhpScopere7e518ee6a5b\Symfony\Component\HttpKernel\Profiler\Profile($token);
