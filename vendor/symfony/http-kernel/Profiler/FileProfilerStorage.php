 ...
 */
namespace _PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\Profiler\Profile($token);
