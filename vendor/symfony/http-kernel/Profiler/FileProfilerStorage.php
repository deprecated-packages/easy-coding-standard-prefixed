 ...
 */
namespace _PhpScoper246d3630afdd\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \_PhpScoper246d3630afdd\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\_PhpScoper246d3630afdd\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\_PhpScoper246d3630afdd\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScoper246d3630afdd\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \_PhpScoper246d3630afdd\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \_PhpScoper246d3630afdd\Symfony\Component\HttpKernel\Profiler\Profile($token);
