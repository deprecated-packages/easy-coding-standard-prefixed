 ...
 */
class FileProfilerStorage implements \_PhpScoper11a6395266c4\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
    ...
    public function write(\_PhpScoper11a6395266c4\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\_PhpScoper11a6395266c4\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \_PhpScoper11a6395266c4\Symfony\Component\HttpKernel\Profiler\Profile($token);
