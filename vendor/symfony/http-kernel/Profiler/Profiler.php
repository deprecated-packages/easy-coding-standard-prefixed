...
use _PhpScoper855b7fb41c61\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface;
...
class Profiler implements ResetInterface
{
    ...
    private $enabled = \true;
    public function __construct(\_PhpScoper855b7fb41c61\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface $storage, LoggerInterface $logger = null, bool $enable = \true)
    {
     ...
     * @return bool
     */
    public function saveProfile(\_PhpScoper855b7fb41c61\Symfony\Component\HttpKernel\Profiler\Profile $profile)
    {
        // late collect
    ...
    public function collect(Request $request, Response $response, \Throwable $exception = null)
    {
        ...
        $profile = new \_PhpScoper855b7fb41c61\Symfony\Component\HttpKernel\Profiler\Profile(\substr(\hash('sha256', \uniqid(\mt_rand(), \true)), 0, 6));
        $profile->setTime(\time());
