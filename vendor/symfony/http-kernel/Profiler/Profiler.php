...
use ECSPrefix20210507\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface;
...
class Profiler implements ResetInterface
{
    ...
    public function collect($request, $response, $exception = null)
    {
        ...
        $profile = new \ECSPrefix20210507\Symfony\Component\HttpKernel\Profiler\Profile(\substr(\hash('sha256', \uniqid(\mt_rand(), \true)), 0, 6));
        $profile->setTime(\time());
