 ...
 */
namespace _PhpScoperac4e86be08e5\Symfony\Component\HttpKernel\Config;

use _PhpScoperac4e86be08e5\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperac4e86be08e5\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperac4e86be08e5\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
