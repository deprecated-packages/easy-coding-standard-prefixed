 ...
 */
namespace _PhpScoperd1a5bf00e83e\Symfony\Component\HttpKernel\Config;

use _PhpScoperd1a5bf00e83e\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperd1a5bf00e83e\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperd1a5bf00e83e\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
