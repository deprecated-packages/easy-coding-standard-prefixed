 ...
 */
namespace _PhpScoper065e4ba46e6d\Symfony\Component\HttpKernel\Config;

use _PhpScoper065e4ba46e6d\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper065e4ba46e6d\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper065e4ba46e6d\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
