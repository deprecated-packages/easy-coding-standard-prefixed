 ...
 */
namespace _PhpScoper4848279dba07\Symfony\Component\HttpKernel\Config;

use _PhpScoper4848279dba07\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper4848279dba07\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper4848279dba07\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
