 ...
 */
namespace _PhpScoper3a22e8e0bd94\Symfony\Component\HttpKernel\Config;

use _PhpScoper3a22e8e0bd94\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper3a22e8e0bd94\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper3a22e8e0bd94\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
