 ...
 */
namespace _PhpScoper967c4b7e296e\Symfony\Component\HttpKernel\Config;

use _PhpScoper967c4b7e296e\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper967c4b7e296e\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper967c4b7e296e\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
