 ...
 */
namespace _PhpScoperaa402dd1b1f1\Symfony\Component\HttpKernel\Config;

use _PhpScoperaa402dd1b1f1\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperaa402dd1b1f1\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperaa402dd1b1f1\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
