 ...
 */
namespace _PhpScoperd35c27cd4b09\Symfony\Component\HttpKernel\Config;

use _PhpScoperd35c27cd4b09\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperd35c27cd4b09\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperd35c27cd4b09\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
