 ...
 */
namespace _PhpScopercf909b66eba8\Symfony\Component\HttpKernel\Config;

use _PhpScopercf909b66eba8\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopercf909b66eba8\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopercf909b66eba8\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
