 ...
 */
namespace _PhpScoperb73f9e44f4eb\Symfony\Component\HttpKernel\Config;

use _PhpScoperb73f9e44f4eb\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperb73f9e44f4eb\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperb73f9e44f4eb\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
