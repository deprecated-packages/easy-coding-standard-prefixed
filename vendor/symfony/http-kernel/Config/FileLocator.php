 ...
 */
namespace _PhpScoper6c2f17c43d2d\Symfony\Component\HttpKernel\Config;

use _PhpScoper6c2f17c43d2d\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper6c2f17c43d2d\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper6c2f17c43d2d\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
