 ...
 */
namespace _PhpScoper8dd2e1c340b1\Symfony\Component\HttpKernel\Config;

use _PhpScoper8dd2e1c340b1\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper8dd2e1c340b1\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper8dd2e1c340b1\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
