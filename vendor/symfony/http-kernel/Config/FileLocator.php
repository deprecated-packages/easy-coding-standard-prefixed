 ...
 */
namespace _PhpScoper992f4af8b9e0\Symfony\Component\HttpKernel\Config;

use _PhpScoper992f4af8b9e0\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper992f4af8b9e0\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper992f4af8b9e0\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
