 ...
 */
namespace _PhpScopera8f555a7493c\Symfony\Component\HttpKernel\Config;

use _PhpScopera8f555a7493c\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopera8f555a7493c\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopera8f555a7493c\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
