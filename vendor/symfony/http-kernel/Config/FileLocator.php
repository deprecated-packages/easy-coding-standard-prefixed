 ...
 */
namespace _PhpScoperc753ccca5a0c\Symfony\Component\HttpKernel\Config;

use _PhpScoperc753ccca5a0c\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperc753ccca5a0c\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperc753ccca5a0c\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
