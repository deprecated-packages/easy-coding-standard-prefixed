 ...
 */
namespace _PhpScoper58a0a169dcfb\Symfony\Component\HttpKernel\Config;

use _PhpScoper58a0a169dcfb\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper58a0a169dcfb\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper58a0a169dcfb\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
