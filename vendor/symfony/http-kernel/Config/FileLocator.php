 ...
 */
namespace _PhpScoper02b5d1bf8fec\Symfony\Component\HttpKernel\Config;

use _PhpScoper02b5d1bf8fec\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper02b5d1bf8fec\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper02b5d1bf8fec\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
