 ...
 */
namespace _PhpScoperfaaf57618f34\Symfony\Component\HttpKernel\Config;

use _PhpScoperfaaf57618f34\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperfaaf57618f34\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperfaaf57618f34\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
