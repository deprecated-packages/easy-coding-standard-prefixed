 ...
 */
namespace _PhpScopera37d6fb0b1ab\Symfony\Component\HttpKernel\Config;

use _PhpScopera37d6fb0b1ab\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopera37d6fb0b1ab\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopera37d6fb0b1ab\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
