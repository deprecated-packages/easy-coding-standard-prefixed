 ...
 */
namespace _PhpScoper3fa05b4669af\Symfony\Component\HttpKernel\Config;

use _PhpScoper3fa05b4669af\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper3fa05b4669af\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper3fa05b4669af\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
