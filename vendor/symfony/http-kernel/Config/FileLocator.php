 ...
 */
namespace _PhpScoper1103e00fb46b\Symfony\Component\HttpKernel\Config;

use _PhpScoper1103e00fb46b\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper1103e00fb46b\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper1103e00fb46b\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
