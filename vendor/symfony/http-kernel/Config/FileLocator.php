 ...
 */
namespace _PhpScoperc95ae4bf942a\Symfony\Component\HttpKernel\Config;

use _PhpScoperc95ae4bf942a\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperc95ae4bf942a\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperc95ae4bf942a\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
