 ...
 */
namespace _PhpScoperdc8fbcd7c69d\Symfony\Component\HttpKernel\Config;

use _PhpScoperdc8fbcd7c69d\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperdc8fbcd7c69d\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperdc8fbcd7c69d\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
