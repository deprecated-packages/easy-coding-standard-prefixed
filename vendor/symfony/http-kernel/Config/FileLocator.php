 ...
 */
namespace _PhpScoper17bb67c99ade\Symfony\Component\HttpKernel\Config;

use _PhpScoper17bb67c99ade\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper17bb67c99ade\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper17bb67c99ade\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
