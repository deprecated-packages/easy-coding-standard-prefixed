 ...
 */
namespace _PhpScoperc5bee3a837bb\Symfony\Component\HttpKernel\Config;

use _PhpScoperc5bee3a837bb\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperc5bee3a837bb\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperc5bee3a837bb\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
