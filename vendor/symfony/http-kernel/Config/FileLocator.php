 ...
 */
namespace _PhpScoper2a8ad010dfbd\Symfony\Component\HttpKernel\Config;

use _PhpScoper2a8ad010dfbd\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper2a8ad010dfbd\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper2a8ad010dfbd\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
