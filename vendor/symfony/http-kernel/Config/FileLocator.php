 ...
 */
namespace _PhpScoper81b3ff5ab9fe\Symfony\Component\HttpKernel\Config;

use _PhpScoper81b3ff5ab9fe\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper81b3ff5ab9fe\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper81b3ff5ab9fe\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
