 ...
 */
namespace _PhpScoperdf15f2b748e9\Symfony\Component\HttpKernel\Config;

use _PhpScoperdf15f2b748e9\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperdf15f2b748e9\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperdf15f2b748e9\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
