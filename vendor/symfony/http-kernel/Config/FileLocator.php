 ...
 */
namespace _PhpScoper7c1f54fd2f3a\Symfony\Component\HttpKernel\Config;

use _PhpScoper7c1f54fd2f3a\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper7c1f54fd2f3a\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper7c1f54fd2f3a\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
