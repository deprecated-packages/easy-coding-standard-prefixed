 ...
 */
namespace _PhpScopere4fa57261c04\Symfony\Component\HttpKernel\Config;

use _PhpScopere4fa57261c04\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopere4fa57261c04\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopere4fa57261c04\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {
