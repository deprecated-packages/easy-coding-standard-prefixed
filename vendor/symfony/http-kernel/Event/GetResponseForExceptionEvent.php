 ...
 */
class GetResponseForExceptionEvent extends \_PhpScoper21fff473f90a\Symfony\Component\HttpKernel\Event\RequestEvent
{
    private $throwable;
    private $exception;
    private $allowCustomResponseCode = \false;
    public function __construct(\_PhpScoper21fff473f90a\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \_PhpScoper21fff473f90a\Symfony\Component\HttpFoundation\Request $request, int $requestType, \Throwable $e)
    {
    ...
    public function getException()
    {
        ...
        return $this->exception ?? ($this->exception = $this->throwable instanceof \Exception ? $this->throwable : new \_PhpScoper21fff473f90a\Symfony\Component\Debug\Exception\FatalThrowableError($this->throwable));
    }
    /**
