 ...
 */
class GetResponseForExceptionEvent extends \_PhpScoperb09c3ec8e01a\Symfony\Component\HttpKernel\Event\RequestEvent
{
    private $throwable;
    private $exception;
    private $allowCustomResponseCode = \false;
    public function __construct(\_PhpScoperb09c3ec8e01a\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \_PhpScoperb09c3ec8e01a\Symfony\Component\HttpFoundation\Request $request, int $requestType, \Throwable $e)
    {
    ...
    public function getException()
    {
        ...
        return $this->exception ?? ($this->exception = $this->throwable instanceof \Exception ? $this->throwable : new \_PhpScoperb09c3ec8e01a\Symfony\Component\Debug\Exception\FatalThrowableError($this->throwable));
    }
    /**
