 ...
 */
final class TraceableValueResolver implements \_PhpScopercf327c47dfc5\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopercf327c47dfc5\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopercf327c47dfc5\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;
