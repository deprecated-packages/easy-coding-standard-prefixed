 ...
 */
final class TraceableValueResolver implements \_PhpScopera1a51450b61d\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopera1a51450b61d\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopera1a51450b61d\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;
