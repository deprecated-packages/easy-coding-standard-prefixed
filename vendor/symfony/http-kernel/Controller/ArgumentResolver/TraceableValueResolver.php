 ...
 */
final class TraceableValueResolver implements \_PhpScopere015d8a3273c\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopere015d8a3273c\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopere015d8a3273c\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;
