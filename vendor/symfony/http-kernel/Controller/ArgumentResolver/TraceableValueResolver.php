 ...
 */
final class TraceableValueResolver implements \_PhpScopere4fa57261c04\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopere4fa57261c04\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopere4fa57261c04\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;
