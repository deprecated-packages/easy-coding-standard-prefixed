 ...
 */
final class SessionValueResolver implements \_PhpScoper528afa732cbd\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoper528afa732cbd\Symfony\Component\HttpFoundation\Request $request, \_PhpScoper528afa732cbd\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoper528afa732cbd\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoper528afa732cbd\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
