 ...
 */
final class SessionValueResolver implements \_PhpScoperf65af7a6d9a0\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoperf65af7a6d9a0\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperf65af7a6d9a0\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoperf65af7a6d9a0\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoperf65af7a6d9a0\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
