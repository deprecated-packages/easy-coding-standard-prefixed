 ...
 */
final class SessionValueResolver implements \_PhpScoper0d0ee1ba46d4\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoper0d0ee1ba46d4\Symfony\Component\HttpFoundation\Request $request, \_PhpScoper0d0ee1ba46d4\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoper0d0ee1ba46d4\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoper0d0ee1ba46d4\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
