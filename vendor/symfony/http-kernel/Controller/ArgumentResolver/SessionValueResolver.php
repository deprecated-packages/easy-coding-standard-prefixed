 ...
 */
final class SessionValueResolver implements \_PhpScoper8ca6426d4e0c\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoper8ca6426d4e0c\Symfony\Component\HttpFoundation\Request $request, \_PhpScoper8ca6426d4e0c\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoper8ca6426d4e0c\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoper8ca6426d4e0c\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
