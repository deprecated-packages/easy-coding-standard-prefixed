 ...
 */
final class SessionValueResolver implements \_PhpScoperc64a4ac1af35\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoperc64a4ac1af35\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperc64a4ac1af35\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoperc64a4ac1af35\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoperc64a4ac1af35\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
