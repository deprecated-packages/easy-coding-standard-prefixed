 ...
 */
final class SessionValueResolver implements \_PhpScopere4fa57261c04\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScopere4fa57261c04\Symfony\Component\HttpFoundation\Request $request, \_PhpScopere4fa57261c04\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScopere4fa57261c04\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScopere4fa57261c04\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
