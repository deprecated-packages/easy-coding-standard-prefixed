 ...
 */
final class SessionValueResolver implements \_PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScopercd2fc5ef50ef\Symfony\Component\HttpFoundation\Request $request, \_PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScopercd2fc5ef50ef\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScopercd2fc5ef50ef\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
