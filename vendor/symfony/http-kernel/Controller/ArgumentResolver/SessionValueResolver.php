 ...
 */
final class SessionValueResolver implements \_PhpScoperf361a7d70552\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoperf361a7d70552\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperf361a7d70552\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoperf361a7d70552\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoperf361a7d70552\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
