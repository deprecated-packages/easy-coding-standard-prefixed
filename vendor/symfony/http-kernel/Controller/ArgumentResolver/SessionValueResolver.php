 ...
 */
final class SessionValueResolver implements \_PhpScoperd8048db577a9\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoperd8048db577a9\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperd8048db577a9\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoperd8048db577a9\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoperd8048db577a9\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
