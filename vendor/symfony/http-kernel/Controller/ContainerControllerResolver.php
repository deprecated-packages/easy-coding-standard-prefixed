 ...
 */
class ContainerControllerResolver extends \_PhpScoperd8b12759ee0d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperd8b12759ee0d\Psr\Container\ContainerInterface $container, \_PhpScoperd8b12759ee0d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperd8b12759ee0d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
