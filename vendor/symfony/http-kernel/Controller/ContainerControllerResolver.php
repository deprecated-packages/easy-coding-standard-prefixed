 ...
 */
class ContainerControllerResolver extends \_PhpScoperb383f16e851e\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperb383f16e851e\Psr\Container\ContainerInterface $container, \_PhpScoperb383f16e851e\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperb383f16e851e\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
