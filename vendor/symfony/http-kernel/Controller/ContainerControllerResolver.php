 ...
 */
class ContainerControllerResolver extends \_PhpScoper4d3fa30a680b\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper4d3fa30a680b\Psr\Container\ContainerInterface $container, \_PhpScoper4d3fa30a680b\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper4d3fa30a680b\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
