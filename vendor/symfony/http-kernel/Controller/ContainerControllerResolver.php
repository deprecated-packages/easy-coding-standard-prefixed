 ...
 */
class ContainerControllerResolver extends \_PhpScoperc75fd40d7a6e\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperc75fd40d7a6e\Psr\Container\ContainerInterface $container, \_PhpScoperc75fd40d7a6e\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperc75fd40d7a6e\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
