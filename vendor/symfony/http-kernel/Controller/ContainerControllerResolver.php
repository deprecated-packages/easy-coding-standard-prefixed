 ...
 */
class ContainerControllerResolver extends \_PhpScoperaba240c3d5f1\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperaba240c3d5f1\Psr\Container\ContainerInterface $container, \_PhpScoperaba240c3d5f1\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperaba240c3d5f1\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
