 ...
 */
class ContainerControllerResolver extends \_PhpScoper79449c4e744b\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper79449c4e744b\Psr\Container\ContainerInterface $container, \_PhpScoper79449c4e744b\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper79449c4e744b\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
