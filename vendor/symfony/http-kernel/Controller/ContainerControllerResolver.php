 ...
 */
class ContainerControllerResolver extends \_PhpScopera6f918786d5c\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera6f918786d5c\Psr\Container\ContainerInterface $container, \_PhpScopera6f918786d5c\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera6f918786d5c\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
