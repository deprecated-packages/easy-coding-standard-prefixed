 ...
 */
class ContainerControllerResolver extends \_PhpScoperea337ed74749\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperea337ed74749\Psr\Container\ContainerInterface $container, \_PhpScoperea337ed74749\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperea337ed74749\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
