 ...
 */
class ContainerControllerResolver extends \_PhpScoperd8048db577a9\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperd8048db577a9\Psr\Container\ContainerInterface $container, \_PhpScoperd8048db577a9\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperd8048db577a9\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
