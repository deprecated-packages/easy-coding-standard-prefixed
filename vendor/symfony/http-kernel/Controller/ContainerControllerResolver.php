 ...
 */
class ContainerControllerResolver extends \_PhpScoper8de082cbb8c7\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper8de082cbb8c7\Psr\Container\ContainerInterface $container, \_PhpScoper8de082cbb8c7\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper8de082cbb8c7\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
