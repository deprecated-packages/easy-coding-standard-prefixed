 ...
 */
class ContainerControllerResolver extends \_PhpScopera1a51450b61d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera1a51450b61d\Psr\Container\ContainerInterface $container, \_PhpScopera1a51450b61d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera1a51450b61d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
