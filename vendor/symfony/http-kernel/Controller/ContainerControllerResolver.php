 ...
 */
class ContainerControllerResolver extends \_PhpScoper1ed8518cf1bf\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper1ed8518cf1bf\Psr\Container\ContainerInterface $container, \_PhpScoper1ed8518cf1bf\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper1ed8518cf1bf\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
