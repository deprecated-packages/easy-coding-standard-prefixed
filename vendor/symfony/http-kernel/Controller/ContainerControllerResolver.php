 ...
 */
class ContainerControllerResolver extends \_PhpScoper589e8c04a9ef\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper589e8c04a9ef\Psr\Container\ContainerInterface $container, \_PhpScoper589e8c04a9ef\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
