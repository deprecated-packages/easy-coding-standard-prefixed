 ...
 */
class ContainerControllerResolver extends \_PhpScoper229e8121cf9f\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper229e8121cf9f\Psr\Container\ContainerInterface $container, \_PhpScoper229e8121cf9f\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
