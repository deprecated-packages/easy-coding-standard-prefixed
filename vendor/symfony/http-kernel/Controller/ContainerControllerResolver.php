 ...
 */
class ContainerControllerResolver extends \_PhpScoper0d0ee1ba46d4\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper0d0ee1ba46d4\Psr\Container\ContainerInterface $container, \_PhpScoper0d0ee1ba46d4\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper0d0ee1ba46d4\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
