 ...
 */
class ContainerControllerResolver extends \_PhpScoper133be48300f9\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper133be48300f9\Psr\Container\ContainerInterface $container, \_PhpScoper133be48300f9\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper133be48300f9\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
