 ...
 */
class ContainerControllerResolver extends \_PhpScoperfcee700af3df\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperfcee700af3df\Psr\Container\ContainerInterface $container, \_PhpScoperfcee700af3df\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperfcee700af3df\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
