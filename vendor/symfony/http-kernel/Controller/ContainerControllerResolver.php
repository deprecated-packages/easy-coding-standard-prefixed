 ...
 */
class ContainerControllerResolver extends \_PhpScoper04022cd986ec\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper04022cd986ec\Psr\Container\ContainerInterface $container, \_PhpScoper04022cd986ec\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper04022cd986ec\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
