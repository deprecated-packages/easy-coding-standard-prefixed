 ...
 */
class ContainerControllerResolver extends \_PhpScoper8db4616aa69d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper8db4616aa69d\Psr\Container\ContainerInterface $container, \_PhpScoper8db4616aa69d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper8db4616aa69d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
