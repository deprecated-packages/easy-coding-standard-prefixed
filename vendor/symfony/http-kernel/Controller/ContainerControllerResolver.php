 ...
 */
class ContainerControllerResolver extends \_PhpScoper10b1b2c5ca55\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper10b1b2c5ca55\Psr\Container\ContainerInterface $container, \_PhpScoper10b1b2c5ca55\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper10b1b2c5ca55\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
