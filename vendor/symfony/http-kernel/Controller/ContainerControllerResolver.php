 ...
 */
class ContainerControllerResolver extends \_PhpScoper64e7ad844899\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper64e7ad844899\Psr\Container\ContainerInterface $container, \_PhpScoper64e7ad844899\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper64e7ad844899\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
