 ...
 */
class ContainerControllerResolver extends \_PhpScoper87c77ad5700d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper87c77ad5700d\Psr\Container\ContainerInterface $container, \_PhpScoper87c77ad5700d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper87c77ad5700d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
