 ...
 */
class ContainerControllerResolver extends \_PhpScopera061b8a47e36\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera061b8a47e36\Psr\Container\ContainerInterface $container, \_PhpScopera061b8a47e36\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera061b8a47e36\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
