 ...
 */
class ContainerControllerResolver extends \_PhpScoper70d1796231ae\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper70d1796231ae\Psr\Container\ContainerInterface $container, \_PhpScoper70d1796231ae\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper70d1796231ae\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
