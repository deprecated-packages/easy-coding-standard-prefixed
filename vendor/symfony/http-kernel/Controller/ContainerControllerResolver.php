 ...
 */
class ContainerControllerResolver extends \_PhpScoper3f3a54dd086f\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper3f3a54dd086f\Psr\Container\ContainerInterface $container, \_PhpScoper3f3a54dd086f\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper3f3a54dd086f\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
