 ...
 */
class ContainerControllerResolver extends \_PhpScoperad4b7e2c09d8\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperad4b7e2c09d8\Psr\Container\ContainerInterface $container, \_PhpScoperad4b7e2c09d8\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperad4b7e2c09d8\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
