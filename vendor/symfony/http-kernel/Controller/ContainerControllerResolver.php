 ...
 */
class ContainerControllerResolver extends \_PhpScopercd2fc5ef50ef\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopercd2fc5ef50ef\Psr\Container\ContainerInterface $container, \_PhpScopercd2fc5ef50ef\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopercd2fc5ef50ef\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
