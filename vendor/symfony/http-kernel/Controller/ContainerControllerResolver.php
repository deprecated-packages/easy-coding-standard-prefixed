 ...
 */
class ContainerControllerResolver extends \_PhpScoperef870243cfdb\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperef870243cfdb\Psr\Container\ContainerInterface $container, \_PhpScoperef870243cfdb\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperef870243cfdb\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
