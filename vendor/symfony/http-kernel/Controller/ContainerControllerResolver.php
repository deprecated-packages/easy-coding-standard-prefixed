 ...
 */
class ContainerControllerResolver extends \_PhpScoperf5c57eca8aae\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf5c57eca8aae\Psr\Container\ContainerInterface $container, \_PhpScoperf5c57eca8aae\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf5c57eca8aae\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
