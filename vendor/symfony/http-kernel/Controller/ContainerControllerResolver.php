 ...
 */
class ContainerControllerResolver extends \_PhpScoperecb978830f1e\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperecb978830f1e\Psr\Container\ContainerInterface $container, \_PhpScoperecb978830f1e\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperecb978830f1e\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
