 ...
 */
class ContainerControllerResolver extends \_PhpScoperc83f84c90b60\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperc83f84c90b60\Psr\Container\ContainerInterface $container, \_PhpScoperc83f84c90b60\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperc83f84c90b60\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
