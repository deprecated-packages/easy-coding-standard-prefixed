 ...
 */
class ContainerControllerResolver extends \_PhpScopercf327c47dfc5\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopercf327c47dfc5\Psr\Container\ContainerInterface $container, \_PhpScopercf327c47dfc5\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
