 ...
 */
class ContainerControllerResolver extends \_PhpScoper3d04c8135695\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper3d04c8135695\Psr\Container\ContainerInterface $container, \_PhpScoper3d04c8135695\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper3d04c8135695\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
