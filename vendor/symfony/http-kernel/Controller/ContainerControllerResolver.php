 ...
 */
class ContainerControllerResolver extends \_PhpScoperd35c27cd4b09\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperd35c27cd4b09\Psr\Container\ContainerInterface $container, \_PhpScoperd35c27cd4b09\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperd35c27cd4b09\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
