 ...
 */
class ContainerControllerResolver extends \_PhpScoper488221d5cc83\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper488221d5cc83\Psr\Container\ContainerInterface $container, \_PhpScoper488221d5cc83\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper488221d5cc83\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
