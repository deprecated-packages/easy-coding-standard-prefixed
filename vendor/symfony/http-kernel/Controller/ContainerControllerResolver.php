 ...
 */
class ContainerControllerResolver extends \_PhpScoperf53473b45c36\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf53473b45c36\Psr\Container\ContainerInterface $container, \_PhpScoperf53473b45c36\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf53473b45c36\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
