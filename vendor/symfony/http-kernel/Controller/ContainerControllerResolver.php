 ...
 */
class ContainerControllerResolver extends \_PhpScopera37d6fb0b1ab\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera37d6fb0b1ab\Psr\Container\ContainerInterface $container, \_PhpScopera37d6fb0b1ab\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera37d6fb0b1ab\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
