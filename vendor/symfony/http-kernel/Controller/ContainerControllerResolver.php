 ...
 */
class ContainerControllerResolver extends \_PhpScoperfab1bfb7ec99\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperfab1bfb7ec99\Psr\Container\ContainerInterface $container, \_PhpScoperfab1bfb7ec99\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperfab1bfb7ec99\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
