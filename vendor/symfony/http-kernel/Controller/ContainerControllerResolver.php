 ...
 */
class ContainerControllerResolver extends \_PhpScoperdf6a0b341030\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperdf6a0b341030\Psr\Container\ContainerInterface $container, \_PhpScoperdf6a0b341030\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperdf6a0b341030\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
