 ...
 */
class ContainerControllerResolver extends \_PhpScoper842c7347e6be\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper842c7347e6be\Psr\Container\ContainerInterface $container, \_PhpScoper842c7347e6be\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper842c7347e6be\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
