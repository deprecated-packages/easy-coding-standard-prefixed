 ...
 */
class ContainerControllerResolver extends \_PhpScoperc64a4ac1af35\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperc64a4ac1af35\Psr\Container\ContainerInterface $container, \_PhpScoperc64a4ac1af35\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperc64a4ac1af35\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
