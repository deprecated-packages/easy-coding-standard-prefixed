 ...
 */
class ContainerControllerResolver extends \_PhpScoper47644ab3aa9a\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper47644ab3aa9a\Psr\Container\ContainerInterface $container, \_PhpScoper47644ab3aa9a\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper47644ab3aa9a\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
