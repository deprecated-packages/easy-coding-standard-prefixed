 ...
 */
class ContainerControllerResolver extends \_PhpScoperfb0714773dc5\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperfb0714773dc5\Psr\Container\ContainerInterface $container, \_PhpScoperfb0714773dc5\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperfb0714773dc5\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
