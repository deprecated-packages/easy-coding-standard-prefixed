 ...
 */
class ContainerControllerResolver extends \_PhpScopere015d8a3273c\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopere015d8a3273c\Psr\Container\ContainerInterface $container, \_PhpScopere015d8a3273c\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopere015d8a3273c\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
