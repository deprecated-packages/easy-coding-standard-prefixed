 ...
 */
class ContainerControllerResolver extends \_PhpScoper59558822d8c7\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper59558822d8c7\Psr\Container\ContainerInterface $container, \_PhpScoper59558822d8c7\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper59558822d8c7\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
