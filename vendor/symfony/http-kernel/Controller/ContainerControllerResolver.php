 ...
 */
class ContainerControllerResolver extends \_PhpScopercc9aec205203\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopercc9aec205203\Psr\Container\ContainerInterface $container, \_PhpScopercc9aec205203\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopercc9aec205203\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
