 ...
 */
class ContainerControllerResolver extends \_PhpScoper35ec99c463ee\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper35ec99c463ee\Psr\Container\ContainerInterface $container, \_PhpScoper35ec99c463ee\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper35ec99c463ee\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
