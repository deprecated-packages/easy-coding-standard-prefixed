 ...
 */
class ContainerControllerResolver extends \_PhpScoper08686b2277af\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper08686b2277af\Psr\Container\ContainerInterface $container, \_PhpScoper08686b2277af\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper08686b2277af\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
