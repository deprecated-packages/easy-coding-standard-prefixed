 ...
 */
class ContainerControllerResolver extends \_PhpScopercb217fd4e736\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopercb217fd4e736\Psr\Container\ContainerInterface $container, \_PhpScopercb217fd4e736\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopercb217fd4e736\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
