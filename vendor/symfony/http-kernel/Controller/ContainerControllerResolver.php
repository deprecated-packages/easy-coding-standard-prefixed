 ...
 */
class ContainerControllerResolver extends \_PhpScopera40fc53e636b\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera40fc53e636b\Psr\Container\ContainerInterface $container, \_PhpScopera40fc53e636b\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera40fc53e636b\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
