 ...
 */
class ContainerControllerResolver extends \_PhpScopera238de2e9b5a\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera238de2e9b5a\Psr\Container\ContainerInterface $container, \_PhpScopera238de2e9b5a\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera238de2e9b5a\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
