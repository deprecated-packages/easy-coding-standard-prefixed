 ...
 */
class ContainerControllerResolver extends \_PhpScoperaac5f7c652e4\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperaac5f7c652e4\Psr\Container\ContainerInterface $container, \_PhpScoperaac5f7c652e4\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperaac5f7c652e4\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
