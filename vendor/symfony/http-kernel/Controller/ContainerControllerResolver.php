 ...
 */
class ContainerControllerResolver extends \_PhpScoper06c5fb6c14ed\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper06c5fb6c14ed\Psr\Container\ContainerInterface $container, \_PhpScoper06c5fb6c14ed\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper06c5fb6c14ed\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
