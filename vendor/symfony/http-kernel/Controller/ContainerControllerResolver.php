 ...
 */
class ContainerControllerResolver extends \_PhpScoperbaf90856897c\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperbaf90856897c\Psr\Container\ContainerInterface $container, \_PhpScoperbaf90856897c\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperbaf90856897c\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
