 ...
 */
class ContainerControllerResolver extends \_PhpScoperdf15f2b748e9\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperdf15f2b748e9\Psr\Container\ContainerInterface $container, \_PhpScoperdf15f2b748e9\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperdf15f2b748e9\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
