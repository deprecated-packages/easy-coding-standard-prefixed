 ...
 */
class ContainerControllerResolver extends \_PhpScoper57c79939064b\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper57c79939064b\Psr\Container\ContainerInterface $container, \_PhpScoper57c79939064b\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper57c79939064b\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
