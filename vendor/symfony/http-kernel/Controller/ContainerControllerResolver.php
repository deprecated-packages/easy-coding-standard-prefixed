 ...
 */
class ContainerControllerResolver extends \_PhpScoper6c2f17c43d2d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper6c2f17c43d2d\Psr\Container\ContainerInterface $container, \_PhpScoper6c2f17c43d2d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper6c2f17c43d2d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
