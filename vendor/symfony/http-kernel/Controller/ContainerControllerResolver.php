 ...
 */
class ContainerControllerResolver extends \_PhpScoper14cb6de5473d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper14cb6de5473d\Psr\Container\ContainerInterface $container, \_PhpScoper14cb6de5473d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper14cb6de5473d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
