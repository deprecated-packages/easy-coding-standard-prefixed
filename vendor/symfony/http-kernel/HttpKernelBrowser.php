 ...
 */
namespace _PhpScoperd232d3743ab9\Symfony\Component\HttpKernel;

use _PhpScoperd232d3743ab9\Symfony\Component\BrowserKit\AbstractBrowser;
use _PhpScoperd232d3743ab9\Symfony\Component\BrowserKit\CookieJar;
use _PhpScoperd232d3743ab9\Symfony\Component\BrowserKit\History;
use _PhpScoperd232d3743ab9\Symfony\Component\BrowserKit\Request as DomRequest;
use _PhpScoperd232d3743ab9\Symfony\Component\BrowserKit\Response as DomResponse;
...
class HttpKernelBrowser extends AbstractBrowser
{
     ...
     */
    public function __construct(\_PhpScoperd232d3743ab9\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, array $server = [], History $history = null, CookieJar $cookieJar = null)
    {
    ...
    {
        $response = $this->kernel->handle($request, \_PhpScoperd232d3743ab9\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $this->catchExceptions);
        if ($this->kernel instanceof \_PhpScoperd232d3743ab9\Symfony\Component\HttpKernel\TerminableInterface) {
