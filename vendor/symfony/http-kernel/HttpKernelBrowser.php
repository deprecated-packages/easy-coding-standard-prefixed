 ...
 */
namespace _PhpScoper27cac5a8b4ab\Symfony\Component\HttpKernel;

use _PhpScoper27cac5a8b4ab\Symfony\Component\BrowserKit\AbstractBrowser;
use _PhpScoper27cac5a8b4ab\Symfony\Component\BrowserKit\CookieJar;
use _PhpScoper27cac5a8b4ab\Symfony\Component\BrowserKit\History;
use _PhpScoper27cac5a8b4ab\Symfony\Component\BrowserKit\Request as DomRequest;
use _PhpScoper27cac5a8b4ab\Symfony\Component\BrowserKit\Response as DomResponse;
...
class HttpKernelBrowser extends AbstractBrowser
{
     ...
     */
    public function __construct(\_PhpScoper27cac5a8b4ab\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, array $server = [], History $history = null, CookieJar $cookieJar = null)
    {
    ...
    {
        $response = $this->kernel->handle($request, \_PhpScoper27cac5a8b4ab\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $this->catchExceptions);
        if ($this->kernel instanceof \_PhpScoper27cac5a8b4ab\Symfony\Component\HttpKernel\TerminableInterface) {
