...
use _PhpScoper7e6a1331d94a\Symfony\Component\BrowserKit\AbstractBrowser;
use _PhpScoper7e6a1331d94a\Symfony\Component\BrowserKit\CookieJar;
use _PhpScoper7e6a1331d94a\Symfony\Component\BrowserKit\History;
use _PhpScoper7e6a1331d94a\Symfony\Component\BrowserKit\Request as DomRequest;
use _PhpScoper7e6a1331d94a\Symfony\Component\BrowserKit\Response as DomResponse;
use _PhpScoper7e6a1331d94a\Symfony\Component\HttpFoundation\File\UploadedFile;
...
class HttpKernelBrowser extends AbstractBrowser
{
     ...
     */
    public function __construct(\_PhpScoper7e6a1331d94a\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, array $server = [], History $history = null, CookieJar $cookieJar = null)
    {
    ...
    {
        $response = $this->kernel->handle($request, \_PhpScoper7e6a1331d94a\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $this->catchExceptions);
        if ($this->kernel instanceof \_PhpScoper7e6a1331d94a\Symfony\Component\HttpKernel\TerminableInterface) {
