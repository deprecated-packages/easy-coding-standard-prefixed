...
use _PhpScoperef2f7aa3581e\Symfony\Component\BrowserKit\AbstractBrowser;
use _PhpScoperef2f7aa3581e\Symfony\Component\BrowserKit\CookieJar;
use _PhpScoperef2f7aa3581e\Symfony\Component\BrowserKit\History;
use _PhpScoperef2f7aa3581e\Symfony\Component\BrowserKit\Request as DomRequest;
use _PhpScoperef2f7aa3581e\Symfony\Component\BrowserKit\Response as DomResponse;
use _PhpScoperef2f7aa3581e\Symfony\Component\HttpFoundation\File\UploadedFile;
...
class HttpKernelBrowser extends AbstractBrowser
{
     ...
     */
    public function __construct(\_PhpScoperef2f7aa3581e\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, array $server = [], History $history = null, CookieJar $cookieJar = null)
    {
    ...
    {
        $response = $this->kernel->handle($request, \_PhpScoperef2f7aa3581e\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $this->catchExceptions);
        if ($this->kernel instanceof \_PhpScoperef2f7aa3581e\Symfony\Component\HttpKernel\TerminableInterface) {
