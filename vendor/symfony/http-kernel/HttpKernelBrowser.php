...
use _PhpScoper82a1412fb847\Symfony\Component\BrowserKit\AbstractBrowser;
use _PhpScoper82a1412fb847\Symfony\Component\BrowserKit\CookieJar;
use _PhpScoper82a1412fb847\Symfony\Component\BrowserKit\History;
use _PhpScoper82a1412fb847\Symfony\Component\BrowserKit\Request as DomRequest;
use _PhpScoper82a1412fb847\Symfony\Component\BrowserKit\Response as DomResponse;
use _PhpScoper82a1412fb847\Symfony\Component\HttpFoundation\File\UploadedFile;
...
class HttpKernelBrowser extends AbstractBrowser
{
     ...
     */
    public function __construct(\_PhpScoper82a1412fb847\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, array $server = [], History $history = null, CookieJar $cookieJar = null)
    {
    ...
    {
        $response = $this->kernel->handle($request, \_PhpScoper82a1412fb847\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $this->catchExceptions);
        if ($this->kernel instanceof \_PhpScoper82a1412fb847\Symfony\Component\HttpKernel\TerminableInterface) {
