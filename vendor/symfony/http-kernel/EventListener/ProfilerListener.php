...
use _PhpScoperef870243cfdb\Symfony\Component\HttpFoundation\RequestMatcherInterface;
...
use _PhpScoperef870243cfdb\Symfony\Component\HttpKernel\Event\PostResponseEvent;
use _PhpScoperef870243cfdb\Symfony\Component\HttpKernel\KernelEvents;
use _PhpScoperef870243cfdb\Symfony\Component\HttpKernel\Profiler\Profiler;
/**
 ...
 */
class ProfilerListener implements \_PhpScoperef870243cfdb\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $profiler;
    protected $matcher;
    ...
    public function onKernelTerminate(\_PhpScoperef870243cfdb\Symfony\Component\HttpKernel\Event\PostResponseEvent $event)
    {
    ...
    {
        return [\_PhpScoperef870243cfdb\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -100], \_PhpScoperef870243cfdb\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => ['onKernelException', 0], \_PhpScoperef870243cfdb\Symfony\Component\HttpKernel\KernelEvents::TERMINATE => ['onKernelTerminate', -1024]];
    }
}
