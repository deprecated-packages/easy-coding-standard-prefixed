...
use _PhpScoper59ccd3f8e121\Psr\Container\ContainerInterface;
use _PhpScoper59ccd3f8e121\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use _PhpScoper59ccd3f8e121\Symfony\Component\HttpFoundation\Session\Session;
use _PhpScoper59ccd3f8e121\Symfony\Component\HttpFoundation\Session\SessionInterface;
use _PhpScoper59ccd3f8e121\Symfony\Component\HttpKernel\Event\FilterResponseEvent;
 ...
 */
abstract class AbstractSessionListener implements \_PhpScoper59ccd3f8e121\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    const NO_AUTO_CACHE_CONTROL_HEADER = 'Symfony-Session-NoAutoCacheControl';
    protected $container;
    private $sessionUsageStack = [];
    public function __construct(\_PhpScoper59ccd3f8e121\Psr\Container\ContainerInterface $container = null)
    {
    ...
    public function onKernelRequest(\_PhpScoper59ccd3f8e121\Symfony\Component\HttpKernel\Event\GetResponseEvent $event)
    {
        ...
        $this->sessionUsageStack[] = $session instanceof \_PhpScoper59ccd3f8e121\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() : 0;
    }
    public function onKernelResponse(\_PhpScoper59ccd3f8e121\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        if (!$event->isMasterRequest()) {
            return;
        }
        ...
        if ($session instanceof \_PhpScoper59ccd3f8e121\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() !== \end($this->sessionUsageStack) : $session->isStarted()) {
            if ($autoCacheControl) {
     ...
     * @internal
     */
    public function onFinishRequest(\_PhpScoper59ccd3f8e121\Symfony\Component\HttpKernel\Event\FinishRequestEvent $event)
    {
        if ($event->isMasterRequest()) {
    ...
    {
        return [
            \_PhpScoper59ccd3f8e121\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 128],
            // low priority to come after regular response listeners, but higher than StreamedResponseListener
            \_PhpScoper59ccd3f8e121\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -1000],
            \_PhpScoper59ccd3f8e121\Symfony\Component\HttpKernel\KernelEvents::FINISH_REQUEST => ['onFinishRequest'],
        ];
    }
    /**
