...
use _PhpScoper2f75f00bf6fa\Psr\Container\ContainerInterface;
use _PhpScoper2f75f00bf6fa\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use _PhpScoper2f75f00bf6fa\Symfony\Component\HttpFoundation\Session\Session;
 ...
 */
abstract class AbstractSessionListener implements \_PhpScoper2f75f00bf6fa\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    const NO_AUTO_CACHE_CONTROL_HEADER = 'Symfony-Session-NoAutoCacheControl';
    protected $container;
    private $sessionUsageStack = [];
    public function __construct(\_PhpScoper2f75f00bf6fa\Psr\Container\ContainerInterface $container = null)
    {
    ...
    public function onKernelRequest(\_PhpScoper2f75f00bf6fa\Symfony\Component\HttpKernel\Event\GetResponseEvent $event)
    {
        ...
        $this->sessionUsageStack[] = $session instanceof \_PhpScoper2f75f00bf6fa\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() : 0;
    }
    public function onKernelResponse(\_PhpScoper2f75f00bf6fa\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        ...
        if ($session instanceof \_PhpScoper2f75f00bf6fa\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() !== \end($this->sessionUsageStack) : $session->isStarted()) {
            if ($autoCacheControl) {
     ...
     * @internal
     */
    public function onFinishRequest(\_PhpScoper2f75f00bf6fa\Symfony\Component\HttpKernel\Event\FinishRequestEvent $event)
    {
        if ($event->isMasterRequest()) {
    ...
    {
        return [
            \_PhpScoper2f75f00bf6fa\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 128],
            // low priority to come after regular response listeners, but higher than StreamedResponseListener
            \_PhpScoper2f75f00bf6fa\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -1000],
            \_PhpScoper2f75f00bf6fa\Symfony\Component\HttpKernel\KernelEvents::FINISH_REQUEST => ['onFinishRequest'],
        ];
    }
    /**
