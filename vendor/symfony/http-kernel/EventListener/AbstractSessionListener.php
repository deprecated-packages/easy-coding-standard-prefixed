...
use _PhpScoper14cb6de5473d\Psr\Container\ContainerInterface;
use _PhpScoper14cb6de5473d\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use _PhpScoper14cb6de5473d\Symfony\Component\HttpFoundation\Session\Session;
 ...
 */
abstract class AbstractSessionListener implements \_PhpScoper14cb6de5473d\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    const NO_AUTO_CACHE_CONTROL_HEADER = 'Symfony-Session-NoAutoCacheControl';
    protected $container;
    private $sessionUsageStack = [];
    public function __construct(\_PhpScoper14cb6de5473d\Psr\Container\ContainerInterface $container = null)
    {
    ...
    public function onKernelRequest(\_PhpScoper14cb6de5473d\Symfony\Component\HttpKernel\Event\GetResponseEvent $event)
    {
        ...
        $this->sessionUsageStack[] = $session instanceof \_PhpScoper14cb6de5473d\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() : 0;
    }
    public function onKernelResponse(\_PhpScoper14cb6de5473d\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        ...
        if ($session instanceof \_PhpScoper14cb6de5473d\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() !== \end($this->sessionUsageStack) : $session->isStarted()) {
            if ($autoCacheControl) {
     ...
     * @internal
     */
    public function onFinishRequest(\_PhpScoper14cb6de5473d\Symfony\Component\HttpKernel\Event\FinishRequestEvent $event)
    {
        if ($event->isMasterRequest()) {
    ...
    {
        return [
            \_PhpScoper14cb6de5473d\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 128],
            // low priority to come after regular response listeners, but higher than StreamedResponseListener
            \_PhpScoper14cb6de5473d\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -1000],
            \_PhpScoper14cb6de5473d\Symfony\Component\HttpKernel\KernelEvents::FINISH_REQUEST => ['onFinishRequest'],
        ];
    }
    /**
