...
use _PhpScoperf3db63c305b2\Psr\Container\ContainerInterface;
use _PhpScoperf3db63c305b2\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use _PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\Session\Session;
use _PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\Session\SessionInterface;
use _PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\Event\FilterResponseEvent;
 ...
 */
abstract class AbstractSessionListener implements \_PhpScoperf3db63c305b2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    const NO_AUTO_CACHE_CONTROL_HEADER = 'Symfony-Session-NoAutoCacheControl';
    protected $container;
    private $sessionUsageStack = [];
    public function __construct(\_PhpScoperf3db63c305b2\Psr\Container\ContainerInterface $container = null)
    {
    ...
    public function onKernelRequest(\_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\Event\GetResponseEvent $event)
    {
        ...
        $this->sessionUsageStack[] = $session instanceof \_PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() : 0;
    }
    public function onKernelResponse(\_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        if (!$event->isMasterRequest()) {
            return;
        }
        ...
        if ($session instanceof \_PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() !== \end($this->sessionUsageStack) : $session->isStarted()) {
            if ($autoCacheControl) {
     ...
     * @internal
     */
    public function onFinishRequest(\_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\Event\FinishRequestEvent $event)
    {
        if ($event->isMasterRequest()) {
    ...
    {
        return [
            \_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 128],
            // low priority to come after regular response listeners, but higher than StreamedResponseListener
            \_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -1000],
            \_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\KernelEvents::FINISH_REQUEST => ['onFinishRequest'],
        ];
    }
    /**
