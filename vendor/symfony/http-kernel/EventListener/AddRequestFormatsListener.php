 ...
 */
class AddRequestFormatsListener implements \_PhpScoper528afa732cbd\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\_PhpScoper528afa732cbd\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
