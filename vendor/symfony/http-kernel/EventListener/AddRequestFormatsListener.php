 ...
 */
class AddRequestFormatsListener implements \_PhpScoperd4937ee9b515\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\_PhpScoperd4937ee9b515\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
