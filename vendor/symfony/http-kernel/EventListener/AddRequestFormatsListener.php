 ...
 * @final
 */
class AddRequestFormatsListener implements \_PhpScoperf361a7d70552\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\_PhpScoperf361a7d70552\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
