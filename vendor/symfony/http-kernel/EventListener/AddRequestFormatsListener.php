 ...
 */
class AddRequestFormatsListener implements \_PhpScoperb44a315fec16\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\_PhpScoperb44a315fec16\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
