 ...
 * @final
 */
class ValidateRequestListener implements \_PhpScoperd32e35cfad84\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\_PhpScoperd32e35cfad84\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
