...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "ErrorListener" instead.', \_PhpScoper3fa05b4669af\Symfony\Component\HttpKernel\EventListener\ExceptionListener::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.4, use ErrorListener instead
 */
class ExceptionListener implements \_PhpScoper3fa05b4669af\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function logKernelException(\_PhpScoper3fa05b4669af\Symfony\Component\HttpKernel\Event\GetResponseForExceptionEvent $event)
    {
        $e = \_PhpScoper3fa05b4669af\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($event->getException());
    ...
    {
        return [\_PhpScoper3fa05b4669af\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]]];
    }
    /**
     * Logs an exception.
     *
     ...
     */
    protected function duplicateRequest(\Exception $exception, \_PhpScoper3fa05b4669af\Symfony\Component\HttpFoundation\Request $request)
    {
        $attributes = ['_controller' => $this->controller, 'exception' => \_PhpScoper3fa05b4669af\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception), 'logger' => $this->logger instanceof \_PhpScoper3fa05b4669af\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null];
