...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "ErrorListener" instead.', \_PhpScopera1a51450b61d\Symfony\Component\HttpKernel\EventListener\ExceptionListener::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.4, use ErrorListener instead
 */
class ExceptionListener implements \_PhpScopera1a51450b61d\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function logKernelException(\_PhpScopera1a51450b61d\Symfony\Component\HttpKernel\Event\GetResponseForExceptionEvent $event)
    {
        $e = \_PhpScopera1a51450b61d\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($event->getException());
    ...
    {
        return [\_PhpScopera1a51450b61d\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]]];
    }
    /**
     * Logs an exception.
     *
     ...
     */
    protected function duplicateRequest(\Exception $exception, \_PhpScopera1a51450b61d\Symfony\Component\HttpFoundation\Request $request)
    {
        $attributes = ['_controller' => $this->controller, 'exception' => \_PhpScopera1a51450b61d\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception), 'logger' => $this->logger instanceof \_PhpScopera1a51450b61d\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null];
