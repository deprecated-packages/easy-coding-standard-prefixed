...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "ErrorListener" instead.', \_PhpScoperf5f75c22067b\Symfony\Component\HttpKernel\EventListener\ExceptionListener::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.4, use ErrorListener instead
 */
class ExceptionListener implements \_PhpScoperf5f75c22067b\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function logKernelException(\_PhpScoperf5f75c22067b\Symfony\Component\HttpKernel\Event\GetResponseForExceptionEvent $event)
    {
        $e = \_PhpScoperf5f75c22067b\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($event->getException());
    ...
    {
        return [\_PhpScoperf5f75c22067b\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]]];
    }
    /**
     * Logs an exception.
     *
     ...
     */
    protected function duplicateRequest(\Exception $exception, \_PhpScoperf5f75c22067b\Symfony\Component\HttpFoundation\Request $request)
    {
        $attributes = ['_controller' => $this->controller, 'exception' => \_PhpScoperf5f75c22067b\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception), 'logger' => $this->logger instanceof \_PhpScoperf5f75c22067b\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null];
