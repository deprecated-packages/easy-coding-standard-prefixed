...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "ErrorListener" instead.', \_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\EventListener\ExceptionListener::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.4, use ErrorListener instead
 */
class ExceptionListener implements \_PhpScoperf3db63c305b2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function logKernelException(\_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\Event\GetResponseForExceptionEvent $event)
    {
        $e = \_PhpScoperf3db63c305b2\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($event->getException());
    ...
    {
        return [\_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]]];
    }
    /**
     * Logs an exception.
     *
     ...
     */
    protected function duplicateRequest(\Exception $exception, \_PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\Request $request)
    {
        $attributes = ['_controller' => $this->controller, 'exception' => \_PhpScoperf3db63c305b2\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception), 'logger' => $this->logger instanceof \_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null];
