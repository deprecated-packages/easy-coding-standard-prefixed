...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3 and will be removed in 5.0, use LocaleAwareListener instead.', \_PhpScoperfcf15c26e033\Symfony\Component\HttpKernel\EventListener\TranslatorListener::class), \E_USER_DEPRECATED);
...
use _PhpScoperfcf15c26e033\Symfony\Component\Translation\TranslatorInterface;
 ...
 */
class TranslatorListener implements \_PhpScoperfcf15c26e033\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $translator;
     ...
     */
    public function __construct($translator, \_PhpScoperfcf15c26e033\Symfony\Component\HttpFoundation\RequestStack $requestStack)
    {
        if (!$translator instanceof \_PhpScoperfcf15c26e033\Symfony\Component\Translation\TranslatorInterface && !$translator instanceof \_PhpScoperfcf15c26e033\Symfony\Contracts\Translation\LocaleAwareInterface) {
            throw new \TypeError(\sprintf('Argument 1 passed to %s() must be an instance of %s, %s given.', __METHOD__, \_PhpScoperfcf15c26e033\Symfony\Contracts\Translation\LocaleAwareInterface::class, \is_object($translator) ? \get_class($translator) : \gettype($translator)));
        }
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            \_PhpScoperfcf15c26e033\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 10]],
