...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.1, use AbstractSessionListener instead.', \_PhpScoperd8b12759ee0d\Symfony\Component\HttpKernel\EventListener\SaveSessionListener::class), \E_USER_DEPRECATED);
 ...
 */
class SaveSessionListener implements \_PhpScoperd8b12759ee0d\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
