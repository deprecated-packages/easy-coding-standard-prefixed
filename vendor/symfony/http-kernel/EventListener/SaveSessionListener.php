...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.1, use AbstractSessionListener instead.', \_PhpScoperab9510cd5d97\Symfony\Component\HttpKernel\EventListener\SaveSessionListener::class), \E_USER_DEPRECATED);
 ...
 */
class SaveSessionListener implements \_PhpScoperab9510cd5d97\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
