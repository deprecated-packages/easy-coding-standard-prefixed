...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.1, use AbstractSessionListener instead.', \_PhpScoperb458b528613f\Symfony\Component\HttpKernel\EventListener\SaveSessionListener::class), \E_USER_DEPRECATED);
 ...
 */
class SaveSessionListener implements \_PhpScoperb458b528613f\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
