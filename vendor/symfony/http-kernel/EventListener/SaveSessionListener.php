...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.1, use AbstractSessionListener instead.', \_PhpScoper5ca2d8bcb02c\Symfony\Component\HttpKernel\EventListener\SaveSessionListener::class), \E_USER_DEPRECATED);
 ...
 */
class SaveSessionListener implements \_PhpScoper5ca2d8bcb02c\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
