...
use _PhpScoperad4605bb9267\Symfony\Component\HttpKernel\Event\ControllerArgumentsEvent;
 ...
 */
class ErrorListener implements \_PhpScoperad4605bb9267\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function logKernelException(\_PhpScoperad4605bb9267\Symfony\Component\HttpKernel\Event\ExceptionEvent $event)
    {
        $e = \_PhpScoperad4605bb9267\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($event->getThrowable());
        $this->logException($event->getThrowable(), \sprintf('Uncaught PHP Exception %s: "%s" at %s line %s', $e->getClass(), $e->getMessage(), $e->getFile(), $e->getLine()));
    }
    public function onKernelException(\_PhpScoperad4605bb9267\Symfony\Component\HttpKernel\Event\ExceptionEvent $event, string $eventName = null, \_PhpScoperad4605bb9267\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null)
    {
    ...
    public function onControllerArguments(\_PhpScoperad4605bb9267\Symfony\Component\HttpKernel\Event\ControllerArgumentsEvent $event)
    {
        ...
        if ($r && (!$r->hasType() || \_PhpScoperad4605bb9267\Symfony\Component\ErrorHandler\Exception\FlattenException::class === $r->getType()->getName())) {
            $arguments = $event->getArguments();
            $arguments[$k] = \_PhpScoperad4605bb9267\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($e);
            $event->setArguments($arguments);
        }
    }
    public static function getSubscribedEvents() : array
    {
        return [\_PhpScoperad4605bb9267\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER_ARGUMENTS => 'onControllerArguments', \_PhpScoperad4605bb9267\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]]];
    }
    /**
     * Logs an exception.
     */
     ...
     */
    protected function duplicateRequest(\Throwable $exception, \_PhpScoperad4605bb9267\Symfony\Component\HttpFoundation\Request $request) : \_PhpScoperad4605bb9267\Symfony\Component\HttpFoundation\Request
    {
        $attributes = ['_controller' => $this->controller, 'exception' => $exception, 'logger' => $this->logger instanceof \_PhpScoperad4605bb9267\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null];
