 ...
 */
class LocaleListener implements \_PhpScoperf3db63c305b2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $router;
    private $defaultLocale;
    private $requestStack;
    public function __construct(\_PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\RequestStack $requestStack, string $defaultLocale = 'en', \_PhpScoperf3db63c305b2\Symfony\Component\Routing\RequestContextAwareInterface $router = null)
    {
        $this->defaultLocale = $defaultLocale;
        $this->requestStack = $requestStack;
        $this->router = $router;
    }
    public function setDefaultLocale(\_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\Event\KernelEvent $event)
    {
    ...
    private function setRouterContext(\_PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\Request $request)
    {
        if (null !== $this->router) {
    ...
    {
        return [\_PhpScoperf3db63c305b2\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [
