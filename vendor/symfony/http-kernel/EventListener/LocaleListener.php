 ...
 */
class LocaleListener implements \_PhpScoperdc8fbcd7c69d\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $router;
    private $defaultLocale;
    private $requestStack;
    public function __construct(\_PhpScoperdc8fbcd7c69d\Symfony\Component\HttpFoundation\RequestStack $requestStack, string $defaultLocale = 'en', \_PhpScoperdc8fbcd7c69d\Symfony\Component\Routing\RequestContextAwareInterface $router = null)
    {
        $this->defaultLocale = $defaultLocale;
        $this->requestStack = $requestStack;
        $this->router = $router;
    }
    public function setDefaultLocale(\_PhpScoperdc8fbcd7c69d\Symfony\Component\HttpKernel\Event\KernelEvent $event)
    {
    ...
    private function setRouterContext(\_PhpScoperdc8fbcd7c69d\Symfony\Component\HttpFoundation\Request $request)
    {
        if (null !== $this->router) {
    ...
    {
        return [\_PhpScoperdc8fbcd7c69d\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [
