 ...
 */
class LocaleListener implements \_PhpScoper70072c07b02b\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $router;
    private $defaultLocale;
    private $requestStack;
    public function __construct(\_PhpScoper70072c07b02b\Symfony\Component\HttpFoundation\RequestStack $requestStack, string $defaultLocale = 'en', \_PhpScoper70072c07b02b\Symfony\Component\Routing\RequestContextAwareInterface $router = null)
    {
        $this->defaultLocale = $defaultLocale;
        $this->requestStack = $requestStack;
        $this->router = $router;
    }
    public function setDefaultLocale(\_PhpScoper70072c07b02b\Symfony\Component\HttpKernel\Event\KernelEvent $event)
    {
    ...
    private function setRouterContext(\_PhpScoper70072c07b02b\Symfony\Component\HttpFoundation\Request $request)
    {
        if (null !== $this->router) {
    ...
    {
        return [\_PhpScoper70072c07b02b\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [
