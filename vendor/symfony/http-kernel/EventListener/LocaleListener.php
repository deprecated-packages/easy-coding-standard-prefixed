 ...
 */
class LocaleListener implements \_PhpScoper3fa05b4669af\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $router;
    private $defaultLocale;
    private $requestStack;
    public function __construct(\_PhpScoper3fa05b4669af\Symfony\Component\HttpFoundation\RequestStack $requestStack, string $defaultLocale = 'en', \_PhpScoper3fa05b4669af\Symfony\Component\Routing\RequestContextAwareInterface $router = null)
    {
        $this->defaultLocale = $defaultLocale;
        $this->requestStack = $requestStack;
        $this->router = $router;
    }
    public function setDefaultLocale(\_PhpScoper3fa05b4669af\Symfony\Component\HttpKernel\Event\KernelEvent $event)
    {
    ...
    private function setRouterContext(\_PhpScoper3fa05b4669af\Symfony\Component\HttpFoundation\Request $request)
    {
        if (null !== $this->router) {
    ...
    {
        return [\_PhpScoper3fa05b4669af\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [
