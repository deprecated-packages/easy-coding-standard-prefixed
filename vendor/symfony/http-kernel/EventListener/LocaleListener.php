 ...
 */
class LocaleListener implements \_PhpScoperaba240c3d5f1\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $router;
    private $defaultLocale;
    private $requestStack;
    public function __construct(\_PhpScoperaba240c3d5f1\Symfony\Component\HttpFoundation\RequestStack $requestStack, string $defaultLocale = 'en', \_PhpScoperaba240c3d5f1\Symfony\Component\Routing\RequestContextAwareInterface $router = null)
    {
        $this->defaultLocale = $defaultLocale;
        $this->requestStack = $requestStack;
        $this->router = $router;
    }
    public function setDefaultLocale(\_PhpScoperaba240c3d5f1\Symfony\Component\HttpKernel\Event\KernelEvent $event)
    {
    ...
    private function setRouterContext(\_PhpScoperaba240c3d5f1\Symfony\Component\HttpFoundation\Request $request)
    {
        if (null !== $this->router) {
    ...
    {
        return [\_PhpScoperaba240c3d5f1\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [
