...
use _PhpScoperda2604e33acb\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\HttpKernelInterface, \_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, $type = \_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $catch = \true)
    {
        ...
        if (\_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\TerminableInterface) {
     ...
     */
    protected function pass(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, $catch = \false)
    {
     ...
     * @see RFC2616 13.10
     */
    protected function invalidate(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, $catch = \false)
    {
        $response = $this->pass($request, $catch);
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
     ...
     * @throws \Exception
     */
    protected function lookup(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, $catch = \false)
    {
        try {
     ...
     * @return Response A Response instance
     */
    protected function validate(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Response $entry, $catch = \false)
    {
     ...
     * @return Response A Response instance
     */
    protected function fetch(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, $catch = \false)
    {
        $subRequest = clone $request;
        // send no head requests because we want content
        if ('HEAD' === $request->getMethod()) {
     ...
     * @return Response A Response instance
     */
    protected function forward(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, $catch = \false, \_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Response $entry = null)
    {
        if ($this->surrogate) {
            $this->surrogate->addSurrogateCapability($request);
        }
        // always a "master" request (as the real master request can be in cache)
        $response = \_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \_PhpScoperda2604e33acb\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $catch);
     ...
     */
    protected function isFreshEnough(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Response $entry)
    {
        if (!$entry->isFresh()) {
     ...
     */
    protected function lock(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Response $entry)
    {
     ...
     * @throws \Exception
     */
    protected function store(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Response $response)
    {
        try {
     ...
     */
    private function restoreResponseBody(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Response $response)
    {
    ...
    protected function processResponseBody(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\_PhpScoperda2604e33acb\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;
