 ...
 */
class ResponseCacheStrategy implements \_PhpScoperb73f9e44f4eb\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategyInterface
{
    /**
    ...
    private $age = 0;
    private $flagDirectives = ['no-cache' => null, 'no-store' => null, 'no-transform' => null, 'must-revalidate' => null, 'proxy-revalidate' => null, 'public' => null, 'private' => null, 'immutable' => null];
    private $ageDirectives = ['max-age' => null, 's-maxage' => null, 'expires' => null];
    /**
     * {@inheritdoc}
     */
    public function add(\_PhpScoperb73f9e44f4eb\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function update(\_PhpScoperb73f9e44f4eb\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function willMakeFinalResponseUncacheable(\_PhpScoperb73f9e44f4eb\Symfony\Component\HttpFoundation\Response $response) : bool
    {
        ...
        if (\in_array($response->getStatusCode(), [200, 203, 300, 301, 410]) && null === $response->getLastModified() && null === $response->getEtag()) {
            return \false;
        }
