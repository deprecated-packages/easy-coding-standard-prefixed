 ...
 */
class ResponseCacheStrategy implements \_PhpScoperb6d4bd368bd9\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategyInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function add(\_PhpScoperb6d4bd368bd9\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function update(\_PhpScoperb6d4bd368bd9\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function willMakeFinalResponseUncacheable(\_PhpScoperb6d4bd368bd9\Symfony\Component\HttpFoundation\Response $response) : bool
    {
