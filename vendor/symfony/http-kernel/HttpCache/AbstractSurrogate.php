 ...
 */
abstract class AbstractSurrogate implements \_PhpScopere66f4b626446\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScopere66f4b626446\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        $subRequest = \_PhpScopere66f4b626446\Symfony\Component\HttpFoundation\Request::create($uri, \_PhpScopere66f4b626446\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \_PhpScopere66f4b626446\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\_PhpScopere66f4b626446\Symfony\Component\HttpFoundation\Response $response)
    {
