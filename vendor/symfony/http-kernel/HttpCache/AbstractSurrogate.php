 ...
 */
abstract class AbstractSurrogate implements \_PhpScopereb9508917a55\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScopereb9508917a55\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
     ...
     * {@inheritdoc}
     */
    public function handle(\_PhpScopereb9508917a55\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, string $uri, string $alt, bool $ignoreErrors)
    {
