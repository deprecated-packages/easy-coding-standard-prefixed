 ...
 */
abstract class AbstractSurrogate implements \_PhpScoper70e3784a2d21\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScoper70e3784a2d21\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        $subRequest = \_PhpScoper70e3784a2d21\Symfony\Component\HttpFoundation\Request::create($uri, \_PhpScoper70e3784a2d21\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \_PhpScoper70e3784a2d21\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\_PhpScoper70e3784a2d21\Symfony\Component\HttpFoundation\Response $response)
    {
