 ...
 */
abstract class AbstractSurrogate implements \_PhpScoper91c59a2f52e1\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScoper91c59a2f52e1\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
     ...
     * {@inheritdoc}
     */
    public function handle(\_PhpScoper91c59a2f52e1\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, string $uri, string $alt, bool $ignoreErrors)
    {
