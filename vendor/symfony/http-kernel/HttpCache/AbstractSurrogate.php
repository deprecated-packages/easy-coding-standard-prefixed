 ...
 */
namespace _PhpScoper99c9619a6243\Symfony\Component\HttpKernel\HttpCache;
 ...
 */
abstract class AbstractSurrogate implements \_PhpScoper99c9619a6243\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScoper99c9619a6243\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
     ...
     * {@inheritdoc}
     */
    public function handle(\_PhpScoper99c9619a6243\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, string $uri, string $alt, bool $ignoreErrors)
    {
