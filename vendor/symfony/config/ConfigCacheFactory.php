 ...
 */
class ConfigCacheFactory implements \_PhpScopere015d8a3273c\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    private $debug;
    /**
    ...
    public function cache($file, $callback)
    {
        ...
        $cache = new \_PhpScopere015d8a3273c\Symfony\Component\Config\ConfigCache($file, $this->debug);
        if (!$cache->isFresh()) {
            $callback($cache);
        }
        return $cache;
