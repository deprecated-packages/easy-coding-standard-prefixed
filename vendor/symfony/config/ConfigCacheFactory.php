 ...
 */
class ConfigCacheFactory implements \_PhpScopere5e7dca8c031\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    private $debug;
    /**
    ...
    public function cache($file, $callback)
    {
        ...
        $cache = new \_PhpScopere5e7dca8c031\Symfony\Component\Config\ConfigCache($file, $this->debug);
        if (!$cache->isFresh()) {
            $callback($cache);
        }
        return $cache;
