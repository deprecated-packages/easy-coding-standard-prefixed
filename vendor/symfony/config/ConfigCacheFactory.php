 ...
 */
class ConfigCacheFactory implements \_PhpScoper880bfa4d8b51\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    private $debug;
    /**
    ...
    public function cache($file, $callback)
    {
        ...
        $cache = new \_PhpScoper880bfa4d8b51\Symfony\Component\Config\ConfigCache($file, $this->debug);
        if (!$cache->isFresh()) {
            $callback($cache);
        }
        return $cache;
