 ...
 */
class ResourceCheckerConfigCacheFactory implements \_PhpScopera9d6a31d814c\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \_PhpScopera9d6a31d814c\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;
