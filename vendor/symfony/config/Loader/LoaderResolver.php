 ...
 */
class LoaderResolver implements \_PhpScoper130a9a1cd4a2\Symfony\Component\Config\Loader\LoaderResolverInterface
{
    /**
    ...
    public function addLoader(\_PhpScoper130a9a1cd4a2\Symfony\Component\Config\Loader\LoaderInterface $loader)
    {
        $this->loaders[] = $loader;
