 ...
 */
namespace _PhpScopera8f555a7493c\Symfony\Component\Config\Resource;

use _PhpScopera8f555a7493c\Symfony\Component\Finder\Finder;
use _PhpScopera8f555a7493c\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \_PhpScopera8f555a7493c\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\_PhpScopera8f555a7493c\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScopera8f555a7493c\Symfony\Component\Finder\Finder();
        $regex = \_PhpScopera8f555a7493c\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
