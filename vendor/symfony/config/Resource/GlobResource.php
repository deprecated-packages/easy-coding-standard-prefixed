 ...
 */
namespace _PhpScoperdc8fbcd7c69d\Symfony\Component\Config\Resource;

use _PhpScoperdc8fbcd7c69d\Symfony\Component\Finder\Finder;
use _PhpScoperdc8fbcd7c69d\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \_PhpScoperdc8fbcd7c69d\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\_PhpScoperdc8fbcd7c69d\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScoperdc8fbcd7c69d\Symfony\Component\Finder\Finder();
        $regex = \_PhpScoperdc8fbcd7c69d\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
