 ...
 */
namespace _PhpScoperedc2e0c967db\Symfony\Component\Config\Resource;

use _PhpScoperedc2e0c967db\Symfony\Component\Finder\Finder;
use _PhpScoperedc2e0c967db\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \_PhpScoperedc2e0c967db\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator()
    {
        ...
        if (!\class_exists(\_PhpScoperedc2e0c967db\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScoperedc2e0c967db\Symfony\Component\Finder\Finder();
        $regex = \_PhpScoperedc2e0c967db\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
