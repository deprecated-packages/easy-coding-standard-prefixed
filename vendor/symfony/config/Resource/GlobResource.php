 ...
 */
namespace _PhpScopera238de2e9b5a\Symfony\Component\Config\Resource;

use _PhpScopera238de2e9b5a\Symfony\Component\Finder\Finder;
use _PhpScopera238de2e9b5a\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \_PhpScopera238de2e9b5a\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator()
    {
        ...
        if (!\class_exists(\_PhpScopera238de2e9b5a\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScopera238de2e9b5a\Symfony\Component\Finder\Finder();
        $regex = \_PhpScopera238de2e9b5a\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
