 ...
 */
namespace _PhpScoperd79d87c3336e\Symfony\Component\Config\Resource;

use _PhpScoperd79d87c3336e\Symfony\Component\Finder\Finder;
use _PhpScoperd79d87c3336e\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \_PhpScoperd79d87c3336e\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator()
    {
        ...
        if (!\class_exists(\_PhpScoperd79d87c3336e\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScoperd79d87c3336e\Symfony\Component\Finder\Finder();
        $regex = \_PhpScoperd79d87c3336e\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
