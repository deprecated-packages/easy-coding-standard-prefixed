 ...
 */
namespace _PhpScoperf65af7a6d9a0\Symfony\Component\Config\Resource;

use _PhpScoperf65af7a6d9a0\Symfony\Component\Finder\Finder;
use _PhpScoperf65af7a6d9a0\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \_PhpScoperf65af7a6d9a0\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\_PhpScoperf65af7a6d9a0\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScoperf65af7a6d9a0\Symfony\Component\Finder\Finder();
        $regex = \_PhpScoperf65af7a6d9a0\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
