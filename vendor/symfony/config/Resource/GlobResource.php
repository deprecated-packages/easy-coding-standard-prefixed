...
use _PhpScoper4f42ead57614\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \_PhpScoper4f42ead57614\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\_PhpScoper4f42ead57614\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScoper4f42ead57614\Symfony\Component\Finder\Finder();
        $regex = \_PhpScoper4f42ead57614\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
