 ...
 */
class VariableNode extends \_PhpScoper75713bc3e278\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper75713bc3e278\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function finalizeValue($value)
    {
        ...
        if (!$this->allowEmptyValue && $this->isValueEmpty($value)) {
            $ex = new \_PhpScoper75713bc3e278\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException(\sprintf('The path "%s" cannot contain an empty value, but got %s.', $this->getPath(), \json_encode($value)));
            if ($hint = $this->getInfo()) {
                $ex->addHint($hint);
            }
