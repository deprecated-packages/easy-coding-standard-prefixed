 ...
 */
class VariableNode extends \_PhpScoper06c66bea2cf6\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper06c66bea2cf6\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function finalizeValue($value)
    {
        ...
        if (!$this->allowEmptyValue && $this->isValueEmpty($value)) {
            $ex = new \_PhpScoper06c66bea2cf6\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException(\sprintf('The path "%s" cannot contain an empty value, but got %s.', $this->getPath(), \json_encode($value)));
            if ($hint = $this->getInfo()) {
                $ex->addHint($hint);
            }
