...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\_PhpScopere050faf861e6\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function ($v) {
            throw new \_PhpScopere050faf861e6\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key.');
        };
        return $this;
    }
    /**
