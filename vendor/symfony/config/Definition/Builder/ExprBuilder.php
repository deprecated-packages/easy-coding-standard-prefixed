...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\_PhpScoper6207116d4311\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function ($v) {
            throw new \_PhpScoper6207116d4311\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key');
        };
        return $this;
    }
    /**
