...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\_PhpScoperf53473b45c36\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function ($v) {
            throw new \_PhpScoperf53473b45c36\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key.');
        };
        return $this;
    }
    /**
