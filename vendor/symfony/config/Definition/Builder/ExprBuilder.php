...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\_PhpScoper0c236037eb04\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function ($v) {
            throw new \_PhpScoper0c236037eb04\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key');
        };
        return $this;
    }
    /**
