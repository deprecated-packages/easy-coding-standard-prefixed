...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\_PhpScopere341acab57d4\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function ($v) {
            throw new \_PhpScopere341acab57d4\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key');
        };
        return $this;
    }
    /**
