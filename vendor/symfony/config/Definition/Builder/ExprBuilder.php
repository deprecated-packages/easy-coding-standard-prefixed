...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\_PhpScoperb6d4bd368bd9\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function ($v) {
            throw new \_PhpScoperb6d4bd368bd9\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key');
        };
        return $this;
    }
    /**
