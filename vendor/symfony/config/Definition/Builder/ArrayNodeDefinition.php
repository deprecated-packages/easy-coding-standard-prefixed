...
use _PhpScopera9d6a31d814c\Symfony\Component\Config\Definition\ArrayNode;
use _PhpScopera9d6a31d814c\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException;
use _PhpScopera9d6a31d814c\Symfony\Component\Config\Definition\PrototypedArrayNode;
/**
 * This class provides a fluent interface for defining an array node.
 *
 * @author Johannes M. Schmitt <schmittjoh@gmail.com>
 */
class ArrayNodeDefinition extends \_PhpScopera9d6a31d814c\Symfony\Component\Config\Definition\Builder\NodeDefinition implements \_PhpScopera9d6a31d814c\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface
{
     ...
     * {@inheritdoc}
     */
    public function setBuilder(\_PhpScopera9d6a31d814c\Symfony\Component\Config\Definition\Builder\NodeBuilder $builder)
    {
    ...
    protected function getNodeBuilder()
    {
        if (null === $this->nodeBuilder) {
            $this->nodeBuilder = new \_PhpScopera9d6a31d814c\Symfony\Component\Config\Definition\Builder\NodeBuilder();
        }
     ...
     */
    public function find(string $nodePath) : \_PhpScopera9d6a31d814c\Symfony\Component\Config\Definition\Builder\NodeDefinition
    {
