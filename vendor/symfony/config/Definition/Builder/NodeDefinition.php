 ...
 */
abstract class NodeDefinition implements \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $name;
     ...
     * @return $this
     */
    public function setParent(\_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Builder\NodeParentInterface $parent)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    public function getNode(bool $forceRootNode = \false)
    {
        ...
        if (null !== $this->normalization) {
            $this->normalization->before = \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Builder\ExprBuilder::buildExpressions($this->normalization->before);
        }
        if (null !== $this->validation) {
            $this->validation->rules = \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Builder\ExprBuilder::buildExpressions($this->validation->rules);
        }
    ...
    {
        if (null === $this->validation) {
            $this->validation = new \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Builder\ValidationBuilder($this);
        }
    ...
    {
        if (null === $this->merge) {
            $this->merge = new \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Builder\MergeBuilder($this);
        }
        return $this->merge;
    }
    /**
    ...
    {
        if (null === $this->normalization) {
            $this->normalization = new \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Builder\NormalizationBuilder($this);
        }
    ...
    {
        if ($this instanceof \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface) {
