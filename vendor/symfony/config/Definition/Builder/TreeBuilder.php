 ...
 */
class TreeBuilder implements \_PhpScoperf5f75c22067b\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $tree;
    protected $root;
    public function __construct(string $name = null, string $type = 'array', \_PhpScoperf5f75c22067b\Symfony\Component\Config\Definition\Builder\NodeBuilder $builder = null)
    {
        if (null === $name) {
            ...
            $builder = $builder ?: new \_PhpScoperf5f75c22067b\Symfony\Component\Config\Definition\Builder\NodeBuilder();
     ...
     */
    public function root($name, $type = 'array', \_PhpScoperf5f75c22067b\Symfony\Component\Config\Definition\Builder\NodeBuilder $builder = null)
    {
     ...
     */
    public function getRootNode() : \_PhpScoperf5f75c22067b\Symfony\Component\Config\Definition\Builder\NodeDefinition
    {
        if (null === $this->root) {
    ...
    {
        if (null === $this->root) {
            throw new \_PhpScoperf5f75c22067b\Symfony\Component\Config\Definition\Exception\TreeWithoutRootNodeException('The configuration tree has no root node.');
        }
    }
}
