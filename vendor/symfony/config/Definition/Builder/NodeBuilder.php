 ...
 */
class NodeBuilder implements \_PhpScoperb09c3ec8e01a\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $parent;
     ...
     * @return $this
     */
    public function setParent(\_PhpScoperb09c3ec8e01a\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    {
        if ($node instanceof \_PhpScoperb09c3ec8e01a\Symfony\Component\Config\Definition\Builder\BuilderAwareInterface) {
            $builder = clone $this;
