 ...
 */
class NodeBuilder implements \_PhpScopercb576ca159b5\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $parent;
     ...
     * @return $this
     */
    public function setParent(\_PhpScopercb576ca159b5\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    {
        if ($node instanceof \_PhpScopercb576ca159b5\Symfony\Component\Config\Definition\Builder\BuilderAwareInterface) {
            $builder = clone $this;
