 ...
 */
class NodeBuilder implements \_PhpScoperedc2e0c967db\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $parent;
     ...
     * @return $this
     */
    public function setParent(\_PhpScoperedc2e0c967db\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    {
        if ($node instanceof \_PhpScoperedc2e0c967db\Symfony\Component\Config\Definition\Builder\BuilderAwareInterface) {
            $builder = clone $this;
