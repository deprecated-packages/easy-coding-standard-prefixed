 ...
 */
class NodeBuilder implements \_PhpScoper666af036e800\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $parent;
     ...
     * @return $this
     */
    public function setParent(\_PhpScoper666af036e800\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    {
        if ($node instanceof \_PhpScoper666af036e800\Symfony\Component\Config\Definition\Builder\BuilderAwareInterface) {
            $builder = clone $this;
