 ...
 */
class NodeBuilder implements \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $parent;
    protected $nodeMapping;
    public function __construct()
    {
        $this->nodeMapping = ['variable' => \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\VariableNodeDefinition::class, 'scalar' => \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\ScalarNodeDefinition::class, 'boolean' => \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\BooleanNodeDefinition::class, 'integer' => \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\IntegerNodeDefinition::class, 'float' => \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\FloatNodeDefinition::class, 'array' => \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\ArrayNodeDefinition::class, 'enum' => \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\EnumNodeDefinition::class];
    }
    /**
     * Set the parent node.
     *
     * @return $this
     */
    public function setParent(\_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    {
        if ($node instanceof \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Builder\BuilderAwareInterface) {
            $builder = clone $this;
