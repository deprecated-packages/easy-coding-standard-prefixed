...
use _PhpScoperd51690aa3091\Symfony\Component\Config\Definition\Exception\DuplicateKeyException;
use _PhpScoperd51690aa3091\Symfony\Component\Config\Definition\Exception\Exception;
use _PhpScoperd51690aa3091\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use _PhpScoperd51690aa3091\Symfony\Component\Config\Definition\Exception\UnsetKeyException;
/**
 * Represents a prototyped Array node in the config tree.
 *
 * @author Johannes M. Schmitt <schmittjoh@gmail.com>
 */
class PrototypedArrayNode extends \_PhpScoperd51690aa3091\Symfony\Component\Config\Definition\ArrayNode
{
    protected $prototype;
     ...
     */
    public function setPrototype(\_PhpScoperd51690aa3091\Symfony\Component\Config\Definition\PrototypeNodeInterface $node)
    {
        $this->prototype = $node;
    }
    /**
     ...
     * @throws Exception
     */
    public function addChild(\_PhpScoperd51690aa3091\Symfony\Component\Config\Definition\NodeInterface $node)
    {
            ...
            if (null !== $this->keyAttribute && \is_array($v)) {
                if (!isset($v[$this->keyAttribute]) && \is_int($k) && !$isAssoc) {
                    ...
                    if (\array_keys($v) === ['value']) {
                        $v = $v['value'];
                        if ($this->prototype instanceof \_PhpScoperd51690aa3091\Symfony\Component\Config\Definition\ArrayNode && ($children = $this->prototype->getChildren()) && \array_key_exists('value', $children)) {
