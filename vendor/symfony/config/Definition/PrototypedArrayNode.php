 ...
 */
namespace _PhpScoper855b7fb41c61\Symfony\Component\Config\Definition;

use _PhpScoper855b7fb41c61\Symfony\Component\Config\Definition\Exception\DuplicateKeyException;
use _PhpScoper855b7fb41c61\Symfony\Component\Config\Definition\Exception\Exception;
use _PhpScoper855b7fb41c61\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use _PhpScoper855b7fb41c61\Symfony\Component\Config\Definition\Exception\UnsetKeyException;
/**
 * Represents a prototyped Array node in the config tree.
 *
 * @author Johannes M. Schmitt <schmittjoh@gmail.com>
 */
class PrototypedArrayNode extends \_PhpScoper855b7fb41c61\Symfony\Component\Config\Definition\ArrayNode
{
    protected $prototype;
     ...
     */
    public function setPrototype(\_PhpScoper855b7fb41c61\Symfony\Component\Config\Definition\PrototypeNodeInterface $node)
    {
        $this->prototype = $node;
    }
    /**
     ...
     * @throws Exception
     */
    public function addChild(\_PhpScoper855b7fb41c61\Symfony\Component\Config\Definition\NodeInterface $node)
    {
            ...
            if (null !== $this->keyAttribute && \is_array($v)) {
                if (!isset($v[$this->keyAttribute]) && \is_int($k) && !$isAssoc) {
                    ...
                    if (\array_keys($v) === ['value']) {
                        $v = $v['value'];
                        if ($this->prototype instanceof \_PhpScoper855b7fb41c61\Symfony\Component\Config\Definition\ArrayNode && ($children = $this->prototype->getChildren()) && \array_key_exists('value', $children)) {
