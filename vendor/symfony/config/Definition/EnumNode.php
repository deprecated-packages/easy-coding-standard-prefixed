 ...
 */
class EnumNode extends \_PhpScoper7e6a1331d94a\Symfony\Component\Config\Definition\ScalarNode
{
    private $values;
    public function __construct(?string $name, \_PhpScoper7e6a1331d94a\Symfony\Component\Config\Definition\NodeInterface $parent = null, array $values = [], string $pathSeparator = \_PhpScoper7e6a1331d94a\Symfony\Component\Config\Definition\BaseNode::DEFAULT_PATH_SEPARATOR)
    {
