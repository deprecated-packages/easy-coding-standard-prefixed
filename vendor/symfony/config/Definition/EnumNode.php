 ...
 */
class EnumNode extends \_PhpScoper130a9a1cd4a2\Symfony\Component\Config\Definition\ScalarNode
{
    private $values;
    public function __construct(?string $name, \_PhpScoper130a9a1cd4a2\Symfony\Component\Config\Definition\NodeInterface $parent = null, array $values = [], string $pathSeparator = \_PhpScoper130a9a1cd4a2\Symfony\Component\Config\Definition\BaseNode::DEFAULT_PATH_SEPARATOR)
    {
