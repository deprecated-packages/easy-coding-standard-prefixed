 ...
 */
class ArrayNode extends \_PhpScoperd51690aa3091\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoperd51690aa3091\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoperd51690aa3091\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
