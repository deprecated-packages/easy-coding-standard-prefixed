 ...
 */
class ArrayNode extends \_PhpScopere72a8aaba560\Symfony\Component\Config\Definition\BaseNode implements \_PhpScopere72a8aaba560\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScopere72a8aaba560\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
