 ...
 */
class ArrayNode extends \_PhpScoper130a9a1cd4a2\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper130a9a1cd4a2\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoper130a9a1cd4a2\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
