...
use _PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
 ...
 */
class ArrayNode extends \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoper78e1a27e740b\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
