...
use _PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
 ...
 */
class ArrayNode extends \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoperc5e9eb67638f\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
