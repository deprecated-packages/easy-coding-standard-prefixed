...
use _PhpScopera658fe86acec\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
 ...
 */
class ArrayNode extends \_PhpScopera658fe86acec\Symfony\Component\Config\Definition\BaseNode implements \_PhpScopera658fe86acec\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScopera658fe86acec\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
