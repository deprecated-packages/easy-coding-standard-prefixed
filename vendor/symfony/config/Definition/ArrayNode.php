...
use _PhpScopercae9e6ab5cea\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
 ...
 */
class ArrayNode extends \_PhpScopercae9e6ab5cea\Symfony\Component\Config\Definition\BaseNode implements \_PhpScopercae9e6ab5cea\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScopercae9e6ab5cea\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
