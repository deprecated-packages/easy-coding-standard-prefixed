 ...
 */
class ArrayNode extends \_PhpScoper6ffa0951a2e9\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper6ffa0951a2e9\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoper6ffa0951a2e9\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
