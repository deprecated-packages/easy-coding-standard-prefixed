 ...
 */
class ArrayNode extends \_PhpScoper4575b9150b52\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper4575b9150b52\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoper4575b9150b52\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
