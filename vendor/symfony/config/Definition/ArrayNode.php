...
use _PhpScoperb5b1090524db\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
 ...
 */
class ArrayNode extends \_PhpScoperb5b1090524db\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoperb5b1090524db\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoperb5b1090524db\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
