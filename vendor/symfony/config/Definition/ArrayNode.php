 ...
 */
class ArrayNode extends \_PhpScoper0261263ca84f\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper0261263ca84f\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoper0261263ca84f\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
