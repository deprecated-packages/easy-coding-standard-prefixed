...
use _PhpScoper91fe47cd7f25\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
 ...
 */
class ArrayNode extends \_PhpScoper91fe47cd7f25\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper91fe47cd7f25\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoper91fe47cd7f25\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
