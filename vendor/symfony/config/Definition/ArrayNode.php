 ...
 */
class ArrayNode extends \_PhpScoper2dc059b3a969\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper2dc059b3a969\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoper2dc059b3a969\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
