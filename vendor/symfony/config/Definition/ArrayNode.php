 ...
 */
class ArrayNode extends \_PhpScoper91c59a2f52e1\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoper91c59a2f52e1\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoper91c59a2f52e1\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
