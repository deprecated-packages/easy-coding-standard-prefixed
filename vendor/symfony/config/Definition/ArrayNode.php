...
use _PhpScoperfde42a25c345\Symfony\Component\Config\Definition\Exception\InvalidTypeException;
 ...
 */
class ArrayNode extends \_PhpScoperfde42a25c345\Symfony\Component\Config\Definition\BaseNode implements \_PhpScoperfde42a25c345\Symfony\Component\Config\Definition\PrototypeNodeInterface
{
    ...
    protected function remapXml(array $value)
    {
        foreach ($this->xmlRemappings as [$singular, $plural]) {
            ...
            $value[$plural] = \_PhpScoperfde42a25c345\Symfony\Component\Config\Definition\Processor::normalizeConfig($value, $singular, $plural);
