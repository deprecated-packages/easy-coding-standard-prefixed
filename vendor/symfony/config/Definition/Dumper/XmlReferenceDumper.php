...
{
    private $reference;
    public function dump(\_PhpScoper5ea36b274140\Symfony\Component\Config\Definition\ConfigurationInterface $configuration, string $namespace = null)
    {
        return $this->dumpNode($configuration->getConfigTreeBuilder()->buildTree(), $namespace);
    }
    public function dumpNode(\_PhpScoper5ea36b274140\Symfony\Component\Config\Definition\NodeInterface $node, string $namespace = null)
    {
        $this->reference = '';
    ...
    private function writeNode(\_PhpScoper5ea36b274140\Symfony\Component\Config\Definition\NodeInterface $node, int $depth = 0, bool $root = \false, string $namespace = null)
    {
        ...
        if ($node instanceof \_PhpScoper5ea36b274140\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            if ($node instanceof \_PhpScoper5ea36b274140\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                ...
                if ($prototype instanceof \_PhpScoper5ea36b274140\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                    $prototype->setName($key ?? '');
                    $children = [$key => $prototype];
                } elseif ($prototype instanceof \_PhpScoper5ea36b274140\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            foreach ($children as $child) {
                if (!$child instanceof \_PhpScoper5ea36b274140\Symfony\Component\Config\Definition\ArrayNode) {
                    // get attributes
                    // metadata
                    ...
                    if ($child instanceof \_PhpScoper5ea36b274140\Symfony\Component\Config\Definition\EnumNode) {
