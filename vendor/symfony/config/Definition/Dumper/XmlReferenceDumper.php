...
{
    private $reference;
    public function dump(\_PhpScoperc233426b15e0\Symfony\Component\Config\Definition\ConfigurationInterface $configuration, string $namespace = null)
    {
        return $this->dumpNode($configuration->getConfigTreeBuilder()->buildTree(), $namespace);
    }
    public function dumpNode(\_PhpScoperc233426b15e0\Symfony\Component\Config\Definition\NodeInterface $node, string $namespace = null)
    {
        $this->reference = '';
    ...
    private function writeNode(\_PhpScoperc233426b15e0\Symfony\Component\Config\Definition\NodeInterface $node, int $depth = 0, bool $root = \false, string $namespace = null)
    {
        ...
        if ($node instanceof \_PhpScoperc233426b15e0\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            if ($node instanceof \_PhpScoperc233426b15e0\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                ...
                if ($prototype instanceof \_PhpScoperc233426b15e0\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                    $prototype->setName($key ?? '');
                    $children = [$key => $prototype];
                } elseif ($prototype instanceof \_PhpScoperc233426b15e0\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            foreach ($children as $child) {
                if (!$child instanceof \_PhpScoperc233426b15e0\Symfony\Component\Config\Definition\ArrayNode) {
                    // get attributes
                    // metadata
                    ...
                    if ($child instanceof \_PhpScoperc233426b15e0\Symfony\Component\Config\Definition\EnumNode) {
