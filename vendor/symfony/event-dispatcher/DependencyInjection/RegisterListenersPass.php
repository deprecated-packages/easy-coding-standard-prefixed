 ...
 */
namespace _PhpScoper0a055416a443\Symfony\Component\EventDispatcher\DependencyInjection;
...
class RegisterListenersPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $extractingDispatcher = new \_PhpScoper0a055416a443\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher();
        foreach ($container->findTaggedServiceIds($this->subscriberTag, \true) as $id => $tags) {
            ...
            $noPreload = 0;
            \_PhpScoper0a055416a443\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$aliases = $aliases;
            \_PhpScoper0a055416a443\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$subscriber = $class;
            ...
            \_PhpScoper0a055416a443\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$aliases = [];
        }
    }
