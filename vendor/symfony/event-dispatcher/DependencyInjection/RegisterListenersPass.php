 ...
 */
namespace _PhpScoper85e989d55df2\Symfony\Component\EventDispatcher\DependencyInjection;
...
class RegisterListenersPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $extractingDispatcher = new \_PhpScoper85e989d55df2\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher();
        foreach ($container->findTaggedServiceIds($this->subscriberTag, \true) as $id => $tags) {
            ...
            $noPreload = 0;
            \_PhpScoper85e989d55df2\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$aliases = $aliases;
            \_PhpScoper85e989d55df2\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$subscriber = $class;
            ...
            \_PhpScoper85e989d55df2\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$aliases = [];
        }
    }
