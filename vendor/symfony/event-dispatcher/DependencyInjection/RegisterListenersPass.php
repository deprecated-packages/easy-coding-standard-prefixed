 ...
 */
namespace _PhpScoper917c99b6aa4c\Symfony\Component\EventDispatcher\DependencyInjection;
...
class RegisterListenersPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $extractingDispatcher = new \_PhpScoper917c99b6aa4c\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher();
        foreach ($container->findTaggedServiceIds($this->subscriberTag, \true) as $id => $tags) {
            ...
            $noPreload = 0;
            \_PhpScoper917c99b6aa4c\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$aliases = $aliases;
            \_PhpScoper917c99b6aa4c\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$subscriber = $class;
            ...
            \_PhpScoper917c99b6aa4c\Symfony\Component\EventDispatcher\DependencyInjection\ExtractingEventDispatcher::$aliases = [];
        }
    }
