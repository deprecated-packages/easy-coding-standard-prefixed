...
trigger_deprecation('symfony/event-dispatcher', '5.1', '%s is deprecated, use the event dispatcher without the proxy.', \_PhpScoperc5e9eb67638f\Symfony\Component\EventDispatcher\LegacyEventDispatcherProxy::class);
/**
