 ...
 */
class UnicodeString extends \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function append(string ...$suffix) : \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    {
        if ($suffix instanceof \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($needle instanceof \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString) {
    ...
    public function join(array $strings, string $lastGlue = null) : \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString
    {
    ...
    public function prepend(string ...$prefix) : \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replace(string $from, string $to) : \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replaceMatches(string $fromRegexp, $to) : \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString
    {
        $str = parent::replaceMatches($fromRegexp, $to);
        \normalizer_is_normalized($str->string) ?: ($str->string = \normalizer_normalize($str->string));
        return $str;
    }
    public function slice(int $start = 0, int $length = null) : \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function splice(string $replacement, int $start = 0, int $length = null) : \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
        if (\PHP_VERSION_ID < 80000 && 0 > $start && \grapheme_strlen($this->string) < -$start) {
            $start = 0;
    ...
    {
        if ($prefix instanceof \_PhpScoper45e1bde0f567\Symfony\Component\String\AbstractString) {
