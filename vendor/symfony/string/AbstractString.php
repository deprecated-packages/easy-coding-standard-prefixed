...
abstract class AbstractString implements \Stringable, \JsonSerializable
{
    ...
    public function toByteString(string $toEncoding = null) : \_PhpScoperd232d3743ab9\Symfony\Component\String\ByteString
    {
        $b = new \_PhpScoperd232d3743ab9\Symfony\Component\String\ByteString();
        $toEncoding = \in_array($toEncoding, ['utf8', 'utf-8', 'UTF8'], \true) ? 'UTF-8' : $toEncoding;
        if (null === $toEncoding || $toEncoding === ($fromEncoding = $this instanceof \_PhpScoperd232d3743ab9\Symfony\Component\String\AbstractUnicodeString || \preg_match('//u', $b->string) ? 'UTF-8' : 'Windows-1252')) {
    ...
    public function toCodePointString() : \_PhpScoperd232d3743ab9\Symfony\Component\String\CodePointString
    {
        return new \_PhpScoperd232d3743ab9\Symfony\Component\String\CodePointString($this->string);
    }
    public function toString() : string
    {
        return $this->string;
    }
    public function toUnicodeString() : \_PhpScoperd232d3743ab9\Symfony\Component\String\UnicodeString
    {
        return new \_PhpScoperd232d3743ab9\Symfony\Component\String\UnicodeString($this->string);
    }
    /**
     * @return static
     */
