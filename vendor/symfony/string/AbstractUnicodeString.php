 ...
 */
namespace _PhpScoper0a055416a443\Symfony\Component\String;

use _PhpScoper0a055416a443\Symfony\Component\String\Exception\ExceptionInterface;
use _PhpScoper0a055416a443\Symfony\Component\String\Exception\InvalidArgumentException;
use _PhpScoper0a055416a443\Symfony\Component\String\Exception\RuntimeException;
/**
 ...
 */
abstract class AbstractUnicodeString extends \_PhpScoper0a055416a443\Symfony\Component\String\AbstractString
{
    ...
    public function snake() : parent
    {
        ...
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], '_PhpScoper0a055416a443\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
