 ...
 */
namespace _PhpScopera22bb3f4d7b7\Symfony\Component\String;

use _PhpScopera22bb3f4d7b7\Symfony\Component\String\Exception\ExceptionInterface;
use _PhpScopera22bb3f4d7b7\Symfony\Component\String\Exception\InvalidArgumentException;
use _PhpScopera22bb3f4d7b7\Symfony\Component\String\Exception\RuntimeException;
/**
 ...
 */
abstract class AbstractUnicodeString extends \_PhpScopera22bb3f4d7b7\Symfony\Component\String\AbstractString
{
    ...
    public function snake() : parent
    {
        ...
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], '_PhpScopera22bb3f4d7b7\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
