 ...
 */
abstract class AbstractUnicodeString extends \_PhpScoper8b3c9ad56565\Symfony\Component\String\AbstractString
{
    ...
    public function snake() : parent
    {
        ...
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], '_PhpScoper8b3c9ad56565\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
