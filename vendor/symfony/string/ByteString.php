 ...
 */
class ByteString extends \_PhpScoperfde42a25c345\Symfony\Component\String\AbstractString
{
    ...
    public function snake() : parent
    {
        ...
        $str->string = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], '_PhpScoperfde42a25c345\\1_\\2', $str->string));
        return $str;
    }
    ...
    public function toUnicodeString(string $fromEncoding = null) : \_PhpScoperfde42a25c345\Symfony\Component\String\UnicodeString
    {
        return new \_PhpScoperfde42a25c345\Symfony\Component\String\UnicodeString($this->toCodePointString($fromEncoding)->string);
    }
    public function toCodePointString(string $fromEncoding = null) : \_PhpScoperfde42a25c345\Symfony\Component\String\CodePointString
    {
        $u = new \_PhpScoperfde42a25c345\Symfony\Component\String\CodePointString();
    ...
    public function width(bool $ignoreAnsiDecoration = \true) : int
    {
        ...
        return (new \_PhpScoperfde42a25c345\Symfony\Component\String\CodePointString($string))->width($ignoreAnsiDecoration);
    }
}
