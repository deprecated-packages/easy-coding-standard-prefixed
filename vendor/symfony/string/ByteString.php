 ...
 */
class ByteString extends \_PhpScoperb6361033cf41\Symfony\Component\String\AbstractString
{
    ...
    {
        if ($length <= 0) {
            throw new \_PhpScoperb6361033cf41\Symfony\Component\String\Exception\InvalidArgumentException(\sprintf('A strictly positive length is expected, "%d" given.', $length));
        }
        $alphabet = $alphabet ?? self::ALPHABET_ALPHANUMERIC;
        $alphabetSize = \strlen($alphabet);
        $bits = (int) \ceil(\log($alphabetSize, 2.0));
        if ($bits <= 0 || $bits > 56) {
            throw new \_PhpScoperb6361033cf41\Symfony\Component\String\Exception\InvalidArgumentException('The length of the alphabet must in the [2^1, 2^56] range.');
        }
        $ret = '';
        while ($length > 0) {
    ...
    public function append(string ...$suffix) : \_PhpScoperb6361033cf41\parent
    {
        $str = clone $this;
    ...
    {
        if (1 > $length) {
            throw new \_PhpScoperb6361033cf41\Symfony\Component\String\Exception\InvalidArgumentException('The chunk length must be greater than zero.');
        }
        if ('' === $this->string) {
            return [];
        }
    ...
    public function folded() : \_PhpScoperb6361033cf41\parent
    {
        $str = clone $this;
    ...
    public function prepend(string ...$prefix) : \_PhpScoperb6361033cf41\parent
    {
        $str = clone $this;
        $str->string = (1 >= \count($prefix) ? $prefix[0] ?? '' : \implode('', $prefix)) . $str->string;
        return $str;
    }
    public function replace(string $from, string $to) : \_PhpScoperb6361033cf41\parent
    {
        $str = clone $this;
        if ('' !== $from) {
    ...
    public function slice(int $start = 0, int $length = null) : \_PhpScoperb6361033cf41\parent
    {
        $str = clone $this;
    ...
    public function snake() : \_PhpScoperb6361033cf41\parent
    {
        ...
        $str->string = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], '_PhpScoperb6361033cf41\\1_\\2', $str->string));
        return $str;
    }
    public function splice(string $replacement, int $start = 0, int $length = null) : \_PhpScoperb6361033cf41\parent
    {
        $str = clone $this;
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        if (1 > ($limit = $limit ?? \PHP_INT_MAX)) {
            throw new \_PhpScoperb6361033cf41\Symfony\Component\String\Exception\InvalidArgumentException('Split limit must be a positive integer.');
        }
        if ('' === $delimiter) {
            throw new \_PhpScoperb6361033cf41\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is empty.');
        }
        if (null !== $flags) {
    ...
    public function toUnicodeString(string $fromEncoding = null) : \_PhpScoperb6361033cf41\Symfony\Component\String\UnicodeString
    {
        return new \_PhpScoperb6361033cf41\Symfony\Component\String\UnicodeString($this->toCodePointString($fromEncoding)->string);
    }
    public function toCodePointString(string $fromEncoding = null) : \_PhpScoperb6361033cf41\Symfony\Component\String\CodePointString
    {
        $u = new \_PhpScoperb6361033cf41\Symfony\Component\String\CodePointString();
        ...
        try {
            ...
            } catch (\_PhpScoperb6361033cf41\Symfony\Component\String\Exception\InvalidArgumentException $e) {
        ...
        if (!$validEncoding) {
            throw new \_PhpScoperb6361033cf41\Symfony\Component\String\Exception\InvalidArgumentException(\sprintf('Invalid "%s" string.', $fromEncoding ?? 'Windows-1252'));
        }
    ...
    public function width(bool $ignoreAnsiDecoration = \true) : int
    {
        ...
        return (new \_PhpScoperb6361033cf41\Symfony\Component\String\CodePointString($string))->width($ignoreAnsiDecoration);
    }
}
