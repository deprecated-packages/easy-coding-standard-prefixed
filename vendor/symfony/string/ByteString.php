 ...
 */
class ByteString extends \_PhpScoper5686a261d89c\Symfony\Component\String\AbstractString
{
    ...
    public function snake() : parent
    {
        ...
        $str->string = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], '_PhpScoper5686a261d89c\\1_\\2', $str->string));
        return $str;
    }
    ...
    public function toUnicodeString(string $fromEncoding = null) : \_PhpScoper5686a261d89c\Symfony\Component\String\UnicodeString
    {
        return new \_PhpScoper5686a261d89c\Symfony\Component\String\UnicodeString($this->toCodePointString($fromEncoding)->string);
    }
    public function toCodePointString(string $fromEncoding = null) : \_PhpScoper5686a261d89c\Symfony\Component\String\CodePointString
    {
        $u = new \_PhpScoper5686a261d89c\Symfony\Component\String\CodePointString();
    ...
    public function width(bool $ignoreAnsiDecoration = \true) : int
    {
        ...
        return (new \_PhpScoper5686a261d89c\Symfony\Component\String\CodePointString($string))->width($ignoreAnsiDecoration);
    }
}
