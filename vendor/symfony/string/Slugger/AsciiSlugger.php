 ...
 */
namespace _PhpScopercd2fc5ef50ef\Symfony\Component\String\Slugger;

use _PhpScopercd2fc5ef50ef\Symfony\Component\String\AbstractUnicodeString;
...
if (!\interface_exists(\_PhpScopercd2fc5ef50ef\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \_PhpScopercd2fc5ef50ef\Symfony\Component\String\Slugger\SluggerInterface, \_PhpScopercd2fc5ef50ef\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     * {@inheritdoc}
     */
    public function slug(string $string, string $separator = '-', string $locale = null) : \_PhpScopercd2fc5ef50ef\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \_PhpScopercd2fc5ef50ef\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
