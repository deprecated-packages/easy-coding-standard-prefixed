 ...
 */
namespace _PhpScopere050faf861e6\Symfony\Component\String\Slugger;

use _PhpScopere050faf861e6\Symfony\Component\String\AbstractUnicodeString;
use _PhpScopere050faf861e6\Symfony\Component\String\UnicodeString;
use _PhpScopere050faf861e6\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\_PhpScopere050faf861e6\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \_PhpScopere050faf861e6\Symfony\Component\String\Slugger\SluggerInterface, \_PhpScopere050faf861e6\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     * {@inheritdoc}
     */
    public function slug(string $string, string $separator = '-', string $locale = null) : \_PhpScopere050faf861e6\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \_PhpScopere050faf861e6\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
