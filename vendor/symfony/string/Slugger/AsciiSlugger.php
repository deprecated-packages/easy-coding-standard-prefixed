 ...
 */
namespace _PhpScoperf5c57eca8aae\Symfony\Component\String\Slugger;

use _PhpScoperf5c57eca8aae\Symfony\Component\String\AbstractUnicodeString;
...
if (!\interface_exists(\_PhpScoperf5c57eca8aae\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \_PhpScoperf5c57eca8aae\Symfony\Component\String\Slugger\SluggerInterface, \_PhpScoperf5c57eca8aae\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     * {@inheritdoc}
     */
    public function slug(string $string, string $separator = '-', string $locale = null) : \_PhpScoperf5c57eca8aae\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \_PhpScoperf5c57eca8aae\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
