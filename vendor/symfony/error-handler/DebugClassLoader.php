...
use _PhpScoperdaf95aff095b\Doctrine\Common\Persistence\Proxy;
use _PhpScoperdaf95aff095b\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperdaf95aff095b\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperdaf95aff095b\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperdaf95aff095b\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperdaf95aff095b\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperdaf95aff095b\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperdaf95aff095b\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperdaf95aff095b\ProxyManager\Proxy\ProxyInterface::class)) {
