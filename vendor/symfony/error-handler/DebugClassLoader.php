...
use _PhpScopera1a51450b61d\Doctrine\Common\Persistence\Proxy;
use _PhpScopera1a51450b61d\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera1a51450b61d\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera1a51450b61d\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera1a51450b61d\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopera1a51450b61d\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopera1a51450b61d\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera1a51450b61d\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera1a51450b61d\ProxyManager\Proxy\ProxyInterface::class)) {
