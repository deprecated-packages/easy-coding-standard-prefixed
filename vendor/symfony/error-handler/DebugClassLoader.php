...
use _PhpScoper64ca614e27fd\Doctrine\Common\Persistence\Proxy;
use _PhpScoper64ca614e27fd\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper64ca614e27fd\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper64ca614e27fd\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper64ca614e27fd\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper64ca614e27fd\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper64ca614e27fd\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper64ca614e27fd\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper64ca614e27fd\ProxyManager\Proxy\ProxyInterface::class)) {
