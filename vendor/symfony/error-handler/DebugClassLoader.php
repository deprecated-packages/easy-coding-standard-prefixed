...
use _PhpScoperdc8fbcd7c69d\Doctrine\Common\Persistence\Proxy;
use _PhpScoperdc8fbcd7c69d\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperdc8fbcd7c69d\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperdc8fbcd7c69d\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperdc8fbcd7c69d\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperdc8fbcd7c69d\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperdc8fbcd7c69d\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperdc8fbcd7c69d\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperdc8fbcd7c69d\ProxyManager\Proxy\ProxyInterface::class)) {
