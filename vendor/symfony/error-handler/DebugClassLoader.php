...
use _PhpScoper83a475a0590e\Doctrine\Common\Persistence\Proxy;
use _PhpScoper83a475a0590e\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper83a475a0590e\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper83a475a0590e\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper83a475a0590e\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper83a475a0590e\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper83a475a0590e\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper83a475a0590e\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper83a475a0590e\ProxyManager\Proxy\ProxyInterface::class)) {
