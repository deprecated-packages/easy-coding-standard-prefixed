...
use _PhpScoper5c006f5f032f\Doctrine\Common\Persistence\Proxy;
use _PhpScoper5c006f5f032f\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper5c006f5f032f\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper5c006f5f032f\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper5c006f5f032f\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper5c006f5f032f\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper5c006f5f032f\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper5c006f5f032f\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper5c006f5f032f\ProxyManager\Proxy\ProxyInterface::class)) {
