...
use _PhpScoper58a0a169dcfb\Doctrine\Common\Persistence\Proxy;
use _PhpScoper58a0a169dcfb\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper58a0a169dcfb\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper58a0a169dcfb\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper58a0a169dcfb\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper58a0a169dcfb\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper58a0a169dcfb\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper58a0a169dcfb\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper58a0a169dcfb\ProxyManager\Proxy\ProxyInterface::class)) {
