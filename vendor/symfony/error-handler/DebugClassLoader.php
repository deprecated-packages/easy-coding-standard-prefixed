...
use _PhpScoper745103eaabcd\Doctrine\Common\Persistence\Proxy;
use _PhpScoper745103eaabcd\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper745103eaabcd\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper745103eaabcd\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper745103eaabcd\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper745103eaabcd\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper745103eaabcd\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper745103eaabcd\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper745103eaabcd\ProxyManager\Proxy\ProxyInterface::class)) {
