...
use _PhpScoper870c18c2de74\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoper870c18c2de74\Doctrine\Persistence\Proxy;
use _PhpScoper870c18c2de74\Mockery\MockInterface;
use _PhpScoper870c18c2de74\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper870c18c2de74\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper870c18c2de74\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\_PhpScoper870c18c2de74\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\_PhpScoper870c18c2de74\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoper870c18c2de74\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
