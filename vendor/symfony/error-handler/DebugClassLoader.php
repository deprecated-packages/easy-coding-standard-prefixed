...
use _PhpScoper89c09b8e7101\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoper89c09b8e7101\Doctrine\Persistence\Proxy;
use _PhpScoper89c09b8e7101\Mockery\MockInterface;
use _PhpScoper89c09b8e7101\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper89c09b8e7101\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper89c09b8e7101\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\_PhpScoper89c09b8e7101\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\_PhpScoper89c09b8e7101\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoper89c09b8e7101\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
