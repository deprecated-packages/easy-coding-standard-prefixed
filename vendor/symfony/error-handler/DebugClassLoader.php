...
use _PhpScoper04022cd986ec\Doctrine\Common\Persistence\Proxy;
use _PhpScoper04022cd986ec\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper04022cd986ec\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper04022cd986ec\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper04022cd986ec\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper04022cd986ec\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper04022cd986ec\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper04022cd986ec\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper04022cd986ec\ProxyManager\Proxy\ProxyInterface::class)) {
