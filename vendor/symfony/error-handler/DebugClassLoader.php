...
use _PhpScoperff1e514762b4\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoperff1e514762b4\Doctrine\Persistence\Proxy;
use _PhpScoperff1e514762b4\Mockery\MockInterface;
use _PhpScoperff1e514762b4\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperff1e514762b4\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperff1e514762b4\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\_PhpScoperff1e514762b4\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\_PhpScoperff1e514762b4\Psr\Log\LogLevel::class);
