...
use _PhpScoperbaf90856897c\Doctrine\Common\Persistence\Proxy;
use _PhpScoperbaf90856897c\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperbaf90856897c\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperbaf90856897c\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperbaf90856897c\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperbaf90856897c\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbaf90856897c\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbaf90856897c\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbaf90856897c\ProxyManager\Proxy\ProxyInterface::class)) {
