...
use _PhpScoper6224e3b16fcc\Doctrine\Common\Persistence\Proxy;
use _PhpScoper6224e3b16fcc\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper6224e3b16fcc\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper6224e3b16fcc\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper6224e3b16fcc\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper6224e3b16fcc\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper6224e3b16fcc\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper6224e3b16fcc\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper6224e3b16fcc\ProxyManager\Proxy\ProxyInterface::class)) {
