...
use _PhpScoper75713bc3e278\Doctrine\Common\Persistence\Proxy;
use _PhpScoper75713bc3e278\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper75713bc3e278\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper75713bc3e278\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper75713bc3e278\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper75713bc3e278\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper75713bc3e278\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper75713bc3e278\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper75713bc3e278\ProxyManager\Proxy\ProxyInterface::class)) {
