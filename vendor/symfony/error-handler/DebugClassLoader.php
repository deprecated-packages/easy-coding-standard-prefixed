...
use _PhpScopera1f11cc38772\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScopera1f11cc38772\Doctrine\Persistence\Proxy;
use _PhpScopera1f11cc38772\Mockery\MockInterface;
use _PhpScopera1f11cc38772\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera1f11cc38772\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera1f11cc38772\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\_PhpScopera1f11cc38772\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\_PhpScopera1f11cc38772\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScopera1f11cc38772\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
