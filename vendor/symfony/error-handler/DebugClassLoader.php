...
use _PhpScoper1ed8518cf1bf\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoper1ed8518cf1bf\Doctrine\Persistence\Proxy;
use _PhpScoper1ed8518cf1bf\Mockery\MockInterface;
use _PhpScoper1ed8518cf1bf\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper1ed8518cf1bf\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper1ed8518cf1bf\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\_PhpScoper1ed8518cf1bf\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\_PhpScoper1ed8518cf1bf\Psr\Log\LogLevel::class);
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper1ed8518cf1bf\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper1ed8518cf1bf\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper1ed8518cf1bf\Doctrine\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper1ed8518cf1bf\ProxyManager\Proxy\ProxyInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper1ed8518cf1bf\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper1ed8518cf1bf\Mockery\MockInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoper1ed8518cf1bf\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
