...
use _PhpScopercd2fc5ef50ef\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScopercd2fc5ef50ef\Doctrine\Persistence\Proxy;
use _PhpScopercd2fc5ef50ef\Mockery\MockInterface;
use _PhpScopercd2fc5ef50ef\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopercd2fc5ef50ef\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopercd2fc5ef50ef\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\_PhpScopercd2fc5ef50ef\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\_PhpScopercd2fc5ef50ef\Psr\Log\LogLevel::class);
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopercd2fc5ef50ef\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopercd2fc5ef50ef\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopercd2fc5ef50ef\Doctrine\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopercd2fc5ef50ef\ProxyManager\Proxy\ProxyInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopercd2fc5ef50ef\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopercd2fc5ef50ef\Mockery\MockInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScopercd2fc5ef50ef\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
