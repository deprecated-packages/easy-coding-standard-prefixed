...
use _PhpScoper2fe14d6302bc\Doctrine\Common\Persistence\Proxy;
use _PhpScoper2fe14d6302bc\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper2fe14d6302bc\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper2fe14d6302bc\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper2fe14d6302bc\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper2fe14d6302bc\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper2fe14d6302bc\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper2fe14d6302bc\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper2fe14d6302bc\ProxyManager\Proxy\ProxyInterface::class)) {
