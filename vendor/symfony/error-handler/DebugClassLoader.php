...
use _PhpScoper61bdb485188f\Doctrine\Common\Persistence\Proxy;
use _PhpScoper61bdb485188f\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper61bdb485188f\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper61bdb485188f\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper61bdb485188f\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper61bdb485188f\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper61bdb485188f\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper61bdb485188f\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper61bdb485188f\ProxyManager\Proxy\ProxyInterface::class)) {
