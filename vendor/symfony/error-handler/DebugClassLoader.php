...
use _PhpScoperf3dc21757def\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoperf3dc21757def\Doctrine\Persistence\Proxy;
use _PhpScoperf3dc21757def\Mockery\MockInterface;
use _PhpScoperf3dc21757def\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperf3dc21757def\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperf3dc21757def\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\_PhpScoperf3dc21757def\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\_PhpScoperf3dc21757def\Psr\Log\LogLevel::class);
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperf3dc21757def\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperf3dc21757def\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperf3dc21757def\Doctrine\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperf3dc21757def\ProxyManager\Proxy\ProxyInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperf3dc21757def\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperf3dc21757def\Mockery\MockInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperf3dc21757def\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
