...
use _PhpScoper167729fa1dde\Doctrine\Common\Persistence\Proxy;
use _PhpScoper167729fa1dde\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper167729fa1dde\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper167729fa1dde\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper167729fa1dde\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper167729fa1dde\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper167729fa1dde\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper167729fa1dde\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper167729fa1dde\ProxyManager\Proxy\ProxyInterface::class)) {
