...
use _PhpScopera23ebff5477f\Doctrine\Common\Persistence\Proxy;
use _PhpScopera23ebff5477f\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera23ebff5477f\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera23ebff5477f\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera23ebff5477f\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopera23ebff5477f\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopera23ebff5477f\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera23ebff5477f\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera23ebff5477f\ProxyManager\Proxy\ProxyInterface::class)) {
