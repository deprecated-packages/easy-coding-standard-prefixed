...
use _PhpScopera37d6fb0b1ab\Doctrine\Common\Persistence\Proxy;
use _PhpScopera37d6fb0b1ab\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera37d6fb0b1ab\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera37d6fb0b1ab\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera37d6fb0b1ab\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopera37d6fb0b1ab\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopera37d6fb0b1ab\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera37d6fb0b1ab\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera37d6fb0b1ab\ProxyManager\Proxy\ProxyInterface::class)) {
