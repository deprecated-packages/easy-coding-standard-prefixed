...
use _PhpScoper589e8c04a9ef\Doctrine\Common\Persistence\Proxy;
use _PhpScoper589e8c04a9ef\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper589e8c04a9ef\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper589e8c04a9ef\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper589e8c04a9ef\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper589e8c04a9ef\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper589e8c04a9ef\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper589e8c04a9ef\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper589e8c04a9ef\ProxyManager\Proxy\ProxyInterface::class)) {
