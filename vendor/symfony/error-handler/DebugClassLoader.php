...
use _PhpScoper02b5d1bf8fec\Doctrine\Common\Persistence\Proxy;
use _PhpScoper02b5d1bf8fec\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper02b5d1bf8fec\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper02b5d1bf8fec\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper02b5d1bf8fec\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper02b5d1bf8fec\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper02b5d1bf8fec\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper02b5d1bf8fec\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper02b5d1bf8fec\ProxyManager\Proxy\ProxyInterface::class)) {
