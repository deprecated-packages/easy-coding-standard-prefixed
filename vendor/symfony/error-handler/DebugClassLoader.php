...
use _PhpScopera40fc53e636b\Doctrine\Common\Persistence\Proxy;
use _PhpScopera40fc53e636b\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera40fc53e636b\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera40fc53e636b\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera40fc53e636b\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopera40fc53e636b\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopera40fc53e636b\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera40fc53e636b\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera40fc53e636b\ProxyManager\Proxy\ProxyInterface::class)) {
