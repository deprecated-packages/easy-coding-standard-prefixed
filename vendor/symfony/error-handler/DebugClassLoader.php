...
use _PhpScoperbcc0395698f8\Doctrine\Common\Persistence\Proxy;
use _PhpScoperbcc0395698f8\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperbcc0395698f8\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperbcc0395698f8\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperbcc0395698f8\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperbcc0395698f8\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbcc0395698f8\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbcc0395698f8\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbcc0395698f8\ProxyManager\Proxy\ProxyInterface::class)) {
