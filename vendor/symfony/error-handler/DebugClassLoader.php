...
use _PhpScoper17bb67c99ade\Doctrine\Common\Persistence\Proxy;
use _PhpScoper17bb67c99ade\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper17bb67c99ade\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper17bb67c99ade\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper17bb67c99ade\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper17bb67c99ade\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper17bb67c99ade\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper17bb67c99ade\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper17bb67c99ade\ProxyManager\Proxy\ProxyInterface::class)) {
