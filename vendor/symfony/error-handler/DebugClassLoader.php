...
use _PhpScoper0f5cd390c37a\Doctrine\Common\Persistence\Proxy;
use _PhpScoper0f5cd390c37a\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper0f5cd390c37a\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper0f5cd390c37a\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper0f5cd390c37a\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper0f5cd390c37a\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper0f5cd390c37a\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper0f5cd390c37a\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper0f5cd390c37a\ProxyManager\Proxy\ProxyInterface::class)) {
