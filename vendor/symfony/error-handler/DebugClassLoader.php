...
use _PhpScopera09818bc50da\Doctrine\Common\Persistence\Proxy;
use _PhpScopera09818bc50da\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera09818bc50da\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera09818bc50da\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera09818bc50da\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopera09818bc50da\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopera09818bc50da\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera09818bc50da\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera09818bc50da\ProxyManager\Proxy\ProxyInterface::class)) {
