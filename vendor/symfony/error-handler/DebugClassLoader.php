...
use _PhpScoper836bc32aecc2\Doctrine\Common\Persistence\Proxy;
use _PhpScoper836bc32aecc2\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper836bc32aecc2\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper836bc32aecc2\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper836bc32aecc2\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper836bc32aecc2\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper836bc32aecc2\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper836bc32aecc2\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper836bc32aecc2\ProxyManager\Proxy\ProxyInterface::class)) {
