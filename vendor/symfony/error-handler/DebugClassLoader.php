...
use _PhpScoperd675aaf00c76\Doctrine\Common\Persistence\Proxy;
use _PhpScoperd675aaf00c76\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperd675aaf00c76\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperd675aaf00c76\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperd675aaf00c76\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperd675aaf00c76\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperd675aaf00c76\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperd675aaf00c76\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperd675aaf00c76\ProxyManager\Proxy\ProxyInterface::class)) {
