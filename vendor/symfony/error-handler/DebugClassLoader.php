...
use _PhpScopera8f555a7493c\Doctrine\Common\Persistence\Proxy;
use _PhpScopera8f555a7493c\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera8f555a7493c\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera8f555a7493c\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera8f555a7493c\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopera8f555a7493c\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopera8f555a7493c\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera8f555a7493c\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera8f555a7493c\ProxyManager\Proxy\ProxyInterface::class)) {
