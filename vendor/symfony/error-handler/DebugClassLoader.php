...
use _PhpScoper53db80252f28\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoper53db80252f28\Doctrine\Persistence\Proxy;
use _PhpScoper53db80252f28\Mockery\MockInterface;
use _PhpScoper53db80252f28\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper53db80252f28\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper53db80252f28\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\_PhpScoper53db80252f28\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\_PhpScoper53db80252f28\Psr\Log\LogLevel::class);
