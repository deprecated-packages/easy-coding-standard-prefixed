...
use _PhpScoper1103e00fb46b\Doctrine\Common\Persistence\Proxy;
use _PhpScoper1103e00fb46b\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper1103e00fb46b\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper1103e00fb46b\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper1103e00fb46b\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper1103e00fb46b\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper1103e00fb46b\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper1103e00fb46b\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper1103e00fb46b\ProxyManager\Proxy\ProxyInterface::class)) {
