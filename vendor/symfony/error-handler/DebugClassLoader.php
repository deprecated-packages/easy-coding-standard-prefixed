...
use _PhpScoper528afa732cbd\Doctrine\Common\Persistence\Proxy;
use _PhpScoper528afa732cbd\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper528afa732cbd\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper528afa732cbd\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper528afa732cbd\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper528afa732cbd\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper528afa732cbd\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper528afa732cbd\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper528afa732cbd\ProxyManager\Proxy\ProxyInterface::class)) {
