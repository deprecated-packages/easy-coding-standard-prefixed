 ...
 */
namespace _PhpScopera749ac204cd2\Symfony\Component\ErrorHandler\ErrorEnhancer;
...
use _PhpScopera749ac204cd2\Symfony\Component\ErrorHandler\Error\ClassNotFoundError;
use _PhpScopera749ac204cd2\Symfony\Component\ErrorHandler\Error\FatalError;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 */
class ClassNotFoundErrorEnhancer implements \_PhpScopera749ac204cd2\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface
{
    /**
     * {@inheritdoc}
     */
    public function enhance(\Throwable $error) : ?\Throwable
    {
        ...
        $message = !$error instanceof \_PhpScopera749ac204cd2\Symfony\Component\ErrorHandler\Error\FatalError ? $error->getMessage() : $error->getError()['message'];
        ...
        foreach (['class', 'interface', 'trait'] as $typeName) {
            ...
            return new \_PhpScopera749ac204cd2\Symfony\Component\ErrorHandler\Error\ClassNotFoundError($message, $error);
        }
        return null;
    }
    /**
    ...
    private function getClassCandidates(string $class) : array
    {
        ...
        foreach ($functions as $function) {
            ...
            if ($function[0] instanceof \_PhpScopera749ac204cd2\Symfony\Component\ErrorHandler\DebugClassLoader) {
