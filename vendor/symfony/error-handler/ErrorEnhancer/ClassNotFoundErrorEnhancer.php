 ...
 */
namespace _PhpScoperd301db66c80c\Symfony\Component\ErrorHandler\ErrorEnhancer;
...
use _PhpScoperd301db66c80c\Symfony\Component\ErrorHandler\Error\ClassNotFoundError;
use _PhpScoperd301db66c80c\Symfony\Component\ErrorHandler\Error\FatalError;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 */
class ClassNotFoundErrorEnhancer implements \_PhpScoperd301db66c80c\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface
{
    /**
     * {@inheritdoc}
     */
    public function enhance(\Throwable $error) : ?\Throwable
    {
        ...
        $message = !$error instanceof \_PhpScoperd301db66c80c\Symfony\Component\ErrorHandler\Error\FatalError ? $error->getMessage() : $error->getError()['message'];
        ...
        foreach (['class', 'interface', 'trait'] as $typeName) {
            ...
            return new \_PhpScoperd301db66c80c\Symfony\Component\ErrorHandler\Error\ClassNotFoundError($message, $error);
        }
        return null;
    }
    /**
    ...
    private function getClassCandidates(string $class) : array
    {
        ...
        foreach ($functions as $function) {
            ...
            if ($function[0] instanceof \_PhpScoperd301db66c80c\Symfony\Component\ErrorHandler\DebugClassLoader) {
