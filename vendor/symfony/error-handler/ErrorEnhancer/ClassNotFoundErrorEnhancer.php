 ...
 */
namespace _PhpScoper5cb8aea05893\Symfony\Component\ErrorHandler\ErrorEnhancer;
...
use _PhpScoper5cb8aea05893\Symfony\Component\ErrorHandler\Error\ClassNotFoundError;
use _PhpScoper5cb8aea05893\Symfony\Component\ErrorHandler\Error\FatalError;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 */
class ClassNotFoundErrorEnhancer implements \_PhpScoper5cb8aea05893\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface
{
    /**
     * {@inheritdoc}
     */
    public function enhance(\Throwable $error) : ?\Throwable
    {
        ...
        $message = !$error instanceof \_PhpScoper5cb8aea05893\Symfony\Component\ErrorHandler\Error\FatalError ? $error->getMessage() : $error->getError()['message'];
        ...
        foreach (['class', 'interface', 'trait'] as $typeName) {
            ...
            return new \_PhpScoper5cb8aea05893\Symfony\Component\ErrorHandler\Error\ClassNotFoundError($message, $error);
        }
        return null;
    }
    /**
    ...
    private function getClassCandidates(string $class) : array
    {
        ...
        foreach ($functions as $function) {
            ...
            if ($function[0] instanceof \_PhpScoper5cb8aea05893\Symfony\Component\ErrorHandler\DebugClassLoader) {
