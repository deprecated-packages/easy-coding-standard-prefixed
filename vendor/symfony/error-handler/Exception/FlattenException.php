 ...
 */
namespace _PhpScoperfcee700af3df\Symfony\Component\ErrorHandler\Exception;

use _PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface;
...
class FlattenException
{
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = []) : self
    {
        ...
        if ($exception instanceof \_PhpScoperfcee700af3df\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \_PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\_PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\Response::class) && isset(\_PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \_PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
