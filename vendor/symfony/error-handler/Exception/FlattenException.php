 ...
 */
namespace _PhpScoperaba240c3d5f1\Symfony\Component\ErrorHandler\Exception;

use _PhpScoperaba240c3d5f1\Symfony\Component\Debug\Exception\FatalThrowableError;
use _PhpScoperaba240c3d5f1\Symfony\Component\Debug\Exception\FlattenException as LegacyFlattenException;
 ...
 */
class FlattenException extends \_PhpScoperaba240c3d5f1\Symfony\Component\Debug\Exception\FlattenException
{
    private $message;
    private $code;
    private $previous;
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = []) : self
    {
        ...
        if ($exception instanceof \_PhpScoperaba240c3d5f1\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \_PhpScoperaba240c3d5f1\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\_PhpScoperaba240c3d5f1\Symfony\Component\HttpFoundation\Response::class) && isset(\_PhpScoperaba240c3d5f1\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \_PhpScoperaba240c3d5f1\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
        ...
        $e->setClass($exception instanceof \_PhpScoperaba240c3d5f1\Symfony\Component\Debug\Exception\FatalThrowableError ? $exception->getOriginalClassName() : \get_class($exception));
     ...
     * @return $this
     */
    public final function setPrevious(\_PhpScoperaba240c3d5f1\Symfony\Component\Debug\Exception\FlattenException $previous) : self
    {
