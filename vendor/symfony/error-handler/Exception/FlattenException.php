 ...
 */
namespace _PhpScoperc4ea0f0bd23f\Symfony\Component\ErrorHandler\Exception;

use _PhpScoperc4ea0f0bd23f\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface;
...
class FlattenException
{
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = []) : self
    {
        ...
        if ($exception instanceof \_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpFoundation\Response::class) && isset(\_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \_PhpScoperc4ea0f0bd23f\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
