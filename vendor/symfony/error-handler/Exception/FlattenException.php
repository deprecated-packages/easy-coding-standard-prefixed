 ...
 */
namespace _PhpScoperf6b7f9bf122d\Symfony\Component\ErrorHandler\Exception;

use _PhpScoperf6b7f9bf122d\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface;
...
class FlattenException
{
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = []) : self
    {
        ...
        if ($exception instanceof \_PhpScoperf6b7f9bf122d\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \_PhpScoperf6b7f9bf122d\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\_PhpScoperf6b7f9bf122d\Symfony\Component\HttpFoundation\Response::class) && isset(\_PhpScoperf6b7f9bf122d\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \_PhpScoperf6b7f9bf122d\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
