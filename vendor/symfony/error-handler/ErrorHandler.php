...
use _PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\Error\OutOfMemoryError;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\ErrorEnhancer\ClassNotFoundErrorEnhancer;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedFunctionErrorEnhancer;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedMethodErrorEnhancer;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\ErrorRenderer\CliErrorRenderer;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\ErrorRenderer\HtmlErrorRenderer;
...
class ErrorHandler
{
    ...
    public function __construct(\_PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\BufferingLogger $bootstrappingLogger = null, bool $debug = \false)
    {
    ...
    public function setLoggers(array $loggers) : array
    {
        ...
        if ($flush) {
            foreach ($this->bootstrappingLogger->cleanLogs() as $log) {
                $type = \_PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\ThrowableUtils::getSeverity($log[2]['exception']);
                if (!isset($flush[$type])) {
    ...
    public function handleException(\Throwable $exception)
    {
        ...
        if (!$exception instanceof FatalError) {
            self::$exitCode = 255;
            $type = \_PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\ThrowableUtils::getSeverity($exception);
        } else {
    ...
    private function cleanTrace(array $backtrace, int $type, string &$file, int &$line, bool $throw) : array
    {
        ...
        if (\class_exists(\_PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\DebugClassLoader::class, \false)) {
            for ($i = \count($lightTrace) - 2; 0 < $i; --$i) {
                if (\_PhpScoperc2b2a9bb0e13\Symfony\Component\ErrorHandler\DebugClassLoader::class === ($lightTrace[$i]['class'] ?? null)) {
