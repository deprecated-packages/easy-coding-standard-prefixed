...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopere66f4b626446\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopere66f4b626446\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopere66f4b626446\Symfony\Component\HttpFoundation\Request $request) : void
    {
