...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb6a8e65b492c\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb6a8e65b492c\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb6a8e65b492c\Symfony\Component\HttpFoundation\Request $request) : void
    {
