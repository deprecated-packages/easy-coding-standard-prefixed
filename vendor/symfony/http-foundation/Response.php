...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper6db4fde00cda\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper6db4fde00cda\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper6db4fde00cda\Symfony\Component\HttpFoundation\Request $request) : void
    {
