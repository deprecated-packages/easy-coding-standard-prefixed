...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper457dd3bd73ba\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper457dd3bd73ba\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper457dd3bd73ba\Symfony\Component\HttpFoundation\Request $request) : void
    {
