...
\class_exists(\_PhpScopera23ebff5477f\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera23ebff5477f\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera23ebff5477f\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera23ebff5477f\Symfony\Component\HttpFoundation\Request $request) : void
    {
