...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper528afa732cbd\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper528afa732cbd\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper528afa732cbd\Symfony\Component\HttpFoundation\Request $request) : void
    {
