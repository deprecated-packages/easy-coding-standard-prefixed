...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperfcee700af3df\Symfony\Component\HttpFoundation\Request $request) : void
    {
