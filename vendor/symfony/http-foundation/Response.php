...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper4936962185e7\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper4936962185e7\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper4936962185e7\Symfony\Component\HttpFoundation\Request $request) : void
    {
