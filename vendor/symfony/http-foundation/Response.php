...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperdf6a0b341030\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperdf6a0b341030\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperdf6a0b341030\Symfony\Component\HttpFoundation\Request $request) : void
    {
