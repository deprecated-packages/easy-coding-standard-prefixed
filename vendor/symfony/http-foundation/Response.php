...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperf3db63c305b2\Symfony\Component\HttpFoundation\Request $request) : void
    {
