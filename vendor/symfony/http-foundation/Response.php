...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperf77bffce0320\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperf77bffce0320\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperf77bffce0320\Symfony\Component\HttpFoundation\Request $request) : void
    {
