...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera909b9d9be2e\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera909b9d9be2e\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera909b9d9be2e\Symfony\Component\HttpFoundation\Request $request) : void
    {
