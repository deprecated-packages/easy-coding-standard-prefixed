...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper0b185984cfb7\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper0b185984cfb7\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper0b185984cfb7\Symfony\Component\HttpFoundation\Request $request) : void
    {
