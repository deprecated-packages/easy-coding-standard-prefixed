...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper3e1e0e5bb8ef\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper3e1e0e5bb8ef\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper3e1e0e5bb8ef\Symfony\Component\HttpFoundation\Request $request) : void
    {
