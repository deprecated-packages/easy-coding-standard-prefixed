...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb6d4bd368bd9\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb6d4bd368bd9\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb6d4bd368bd9\Symfony\Component\HttpFoundation\Request $request) : void
    {
