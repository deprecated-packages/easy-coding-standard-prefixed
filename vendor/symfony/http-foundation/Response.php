...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera4be459e5e3d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera4be459e5e3d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera4be459e5e3d\Symfony\Component\HttpFoundation\Request $request) : void
    {
