...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper255a4eaff575\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper255a4eaff575\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper255a4eaff575\Symfony\Component\HttpFoundation\Request $request) : void
    {
