...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper8db4616aa69d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper8db4616aa69d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper8db4616aa69d\Symfony\Component\HttpFoundation\Request $request) : void
    {
