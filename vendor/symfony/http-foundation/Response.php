...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper069ebd53a518\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper069ebd53a518\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper069ebd53a518\Symfony\Component\HttpFoundation\Request $request) : void
    {
