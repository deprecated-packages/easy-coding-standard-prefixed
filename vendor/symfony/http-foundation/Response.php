...
\class_exists(\_PhpScoperf3f1be0d8a30\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperf3f1be0d8a30\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperf3f1be0d8a30\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperf3f1be0d8a30\Symfony\Component\HttpFoundation\Request $request) : void
    {
