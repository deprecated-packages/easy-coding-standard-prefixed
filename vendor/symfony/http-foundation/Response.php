...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper470d6df94ac0\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper470d6df94ac0\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper470d6df94ac0\Symfony\Component\HttpFoundation\Request $request) : void
    {
