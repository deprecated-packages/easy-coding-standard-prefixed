...
\class_exists(\_PhpScopera48d5dbb002d\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera48d5dbb002d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera48d5dbb002d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera48d5dbb002d\Symfony\Component\HttpFoundation\Request $request) : void
    {
