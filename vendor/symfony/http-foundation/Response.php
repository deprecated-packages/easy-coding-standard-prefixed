...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper9e3283ae8193\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper9e3283ae8193\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper9e3283ae8193\Symfony\Component\HttpFoundation\Request $request) : void
    {
