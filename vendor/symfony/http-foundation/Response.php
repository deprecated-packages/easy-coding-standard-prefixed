...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperd301db66c80c\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperd301db66c80c\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperd301db66c80c\Symfony\Component\HttpFoundation\Request $request) : void
    {
