...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperecb978830f1e\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperecb978830f1e\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperecb978830f1e\Symfony\Component\HttpFoundation\Request $request) : void
    {
