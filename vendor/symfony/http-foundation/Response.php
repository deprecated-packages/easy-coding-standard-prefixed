...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper4f985154d5a0\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper4f985154d5a0\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper4f985154d5a0\Symfony\Component\HttpFoundation\Request $request) : void
    {
