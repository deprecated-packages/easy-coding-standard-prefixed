...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperd8048db577a9\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperd8048db577a9\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperd8048db577a9\Symfony\Component\HttpFoundation\Request $request) : void
    {
