...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper842c7347e6be\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper842c7347e6be\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper842c7347e6be\Symfony\Component\HttpFoundation\Request $request) : void
    {
