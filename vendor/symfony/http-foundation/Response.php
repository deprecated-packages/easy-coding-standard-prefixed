...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper68a3a2539032\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper68a3a2539032\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper68a3a2539032\Symfony\Component\HttpFoundation\Request $request) : void
    {
