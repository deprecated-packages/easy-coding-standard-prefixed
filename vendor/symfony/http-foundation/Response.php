...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperedc2e0c967db\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperedc2e0c967db\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperedc2e0c967db\Symfony\Component\HttpFoundation\Request $request) : void
    {
