...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper86aebf8cf357\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper86aebf8cf357\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper86aebf8cf357\Symfony\Component\HttpFoundation\Request $request) : void
    {
