...
\class_exists(\_PhpScoper6ffa0951a2e9\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper6ffa0951a2e9\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @return $this
     */
    public function prepare(\_PhpScoper6ffa0951a2e9\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper6ffa0951a2e9\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper6ffa0951a2e9\Symfony\Component\HttpFoundation\Request $request) : void
    {
