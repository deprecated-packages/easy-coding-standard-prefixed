...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperc75fd40d7a6e\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperc75fd40d7a6e\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperc75fd40d7a6e\Symfony\Component\HttpFoundation\Request $request) : void
    {
