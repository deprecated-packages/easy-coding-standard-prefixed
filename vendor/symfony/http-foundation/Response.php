...
\class_exists(\_PhpScoper0752b31150a1\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper0752b31150a1\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @return $this
     */
    public function prepare(\_PhpScoper0752b31150a1\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper0752b31150a1\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper0752b31150a1\Symfony\Component\HttpFoundation\Request $request) : void
    {
