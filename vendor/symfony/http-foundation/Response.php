...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera9d6b451df71\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera9d6b451df71\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera9d6b451df71\Symfony\Component\HttpFoundation\Request $request) : void
    {
