...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper1e80a2e03314\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper1e80a2e03314\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper1e80a2e03314\Symfony\Component\HttpFoundation\Request $request) : void
    {
