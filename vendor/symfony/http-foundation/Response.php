...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper6a8174766bf7\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper6a8174766bf7\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper6a8174766bf7\Symfony\Component\HttpFoundation\Request $request) : void
    {
