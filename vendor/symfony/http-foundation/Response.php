...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper629192f0909b\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper629192f0909b\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper629192f0909b\Symfony\Component\HttpFoundation\Request $request) : void
    {
