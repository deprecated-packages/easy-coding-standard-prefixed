...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper4e2df00556a9\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper4e2df00556a9\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper4e2df00556a9\Symfony\Component\HttpFoundation\Request $request) : void
    {
