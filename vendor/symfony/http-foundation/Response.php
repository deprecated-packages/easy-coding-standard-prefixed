...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper776637f3d3c3\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper776637f3d3c3\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper776637f3d3c3\Symfony\Component\HttpFoundation\Request $request) : void
    {
