...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera37d6fb0b1ab\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera37d6fb0b1ab\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera37d6fb0b1ab\Symfony\Component\HttpFoundation\Request $request) : void
    {
