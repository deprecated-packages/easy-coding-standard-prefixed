...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper592524ba34f0\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper592524ba34f0\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper592524ba34f0\Symfony\Component\HttpFoundation\Request $request) : void
    {
