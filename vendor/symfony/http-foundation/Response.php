...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper9f8d5dcff860\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper9f8d5dcff860\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper9f8d5dcff860\Symfony\Component\HttpFoundation\Request $request) : void
    {
