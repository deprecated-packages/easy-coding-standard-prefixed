...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper2f75f00bf6fa\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper2f75f00bf6fa\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper2f75f00bf6fa\Symfony\Component\HttpFoundation\Request $request) : void
    {
