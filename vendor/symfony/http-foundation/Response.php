...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperbcc0395698f8\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperbcc0395698f8\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperbcc0395698f8\Symfony\Component\HttpFoundation\Request $request) : void
    {
