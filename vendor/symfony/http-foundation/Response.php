...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperf361a7d70552\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperf361a7d70552\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperf361a7d70552\Symfony\Component\HttpFoundation\Request $request) : void
    {
