...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopercd2fc5ef50ef\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopercd2fc5ef50ef\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopercd2fc5ef50ef\Symfony\Component\HttpFoundation\Request $request) : void
    {
