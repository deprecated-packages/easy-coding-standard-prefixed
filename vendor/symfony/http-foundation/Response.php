...
\class_exists(\_PhpScopera658fe86acec\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera658fe86acec\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @return $this
     */
    public function prepare(\_PhpScopera658fe86acec\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera658fe86acec\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera658fe86acec\Symfony\Component\HttpFoundation\Request $request) : void
    {
