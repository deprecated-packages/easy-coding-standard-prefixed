...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper8cb97064581a\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper8cb97064581a\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper8cb97064581a\Symfony\Component\HttpFoundation\Request $request) : void
    {
