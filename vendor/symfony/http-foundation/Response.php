...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper326bba7310a2\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper326bba7310a2\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper326bba7310a2\Symfony\Component\HttpFoundation\Request $request) : void
    {
