...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper5e5ebcdbebdf\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper5e5ebcdbebdf\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper5e5ebcdbebdf\Symfony\Component\HttpFoundation\Request $request) : void
    {
