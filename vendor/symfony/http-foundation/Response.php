...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopere050faf861e6\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopere050faf861e6\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopere050faf861e6\Symfony\Component\HttpFoundation\Request $request) : void
    {
