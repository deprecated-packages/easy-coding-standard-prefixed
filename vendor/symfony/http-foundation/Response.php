...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper7cef7256eba6\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper7cef7256eba6\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper7cef7256eba6\Symfony\Component\HttpFoundation\Request $request) : void
    {
