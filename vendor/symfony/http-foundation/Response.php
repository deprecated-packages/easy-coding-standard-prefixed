...
\class_exists(\_PhpScoper2737ffe13a7b\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper2737ffe13a7b\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @return $this
     */
    public function prepare(\_PhpScoper2737ffe13a7b\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper2737ffe13a7b\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper2737ffe13a7b\Symfony\Component\HttpFoundation\Request $request) : void
    {
