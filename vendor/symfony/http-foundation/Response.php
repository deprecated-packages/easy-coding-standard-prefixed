...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper2fe14d6302bc\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper2fe14d6302bc\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper2fe14d6302bc\Symfony\Component\HttpFoundation\Request $request) : void
    {
