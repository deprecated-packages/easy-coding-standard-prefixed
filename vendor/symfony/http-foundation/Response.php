...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperc64a4ac1af35\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperc64a4ac1af35\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperc64a4ac1af35\Symfony\Component\HttpFoundation\Request $request) : void
    {
