...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopercae980ebf12d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopercae980ebf12d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopercae980ebf12d\Symfony\Component\HttpFoundation\Request $request) : void
    {
