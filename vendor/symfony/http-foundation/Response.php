...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb0c6500a504c\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb0c6500a504c\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb0c6500a504c\Symfony\Component\HttpFoundation\Request $request) : void
    {
