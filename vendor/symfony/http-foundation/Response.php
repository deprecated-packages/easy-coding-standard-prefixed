...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperc8fea59b0cb1\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperc8fea59b0cb1\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperc8fea59b0cb1\Symfony\Component\HttpFoundation\Request $request) : void
    {
