...
use ECSPrefix20210507\Predis\Response\ErrorInterface;
 ...
 */
class RedisSessionHandler extends \ECSPrefix20210507\Symfony\Component\HttpFoundation\Session\Storage\Handler\AbstractSessionHandler
{
    private $redis;
    /**
    ...
    {
        if (!$redis instanceof \Redis && !$redis instanceof \RedisArray && !$redis instanceof \RedisCluster && !$redis instanceof \ECSPrefix20210507\Predis\ClientInterface && !$redis instanceof RedisProxy && !$redis instanceof RedisClusterProxy) {
