...
use _PhpScoper1ddca3f92d7d\Predis\Response\ErrorInterface;
 ...
 */
class RedisSessionHandler extends \_PhpScoper1ddca3f92d7d\Symfony\Component\HttpFoundation\Session\Storage\Handler\AbstractSessionHandler
{
    private $redis;
    /**
    ...
    {
        if (!$redis instanceof \Redis && !$redis instanceof \RedisArray && !$redis instanceof \RedisCluster && !$redis instanceof \_PhpScoper1ddca3f92d7d\Predis\ClientInterface && !$redis instanceof RedisProxy && !$redis instanceof RedisClusterProxy) {
