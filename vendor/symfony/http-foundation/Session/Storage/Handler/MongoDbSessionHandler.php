 ...
 */
class MongoDbSessionHandler extends \_PhpScopera4be459e5e3d\Symfony\Component\HttpFoundation\Session\Storage\Handler\AbstractSessionHandler
{
    private $mongo;
    /**
     ...
     */
    public function __construct(\_PhpScopera4be459e5e3d\MongoDB\Client $mongo, array $options)
    {
    ...
    private function getCollection() : \_PhpScopera4be459e5e3d\MongoDB\Collection
    {
