 ...
 */
class MongoDbSessionHandler extends \_PhpScoper82a1412fb847\Symfony\Component\HttpFoundation\Session\Storage\Handler\AbstractSessionHandler
{
    private $mongo;
    /**
     ...
     */
    public function __construct(\_PhpScoper82a1412fb847\MongoDB\Client $mongo, array $options)
    {
    ...
    private function getCollection() : \_PhpScoper82a1412fb847\MongoDB\Collection
    {
