 ...
 */
class MongoDbSessionHandler extends \_PhpScoperf65af7a6d9a0\Symfony\Component\HttpFoundation\Session\Storage\Handler\AbstractSessionHandler
{
    private $mongo;
    /**
     ...
     */
    public function __construct(\_PhpScoperf65af7a6d9a0\MongoDB\Client $mongo, array $options)
    {
    ...
    private function getCollection() : \_PhpScoperf65af7a6d9a0\MongoDB\Collection
    {
