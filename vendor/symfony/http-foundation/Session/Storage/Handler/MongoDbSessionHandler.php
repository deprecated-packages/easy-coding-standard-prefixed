 ...
 */
class MongoDbSessionHandler extends \_PhpScoperbd5fb781fe24\Symfony\Component\HttpFoundation\Session\Storage\Handler\AbstractSessionHandler
{
    private $mongo;
    /**
     ...
     */
    public function __construct(\_PhpScoperbd5fb781fe24\MongoDB\Client $mongo, array $options)
    {
    ...
    private function getCollection() : \_PhpScoperbd5fb781fe24\MongoDB\Collection
    {
