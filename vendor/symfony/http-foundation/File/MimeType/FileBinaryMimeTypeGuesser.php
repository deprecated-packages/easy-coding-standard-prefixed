...
use _PhpScoper836bc32aecc2\Symfony\Component\Mime\FileBinaryMimeTypeGuesser as NewFileBinaryMimeTypeGuesser;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" instead.', \_PhpScoper836bc32aecc2\Symfony\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser::class, \_PhpScoper836bc32aecc2\Symfony\Component\Mime\FileBinaryMimeTypeGuesser::class), \E_USER_DEPRECATED);
/**
 ...
 */
class FileBinaryMimeTypeGuesser implements \_PhpScoper836bc32aecc2\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface
{
    private $cmd;
    /**
