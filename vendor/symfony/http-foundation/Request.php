 ...
 */
namespace _PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation;

use _PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use _PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
...
class Request
{
    ...
    {
        $this->request = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ParameterBag($request);
        $this->query = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ParameterBag($query);
        $this->attributes = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ParameterBag($attributes);
        $this->cookies = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ParameterBag($cookies);
        $this->files = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\FileBag($files);
        $this->server = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ServerBag($server);
        $this->headers = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\HeaderBag($this->server->getHeaders());
    ...
    public static function createFromGlobals()
    {
        ...
        if (0 === \strpos($request->headers->get('CONTENT_TYPE'), 'application/x-www-form-urlencoded') && \in_array(\strtoupper($request->server->get('REQUEST_METHOD', 'GET')), ['PUT', 'DELETE', 'PATCH'])) {
            ...
            $request->request = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ParameterBag($data);
        }
        return $request;
    }
    /**
    ...
    public function duplicate(array $query = null, array $request = null, array $attributes = null, array $cookies = null, array $files = null, array $server = null)
    {
        $dup = clone $this;
        if (null !== $query) {
            $dup->query = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ParameterBag($query);
        }
        if (null !== $request) {
            $dup->request = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ParameterBag($request);
        }
        if (null !== $attributes) {
            $dup->attributes = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ParameterBag($attributes);
        }
        if (null !== $cookies) {
            $dup->cookies = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ParameterBag($cookies);
        }
        if (null !== $files) {
            $dup->files = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\FileBag($files);
        }
        if (null !== $server) {
            $dup->server = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\ServerBag($server);
            $dup->headers = new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\HeaderBag($dup->server->getHeaders());
        }
        $dup->languages = null;
        $dup->charsets = null;
        $dup->encodings = null;
    ...
    public function getSession()
    {
        ...
        if (!$session instanceof \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\Session\SessionInterface && null !== $session) {
    ...
    public function setSession(\_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\Session\SessionInterface $session)
    {
    ...
    public function getHost()
    {
        ...
        if ($host && '' !== \preg_replace('/(?:^\\[)?[a-zA-Z0-9-:\\]_]+\\.?/', '', $host)) {
            ...
            throw new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException(\sprintf('Invalid Host "%s".', $host));
        }
        if (\count(self::$trustedHostPatterns) > 0) {
            ...
            $this->isHostValid = \false;
            throw new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException(\sprintf('Untrusted Host "%s".', $host));
        }
        return $host;
    }
    /**
    ...
    public function getMethod()
    {
        ...
        if (!\preg_match('/^[A-Z]++$/D', $method)) {
            throw new \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException(\sprintf('Invalid method override "%s".', $method));
        }
        return $this->method = $method;
    }
    /**
    ...
    public function getLanguages()
    {
        ...
        $languages = \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\AcceptHeader::fromString($this->headers->get('Accept-Language'))->all();
        $this->languages = [];
    ...
    public function getCharsets()
    {
        ...
        return $this->charsets = \array_keys(\_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\AcceptHeader::fromString($this->headers->get('Accept-Charset'))->all());
    }
    /**
    ...
    public function getEncodings()
    {
        ...
        return $this->encodings = \array_keys(\_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\AcceptHeader::fromString($this->headers->get('Accept-Encoding'))->all());
    }
    /**
    ...
    public function getAcceptableContentTypes()
    {
        ...
        return $this->acceptableContentTypes = \array_keys(\_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\AcceptHeader::fromString($this->headers->get('Accept'))->all());
    }
    /**
    ...
    {
        return self::$trustedProxies && \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\IpUtils::checkIp($this->server->get('REMOTE_ADDR'), self::$trustedProxies);
    }
    private function getTrustedValues(int $type, string $ip = null) : array
    {
        ...
        if (self::$trustedHeaderSet & self::HEADER_FORWARDED && $this->headers->has(self::$trustedHeaders[self::HEADER_FORWARDED])) {
            ...
            $parts = \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\HeaderUtils::split($forwarded, ',;=');
            $forwardedValues = [];
            $param = self::$forwardedParams[$type];
            foreach ($parts as $subParts) {
                if (null === ($v = \_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\HeaderUtils::combine($subParts)[$param] ?? null)) {
                    continue;
                }
    ...
    private function normalizeAndFilterClientIps(array $clientIps, string $ip) : array
    {
        ...
        foreach ($clientIps as $key => $clientIp) {
            ...
            if (\_PhpScoperfa7254c25e18\Symfony\Component\HttpFoundation\IpUtils::checkIp($clientIp, self::$trustedProxies)) {
                unset($clientIps[$key]);
