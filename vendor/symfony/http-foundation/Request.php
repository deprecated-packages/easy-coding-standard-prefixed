 ...
 */
namespace _PhpScopera46128941588\Symfony\Component\HttpFoundation;

use _PhpScopera46128941588\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use _PhpScopera46128941588\Symfony\Component\HttpFoundation\Exception\JsonException;
use _PhpScopera46128941588\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use _PhpScopera46128941588\Symfony\Component\HttpFoundation\Session\SessionInterface;
// Help opcache.preload discover always-needed symbols
\class_exists(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\AcceptHeader::class);
\class_exists(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\FileBag::class);
\class_exists(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\HeaderBag::class);
\class_exists(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\HeaderUtils::class);
\class_exists(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\InputBag::class);
\class_exists(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\ParameterBag::class);
\class_exists(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\ServerBag::class);
/**
...
class Request
{
    ...
    {
        $this->request = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\ParameterBag($request);
        $this->query = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\InputBag($query);
        $this->attributes = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\ParameterBag($attributes);
        $this->cookies = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\InputBag($cookies);
        $this->files = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\FileBag($files);
        $this->server = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\ServerBag($server);
        $this->headers = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\HeaderBag($this->server->getHeaders());
    ...
    public static function createFromGlobals()
    {
        ...
        if ($_POST) {
            $request->request = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\InputBag($_POST);
            ...
            $request->request = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\InputBag($data);
        }
        return $request;
    }
    /**
    ...
    public function duplicate(array $query = null, array $request = null, array $attributes = null, array $cookies = null, array $files = null, array $server = null)
    {
        $dup = clone $this;
        if (null !== $query) {
            $dup->query = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\InputBag($query);
        }
        if (null !== $request) {
            $dup->request = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\ParameterBag($request);
        }
        if (null !== $attributes) {
            $dup->attributes = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\ParameterBag($attributes);
        }
        if (null !== $cookies) {
            $dup->cookies = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\InputBag($cookies);
        }
        if (null !== $files) {
            $dup->files = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\FileBag($files);
        }
        if (null !== $server) {
            $dup->server = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\ServerBag($server);
            $dup->headers = new \_PhpScopera46128941588\Symfony\Component\HttpFoundation\HeaderBag($dup->server->getHeaders());
        }
        $dup->languages = null;
        $dup->charsets = null;
        $dup->encodings = null;
    ...
    public static function normalizeQueryString(?string $qs)
    {
        ...
        $qs = \_PhpScopera46128941588\Symfony\Component\HttpFoundation\HeaderUtils::parseQuery($qs);
        \ksort($qs);
    ...
    public function getLanguages()
    {
        ...
        $languages = \_PhpScopera46128941588\Symfony\Component\HttpFoundation\AcceptHeader::fromString($this->headers->get('Accept-Language'))->all();
        $this->languages = [];
    ...
    public function getCharsets()
    {
        ...
        return $this->charsets = \array_keys(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\AcceptHeader::fromString($this->headers->get('Accept-Charset'))->all());
    }
    /**
    ...
    public function getEncodings()
    {
        ...
        return $this->encodings = \array_keys(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\AcceptHeader::fromString($this->headers->get('Accept-Encoding'))->all());
    }
    /**
    ...
    public function getAcceptableContentTypes()
    {
        ...
        return $this->acceptableContentTypes = \array_keys(\_PhpScopera46128941588\Symfony\Component\HttpFoundation\AcceptHeader::fromString($this->headers->get('Accept'))->all());
    }
    /**
    ...
    public function preferSafeContent() : bool
    {
        ...
        $this->isSafeContentPreferred = \_PhpScopera46128941588\Symfony\Component\HttpFoundation\AcceptHeader::fromString($this->headers->get('Prefer'))->has('safe');
        return $this->isSafeContentPreferred;
    }
    /*
    ...
    {
        return self::$trustedProxies && \_PhpScopera46128941588\Symfony\Component\HttpFoundation\IpUtils::checkIp($this->server->get('REMOTE_ADDR'), self::$trustedProxies);
    }
    private function getTrustedValues(int $type, string $ip = null) : array
    {
        ...
        if (self::$trustedHeaderSet & self::HEADER_FORWARDED && isset(self::FORWARDED_PARAMS[$type]) && $this->headers->has(self::TRUSTED_HEADERS[self::HEADER_FORWARDED])) {
            ...
            $parts = \_PhpScopera46128941588\Symfony\Component\HttpFoundation\HeaderUtils::split($forwarded, ',;=');
            $forwardedValues = [];
            $param = self::FORWARDED_PARAMS[$type];
            foreach ($parts as $subParts) {
                if (null === ($v = \_PhpScopera46128941588\Symfony\Component\HttpFoundation\HeaderUtils::combine($subParts)[$param] ?? null)) {
                    continue;
                }
    ...
    private function normalizeAndFilterClientIps(array $clientIps, string $ip) : array
    {
        ...
        foreach ($clientIps as $key => $clientIp) {
            ...
            if (\_PhpScopera46128941588\Symfony\Component\HttpFoundation\IpUtils::checkIp($clientIp, self::$trustedProxies)) {
                unset($clientIps[$key]);
