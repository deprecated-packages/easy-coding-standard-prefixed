...
use _PhpScopera609aff833be\Symfony\Component\HttpFoundation\File\File;
/**
 ...
 */
class BinaryFileResponse extends \_PhpScopera609aff833be\Symfony\Component\HttpFoundation\Response
{
    ...
    {
        if (!$file instanceof \_PhpScopera609aff833be\Symfony\Component\HttpFoundation\File\File) {
            if ($file instanceof \SplFileInfo) {
                $file = new \_PhpScopera609aff833be\Symfony\Component\HttpFoundation\File\File($file->getPathname());
            } else {
                $file = new \_PhpScopera609aff833be\Symfony\Component\HttpFoundation\File\File((string) $file);
            }
        }
        if (!$file->isReadable()) {
            throw new \_PhpScopera609aff833be\Symfony\Component\HttpFoundation\File\Exception\FileException('File must be readable.');
        }
        $this->file = $file;
        if ($autoEtag) {
            $this->setAutoEtag();
     ...
     * {@inheritdoc}
     */
    public function prepare(\_PhpScopera609aff833be\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (self::$trustXSendfileTypeHeader && $request->headers->has('X-Sendfile-Type')) {
            ...
            if ('x-accel-redirect' === \strtolower($type)) {
                ...
                $parts = \_PhpScopera609aff833be\Symfony\Component\HttpFoundation\HeaderUtils::split($request->headers->get('X-Accel-Mapping', ''), ',=');
