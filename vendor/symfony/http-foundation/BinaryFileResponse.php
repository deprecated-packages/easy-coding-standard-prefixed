...
use _PhpScoper4fedb9aa1e5f\Symfony\Component\HttpFoundation\File\File;
/**
 ...
 */
class BinaryFileResponse extends \_PhpScoper4fedb9aa1e5f\Symfony\Component\HttpFoundation\Response
{
    ...
    public function prepare(\_PhpScoper4fedb9aa1e5f\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (self::$trustXSendfileTypeHeader && $request->headers->has('X-Sendfile-Type')) {
            ...
            if ('x-accel-redirect' === \strtolower($type)) {
                ...
                $parts = \_PhpScoper4fedb9aa1e5f\Symfony\Component\HttpFoundation\HeaderUtils::split($request->headers->get('X-Accel-Mapping', ''), ',=');
