...
use _PhpScoper4fc0030e9d22\Symfony\Component\HttpFoundation\File\File;
/**
 ...
 */
class BinaryFileResponse extends \_PhpScoper4fc0030e9d22\Symfony\Component\HttpFoundation\Response
{
    ...
    {
        if (!$file instanceof \_PhpScoper4fc0030e9d22\Symfony\Component\HttpFoundation\File\File) {
            if ($file instanceof \SplFileInfo) {
                $file = new \_PhpScoper4fc0030e9d22\Symfony\Component\HttpFoundation\File\File($file->getPathname());
            } else {
                $file = new \_PhpScoper4fc0030e9d22\Symfony\Component\HttpFoundation\File\File((string) $file);
            }
        }
        if (!$file->isReadable()) {
            throw new \_PhpScoper4fc0030e9d22\Symfony\Component\HttpFoundation\File\Exception\FileException('File must be readable.');
        }
        $this->file = $file;
        if ($autoEtag) {
            $this->setAutoEtag();
     ...
     * {@inheritdoc}
     */
    public function prepare(\_PhpScoper4fc0030e9d22\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (self::$trustXSendfileTypeHeader && $request->headers->has('X-Sendfile-Type')) {
            ...
            if ('x-accel-redirect' === \strtolower($type)) {
                ...
                $parts = \_PhpScoper4fc0030e9d22\Symfony\Component\HttpFoundation\HeaderUtils::split($request->headers->get('X-Accel-Mapping', ''), ',=');
