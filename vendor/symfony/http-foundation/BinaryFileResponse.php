...
use _PhpScoper08fb1f8a2f44\Symfony\Component\HttpFoundation\File\File;
/**
 ...
 */
class BinaryFileResponse extends \_PhpScoper08fb1f8a2f44\Symfony\Component\HttpFoundation\Response
{
    ...
    public function prepare(\_PhpScoper08fb1f8a2f44\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (self::$trustXSendfileTypeHeader && $request->headers->has('X-Sendfile-Type')) {
            ...
            if ('x-accel-redirect' === \strtolower($type)) {
                ...
                $parts = \_PhpScoper08fb1f8a2f44\Symfony\Component\HttpFoundation\HeaderUtils::split($request->headers->get('X-Accel-Mapping', ''), ',=');
