 ...
 */
class RequestMatcher implements \_PhpScopera48d5dbb002d\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
     ...
     * {@inheritdoc}
     */
    public function matches(\_PhpScopera48d5dbb002d\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\_PhpScopera48d5dbb002d\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
