 ...
 */
class RequestMatcher implements \_PhpScoper9a024705919c\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\_PhpScoper9a024705919c\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\_PhpScoper9a024705919c\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
