 ...
 */
class RequestMatcher implements \_PhpScoper7faa8deb0d3c\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\_PhpScoper7faa8deb0d3c\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\_PhpScoper7faa8deb0d3c\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
