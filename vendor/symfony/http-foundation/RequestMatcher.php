 ...
 */
class RequestMatcher implements \_PhpScoper1ddca3f92d7d\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\_PhpScoper1ddca3f92d7d\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\_PhpScoper1ddca3f92d7d\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
