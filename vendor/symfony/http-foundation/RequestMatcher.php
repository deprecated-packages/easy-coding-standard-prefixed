 ...
 */
class RequestMatcher implements \_PhpScoper6ffa0951a2e9\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
     ...
     * {@inheritdoc}
     */
    public function matches(\_PhpScoper6ffa0951a2e9\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\_PhpScoper6ffa0951a2e9\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
