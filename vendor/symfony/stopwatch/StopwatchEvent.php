...
class StopwatchEvent
{
    ...
    public function stop()
    {
        ...
        $this->periods[] = new \_PhpScoperd4c5032f0671\Symfony\Component\Stopwatch\StopwatchPeriod(\array_pop($this->started), $this->getNow());
        return $this;
    }
    /**
    ...
    public function getDuration()
    {
        ...
        for ($i = 0; $i < $left; ++$i) {
            $index = $stopped + $i;
            $periods[] = new \_PhpScoperd4c5032f0671\Symfony\Component\Stopwatch\StopwatchPeriod($this->started[$index], $this->getNow());
        }
        $total = 0;
