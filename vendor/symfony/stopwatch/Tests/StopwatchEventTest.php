 ...
 */
namespace _PhpScoperc75fd40d7a6e\Symfony\Component\Stopwatch\Tests;

use _PhpScoperc75fd40d7a6e\Symfony\Component\Stopwatch\StopwatchEvent;
/**
 * StopwatchEventTest.
 *
 ...
 */
class StopwatchEventTest extends \_PhpScoperc75fd40d7a6e\PHPUnit_Framework_TestCase
{
    const DELTA = 37;
    public function testGetOrigin()
    {
        $event = new \_PhpScoperc75fd40d7a6e\Symfony\Component\Stopwatch\StopwatchEvent(12);
        $this->assertEquals(12, $event->getOrigin());
    }
    public function testGetCategory()
    {
        $event = new \_PhpScoperc75fd40d7a6e\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000);
        $this->assertEquals('default', $event->getCategory());
        $event = new \_PhpScoperc75fd40d7a6e\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'cat');
    ...
    {
        new \_PhpScoperc75fd40d7a6e\Symfony\Component\Stopwatch\StopwatchEvent('abc');
    }
    public function testHumanRepresentation()
    {
        ...
        $event = new \_PhpScoperc75fd40d7a6e\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'foo');
