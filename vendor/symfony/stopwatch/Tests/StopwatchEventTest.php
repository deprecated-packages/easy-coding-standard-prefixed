 ...
 */
namespace _PhpScoperf77bffce0320\Symfony\Component\Stopwatch\Tests;

use _PhpScoperf77bffce0320\Symfony\Component\Stopwatch\StopwatchEvent;
/**
 * StopwatchEventTest.
 *
 ...
 */
class StopwatchEventTest extends \_PhpScoperf77bffce0320\PHPUnit_Framework_TestCase
{
    const DELTA = 37;
    public function testGetOrigin()
    {
        $event = new \_PhpScoperf77bffce0320\Symfony\Component\Stopwatch\StopwatchEvent(12);
        $this->assertEquals(12, $event->getOrigin());
    }
    public function testGetCategory()
    {
        $event = new \_PhpScoperf77bffce0320\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000);
        $this->assertEquals('default', $event->getCategory());
        $event = new \_PhpScoperf77bffce0320\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'cat');
    ...
    {
        new \_PhpScoperf77bffce0320\Symfony\Component\Stopwatch\StopwatchEvent('abc');
    }
    public function testHumanRepresentation()
    {
        ...
        $event = new \_PhpScoperf77bffce0320\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'foo');
