 ...
 */
namespace _PhpScoper5a9febfbbe05\Symfony\Component\Stopwatch\Tests;
 ...
 */
class StopwatchEventTest extends \_PhpScoper5a9febfbbe05\PHPUnit_Framework_TestCase
{
    const DELTA = 37;
    public function testGetOrigin()
    {
        $event = new \_PhpScoper5a9febfbbe05\Symfony\Component\Stopwatch\StopwatchEvent(12);
        $this->assertEquals(12, $event->getOrigin());
    }
    public function testGetCategory()
    {
        $event = new \_PhpScoper5a9febfbbe05\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000);
        $this->assertEquals('default', $event->getCategory());
        $event = new \_PhpScoper5a9febfbbe05\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'cat');
    ...
    {
        new \_PhpScoper5a9febfbbe05\Symfony\Component\Stopwatch\StopwatchEvent('abc');
    }
    public function testHumanRepresentation()
    {
        ...
        $event = new \_PhpScoper5a9febfbbe05\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'foo');
