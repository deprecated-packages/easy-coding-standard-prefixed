 ...
 */
namespace _PhpScopera238de2e9b5a\Symfony\Component\Stopwatch\Tests;

use _PhpScopera238de2e9b5a\Symfony\Component\Stopwatch\StopwatchEvent;
/**
 * StopwatchEventTest.
 *
 ...
 */
class StopwatchEventTest extends \_PhpScopera238de2e9b5a\PHPUnit_Framework_TestCase
{
    const DELTA = 37;
    public function testGetOrigin()
    {
        $event = new \_PhpScopera238de2e9b5a\Symfony\Component\Stopwatch\StopwatchEvent(12);
        $this->assertEquals(12, $event->getOrigin());
    }
    public function testGetCategory()
    {
        $event = new \_PhpScopera238de2e9b5a\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000);
        $this->assertEquals('default', $event->getCategory());
        $event = new \_PhpScopera238de2e9b5a\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'cat');
    ...
    {
        new \_PhpScopera238de2e9b5a\Symfony\Component\Stopwatch\StopwatchEvent('abc');
    }
    public function testHumanRepresentation()
    {
        ...
        $event = new \_PhpScopera238de2e9b5a\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'foo');
