...
class Section
{
    ...
    public function startEvent(string $name, ?string $category)
    {
        if (!isset($this->events[$name])) {
            $this->events[$name] = new \_PhpScoperb0c6500a504c\Symfony\Component\Stopwatch\StopwatchEvent($this->origin ?: \microtime(\true) * 1000, $category, $this->morePrecision, $name);
        }
