...
\class_exists(\_PhpScoper000f93dc572d\Symfony\Component\Stopwatch\Section::class);
/**
...
class Stopwatch implements ResetInterface
{
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoper000f93dc572d\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
