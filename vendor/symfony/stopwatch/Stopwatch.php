...
\class_exists(\_PhpScoper91fe47cd7f25\Symfony\Component\Stopwatch\Section::class);
/**
...
class Stopwatch implements ResetInterface
{
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoper91fe47cd7f25\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
