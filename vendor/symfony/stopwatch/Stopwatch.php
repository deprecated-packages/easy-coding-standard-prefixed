...
\class_exists(\_PhpScoper5e5ebcdbebdf\Symfony\Component\Stopwatch\Section::class);
/**
 * Stopwatch provides a way to profile code.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class Stopwatch implements \_PhpScoper5e5ebcdbebdf\Symfony\Contracts\Service\ResetInterface
{
    /**
     * @var bool
     */
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoper5e5ebcdbebdf\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
