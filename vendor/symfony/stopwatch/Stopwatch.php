...
\class_exists(\_PhpScoperd8048db577a9\Symfony\Component\Stopwatch\Section::class);
/**
 * Stopwatch provides a way to profile code.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class Stopwatch implements \_PhpScoperd8048db577a9\Symfony\Contracts\Service\ResetInterface
{
    /**
     * @var bool
     */
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoperd8048db577a9\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
