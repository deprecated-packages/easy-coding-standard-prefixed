...
\class_exists(\_PhpScoper1ddca3f92d7d\Symfony\Component\Stopwatch\Section::class);
/**
...
class Stopwatch implements ResetInterface
{
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoper1ddca3f92d7d\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
