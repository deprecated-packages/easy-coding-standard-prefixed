...
\class_exists(\_PhpScoper2737ffe13a7b\Symfony\Component\Stopwatch\Section::class);
/**
...
class Stopwatch implements ResetInterface
{
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoper2737ffe13a7b\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
