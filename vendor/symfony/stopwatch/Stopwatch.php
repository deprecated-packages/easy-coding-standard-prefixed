...
\class_exists(\_PhpScopera22bb3f4d7b7\Symfony\Component\Stopwatch\Section::class);
/**
...
class Stopwatch implements ResetInterface
{
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScopera22bb3f4d7b7\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
