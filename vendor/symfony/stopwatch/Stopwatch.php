...
\class_exists(\_PhpScoper6ffa0951a2e9\Symfony\Component\Stopwatch\Section::class);
/**
...
class Stopwatch implements ResetInterface
{
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoper6ffa0951a2e9\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
