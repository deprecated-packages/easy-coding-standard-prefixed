...
\class_exists(\_PhpScoperdb89411b20b4\Symfony\Component\Stopwatch\Section::class);
/**
...
class Stopwatch implements ResetInterface
{
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoperdb89411b20b4\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
