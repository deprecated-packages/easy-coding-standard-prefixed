...
\class_exists(\_PhpScoperd2a667bd5a98\Symfony\Component\Stopwatch\Section::class);
/**
...
class Stopwatch implements ResetInterface
{
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoperd2a667bd5a98\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
