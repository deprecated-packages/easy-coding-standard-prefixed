...
\class_exists(\_PhpScoper0752b31150a1\Symfony\Component\Stopwatch\Section::class);
/**
...
class Stopwatch implements ResetInterface
{
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \_PhpScoper0752b31150a1\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
