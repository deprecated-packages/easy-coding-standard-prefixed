 ...
 */
class ClassStub extends \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub(), \true, \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
