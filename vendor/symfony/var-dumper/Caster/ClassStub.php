 ...
 */
class ClassStub extends \_PhpScopera4be459e5e3d\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \_PhpScopera4be459e5e3d\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \_PhpScopera4be459e5e3d\Symfony\Component\VarDumper\Cloner\Stub(), \true, \_PhpScopera4be459e5e3d\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \_PhpScopera4be459e5e3d\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
