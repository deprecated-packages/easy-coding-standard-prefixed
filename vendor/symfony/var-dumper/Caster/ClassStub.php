 ...
 */
class ClassStub extends \_PhpScoperc4b135661b3a\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \_PhpScoperc4b135661b3a\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \_PhpScoperc4b135661b3a\Symfony\Component\VarDumper\Cloner\Stub(), \true, \_PhpScoperc4b135661b3a\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \_PhpScoperc4b135661b3a\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
