 ...
 */
class ClassStub extends \_PhpScoper6b644dbe715d\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \_PhpScoper6b644dbe715d\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \_PhpScoper6b644dbe715d\Symfony\Component\VarDumper\Cloner\Stub(), \true, \_PhpScoper6b644dbe715d\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \_PhpScoper6b644dbe715d\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
