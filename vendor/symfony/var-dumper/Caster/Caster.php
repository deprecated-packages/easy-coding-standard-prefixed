...
class Caster
{
    ...
    public static function castPhpIncompleteClass(\__PHP_Incomplete_Class $c, array $a, \_PhpScoperb6d4bd368bd9\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested) : array
    {
