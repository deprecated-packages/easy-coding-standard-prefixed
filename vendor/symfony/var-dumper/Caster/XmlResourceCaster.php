...
class XmlResourceCaster
{
    ...
    public static function castXml($h, array $a, \_PhpScoper836bc32aecc2\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        ...
        if (isset(self::$xmlErrors[$a['error_code']])) {
            $a['error_code'] = new \_PhpScoper836bc32aecc2\Symfony\Component\VarDumper\Caster\ConstStub(self::$xmlErrors[$a['error_code']], $a['error_code']);
        }
        return $a;
    }
}
