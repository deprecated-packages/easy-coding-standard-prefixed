...
class XmlResourceCaster
{
    ...
    public static function castXml($h, array $a, \_PhpScoperf6b7f9bf122d\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        ...
        if (isset(self::XML_ERRORS[$a['error_code']])) {
            $a['error_code'] = new \_PhpScoperf6b7f9bf122d\Symfony\Component\VarDumper\Caster\ConstStub(self::XML_ERRORS[$a['error_code']], $a['error_code']);
        }
        return $a;
    }
}
