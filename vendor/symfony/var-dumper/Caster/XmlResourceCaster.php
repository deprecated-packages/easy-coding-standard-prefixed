...
class XmlResourceCaster
{
    ...
    public static function castXml($h, array $a, \_PhpScoperca8ca183ac38\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        ...
        if (isset(self::$xmlErrors[$a['error_code']])) {
            $a['error_code'] = new \_PhpScoperca8ca183ac38\Symfony\Component\VarDumper\Caster\ConstStub(self::$xmlErrors[$a['error_code']], $a['error_code']);
        }
        return $a;
    }
}
