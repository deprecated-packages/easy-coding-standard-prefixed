        ...
        switch (\gettype($value)) {
            case 'object':
                ...
                if ($value instanceof \Closure) {
                    \_PhpScoperef2f7aa3581e\Symfony\Component\VarDumper\Caster\ReflectionCaster::castClosure($value, [], $this, \true, \_PhpScoperef2f7aa3581e\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                }
                $this->cut = -1;
                break;
            case 'array':
