        ...
        switch (\gettype($value)) {
            case 'object':
                ...
                if ($value instanceof \Closure) {
                    \_PhpScoperc2b2a9bb0e13\Symfony\Component\VarDumper\Caster\ReflectionCaster::castClosure($value, [], $this, \true, \_PhpScoperc2b2a9bb0e13\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                }
                $this->cut = -1;
                break;
            case 'array':
