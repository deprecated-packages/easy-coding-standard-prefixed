        ...
        switch (\gettype($value)) {
            case 'object':
                ...
                if ($value instanceof \Closure) {
                    \_PhpScoper4fedb9aa1e5f\Symfony\Component\VarDumper\Caster\ReflectionCaster::castClosure($value, [], $this, \true, \_PhpScoper4fedb9aa1e5f\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                }
                $this->cut = -1;
                break;
            case 'array':
