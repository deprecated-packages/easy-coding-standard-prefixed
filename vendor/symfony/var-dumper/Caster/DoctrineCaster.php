...
use _PhpScoperc5e9eb67638f\Doctrine\Common\Proxy\Proxy as CommonProxy;
use _PhpScoperc5e9eb67638f\Doctrine\ORM\PersistentCollection;
use _PhpScoperc5e9eb67638f\Doctrine\ORM\Proxy\Proxy as OrmProxy;
    ...
    public static function castPersistentCollection(PersistentCollection $coll, array $a, Stub $stub, bool $isNested)
    {
        foreach (['snapshot', 'association', 'typeClass'] as $k) {
            if (\array_key_exists($k = "\0Doctrine\\ORM\\PersistentCollection\0" . $k, $a)) {
                $a[$k] = new \_PhpScoperc5e9eb67638f\Symfony\Component\VarDumper\Caster\CutStub($a[$k]);
            }
        }
        return $a;
    }
