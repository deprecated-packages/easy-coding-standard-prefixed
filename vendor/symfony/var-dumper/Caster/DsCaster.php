...
class DsCaster
{
    ...
    {
        $a[\_PhpScoper78e1a27e740b\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'count'] = $c->count();
        $a[\_PhpScoper78e1a27e740b\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'capacity'] = $c->capacity();
        if (!$c instanceof Map) {
            $a += $c->toArray();
        }
        return $a;
    ...
    {
        foreach ($c as $k => $v) {
            $a[] = new \_PhpScoper78e1a27e740b\Symfony\Component\VarDumper\Caster\DsPairStub($k, $v);
        }
        return $a;
    }
    ...
    public static function castPairStub(\_PhpScoper78e1a27e740b\Symfony\Component\VarDumper\Caster\DsPairStub $c, array $a, Stub $stub, bool $isNested) : array
    {
        if ($isNested) {
