...
class DateCaster
{
    ...
    public static function castDateTime(\DateTimeInterface $d, array $a, Stub $stub, bool $isNested, int $filter)
    {
        ...
        unset($a[\_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\Caster::PREFIX_DYNAMIC . 'date'], $a[\_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\Caster::PREFIX_DYNAMIC . 'timezone'], $a[\_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\Caster::PREFIX_DYNAMIC . 'timezone_type']);
        $a[$prefix . 'date'] = new \_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\ConstStub(self::formatDateTime($d, $location ? ' e (P)' : ' P'), $title);
    ...
    public static function castInterval(\DateInterval $interval, array $a, Stub $stub, bool $isNested, int $filter)
    {
        ...
        $i = [\_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'interval' => new \_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\ConstStub(self::formatInterval($interval), $title)];
        return $filter & \_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE ? $i : $i + $a;
    }
    ...
    public static function castTimeZone(\DateTimeZone $timeZone, array $a, Stub $stub, bool $isNested, int $filter)
    {
        ...
        $z = [\_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'timezone' => new \_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\ConstStub($formatted, $title)];
        return $filter & \_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE ? $z : $z + $a;
    }
    public static function castPeriod(\DatePeriod $p, array $a, Stub $stub, bool $isNested, int $filter)
    {
        ...
        $p = [\_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'period' => new \_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\ConstStub($period, \implode("\n", $dates))];
        return $filter & \_PhpScopereb9508917a55\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE ? $p : $p + $a;
    }
