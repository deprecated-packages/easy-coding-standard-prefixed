...
class ResourceCaster
{
    ...
    public static function castStream($stream, array $a, Stub $stub, bool $isNested)
    {
        ...
        if (isset($a['uri'])) {
            $a['uri'] = new \_PhpScoper890197fe38f7\Symfony\Component\VarDumper\Caster\LinkStub($a['uri']);
        }
        return $a;
    }
    ...
    public static function castOpensslX509($h, array $a, Stub $stub, bool $isNested)
    {
        ...
        $a += ['subject' => new \_PhpScoper890197fe38f7\Symfony\Component\VarDumper\Caster\EnumStub(\array_intersect_key($info['subject'], ['organizationName' => \true, 'commonName' => \true])), 'issuer' => new \_PhpScoper890197fe38f7\Symfony\Component\VarDumper\Caster\EnumStub(\array_intersect_key($info['issuer'], ['organizationName' => \true, 'commonName' => \true])), 'expiry' => new \_PhpScoper890197fe38f7\Symfony\Component\VarDumper\Caster\ConstStub(\date(\DateTime::ISO8601, $info['validTo_time_t']), $info['validTo_time_t']), 'fingerprint' => new \_PhpScoper890197fe38f7\Symfony\Component\VarDumper\Caster\EnumStub(['md5' => new \_PhpScoper890197fe38f7\Symfony\Component\VarDumper\Caster\ConstStub(\wordwrap(\strtoupper(\openssl_x509_fingerprint($h, 'md5')), 2, ':', \true)), 'sha1' => new \_PhpScoper890197fe38f7\Symfony\Component\VarDumper\Caster\ConstStub(\wordwrap(\strtoupper(\openssl_x509_fingerprint($h, 'sha1')), 2, ':', \true)), 'sha256' => new \_PhpScoper890197fe38f7\Symfony\Component\VarDumper\Caster\ConstStub(\wordwrap(\strtoupper(\openssl_x509_fingerprint($h, 'sha256')), 2, ':', \true)), 'pin-sha256' => new \_PhpScoper890197fe38f7\Symfony\Component\VarDumper\Caster\ConstStub($pin)])];
        return $a;
    }
}
