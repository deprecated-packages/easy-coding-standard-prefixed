 ...
 * @final
 */
class HtmlDescriptor implements \_PhpScoper5e5ebcdbebdf\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $initialized = \false;
    public function __construct(\_PhpScoper5e5ebcdbebdf\Symfony\Component\VarDumper\Dumper\HtmlDumper $dumper)
    {
        $this->dumper = $dumper;
    }
