 ...
 * @final
 */
class HtmlDescriptor implements \_PhpScoper4e2df00556a9\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $initialized = \false;
    public function __construct(\_PhpScoper4e2df00556a9\Symfony\Component\VarDumper\Dumper\HtmlDumper $dumper)
    {
        $this->dumper = $dumper;
    }
