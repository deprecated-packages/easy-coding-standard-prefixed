 ...
 * @final
 */
class HtmlDescriptor implements \_PhpScoper3e1e0e5bb8ef\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $initialized = \false;
    public function __construct(\_PhpScoper3e1e0e5bb8ef\Symfony\Component\VarDumper\Dumper\HtmlDumper $dumper)
    {
        $this->dumper = $dumper;
    }
