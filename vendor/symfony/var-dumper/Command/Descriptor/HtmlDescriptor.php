 ...
 * @final
 */
class HtmlDescriptor implements \_PhpScoperf65af7a6d9a0\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $initialized = \false;
    public function __construct(\_PhpScoperf65af7a6d9a0\Symfony\Component\VarDumper\Dumper\HtmlDumper $dumper)
    {
        $this->dumper = $dumper;
    }
