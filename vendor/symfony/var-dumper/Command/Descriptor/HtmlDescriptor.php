 ...
 * @final
 */
class HtmlDescriptor implements \_PhpScoperb6d4bd368bd9\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $initialized = \false;
    public function __construct(\_PhpScoperb6d4bd368bd9\Symfony\Component\VarDumper\Dumper\HtmlDumper $dumper)
    {
        $this->dumper = $dumper;
    }
