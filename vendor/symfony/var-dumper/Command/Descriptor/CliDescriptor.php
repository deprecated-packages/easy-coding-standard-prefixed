 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperfd70a7e8e84f\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperfd70a7e8e84f\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperfd70a7e8e84f\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperfd70a7e8e84f\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperfd70a7e8e84f\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperfd70a7e8e84f\Symfony\Component\Console\Input\ArrayInput([]), $output);
