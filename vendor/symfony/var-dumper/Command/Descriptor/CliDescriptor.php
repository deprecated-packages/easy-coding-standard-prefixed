 ...
 * @final
 */
class CliDescriptor implements \_PhpScopera1f11cc38772\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScopera1f11cc38772\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScopera1f11cc38772\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScopera1f11cc38772\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScopera1f11cc38772\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScopera1f11cc38772\Symfony\Component\Console\Input\ArrayInput([]), $output);
