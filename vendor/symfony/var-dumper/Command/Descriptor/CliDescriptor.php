 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperc4ea0f0bd23f\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperc4ea0f0bd23f\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperc4ea0f0bd23f\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperc4ea0f0bd23f\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperc4ea0f0bd23f\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperc4ea0f0bd23f\Symfony\Component\Console\Input\ArrayInput([]), $output);
