 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperf65af7a6d9a0\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperf65af7a6d9a0\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperf65af7a6d9a0\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperf65af7a6d9a0\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperf65af7a6d9a0\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperf65af7a6d9a0\Symfony\Component\Console\Input\ArrayInput([]), $output);
