 ...
 * @final
 */
class CliDescriptor implements \_PhpScopera09818bc50da\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScopera09818bc50da\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScopera09818bc50da\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScopera09818bc50da\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScopera09818bc50da\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScopera09818bc50da\Symfony\Component\Console\Input\ArrayInput([]), $output);
