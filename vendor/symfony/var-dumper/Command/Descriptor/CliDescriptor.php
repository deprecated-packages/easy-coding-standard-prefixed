 ...
 * @final
 */
class CliDescriptor implements \_PhpScopere5e7dca8c031\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScopere5e7dca8c031\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScopere5e7dca8c031\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScopere5e7dca8c031\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScopere5e7dca8c031\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScopere5e7dca8c031\Symfony\Component\Console\Input\ArrayInput([]), $output);
