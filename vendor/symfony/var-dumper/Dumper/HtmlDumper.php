 ...
 */
class HtmlDumper extends \_PhpScoperd4c5032f0671\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \_PhpScoperd4c5032f0671\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     * {@inheritdoc}
     */
    public function dump(\_PhpScoperd4c5032f0671\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, array $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\_PhpScoperd4c5032f0671\Symfony\Component\VarDumper\Cloner\Cursor $cursor, $type, $class, $hasChild)
    {
        ...
        if ($hasChild) {
            $this->line .= '<samp';
            if ($cursor->refIndex) {
                $r = \_PhpScoperd4c5032f0671\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\_PhpScoperd4c5032f0671\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine($depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \_PhpScoperd4c5032f0671\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \_PhpScoperd4c5032f0671\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
