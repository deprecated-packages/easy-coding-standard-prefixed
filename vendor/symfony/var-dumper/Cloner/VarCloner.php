 ...
 */
class VarCloner extends \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\AbstractCloner
{
    private static $gid;
    ...
    protected function doClone($var)
    {
        ...
        $arrayStub = new \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub();
        $arrayStub->type = \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::TYPE_ARRAY;
        $fromObjCast = \false;
        for ($i = 0; $i < $len; ++$i) {
            ...
            foreach ($vals as $k => $v) {
                ...
                if ($zvalIsRef) {
                    ...
                    if ($v instanceof \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub && isset($hardRefs[\spl_object_id($v)])) {
                        $vals[$k] = $refs[$k] = $v;
                        if ($v->value instanceof \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub && (\_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::TYPE_OBJECT === $v->value->type || \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::TYPE_RESOURCE === $v->value->type)) {
                            ++$v->value->refCount;
                        }
                        ++$v->refCount;
                        continue;
                    }
                    $refs[$k] = $vals[$k] = new \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub();
                    $refs[$k]->value = $v;
                ...
                switch (\true) {
                    ...
                    case \is_string($v):
                        ...
                        if (!\preg_match('//u', $v)) {
                            ...
                            $stub = new \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub();
                            $stub->type = \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::TYPE_STRING;
                            $stub->class = \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::STRING_UTF8;
                            $stub->cut = $cut;
                    ...
                    case \is_array($v):
                        ...
                        $stub = $arrayStub;
                        $stub->class = \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::ARRAY_INDEXED;
                        $j = -1;
                        foreach ($v as $gk => $gv) {
                            if ($gk !== ++$j) {
                                $stub->class = \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::ARRAY_ASSOC;
                                break;
                            }
                        }
                        $a = $v;
                        if (\_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::ARRAY_ASSOC === $stub->class) {
                    ...
                    case $v instanceof \__PHP_Incomplete_Class:
                        if (empty($objRefs[$h = \spl_object_id($v)])) {
                            ...
                            if ($v !== $stub->value) {
                                if (\_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::TYPE_OBJECT !== $stub->type || null === $stub->value) {
                                    break;
                                }
                    ...
                    default:
                        ...
                        if (empty($resRefs[$h = (int) $v])) {
                            $stub = new \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub();
                            $stub->type = \_PhpScoperc8fea59b0cb1\Symfony\Component\VarDumper\Cloner\Stub::TYPE_RESOURCE;
