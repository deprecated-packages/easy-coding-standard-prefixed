 ...
 */
namespace _PhpScoper5686a261d89c\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\_PhpScoper5686a261d89c\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\_PhpScoper5686a261d89c\Psr\Container\ContainerExceptionInterface::class);
