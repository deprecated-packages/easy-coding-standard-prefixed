 ...
 */
namespace _PhpScoper8a8080b03ed6\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException('_PhpScoper8a8080b03ed6\\Psr\\Container\\NotFoundExceptionInterface');
    ...
    {
        $this->expectException('_PhpScoper8a8080b03ed6\\Psr\\Container\\ContainerExceptionInterface');
