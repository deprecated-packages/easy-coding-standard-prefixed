...
use _PhpScoper2637e9a72c68\Symfony\Component\Debug\Exception\UndefinedFunctionException;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', \_PhpScoper2637e9a72c68\Symfony\Component\Debug\FatalErrorHandler\UndefinedFunctionFatalErrorHandler::class, \_PhpScoper2637e9a72c68\Symfony\Component\ErrorHandler\ErrorEnhancer\UndefinedFunctionErrorEnhancer::class), \E_USER_DEPRECATED);
/**
 ...
 */
class UndefinedFunctionFatalErrorHandler implements \_PhpScoper2637e9a72c68\Symfony\Component\Debug\FatalErrorHandler\FatalErrorHandlerInterface
{
    /**
     * {@inheritdoc}
     */
    public function handleError(array $error, \_PhpScoper2637e9a72c68\Symfony\Component\Debug\Exception\FatalErrorException $exception)
    {
        ...
        return new \_PhpScoper2637e9a72c68\Symfony\Component\Debug\Exception\UndefinedFunctionException($message, $exception);
    }
}
