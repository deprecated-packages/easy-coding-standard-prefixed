 ...
 */
namespace _PhpScoper8dd2e1c340b1\Symfony\Component\Debug;

use _PhpScoper8dd2e1c340b1\Symfony\Component\Debug\Exception\FlattenException;
use _PhpScoper8dd2e1c340b1\Symfony\Component\Debug\Exception\OutOfMemoryException;
use _PhpScoper8dd2e1c340b1\Symfony\Component\HttpKernel\Debug\FileLinkFormatter;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', \_PhpScoper8dd2e1c340b1\Symfony\Component\Debug\ExceptionHandler::class, \_PhpScoper8dd2e1c340b1\Symfony\Component\ErrorHandler\ErrorHandler::class), \E_USER_DEPRECATED);
/**
...
class ExceptionHandler
{
    ...
    public static function register($debug = \true, $charset = null, $fileLinkFormat = null)
    {
        ...
        if (\is_array($prev) && $prev[0] instanceof \_PhpScoper8dd2e1c340b1\Symfony\Component\Debug\ErrorHandler) {
    ...
    {
        if (null === $this->handler || $exception instanceof \_PhpScoper8dd2e1c340b1\Symfony\Component\Debug\Exception\OutOfMemoryException) {
    ...
    public function sendPhpResponse($exception)
    {
        if ($exception instanceof \Throwable) {
            $exception = \_PhpScoper8dd2e1c340b1\Symfony\Component\Debug\Exception\FlattenException::createFromThrowable($exception);
        }
        if (!\headers_sent()) {
    ...
    {
        if (!$exception instanceof \_PhpScoper8dd2e1c340b1\Symfony\Component\Debug\Exception\FlattenException) {
            $exception = \_PhpScoper8dd2e1c340b1\Symfony\Component\Debug\Exception\FlattenException::create($exception);
        }
     ...
     */
    public function getContent(\_PhpScoper8dd2e1c340b1\Symfony\Component\Debug\Exception\FlattenException $exception)
    {
...
, $ind, $total, $class, $message);
            ...
            if ($this->debug) {
                $e = \_PhpScoper8dd2e1c340b1\Symfony\Component\Debug\Exception\FlattenException::create($e);
...
EOF;
     ...
     */
    public function getStylesheet(\_PhpScoper8dd2e1c340b1\Symfony\Component\Debug\Exception\FlattenException $exception)
    {
        if (!$this->debug) {
            return <<<'EOF'
