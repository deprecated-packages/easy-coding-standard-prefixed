...
use _PhpScoperc5bee3a837bb\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', \_PhpScoperc5bee3a837bb\Symfony\Component\Debug\DebugClassLoader::class, \_PhpScoperc5bee3a837bb\Symfony\Component\ErrorHandler\DebugClassLoader::class), \E_USER_DEPRECATED);
/**
...
class DebugClassLoader
{
    ...
    public static function enable()
    {
        ...
        \class_exists('_PhpScoperc5bee3a837bb\\Symfony\\Component\\Debug\\ErrorHandler');
        \class_exists('_PhpScoperc5bee3a837bb\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, $class)
    {
        ...
        foreach ($refl->getMethods(\ReflectionMethod::IS_PUBLIC | \ReflectionMethod::IS_PROTECTED) as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperc5bee3a837bb\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
