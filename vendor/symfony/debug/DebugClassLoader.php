...
use _PhpScoperb26833cc184d\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', \_PhpScoperb26833cc184d\Symfony\Component\Debug\DebugClassLoader::class, \_PhpScoperb26833cc184d\Symfony\Component\ErrorHandler\DebugClassLoader::class), \E_USER_DEPRECATED);
/**
...
class DebugClassLoader
{
    ...
    public static function enable()
    {
        ...
        \class_exists('_PhpScoperb26833cc184d\\Symfony\\Component\\Debug\\ErrorHandler');
        \class_exists('_PhpScoperb26833cc184d\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, $class)
    {
        ...
        foreach ($refl->getMethods(\ReflectionMethod::IS_PUBLIC | \ReflectionMethod::IS_PROTECTED) as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperb26833cc184d\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
