...
use _PhpScoper0270f1d35181\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', \_PhpScoper0270f1d35181\Symfony\Component\Debug\DebugClassLoader::class, \_PhpScoper0270f1d35181\Symfony\Component\ErrorHandler\DebugClassLoader::class), \E_USER_DEPRECATED);
/**
...
class DebugClassLoader
{
    ...
    public static function enable()
    {
        ...
        \class_exists('_PhpScoper0270f1d35181\\Symfony\\Component\\Debug\\ErrorHandler');
        \class_exists('_PhpScoper0270f1d35181\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, $class)
    {
        ...
        foreach ($refl->getMethods(\ReflectionMethod::IS_PUBLIC | \ReflectionMethod::IS_PROTECTED) as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoper0270f1d35181\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
