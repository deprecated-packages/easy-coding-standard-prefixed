...
use _PhpScopereb9508917a55\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface;
...
abstract class HttpClientTestCase extends TestCase
{
    ...
    {
        \_PhpScopereb9508917a55\Symfony\Contracts\HttpClient\Test\TestHttpServer::start();
    }
    ...
    {
        $p1 = \_PhpScopereb9508917a55\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8067);
        $p2 = \_PhpScopereb9508917a55\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8077);
        $client = $this->getHttpClient(__FUNCTION__);
