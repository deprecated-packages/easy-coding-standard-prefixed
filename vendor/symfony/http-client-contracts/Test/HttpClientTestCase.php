...
use _PhpScopere72a8aaba560\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface;
...
abstract class HttpClientTestCase extends TestCase
{
    ...
    {
        \_PhpScopere72a8aaba560\Symfony\Contracts\HttpClient\Test\TestHttpServer::start();
    }
    ...
    {
        $p1 = \_PhpScopere72a8aaba560\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8067);
        $p2 = \_PhpScopere72a8aaba560\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8077);
        $client = $this->getHttpClient(__FUNCTION__);
