...
trait CacheTrait
{
    ...
    private function doGet(CacheItemPoolInterface $pool, string $key, callable $callback, ?float $beta, array &$metadata = null, LoggerInterface $logger = null)
    {
        ...
        $metadata = $item instanceof \_PhpScoper6d453419d16a\Symfony\Contracts\Cache\ItemInterface ? $item->getMetadata() : [];
        if (!$recompute && $metadata) {
            $expiry = $metadata[\_PhpScoper6d453419d16a\Symfony\Contracts\Cache\ItemInterface::METADATA_EXPIRY] ?? \false;
            $ctime = $metadata[\_PhpScoper6d453419d16a\Symfony\Contracts\Cache\ItemInterface::METADATA_CTIME] ?? \false;
