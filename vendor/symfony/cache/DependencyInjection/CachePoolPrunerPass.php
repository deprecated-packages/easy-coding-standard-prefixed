 ...
 */
class CachePoolPrunerPass implements \_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolTag) as $id => $tags) {
            ...
            if ($reflection->implementsInterface(\_PhpScopercf327c47dfc5\Symfony\Component\Cache\PruneableInterface::class)) {
                $services[$id] = new \_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\Reference($id);
            }
        }
        $container->getDefinition($this->cacheCommandServiceId)->replaceArgument(0, new \_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\Argument\IteratorArgument($services));
    }
}
