 ...
 */
class CachePoolPrunerPass implements \_PhpScoperc75fd40d7a6e\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\_PhpScoperc75fd40d7a6e\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolTag) as $id => $tags) {
            ...
            if ($reflection->implementsInterface(\_PhpScoperc75fd40d7a6e\Symfony\Component\Cache\PruneableInterface::class)) {
                $services[$id] = new \_PhpScoperc75fd40d7a6e\Symfony\Component\DependencyInjection\Reference($id);
            }
        }
        $container->getDefinition($this->cacheCommandServiceId)->replaceArgument(0, new \_PhpScoperc75fd40d7a6e\Symfony\Component\DependencyInjection\Argument\IteratorArgument($services));
    }
}
