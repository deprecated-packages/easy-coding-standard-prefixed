 ...
 */
class CachePoolClearerPass implements \_PhpScoperc4ea0f0bd23f\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolClearerTag) as $id => $attr) {
            ...
            foreach ($clearer->getArgument(0) as $name => $ref) {
                if ($container->hasDefinition($ref)) {
                    $pools[$name] = new \_PhpScoperc4ea0f0bd23f\Symfony\Component\DependencyInjection\Reference($ref);
                }
            }
