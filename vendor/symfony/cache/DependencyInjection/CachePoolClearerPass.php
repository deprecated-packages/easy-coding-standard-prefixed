 ...
 */
namespace _PhpScoperb44a315fec16\Symfony\Component\Cache\DependencyInjection;
 ...
 */
class CachePoolClearerPass implements \_PhpScoperb44a315fec16\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolClearerTag) as $id => $attr) {
            ...
            foreach ($clearer->getArgument(0) as $name => $ref) {
                if ($container->hasDefinition($ref)) {
                    $pools[$name] = new \_PhpScoperb44a315fec16\Symfony\Component\DependencyInjection\Reference($ref);
                }
            }
