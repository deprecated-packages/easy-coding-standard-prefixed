 ...
 */
namespace _PhpScoper589e8c04a9ef\Symfony\Component\Cache\DependencyInjection;
 ...
 */
class CachePoolClearerPass implements \_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolClearerTag) as $id => $attr) {
            ...
            foreach ($clearer->getArgument(0) as $name => $ref) {
                if ($container->hasDefinition($ref)) {
                    $pools[$name] = new \_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\Reference($ref);
                }
            }
