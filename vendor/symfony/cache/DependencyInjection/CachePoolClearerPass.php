 ...
 */
namespace _PhpScoper9885c8c176c7\Symfony\Component\Cache\DependencyInjection;
 ...
 */
class CachePoolClearerPass implements \_PhpScoper9885c8c176c7\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolClearerTag) as $id => $attr) {
            ...
            foreach ($clearer->getArgument(0) as $name => $ref) {
                if ($container->hasDefinition($ref)) {
                    $pools[$name] = new \_PhpScoper9885c8c176c7\Symfony\Component\DependencyInjection\Reference($ref);
                }
            }
