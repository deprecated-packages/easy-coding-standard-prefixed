 ...
 */
class SodiumMarshaller implements \_PhpScoper0752b31150a1\Symfony\Component\Cache\Marshaller\MarshallerInterface
{
    private $marshaller;
     ...
     */
    public function __construct(array $decryptionKeys, \_PhpScoper0752b31150a1\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!self::isSupported()) {
        ...
        $this->marshaller = $marshaller ?? new \_PhpScoper0752b31150a1\Symfony\Component\Cache\Marshaller\DefaultMarshaller();
