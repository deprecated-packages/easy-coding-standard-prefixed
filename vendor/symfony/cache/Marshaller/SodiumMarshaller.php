 ...
 */
namespace _PhpScoper1ddca3f92d7d\Symfony\Component\Cache\Marshaller;
 ...
 */
class SodiumMarshaller implements \_PhpScoper1ddca3f92d7d\Symfony\Component\Cache\Marshaller\MarshallerInterface
{
    private $marshaller;
     ...
     */
    public function __construct(array $decryptionKeys, \_PhpScoper1ddca3f92d7d\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!self::isSupported()) {
        ...
        $this->marshaller = $marshaller ?? new \_PhpScoper1ddca3f92d7d\Symfony\Component\Cache\Marshaller\DefaultMarshaller();
