 ...
 */
class DefaultMarshaller implements \_PhpScoper836bc32aecc2\Symfony\Component\Cache\Marshaller\MarshallerInterface
{
    ...
    public function __construct(bool $useIgbinarySerialize = null)
    {
        if (null === $useIgbinarySerialize) {
            ...
            throw new \_PhpScoper836bc32aecc2\Symfony\Component\Cache\Exception\CacheException('The "igbinary" PHP extension is not ' . (\PHP_VERSION_ID >= 70400 ? 'compatible with PHP 7.4.' : 'loaded.'));
        }
