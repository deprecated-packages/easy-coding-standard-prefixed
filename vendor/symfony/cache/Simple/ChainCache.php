 ...
 */
class ChainCache implements \_PhpScoperfb2c402b972b\Psr\SimpleCache\CacheInterface, \_PhpScoperfb2c402b972b\Symfony\Component\Cache\PruneableInterface, \_PhpScoperfb2c402b972b\Symfony\Component\Cache\ResettableInterface
{
    private $miss;
    private $caches = [];
    ...
    {
        if (!$caches) {
            throw new \_PhpScoperfb2c402b972b\Symfony\Component\Cache\Exception\InvalidArgumentException('At least one cache must be specified.');
        }
        foreach ($caches as $cache) {
            if (!$cache instanceof \_PhpScoperfb2c402b972b\Psr\SimpleCache\CacheInterface) {
                throw new \_PhpScoperfb2c402b972b\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('The class "%s" does not implement the "%s" interface.', \get_class($cache), \_PhpScoperfb2c402b972b\Psr\SimpleCache\CacheInterface::class));
            }
        }
    ...
    public function prune()
    {
        $pruned = \true;
        foreach ($this->caches as $cache) {
            if ($cache instanceof \_PhpScoperfb2c402b972b\Symfony\Component\Cache\PruneableInterface) {
    ...
    {
        foreach ($this->caches as $cache) {
            if ($cache instanceof \_PhpScoperfb2c402b972b\Symfony\Contracts\Service\ResetInterface) {
                $cache->reset();
            }
        }
    }
