...
use _PhpScoperb383f16e851e\Symfony\Component\Cache\Adapter\PhpArrayAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperb383f16e851e\Symfony\Component\Cache\Simple\PhpArrayCache::class, \_PhpScoperb383f16e851e\Symfony\Component\Cache\Adapter\PhpArrayAdapter::class, \_PhpScoperb383f16e851e\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PhpArrayAdapter and type-hint for CacheInterface instead.
 */
class PhpArrayCache implements \_PhpScoperb383f16e851e\Psr\SimpleCache\CacheInterface, \_PhpScoperb383f16e851e\Symfony\Component\Cache\PruneableInterface, \_PhpScoperb383f16e851e\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    /**
     ...
     */
    public function __construct(string $file, \_PhpScoperb383f16e851e\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoperb383f16e851e\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
