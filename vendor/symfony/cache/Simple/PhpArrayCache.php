...
use _PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Adapter\PhpArrayAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Simple\PhpArrayCache::class, \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Adapter\PhpArrayAdapter::class, \_PhpScoperfd70a7e8e84f\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PhpArrayAdapter and type-hint for CacheInterface instead.
 */
class PhpArrayCache implements \_PhpScoperfd70a7e8e84f\Psr\SimpleCache\CacheInterface, \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\PruneableInterface, \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    /**
     ...
     */
    public function __construct(string $file, \_PhpScoperfd70a7e8e84f\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoperfd70a7e8e84f\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
