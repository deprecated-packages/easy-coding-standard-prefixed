...
use _PhpScoperae959d396e95\Symfony\Component\Cache\Adapter\PhpArrayAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperae959d396e95\Symfony\Component\Cache\Simple\PhpArrayCache::class, \_PhpScoperae959d396e95\Symfony\Component\Cache\Adapter\PhpArrayAdapter::class, \_PhpScoperae959d396e95\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PhpArrayAdapter and type-hint for CacheInterface instead.
 */
class PhpArrayCache implements \_PhpScoperae959d396e95\Psr\SimpleCache\CacheInterface, \_PhpScoperae959d396e95\Symfony\Component\Cache\PruneableInterface, \_PhpScoperae959d396e95\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    /**
     ...
     */
    public function __construct(string $file, \_PhpScoperae959d396e95\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoperae959d396e95\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
