...
use _PhpScoperbaf90856897c\Symfony\Component\Cache\Adapter\PhpArrayAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperbaf90856897c\Symfony\Component\Cache\Simple\PhpArrayCache::class, \_PhpScoperbaf90856897c\Symfony\Component\Cache\Adapter\PhpArrayAdapter::class, \_PhpScoperbaf90856897c\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PhpArrayAdapter and type-hint for CacheInterface instead.
 */
class PhpArrayCache implements \_PhpScoperbaf90856897c\Psr\SimpleCache\CacheInterface, \_PhpScoperbaf90856897c\Symfony\Component\Cache\PruneableInterface, \_PhpScoperbaf90856897c\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    /**
     ...
     */
    public function __construct(string $file, \_PhpScoperbaf90856897c\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoperbaf90856897c\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
