...
use _PhpScoperb83706991c7f\Symfony\Component\Cache\Adapter\MemcachedAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperb83706991c7f\Symfony\Component\Cache\Simple\MemcachedCache::class, \_PhpScoperb83706991c7f\Symfony\Component\Cache\Adapter\MemcachedAdapter::class, \_PhpScoperb83706991c7f\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use MemcachedAdapter and type-hint for CacheInterface instead.
 */
class MemcachedCache extends \_PhpScoperb83706991c7f\Symfony\Component\Cache\Simple\AbstractCache
{
    use MemcachedTrait;
