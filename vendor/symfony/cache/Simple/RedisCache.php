...
use _PhpScoper3fa05b4669af\Symfony\Component\Cache\Adapter\RedisAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoper3fa05b4669af\Symfony\Component\Cache\Simple\RedisCache::class, \_PhpScoper3fa05b4669af\Symfony\Component\Cache\Adapter\RedisAdapter::class, \_PhpScoper3fa05b4669af\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use RedisAdapter and type-hint for CacheInterface instead.
 */
class RedisCache extends \_PhpScoper3fa05b4669af\Symfony\Component\Cache\Simple\AbstractCache
{
    use RedisTrait;
    /**
