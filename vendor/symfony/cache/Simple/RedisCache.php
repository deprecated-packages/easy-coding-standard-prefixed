...
use _PhpScopere106f9fd4493\Symfony\Component\Cache\Adapter\RedisAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScopere106f9fd4493\Symfony\Component\Cache\Simple\RedisCache::class, \_PhpScopere106f9fd4493\Symfony\Component\Cache\Adapter\RedisAdapter::class, \_PhpScopere106f9fd4493\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use RedisAdapter and type-hint for CacheInterface instead.
 */
class RedisCache extends \_PhpScopere106f9fd4493\Symfony\Component\Cache\Simple\AbstractCache
{
    use RedisTrait;
    /**
