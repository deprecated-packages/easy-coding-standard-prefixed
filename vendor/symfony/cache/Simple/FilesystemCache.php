...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScopere5e7dca8c031\Symfony\Component\Cache\Simple\FilesystemCache::class, \_PhpScopere5e7dca8c031\Symfony\Component\Cache\Adapter\FilesystemAdapter::class, \_PhpScopere5e7dca8c031\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use FilesystemAdapter and type-hint for CacheInterface instead.
 */
class FilesystemCache extends \_PhpScopere5e7dca8c031\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScopere5e7dca8c031\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait;
