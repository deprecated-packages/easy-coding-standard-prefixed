...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperd301db66c80c\Symfony\Component\Cache\Simple\TraceableCache::class, \_PhpScoperd301db66c80c\Symfony\Component\Cache\Simple\TraceableAdapter::class, \_PhpScoperd301db66c80c\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use TraceableAdapter and type-hint for CacheInterface instead.
 */
class TraceableCache implements \_PhpScoperd301db66c80c\Psr\SimpleCache\CacheInterface, \_PhpScoperd301db66c80c\Symfony\Component\Cache\PruneableInterface, \_PhpScoperd301db66c80c\Symfony\Component\Cache\ResettableInterface
{
    private $pool;
    private $miss;
    private $calls = [];
    public function __construct(\_PhpScoperd301db66c80c\Psr\SimpleCache\CacheInterface $pool)
    {
        $this->pool = $pool;
    ...
    private function start(string $name) : \_PhpScoperd301db66c80c\Symfony\Component\Cache\Simple\TraceableCacheEvent
    {
        $this->calls[] = $event = new \_PhpScoperd301db66c80c\Symfony\Component\Cache\Simple\TraceableCacheEvent();
        $event->name = $name;
