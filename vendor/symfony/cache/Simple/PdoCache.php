...
use _PhpScoper6ec31b85adcf\Symfony\Component\Cache\Adapter\PdoAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoper6ec31b85adcf\Symfony\Component\Cache\Simple\PdoCache::class, \_PhpScoper6ec31b85adcf\Symfony\Component\Cache\Adapter\PdoAdapter::class, \_PhpScoper6ec31b85adcf\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PdoAdapter and type-hint for CacheInterface instead.
 */
class PdoCache extends \_PhpScoper6ec31b85adcf\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScoper6ec31b85adcf\Symfony\Component\Cache\PruneableInterface
{
    use PdoTrait;
