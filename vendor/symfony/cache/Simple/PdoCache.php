...
use _PhpScopere015d8a3273c\Symfony\Component\Cache\Adapter\PdoAdapter;
...
use _PhpScopere015d8a3273c\Symfony\Component\Cache\Traits\PdoTrait;
use _PhpScopere015d8a3273c\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScopere015d8a3273c\Symfony\Component\Cache\Simple\PdoCache::class, \_PhpScopere015d8a3273c\Symfony\Component\Cache\Adapter\PdoAdapter::class, \_PhpScopere015d8a3273c\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PdoAdapter and type-hint for CacheInterface instead.
 */
class PdoCache extends \_PhpScopere015d8a3273c\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScopere015d8a3273c\Symfony\Component\Cache\PruneableInterface
{
    use PdoTrait;
     ...
     */
    public function __construct($connOrDsn, string $namespace = '', int $defaultLifetime = 0, array $options = [], \_PhpScopere015d8a3273c\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
