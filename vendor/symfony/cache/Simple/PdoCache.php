...
use _PhpScoper7145e5e87de5\Symfony\Component\Cache\Adapter\PdoAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoper7145e5e87de5\Symfony\Component\Cache\Simple\PdoCache::class, \_PhpScoper7145e5e87de5\Symfony\Component\Cache\Adapter\PdoAdapter::class, \_PhpScoper7145e5e87de5\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PdoAdapter and type-hint for CacheInterface instead.
 */
class PdoCache extends \_PhpScoper7145e5e87de5\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScoper7145e5e87de5\Symfony\Component\Cache\PruneableInterface
{
    use PdoTrait;
