...
use _PhpScoperca8ca183ac38\Symfony\Component\Cache\Adapter\PdoAdapter;
...
use _PhpScoperca8ca183ac38\Symfony\Component\Cache\Traits\PdoTrait;
use _PhpScoperca8ca183ac38\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperca8ca183ac38\Symfony\Component\Cache\Simple\PdoCache::class, \_PhpScoperca8ca183ac38\Symfony\Component\Cache\Adapter\PdoAdapter::class, \_PhpScoperca8ca183ac38\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PdoAdapter and type-hint for CacheInterface instead.
 */
class PdoCache extends \_PhpScoperca8ca183ac38\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScoperca8ca183ac38\Symfony\Component\Cache\PruneableInterface
{
    use PdoTrait;
     ...
     */
    public function __construct($connOrDsn, string $namespace = '', int $defaultLifetime = 0, array $options = [], \_PhpScoperca8ca183ac38\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
