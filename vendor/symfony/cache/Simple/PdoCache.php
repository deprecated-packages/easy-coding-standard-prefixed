...
use _PhpScoperd301db66c80c\Symfony\Component\Cache\Adapter\PdoAdapter;
...
use _PhpScoperd301db66c80c\Symfony\Component\Cache\Traits\PdoTrait;
use _PhpScoperd301db66c80c\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperd301db66c80c\Symfony\Component\Cache\Simple\PdoCache::class, \_PhpScoperd301db66c80c\Symfony\Component\Cache\Adapter\PdoAdapter::class, \_PhpScoperd301db66c80c\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PdoAdapter and type-hint for CacheInterface instead.
 */
class PdoCache extends \_PhpScoperd301db66c80c\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScoperd301db66c80c\Symfony\Component\Cache\PruneableInterface
{
    use PdoTrait;
     ...
     */
    public function __construct($connOrDsn, string $namespace = '', int $defaultLifetime = 0, array $options = [], \_PhpScoperd301db66c80c\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
