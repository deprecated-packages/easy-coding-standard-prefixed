...
use _PhpScoperb6a8e65b492c\Symfony\Component\Cache\Adapter\PdoAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperb6a8e65b492c\Symfony\Component\Cache\Simple\PdoCache::class, \_PhpScoperb6a8e65b492c\Symfony\Component\Cache\Adapter\PdoAdapter::class, \_PhpScoperb6a8e65b492c\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PdoAdapter and type-hint for CacheInterface instead.
 */
class PdoCache extends \_PhpScoperb6a8e65b492c\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScoperb6a8e65b492c\Symfony\Component\Cache\PruneableInterface
{
    use PdoTrait;
