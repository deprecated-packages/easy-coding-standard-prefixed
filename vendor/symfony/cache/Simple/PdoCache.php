...
use _PhpScopercb217fd4e736\Symfony\Component\Cache\Adapter\PdoAdapter;
...
use _PhpScopercb217fd4e736\Symfony\Component\Cache\Traits\PdoTrait;
use _PhpScopercb217fd4e736\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScopercb217fd4e736\Symfony\Component\Cache\Simple\PdoCache::class, \_PhpScopercb217fd4e736\Symfony\Component\Cache\Adapter\PdoAdapter::class, \_PhpScopercb217fd4e736\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PdoAdapter and type-hint for CacheInterface instead.
 */
class PdoCache extends \_PhpScopercb217fd4e736\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScopercb217fd4e736\Symfony\Component\Cache\PruneableInterface
{
    use PdoTrait;
     ...
     */
    public function __construct($connOrDsn, string $namespace = '', int $defaultLifetime = 0, array $options = [], \_PhpScopercb217fd4e736\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
