...
use _PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Adapter\PdoAdapter;
...
use _PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Traits\PdoTrait;
use _PhpScoperfd70a7e8e84f\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Simple\PdoCache::class, \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Adapter\PdoAdapter::class, \_PhpScoperfd70a7e8e84f\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PdoAdapter and type-hint for CacheInterface instead.
 */
class PdoCache extends \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\PruneableInterface
{
    use PdoTrait;
     ...
     */
    public function __construct($connOrDsn, string $namespace = '', int $defaultLifetime = 0, array $options = [], \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
