...
use _PhpScoperdebd9d705540\Symfony\Component\Cache\Adapter\PdoAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperdebd9d705540\Symfony\Component\Cache\Simple\PdoCache::class, \_PhpScoperdebd9d705540\Symfony\Component\Cache\Adapter\PdoAdapter::class, \_PhpScoperdebd9d705540\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PdoAdapter and type-hint for CacheInterface instead.
 */
class PdoCache extends \_PhpScoperdebd9d705540\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScoperdebd9d705540\Symfony\Component\Cache\PruneableInterface
{
    use PdoTrait;
