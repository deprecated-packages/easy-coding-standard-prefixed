...
use _PhpScoperca8ca183ac38\Symfony\Component\Cache\Adapter\DoctrineAdapter;
...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperca8ca183ac38\Symfony\Component\Cache\Simple\DoctrineCache::class, \_PhpScoperca8ca183ac38\Symfony\Component\Cache\Adapter\DoctrineAdapter::class, \_PhpScoperca8ca183ac38\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use DoctrineAdapter and type-hint for CacheInterface instead.
 */
class DoctrineCache extends \_PhpScoperca8ca183ac38\Symfony\Component\Cache\Simple\AbstractCache
{
    use DoctrineTrait;
