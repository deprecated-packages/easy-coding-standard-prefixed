...
use _PhpScoperfb2c402b972b\Psr\SimpleCache\CacheInterface as Psr16CacheInterface;
use _PhpScoperfb2c402b972b\Symfony\Component\Cache\Adapter\NullAdapter;
use _PhpScoperfb2c402b972b\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperfb2c402b972b\Symfony\Component\Cache\Simple\NullCache::class, \_PhpScoperfb2c402b972b\Symfony\Component\Cache\Adapter\NullAdapter::class, \_PhpScoperfb2c402b972b\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use NullAdapter and type-hint for CacheInterface instead.
 */
class NullCache implements \_PhpScoperfb2c402b972b\Psr\SimpleCache\CacheInterface
{
    /**
     * {@inheritdoc}
     */
