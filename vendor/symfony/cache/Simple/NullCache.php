...
use _PhpScopercb217fd4e736\Psr\SimpleCache\CacheInterface as Psr16CacheInterface;
use _PhpScopercb217fd4e736\Symfony\Component\Cache\Adapter\NullAdapter;
use _PhpScopercb217fd4e736\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScopercb217fd4e736\Symfony\Component\Cache\Simple\NullCache::class, \_PhpScopercb217fd4e736\Symfony\Component\Cache\Adapter\NullAdapter::class, \_PhpScopercb217fd4e736\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use NullAdapter and type-hint for CacheInterface instead.
 */
class NullCache implements \_PhpScopercb217fd4e736\Psr\SimpleCache\CacheInterface
{
    /**
     * {@inheritdoc}
     */
