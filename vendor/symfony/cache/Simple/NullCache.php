...
use _PhpScoperd301db66c80c\Psr\SimpleCache\CacheInterface as Psr16CacheInterface;
use _PhpScoperd301db66c80c\Symfony\Component\Cache\Adapter\NullAdapter;
use _PhpScoperd301db66c80c\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperd301db66c80c\Symfony\Component\Cache\Simple\NullCache::class, \_PhpScoperd301db66c80c\Symfony\Component\Cache\Adapter\NullAdapter::class, \_PhpScoperd301db66c80c\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use NullAdapter and type-hint for CacheInterface instead.
 */
class NullCache implements \_PhpScoperd301db66c80c\Psr\SimpleCache\CacheInterface
{
    /**
     * {@inheritdoc}
     */
