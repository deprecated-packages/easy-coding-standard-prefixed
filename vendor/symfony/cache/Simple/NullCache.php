...
use _PhpScoperbcc0395698f8\Psr\SimpleCache\CacheInterface as Psr16CacheInterface;
use _PhpScoperbcc0395698f8\Symfony\Component\Cache\Adapter\NullAdapter;
use _PhpScoperbcc0395698f8\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperbcc0395698f8\Symfony\Component\Cache\Simple\NullCache::class, \_PhpScoperbcc0395698f8\Symfony\Component\Cache\Adapter\NullAdapter::class, \_PhpScoperbcc0395698f8\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use NullAdapter and type-hint for CacheInterface instead.
 */
class NullCache implements \_PhpScoperbcc0395698f8\Psr\SimpleCache\CacheInterface
{
    /**
     * {@inheritdoc}
     */
