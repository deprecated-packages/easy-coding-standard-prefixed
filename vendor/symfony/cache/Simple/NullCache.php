...
use _PhpScoperc4b135661b3a\Symfony\Component\Cache\Adapter\NullAdapter;
use _PhpScoperc4b135661b3a\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperc4b135661b3a\Symfony\Component\Cache\Simple\NullCache::class, \_PhpScoperc4b135661b3a\Symfony\Component\Cache\Adapter\NullAdapter::class, \_PhpScoperc4b135661b3a\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use NullAdapter and type-hint for CacheInterface instead.
 */
class NullCache implements \_PhpScoperc4b135661b3a\Psr\SimpleCache\CacheInterface
{
    /**
     * {@inheritdoc}
     */
