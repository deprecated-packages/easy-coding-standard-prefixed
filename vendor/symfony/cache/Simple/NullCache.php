...
use _PhpScoper14cb6de5473d\Symfony\Component\Cache\Adapter\NullAdapter;
use _PhpScoper14cb6de5473d\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoper14cb6de5473d\Symfony\Component\Cache\Simple\NullCache::class, \_PhpScoper14cb6de5473d\Symfony\Component\Cache\Adapter\NullAdapter::class, \_PhpScoper14cb6de5473d\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use NullAdapter and type-hint for CacheInterface instead.
 */
class NullCache implements \_PhpScoper14cb6de5473d\Psr\SimpleCache\CacheInterface
{
    /**
     * {@inheritdoc}
     */
