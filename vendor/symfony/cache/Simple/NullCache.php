...
use _PhpScoperb458b528613f\Psr\SimpleCache\CacheInterface as Psr16CacheInterface;
use _PhpScoperb458b528613f\Symfony\Component\Cache\Adapter\NullAdapter;
use _PhpScoperb458b528613f\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperb458b528613f\Symfony\Component\Cache\Simple\NullCache::class, \_PhpScoperb458b528613f\Symfony\Component\Cache\Adapter\NullAdapter::class, \_PhpScoperb458b528613f\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use NullAdapter and type-hint for CacheInterface instead.
 */
class NullCache implements \_PhpScoperb458b528613f\Psr\SimpleCache\CacheInterface
{
    /**
     * {@inheritdoc}
     */
