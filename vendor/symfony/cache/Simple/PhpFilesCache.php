...
use _PhpScoperd301db66c80c\Symfony\Component\Cache\Adapter\PhpFilesAdapter;
...
use _PhpScoperd301db66c80c\Symfony\Component\Cache\Traits\PhpFilesTrait;
use _PhpScoperd301db66c80c\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperd301db66c80c\Symfony\Component\Cache\Simple\PhpFilesCache::class, \_PhpScoperd301db66c80c\Symfony\Component\Cache\Adapter\PhpFilesAdapter::class, \_PhpScoperd301db66c80c\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PhpFilesAdapter and type-hint for CacheInterface instead.
 */
class PhpFilesCache extends \_PhpScoperd301db66c80c\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScoperd301db66c80c\Symfony\Component\Cache\PruneableInterface
{
    use PhpFilesTrait;
    /**
