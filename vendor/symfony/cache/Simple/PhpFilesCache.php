...
use _PhpScopercb217fd4e736\Symfony\Component\Cache\Adapter\PhpFilesAdapter;
...
use _PhpScopercb217fd4e736\Symfony\Component\Cache\Traits\PhpFilesTrait;
use _PhpScopercb217fd4e736\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScopercb217fd4e736\Symfony\Component\Cache\Simple\PhpFilesCache::class, \_PhpScopercb217fd4e736\Symfony\Component\Cache\Adapter\PhpFilesAdapter::class, \_PhpScopercb217fd4e736\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use PhpFilesAdapter and type-hint for CacheInterface instead.
 */
class PhpFilesCache extends \_PhpScopercb217fd4e736\Symfony\Component\Cache\Simple\AbstractCache implements \_PhpScopercb217fd4e736\Symfony\Component\Cache\PruneableInterface
{
    use PhpFilesTrait;
    /**
