...
use _PhpScoperbaf90856897c\Symfony\Component\Cache\Traits\AbstractTrait;
use _PhpScoperbaf90856897c\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperbaf90856897c\Symfony\Component\Cache\Simple\AbstractCache::class, \_PhpScoperbaf90856897c\Symfony\Component\Cache\Adapter\AbstractAdapter::class, \_PhpScoperbaf90856897c\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use AbstractAdapter and type-hint for CacheInterface instead.
 */
abstract class AbstractCache implements \_PhpScoperbaf90856897c\Psr\SimpleCache\CacheInterface, \_PhpScoperbaf90856897c\Psr\Log\LoggerAwareInterface, \_PhpScoperbaf90856897c\Symfony\Component\Cache\ResettableInterface
{
    /**
     * @internal
     */
    ...
    public function getMultiple($keys, $default = null)
    {
        ...
        try {
            ...
            \_PhpScoperbaf90856897c\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch values: ' . $e->getMessage(), ['keys' => $keys, 'exception' => $e]);
            $values = [];
        }
    ...
    public function setMultiple($values, $ttl = null)
    {
        ...
        \_PhpScoperbaf90856897c\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['keys' => $keys, 'exception' => $e instanceof \Exception ? $e : null]);
        return \false;
    }
    /**
     * {@inheritdoc}
    ...
    private function generateValues(iterable $values, array &$keys, $default) : iterable
    {
        try {
            ...
            \_PhpScoperbaf90856897c\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch values: ' . $e->getMessage(), ['keys' => \array_values($keys), 'exception' => $e]);
        }
        foreach ($keys as $key) {
            (yield $key => $default);
        }
