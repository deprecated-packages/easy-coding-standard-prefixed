...
use _PhpScoper87c77ad5700d\Symfony\Component\Cache\Traits\AbstractTrait;
use _PhpScoper87c77ad5700d\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoper87c77ad5700d\Symfony\Component\Cache\Simple\AbstractCache::class, \_PhpScoper87c77ad5700d\Symfony\Component\Cache\Adapter\AbstractAdapter::class, \_PhpScoper87c77ad5700d\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use AbstractAdapter and type-hint for CacheInterface instead.
 */
abstract class AbstractCache implements \_PhpScoper87c77ad5700d\Psr\SimpleCache\CacheInterface, \_PhpScoper87c77ad5700d\Psr\Log\LoggerAwareInterface, \_PhpScoper87c77ad5700d\Symfony\Component\Cache\ResettableInterface
{
    /**
     * @internal
     */
    ...
    public function getMultiple($keys, $default = null)
    {
        ...
        try {
            ...
            \_PhpScoper87c77ad5700d\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch values: ' . $e->getMessage(), ['keys' => $keys, 'exception' => $e]);
            $values = [];
        }
    ...
    public function setMultiple($values, $ttl = null)
    {
        ...
        \_PhpScoper87c77ad5700d\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['keys' => $keys, 'exception' => $e instanceof \Exception ? $e : null]);
        return \false;
    }
    /**
     * {@inheritdoc}
    ...
    private function generateValues(iterable $values, array &$keys, $default) : iterable
    {
        try {
            ...
            \_PhpScoper87c77ad5700d\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch values: ' . $e->getMessage(), ['keys' => \array_values($keys), 'exception' => $e]);
        }
        foreach ($keys as $key) {
            (yield $key => $default);
        }
