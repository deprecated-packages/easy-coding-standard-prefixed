...
use _PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Traits\ArrayTrait;
use _PhpScoperfd70a7e8e84f\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Simple\ArrayCache::class, \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Adapter\ArrayAdapter::class, \_PhpScoperfd70a7e8e84f\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use ArrayAdapter and type-hint for CacheInterface instead.
 */
class ArrayCache implements \_PhpScoperfd70a7e8e84f\Psr\SimpleCache\CacheInterface, \_PhpScoperfd70a7e8e84f\Psr\Log\LoggerAwareInterface, \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\ResettableInterface
{
    use ArrayTrait {
