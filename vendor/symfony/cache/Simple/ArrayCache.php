...
use _PhpScoper0d0ee1ba46d4\Symfony\Component\Cache\Traits\ArrayTrait;
use _PhpScoper0d0ee1ba46d4\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoper0d0ee1ba46d4\Symfony\Component\Cache\Simple\ArrayCache::class, \_PhpScoper0d0ee1ba46d4\Symfony\Component\Cache\Adapter\ArrayAdapter::class, \_PhpScoper0d0ee1ba46d4\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use ArrayAdapter and type-hint for CacheInterface instead.
 */
class ArrayCache implements \_PhpScoper0d0ee1ba46d4\Psr\SimpleCache\CacheInterface, \_PhpScoper0d0ee1ba46d4\Psr\Log\LoggerAwareInterface, \_PhpScoper0d0ee1ba46d4\Symfony\Component\Cache\ResettableInterface
{
    use ArrayTrait {
