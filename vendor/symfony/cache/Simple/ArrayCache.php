...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperbcc0395698f8\Symfony\Component\Cache\Simple\ArrayCache::class, \_PhpScoperbcc0395698f8\Symfony\Component\Cache\Adapter\ArrayAdapter::class, \_PhpScoperbcc0395698f8\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use ArrayAdapter and type-hint for CacheInterface instead.
 */
class ArrayCache implements \_PhpScoperbcc0395698f8\Psr\SimpleCache\CacheInterface, \_PhpScoperbcc0395698f8\Psr\Log\LoggerAwareInterface, \_PhpScoperbcc0395698f8\Symfony\Component\Cache\ResettableInterface
{
    use ArrayTrait {
