...
use _PhpScoperae959d396e95\Symfony\Component\Cache\Traits\ArrayTrait;
use _PhpScoperae959d396e95\Symfony\Contracts\Cache\CacheInterface;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" and type-hint for "%s" instead.', \_PhpScoperae959d396e95\Symfony\Component\Cache\Simple\ArrayCache::class, \_PhpScoperae959d396e95\Symfony\Component\Cache\Adapter\ArrayAdapter::class, \_PhpScoperae959d396e95\Symfony\Contracts\Cache\CacheInterface::class), \E_USER_DEPRECATED);
/**
 * @deprecated since Symfony 4.3, use ArrayAdapter and type-hint for CacheInterface instead.
 */
class ArrayCache implements \_PhpScoperae959d396e95\Psr\SimpleCache\CacheInterface, \_PhpScoperae959d396e95\Psr\Log\LoggerAwareInterface, \_PhpScoperae959d396e95\Symfony\Component\Cache\ResettableInterface
{
    use ArrayTrait {
