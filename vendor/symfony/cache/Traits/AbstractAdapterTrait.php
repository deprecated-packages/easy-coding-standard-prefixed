...
trait AbstractAdapterTrait
{
    ...
    public function getItem($key)
    {
        ...
        try {
            ...
            \_PhpScoperbaf90856897c\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch key "{key}": ' . $e->getMessage(), ['key' => $key, 'exception' => $e]);
        }
    ...
    public function getItems(array $keys = [])
    {
        ...
        try {
            ...
            \_PhpScoperbaf90856897c\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch items: ' . $e->getMessage(), ['keys' => $keys, 'exception' => $e]);
            $items = [];
        }
    ...
    private function generateItems(iterable $items, array &$keys) : iterable
    {
        ...
        try {
            ...
            \_PhpScoperbaf90856897c\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to fetch items: ' . $e->getMessage(), ['keys' => \array_values($keys), 'exception' => $e]);
        }
        foreach ($keys as $key) {
