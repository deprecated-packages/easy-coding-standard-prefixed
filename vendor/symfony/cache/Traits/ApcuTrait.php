...
trait ApcuTrait
{
    ...
    private function init(string $namespace, int $defaultLifetime, ?string $version)
    {
        if (!static::isSupported()) {
            throw new \_PhpScoper8db4616aa69d\Symfony\Component\Cache\Exception\CacheException('APCu is not enabled');
        }
        if ('cli' === \PHP_SAPI) {
        ...
        if (null !== $version) {
            \_PhpScoper8db4616aa69d\Symfony\Component\Cache\CacheItem::validateKey($version);
