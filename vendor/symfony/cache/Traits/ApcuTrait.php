...
trait ApcuTrait
{
    ...
    private function init(string $namespace, int $defaultLifetime, ?string $version)
    {
        if (!static::isSupported()) {
            throw new \_PhpScoperbd5fb781fe24\Symfony\Component\Cache\Exception\CacheException('APCu is not enabled');
        }
        if ('cli' === \PHP_SAPI) {
        ...
        if (null !== $version) {
            \_PhpScoperbd5fb781fe24\Symfony\Component\Cache\CacheItem::validateKey($version);
