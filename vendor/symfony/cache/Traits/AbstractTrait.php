...
use _PhpScopera1a51450b61d\Psr\Log\LoggerAwareTrait;
...
trait AbstractTrait
{
    ...
    public function hasItem($key)
    {
        ...
        try {
            ...
            \_PhpScopera1a51450b61d\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to check if key "{key}" is cached: ' . $e->getMessage(), ['key' => $key, 'exception' => $e]);
            return \false;
        }
    }
    /**
    ...
    public function clear()
    {
        ...
        try {
            ...
            \_PhpScopera1a51450b61d\Symfony\Component\Cache\CacheItem::log($this->logger, 'Failed to clear the cache: ' . $e->getMessage(), ['exception' => $e]);
            return \false;
        }
    }
    /**
