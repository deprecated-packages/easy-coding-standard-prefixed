    ...
    protected function doFetch(array $ids)
    {
        ...
        foreach ($ids as $id) {
            if (null === ($value = $this->values[$id] ?? null)) {
                ...
                $values[$id] = $value;
            } elseif (!$value instanceof \_PhpScoper7f5523334c1b\Symfony\Component\Cache\Traits\LazyValue) {
            ...
            foreach ($missingIds as $k => $id) {
                try {
                    ...
                    if (\is_array($expiresAt = (include $file))) {
                        ...
                        $this->values[$id] = new \_PhpScoper7f5523334c1b\Symfony\Component\Cache\Traits\LazyValue($file);
                    }
                    if ($now >= $expiresAt) {
    ...
    protected function doHave($id)
    {
        ...
        try {
            ...
            if (\is_array($expiresAt = (include $file))) {
                ...
                $value = new \_PhpScoper7f5523334c1b\Symfony\Component\Cache\Traits\LazyValue($file);
            }
        } catch (\ErrorException $e) {
            return \false;
        } finally {
