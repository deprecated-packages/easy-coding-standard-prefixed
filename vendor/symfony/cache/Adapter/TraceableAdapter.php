 ...
 */
class TraceableAdapter implements \_PhpScoper130a9a1cd4a2\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    protected $pool;
    private $calls = [];
    public function __construct(\_PhpScoper130a9a1cd4a2\Symfony\Component\Cache\Adapter\AdapterInterface $pool)
    {
        $this->pool = $pool;
    }
    /**
    ...
    {
        $this->calls[] = $event = new \_PhpScoper130a9a1cd4a2\Symfony\Component\Cache\Adapter\TraceableAdapterEvent();
        $event->name = $name;
