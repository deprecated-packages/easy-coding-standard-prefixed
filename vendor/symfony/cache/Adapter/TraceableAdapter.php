 ...
 */
class TraceableAdapter implements \_PhpScoper6ffa0951a2e9\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    protected $pool;
    private $calls = [];
    public function __construct(\_PhpScoper6ffa0951a2e9\Symfony\Component\Cache\Adapter\AdapterInterface $pool)
    {
        $this->pool = $pool;
    }
    /**
    ...
    {
        $this->calls[] = $event = new \_PhpScoper6ffa0951a2e9\Symfony\Component\Cache\Adapter\TraceableAdapterEvent();
        $event->name = $name;
