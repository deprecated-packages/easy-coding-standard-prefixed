 ...
 */
class TraceableAdapter implements \_PhpScoper08fb1f8a2f44\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    protected $pool;
    private $calls = [];
    public function __construct(\_PhpScoper08fb1f8a2f44\Symfony\Component\Cache\Adapter\AdapterInterface $pool)
    {
        $this->pool = $pool;
    }
    /**
    ...
    {
        $this->calls[] = $event = new \_PhpScoper08fb1f8a2f44\Symfony\Component\Cache\Adapter\TraceableAdapterEvent();
        $event->name = $name;
