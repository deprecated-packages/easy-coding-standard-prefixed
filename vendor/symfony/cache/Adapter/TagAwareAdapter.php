...
use _PhpScoper653866602a9e\Psr\Cache\InvalidArgumentException;
 ...
 */
class TagAwareAdapter implements \_PhpScoper653866602a9e\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, TagAwareCacheInterface, PruneableInterface, ResettableInterface, LoggerAwareInterface
{
    ...
    public function __construct(\_PhpScoper653866602a9e\Symfony\Component\Cache\Adapter\AdapterInterface $itemsPool, \_PhpScoper653866602a9e\Symfony\Component\Cache\Adapter\AdapterInterface $tagsPool = null, float $knownTagVersionsTtl = 0.15)
    {
        $this->pool = $itemsPool;
        ...
        $this->invalidateTags = \Closure::bind(static function (\_PhpScoper653866602a9e\Symfony\Component\Cache\Adapter\AdapterInterface $tagsAdapter, array $tags) {
            foreach ($tags as $v) {
                $v->expiry = 0;
