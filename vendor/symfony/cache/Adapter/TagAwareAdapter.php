...
use _PhpScoper96c81c3c1716\Psr\Cache\InvalidArgumentException;
 ...
 */
class TagAwareAdapter implements \_PhpScoper96c81c3c1716\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, TagAwareCacheInterface, PruneableInterface, ResettableInterface
{
    ...
    public function __construct(\_PhpScoper96c81c3c1716\Symfony\Component\Cache\Adapter\AdapterInterface $itemsPool, \_PhpScoper96c81c3c1716\Symfony\Component\Cache\Adapter\AdapterInterface $tagsPool = null, float $knownTagVersionsTtl = 0.15)
    {
        $this->pool = $itemsPool;
        ...
        $this->invalidateTags = \Closure::bind(static function (\_PhpScoper96c81c3c1716\Symfony\Component\Cache\Adapter\AdapterInterface $tagsAdapter, array $tags) {
            foreach ($tags as $v) {
                $v->expiry = 0;
