 ...
 */
class TagAwareAdapter implements \_PhpScoper78e1a27e740b\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, TagAwareCacheInterface, PruneableInterface, ResettableInterface
{
    ...
    public function __construct(\_PhpScoper78e1a27e740b\Symfony\Component\Cache\Adapter\AdapterInterface $itemsPool, \_PhpScoper78e1a27e740b\Symfony\Component\Cache\Adapter\AdapterInterface $tagsPool = null, float $knownTagVersionsTtl = 0.15)
    {
        $this->pool = $itemsPool;
        ...
        $this->invalidateTags = \Closure::bind(static function (\_PhpScoper78e1a27e740b\Symfony\Component\Cache\Adapter\AdapterInterface $tagsAdapter, array $tags) {
            foreach ($tags as $v) {
                $v->expiry = 0;
