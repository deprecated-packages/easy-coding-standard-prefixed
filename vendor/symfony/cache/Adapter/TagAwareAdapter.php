...
use _PhpScoperc2b2a9bb0e13\Psr\Cache\InvalidArgumentException;
 ...
 */
class TagAwareAdapter implements \_PhpScoperc2b2a9bb0e13\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, TagAwareCacheInterface, PruneableInterface, ResettableInterface, LoggerAwareInterface
{
    ...
    public function __construct(\_PhpScoperc2b2a9bb0e13\Symfony\Component\Cache\Adapter\AdapterInterface $itemsPool, \_PhpScoperc2b2a9bb0e13\Symfony\Component\Cache\Adapter\AdapterInterface $tagsPool = null, float $knownTagVersionsTtl = 0.15)
    {
        $this->pool = $itemsPool;
        ...
        $this->invalidateTags = \Closure::bind(static function (\_PhpScoperc2b2a9bb0e13\Symfony\Component\Cache\Adapter\AdapterInterface $tagsAdapter, array $tags) {
            foreach ($tags as $v) {
                $v->expiry = 0;
