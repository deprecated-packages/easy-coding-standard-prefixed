...
use _PhpScoper8a8080b03ed6\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
 ...
 */
class PhpFilesAdapter extends \_PhpScoper8a8080b03ed6\Symfony\Component\Cache\Adapter\AbstractAdapter implements PruneableInterface
{
    ...
    protected function doFetch(array $ids)
    {
        ...
        foreach ($ids as $id) {
            if (null === ($value = $this->values[$id] ?? null)) {
                ...
                $values[$id] = $value;
            } elseif (!$value instanceof \_PhpScoper8a8080b03ed6\Symfony\Component\Cache\Adapter\LazyValue) {
                $values[$id] = $value();
            ...
            foreach ($missingIds as $k => $id) {
                try {
                    ...
                    if (isset(self::$valuesCache[$file])) {
                        ...
                        $this->values[$id] = new \_PhpScoper8a8080b03ed6\Symfony\Component\Cache\Adapter\LazyValue($file);
                    }
                    if ($now >= $expiresAt) {
    ...
    protected function doHave(string $id)
    {
        ...
        try {
            ...
            if (isset(self::$valuesCache[$file])) {
                ...
                $value = new \_PhpScoper8a8080b03ed6\Symfony\Component\Cache\Adapter\LazyValue($file);
            }
        } catch (\ErrorException $e) {
            return \false;
        } finally {
