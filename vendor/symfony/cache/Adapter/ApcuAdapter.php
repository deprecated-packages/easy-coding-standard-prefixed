 ...
 */
class ApcuAdapter extends \_PhpScoper326af2119eba\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    /**
    ...
    public function __construct(string $namespace = '', int $defaultLifetime = 0, string $version = null)
    {
        if (!static::isSupported()) {
            throw new \_PhpScoper326af2119eba\Symfony\Component\Cache\Exception\CacheException('APCu is not enabled.');
        }
        if ('cli' === \PHP_SAPI) {
        ...
        if (null !== $version) {
            \_PhpScoper326af2119eba\Symfony\Component\Cache\CacheItem::validateKey($version);
