...
use _PhpScoper6b644dbe715d\Symfony\Component\Cache\Traits\FilesystemTrait;
/**
 ...
 */
class FilesystemTagAwareAdapter extends \_PhpScoper6b644dbe715d\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter implements \_PhpScoper6b644dbe715d\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait {
    ...
    public function __construct(string $namespace = '', int $defaultLifetime = 0, string $directory = null, \_PhpScoper6b644dbe715d\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        $this->marshaller = new \_PhpScoper6b644dbe715d\Symfony\Component\Cache\Marshaller\TagAwareMarshaller($marshaller);
