 ...
 */
class FilesystemTagAwareAdapter extends \_PhpScoper528afa732cbd\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter implements \_PhpScoper528afa732cbd\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait {
    ...
    {
        $this->marshaller = new \_PhpScoper528afa732cbd\Symfony\Component\Cache\Marshaller\TagAwareMarshaller($marshaller);
