 ...
 */
class FilesystemTagAwareAdapter extends \_PhpScoperb6d4bd368bd9\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter implements \_PhpScoperb6d4bd368bd9\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait {
    ...
    {
        $this->marshaller = new \_PhpScoperb6d4bd368bd9\Symfony\Component\Cache\Marshaller\TagAwareMarshaller($marshaller);
