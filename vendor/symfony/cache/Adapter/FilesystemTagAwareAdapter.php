...
use _PhpScoperd8048db577a9\Symfony\Component\Cache\Traits\FilesystemTrait;
/**
 ...
 */
class FilesystemTagAwareAdapter extends \_PhpScoperd8048db577a9\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter implements \_PhpScoperd8048db577a9\Symfony\Component\Cache\PruneableInterface
{
    use FilesystemTrait {
    ...
    public function __construct(string $namespace = '', int $defaultLifetime = 0, string $directory = null, \_PhpScoperd8048db577a9\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        $this->marshaller = new \_PhpScoperd8048db577a9\Symfony\Component\Cache\Marshaller\TagAwareMarshaller($marshaller);
