...
use _PhpScoper833c56a97273\Symfony\Contracts\Cache\TagAwareCacheInterface;
/**
 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \_PhpScoper833c56a97273\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \_PhpScoper833c56a97273\Symfony\Contracts\Cache\TagAwareCacheInterface, \_PhpScoper833c56a97273\Psr\Log\LoggerAwareInterface, \_PhpScoper833c56a97273\Symfony\Component\Cache\ResettableInterface
{
    ...
    {
        $this->namespace = '' === $namespace ? '' : \_PhpScoper833c56a97273\Symfony\Component\Cache\CacheItem::validateKey($namespace) . ':';
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) use($defaultLifetime) {
            ...
            $item->metadata[\_PhpScoper833c56a97273\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\_PhpScoper833c56a97273\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\_PhpScoper833c56a97273\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\_PhpScoper833c56a97273\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
    ...
    public function deleteItems(array $keys) : bool
    {
        ...
        foreach ($ids as $key => $id) {
            ...
            \_PhpScoper833c56a97273\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['key' => $key, 'exception' => $e]);
            $ok = \false;
        }
        return $ok;
    }
