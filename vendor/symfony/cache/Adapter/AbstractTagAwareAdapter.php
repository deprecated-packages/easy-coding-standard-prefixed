 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \_PhpScoperd1a5bf00e83e\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \_PhpScoperd1a5bf00e83e\Symfony\Contracts\Cache\TagAwareCacheInterface, \_PhpScoperd1a5bf00e83e\Psr\Log\LoggerAwareInterface, \_PhpScoperd1a5bf00e83e\Symfony\Component\Cache\ResettableInterface
{
    ...
    protected function __construct(string $namespace = '', int $defaultLifetime = 0)
    {
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) use($defaultLifetime) {
            ...
            $item->metadata[\_PhpScoperd1a5bf00e83e\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\_PhpScoperd1a5bf00e83e\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\_PhpScoperd1a5bf00e83e\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\_PhpScoperd1a5bf00e83e\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
