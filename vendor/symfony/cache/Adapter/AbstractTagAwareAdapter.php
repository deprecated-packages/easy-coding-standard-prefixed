...
use _PhpScoperd47a2fa2a77e\Symfony\Contracts\Cache\TagAwareCacheInterface;
/**
 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \_PhpScoperd47a2fa2a77e\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \_PhpScoperd47a2fa2a77e\Symfony\Contracts\Cache\TagAwareCacheInterface, \_PhpScoperd47a2fa2a77e\Psr\Log\LoggerAwareInterface, \_PhpScoperd47a2fa2a77e\Symfony\Component\Cache\ResettableInterface
{
    ...
    {
        $this->namespace = '' === $namespace ? '' : \_PhpScoperd47a2fa2a77e\Symfony\Component\Cache\CacheItem::validateKey($namespace) . ':';
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) {
            ...
            $item->metadata[\_PhpScoperd47a2fa2a77e\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix, $defaultLifetime) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\_PhpScoperd47a2fa2a77e\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\_PhpScoperd47a2fa2a77e\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\_PhpScoperd47a2fa2a77e\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
    ...
    public function deleteItems(array $keys) : bool
    {
        ...
        foreach ($ids as $key => $id) {
            ...
            \_PhpScoperd47a2fa2a77e\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['key' => $key, 'exception' => $e, 'cache-adapter' => \get_debug_type($this)]);
            $ok = \false;
        }
        return $ok;
    }
