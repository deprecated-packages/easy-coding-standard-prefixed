...
use _PhpScoper2a8ad010dfbd\Symfony\Contracts\Cache\TagAwareCacheInterface;
/**
 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \_PhpScoper2a8ad010dfbd\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \_PhpScoper2a8ad010dfbd\Symfony\Contracts\Cache\TagAwareCacheInterface, \_PhpScoper2a8ad010dfbd\Psr\Log\LoggerAwareInterface, \_PhpScoper2a8ad010dfbd\Symfony\Component\Cache\ResettableInterface
{
    ...
    protected function __construct(string $namespace = '', int $defaultLifetime = 0)
    {
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) use($defaultLifetime) {
            ...
            $item->metadata[\_PhpScoper2a8ad010dfbd\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\_PhpScoper2a8ad010dfbd\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\_PhpScoper2a8ad010dfbd\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\_PhpScoper2a8ad010dfbd\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
    ...
    public function deleteItems(array $keys) : bool
    {
        ...
        foreach ($ids as $key => $id) {
            ...
            \_PhpScoper2a8ad010dfbd\Symfony\Component\Cache\CacheItem::log($this->logger, $message, ['key' => $key, 'exception' => $e]);
            $ok = \false;
        }
        return $ok;
    }
