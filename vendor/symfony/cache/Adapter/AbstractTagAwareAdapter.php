 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \_PhpScopera09818bc50da\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \_PhpScopera09818bc50da\Symfony\Contracts\Cache\TagAwareCacheInterface, \_PhpScopera09818bc50da\Psr\Log\LoggerAwareInterface, \_PhpScopera09818bc50da\Symfony\Component\Cache\ResettableInterface
{
    ...
    {
        $this->namespace = '' === $namespace ? '' : \_PhpScopera09818bc50da\Symfony\Component\Cache\CacheItem::validateKey($namespace) . ':';
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $value, $isHit) use($defaultLifetime) {
            ...
            $item->metadata[\_PhpScopera09818bc50da\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        $this->mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds) use($getId, $tagPrefix) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\_PhpScopera09818bc50da\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\_PhpScopera09818bc50da\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\_PhpScopera09818bc50da\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
