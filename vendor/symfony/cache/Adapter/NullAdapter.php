 ...
 */
class NullAdapter implements \_PhpScoperbcc0395698f8\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoperbcc0395698f8\Symfony\Contracts\Cache\CacheInterface
{
    ...
    public function __construct()
    {
        $this->createCacheItem = \Closure::bind(function ($key) {
            ...
            $item->isHit = \false;
            return $item;
        }, $this, \_PhpScoperbcc0395698f8\Symfony\Component\Cache\CacheItem::class);
    }
    /**
     * {@inheritdoc}
     */
