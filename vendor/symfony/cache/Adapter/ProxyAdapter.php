 ...
 */
class ProxyAdapter implements \_PhpScoperff1e514762b4\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoperff1e514762b4\Symfony\Component\Cache\Adapter\AdapterInterface) {
