 ...
 */
class ProxyAdapter implements \_PhpScopercae9e6ab5cea\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScopercae9e6ab5cea\Symfony\Component\Cache\Adapter\AdapterInterface) {
