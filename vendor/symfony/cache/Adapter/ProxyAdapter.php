 ...
 */
class ProxyAdapter implements \_PhpScoper3c4e863e8a34\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper3c4e863e8a34\Symfony\Component\Cache\Adapter\AdapterInterface) {
