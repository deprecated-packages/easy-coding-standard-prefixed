 ...
 */
class ProxyAdapter implements \_PhpScoper1ddca3f92d7d\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper1ddca3f92d7d\Symfony\Component\Cache\Adapter\AdapterInterface) {
