 ...
 */
class ProxyAdapter implements \_PhpScoper6d453419d16a\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper6d453419d16a\Symfony\Component\Cache\Adapter\AdapterInterface) {
