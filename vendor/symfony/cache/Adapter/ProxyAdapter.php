 ...
 */
class ProxyAdapter implements \_PhpScopere7e518ee6a5b\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScopere7e518ee6a5b\Symfony\Component\Cache\Adapter\AdapterInterface) {
