 ...
 */
class ProxyAdapter implements \_PhpScoper08fb1f8a2f44\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper08fb1f8a2f44\Symfony\Component\Cache\Adapter\AdapterInterface) {
