 ...
 */
class ProxyAdapter implements \_PhpScoper5f836821822a\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper5f836821822a\Symfony\Component\Cache\Adapter\AdapterInterface) {
