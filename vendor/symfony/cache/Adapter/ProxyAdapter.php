 ...
 */
class ProxyAdapter implements \_PhpScoper2dcc760f8ff8\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper2dcc760f8ff8\Symfony\Component\Cache\Adapter\AdapterInterface) {
