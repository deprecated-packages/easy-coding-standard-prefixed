 ...
 */
class ProxyAdapter implements \_PhpScoper45e1bde0f567\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper45e1bde0f567\Symfony\Component\Cache\Adapter\AdapterInterface) {
