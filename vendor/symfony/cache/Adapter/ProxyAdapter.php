...
use _PhpScoperfab1bfb7ec99\Symfony\Component\Cache\PruneableInterface;
 ...
 */
class ProxyAdapter implements \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoperfab1bfb7ec99\Symfony\Contracts\Cache\CacheInterface, \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\PruneableInterface, \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\ResettableInterface
{
    use ProxyTrait;
    use ContractsTrait;
    private $namespace;
    ...
    private $poolHash;
    public function __construct(\_PhpScoperfab1bfb7ec99\Psr\Cache\CacheItemPoolInterface $pool, string $namespace = '', int $defaultLifetime = 0)
    {
        $this->pool = $pool;
        $this->poolHash = $poolHash = \spl_object_hash($pool);
        $this->namespace = '' === $namespace ? '' : \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\CacheItem::validateKey($namespace);
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $innerItem) use($defaultLifetime, $poolHash) {
            ...
            } elseif ($innerItem instanceof \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\CacheItem) {
        ...
        $this->setInnerItem = \Closure::bind(
             ...
             */
            static function (\_PhpScoperfab1bfb7ec99\Psr\Cache\CacheItemInterface $innerItem, array $item) {
                // Tags are stored separately, no need to account for them when considering this item's newly set metadata
                if (isset(($metadata = $item["\0*\0newMetadata"])[\_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
            ...
            null,
            \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\CacheItem::class
        );
    }
    /**
     * {@inheritdoc}
    ...
    {
        if (!$this->pool instanceof \_PhpScoperfab1bfb7ec99\Symfony\Contracts\Cache\CacheInterface) {
    ...
    private function doSave(\_PhpScoperfab1bfb7ec99\Psr\Cache\CacheItemInterface $item, string $method)
    {
        if (!$item instanceof \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\CacheItem) {
            return \false;
        }
        $item = (array) $item;
        ...
        } elseif ($this->pool instanceof \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\Adapter\AdapterInterface) {
    ...
    {
        \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\CacheItem::validateKey($key);
