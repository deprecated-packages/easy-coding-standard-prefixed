 ...
 */
class ProxyAdapter implements \_PhpScoper0c575b5c37d7\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper0c575b5c37d7\Symfony\Component\Cache\Adapter\AdapterInterface) {
