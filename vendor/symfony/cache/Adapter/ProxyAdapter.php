 ...
 */
class ProxyAdapter implements \_PhpScoper96c81c3c1716\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper96c81c3c1716\Symfony\Component\Cache\Adapter\AdapterInterface) {
