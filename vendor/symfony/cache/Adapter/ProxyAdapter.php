 ...
 */
class ProxyAdapter implements \_PhpScopera09818bc50da\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScopera09818bc50da\Symfony\Contracts\Cache\CacheInterface, \_PhpScopera09818bc50da\Symfony\Component\Cache\PruneableInterface, \_PhpScopera09818bc50da\Symfony\Component\Cache\ResettableInterface
{
    use ProxyTrait;
    use ContractsTrait;
    private $namespace;
    ...
    private $poolHash;
    public function __construct(\_PhpScopera09818bc50da\Psr\Cache\CacheItemPoolInterface $pool, string $namespace = '', int $defaultLifetime = 0)
    {
        $this->pool = $pool;
        ...
        $this->createCacheItem = \Closure::bind(static function ($key, $innerItem) use($defaultLifetime, $poolHash) {
            ...
            } elseif ($innerItem instanceof \_PhpScopera09818bc50da\Symfony\Component\Cache\CacheItem) {
        ...
        $this->setInnerItem = \Closure::bind(
             ...
             */
            static function (\_PhpScopera09818bc50da\Psr\Cache\CacheItemInterface $innerItem, array $item) {
                // Tags are stored separately, no need to account for them when considering this item's newly set metadata
                if (isset(($metadata = $item["\0*\0newMetadata"])[\_PhpScopera09818bc50da\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
            ...
            null,
            \_PhpScopera09818bc50da\Symfony\Component\Cache\CacheItem::class
        );
    }
    /**
     * {@inheritdoc}
    ...
    {
        if (!$this->pool instanceof \_PhpScopera09818bc50da\Symfony\Contracts\Cache\CacheInterface) {
    ...
    private function doSave(\_PhpScopera09818bc50da\Psr\Cache\CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScopera09818bc50da\Symfony\Component\Cache\Adapter\AdapterInterface) {
