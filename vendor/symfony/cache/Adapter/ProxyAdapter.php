 ...
 */
class ProxyAdapter implements \_PhpScopera48d5dbb002d\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScopera48d5dbb002d\Symfony\Component\Cache\Adapter\AdapterInterface) {
