 ...
 */
class ProxyAdapter implements \_PhpScoperc5e9eb67638f\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoperc5e9eb67638f\Symfony\Component\Cache\Adapter\AdapterInterface) {
