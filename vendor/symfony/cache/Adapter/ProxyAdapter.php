 ...
 */
class ProxyAdapter implements \_PhpScoper53db80252f28\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper53db80252f28\Symfony\Component\Cache\Adapter\AdapterInterface) {
