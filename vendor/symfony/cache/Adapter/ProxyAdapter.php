 ...
 */
class ProxyAdapter implements \_PhpScopera9d6a31d814c\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScopera9d6a31d814c\Symfony\Component\Cache\Adapter\AdapterInterface) {
