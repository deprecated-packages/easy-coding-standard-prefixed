 ...
 */
class ProxyAdapter implements \_PhpScoper917c99b6aa4c\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $namespace;
    ...
    private function doSave(CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \_PhpScoper917c99b6aa4c\Symfony\Component\Cache\Adapter\AdapterInterface) {
