...
use _PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Traits\PhpArrayTrait;
 ...
 */
class PhpArrayAdapter implements \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoperfd70a7e8e84f\Symfony\Contracts\Cache\CacheInterface, \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\PruneableInterface, \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    use ContractsTrait;
     ...
     */
    public function __construct(string $file, \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoperfd70a7e8e84f\Psr\Cache\CacheItemPoolInterface $fallbackPool)
    {
        // Shared memory is available in PHP 7.0+ with OPCache enabled
        if (\filter_var(\ini_get('opcache.enable'), \FILTER_VALIDATE_BOOLEAN)) {
            if (!$fallbackPool instanceof \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Adapter\AdapterInterface) {
                $fallbackPool = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
            }
