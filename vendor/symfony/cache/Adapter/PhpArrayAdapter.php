...
use _PhpScopercae9e6ab5cea\Symfony\Component\VarExporter\VarExporter;
 ...
 */
class PhpArrayAdapter implements \_PhpScopercae9e6ab5cea\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $file;
     ...
     */
    public function __construct(string $file, \_PhpScopercae9e6ab5cea\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
    ...
    {
        if (!$fallbackPool instanceof \_PhpScopercae9e6ab5cea\Symfony\Component\Cache\Adapter\AdapterInterface) {
            $fallbackPool = new \_PhpScopercae9e6ab5cea\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
        }
    ...
    public function clear(string $prefix = '')
    {
        ...
        if ($this->pool instanceof \_PhpScopercae9e6ab5cea\Symfony\Component\Cache\Adapter\AdapterInterface) {
