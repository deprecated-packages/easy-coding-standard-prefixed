...
use _PhpScoper2dcc760f8ff8\Psr\Cache\CacheItemInterface;
...
use _PhpScoper2dcc760f8ff8\Symfony\Component\VarExporter\VarExporter;
 ...
 */
class PhpArrayAdapter implements \_PhpScoper2dcc760f8ff8\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $file;
     ...
     */
    public function __construct(string $file, \_PhpScoper2dcc760f8ff8\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
    ...
    {
        if (!$fallbackPool instanceof \_PhpScoper2dcc760f8ff8\Symfony\Component\Cache\Adapter\AdapterInterface) {
            $fallbackPool = new \_PhpScoper2dcc760f8ff8\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
        }
    ...
    public function clear(string $prefix = '')
    {
        ...
        if ($this->pool instanceof \_PhpScoper2dcc760f8ff8\Symfony\Component\Cache\Adapter\AdapterInterface) {
