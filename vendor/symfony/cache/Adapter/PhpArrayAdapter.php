...
use _PhpScoperbaf90856897c\Symfony\Component\Cache\Traits\PhpArrayTrait;
 ...
 */
class PhpArrayAdapter implements \_PhpScoperbaf90856897c\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoperbaf90856897c\Symfony\Contracts\Cache\CacheInterface, \_PhpScoperbaf90856897c\Symfony\Component\Cache\PruneableInterface, \_PhpScoperbaf90856897c\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    use ContractsTrait;
     ...
     */
    public function __construct(string $file, \_PhpScoperbaf90856897c\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoperbaf90856897c\Psr\Cache\CacheItemPoolInterface $fallbackPool)
    {
        // Shared memory is available in PHP 7.0+ with OPCache enabled
        if (\filter_var(\ini_get('opcache.enable'), \FILTER_VALIDATE_BOOLEAN)) {
            if (!$fallbackPool instanceof \_PhpScoperbaf90856897c\Symfony\Component\Cache\Adapter\AdapterInterface) {
                $fallbackPool = new \_PhpScoperbaf90856897c\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
            }
