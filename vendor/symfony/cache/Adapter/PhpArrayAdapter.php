...
use _PhpScoperad68e34a80c5\Symfony\Component\Cache\Traits\PhpArrayTrait;
 ...
 */
class PhpArrayAdapter implements \_PhpScoperad68e34a80c5\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoperad68e34a80c5\Symfony\Contracts\Cache\CacheInterface, \_PhpScoperad68e34a80c5\Symfony\Component\Cache\PruneableInterface, \_PhpScoperad68e34a80c5\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    use ContractsTrait;
     ...
     */
    public function __construct(string $file, \_PhpScoperad68e34a80c5\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoperad68e34a80c5\Psr\Cache\CacheItemPoolInterface $fallbackPool)
    {
        // Shared memory is available in PHP 7.0+ with OPCache enabled
        if (\filter_var(\ini_get('opcache.enable'), \FILTER_VALIDATE_BOOLEAN)) {
            if (!$fallbackPool instanceof \_PhpScoperad68e34a80c5\Symfony\Component\Cache\Adapter\AdapterInterface) {
                $fallbackPool = new \_PhpScoperad68e34a80c5\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
            }
