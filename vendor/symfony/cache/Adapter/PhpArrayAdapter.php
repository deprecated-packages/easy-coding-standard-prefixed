...
use _PhpScopere72a8aaba560\Psr\Cache\CacheItemInterface;
...
use _PhpScopere72a8aaba560\Symfony\Component\VarExporter\VarExporter;
 ...
 */
class PhpArrayAdapter implements \_PhpScopere72a8aaba560\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $file;
     ...
     */
    public function __construct(string $file, \_PhpScopere72a8aaba560\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
    ...
    {
        if (!$fallbackPool instanceof \_PhpScopere72a8aaba560\Symfony\Component\Cache\Adapter\AdapterInterface) {
            $fallbackPool = new \_PhpScopere72a8aaba560\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
        }
    ...
    public function clear(string $prefix = '')
    {
        ...
        if ($this->pool instanceof \_PhpScopere72a8aaba560\Symfony\Component\Cache\Adapter\AdapterInterface) {
