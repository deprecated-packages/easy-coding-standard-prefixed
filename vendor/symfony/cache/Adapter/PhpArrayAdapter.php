...
use _PhpScoperbd5fb781fe24\Symfony\Component\Cache\Traits\PhpArrayTrait;
 ...
 */
class PhpArrayAdapter implements \_PhpScoperbd5fb781fe24\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoperbd5fb781fe24\Symfony\Contracts\Cache\CacheInterface, \_PhpScoperbd5fb781fe24\Symfony\Component\Cache\PruneableInterface, \_PhpScoperbd5fb781fe24\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    use ContractsTrait;
     ...
     */
    public function __construct(string $file, \_PhpScoperbd5fb781fe24\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoperbd5fb781fe24\Psr\Cache\CacheItemPoolInterface $fallbackPool)
    {
        // Shared memory is available in PHP 7.0+ with OPCache enabled
        if (\filter_var(\ini_get('opcache.enable'), \FILTER_VALIDATE_BOOLEAN)) {
            if (!$fallbackPool instanceof \_PhpScoperbd5fb781fe24\Symfony\Component\Cache\Adapter\AdapterInterface) {
                $fallbackPool = new \_PhpScoperbd5fb781fe24\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
            }
