...
use _PhpScoperfab1bfb7ec99\Symfony\Component\Cache\Traits\PhpArrayTrait;
 ...
 */
class PhpArrayAdapter implements \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoperfab1bfb7ec99\Symfony\Contracts\Cache\CacheInterface, \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\PruneableInterface, \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    use ContractsTrait;
     ...
     */
    public function __construct(string $file, \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoperfab1bfb7ec99\Psr\Cache\CacheItemPoolInterface $fallbackPool)
    {
        // Shared memory is available in PHP 7.0+ with OPCache enabled
        if (\filter_var(\ini_get('opcache.enable'), \FILTER_VALIDATE_BOOLEAN)) {
            if (!$fallbackPool instanceof \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\Adapter\AdapterInterface) {
                $fallbackPool = new \_PhpScoperfab1bfb7ec99\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
            }
