...
use _PhpScoper87c77ad5700d\Symfony\Component\Cache\Traits\PhpArrayTrait;
 ...
 */
class PhpArrayAdapter implements \_PhpScoper87c77ad5700d\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoper87c77ad5700d\Symfony\Contracts\Cache\CacheInterface, \_PhpScoper87c77ad5700d\Symfony\Component\Cache\PruneableInterface, \_PhpScoper87c77ad5700d\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    use ContractsTrait;
     ...
     */
    public function __construct(string $file, \_PhpScoper87c77ad5700d\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoper87c77ad5700d\Psr\Cache\CacheItemPoolInterface $fallbackPool)
    {
        // Shared memory is available in PHP 7.0+ with OPCache enabled
        if (\filter_var(\ini_get('opcache.enable'), \FILTER_VALIDATE_BOOLEAN)) {
            if (!$fallbackPool instanceof \_PhpScoper87c77ad5700d\Symfony\Component\Cache\Adapter\AdapterInterface) {
                $fallbackPool = new \_PhpScoper87c77ad5700d\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
            }
