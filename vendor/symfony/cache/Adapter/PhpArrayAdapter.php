...
use _PhpScopera09818bc50da\Symfony\Component\Cache\Traits\PhpArrayTrait;
 ...
 */
class PhpArrayAdapter implements \_PhpScopera09818bc50da\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScopera09818bc50da\Symfony\Contracts\Cache\CacheInterface, \_PhpScopera09818bc50da\Symfony\Component\Cache\PruneableInterface, \_PhpScopera09818bc50da\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    use ContractsTrait;
     ...
     */
    public function __construct(string $file, \_PhpScopera09818bc50da\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScopera09818bc50da\Psr\Cache\CacheItemPoolInterface $fallbackPool)
    {
        // Shared memory is available in PHP 7.0+ with OPCache enabled
        if (\filter_var(\ini_get('opcache.enable'), \FILTER_VALIDATE_BOOLEAN)) {
            if (!$fallbackPool instanceof \_PhpScopera09818bc50da\Symfony\Component\Cache\Adapter\AdapterInterface) {
                $fallbackPool = new \_PhpScopera09818bc50da\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
            }
