...
use _PhpScoper5ca2d8bcb02c\Symfony\Component\Cache\Traits\PhpArrayTrait;
 ...
 */
class PhpArrayAdapter implements \_PhpScoper5ca2d8bcb02c\Symfony\Component\Cache\Adapter\AdapterInterface, \_PhpScoper5ca2d8bcb02c\Symfony\Contracts\Cache\CacheInterface, \_PhpScoper5ca2d8bcb02c\Symfony\Component\Cache\PruneableInterface, \_PhpScoper5ca2d8bcb02c\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    use ContractsTrait;
     ...
     */
    public function __construct(string $file, \_PhpScoper5ca2d8bcb02c\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \_PhpScoper5ca2d8bcb02c\Psr\Cache\CacheItemPoolInterface $fallbackPool)
    {
        // Shared memory is available in PHP 7.0+ with OPCache enabled
        if (\filter_var(\ini_get('opcache.enable'), \FILTER_VALIDATE_BOOLEAN)) {
            if (!$fallbackPool instanceof \_PhpScoper5ca2d8bcb02c\Symfony\Component\Cache\Adapter\AdapterInterface) {
                $fallbackPool = new \_PhpScoper5ca2d8bcb02c\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
            }
