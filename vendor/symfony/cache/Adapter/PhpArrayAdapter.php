...
use _PhpScopera9d6a31d814c\Psr\Cache\CacheItemInterface;
...
use _PhpScopera9d6a31d814c\Symfony\Component\Cache\Traits\ProxyTrait;
use _PhpScopera9d6a31d814c\Symfony\Component\VarExporter\VarExporter;
 ...
 */
class PhpArrayAdapter implements \_PhpScopera9d6a31d814c\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $file;
     ...
     */
    public function __construct(string $file, \_PhpScopera9d6a31d814c\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
    ...
    {
        if (!$fallbackPool instanceof \_PhpScopera9d6a31d814c\Symfony\Component\Cache\Adapter\AdapterInterface) {
            $fallbackPool = new \_PhpScopera9d6a31d814c\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
        }
    ...
    public function clear(string $prefix = '')
    {
        ...
        if ($this->pool instanceof \_PhpScopera9d6a31d814c\Symfony\Component\Cache\Adapter\AdapterInterface) {
