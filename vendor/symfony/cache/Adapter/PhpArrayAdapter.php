...
use _PhpScopereb9508917a55\Psr\Cache\CacheItemInterface;
...
use _PhpScopereb9508917a55\Symfony\Component\VarExporter\VarExporter;
 ...
 */
class PhpArrayAdapter implements \_PhpScopereb9508917a55\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, PruneableInterface, ResettableInterface
{
    use ContractsTrait;
    use ProxyTrait;
    private $file;
     ...
     */
    public function __construct(string $file, \_PhpScopereb9508917a55\Symfony\Component\Cache\Adapter\AdapterInterface $fallbackPool)
    {
        $this->file = $file;
    ...
    {
        if (!$fallbackPool instanceof \_PhpScopereb9508917a55\Symfony\Component\Cache\Adapter\AdapterInterface) {
            $fallbackPool = new \_PhpScopereb9508917a55\Symfony\Component\Cache\Adapter\ProxyAdapter($fallbackPool);
        }
    ...
    public function clear(string $prefix = '')
    {
        ...
        if ($this->pool instanceof \_PhpScopereb9508917a55\Symfony\Component\Cache\Adapter\AdapterInterface) {
