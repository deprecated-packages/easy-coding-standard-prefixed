 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper653866602a9e\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper653866602a9e\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper653866602a9e\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper653866602a9e\CouchbaseCluster($connectionString);
