 ...
 */
class CouchbaseBucketAdapter extends \_PhpScopere050faf861e6\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScopere050faf861e6\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, \_PhpScopere050faf861e6\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!static::isSupported()) {
            throw new \_PhpScopere050faf861e6\Symfony\Component\Cache\Exception\CacheException('Couchbase >= 2.6.0 < 3.0.0 is required.');
        }
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScopere050faf861e6\CouchbaseBucket
    {
        ...
        try {
            ...
            foreach ($servers as $dsn) {
                if (0 !== \strpos($dsn, 'couchbase:')) {
                    throw new \_PhpScopere050faf861e6\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('Invalid Couchbase DSN: "%s" does not start with "couchbase:".', $dsn));
                }
            ...
            $client = new \_PhpScopere050faf861e6\CouchbaseCluster($connectionString);
