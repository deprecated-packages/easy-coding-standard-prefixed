 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper6ffa0951a2e9\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper6ffa0951a2e9\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper6ffa0951a2e9\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper6ffa0951a2e9\CouchbaseCluster($connectionString);
