 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper91c59a2f52e1\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper91c59a2f52e1\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper91c59a2f52e1\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper91c59a2f52e1\CouchbaseCluster($connectionString);
