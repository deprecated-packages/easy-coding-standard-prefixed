 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoperb5b1090524db\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoperb5b1090524db\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoperb5b1090524db\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoperb5b1090524db\CouchbaseCluster($connectionString);
