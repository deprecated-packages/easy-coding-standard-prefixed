 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper130a9a1cd4a2\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper130a9a1cd4a2\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper130a9a1cd4a2\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper130a9a1cd4a2\CouchbaseCluster($connectionString);
