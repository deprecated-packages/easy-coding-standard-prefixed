 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper7239e3eaf11a\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper7239e3eaf11a\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper7239e3eaf11a\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper7239e3eaf11a\CouchbaseCluster($connectionString);
