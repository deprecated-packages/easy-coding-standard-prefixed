 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoperff1e514762b4\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoperff1e514762b4\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoperff1e514762b4\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoperff1e514762b4\CouchbaseCluster($connectionString);
