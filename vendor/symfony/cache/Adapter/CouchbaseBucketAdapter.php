 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper4fedb9aa1e5f\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper4fedb9aa1e5f\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper4fedb9aa1e5f\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper4fedb9aa1e5f\CouchbaseCluster($connectionString);
