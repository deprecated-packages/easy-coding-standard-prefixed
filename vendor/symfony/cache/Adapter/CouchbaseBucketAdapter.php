 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper9385100df341\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper9385100df341\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper9385100df341\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper9385100df341\CouchbaseCluster($connectionString);
