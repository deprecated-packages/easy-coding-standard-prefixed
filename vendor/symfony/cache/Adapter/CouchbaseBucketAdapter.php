 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper78e1a27e740b\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper78e1a27e740b\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper78e1a27e740b\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper78e1a27e740b\CouchbaseCluster($connectionString);
