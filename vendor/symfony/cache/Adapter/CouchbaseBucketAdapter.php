 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoperc7096eb2567d\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoperc7096eb2567d\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, \_PhpScoperc7096eb2567d\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!static::isSupported()) {
            throw new \_PhpScoperc7096eb2567d\Symfony\Component\Cache\Exception\CacheException('Couchbase >= 2.6.0 < 3.0.0 is required.');
        }
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoperc7096eb2567d\CouchbaseBucket
    {
        ...
        try {
            ...
            foreach ($servers as $dsn) {
                if (0 !== \strpos($dsn, 'couchbase:')) {
                    throw new \_PhpScoperc7096eb2567d\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('Invalid Couchbase DSN: "%s" does not start with "couchbase:".', $dsn));
                }
            ...
            $client = new \_PhpScoperc7096eb2567d\CouchbaseCluster($connectionString);
