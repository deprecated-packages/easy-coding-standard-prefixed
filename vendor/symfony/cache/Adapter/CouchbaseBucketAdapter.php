 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper8a8080b03ed6\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper8a8080b03ed6\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper8a8080b03ed6\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper8a8080b03ed6\CouchbaseCluster($connectionString);
