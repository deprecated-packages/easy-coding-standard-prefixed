 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoperd2a667bd5a98\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoperd2a667bd5a98\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoperd2a667bd5a98\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoperd2a667bd5a98\CouchbaseCluster($connectionString);
