 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper2dc059b3a969\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper2dc059b3a969\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper2dc059b3a969\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper2dc059b3a969\CouchbaseCluster($connectionString);
