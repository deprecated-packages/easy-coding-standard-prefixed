 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper1ddca3f92d7d\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper1ddca3f92d7d\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper1ddca3f92d7d\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper1ddca3f92d7d\CouchbaseCluster($connectionString);
