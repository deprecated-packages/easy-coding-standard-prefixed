 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper53db80252f28\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper53db80252f28\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper53db80252f28\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper53db80252f28\CouchbaseCluster($connectionString);
