 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper0752b31150a1\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper0752b31150a1\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper0752b31150a1\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper0752b31150a1\CouchbaseCluster($connectionString);
