 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper2d11f18408ea\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper2d11f18408ea\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper2d11f18408ea\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper2d11f18408ea\CouchbaseCluster($connectionString);
