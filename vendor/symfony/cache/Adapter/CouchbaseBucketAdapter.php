 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper917c99b6aa4c\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper917c99b6aa4c\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper917c99b6aa4c\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper917c99b6aa4c\CouchbaseCluster($connectionString);
