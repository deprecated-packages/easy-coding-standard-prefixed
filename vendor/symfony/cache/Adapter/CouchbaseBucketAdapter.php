 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoper0c575b5c37d7\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoper0c575b5c37d7\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoper0c575b5c37d7\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoper0c575b5c37d7\CouchbaseCluster($connectionString);
