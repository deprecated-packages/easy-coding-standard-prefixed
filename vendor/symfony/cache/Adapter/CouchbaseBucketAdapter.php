 ...
 */
class CouchbaseBucketAdapter extends \_PhpScopereb9508917a55\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScopereb9508917a55\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScopereb9508917a55\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScopereb9508917a55\CouchbaseCluster($connectionString);
