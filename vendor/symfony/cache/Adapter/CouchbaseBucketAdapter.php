 ...
 */
class CouchbaseBucketAdapter extends \_PhpScoperef2f7aa3581e\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\_PhpScoperef2f7aa3581e\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \_PhpScoperef2f7aa3581e\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \_PhpScoperef2f7aa3581e\CouchbaseCluster($connectionString);
