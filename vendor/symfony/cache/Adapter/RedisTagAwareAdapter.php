...
use _PhpScopercae9e6ab5cea\Predis\Connection\Aggregate\PredisCluster;
...
use _PhpScopercae9e6ab5cea\Symfony\Component\Cache\Exception\LogicException;
use _PhpScopercae9e6ab5cea\Symfony\Component\Cache\Marshaller\DeflateMarshaller;
use _PhpScopercae9e6ab5cea\Symfony\Component\Cache\Marshaller\MarshallerInterface;
use _PhpScopercae9e6ab5cea\Symfony\Component\Cache\Marshaller\TagAwareMarshaller;
 ...
 */
class RedisTagAwareAdapter extends \_PhpScopercae9e6ab5cea\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter
{
    use RedisTrait;
    /**
    ...
    {
        if ($redisClient instanceof \_PhpScopercae9e6ab5cea\Predis\ClientInterface && $redisClient->getConnection() instanceof ClusterInterface && !$redisClient->getConnection() instanceof PredisCluster) {
...
EOLUA;
    ...
    {
        if (!$this->redis instanceof \_PhpScopercae9e6ab5cea\Predis\ClientInterface || !$this->redis->getConnection() instanceof PredisCluster) {
