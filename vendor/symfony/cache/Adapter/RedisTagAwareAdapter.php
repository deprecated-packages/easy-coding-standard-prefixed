...
use _PhpScoper08fb1f8a2f44\Predis\Connection\Aggregate\PredisCluster;
...
use _PhpScoper08fb1f8a2f44\Symfony\Component\Cache\Exception\LogicException;
use _PhpScoper08fb1f8a2f44\Symfony\Component\Cache\Marshaller\DeflateMarshaller;
...
use _PhpScoper08fb1f8a2f44\Symfony\Component\Cache\Traits\RedisTrait;
/**
 ...
 */
class RedisTagAwareAdapter extends \_PhpScoper08fb1f8a2f44\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter
{
    use RedisTrait;
    /**
    ...
    {
        if ($redisClient instanceof \_PhpScoper08fb1f8a2f44\Predis\ClientInterface && $redisClient->getConnection() instanceof ClusterInterface && !$redisClient->getConnection() instanceof PredisCluster) {
...
EOLUA;
    ...
    {
        if (!$this->redis instanceof \_PhpScoper08fb1f8a2f44\Predis\ClientInterface || !$this->redis->getConnection() instanceof PredisCluster) {
