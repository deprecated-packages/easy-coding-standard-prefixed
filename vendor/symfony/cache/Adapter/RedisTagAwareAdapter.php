...
use _PhpScoper0c575b5c37d7\Predis\Connection\Aggregate\PredisCluster;
...
use _PhpScoper0c575b5c37d7\Symfony\Component\Cache\Exception\LogicException;
use _PhpScoper0c575b5c37d7\Symfony\Component\Cache\Marshaller\DeflateMarshaller;
use _PhpScoper0c575b5c37d7\Symfony\Component\Cache\Marshaller\MarshallerInterface;
use _PhpScoper0c575b5c37d7\Symfony\Component\Cache\Marshaller\TagAwareMarshaller;
use _PhpScoper0c575b5c37d7\Symfony\Component\Cache\Traits\RedisTrait;
/**
 ...
 */
class RedisTagAwareAdapter extends \_PhpScoper0c575b5c37d7\Symfony\Component\Cache\Adapter\AbstractTagAwareAdapter
{
    use RedisTrait;
    /**
    ...
    {
        if ($redisClient instanceof \_PhpScoper0c575b5c37d7\Predis\ClientInterface && $redisClient->getConnection() instanceof ClusterInterface && !$redisClient->getConnection() instanceof PredisCluster) {
...
EOLUA;
    ...
    {
        if (!$this->redis instanceof \_PhpScoper0c575b5c37d7\Predis\ClientInterface || !$this->redis->getConnection() instanceof PredisCluster) {
