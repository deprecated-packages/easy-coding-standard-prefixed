 ...
 */
abstract class AbstractAdapter implements \ECSPrefix20210507\Symfony\Component\Cache\Adapter\AdapterInterface, CacheInterface, LoggerAwareInterface, ResettableInterface
{
    /**
     * @internal
     */
    ...
    public static function createSystemCache($namespace, $defaultLifetime, $version, $directory, $logger = null)
    {
        ...
        $apcu = new \ECSPrefix20210507\Symfony\Component\Cache\Adapter\ApcuAdapter($namespace, (int) $defaultLifetime / 5, $version);
        if (null !== $logger) {
    ...
    public static function createConnection($dsn, array $options = [])
    {
        ...
        if (0 === \strpos($dsn, 'memcached:')) {
            return \ECSPrefix20210507\Symfony\Component\Cache\Adapter\MemcachedAdapter::createConnection($dsn, $options);
        }
        if (0 === \strpos($dsn, 'couchbase:')) {
            return \ECSPrefix20210507\Symfony\Component\Cache\Adapter\CouchbaseBucketAdapter::createConnection($dsn, $options);
        }
