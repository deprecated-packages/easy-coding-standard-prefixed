 ...
 */
namespace _PhpScoperd232d3743ab9\Symfony\Component\Cache\Adapter;

use _PhpScoperd232d3743ab9\Doctrine\DBAL\Connection;
use _PhpScoperd232d3743ab9\Doctrine\DBAL\DBALException;
use _PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use _PhpScoperd232d3743ab9\Doctrine\DBAL\DriverManager;
use _PhpScoperd232d3743ab9\Doctrine\DBAL\Exception;
use _PhpScoperd232d3743ab9\Doctrine\DBAL\Exception\TableNotFoundException;
use _PhpScoperd232d3743ab9\Doctrine\DBAL\Schema\Schema;
...
use _PhpScoperd232d3743ab9\Symfony\Component\Cache\PruneableInterface;
class PdoAdapter extends \_PhpScoperd232d3743ab9\Symfony\Component\Cache\Adapter\AbstractAdapter implements PruneableInterface
{
    ...
    private function getConnection() : object
    {
        ...
        if (null === $this->driver) {
            if ($this->conn instanceof \PDO) {
                ...
                switch (\true) {
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\Mysqli\Driver:
                        throw new \LogicException(\sprintf('The adapter "%s" does not support the mysqli driver, use pdo_mysql instead.', static::class));
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\AbstractMySQLDriver:
                        $this->driver = 'mysql';
                        break;
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\PDOSqlite\Driver:
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\PDO\SQLite\Driver:
                        $this->driver = 'sqlite';
                        break;
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\PDOPgSql\Driver:
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\PDO\PgSQL\Driver:
                        $this->driver = 'pgsql';
                        break;
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\OCI8\Driver:
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\PDOOracle\Driver:
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\PDO\OCI\Driver:
                        $this->driver = 'oci';
                        break;
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\SQLSrv\Driver:
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\PDOSqlsrv\Driver:
                    case $driver instanceof \_PhpScoperd232d3743ab9\Doctrine\DBAL\Driver\PDO\SQLSrv\Driver:
                        $this->driver = 'sqlsrv';
                        break;
                    default:
