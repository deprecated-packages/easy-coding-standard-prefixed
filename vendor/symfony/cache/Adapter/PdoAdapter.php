...
use _PhpScopera9d6a31d814c\Doctrine\DBAL\Connection;
use _PhpScopera9d6a31d814c\Doctrine\DBAL\DBALException;
use _PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use _PhpScopera9d6a31d814c\Doctrine\DBAL\DriverManager;
use _PhpScopera9d6a31d814c\Doctrine\DBAL\Exception;
use _PhpScopera9d6a31d814c\Doctrine\DBAL\Exception\TableNotFoundException;
use _PhpScopera9d6a31d814c\Doctrine\DBAL\Schema\Schema;
...
class PdoAdapter extends \_PhpScopera9d6a31d814c\Symfony\Component\Cache\Adapter\AbstractAdapter implements PruneableInterface
{
    ...
    private function getConnection() : object
    {
        ...
        if (null === $this->driver) {
            if ($this->conn instanceof \PDO) {
                ...
                switch (\true) {
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\Mysqli\Driver:
                        throw new \LogicException(\sprintf('The adapter "%s" does not support the mysqli driver, use pdo_mysql instead.', static::class));
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\AbstractMySQLDriver:
                        $this->driver = 'mysql';
                        break;
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\PDOSqlite\Driver:
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\PDO\SQLite\Driver:
                        $this->driver = 'sqlite';
                        break;
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\PDOPgSql\Driver:
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\PDO\PgSQL\Driver:
                        $this->driver = 'pgsql';
                        break;
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\OCI8\Driver:
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\PDOOracle\Driver:
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\PDO\OCI\Driver:
                        $this->driver = 'oci';
                        break;
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\SQLSrv\Driver:
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\PDOSqlsrv\Driver:
                    case $driver instanceof \_PhpScopera9d6a31d814c\Doctrine\DBAL\Driver\PDO\SQLSrv\Driver:
                        $this->driver = 'sqlsrv';
                        break;
                    default:
