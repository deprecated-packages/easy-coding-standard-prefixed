...
use _PhpScoper5f836821822a\Doctrine\DBAL\Connection;
use _PhpScoper5f836821822a\Doctrine\DBAL\DBALException;
use _PhpScoper5f836821822a\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use _PhpScoper5f836821822a\Doctrine\DBAL\DriverManager;
use _PhpScoper5f836821822a\Doctrine\DBAL\Exception;
use _PhpScoper5f836821822a\Doctrine\DBAL\Exception\TableNotFoundException;
use _PhpScoper5f836821822a\Doctrine\DBAL\Schema\Schema;
...
class PdoAdapter extends \_PhpScoper5f836821822a\Symfony\Component\Cache\Adapter\AbstractAdapter implements PruneableInterface
{
    ...
    private function getConnection() : object
    {
        ...
        if (null === $this->driver) {
            if ($this->conn instanceof \PDO) {
                ...
                switch (\true) {
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\Mysqli\Driver:
                        throw new \LogicException(\sprintf('The adapter "%s" does not support the mysqli driver, use pdo_mysql instead.', static::class));
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\AbstractMySQLDriver:
                        $this->driver = 'mysql';
                        break;
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\PDOSqlite\Driver:
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\PDO\SQLite\Driver:
                        $this->driver = 'sqlite';
                        break;
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\PDOPgSql\Driver:
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\PDO\PgSQL\Driver:
                        $this->driver = 'pgsql';
                        break;
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\OCI8\Driver:
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\PDOOracle\Driver:
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\PDO\OCI\Driver:
                        $this->driver = 'oci';
                        break;
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\SQLSrv\Driver:
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\PDOSqlsrv\Driver:
                    case $driver instanceof \_PhpScoper5f836821822a\Doctrine\DBAL\Driver\PDO\SQLSrv\Driver:
                        $this->driver = 'sqlsrv';
                        break;
                    default:
