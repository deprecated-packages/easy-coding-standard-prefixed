...
if (\interface_exists(\_PhpScoper59da9ac954a6\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper59da9ac954a6\Psr\Cache\CacheException, \_PhpScoper59da9ac954a6\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper59da9ac954a6\Psr\Cache\CacheException
    {
    }
}
