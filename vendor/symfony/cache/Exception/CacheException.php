...
if (\interface_exists(\_PhpScoperba24099fc6fd\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperba24099fc6fd\Psr\Cache\CacheException, \_PhpScoperba24099fc6fd\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperba24099fc6fd\Psr\Cache\CacheException
    {
    }
}
