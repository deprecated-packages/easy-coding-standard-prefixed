...
if (\interface_exists(\_PhpScopercc9aec205203\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScopercc9aec205203\Psr\Cache\CacheException, \_PhpScopercc9aec205203\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScopercc9aec205203\Psr\Cache\CacheException
    {
    }
}
