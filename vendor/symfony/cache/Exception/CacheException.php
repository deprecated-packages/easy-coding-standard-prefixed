...
if (\interface_exists(\_PhpScoperaad82bb90a86\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperaad82bb90a86\Psr\Cache\CacheException, \_PhpScoperaad82bb90a86\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperaad82bb90a86\Psr\Cache\CacheException
    {
    }
}
