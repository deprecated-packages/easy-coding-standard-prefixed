...
if (\interface_exists(\_PhpScoperf3d5f0921050\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperf3d5f0921050\Psr\Cache\CacheException, \_PhpScoperf3d5f0921050\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperf3d5f0921050\Psr\Cache\CacheException
    {
    }
}
