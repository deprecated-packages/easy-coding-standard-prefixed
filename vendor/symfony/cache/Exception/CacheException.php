...
if (\interface_exists(\_PhpScoper246d3630afdd\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper246d3630afdd\Psr\Cache\CacheException, \_PhpScoper246d3630afdd\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper246d3630afdd\Psr\Cache\CacheException
    {
    }
}
