...
if (\interface_exists(\_PhpScoper81b3ff5ab9fe\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper81b3ff5ab9fe\Psr\Cache\CacheException, \_PhpScoper81b3ff5ab9fe\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper81b3ff5ab9fe\Psr\Cache\CacheException
    {
    }
}
