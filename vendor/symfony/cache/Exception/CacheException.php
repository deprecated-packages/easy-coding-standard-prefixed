...
if (\interface_exists(\_PhpScoper0270f1d35181\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper0270f1d35181\Psr\Cache\CacheException, \_PhpScoper0270f1d35181\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper0270f1d35181\Psr\Cache\CacheException
    {
    }
}
