...
if (\interface_exists(\_PhpScoperbd5fb781fe24\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperbd5fb781fe24\Psr\Cache\CacheException, \_PhpScoperbd5fb781fe24\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperbd5fb781fe24\Psr\Cache\CacheException
    {
    }
}
