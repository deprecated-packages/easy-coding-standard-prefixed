...
if (\interface_exists(\_PhpScoper4e2df00556a9\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper4e2df00556a9\Psr\Cache\CacheException, \_PhpScoper4e2df00556a9\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper4e2df00556a9\Psr\Cache\CacheException
    {
    }
}
