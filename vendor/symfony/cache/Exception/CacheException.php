...
if (\interface_exists(\_PhpScoper2a48669dad72\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper2a48669dad72\Psr\Cache\CacheException, \_PhpScoper2a48669dad72\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper2a48669dad72\Psr\Cache\CacheException
    {
    }
}
