...
if (\interface_exists(\_PhpScoper2b44cb0c30af\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper2b44cb0c30af\Psr\Cache\CacheException, \_PhpScoper2b44cb0c30af\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper2b44cb0c30af\Psr\Cache\CacheException
    {
    }
}
