...
if (\interface_exists(\_PhpScoper880bfa4d8b51\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper880bfa4d8b51\Psr\Cache\CacheException, \_PhpScoper880bfa4d8b51\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper880bfa4d8b51\Psr\Cache\CacheException
    {
    }
}
