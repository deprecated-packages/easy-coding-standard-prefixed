...
if (\interface_exists(\_PhpScoper35ec99c463ee\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper35ec99c463ee\Psr\Cache\CacheException, \_PhpScoper35ec99c463ee\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper35ec99c463ee\Psr\Cache\CacheException
    {
    }
}
