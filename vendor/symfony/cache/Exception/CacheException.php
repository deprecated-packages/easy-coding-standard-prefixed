...
if (\interface_exists(\_PhpScoper326af2119eba\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper326af2119eba\Psr\Cache\CacheException, \_PhpScoper326af2119eba\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper326af2119eba\Psr\Cache\CacheException
    {
    }
}
