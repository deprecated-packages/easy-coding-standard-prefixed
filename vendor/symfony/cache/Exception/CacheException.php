...
if (\interface_exists(\_PhpScoperfcce67077a55\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperfcce67077a55\Psr\Cache\CacheException, \_PhpScoperfcce67077a55\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperfcce67077a55\Psr\Cache\CacheException
    {
    }
}
