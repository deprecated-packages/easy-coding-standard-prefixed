...
if (\interface_exists(\_PhpScoper82aa0193482e\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper82aa0193482e\Psr\Cache\CacheException, \_PhpScoper82aa0193482e\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper82aa0193482e\Psr\Cache\CacheException
    {
    }
}
