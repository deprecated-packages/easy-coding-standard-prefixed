...
if (\interface_exists(\_PhpScoperb83706991c7f\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperb83706991c7f\Psr\Cache\CacheException, \_PhpScoperb83706991c7f\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperb83706991c7f\Psr\Cache\CacheException
    {
    }
}
