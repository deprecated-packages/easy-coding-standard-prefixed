...
if (\interface_exists(\_PhpScopera51a90153f58\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScopera51a90153f58\Psr\Cache\CacheException, \_PhpScopera51a90153f58\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScopera51a90153f58\Psr\Cache\CacheException
    {
    }
}
