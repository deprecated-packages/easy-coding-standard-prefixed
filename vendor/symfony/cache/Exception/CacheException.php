...
if (\interface_exists(\_PhpScoper8a7636b3fdaf\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper8a7636b3fdaf\Psr\Cache\CacheException, \_PhpScoper8a7636b3fdaf\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper8a7636b3fdaf\Psr\Cache\CacheException
    {
    }
}
