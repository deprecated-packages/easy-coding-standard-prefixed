...
if (\interface_exists(\_PhpScopera04bf8e97c06\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScopera04bf8e97c06\Psr\Cache\CacheException, \_PhpScopera04bf8e97c06\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScopera04bf8e97c06\Psr\Cache\CacheException
    {
    }
}
