...
if (\interface_exists(\_PhpScoper32136251d417\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper32136251d417\Psr\Cache\CacheException, \_PhpScoper32136251d417\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper32136251d417\Psr\Cache\CacheException
    {
    }
}
