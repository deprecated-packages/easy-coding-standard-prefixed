...
if (\interface_exists(\_PhpScoper02b5d1bf8fec\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper02b5d1bf8fec\Psr\Cache\CacheException, \_PhpScoper02b5d1bf8fec\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper02b5d1bf8fec\Psr\Cache\CacheException
    {
    }
}
