...
if (\interface_exists(\_PhpScoper48b5ec5b60cf\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper48b5ec5b60cf\Psr\Cache\CacheException, \_PhpScoper48b5ec5b60cf\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper48b5ec5b60cf\Psr\Cache\CacheException
    {
    }
}
