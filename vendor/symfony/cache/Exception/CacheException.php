...
if (\interface_exists(\_PhpScoperaa402dd1b1f1\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperaa402dd1b1f1\Psr\Cache\CacheException, \_PhpScoperaa402dd1b1f1\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperaa402dd1b1f1\Psr\Cache\CacheException
    {
    }
}
