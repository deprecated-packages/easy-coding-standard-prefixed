...
if (\interface_exists(\_PhpScoper971ef29294dd\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper971ef29294dd\Psr\Cache\CacheException, \_PhpScoper971ef29294dd\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper971ef29294dd\Psr\Cache\CacheException
    {
    }
}
