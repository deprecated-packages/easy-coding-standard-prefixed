...
if (\interface_exists(\_PhpScoper255a4eaff575\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper255a4eaff575\Psr\Cache\CacheException, \_PhpScoper255a4eaff575\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper255a4eaff575\Psr\Cache\CacheException
    {
    }
}
