...
if (\interface_exists(\_PhpScoper224ae0b86670\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper224ae0b86670\Psr\Cache\CacheException, \_PhpScoper224ae0b86670\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper224ae0b86670\Psr\Cache\CacheException
    {
    }
}
