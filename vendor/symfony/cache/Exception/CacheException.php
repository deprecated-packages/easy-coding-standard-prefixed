...
if (\interface_exists(\_PhpScopere050faf861e6\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScopere050faf861e6\Psr\Cache\CacheException, \_PhpScopere050faf861e6\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScopere050faf861e6\Psr\Cache\CacheException
    {
    }
}
