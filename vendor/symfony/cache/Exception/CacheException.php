...
if (\interface_exists(\_PhpScopere24d949bf310\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScopere24d949bf310\Psr\Cache\CacheException, \_PhpScopere24d949bf310\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScopere24d949bf310\Psr\Cache\CacheException
    {
    }
}
