...
if (\interface_exists(\_PhpScoperdeea1786e972\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperdeea1786e972\Psr\Cache\CacheException, \_PhpScoperdeea1786e972\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperdeea1786e972\Psr\Cache\CacheException
    {
    }
}
