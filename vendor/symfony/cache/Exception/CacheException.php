...
if (\interface_exists(\_PhpScoper470d6df94ac0\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper470d6df94ac0\Psr\Cache\CacheException, \_PhpScoper470d6df94ac0\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper470d6df94ac0\Psr\Cache\CacheException
    {
    }
}
