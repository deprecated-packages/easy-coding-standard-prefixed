...
if (\interface_exists(\_PhpScopera238de2e9b5a\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScopera238de2e9b5a\Psr\Cache\CacheException, \_PhpScopera238de2e9b5a\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScopera238de2e9b5a\Psr\Cache\CacheException
    {
    }
}
