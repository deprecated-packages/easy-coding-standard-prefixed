...
if (\interface_exists(\_PhpScoper3e1e0e5bb8ef\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper3e1e0e5bb8ef\Psr\Cache\CacheException, \_PhpScoper3e1e0e5bb8ef\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper3e1e0e5bb8ef\Psr\Cache\CacheException
    {
    }
}
