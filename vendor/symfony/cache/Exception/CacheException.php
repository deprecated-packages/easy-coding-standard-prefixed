...
if (\interface_exists(\_PhpScoper4936962185e7\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper4936962185e7\Psr\Cache\CacheException, \_PhpScoper4936962185e7\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper4936962185e7\Psr\Cache\CacheException
    {
    }
}
