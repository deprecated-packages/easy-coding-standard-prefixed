...
if (\interface_exists(\_PhpScoperf7b66f9e3817\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperf7b66f9e3817\Psr\Cache\CacheException, \_PhpScoperf7b66f9e3817\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperf7b66f9e3817\Psr\Cache\CacheException
    {
    }
}
