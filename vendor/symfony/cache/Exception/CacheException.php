...
if (\interface_exists(\_PhpScoperf3dc21757def\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperf3dc21757def\Psr\Cache\CacheException, \_PhpScoperf3dc21757def\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperf3dc21757def\Psr\Cache\CacheException
    {
    }
}
