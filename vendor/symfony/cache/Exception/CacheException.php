...
if (\interface_exists(\_PhpScoper89c09b8e7101\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper89c09b8e7101\Psr\Cache\CacheException, \_PhpScoper89c09b8e7101\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper89c09b8e7101\Psr\Cache\CacheException
    {
    }
}
