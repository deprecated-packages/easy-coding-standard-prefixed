...
if (\interface_exists(\_PhpScoperf77bffce0320\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperf77bffce0320\Psr\Cache\CacheException, \_PhpScoperf77bffce0320\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperf77bffce0320\Psr\Cache\CacheException
    {
    }
}
