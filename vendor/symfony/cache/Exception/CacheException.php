...
if (\interface_exists(\_PhpScoperf65af7a6d9a0\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperf65af7a6d9a0\Psr\Cache\CacheException, \_PhpScoperf65af7a6d9a0\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperf65af7a6d9a0\Psr\Cache\CacheException
    {
    }
}
