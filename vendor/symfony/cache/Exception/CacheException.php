...
if (\interface_exists(\_PhpScoperddde3ba4aebc\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperddde3ba4aebc\Psr\Cache\CacheException, \_PhpScoperddde3ba4aebc\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperddde3ba4aebc\Psr\Cache\CacheException
    {
    }
}
