...
if (\interface_exists(\_PhpScoper279cf54b77ad\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper279cf54b77ad\Psr\Cache\CacheException, \_PhpScoper279cf54b77ad\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper279cf54b77ad\Psr\Cache\CacheException
    {
    }
}
