...
if (\interface_exists(\_PhpScoperc4ea0f0bd23f\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperc4ea0f0bd23f\Psr\Cache\CacheException, \_PhpScoperc4ea0f0bd23f\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperc4ea0f0bd23f\Psr\Cache\CacheException
    {
    }
}
