...
if (\interface_exists(\_PhpScoperd4c5032f0671\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperd4c5032f0671\Psr\Cache\CacheException, \_PhpScoperd4c5032f0671\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperd4c5032f0671\Psr\Cache\CacheException
    {
    }
}
