...
if (\interface_exists(\_PhpScoper2f75f00bf6fa\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper2f75f00bf6fa\Psr\Cache\CacheException, \_PhpScoper2f75f00bf6fa\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper2f75f00bf6fa\Psr\Cache\CacheException
    {
    }
}
