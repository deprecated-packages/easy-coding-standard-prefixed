...
if (\interface_exists(\_PhpScoperb6a8e65b492c\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperb6a8e65b492c\Psr\Cache\CacheException, \_PhpScoperb6a8e65b492c\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperb6a8e65b492c\Psr\Cache\CacheException
    {
    }
}
