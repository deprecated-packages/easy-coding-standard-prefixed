...
if (\interface_exists(\_PhpScopere341acab57d4\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScopere341acab57d4\Psr\Cache\CacheException, \_PhpScopere341acab57d4\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScopere341acab57d4\Psr\Cache\CacheException
    {
    }
}
