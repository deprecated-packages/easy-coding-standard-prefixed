...
if (\interface_exists(\_PhpScoperd79d87c3336e\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperd79d87c3336e\Psr\Cache\CacheException, \_PhpScoperd79d87c3336e\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperd79d87c3336e\Psr\Cache\CacheException
    {
    }
}
