...
if (\interface_exists(\_PhpScoper0c0702cca4ac\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper0c0702cca4ac\Psr\Cache\CacheException, \_PhpScoper0c0702cca4ac\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper0c0702cca4ac\Psr\Cache\CacheException
    {
    }
}
