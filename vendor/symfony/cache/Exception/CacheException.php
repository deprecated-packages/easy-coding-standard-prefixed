...
if (\interface_exists(\_PhpScoperb09c3ec8e01a\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoperb09c3ec8e01a\Psr\Cache\CacheException, \_PhpScoperb09c3ec8e01a\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoperb09c3ec8e01a\Psr\Cache\CacheException
    {
    }
}
