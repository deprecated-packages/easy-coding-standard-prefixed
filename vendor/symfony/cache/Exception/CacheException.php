...
if (\interface_exists(\_PhpScopercda2b863d098\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScopercda2b863d098\Psr\Cache\CacheException, \_PhpScopercda2b863d098\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScopercda2b863d098\Psr\Cache\CacheException
    {
    }
}
