...
if (\interface_exists(\_PhpScoper3e8786a75afe\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \_PhpScoper3e8786a75afe\Psr\Cache\CacheException, \_PhpScoper3e8786a75afe\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \_PhpScoper3e8786a75afe\Psr\Cache\CacheException
    {
    }
}
