...
if (\interface_exists(\_PhpScoper4aefa5ecccc4\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper4aefa5ecccc4\Psr\Cache\CacheException, \_PhpScoper4aefa5ecccc4\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper4aefa5ecccc4\Psr\Cache\CacheException
    {
    }
}
