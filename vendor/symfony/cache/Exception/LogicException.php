...
if (\interface_exists(\_PhpScoper133be48300f9\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper133be48300f9\Psr\Cache\CacheException, \_PhpScoper133be48300f9\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper133be48300f9\Psr\Cache\CacheException
    {
    }
}
