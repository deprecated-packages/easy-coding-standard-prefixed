...
if (\interface_exists(\_PhpScoper833c56a97273\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper833c56a97273\Psr\Cache\CacheException, \_PhpScoper833c56a97273\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper833c56a97273\Psr\Cache\CacheException
    {
    }
}
