...
if (\interface_exists(\_PhpScoper5ea36b274140\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper5ea36b274140\Psr\Cache\CacheException, \_PhpScoper5ea36b274140\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper5ea36b274140\Psr\Cache\CacheException
    {
    }
}
