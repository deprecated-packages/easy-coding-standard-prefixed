...
if (\interface_exists(\_PhpScoperd4937ee9b515\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperd4937ee9b515\Psr\Cache\CacheException, \_PhpScoperd4937ee9b515\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperd4937ee9b515\Psr\Cache\CacheException
    {
    }
}
