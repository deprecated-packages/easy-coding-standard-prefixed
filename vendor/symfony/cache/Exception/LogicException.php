...
if (\interface_exists(\_PhpScoperfabf55fef6b7\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperfabf55fef6b7\Psr\Cache\CacheException, \_PhpScoperfabf55fef6b7\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperfabf55fef6b7\Psr\Cache\CacheException
    {
    }
}
