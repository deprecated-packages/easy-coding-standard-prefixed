...
if (\interface_exists(\_PhpScoper9f8d5dcff860\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper9f8d5dcff860\Psr\Cache\CacheException, \_PhpScoper9f8d5dcff860\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper9f8d5dcff860\Psr\Cache\CacheException
    {
    }
}
