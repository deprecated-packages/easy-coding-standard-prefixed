...
if (\interface_exists(\_PhpScoper2a8ad010dfbd\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper2a8ad010dfbd\Psr\Cache\CacheException, \_PhpScoper2a8ad010dfbd\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper2a8ad010dfbd\Psr\Cache\CacheException
    {
    }
}
