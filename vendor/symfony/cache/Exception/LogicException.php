...
if (\interface_exists(\_PhpScoperd301db66c80c\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperd301db66c80c\Psr\Cache\CacheException, \_PhpScoperd301db66c80c\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperd301db66c80c\Psr\Cache\CacheException
    {
    }
}
