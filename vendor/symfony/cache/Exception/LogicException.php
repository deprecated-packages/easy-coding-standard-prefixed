...
if (\interface_exists(\_PhpScoper57210e33e43a\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper57210e33e43a\Psr\Cache\CacheException, \_PhpScoper57210e33e43a\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper57210e33e43a\Psr\Cache\CacheException
    {
    }
}
