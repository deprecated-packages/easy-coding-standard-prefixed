...
if (\interface_exists(\_PhpScoperca8ca183ac38\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperca8ca183ac38\Psr\Cache\CacheException, \_PhpScoperca8ca183ac38\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperca8ca183ac38\Psr\Cache\CacheException
    {
    }
}
