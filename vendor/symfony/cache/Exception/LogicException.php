...
if (\interface_exists(\_PhpScoper4d3fa30a680b\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper4d3fa30a680b\Psr\Cache\CacheException, \_PhpScoper4d3fa30a680b\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper4d3fa30a680b\Psr\Cache\CacheException
    {
    }
}
