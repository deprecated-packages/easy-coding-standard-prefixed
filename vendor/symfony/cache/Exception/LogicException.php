...
if (\interface_exists(\_PhpScoper92597f5b42a7\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper92597f5b42a7\Psr\Cache\CacheException, \_PhpScoper92597f5b42a7\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper92597f5b42a7\Psr\Cache\CacheException
    {
    }
}
