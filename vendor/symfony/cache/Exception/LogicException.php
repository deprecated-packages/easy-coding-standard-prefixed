...
if (\interface_exists(\_PhpScoperf53473b45c36\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperf53473b45c36\Psr\Cache\CacheException, \_PhpScoperf53473b45c36\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperf53473b45c36\Psr\Cache\CacheException
    {
    }
}
