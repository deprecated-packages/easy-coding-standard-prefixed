...
if (\interface_exists(\_PhpScoperc83f84c90b60\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperc83f84c90b60\Psr\Cache\CacheException, \_PhpScoperc83f84c90b60\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperc83f84c90b60\Psr\Cache\CacheException
    {
    }
}
