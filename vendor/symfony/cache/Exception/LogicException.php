...
if (\interface_exists(\_PhpScoperad4605bb9267\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperad4605bb9267\Psr\Cache\CacheException, \_PhpScoperad4605bb9267\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperad4605bb9267\Psr\Cache\CacheException
    {
    }
}
