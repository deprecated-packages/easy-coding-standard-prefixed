...
if (\interface_exists(\_PhpScopera34ae19e8d40\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScopera34ae19e8d40\Psr\Cache\CacheException, \_PhpScopera34ae19e8d40\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScopera34ae19e8d40\Psr\Cache\CacheException
    {
    }
}
