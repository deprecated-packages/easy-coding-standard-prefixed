...
if (\interface_exists(\_PhpScoper70e3784a2d21\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper70e3784a2d21\Psr\Cache\CacheException, \_PhpScoper70e3784a2d21\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper70e3784a2d21\Psr\Cache\CacheException
    {
    }
}
