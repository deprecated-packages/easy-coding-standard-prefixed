...
if (\interface_exists(\_PhpScoper83a475a0590e\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper83a475a0590e\Psr\Cache\CacheException, \_PhpScoper83a475a0590e\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper83a475a0590e\Psr\Cache\CacheException
    {
    }
}
