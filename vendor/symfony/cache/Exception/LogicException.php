...
if (\interface_exists(\_PhpScoperfcee700af3df\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperfcee700af3df\Psr\Cache\CacheException, \_PhpScoperfcee700af3df\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperfcee700af3df\Psr\Cache\CacheException
    {
    }
}
