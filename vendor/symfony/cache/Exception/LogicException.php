...
if (\interface_exists(\_PhpScoper13160cf3462c\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper13160cf3462c\Psr\Cache\CacheException, \_PhpScoper13160cf3462c\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper13160cf3462c\Psr\Cache\CacheException
    {
    }
}
