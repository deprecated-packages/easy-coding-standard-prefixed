...
if (\interface_exists(\_PhpScoper0d0ee1ba46d4\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper0d0ee1ba46d4\Psr\Cache\CacheException, \_PhpScoper0d0ee1ba46d4\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper0d0ee1ba46d4\Psr\Cache\CacheException
    {
    }
}
