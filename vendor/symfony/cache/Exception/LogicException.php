...
if (\interface_exists(\_PhpScoper92feab6bddf8\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper92feab6bddf8\Psr\Cache\CacheException, \_PhpScoper92feab6bddf8\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper92feab6bddf8\Psr\Cache\CacheException
    {
    }
}
