...
if (\interface_exists(\_PhpScoperdc8fbcd7c69d\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperdc8fbcd7c69d\Psr\Cache\CacheException, \_PhpScoperdc8fbcd7c69d\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperdc8fbcd7c69d\Psr\Cache\CacheException
    {
    }
}
