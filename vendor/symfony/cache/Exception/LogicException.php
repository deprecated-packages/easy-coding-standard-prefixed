...
if (\interface_exists(\_PhpScoperd47a2fa2a77e\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperd47a2fa2a77e\Psr\Cache\CacheException, \_PhpScoperd47a2fa2a77e\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperd47a2fa2a77e\Psr\Cache\CacheException
    {
    }
}
