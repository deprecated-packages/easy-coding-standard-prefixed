...
if (\interface_exists(\_PhpScoper15c5423f4731\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper15c5423f4731\Psr\Cache\CacheException, \_PhpScoper15c5423f4731\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper15c5423f4731\Psr\Cache\CacheException
    {
    }
}
