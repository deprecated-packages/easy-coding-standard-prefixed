...
if (\interface_exists(\_PhpScoper967c4b7e296e\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper967c4b7e296e\Psr\Cache\CacheException, \_PhpScoper967c4b7e296e\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper967c4b7e296e\Psr\Cache\CacheException
    {
    }
}
