...
if (\interface_exists(\_PhpScoper9e3283ae8193\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper9e3283ae8193\Psr\Cache\CacheException, \_PhpScoper9e3283ae8193\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper9e3283ae8193\Psr\Cache\CacheException
    {
    }
}
