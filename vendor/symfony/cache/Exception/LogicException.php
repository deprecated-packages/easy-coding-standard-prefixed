...
if (\interface_exists(\_PhpScoper908feaf49cd8\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper908feaf49cd8\Psr\Cache\CacheException, \_PhpScoper908feaf49cd8\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper908feaf49cd8\Psr\Cache\CacheException
    {
    }
}
