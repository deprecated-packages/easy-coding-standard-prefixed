...
if (\interface_exists(\_PhpScopera061b8a47e36\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScopera061b8a47e36\Psr\Cache\CacheException, \_PhpScopera061b8a47e36\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScopera061b8a47e36\Psr\Cache\CacheException
    {
    }
}
