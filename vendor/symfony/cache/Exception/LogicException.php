...
if (\interface_exists(\_PhpScoperbc5235eb86f3\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperbc5235eb86f3\Psr\Cache\CacheException, \_PhpScoperbc5235eb86f3\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperbc5235eb86f3\Psr\Cache\CacheException
    {
    }
}
