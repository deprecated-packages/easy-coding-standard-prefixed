...
if (\interface_exists(\_PhpScoperab9510cd5d97\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperab9510cd5d97\Psr\Cache\CacheException, \_PhpScoperab9510cd5d97\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperab9510cd5d97\Psr\Cache\CacheException
    {
    }
}
