...
if (\interface_exists(\_PhpScoperc5bee3a837bb\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperc5bee3a837bb\Psr\Cache\CacheException, \_PhpScoperc5bee3a837bb\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperc5bee3a837bb\Psr\Cache\CacheException
    {
    }
}
