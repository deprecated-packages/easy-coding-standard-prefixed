...
if (\interface_exists(\_PhpScoperfacc742d2745\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperfacc742d2745\Psr\Cache\CacheException, \_PhpScoperfacc742d2745\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperfacc742d2745\Psr\Cache\CacheException
    {
    }
}
