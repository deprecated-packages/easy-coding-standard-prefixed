...
if (\interface_exists(\_PhpScoperc95ae4bf942a\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperc95ae4bf942a\Psr\Cache\CacheException, \_PhpScoperc95ae4bf942a\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperc95ae4bf942a\Psr\Cache\CacheException
    {
    }
}
