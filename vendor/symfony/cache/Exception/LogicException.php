...
if (\interface_exists(\_PhpScoper2f04ef4e8878\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper2f04ef4e8878\Psr\Cache\CacheException, \_PhpScoper2f04ef4e8878\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper2f04ef4e8878\Psr\Cache\CacheException
    {
    }
}
