...
if (\interface_exists(\_PhpScoper80dbed43490f\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper80dbed43490f\Psr\Cache\CacheException, \_PhpScoper80dbed43490f\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper80dbed43490f\Psr\Cache\CacheException
    {
    }
}
