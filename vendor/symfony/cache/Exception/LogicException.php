...
if (\interface_exists(\_PhpScopera749ac204cd2\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScopera749ac204cd2\Psr\Cache\CacheException, \_PhpScopera749ac204cd2\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScopera749ac204cd2\Psr\Cache\CacheException
    {
    }
}
