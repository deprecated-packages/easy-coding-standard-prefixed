...
if (\interface_exists(\_PhpScoperbd5c5a045153\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperbd5c5a045153\Psr\Cache\CacheException, \_PhpScoperbd5c5a045153\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperbd5c5a045153\Psr\Cache\CacheException
    {
    }
}
