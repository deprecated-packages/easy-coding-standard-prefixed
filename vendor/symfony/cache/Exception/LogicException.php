...
if (\interface_exists(\_PhpScoper57272265e1c9\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper57272265e1c9\Psr\Cache\CacheException, \_PhpScoper57272265e1c9\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper57272265e1c9\Psr\Cache\CacheException
    {
    }
}
