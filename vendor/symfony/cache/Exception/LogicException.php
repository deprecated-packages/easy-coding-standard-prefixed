...
if (\interface_exists(\_PhpScoperfcf15c26e033\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperfcf15c26e033\Psr\Cache\CacheException, \_PhpScoperfcf15c26e033\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperfcf15c26e033\Psr\Cache\CacheException
    {
    }
}
