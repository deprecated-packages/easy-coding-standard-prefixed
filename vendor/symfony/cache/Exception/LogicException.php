...
if (\interface_exists(\_PhpScoperb0c6500a504c\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperb0c6500a504c\Psr\Cache\CacheException, \_PhpScoperb0c6500a504c\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperb0c6500a504c\Psr\Cache\CacheException
    {
    }
}
