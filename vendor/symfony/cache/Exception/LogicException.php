...
if (\interface_exists(\_PhpScoper7cef7256eba6\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper7cef7256eba6\Psr\Cache\CacheException, \_PhpScoper7cef7256eba6\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper7cef7256eba6\Psr\Cache\CacheException
    {
    }
}
