...
if (\interface_exists(\_PhpScopera23ebff5477f\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScopera23ebff5477f\Psr\Cache\CacheException, \_PhpScopera23ebff5477f\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScopera23ebff5477f\Psr\Cache\CacheException
    {
    }
}
