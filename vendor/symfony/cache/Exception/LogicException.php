...
if (\interface_exists(\_PhpScoper207eb8f99af3\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoper207eb8f99af3\Psr\Cache\CacheException, \_PhpScoper207eb8f99af3\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoper207eb8f99af3\Psr\Cache\CacheException
    {
    }
}
