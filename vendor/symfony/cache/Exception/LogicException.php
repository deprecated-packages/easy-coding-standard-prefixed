...
if (\interface_exists(\_PhpScopere015d8a3273c\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScopere015d8a3273c\Psr\Cache\CacheException, \_PhpScopere015d8a3273c\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScopere015d8a3273c\Psr\Cache\CacheException
    {
    }
}
