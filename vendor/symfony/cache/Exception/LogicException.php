...
if (\interface_exists(\_PhpScoperad4b7e2c09d8\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperad4b7e2c09d8\Psr\Cache\CacheException, \_PhpScoperad4b7e2c09d8\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperad4b7e2c09d8\Psr\Cache\CacheException
    {
    }
}
