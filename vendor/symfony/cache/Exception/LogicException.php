...
if (\interface_exists(\_PhpScoperb6ccec8ab642\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperb6ccec8ab642\Psr\Cache\CacheException, \_PhpScoperb6ccec8ab642\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperb6ccec8ab642\Psr\Cache\CacheException
    {
    }
}
