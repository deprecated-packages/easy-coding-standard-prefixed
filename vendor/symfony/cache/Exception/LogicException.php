...
if (\interface_exists(\_PhpScoperc75fd40d7a6e\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperc75fd40d7a6e\Psr\Cache\CacheException, \_PhpScoperc75fd40d7a6e\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperc75fd40d7a6e\Psr\Cache\CacheException
    {
    }
}
