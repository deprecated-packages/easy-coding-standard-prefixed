...
if (\interface_exists(\_PhpScoperb458b528613f\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperb458b528613f\Psr\Cache\CacheException, \_PhpScoperb458b528613f\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperb458b528613f\Psr\Cache\CacheException
    {
    }
}
