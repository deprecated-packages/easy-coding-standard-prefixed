...
if (\interface_exists(\_PhpScoperbaf90856897c\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \_PhpScoperbaf90856897c\Psr\Cache\CacheException, \_PhpScoperbaf90856897c\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \_PhpScoperbaf90856897c\Psr\Cache\CacheException
    {
    }
}
