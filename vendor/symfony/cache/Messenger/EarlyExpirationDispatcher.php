...
use _PhpScoper1ddca3f92d7d\Symfony\Component\Messenger\MessageBusInterface;
use _PhpScoper1ddca3f92d7d\Symfony\Component\Messenger\Stamp\HandledStamp;
/**
...
class EarlyExpirationDispatcher
{
    ...
    {
        if (!$item->isHit() || null === ($message = \_PhpScoper1ddca3f92d7d\Symfony\Component\Cache\Messenger\EarlyExpirationMessage::create($this->reverseContainer, $callback, $item, $pool))) {
