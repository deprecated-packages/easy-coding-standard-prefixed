 ...
 */
namespace _PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests;

use _PhpScoperf5f75c22067b\PHPUnit\Framework\TestCase;
use _PhpScoperf5f75c22067b\Symfony\Component\VarDumper\Test\VarDumperTestTrait;
use _PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Internal\Registry;
use _PhpScoperf5f75c22067b\Symfony\Component\VarExporter\VarExporter;
class VarExporterTest extends \_PhpScoperf5f75c22067b\PHPUnit\Framework\TestCase
{
    ...
    public function testPhpIncompleteClassesAreForbidden()
    {
        ...
        try {
            \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Internal\Registry::unserialize(array(), array('O:20:"SomeNotExistingClass":0:{}'));
        } finally {
    ...
    public function testFailingSerialization($value)
    {
        ...
        try {
            \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\VarExporter::export($value);
        } finally {
    ...
    public function testExport(string $testName, $value, bool $staticValueExpected = \false)
    {
        ...
        $isStaticValue = \true;
        $marshalledValue = \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\VarExporter::export($value, $isStaticValue);
        ...
        if (!$isStaticValue) {
            if ($value instanceof \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyWakeup) {
                $value->bis = null;
            }
    ...
    public function provideExport()
    {
        ...
        (yield array('array-object-custom', new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyArrayObject(array(234))));
        $value = new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MySerializable();
        (yield array('serializable', array($value, $value)));
        $value = new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyWakeup();
        $value->sub = new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyWakeup();
        $value->sub->sub = 123;
        $value->sub->bis = 123;
        $value->sub->baz = 123;
        (yield array('wakeup', $value));
        (yield array('clone', array(new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyCloneable(), new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyNotCloneable())));
        (yield array('private', array(new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyPrivateValue(123, 234), new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyPrivateChildValue(123, 234))));
        ...
        (yield array('var-on-sleep', new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\GoodNight()));
        $value = new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\FinalError(\false);
        $rt->setValue($value, array());
        $rl->setValue($value, 123);
        (yield array('final-error', $value));
        (yield array('final-array-iterator', new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\FinalArrayIterator()));
        (yield array('final-stdclass', new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\FinalStdClass()));
        $value = new \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyWakeup();
...
class MyPrivateChildValue extends \_PhpScoperf5f75c22067b\Symfony\Component\VarExporter\Tests\MyPrivateValue
{
}
