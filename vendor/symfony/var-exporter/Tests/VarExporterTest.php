 ...
 */
namespace _PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests;

use _PhpScoper8acb416c2f5a\PHPUnit\Framework\TestCase;
use _PhpScoper8acb416c2f5a\Symfony\Component\VarDumper\Test\VarDumperTestTrait;
use _PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Internal\Registry;
use _PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\VarExporter;
class VarExporterTest extends \_PhpScoper8acb416c2f5a\PHPUnit\Framework\TestCase
{
    ...
    public function testPhpIncompleteClassesAreForbidden()
    {
        ...
        try {
            \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Internal\Registry::unserialize(array(), array('O:20:"SomeNotExistingClass":0:{}'));
        } finally {
    ...
    public function testFailingSerialization($value)
    {
        ...
        try {
            \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\VarExporter::export($value);
        } finally {
    ...
    public function testExport(string $testName, $value, bool $staticValueExpected = \false)
    {
        ...
        $isStaticValue = \true;
        $marshalledValue = \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\VarExporter::export($value, $isStaticValue);
        ...
        if (!$isStaticValue) {
            if ($value instanceof \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyWakeup) {
                $value->bis = null;
            }
    ...
    public function provideExport()
    {
        ...
        (yield array('array-object-custom', new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyArrayObject(array(234))));
        $value = new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MySerializable();
        (yield array('serializable', array($value, $value)));
        $value = new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyWakeup();
        $value->sub = new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyWakeup();
        $value->sub->sub = 123;
        $value->sub->bis = 123;
        $value->sub->baz = 123;
        (yield array('wakeup', $value));
        (yield array('clone', array(new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyCloneable(), new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyNotCloneable())));
        (yield array('private', array(new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyPrivateValue(123, 234), new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyPrivateChildValue(123, 234))));
        ...
        (yield array('var-on-sleep', new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\GoodNight()));
        $value = new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\FinalError(\false);
        $rt->setValue($value, array());
        $rl->setValue($value, 123);
        (yield array('final-error', $value));
        (yield array('final-array-iterator', new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\FinalArrayIterator()));
        (yield array('final-stdclass', new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\FinalStdClass()));
        $value = new \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyWakeup();
...
class MyPrivateChildValue extends \_PhpScoper8acb416c2f5a\Symfony\Component\VarExporter\Tests\MyPrivateValue
{
}
