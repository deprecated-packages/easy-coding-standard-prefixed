 ...
 */
namespace _PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal;

use _PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException;
/**
...
class Exporter
{
    ...
    public static function prepare($values, $objectsPool, &$refsPool, &$objectsCount, &$valuesAreStatic)
    {
        ...
        foreach ($values as $k => $value) {
            if (\is_resource($value)) {
                throw new \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException(\get_resource_type($value) . ' resource');
            }
            $refs[$k] = $objectsPool;
            if ($isRef = !($valueIsStatic = $values[$k] !== $objectsPool)) {
                ...
                if ($value instanceof \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Reference && 0 > $value->id) {
                    $valuesAreStatic = \false;
                    ++$value->count;
                    continue;
                }
                $refsPool[] = array(&$refs[$k], $value, &$value);
                $refs[$k] = $values[$k] = new \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Reference(-\count($refsPool), $value);
            }
            if (\is_array($value)) {
                if ($value) {
            ...
            if (isset($objectsPool[$value])) {
                ++$objectsCount;
                $value = new \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Reference($objectsPool[$value][0]);
                goto handle_value;
            }
            ...
            $reflector = \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$class] ?? \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class);
            $proto = \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class];
            if (($value instanceof \ArrayIterator || $value instanceof \ArrayObject) && null !== $proto) {
                ...
                \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class, \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class], \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]);
            } elseif ($value instanceof \SplObjectStorage && \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class] && null !== $proto) {
                ...
                $value = new \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Reference($id);
                goto handle_value;
            }
    ...
    public static function export($value, $indent = '')
    {
        ...
        if ($value instanceof \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Reference) {
            if (0 <= $value->id) {
                return '$o[' . $value->id . ']';
            }
            if (!$value->count) {
        ...
        if ($value instanceof \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Values) {
            $code = $subIndent . "\$r = [],\n";
        ...
        if ($value instanceof \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry) {
            return self::exportRegistry($value, $indent, $subIndent);
        }
        if ($value instanceof \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Hydrator) {
    ...
    private static function exportRegistry(\_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry $value, string $indent, string $subIndent) : string
    {
        $code = '';
        $serializables = array();
        $seen = array();
        $prototypesAccess = 0;
        $factoriesAccess = 0;
        $r = '\\' . \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::class;
        $j = -1;
        foreach ($value as $k => $class) {
            ...
            if (!\_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            ...
            $c = '[' . self::export($class) . ']';
            if ($seen[$class] ?? \false) {
                if (\_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
                    ++$prototypesAccess;
                    $code .= 'clone $p' . $c;
                } else {
                    ++$factoriesAccess;
    ...
    private static function exportHydrator(\_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Hydrator $value, string $indent, string $subIndent) : string
    {
        $code = '';
    ...
    private static function getArrayObjectProperties($value, array &$arrayValue, $proto) : array
    {
        ...
        $reflector = \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$reflector] ?? \_PhpScopercf327c47dfc5\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($reflector);
