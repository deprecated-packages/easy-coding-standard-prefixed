...
use _PhpScoperdc8fbcd7c69d\Symfony\Component\VarExporter\Internal\Exporter;
...
use _PhpScoperdc8fbcd7c69d\Symfony\Component\VarExporter\Internal\Values;
/**
...
final class VarExporter
{
    ...
    public static function export($value, bool &$isStaticValue = null) : string
    {
        ...
        if (!\is_object($value) && !(\is_array($value) && $value) && !$value instanceof \__PHP_Incomplete_Class && !\is_resource($value)) {
            return \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarExporter\Internal\Exporter::export($value);
        }
        $objectsPool = new \SplObjectStorage();
        $refsPool = array();
        $objectsCount = 0;
        try {
            $value = \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarExporter\Internal\Exporter::prepare(array($value), $objectsPool, $refsPool, $objectsCount, $isStaticValue)[0];
        } finally {
            $references = array();
        ...
        if ($classes || $references) {
            $value = new \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarExporter\Internal\Hydrator(new \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarExporter\Internal\Registry($classes), $references ? new \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarExporter\Internal\Values($references) : null, $properties, $value, $wakeups);
        } else {
            $isStaticValue = \true;
        }
        return \_PhpScoperdc8fbcd7c69d\Symfony\Component\VarExporter\Internal\Exporter::export($value);
