...
final class Instantiator
{
    ...
    public static function instantiate(string $class, array $properties = array(), array $privateProperties = array())
    {
        ...
        if (\_PhpScoper64ca614e27fd\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = array(clone \_PhpScoper64ca614e27fd\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]);
        } elseif (\_PhpScoper64ca614e27fd\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = array($reflector->newInstanceWithoutConstructor());
        } elseif (null === \_PhpScoper64ca614e27fd\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (\_PhpScoper64ca614e27fd\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] ?? \_PhpScoper64ca614e27fd\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
