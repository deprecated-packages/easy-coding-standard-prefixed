...
final class Instantiator
{
    ...
    public static function instantiate(string $class, array $properties = array(), array $privateProperties = array())
    {
        ...
        if (\_PhpScoper7cef7256eba6\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = array(clone \_PhpScoper7cef7256eba6\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]);
        } elseif (\_PhpScoper7cef7256eba6\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = array($reflector->newInstanceWithoutConstructor());
        } elseif (null === \_PhpScoper7cef7256eba6\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (\_PhpScoper7cef7256eba6\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] ?? \_PhpScoper7cef7256eba6\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
