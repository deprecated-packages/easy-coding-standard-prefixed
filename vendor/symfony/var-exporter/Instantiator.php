...
final class Instantiator
{
    ...
    public static function instantiate(string $class, array $properties = array(), array $privateProperties = array())
    {
        ...
        if (\_PhpScoperc8b83ee8976a\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = array(clone \_PhpScoperc8b83ee8976a\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]);
        } elseif (\_PhpScoperc8b83ee8976a\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = array($reflector->newInstanceWithoutConstructor());
        } elseif (null === \_PhpScoperc8b83ee8976a\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (\_PhpScoperc8b83ee8976a\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] ?? \_PhpScoperc8b83ee8976a\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
