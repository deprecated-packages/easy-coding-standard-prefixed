...
final class Instantiator
{
    ...
    public static function instantiate(string $class, array $properties = [], array $privateProperties = []) : object
    {
        ...
        if (\_PhpScoper06c5fb6c14ed\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = [clone \_PhpScoper06c5fb6c14ed\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]];
        } elseif (\_PhpScoper06c5fb6c14ed\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = [$reflector->newInstanceWithoutConstructor()];
        } elseif (null === \_PhpScoper06c5fb6c14ed\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (\_PhpScoper06c5fb6c14ed\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] ?? \_PhpScoper06c5fb6c14ed\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
