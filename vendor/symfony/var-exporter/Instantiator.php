...
final class Instantiator
{
    ...
    public static function instantiate(string $class, array $properties = array(), array $privateProperties = array())
    {
        ...
        if (\_PhpScopercae980ebf12d\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = array(clone \_PhpScopercae980ebf12d\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]);
        } elseif (\_PhpScopercae980ebf12d\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = array($reflector->newInstanceWithoutConstructor());
        } elseif (null === \_PhpScopercae980ebf12d\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (\_PhpScopercae980ebf12d\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] ?? \_PhpScopercae980ebf12d\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
