 ...
 */
class AutowiringFailedException extends \_PhpScopera22bb3f4d7b7\Symfony\Component\DependencyInjection\Exception\RuntimeException
{
    private $serviceId;
    ...
    public function __construct(string $serviceId, $message = '', int $code = 0, \Throwable $previous = null)
    {
        ...
        if ($message instanceof \Closure && (\function_exists('xdebug_is_enabled') ? \xdebug_is_enabled() : \function_exists('_PhpScopera22bb3f4d7b7\\xdebug_info'))) {
            $message = $message();
        }
