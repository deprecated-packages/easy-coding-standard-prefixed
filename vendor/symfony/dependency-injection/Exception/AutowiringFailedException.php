 ...
 */
class AutowiringFailedException extends \_PhpScoper22e359cd1ab0\Symfony\Component\DependencyInjection\Exception\RuntimeException
{
    private $serviceId;
    ...
    public function __construct(string $serviceId, $message = '', int $code = 0, \Throwable $previous = null)
    {
        ...
        if ($message instanceof \Closure && (\function_exists('xdebug_is_enabled') ? \xdebug_is_enabled() : \function_exists('_PhpScoper22e359cd1ab0\\xdebug_info'))) {
            $message = $message();
        }
