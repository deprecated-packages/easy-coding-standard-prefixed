...
use _PhpScoper514703a076a2\Symfony\Component\DependencyInjection\Argument\ServiceLocator as ArgumentServiceLocator;
use _PhpScoper514703a076a2\Symfony\Component\DependencyInjection\Exception\EnvNotFoundException;
 ...
 */
class Container implements \_PhpScoper514703a076a2\Symfony\Component\DependencyInjection\ContainerInterface, ResetInterface
{
    ...
    protected function getEnv($name)
    {
        ...
        if (!$this->has($id = 'container.env_var_processors_locator')) {
            $this->set($id, new \_PhpScoper514703a076a2\Symfony\Component\DependencyInjection\ServiceLocator([]));
        }
        if (!$this->getEnv) {
        ...
        $processor = $processors->has($prefix) ? $processors->get($prefix) : new \_PhpScoper514703a076a2\Symfony\Component\DependencyInjection\EnvVarProcessor($this);
