...
use _PhpScoper4fedb9aa1e5f\Symfony\Component\DependencyInjection\Argument\ServiceLocator as ArgumentServiceLocator;
use _PhpScoper4fedb9aa1e5f\Symfony\Component\DependencyInjection\Exception\EnvNotFoundException;
 ...
 */
class Container implements \_PhpScoper4fedb9aa1e5f\Symfony\Component\DependencyInjection\ContainerInterface, ResetInterface
{
    ...
    protected function getEnv($name)
    {
        ...
        if (!$this->has($id = 'container.env_var_processors_locator')) {
            $this->set($id, new \_PhpScoper4fedb9aa1e5f\Symfony\Component\DependencyInjection\ServiceLocator([]));
        }
        if (!$this->getEnv) {
        ...
        $processor = $processors->has($prefix) ? $processors->get($prefix) : new \_PhpScoper4fedb9aa1e5f\Symfony\Component\DependencyInjection\EnvVarProcessor($this);
