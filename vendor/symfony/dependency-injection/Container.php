...
use _PhpScoper45e1bde0f567\Symfony\Component\DependencyInjection\Argument\ServiceLocator as ArgumentServiceLocator;
use _PhpScoper45e1bde0f567\Symfony\Component\DependencyInjection\Exception\EnvNotFoundException;
 ...
 */
class Container implements \_PhpScoper45e1bde0f567\Symfony\Component\DependencyInjection\ContainerInterface, ResetInterface
{
    ...
    protected function getEnv($name)
    {
        ...
        if (!$this->has($id = 'container.env_var_processors_locator')) {
            $this->set($id, new \_PhpScoper45e1bde0f567\Symfony\Component\DependencyInjection\ServiceLocator([]));
        }
        if (!$this->getEnv) {
        ...
        $processor = $processors->has($prefix) ? $processors->get($prefix) : new \_PhpScoper45e1bde0f567\Symfony\Component\DependencyInjection\EnvVarProcessor($this);
