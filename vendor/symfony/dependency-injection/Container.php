...
use _PhpScoperef2f7aa3581e\Symfony\Component\DependencyInjection\Argument\ServiceLocator as ArgumentServiceLocator;
use _PhpScoperef2f7aa3581e\Symfony\Component\DependencyInjection\Exception\EnvNotFoundException;
 ...
 */
class Container implements \_PhpScoperef2f7aa3581e\Symfony\Component\DependencyInjection\ContainerInterface, ResetInterface
{
    ...
    protected function getEnv($name)
    {
        ...
        if (!$this->has($id = 'container.env_var_processors_locator')) {
            $this->set($id, new \_PhpScoperef2f7aa3581e\Symfony\Component\DependencyInjection\ServiceLocator([]));
        }
        if (!$this->getEnv) {
        ...
        $processor = $processors->has($prefix) ? $processors->get($prefix) : new \_PhpScoperef2f7aa3581e\Symfony\Component\DependencyInjection\EnvVarProcessor($this);
