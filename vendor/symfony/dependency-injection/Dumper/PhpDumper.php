 ...
 */
namespace _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Dumper;

use _PhpScopera9d6a31d814c\Composer\Autoload\ClassLoader;
use _PhpScopera9d6a31d814c\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
...
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\ContainerInterface;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Definition;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
...
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\ExpressionLanguage;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Loader\FileLoader;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Parameter;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Reference;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\TypedReference;
use _PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Variable;
use _PhpScopera9d6a31d814c\Symfony\Component\ErrorHandler\DebugClassLoader;
use _PhpScopera9d6a31d814c\Symfony\Component\ExpressionLanguage\Expression;
use _PhpScopera9d6a31d814c\Symfony\Component\HttpKernel\Kernel;
/**
 ...
 */
class PhpDumper extends \_PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
...
use _PhpScopera9d6a31d814c\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use _PhpScopera9d6a31d814c\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use _PhpScopera9d6a31d814c\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use _PhpScopera9d6a31d814c\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use _PhpScopera9d6a31d814c\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use _PhpScopera9d6a31d814c\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use _PhpScopera9d6a31d814c\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists(\_PhpScopera9d6a31d814c\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
