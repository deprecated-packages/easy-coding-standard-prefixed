 ...
 */
namespace _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Dumper;

use _PhpScoper96c81c3c1716\Composer\Autoload\ClassLoader;
use _PhpScoper96c81c3c1716\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Container;
...
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Exception\LogicException;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\ExpressionLanguage;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Loader\FileLoader;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Parameter;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Reference;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\TypedReference;
use _PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Variable;
use _PhpScoper96c81c3c1716\Symfony\Component\ErrorHandler\DebugClassLoader;
use _PhpScoper96c81c3c1716\Symfony\Component\ExpressionLanguage\Expression;
use _PhpScoper96c81c3c1716\Symfony\Component\HttpKernel\Kernel;
/**
 ...
 */
class PhpDumper extends \_PhpScoper96c81c3c1716\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
...
use _PhpScoper96c81c3c1716\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use _PhpScoper96c81c3c1716\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use _PhpScoper96c81c3c1716\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use _PhpScoper96c81c3c1716\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use _PhpScoper96c81c3c1716\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use _PhpScoper96c81c3c1716\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use _PhpScoper96c81c3c1716\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists(\_PhpScoper96c81c3c1716\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
