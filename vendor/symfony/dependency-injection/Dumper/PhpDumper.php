 ...
 */
namespace _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Dumper;

use _PhpScoperd2a667bd5a98\Composer\Autoload\ClassLoader;
use _PhpScoperd2a667bd5a98\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Container;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\ContainerBuilder;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\ContainerInterface;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Definition;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Exception\LogicException;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\ExpressionLanguage;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Loader\FileLoader;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Parameter;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Reference;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\TypedReference;
use _PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Variable;
use _PhpScoperd2a667bd5a98\Symfony\Component\ErrorHandler\DebugClassLoader;
use _PhpScoperd2a667bd5a98\Symfony\Component\ExpressionLanguage\Expression;
use _PhpScoperd2a667bd5a98\Symfony\Component\HttpKernel\Kernel;
/**
 ...
 */
class PhpDumper extends \_PhpScoperd2a667bd5a98\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
...
use _PhpScoperd2a667bd5a98\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use _PhpScoperd2a667bd5a98\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use _PhpScoperd2a667bd5a98\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use _PhpScoperd2a667bd5a98\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use _PhpScoperd2a667bd5a98\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use _PhpScoperd2a667bd5a98\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use _PhpScoperd2a667bd5a98\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists(\_PhpScoperd2a667bd5a98\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
