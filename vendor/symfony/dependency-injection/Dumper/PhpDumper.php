 ...
 */
namespace _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Dumper;

use _PhpScoper32abeec2fe5a\Composer\Autoload\ClassLoader;
use _PhpScoper32abeec2fe5a\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Container;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\ContainerBuilder;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\ContainerInterface;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Definition;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Exception\LogicException;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\ExpressionLanguage;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Loader\FileLoader;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Parameter;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Reference;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\TypedReference;
use _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Variable;
use _PhpScoper32abeec2fe5a\Symfony\Component\ErrorHandler\DebugClassLoader;
use _PhpScoper32abeec2fe5a\Symfony\Component\ExpressionLanguage\Expression;
use _PhpScoper32abeec2fe5a\Symfony\Component\HttpKernel\Kernel;
/**
 ...
 */
class PhpDumper extends \_PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
...
use _PhpScoper32abeec2fe5a\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use _PhpScoper32abeec2fe5a\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use _PhpScoper32abeec2fe5a\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use _PhpScoper32abeec2fe5a\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use _PhpScoper32abeec2fe5a\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use _PhpScoper32abeec2fe5a\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use _PhpScoper32abeec2fe5a\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists(\_PhpScoper32abeec2fe5a\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
