 ...
 */
namespace _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Dumper;

use _PhpScoper130a9a1cd4a2\Composer\Autoload\ClassLoader;
use _PhpScoper130a9a1cd4a2\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
...
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
...
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\ExpressionLanguage;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Loader\FileLoader;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Parameter;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Reference;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\TypedReference;
use _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Variable;
use _PhpScoper130a9a1cd4a2\Symfony\Component\ErrorHandler\DebugClassLoader;
use _PhpScoper130a9a1cd4a2\Symfony\Component\ExpressionLanguage\Expression;
 ...
 */
class PhpDumper extends \_PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
...
use _PhpScoper130a9a1cd4a2\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use _PhpScoper130a9a1cd4a2\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use _PhpScoper130a9a1cd4a2\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use _PhpScoper130a9a1cd4a2\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use _PhpScoper130a9a1cd4a2\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use _PhpScoper130a9a1cd4a2\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use _PhpScoper130a9a1cd4a2\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists(\_PhpScoper130a9a1cd4a2\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
