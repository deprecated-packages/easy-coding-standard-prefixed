...
use _PhpScopercae9e6ab5cea\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
...
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
...
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
...
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\ExpressionLanguage;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Loader\FileLoader;
...
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\TypedReference;
use _PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Variable;
use _PhpScopercae9e6ab5cea\Symfony\Component\ErrorHandler\DebugClassLoader;
use _PhpScopercae9e6ab5cea\Symfony\Component\ExpressionLanguage\Expression;
use _PhpScopercae9e6ab5cea\Symfony\Component\HttpKernel\Kernel;
/**
 ...
 */
class PhpDumper extends \_PhpScopercae9e6ab5cea\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
...
use _PhpScopercae9e6ab5cea\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use _PhpScopercae9e6ab5cea\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use _PhpScopercae9e6ab5cea\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use _PhpScopercae9e6ab5cea\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use _PhpScopercae9e6ab5cea\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists(\_PhpScopercae9e6ab5cea\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
