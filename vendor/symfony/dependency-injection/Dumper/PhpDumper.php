 ...
 */
namespace _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Dumper;

use _PhpScoper9385100df341\Composer\Autoload\ClassLoader;
use _PhpScoper9385100df341\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Container;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\ContainerBuilder;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\ContainerInterface;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Definition;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Exception\LogicException;
...
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\ExpressionLanguage;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Loader\FileLoader;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Parameter;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Reference;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\TypedReference;
use _PhpScoper9385100df341\Symfony\Component\DependencyInjection\Variable;
use _PhpScoper9385100df341\Symfony\Component\ErrorHandler\DebugClassLoader;
use _PhpScoper9385100df341\Symfony\Component\ExpressionLanguage\Expression;
 ...
 */
class PhpDumper extends \_PhpScoper9385100df341\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
...
use _PhpScoper9385100df341\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use _PhpScoper9385100df341\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use _PhpScoper9385100df341\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use _PhpScoper9385100df341\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use _PhpScoper9385100df341\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use _PhpScoper9385100df341\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use _PhpScoper9385100df341\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists(\_PhpScoper9385100df341\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
