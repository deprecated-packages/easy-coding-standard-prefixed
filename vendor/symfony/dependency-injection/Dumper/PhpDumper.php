...
use _PhpScoper91fe47cd7f25\Composer\Autoload\ClassLoader;
use _PhpScoper91fe47cd7f25\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
...
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Container;
...
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Exception\LogicException;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\ExpressionLanguage;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Loader\FileLoader;
...
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\TypedReference;
use _PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Variable;
use _PhpScoper91fe47cd7f25\Symfony\Component\ErrorHandler\DebugClassLoader;
use _PhpScoper91fe47cd7f25\Symfony\Component\ExpressionLanguage\Expression;
use _PhpScoper91fe47cd7f25\Symfony\Component\HttpKernel\Kernel;
/**
 ...
 */
class PhpDumper extends \_PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
...
use _PhpScoper91fe47cd7f25\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use _PhpScoper91fe47cd7f25\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use _PhpScoper91fe47cd7f25\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use _PhpScoper91fe47cd7f25\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use _PhpScoper91fe47cd7f25\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use _PhpScoper91fe47cd7f25\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use _PhpScoper91fe47cd7f25\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists(\_PhpScoper91fe47cd7f25\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
