 ...
 */
namespace _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Dumper;

use _PhpScoper3c44535fe75f\Composer\Autoload\ClassLoader;
use _PhpScoper3c44535fe75f\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
...
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
...
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Exception\LogicException;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\ExpressionLanguage;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Loader\FileLoader;
...
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\TypedReference;
use _PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Variable;
use _PhpScoper3c44535fe75f\Symfony\Component\ErrorHandler\DebugClassLoader;
 ...
 */
class PhpDumper extends \_PhpScoper3c44535fe75f\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
...
use _PhpScoper3c44535fe75f\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use _PhpScoper3c44535fe75f\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use _PhpScoper3c44535fe75f\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use _PhpScoper3c44535fe75f\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use _PhpScoper3c44535fe75f\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            if (!\class_exists(\_PhpScoper3c44535fe75f\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
