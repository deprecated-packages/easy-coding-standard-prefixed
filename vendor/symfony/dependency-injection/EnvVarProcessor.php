 ...
 */
class EnvVarProcessor implements \_PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\EnvVarProcessorInterface
{
    private $container;
    private $loaders;
    private $loadedVars = [];
     ...
     */
    public function __construct(\_PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\ContainerInterface $container, \Traversable $loaders = null)
    {
