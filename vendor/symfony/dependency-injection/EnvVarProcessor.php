 ...
 */
class EnvVarProcessor implements \_PhpScoper0752b31150a1\Symfony\Component\DependencyInjection\EnvVarProcessorInterface
{
    private $container;
    private $loaders;
    private $loadedVars = [];
     ...
     */
    public function __construct(\_PhpScoper0752b31150a1\Symfony\Component\DependencyInjection\ContainerInterface $container, \Traversable $loaders = null)
    {
