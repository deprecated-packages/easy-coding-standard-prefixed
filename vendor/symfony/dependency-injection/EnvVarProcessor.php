 ...
 */
class EnvVarProcessor implements \_PhpScoper53db80252f28\Symfony\Component\DependencyInjection\EnvVarProcessorInterface
{
    private $container;
    private $loaders;
    private $loadedVars = [];
     ...
     */
    public function __construct(\_PhpScoper53db80252f28\Symfony\Component\DependencyInjection\ContainerInterface $container, \Traversable $loaders = null)
    {
