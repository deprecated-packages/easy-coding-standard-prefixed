 ...
 */
namespace _PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection;

use _PhpScoper32abeec2fe5a\Psr\Container\ContainerExceptionInterface;
use _PhpScoper32abeec2fe5a\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper32abeec2fe5a\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper32abeec2fe5a\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper32abeec2fe5a\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper32abeec2fe5a\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
