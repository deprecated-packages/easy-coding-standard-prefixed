 ...
 */
namespace _PhpScoper6b1da46bea54\Symfony\Component\DependencyInjection;

use _PhpScoper6b1da46bea54\Psr\Container\ContainerExceptionInterface;
use _PhpScoper6b1da46bea54\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper6b1da46bea54\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper6b1da46bea54\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper6b1da46bea54\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper6b1da46bea54\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
