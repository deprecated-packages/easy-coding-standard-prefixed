 ...
 */
namespace _PhpScoper855b7fb41c61\Symfony\Component\DependencyInjection;

use _PhpScoper855b7fb41c61\Psr\Container\ContainerExceptionInterface;
use _PhpScoper855b7fb41c61\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper855b7fb41c61\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper855b7fb41c61\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper855b7fb41c61\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper855b7fb41c61\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
