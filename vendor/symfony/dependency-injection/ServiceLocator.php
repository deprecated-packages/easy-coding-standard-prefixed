...
use _PhpScoper1c0f546920a5\Psr\Container\ContainerExceptionInterface;
use _PhpScoper1c0f546920a5\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper1c0f546920a5\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper1c0f546920a5\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper1c0f546920a5\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper1c0f546920a5\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
