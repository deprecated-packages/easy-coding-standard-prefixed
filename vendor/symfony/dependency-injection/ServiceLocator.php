...
use _PhpScoperd47a2fa2a77e\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoperd47a2fa2a77e\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
 * @author Robin Chalas <robin.chalas@gmail.com>
 * @author Nicolas Grekas <p@tchwork.com>
 */
class ServiceLocator implements \_PhpScoperd47a2fa2a77e\Symfony\Contracts\Service\ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoperd47a2fa2a77e\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
    ...
    private function createNotFoundException(string $id) : \_PhpScoperd47a2fa2a77e\Psr\Container\NotFoundExceptionInterface
    {
        if ($this->loading) {
            ...
            return new \_PhpScoperd47a2fa2a77e\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], $msg);
        }
        ...
        if (!$this->container) {
            ...
            try {
                ...
                $class = null;
            } catch (\_PhpScoperd47a2fa2a77e\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException $e) {
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \_PhpScoperd47a2fa2a77e\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            $msg[] = \sprintf('Unless you need extra laziness, try using dependency injection instead. Otherwise, you need to declare it using "%s::getSubscribedServices()".', \preg_replace('/([^\\\\]++\\\\)++/', '', $class));
        } else {
            $msg[] = 'Try using dependency injection instead.';
        }
        return new \_PhpScoperd47a2fa2a77e\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], \implode(' ', $msg));
    }
    ...
    {
        return new \_PhpScoperd47a2fa2a77e\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, $path);
    }
