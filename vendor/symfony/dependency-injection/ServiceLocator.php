...
use _PhpScoper1ddca3f92d7d\Psr\Container\ContainerExceptionInterface;
use _PhpScoper1ddca3f92d7d\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper1ddca3f92d7d\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper1ddca3f92d7d\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper1ddca3f92d7d\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper1ddca3f92d7d\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
