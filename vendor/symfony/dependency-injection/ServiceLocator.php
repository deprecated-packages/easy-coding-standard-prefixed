...
use _PhpScoper08fb1f8a2f44\Psr\Container\ContainerExceptionInterface;
use _PhpScoper08fb1f8a2f44\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper08fb1f8a2f44\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper08fb1f8a2f44\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper08fb1f8a2f44\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper08fb1f8a2f44\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
