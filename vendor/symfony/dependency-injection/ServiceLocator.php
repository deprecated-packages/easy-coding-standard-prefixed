...
use _PhpScoper6ffa0951a2e9\Psr\Container\ContainerExceptionInterface;
use _PhpScoper6ffa0951a2e9\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper6ffa0951a2e9\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper6ffa0951a2e9\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper6ffa0951a2e9\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper6ffa0951a2e9\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
