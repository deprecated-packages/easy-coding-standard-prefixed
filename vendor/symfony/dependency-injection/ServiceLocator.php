...
use _PhpScoper91fe47cd7f25\Psr\Container\ContainerExceptionInterface;
use _PhpScoper91fe47cd7f25\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper91fe47cd7f25\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper91fe47cd7f25\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper91fe47cd7f25\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
