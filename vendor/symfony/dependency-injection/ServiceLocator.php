...
use _PhpScoper2d11f18408ea\Psr\Container\ContainerExceptionInterface;
use _PhpScoper2d11f18408ea\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper2d11f18408ea\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper2d11f18408ea\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper2d11f18408ea\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper2d11f18408ea\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
