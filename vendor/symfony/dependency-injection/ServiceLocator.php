 ...
 */
namespace _PhpScoperc5e9eb67638f\Symfony\Component\DependencyInjection;

use _PhpScoperc5e9eb67638f\Psr\Container\ContainerExceptionInterface;
use _PhpScoperc5e9eb67638f\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoperc5e9eb67638f\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoperc5e9eb67638f\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoperc5e9eb67638f\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoperc5e9eb67638f\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
