...
use _PhpScoper53db80252f28\Psr\Container\ContainerExceptionInterface;
use _PhpScoper53db80252f28\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper53db80252f28\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper53db80252f28\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper53db80252f28\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper53db80252f28\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
