...
use _PhpScoper0752b31150a1\Psr\Container\ContainerExceptionInterface;
use _PhpScoper0752b31150a1\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper0752b31150a1\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper0752b31150a1\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper0752b31150a1\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper0752b31150a1\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
