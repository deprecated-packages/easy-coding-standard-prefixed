 ...
 */
namespace _PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection;

use _PhpScoper130a9a1cd4a2\Psr\Container\ContainerExceptionInterface;
use _PhpScoper130a9a1cd4a2\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper130a9a1cd4a2\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper130a9a1cd4a2\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper130a9a1cd4a2\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper130a9a1cd4a2\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
