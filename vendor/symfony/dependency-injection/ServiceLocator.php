...
use _PhpScoper0a055416a443\Psr\Container\ContainerExceptionInterface;
use _PhpScoper0a055416a443\Psr\Container\NotFoundExceptionInterface;
...
use _PhpScoper0a055416a443\Symfony\Contracts\Service\ServiceLocatorTrait;
use _PhpScoper0a055416a443\Symfony\Contracts\Service\ServiceProviderInterface;
use _PhpScoper0a055416a443\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
...
class ServiceLocator implements ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \_PhpScoper0a055416a443\Symfony\Component\DependencyInjection\Container $container) : self
    {
        $locator = clone $this;
