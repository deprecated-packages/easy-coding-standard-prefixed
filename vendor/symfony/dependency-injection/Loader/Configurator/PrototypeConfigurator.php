 ...
 */
class PrototypeConfigurator extends \_PhpScoper890197fe38f7\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    ...
    private $excludes;
    private $allowParent;
    public function __construct(\_PhpScoper890197fe38f7\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, PhpFileLoader $loader, Definition $defaults, string $namespace, string $resource, bool $allowParent)
    {
