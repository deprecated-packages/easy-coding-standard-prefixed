 ...
 */
class PrototypeConfigurator extends \_PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    ...
    private $excludes;
    private $allowParent;
    public function __construct(\_PhpScoper91fe47cd7f25\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, PhpFileLoader $loader, Definition $defaults, string $namespace, string $resource, bool $allowParent)
    {
