 ...
 */
class PrototypeConfigurator extends \_PhpScoper757c066053f8\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    ...
    private $excludes;
    private $allowParent;
    public function __construct(\_PhpScoper757c066053f8\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, PhpFileLoader $loader, Definition $defaults, string $namespace, string $resource, bool $allowParent)
    {
