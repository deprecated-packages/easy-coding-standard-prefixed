 ...
 */
class PrototypeConfigurator extends \_PhpScoperfd70a7e8e84f\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    const FACTORY = 'load';
    ...
    private $excludes;
    private $allowParent;
    public function __construct(\_PhpScoperfd70a7e8e84f\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, \_PhpScoperfd70a7e8e84f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader $loader, \_PhpScoperfd70a7e8e84f\Symfony\Component\DependencyInjection\Definition $defaults, string $namespace, string $resource, bool $allowParent)
    {
