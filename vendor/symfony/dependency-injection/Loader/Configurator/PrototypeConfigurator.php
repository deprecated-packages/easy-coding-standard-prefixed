 ...
 */
class PrototypeConfigurator extends \_PhpScoper27cac5a8b4ab\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    ...
    private $excludes;
    private $allowParent;
    public function __construct(\_PhpScoper27cac5a8b4ab\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, PhpFileLoader $loader, Definition $defaults, string $namespace, string $resource, bool $allowParent)
    {
