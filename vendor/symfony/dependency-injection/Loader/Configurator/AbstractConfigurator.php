...
abstract class AbstractConfigurator
{
    ...
    public static function processValue($value, $allowServices = \false)
    {
        ...
        if ($value instanceof \_PhpScopere7e518ee6a5b\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator) {
            return new Reference($value->id, $value->invalidBehavior);
        }
        if ($value instanceof \_PhpScopere7e518ee6a5b\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator) {
