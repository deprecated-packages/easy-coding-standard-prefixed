...
abstract class AbstractConfigurator
{
    ...
    public static function processValue($value, $allowServices = \false)
    {
        ...
        if ($value instanceof \_PhpScoperd51690aa3091\Symfony\Component\DependencyInjection\Loader\Configurator\ReferenceConfigurator) {
            return new Reference($value->id, $value->invalidBehavior);
        }
        if ($value instanceof \_PhpScoperd51690aa3091\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator) {
