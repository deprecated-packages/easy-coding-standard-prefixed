 ...
 */
class IniFileLoader extends \_PhpScoper5c006f5f032f\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    /**
     * {@inheritdoc}
     */
    public function load($resource, string $type = null)
    {
        ...
        if (\false === $result || [] === $result) {
            throw new \_PhpScoper5c006f5f032f\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" file is not valid.', $resource));
        }
        // real raw parsing
    ...
    private function phpize(string $value)
    {
        ...
        switch (\true) {
            ...
            default:
                return \_PhpScoper5c006f5f032f\Symfony\Component\Config\Util\XmlUtils::phpize($value);
        }
    }
}
