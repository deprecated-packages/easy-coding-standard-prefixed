 ...
 */
class TypedReference extends \_PhpScoper66292c14b658\Symfony\Component\DependencyInjection\Reference
{
    private $type;
    private $name;
     ...
     */
    public function __construct(string $id, string $type, $invalidBehavior = \_PhpScoper66292c14b658\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, $name = null)
    {
        if (\is_string($invalidBehavior ?? '') || \is_int($name)) {
            ...
            $invalidBehavior = 3 < \func_num_args() ? \func_get_arg(3) : \_PhpScoper66292c14b658\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
        } else {
