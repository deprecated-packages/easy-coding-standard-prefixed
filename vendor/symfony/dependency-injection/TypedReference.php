 ...
 */
class TypedReference extends \_PhpScoperd4c5032f0671\Symfony\Component\DependencyInjection\Reference
{
    private $type;
    private $name;
     ...
     */
    public function __construct(string $id, string $type, $invalidBehavior = \_PhpScoperd4c5032f0671\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, $name = null)
    {
        if (\is_string($invalidBehavior ?? '') || \is_int($name)) {
            ...
            $invalidBehavior = 3 < \func_num_args() ? \func_get_arg(3) : \_PhpScoperd4c5032f0671\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
        } else {
