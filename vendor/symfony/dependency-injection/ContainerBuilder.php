...
use _PhpScoperc7a2896cc805\Symfony\Component\Config\Resource\ComposerResource;
use _PhpScoperc7a2896cc805\Symfony\Component\Config\Resource\DirectoryResource;
use _PhpScoperc7a2896cc805\Symfony\Component\Config\Resource\FileExistenceResource;
use _PhpScoperc7a2896cc805\Symfony\Component\Config\Resource\FileResource;
use _PhpScoperc7a2896cc805\Symfony\Component\Config\Resource\GlobResource;
use _PhpScoperc7a2896cc805\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Compiler\Compiler;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
...
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use _PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
use _PhpScoperc7a2896cc805\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
 * ContainerBuilder is a DI container that provides an API to easily describe services.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class ContainerBuilder extends \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Container implements \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\TaggedContainerInterface
{
    /**
    ...
    public function __construct(ParameterBagInterface $parameterBag = null)
    {
        ...
        $this->setDefinition('service_container', (new \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Definition(\_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::class))->setSynthetic(\true)->setPublic(\true));
        $this->setAlias(PsrContainerInterface::class, new \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Alias('service_container', \false))->setDeprecated('symfony/dependency-injection', '5.1', $deprecationMessage = 'The "%alias_id%" autowiring alias is deprecated. Define it explicitly in your app if you want to keep using it.');
        $this->setAlias(\_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::class, new \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Alias('service_container', \false))->setDeprecated('symfony/dependency-injection', '5.1', $deprecationMessage);
    }
    /**
     ...
     * @see Reference
     */
    public function get($id, int $invalidBehavior = \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE)
    {
        if ($this->isCompiled() && isset($this->removedIds[$id = (string) $id]) && \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE >= $invalidBehavior) {
            return parent::get($id);
        }
        return $this->doGet($id, $invalidBehavior);
    }
    private function doGet(string $id, int $invalidBehavior = \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, array &$inlineServices = null, bool $isConstructorArgument = \false)
    {
        ...
        try {
            if (\_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $invalidBehavior) {
                return parent::get($id, $invalidBehavior);
            }
            if ($service = parent::get($id, \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE)) {
                return $service;
            }
    ...
    public function setAlias(string $alias, $id)
    {
        ...
        if (\is_string($id)) {
            $id = new \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Alias($id);
        } elseif (!$id instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Alias) {
    ...
    {
        return $this->setDefinition($id, new \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Definition($class));
    }
    /**
    ...
    {
        return $this->setDefinition($id, (new \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Definition($class))->setAutowired(\true));
    }
    /**
     ...
     * @throws BadMethodCallException When this ContainerBuilder is compiled
     */
    public function setDefinition(string $id, \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Definition $definition)
    {
        if ($this->isCompiled()) {
     ...
     */
    private function createService(\_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Definition $definition, array &$inlineServices, bool $isConstructorArgument = \false, string $id = null, bool $tryProxy = \true)
    {
        if (null === $id && isset($inlineServices[$h = \spl_object_hash($definition)])) {
            return $inlineServices[$h];
        }
        if ($definition instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ChildDefinition) {
        ...
        if ($callable = $definition->getConfigurator()) {
            if (\is_array($callable)) {
                ...
                if ($callable[0] instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Reference) {
                    $callable[0] = $this->doGet((string) $callable[0], $callable[0]->getInvalidBehavior(), $inlineServices);
                } elseif ($callable[0] instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Definition) {
    ...
    private function doResolveServices($value, array &$inlineServices = [], bool $isConstructorArgument = \false)
    {
        if (\is_array($value)) {
            ...
            $value = new RewindableGenerator(function () use($value, &$inlineServices) {
                foreach ($value->getValues() as $k => $v) {
                    ...
                    foreach (self::getInitializedConditionals($v) as $s) {
                        if (!$this->doGet($s, \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE, $inlineServices)) {
                            continue 2;
                        }
                    }
                ...
                foreach ($value->getValues() as $v) {
                    ...
                    foreach (self::getInitializedConditionals($v) as $s) {
                        if (!$this->doGet($s, \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE)) {
                            continue 2;
                        }
                    }
                    ++$count;
            ...
            foreach ($value->getValues() as $k => $v) {
                if ($v) {
                    $refs[$k] = [$v];
                    $types[$k] = $v instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\TypedReference ? $v->getType() : '?';
                }
            }
            $value = new ServiceLocator(\Closure::fromCallable([$this, 'resolveServices']), $refs, $types);
        } elseif ($value instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Reference) {
            $value = $this->doGet((string) $value, $value->getInvalidBehavior(), $inlineServices, $isConstructorArgument);
        } elseif ($value instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Definition) {
            $value = $this->createService($value, $inlineServices, $isConstructorArgument);
        } elseif ($value instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Parameter) {
    ...
    {
        if (!isset($this->autoconfiguredInstanceof[$interface])) {
            $this->autoconfiguredInstanceof[$interface] = new \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ChildDefinition('');
        }
     ...
     */
    public function registerAliasForArgument(string $id, string $type, string $name = null) : \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Alias
    {
    ...
    public function resolveEnvPlaceholders($value, $format = null, array &$usedEnvs = null)
    {
        ...
        if ($value instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Definition) {
            $value = (array) $value;
        }
        if (\is_array($value)) {
            $result = [];
    ...
    public static function getServiceConditionals($value) : array
    {
        ...
        } elseif ($value instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Reference && \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE === $value->getInvalidBehavior()) {
    ...
    public static function getInitializedConditionals($value) : array
    {
        ...
        } elseif ($value instanceof \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Reference && \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $value->getInvalidBehavior()) {
            $services[] = (string) $value;
        }
        return $services;
    }
     ...
     * @param mixed $service
     */
    private function shareService(\_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\Definition $definition, $service, ?string $id, array &$inlineServices)
    {
    ...
    private function getExpressionLanguage() : \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ExpressionLanguage
    {
        if (null === $this->expressionLanguage) {
            ...
            $this->expressionLanguage = new \_PhpScoperc7a2896cc805\Symfony\Component\DependencyInjection\ExpressionLanguage(null, $this->expressionLanguageProviders);
        }
