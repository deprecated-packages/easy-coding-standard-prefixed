 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoper3f3a54dd086f\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoper3f3a54dd086f\Symfony\Contracts\Service\Attribute\Required::class)) {
