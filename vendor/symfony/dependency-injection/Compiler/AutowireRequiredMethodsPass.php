 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoper7faa8deb0d3c\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoper7faa8deb0d3c\Symfony\Contracts\Service\Attribute\Required::class)) {
