 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoper0c0702cca4ac\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoper0c0702cca4ac\Symfony\Contracts\Service\Attribute\Required::class)) {
