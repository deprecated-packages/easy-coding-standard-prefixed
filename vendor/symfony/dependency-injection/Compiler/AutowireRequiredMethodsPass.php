 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoperf6b7f9bf122d\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoperf6b7f9bf122d\Symfony\Contracts\Service\Attribute\Required::class)) {
