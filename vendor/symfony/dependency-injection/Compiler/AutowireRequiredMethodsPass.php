 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoperc7096eb2567d\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoperc7096eb2567d\Symfony\Contracts\Service\Attribute\Required::class)) {
