 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoper8ca6426d4e0c\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoper8ca6426d4e0c\Symfony\Contracts\Service\Attribute\Required::class)) {
