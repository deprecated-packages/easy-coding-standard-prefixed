 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoper842c7347e6be\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoper842c7347e6be\Symfony\Contracts\Service\Attribute\Required::class)) {
