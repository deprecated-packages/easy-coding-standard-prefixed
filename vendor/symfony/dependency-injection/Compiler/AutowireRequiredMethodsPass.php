 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoper5e93f39f19fe\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoper5e93f39f19fe\Symfony\Contracts\Service\Attribute\Required::class)) {
