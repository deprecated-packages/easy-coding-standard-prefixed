 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoper488221d5cc83\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoper488221d5cc83\Symfony\Contracts\Service\Attribute\Required::class)) {
