 ...
 */
class AutowireRequiredMethodsPass extends \_PhpScoper8a7636b3fdaf\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\_PhpScoper8a7636b3fdaf\Symfony\Contracts\Service\Attribute\Required::class)) {
