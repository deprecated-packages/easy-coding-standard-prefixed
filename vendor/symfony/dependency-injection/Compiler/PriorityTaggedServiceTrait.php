        ...
        foreach ($container->findTaggedServiceIds($tagName, \true) as $serviceId => $attributes) {
            ...
            foreach ($attributes as $attribute) {
                ...
                if (isset($attribute['priority'])) {
                    ...
                    $defaultPriority = \_PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Compiler\PriorityTaggedServiceUtil::getDefaultPriority($container, $serviceId, $class, $defaultPriorityMethod, $tagName);
                }
                ...
                if (null !== $indexAttribute && isset($attribute[$indexAttribute])) {
                    ...
                    $defaultIndex = \_PhpScopera9d6a31d814c\Symfony\Component\DependencyInjection\Compiler\PriorityTaggedServiceUtil::getDefaultIndex($container, $serviceId, $class, $defaultIndexMethod ?? 'getDefaultName', $tagName, $indexAttribute);
                }
