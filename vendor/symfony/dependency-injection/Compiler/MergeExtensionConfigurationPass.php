...
use _PhpScoper4c15c250a340\Symfony\Component\DependencyInjection\Extension\Extension;
use _PhpScoper4c15c250a340\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use _PhpScoper4c15c250a340\Symfony\Component\DependencyInjection\Extension\PrependExtensionInterface;
 ...
 */
class MergeExtensionConfigurationPass implements \_PhpScoper4c15c250a340\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * {@inheritdoc}
     */
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($container->getExtensions() as $name => $extension) {
            ...
            if ($resolvingBag instanceof EnvPlaceholderParameterBag && $extension instanceof Extension) {
                ...
                $resolvingBag = new \_PhpScoper4c15c250a340\Symfony\Component\DependencyInjection\Compiler\MergeExtensionConfigurationParameterBag($resolvingBag);
                if ($configAvailable) {
            ...
            try {
                $tmpContainer = new \_PhpScoper4c15c250a340\Symfony\Component\DependencyInjection\Compiler\MergeExtensionConfigurationContainerBuilder($extension, $resolvingBag);
                ...
                if ($resolvingBag instanceof \_PhpScoper4c15c250a340\Symfony\Component\DependencyInjection\Compiler\MergeExtensionConfigurationParameterBag) {
...
class MergeExtensionConfigurationContainerBuilder extends ContainerBuilder
{
     ...
     * {@inheritdoc}
     */
    public function addCompilerPass(\_PhpScoper4c15c250a340\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface $pass, string $type = \_PhpScoper4c15c250a340\Symfony\Component\DependencyInjection\Compiler\PassConfig::TYPE_BEFORE_OPTIMIZATION, int $priority = 0) : self
    {
