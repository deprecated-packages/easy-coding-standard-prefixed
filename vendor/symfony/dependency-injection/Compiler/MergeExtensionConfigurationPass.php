...
use _PhpScopercfeba9d8ad31\Symfony\Component\Config\Definition\BaseNode;
...
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Extension\ConfigurationExtensionInterface;
...
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Extension\PrependExtensionInterface;
use _PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
 ...
 */
class MergeExtensionConfigurationPass implements \_PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * {@inheritdoc}
     */
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($container->getExtensions() as $name => $extension) {
            ...
            if ($resolvingBag instanceof EnvPlaceholderParameterBag && $extension instanceof Extension) {
                ...
                $resolvingBag = new \_PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Compiler\MergeExtensionConfigurationParameterBag($resolvingBag);
                if ($configAvailable) {
            ...
            try {
                $tmpContainer = new \_PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Compiler\MergeExtensionConfigurationContainerBuilder($extension, $resolvingBag);
                ...
                if ($resolvingBag instanceof \_PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Compiler\MergeExtensionConfigurationParameterBag) {
...
class MergeExtensionConfigurationContainerBuilder extends ContainerBuilder
{
     ...
     * {@inheritdoc}
     */
    public function addCompilerPass(\_PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface $pass, string $type = \_PhpScopercfeba9d8ad31\Symfony\Component\DependencyInjection\Compiler\PassConfig::TYPE_BEFORE_OPTIMIZATION, int $priority = 0) : self
    {
