 ...
 */
class RemoveUnusedDefinitionsPass extends \_PhpScoper0d0ee1ba46d4\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass implements \_PhpScoper0d0ee1ba46d4\Symfony\Component\DependencyInjection\Compiler\RepeatablePassInterface
{
    private $connectedIds = [];
    /**
     * {@inheritdoc}
     */
    public function setRepeatedPass(\_PhpScoper0d0ee1ba46d4\Symfony\Component\DependencyInjection\Compiler\RepeatedPass $repeatedPass)
    {
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if (\_PhpScoper0d0ee1ba46d4\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior()) {
