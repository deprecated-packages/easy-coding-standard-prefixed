 ...
 */
class RemoveUnusedDefinitionsPass extends \_PhpScoperb09c3ec8e01a\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass implements \_PhpScoperb09c3ec8e01a\Symfony\Component\DependencyInjection\Compiler\RepeatablePassInterface
{
    private $connectedIds = [];
    /**
     * {@inheritdoc}
     */
    public function setRepeatedPass(\_PhpScoperb09c3ec8e01a\Symfony\Component\DependencyInjection\Compiler\RepeatedPass $repeatedPass)
    {
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if (\_PhpScoperb09c3ec8e01a\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior()) {
