 ...
 */
class RemoveUnusedDefinitionsPass extends \_PhpScoperb6d4bd368bd9\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass implements \_PhpScoperb6d4bd368bd9\Symfony\Component\DependencyInjection\Compiler\RepeatablePassInterface
{
    private $connectedIds = [];
    /**
     * {@inheritdoc}
     */
    public function setRepeatedPass(\_PhpScoperb6d4bd368bd9\Symfony\Component\DependencyInjection\Compiler\RepeatedPass $repeatedPass)
    {
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if (\_PhpScoperb6d4bd368bd9\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior()) {
