 ...
 */
class RemoveUnusedDefinitionsPass extends \_PhpScopera238de2e9b5a\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass implements \_PhpScopera238de2e9b5a\Symfony\Component\DependencyInjection\Compiler\RepeatablePassInterface
{
    private $connectedIds = [];
    /**
     * {@inheritdoc}
     */
    public function setRepeatedPass(\_PhpScopera238de2e9b5a\Symfony\Component\DependencyInjection\Compiler\RepeatedPass $repeatedPass)
    {
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if (\_PhpScopera238de2e9b5a\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior()) {
