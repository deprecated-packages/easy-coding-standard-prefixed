 ...
 */
class RemoveUnusedDefinitionsPass extends \_PhpScoper3e1e0e5bb8ef\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass implements \_PhpScoper3e1e0e5bb8ef\Symfony\Component\DependencyInjection\Compiler\RepeatablePassInterface
{
    private $connectedIds = [];
    /**
     * {@inheritdoc}
     */
    public function setRepeatedPass(\_PhpScoper3e1e0e5bb8ef\Symfony\Component\DependencyInjection\Compiler\RepeatedPass $repeatedPass)
    {
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if (\_PhpScoper3e1e0e5bb8ef\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior()) {
