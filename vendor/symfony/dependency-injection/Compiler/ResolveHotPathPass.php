 ...
 */
class ResolveHotPathPass extends \_PhpScoper89c09b8e7101\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $tagName;
    private $resolvedIds = [];
    ...
    {
        if ($value instanceof \_PhpScoper89c09b8e7101\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            return $value;
        }
        if ($value instanceof \_PhpScoper89c09b8e7101\Symfony\Component\DependencyInjection\Definition && $isRoot) {
