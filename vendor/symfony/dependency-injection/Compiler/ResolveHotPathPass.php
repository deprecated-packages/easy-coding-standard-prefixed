 ...
 */
class ResolveHotPathPass extends \_PhpScoperfd70a7e8e84f\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $tagName;
    private $resolvedIds = [];
    ...
    {
        if ($value instanceof \_PhpScoperfd70a7e8e84f\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            return $value;
        }
        if ($value instanceof \_PhpScoperfd70a7e8e84f\Symfony\Component\DependencyInjection\Definition && $isRoot) {
        ...
        if ($value instanceof \_PhpScoperfd70a7e8e84f\Symfony\Component\DependencyInjection\Reference && \_PhpScoperfd70a7e8e84f\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior() && $this->container->hasDefinition($id = (string) $value)) {
