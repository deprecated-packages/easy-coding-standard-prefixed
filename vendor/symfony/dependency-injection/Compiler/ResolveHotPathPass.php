 ...
 */
class ResolveHotPathPass extends \_PhpScoper069ebd53a518\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $tagName;
    private $resolvedIds = [];
    ...
    {
        if ($value instanceof \_PhpScoper069ebd53a518\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            return $value;
        }
        if ($value instanceof \_PhpScoper069ebd53a518\Symfony\Component\DependencyInjection\Definition && $isRoot) {
        ...
        if ($value instanceof \_PhpScoper069ebd53a518\Symfony\Component\DependencyInjection\Reference && \_PhpScoper069ebd53a518\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior() && $this->container->hasDefinition($id = (string) $value)) {
