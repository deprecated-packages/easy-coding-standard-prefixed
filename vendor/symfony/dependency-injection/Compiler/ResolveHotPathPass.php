 ...
 */
class ResolveHotPathPass extends \_PhpScopera23ebff5477f\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $tagName;
    private $resolvedIds = [];
    ...
    {
        if ($value instanceof \_PhpScopera23ebff5477f\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            return $value;
        }
        if ($value instanceof \_PhpScopera23ebff5477f\Symfony\Component\DependencyInjection\Definition && $isRoot) {
        ...
        if ($value instanceof \_PhpScopera23ebff5477f\Symfony\Component\DependencyInjection\Reference && \_PhpScopera23ebff5477f\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior() && $this->container->hasDefinition($id = (string) $value)) {
