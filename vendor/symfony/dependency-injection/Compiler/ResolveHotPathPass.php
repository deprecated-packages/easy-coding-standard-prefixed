 ...
 */
class ResolveHotPathPass extends \_PhpScoper35ec99c463ee\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $tagName;
    private $resolvedIds = [];
    ...
    {
        if ($value instanceof \_PhpScoper35ec99c463ee\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            return $value;
        }
        if ($value instanceof \_PhpScoper35ec99c463ee\Symfony\Component\DependencyInjection\Definition && $isRoot) {
        ...
        if ($value instanceof \_PhpScoper35ec99c463ee\Symfony\Component\DependencyInjection\Reference && \_PhpScoper35ec99c463ee\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior() && $this->container->hasDefinition($id = (string) $value)) {
