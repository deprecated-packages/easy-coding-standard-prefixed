 ...
 */
class ResolveHotPathPass extends \_PhpScoperfcee700af3df\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $tagName;
    private $resolvedIds = [];
    ...
    {
        if ($value instanceof \_PhpScoperfcee700af3df\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            return $value;
        }
        if ($value instanceof \_PhpScoperfcee700af3df\Symfony\Component\DependencyInjection\Definition && $isRoot) {
