...
class ServiceReferenceGraphNode
{
    ...
    public function addInEdge(\_PhpScoper1ddca3f92d7d\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphEdge $edge)
    {
        $this->inEdges[] = $edge;
    }
    public function addOutEdge(\_PhpScoper1ddca3f92d7d\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphEdge $edge)
    {
        $this->outEdges[] = $edge;
    }
    /**
