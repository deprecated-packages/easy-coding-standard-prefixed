 ...
 */
class InlineServiceDefinitionsPass extends \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass implements \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Compiler\RepeatablePassInterface
{
    ...
    private $inlinedIds = [];
    private $graph;
    public function __construct(\_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass $analyzingPass = null)
    {
    ...
    public function process(\_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        if ($this->analyzingPass) {
            $analyzedContainer = new \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\ContainerBuilder();
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if ($value instanceof \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Definition && $this->cloningIds) {
            if ($value->isShared()) {
                return $value;
            }
            $value = clone $value;
        ...
        if (isset($this->cloningIds[$id])) {
            ...
            $ids[] = $id;
            throw new \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_slice($ids, \array_search($id, $ids)));
        }
     ...
     */
    private function isInlineableDefinition(string $id, \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ($srcCount > 1 && \is_array($factory = $definition->getFactory()) && ($factory[0] instanceof \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Reference || $factory[0] instanceof \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Definition)) {
            return \false;
        }
