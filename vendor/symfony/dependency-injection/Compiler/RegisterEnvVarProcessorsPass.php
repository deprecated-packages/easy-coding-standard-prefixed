...
use _PhpScoper8a1ea80774eb\Symfony\Component\DependencyInjection\EnvVarProcessor;
use _PhpScoper8a1ea80774eb\Symfony\Component\DependencyInjection\EnvVarProcessorInterface;
 ...
 */
class RegisterEnvVarProcessorsPass implements \_PhpScoper8a1ea80774eb\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        if ($processors) {
            $container->setAlias('container.env_var_processors_locator', (string) \_PhpScoper8a1ea80774eb\Symfony\Component\DependencyInjection\Compiler\ServiceLocatorTagPass::register($container, $processors))->setPublic(\true);
        }
    }
