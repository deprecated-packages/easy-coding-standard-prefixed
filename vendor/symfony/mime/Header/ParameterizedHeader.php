...
use _PhpScoper5384d7276e1f\Symfony\Component\Mime\Encoder\Rfc2231Encoder;
/**
 * @author Chris Corbyn
 *
 * @experimental in 4.3
 */
final class ParameterizedHeader extends \_PhpScoper5384d7276e1f\Symfony\Component\Mime\Header\UnstructuredHeader
{
    /**
    ...
    public function __construct(string $name, string $value, array $parameters = [])
    {
        ...
        if ('content-disposition' === \strtolower($name)) {
            $this->encoder = new \_PhpScoper5384d7276e1f\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
        }
    }
