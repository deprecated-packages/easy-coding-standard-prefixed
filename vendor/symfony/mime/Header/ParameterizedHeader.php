...
use _PhpScoperdaf95aff095b\Symfony\Component\Mime\Encoder\Rfc2231Encoder;
/**
 * @author Chris Corbyn
 *
 * @experimental in 4.3
 */
final class ParameterizedHeader extends \_PhpScoperdaf95aff095b\Symfony\Component\Mime\Header\UnstructuredHeader
{
    /**
    ...
    public function __construct(string $name, string $value, array $parameters = [])
    {
        ...
        if ('content-disposition' === \strtolower($name)) {
            $this->encoder = new \_PhpScoperdaf95aff095b\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
        }
    }
