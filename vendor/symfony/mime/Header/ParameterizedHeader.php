 ...
 * @experimental in 4.3
 */
final class ParameterizedHeader extends \_PhpScoper239b374a39c8\Symfony\Component\Mime\Header\UnstructuredHeader
{
    /**
    ...
    public function __construct(string $name, string $value, array $parameters = [])
    {
        ...
        if ('content-disposition' === \strtolower($name)) {
            $this->encoder = new \_PhpScoper239b374a39c8\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
        }
    }
