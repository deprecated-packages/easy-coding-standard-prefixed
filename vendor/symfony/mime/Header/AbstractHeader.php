...
use _PhpScoper592524ba34f0\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder;
/**
 ...
 * @experimental in 4.3
 */
abstract class AbstractHeader implements \_PhpScoper592524ba34f0\Symfony\Component\Mime\Header\HeaderInterface
{
     ...
     */
    protected function createPhrase(\_PhpScoper592524ba34f0\Symfony\Component\Mime\Header\HeaderInterface $header, string $string, string $charset, bool $shorten = \false) : string
    {
     ...
     */
    protected function encodeWords(\_PhpScoper592524ba34f0\Symfony\Component\Mime\Header\HeaderInterface $header, string $input, int $usedLength = -1) : string
    {
        $value = '';
    ...
    protected function getTokenAsEncodedWord(string $token, int $firstLineOffset = 0) : string
    {
        if (null === self::$encoder) {
            self::$encoder = new \_PhpScoper592524ba34f0\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
        }
