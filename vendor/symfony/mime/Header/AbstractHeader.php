...
use _PhpScoper2f75f00bf6fa\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder;
/**
 ...
 * @experimental in 4.3
 */
abstract class AbstractHeader implements \_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\Header\HeaderInterface
{
     ...
     */
    protected function createPhrase(\_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\Header\HeaderInterface $header, string $string, string $charset, bool $shorten = \false) : string
    {
     ...
     */
    protected function encodeWords(\_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\Header\HeaderInterface $header, string $input, int $usedLength = -1) : string
    {
        $value = '';
    ...
    protected function getTokenAsEncodedWord(string $token, int $firstLineOffset = 0) : string
    {
        if (null === self::$encoder) {
            self::$encoder = new \_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
        }
