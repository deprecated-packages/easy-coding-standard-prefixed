 ...
 * @experimental in 4.3
 */
final class IdentificationHeader extends \_PhpScoperfb2c402b972b\Symfony\Component\Mime\Header\AbstractHeader
{
    private $ids = [];
    ...
    public function setIds(array $ids)
    {
        ...
        $this->idsAsAddresses = [];
        foreach ($ids as $id) {
            $this->idsAsAddresses[] = new \_PhpScoperfb2c402b972b\Symfony\Component\Mime\Address($id);
            $this->ids[] = $id;
        }
    }
    /**
