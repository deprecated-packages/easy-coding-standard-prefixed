 ...
 * @experimental in 4.3
 */
final class MailboxHeader extends \_PhpScopera061b8a47e36\Symfony\Component\Mime\Header\AbstractHeader
{
    private $address;
    ...
    public function getBodyAsString() : string
    {
        ...
        if ($this->address instanceof \_PhpScopera061b8a47e36\Symfony\Component\Mime\NamedAddress && ($name = $this->address->getName())) {
