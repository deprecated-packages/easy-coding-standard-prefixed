 ...
 * @experimental in 4.3
 */
abstract class AbstractMultipartPart extends \_PhpScopercf909b66eba8\Symfony\Component\Mime\Part\AbstractPart
{
    private $boundary;
    private $parts = [];
    public function __construct(\_PhpScopercf909b66eba8\Symfony\Component\Mime\Part\AbstractPart ...$parts)
    {
        parent::__construct();
