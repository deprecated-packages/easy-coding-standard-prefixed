 ...
 * @experimental in 4.3
 */
abstract class AbstractMultipartPart extends \_PhpScoper8e2d8a2760d1\Symfony\Component\Mime\Part\AbstractPart
{
    private $boundary;
    private $parts = [];
    public function __construct(\_PhpScoper8e2d8a2760d1\Symfony\Component\Mime\Part\AbstractPart ...$parts)
    {
        parent::__construct();
