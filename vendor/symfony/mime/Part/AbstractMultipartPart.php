 ...
 * @experimental in 4.3
 */
abstract class AbstractMultipartPart extends \_PhpScoperad4605bb9267\Symfony\Component\Mime\Part\AbstractPart
{
    private $boundary;
    private $parts = [];
    public function __construct(\_PhpScoperad4605bb9267\Symfony\Component\Mime\Part\AbstractPart ...$parts)
    {
        parent::__construct();
