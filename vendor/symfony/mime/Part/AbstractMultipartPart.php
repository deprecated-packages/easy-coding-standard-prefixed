 ...
 * @experimental in 4.3
 */
abstract class AbstractMultipartPart extends \_PhpScoper7cef7256eba6\Symfony\Component\Mime\Part\AbstractPart
{
    private $boundary;
    private $parts = [];
    public function __construct(\_PhpScoper7cef7256eba6\Symfony\Component\Mime\Part\AbstractPart ...$parts)
    {
        parent::__construct();
