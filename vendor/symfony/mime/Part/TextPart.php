...
use _PhpScoper7312d63d356f\Symfony\Component\Mime\Encoder\Base64ContentEncoder;
use _PhpScoper7312d63d356f\Symfony\Component\Mime\Encoder\ContentEncoderInterface;
use _PhpScoper7312d63d356f\Symfony\Component\Mime\Encoder\EightBitContentEncoder;
use _PhpScoper7312d63d356f\Symfony\Component\Mime\Encoder\QpContentEncoder;
 ...
 * @experimental in 4.3
 */
class TextPart extends \_PhpScoper7312d63d356f\Symfony\Component\Mime\Part\AbstractPart
{
    ...
    public function __construct($body, ?string $charset = 'utf-8', $subtype = 'plain', string $encoding = null)
    {
        ...
        if (null === $encoding) {
            ...
            if ('quoted-printable' !== $encoding && 'base64' !== $encoding && '8bit' !== $encoding) {
                throw new \_PhpScoper7312d63d356f\Symfony\Component\Mime\Exception\InvalidArgumentException(\sprintf('The encoding must be one of "quoted-printable", "base64", or "8bit" ("%s" given).', $encoding));
            }
    ...
    private function getEncoder() : \_PhpScoper7312d63d356f\Symfony\Component\Mime\Encoder\ContentEncoderInterface
    {
        if ('8bit' === $this->encoding) {
            return self::$encoders[$this->encoding] ?? (self::$encoders[$this->encoding] = new \_PhpScoper7312d63d356f\Symfony\Component\Mime\Encoder\EightBitContentEncoder());
        }
        if ('quoted-printable' === $this->encoding) {
            return self::$encoders[$this->encoding] ?? (self::$encoders[$this->encoding] = new \_PhpScoper7312d63d356f\Symfony\Component\Mime\Encoder\QpContentEncoder());
        }
        return self::$encoders[$this->encoding] ?? (self::$encoders[$this->encoding] = new \_PhpScoper7312d63d356f\Symfony\Component\Mime\Encoder\Base64ContentEncoder());
    }
