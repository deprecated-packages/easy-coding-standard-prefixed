...
use _PhpScopera51a90153f58\Symfony\Component\Mime\Header\IdentificationHeader;
...
class HeadersTest extends \_PhpScopera51a90153f58\PHPUnit\Framework\TestCase
{
    public function testAddMailboxListHeaderDelegatesToFactory()
    {
        $headers = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\Headers();
    ...
    {
        $headers = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\Headers();
        $headers->add(new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\UnstructuredHeader('X-Foo', 'bar'));
    ...
    {
        $header = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\IdentificationHeader('Message-ID', 'some@id');
        $headers = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\Headers();
        $headers->addIdHeader('Message-ID', 'some@id');
    ...
    {
        $header0 = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\UnstructuredHeader('X-Test', 'some@id');
        $header1 = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\UnstructuredHeader('X-Test', 'other@id');
        $header2 = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\UnstructuredHeader('X-Test', 'more@id');
        $headers = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\Headers();
        $headers->addTextHeader('X-Test', 'some@id');
        $headers->addTextHeader('X-Test', 'other@id');
    ...
    {
        $header0 = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\IdentificationHeader('Message-ID', 'some@id');
        $header1 = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\UnstructuredHeader('Subject', 'thing');
        $header2 = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\MailboxListHeader('To', [new \_PhpScopera51a90153f58\Symfony\Component\Mime\Address('person@example.org')]);
        $headers = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Header\Headers();
        $headers->addIdHeader('Message-ID', 'some@id');
        $headers->addTextHeader('Subject', 'thing');
        $headers->addMailboxListHeader('To', [new \_PhpScopera51a90153f58\Symfony\Component\Mime\Address('person@example.org')]);
