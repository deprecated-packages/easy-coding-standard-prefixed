...
use _PhpScoper0c236037eb04\Symfony\Component\Mime\Header\IdentificationHeader;
...
class HeadersTest extends \_PhpScoper0c236037eb04\PHPUnit\Framework\TestCase
{
    public function testAddMailboxListHeaderDelegatesToFactory()
    {
        $headers = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\Headers();
    ...
    {
        $headers = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\Headers();
        $headers->add(new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\UnstructuredHeader('X-Foo', 'bar'));
    ...
    {
        $header = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\IdentificationHeader('Message-ID', 'some@id');
        $headers = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\Headers();
        $headers->addIdHeader('Message-ID', 'some@id');
    ...
    {
        $header0 = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\UnstructuredHeader('X-Test', 'some@id');
        $header1 = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\UnstructuredHeader('X-Test', 'other@id');
        $header2 = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\UnstructuredHeader('X-Test', 'more@id');
        $headers = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\Headers();
        $headers->addTextHeader('X-Test', 'some@id');
        $headers->addTextHeader('X-Test', 'other@id');
    ...
    {
        $header0 = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\IdentificationHeader('Message-ID', 'some@id');
        $header1 = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\UnstructuredHeader('Subject', 'thing');
        $header2 = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\MailboxListHeader('To', [new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Address('person@example.org')]);
        $headers = new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Header\Headers();
        $headers->addIdHeader('Message-ID', 'some@id');
        $headers->addTextHeader('Subject', 'thing');
        $headers->addMailboxListHeader('To', [new \_PhpScoper0c236037eb04\Symfony\Component\Mime\Address('person@example.org')]);
