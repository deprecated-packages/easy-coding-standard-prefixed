...
class IdentificationHeaderTest extends \_PhpScoper13160cf3462c\PHPUnit\Framework\TestCase
{
    public function testValueMatchesMsgIdSpec()
    {
        /* -- RFC 2822, 3.6.4.
                ...
                */
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('Message-ID', 'id-left@id-right');
    ...
    {
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('References', 'c@d');
    ...
    public function testSettingMultipleIdsProducesAListValue()
    {
        /* -- RFC 2822, 3.6.4.
                ...
                unique message identifiers, optionally separated by CFWS.
                 ...
                 references      =       "References:" 1*msg-id CRLF
                 */
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('References', ['a@b', 'x@y']);
    ...
    public function testIdLeftCanBeQuoted()
    {
        /* -- RFC 2822, 3.6.4.
           id-left         =       dot-atom-text / no-fold-quote / obs-id-left
           */
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('References', '"ab"@c');
    ...
    public function testIdLeftCanContainAnglesAsQuotedPairs()
    {
        /* -- RFC 2822, 3.6.4.
           no-fold-quote   =       DQUOTE *(qtext / quoted-pair) DQUOTE
           */
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('References', '"a\\<\\>b"@c');
        $this->assertEquals('"a\\<\\>b"@c', $header->getId());
        $this->assertEquals('<"a\\<\\>b"@c>', $header->getBodyAsString());
    }
    public function testIdLeftCanBeDotAtom()
    {
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('References', 'a.b+&%$.c@d');
    ...
    public function testIdRightCanBeLiteral()
    {
        /* -- RFC 2822, 3.6.4.
            no-fold-literal =       "[" *(dtext / quoted-pair) "]"
           */
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('References', 'a@[1.2.3.4]');
    ...
    {
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('References', 'a@ä');
    ...
    public function testMissingAtSignThrowsException()
    {
        /* -- RFC 2822, 3.6.4.
           msg-id          =       [CFWS] "<" id-left "@" id-right ">" [CFWS]
           */
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('References', 'abc');
    }
    public function testSetBody()
    {
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('Message-ID', 'c@d');
        $header->setBody('a@b');
        $this->assertEquals(['a@b'], $header->getIds());
    }
    public function testGetBody()
    {
        $header = new \_PhpScoper13160cf3462c\Symfony\Component\Mime\Header\IdentificationHeader('Message-ID', 'a@b');
