...
class ParameterizedHeaderTest extends \_PhpScoper7574e8786845\PHPUnit\Framework\TestCase
{
    private $charset = 'utf-8';
    private $lang = 'en-us';
    public function testValueIsReturnedVerbatim()
    {
        $header = new \_PhpScoper7574e8786845\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'text/plain');
    ...
    {
        $header = new \_PhpScoper7574e8786845\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'attachment');
    ...
    public function testLongParamsAreBrokenIntoMultipleAttributeStrings()
    {
        ...
        $header = new \_PhpScoper7574e8786845\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Disposition', 'attachment');
    ...
    public function testEncodedParamDataIncludesCharsetAndLanguage()
    {
        ...
        $this->assertEquals('attachment; filename*=' . $header->getCharset() . "'" . $this->lang . "'" . \str_repeat('a', 20) . '%8F' . \str_repeat('a', 10), $header->getBodyAsString());
    }
    public function testMultipleEncodedParamLinesAreFormattedCorrectly()
    {
        ...
        $header->setParameters(['filename' => $value]);
        $header->setLanguage($this->lang);
        $this->assertEquals('attachment; filename*0*=' . $header->getCharset() . "'" . $this->lang . "'" . \str_repeat('a', 20) . '%8F' . \str_repeat('a', 23) . ";\r\n " . 'filename*1*=' . \str_repeat('a', 37), $header->getBodyAsString());
    }
    public function testToString()
    {
        $header = new \_PhpScoper7574e8786845\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'text/html');
        $header->setParameters(['charset' => 'utf-8']);
    ...
    public function testValueCanBeEncodedIfNonAscii()
    {
        ...
        $header = new \_PhpScoper7574e8786845\Symfony\Component\Mime\Header\ParameterizedHeader('X-Foo', $value);
        $header->setCharset('iso-8859-1');
    ...
    {
        $value = 'fo' . \pack('C', 0x8f) . 'bar';
        $header = new \_PhpScoper7574e8786845\Symfony\Component\Mime\Header\ParameterizedHeader('X-Foo', 'bar');
        $header->setCharset('iso-8859-1');
        $header->setParameters(['says' => $value]);
