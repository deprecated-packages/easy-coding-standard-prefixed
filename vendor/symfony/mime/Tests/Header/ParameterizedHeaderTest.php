...
class ParameterizedHeaderTest extends \_PhpScoperb730595bc9f4\PHPUnit\Framework\TestCase
{
    private $charset = 'utf-8';
    private $lang = 'en-us';
    public function testValueIsReturnedVerbatim()
    {
        $header = new \_PhpScoperb730595bc9f4\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'text/plain');
    ...
    {
        $header = new \_PhpScoperb730595bc9f4\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'attachment');
    ...
    public function testLongParamsAreBrokenIntoMultipleAttributeStrings()
    {
        ...
        $header = new \_PhpScoperb730595bc9f4\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Disposition', 'attachment');
    ...
    {
        $header = new \_PhpScoperb730595bc9f4\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'text/html');
        $header->setParameters(['charset' => 'utf-8']);
    ...
    public function testValueCanBeEncodedIfNonAscii()
    {
        ...
        $header = new \_PhpScoperb730595bc9f4\Symfony\Component\Mime\Header\ParameterizedHeader('X-Foo', $value);
        $header->setCharset('iso-8859-1');
    ...
    {
        $value = 'fo' . \pack('C', 0x8f) . 'bar';
        $header = new \_PhpScoperb730595bc9f4\Symfony\Component\Mime\Header\ParameterizedHeader('X-Foo', 'bar');
        $header->setCharset('iso-8859-1');
        $header->setParameters(['says' => $value]);
