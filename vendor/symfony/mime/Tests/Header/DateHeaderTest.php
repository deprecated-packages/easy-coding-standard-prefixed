...
use _PhpScoper48800f361566\Symfony\Component\Mime\Header\DateHeader;
class DateHeaderTest extends \_PhpScoper48800f361566\PHPUnit\Framework\TestCase
{
    /* --
    ...
    {
        $header = new \_PhpScoper48800f361566\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime = new \DateTimeImmutable());
        $this->assertSame($dateTime, $header->getDateTime());
    }
    public function testDateTimeCanBeSetBySetter()
    {
        $header = new \_PhpScoper48800f361566\Symfony\Component\Mime\Header\DateHeader('Date', new \DateTimeImmutable());
    ...
    public function testDateTimeIsConvertedToImmutable()
    {
        ...
        $header = new \_PhpScoper48800f361566\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime);
    ...
    {
        $header = new \_PhpScoper48800f361566\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime = new \DateTime('2000-01-01 12:00:00 Europe/Berlin'));
    ...
    {
        $header = new \_PhpScoper48800f361566\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime = new \DateTimeImmutable('2000-01-01 12:00:00 Europe/Berlin'));
