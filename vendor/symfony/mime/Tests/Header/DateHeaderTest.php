...
use _PhpScoperba24099fc6fd\Symfony\Component\Mime\Header\DateHeader;
class DateHeaderTest extends \_PhpScoperba24099fc6fd\PHPUnit\Framework\TestCase
{
    /* --
    ...
    {
        $header = new \_PhpScoperba24099fc6fd\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime = new \DateTimeImmutable());
        $this->assertSame($dateTime, $header->getDateTime());
    }
    public function testDateTimeCanBeSetBySetter()
    {
        $header = new \_PhpScoperba24099fc6fd\Symfony\Component\Mime\Header\DateHeader('Date', new \DateTimeImmutable());
    ...
    public function testDateTimeIsConvertedToImmutable()
    {
        ...
        $header = new \_PhpScoperba24099fc6fd\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime);
    ...
    {
        $header = new \_PhpScoperba24099fc6fd\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime = new \DateTime('2000-01-01 12:00:00 Europe/Berlin'));
    ...
    {
        $header = new \_PhpScoperba24099fc6fd\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime = new \DateTimeImmutable('2000-01-01 12:00:00 Europe/Berlin'));
