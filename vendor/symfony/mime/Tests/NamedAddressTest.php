...
class NamedAddressTest extends \_PhpScoper326bba7310a2\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScoper326bba7310a2\Symfony\Component\Mime\NamedAddress('fabien@symfonï.com', 'Fabien');
