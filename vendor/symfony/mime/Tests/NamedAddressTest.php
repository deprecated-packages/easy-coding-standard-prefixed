...
class NamedAddressTest extends \_PhpScoperddde3ba4aebc\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScoperddde3ba4aebc\Symfony\Component\Mime\NamedAddress('fabien@symfonï.com', 'Fabien');
