...
class NamedAddressTest extends \_PhpScoperfacc742d2745\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScoperfacc742d2745\Symfony\Component\Mime\NamedAddress('fabien@symfonï.com', 'Fabien');
