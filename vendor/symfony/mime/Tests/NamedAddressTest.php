...
class NamedAddressTest extends \_PhpScopere015d8a3273c\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScopere015d8a3273c\Symfony\Component\Mime\NamedAddress('fabien@symfonï.com', 'Fabien');
