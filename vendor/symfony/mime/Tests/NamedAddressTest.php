...
class NamedAddressTest extends \_PhpScoperfcce67077a55\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScoperfcce67077a55\Symfony\Component\Mime\NamedAddress('fabien@symfonï.com', 'Fabien');
