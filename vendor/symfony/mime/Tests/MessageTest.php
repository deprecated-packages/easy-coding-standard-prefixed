...
use _PhpScoper7c0f822a05e1\Symfony\Component\Mime\Header\Headers;
use _PhpScoper7c0f822a05e1\Symfony\Component\Mime\Header\MailboxListHeader;
use _PhpScoper7c0f822a05e1\Symfony\Component\Mime\Header\UnstructuredHeader;
use _PhpScoper7c0f822a05e1\Symfony\Component\Mime\Message;
...
class MessageTest extends \_PhpScoper7c0f822a05e1\PHPUnit\Framework\TestCase
{
    public function testConstruct()
    {
        $m = new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Message();
        $this->assertNull($m->getBody());
        $this->assertEquals(new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Header\Headers(), $m->getHeaders());
        $m = new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Message($h = (new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Header\Headers())->addDateHeader('Date', new \DateTime()), $b = new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Part\TextPart('content'));
    ...
    public function testGetPreparedHeadersThrowsWhenNoFrom()
    {
        ...
        (new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Message())->getPreparedHeaders();
    }
    public function testGetPreparedHeadersCloneHeaders()
    {
        $message = new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Message();
    ...
    public function testGetPreparedHeaders()
    {
        ...
        $this->assertEquals(new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Header\MailboxListHeader('From', [new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Address('fabien@symfony.com')]), $h->get('From'));
        $this->assertEquals(new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Header\UnstructuredHeader('MIME-Version', '1.0'), $h->get('mime-version'));
    ...
    {
        $message = new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Message();
        $message->getHeaders()->addMailboxListHeader('From', [new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\NamedAddress('fabien@symfony.com', 'Fabien')]);
        $h = $message->getPreparedHeaders();
        $this->assertEquals(new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Header\MailboxListHeader('From', [new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\NamedAddress('fabien@symfony.com', 'Fabien')]), $h->get('From'));
        $this->assertTrue($h->has('Message-Id'));
    }
...
EOF;
        ...
        $message = new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Message(null, new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\Part\TextPart('content'));
        $message->getHeaders()->addMailboxListHeader('From', ['fabien@symfony.com']);
        $expected = <<<EOF
From: fabien@symfony.com
MIME-Version: 1.0
