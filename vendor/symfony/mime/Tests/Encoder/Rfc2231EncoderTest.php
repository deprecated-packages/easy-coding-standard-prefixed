...
use _PhpScoper4d3fa30a680b\Symfony\Component\Mime\Encoder\Rfc2231Encoder;
class Rfc2231EncoderTest extends \_PhpScoper4d3fa30a680b\PHPUnit\Framework\TestCase
{
    ...
    {
        $string = '';
        foreach (\range(0x0, 0x7f) as $octet) {
            $char = \pack('C', $octet);
            $string .= $char;
        }
        $encoder = new \_PhpScoper4d3fa30a680b\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
