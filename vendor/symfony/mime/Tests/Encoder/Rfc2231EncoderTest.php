...
class Rfc2231EncoderTest extends \_PhpScoperbd5fb781fe24\PHPUnit\Framework\TestCase
{
    ...
    public function testEncodingAsciiCharactersProducesValidToken()
    {
        ...
        $encoder = new \_PhpScoperbd5fb781fe24\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
