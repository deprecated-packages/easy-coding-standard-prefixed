...
class Rfc2231EncoderTest extends \_PhpScoperb44a315fec16\PHPUnit\Framework\TestCase
{
    ...
    public function testEncodingAsciiCharactersProducesValidToken()
    {
        ...
        $encoder = new \_PhpScoperb44a315fec16\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
