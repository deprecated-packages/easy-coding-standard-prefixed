...
class QpMimeHeaderEncoderTest extends \_PhpScopercb217fd4e736\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopercb217fd4e736\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
