...
class QpMimeHeaderEncoderTest extends \_PhpScoper38a7d00685f8\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper38a7d00685f8\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
