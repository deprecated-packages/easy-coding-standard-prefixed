...
class QpMimeHeaderEncoderTest extends \_PhpScoper8a0112f19f39\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper8a0112f19f39\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
