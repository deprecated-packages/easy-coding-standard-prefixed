...
class QpMimeHeaderEncoderTest extends \_PhpScoper8db4616aa69d\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper8db4616aa69d\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
