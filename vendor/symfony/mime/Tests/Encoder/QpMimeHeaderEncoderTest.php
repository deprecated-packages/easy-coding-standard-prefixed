...
class QpMimeHeaderEncoderTest extends \_PhpScoper23ef26a4fb01\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper23ef26a4fb01\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
