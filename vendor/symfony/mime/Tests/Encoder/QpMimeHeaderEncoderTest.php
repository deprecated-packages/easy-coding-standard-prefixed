...
class QpMimeHeaderEncoderTest extends \_PhpScoper745103eaabcd\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper745103eaabcd\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
