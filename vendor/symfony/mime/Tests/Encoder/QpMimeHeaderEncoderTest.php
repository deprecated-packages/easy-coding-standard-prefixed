...
class QpMimeHeaderEncoderTest extends \_PhpScoper8e2d8a2760d1\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper8e2d8a2760d1\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
