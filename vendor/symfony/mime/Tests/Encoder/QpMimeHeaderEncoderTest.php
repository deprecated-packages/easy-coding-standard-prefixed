...
class QpMimeHeaderEncoderTest extends \_PhpScoperf77bffce0320\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperf77bffce0320\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
