...
class QpMimeHeaderEncoderTest extends \_PhpScopercb576ca159b5\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopercb576ca159b5\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
