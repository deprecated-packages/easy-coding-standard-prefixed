...
class QpMimeHeaderEncoderTest extends \_PhpScoperb6d4bd368bd9\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperb6d4bd368bd9\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
