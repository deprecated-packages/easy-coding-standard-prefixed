...
class QpMimeHeaderEncoderTest extends \_PhpScoper6db4fde00cda\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper6db4fde00cda\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
