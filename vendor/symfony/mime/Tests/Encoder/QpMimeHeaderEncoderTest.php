...
class QpMimeHeaderEncoderTest extends \_PhpScoper4936962185e7\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper4936962185e7\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
