...
class QpMimeHeaderEncoderTest extends \_PhpScoper04022cd986ec\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper04022cd986ec\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
