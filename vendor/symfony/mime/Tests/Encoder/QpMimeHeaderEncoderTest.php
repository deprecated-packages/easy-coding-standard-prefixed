...
class QpMimeHeaderEncoderTest extends \_PhpScoper83b3b9a317c0\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper83b3b9a317c0\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
