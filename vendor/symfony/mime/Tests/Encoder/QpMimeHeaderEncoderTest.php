...
class QpMimeHeaderEncoderTest extends \_PhpScoper8751341571b5\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper8751341571b5\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
