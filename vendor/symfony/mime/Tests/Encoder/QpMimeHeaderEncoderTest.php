...
class QpMimeHeaderEncoderTest extends \_PhpScoperd4c5032f0671\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperd4c5032f0671\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
