...
class QpMimeHeaderEncoderTest extends \_PhpScopere205696a9dd6\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopere205696a9dd6\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
