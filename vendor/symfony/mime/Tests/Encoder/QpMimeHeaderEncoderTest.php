...
class QpMimeHeaderEncoderTest extends \_PhpScoperd4937ee9b515\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperd4937ee9b515\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
