...
class QpMimeHeaderEncoderTest extends \_PhpScoper839420027581\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper839420027581\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
