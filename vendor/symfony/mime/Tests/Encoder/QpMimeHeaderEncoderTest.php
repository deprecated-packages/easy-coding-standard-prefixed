...
class QpMimeHeaderEncoderTest extends \_PhpScoper5ca2d8bcb02c\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper5ca2d8bcb02c\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
