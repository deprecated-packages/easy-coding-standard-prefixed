...
class QpMimeHeaderEncoderTest extends \_PhpScoperd8b12759ee0d\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperd8b12759ee0d\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
