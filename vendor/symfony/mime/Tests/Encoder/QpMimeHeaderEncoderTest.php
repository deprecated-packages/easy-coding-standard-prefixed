...
class QpMimeHeaderEncoderTest extends \_PhpScoperdf6a0b341030\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperdf6a0b341030\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
