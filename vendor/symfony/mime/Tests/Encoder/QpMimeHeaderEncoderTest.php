...
class QpMimeHeaderEncoderTest extends \_PhpScoper326bba7310a2\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper326bba7310a2\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
