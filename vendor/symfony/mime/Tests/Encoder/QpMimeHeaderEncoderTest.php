...
class QpMimeHeaderEncoderTest extends \_PhpScoper836bc32aecc2\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper836bc32aecc2\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
