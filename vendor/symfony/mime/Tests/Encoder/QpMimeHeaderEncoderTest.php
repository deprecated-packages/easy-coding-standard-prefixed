...
class QpMimeHeaderEncoderTest extends \_PhpScoperfcce67077a55\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperfcce67077a55\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
