...
class QpMimeHeaderEncoderTest extends \_PhpScoper4298f97f3cb3\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper4298f97f3cb3\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
