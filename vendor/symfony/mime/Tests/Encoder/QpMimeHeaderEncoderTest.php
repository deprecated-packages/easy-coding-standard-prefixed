...
class QpMimeHeaderEncoderTest extends \_PhpScopera37d6fb0b1ab\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera37d6fb0b1ab\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
