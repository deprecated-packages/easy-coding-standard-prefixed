...
class QpMimeHeaderEncoderTest extends \_PhpScoperb6a8e65b492c\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperb6a8e65b492c\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
