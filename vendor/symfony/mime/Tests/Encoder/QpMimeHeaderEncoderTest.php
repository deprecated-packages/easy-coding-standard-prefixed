...
class QpMimeHeaderEncoderTest extends \_PhpScoper6a1dd9b8a650\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper6a1dd9b8a650\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
