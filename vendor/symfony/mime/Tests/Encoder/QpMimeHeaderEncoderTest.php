...
class QpMimeHeaderEncoderTest extends \_PhpScoper4f985154d5a0\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper4f985154d5a0\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
