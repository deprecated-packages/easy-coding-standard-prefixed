...
class QpMimeHeaderEncoderTest extends \_PhpScoperbc5235eb86f3\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperbc5235eb86f3\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
