...
class QpMimeHeaderEncoderTest extends \_PhpScoper3e1e0e5bb8ef\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper3e1e0e5bb8ef\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
