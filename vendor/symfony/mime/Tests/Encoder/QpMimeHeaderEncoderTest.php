...
class QpMimeHeaderEncoderTest extends \_PhpScoper5a9febfbbe05\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper5a9febfbbe05\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
