...
class QpMimeHeaderEncoderTest extends \_PhpScopera9d6b451df71\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera9d6b451df71\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
