...
class QpMimeHeaderEncoderTest extends \_PhpScoper167729fa1dde\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper167729fa1dde\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
