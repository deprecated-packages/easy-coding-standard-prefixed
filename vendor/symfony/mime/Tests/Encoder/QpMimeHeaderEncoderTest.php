...
class QpMimeHeaderEncoderTest extends \_PhpScopera51a90153f58\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera51a90153f58\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
