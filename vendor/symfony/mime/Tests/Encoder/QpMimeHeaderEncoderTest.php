...
class QpMimeHeaderEncoderTest extends \_PhpScoperc4b135661b3a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperc4b135661b3a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
