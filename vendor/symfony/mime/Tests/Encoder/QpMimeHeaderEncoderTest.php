...
class QpMimeHeaderEncoderTest extends \_PhpScoper68a3a2539032\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper68a3a2539032\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
