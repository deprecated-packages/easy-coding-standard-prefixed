...
class QpMimeHeaderEncoderTest extends \_PhpScoperad4b7e2c09d8\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperad4b7e2c09d8\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
