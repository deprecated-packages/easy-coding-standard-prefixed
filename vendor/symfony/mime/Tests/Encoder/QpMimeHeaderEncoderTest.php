...
class QpMimeHeaderEncoderTest extends \_PhpScoper7cef7256eba6\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper7cef7256eba6\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
