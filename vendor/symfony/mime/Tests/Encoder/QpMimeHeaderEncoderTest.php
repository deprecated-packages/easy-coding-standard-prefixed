...
class QpMimeHeaderEncoderTest extends \_PhpScoperbcc0395698f8\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperbcc0395698f8\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
