...
class QpMimeHeaderEncoderTest extends \_PhpScoperfd70a7e8e84f\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
