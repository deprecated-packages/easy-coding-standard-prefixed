...
class QpMimeHeaderEncoderTest extends \_PhpScoper2f75f00bf6fa\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
