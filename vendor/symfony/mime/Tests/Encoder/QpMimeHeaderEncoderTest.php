...
class QpMimeHeaderEncoderTest extends \_PhpScoper9f8d5dcff860\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper9f8d5dcff860\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
