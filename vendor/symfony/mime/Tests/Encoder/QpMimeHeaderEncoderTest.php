...
class QpMimeHeaderEncoderTest extends \_PhpScoperef870243cfdb\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperef870243cfdb\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
