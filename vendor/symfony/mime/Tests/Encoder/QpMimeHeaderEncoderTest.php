...
class QpMimeHeaderEncoderTest extends \_PhpScoperddde3ba4aebc\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperddde3ba4aebc\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
