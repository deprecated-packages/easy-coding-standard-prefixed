...
class QpMimeHeaderEncoderTest extends \_PhpScoperedc2e0c967db\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperedc2e0c967db\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
