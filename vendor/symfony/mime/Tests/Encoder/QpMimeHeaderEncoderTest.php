...
class QpMimeHeaderEncoderTest extends \_PhpScoper0f5cd390c37a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper0f5cd390c37a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
