...
class QpMimeHeaderEncoderTest extends \_PhpScoper3e7ab659bd82\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper3e7ab659bd82\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
