...
class QpMimeHeaderEncoderTest extends \_PhpScoperd35c27cd4b09\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperd35c27cd4b09\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
