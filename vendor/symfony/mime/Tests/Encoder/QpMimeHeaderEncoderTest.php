...
class QpMimeHeaderEncoderTest extends \_PhpScoper1e80a2e03314\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper1e80a2e03314\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
