...
class QpMimeHeaderEncoderTest extends \_PhpScopera749ac204cd2\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera749ac204cd2\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
