...
class QpMimeHeaderEncoderTest extends \_PhpScopera4be459e5e3d\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera4be459e5e3d\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
