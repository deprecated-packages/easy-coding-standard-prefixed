...
class QpMimeHeaderEncoderTest extends \_PhpScopera189153e1f79\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera189153e1f79\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
