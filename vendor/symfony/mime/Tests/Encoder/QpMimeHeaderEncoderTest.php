...
class QpMimeHeaderEncoderTest extends \_PhpScoper92597f5b42a7\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper92597f5b42a7\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
