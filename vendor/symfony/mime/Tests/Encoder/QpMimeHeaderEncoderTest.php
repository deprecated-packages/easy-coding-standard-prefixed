...
class QpMimeHeaderEncoderTest extends \_PhpScoperc8b83ee8976a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperc8b83ee8976a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
