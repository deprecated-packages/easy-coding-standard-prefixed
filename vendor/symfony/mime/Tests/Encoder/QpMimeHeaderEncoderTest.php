...
class QpMimeHeaderEncoderTest extends \_PhpScoperecb978830f1e\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperecb978830f1e\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();
