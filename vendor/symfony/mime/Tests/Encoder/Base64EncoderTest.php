...
use _PhpScoperbd5fb781fe24\Symfony\Component\Mime\Encoder\Base64Encoder;
class Base64EncoderTest extends \_PhpScoperbd5fb781fe24\PHPUnit\Framework\TestCase
{
    /*
    ...
    */
    public function testInputOutputRatioIs3to4Bytes()
    {
        ...
        */
        $encoder = new \_PhpScoperbd5fb781fe24\Symfony\Component\Mime\Encoder\Base64Encoder();
