...
use _PhpScopera9d6b451df71\Symfony\Component\Mime\Encoder\Base64Encoder;
class Base64EncoderTest extends \_PhpScopera9d6b451df71\PHPUnit\Framework\TestCase
{
    /*
    ...
    */
    public function testInputOutputRatioIs3to4Bytes()
    {
        ...
        */
        $encoder = new \_PhpScopera9d6b451df71\Symfony\Component\Mime\Encoder\Base64Encoder();
