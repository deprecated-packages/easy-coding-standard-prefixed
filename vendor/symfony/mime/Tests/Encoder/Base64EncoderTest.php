...
use _PhpScopera4be459e5e3d\Symfony\Component\Mime\Encoder\Base64Encoder;
class Base64EncoderTest extends \_PhpScopera4be459e5e3d\PHPUnit\Framework\TestCase
{
    /*
    ...
    */
    public function testInputOutputRatioIs3to4Bytes()
    {
        ...
        */
        $encoder = new \_PhpScopera4be459e5e3d\Symfony\Component\Mime\Encoder\Base64Encoder();
