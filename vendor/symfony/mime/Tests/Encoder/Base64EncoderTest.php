...
use _PhpScopercf909b66eba8\Symfony\Component\Mime\Encoder\Base64Encoder;
class Base64EncoderTest extends \_PhpScopercf909b66eba8\PHPUnit\Framework\TestCase
{
    /*
    ...
    */
    public function testInputOutputRatioIs3to4Bytes()
    {
        ...
        */
        $encoder = new \_PhpScopercf909b66eba8\Symfony\Component\Mime\Encoder\Base64Encoder();
