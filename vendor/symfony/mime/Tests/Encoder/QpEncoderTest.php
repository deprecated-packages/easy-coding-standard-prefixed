...
use _PhpScoper470d6df94ac0\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScoper470d6df94ac0\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScoper470d6df94ac0\Symfony\Component\Mime\Encoder\QpEncoder();
