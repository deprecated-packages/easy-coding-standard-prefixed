...
use _PhpScoperca8ca183ac38\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScoperca8ca183ac38\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScoperca8ca183ac38\Symfony\Component\Mime\Encoder\QpEncoder();
