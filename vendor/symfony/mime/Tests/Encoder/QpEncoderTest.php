...
use _PhpScopere341acab57d4\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScopere341acab57d4\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScopere341acab57d4\Symfony\Component\Mime\Encoder\QpEncoder();
