...
use _PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScoperfd70a7e8e84f\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Encoder\QpEncoder();
