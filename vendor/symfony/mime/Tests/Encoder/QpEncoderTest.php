...
use _PhpScoper0f5cd390c37a\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScoper0f5cd390c37a\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScoper0f5cd390c37a\Symfony\Component\Mime\Encoder\QpEncoder();
