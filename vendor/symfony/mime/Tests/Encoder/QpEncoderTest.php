...
use _PhpScoperad4b7e2c09d8\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScoperad4b7e2c09d8\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScoperad4b7e2c09d8\Symfony\Component\Mime\Encoder\QpEncoder();
