...
use _PhpScopera9d6b451df71\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScopera9d6b451df71\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScopera9d6b451df71\Symfony\Component\Mime\Encoder\QpEncoder();
