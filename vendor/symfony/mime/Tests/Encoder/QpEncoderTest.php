...
use _PhpScopera4be459e5e3d\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScopera4be459e5e3d\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScopera4be459e5e3d\Symfony\Component\Mime\Encoder\QpEncoder();
