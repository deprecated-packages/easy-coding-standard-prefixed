...
use _PhpScoper7cef7256eba6\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScoper7cef7256eba6\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScoper7cef7256eba6\Symfony\Component\Mime\Encoder\QpEncoder();
