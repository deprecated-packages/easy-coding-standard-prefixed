...
use _PhpScoperef870243cfdb\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScoperef870243cfdb\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScoperef870243cfdb\Symfony\Component\Mime\Encoder\QpEncoder();
