...
use _PhpScopere205696a9dd6\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScopere205696a9dd6\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScopere205696a9dd6\Symfony\Component\Mime\Encoder\QpEncoder();
