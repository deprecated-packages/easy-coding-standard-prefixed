...
class RelatedPartTest extends \_PhpScoper528afa732cbd\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $r = new \_PhpScoper528afa732cbd\Symfony\Component\Mime\Part\Multipart\RelatedPart($a = new \_PhpScoper528afa732cbd\Symfony\Component\Mime\Part\TextPart('content'), $b = new \_PhpScoper528afa732cbd\Symfony\Component\Mime\Part\TextPart('HTML content', 'utf-8', 'html'), $c = new \_PhpScoper528afa732cbd\Symfony\Component\Mime\Part\TextPart('HTML content again', 'utf-8', 'html'));
