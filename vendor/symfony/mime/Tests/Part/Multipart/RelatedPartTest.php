...
class RelatedPartTest extends \_PhpScoperfd70a7e8e84f\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $r = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\Multipart\RelatedPart($a = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart('content'), $b = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart('HTML content', 'utf-8', 'html'), $c = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart('HTML content again', 'utf-8', 'html'));
