...
class TextPartTest extends \_PhpScoperfd70a7e8e84f\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $p = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart('content');
        ...
        $p = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart('content', null, 'html');
    ...
    public function testConstructorWithResource()
    {
        ...
        \fwrite($f, 'content');
        \rewind($f);
        $p = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart($f);
        $this->assertEquals('content', $p->getBody());
        $this->assertEquals('content', $p->bodyToString());
        $this->assertEquals('content', \implode('', \iterator_to_array($p->bodyToIterable())));
        \fclose($f);
    ...
    public function testConstructorWithNonStringOrResource()
    {
        ...
        new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart(new \stdClass());
    }
    public function testHeaders()
    {
        $p = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart('content');
        $this->assertEquals(new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Header\Headers(new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'text/plain', ['charset' => 'utf-8']), new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Header\UnstructuredHeader('Content-Transfer-Encoding', 'quoted-printable')), $p->getPreparedHeaders());
        $p = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart('content', 'iso-8859-1');
        $this->assertEquals(new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Header\Headers(new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'text/plain', ['charset' => 'iso-8859-1']), new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Header\UnstructuredHeader('Content-Transfer-Encoding', 'quoted-printable')), $p->getPreparedHeaders());
    }
    public function testEncoding()
    {
        $p = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart('content', 'utf-8', 'plain', 'base64');
    ...
    public function testSerialize()
    {
        ...
        \rewind($r);
        $p = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Part\TextPart($r);
