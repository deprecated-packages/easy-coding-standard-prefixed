...
class TextPartTest extends \_PhpScopere106f9fd4493\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $p = new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Part\TextPart('content');
        ...
        $p = new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Part\TextPart('content', null, 'html');
    ...
    public function testConstructorWithResource()
    {
        ...
        \fwrite($f, 'content');
        \rewind($f);
        $p = new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Part\TextPart($f);
        $this->assertEquals('content', $p->getBody());
        $this->assertEquals('content', $p->bodyToString());
        $this->assertEquals('content', \implode('', \iterator_to_array($p->bodyToIterable())));
        \fclose($f);
    ...
    public function testConstructorWithNonStringOrResource()
    {
        ...
        new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Part\TextPart(new \stdClass());
    }
    public function testHeaders()
    {
        $p = new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Part\TextPart('content');
        $this->assertEquals(new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Header\Headers(new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'text/plain', ['charset' => 'utf-8']), new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Header\UnstructuredHeader('Content-Transfer-Encoding', 'quoted-printable')), $p->getPreparedHeaders());
        $p = new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Part\TextPart('content', 'iso-8859-1');
        $this->assertEquals(new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Header\Headers(new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Header\ParameterizedHeader('Content-Type', 'text/plain', ['charset' => 'iso-8859-1']), new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Header\UnstructuredHeader('Content-Transfer-Encoding', 'quoted-printable')), $p->getPreparedHeaders());
    }
    public function testEncoding()
    {
        $p = new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Part\TextPart('content', 'utf-8', 'plain', 'base64');
    ...
    public function testSerialize()
    {
        ...
        \rewind($r);
        $p = new \_PhpScopere106f9fd4493\Symfony\Component\Mime\Part\TextPart($r);
