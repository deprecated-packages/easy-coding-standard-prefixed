...
use _PhpScoper7c0f822a05e1\Symfony\Component\Mime\CharacterStream;
class CharacterStreamTest extends \_PhpScoper7c0f822a05e1\PHPUnit\Framework\TestCase
{
    public function testReadCharactersAreInTact()
    {
        $stream = new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\CharacterStream(\pack('C*', 0xd0, 0x94, 0xd0, 0xb6, 0xd0, 0xbe));
    ...
    {
        $stream = new \_PhpScoper7c0f822a05e1\Symfony\Component\Mime\CharacterStream(\pack('C*', 0xd1, 0x8d, 0xd0, 0xbb, 0xd0, 0xb0));
