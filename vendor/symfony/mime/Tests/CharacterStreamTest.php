...
use _PhpScoperc64a4ac1af35\Symfony\Component\Mime\CharacterStream;
class CharacterStreamTest extends \_PhpScoperc64a4ac1af35\PHPUnit\Framework\TestCase
{
    public function testReadCharactersAreInTact()
    {
        $stream = new \_PhpScoperc64a4ac1af35\Symfony\Component\Mime\CharacterStream(\pack('C*', 0xd0, 0x94, 0xd0, 0xb6, 0xd0, 0xbe));
    ...
    {
        $stream = new \_PhpScoperc64a4ac1af35\Symfony\Component\Mime\CharacterStream(\pack('C*', 0xd1, 0x8d, 0xd0, 0xbb, 0xd0, 0xb0));
