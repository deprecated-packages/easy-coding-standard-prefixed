 ...
 */
class MimeTypesTest extends \_PhpScoper32136251d417\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper32136251d417\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper32136251d417\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper32136251d417\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper32136251d417\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper32136251d417\Symfony\Component\Mime\MimeTypes();
