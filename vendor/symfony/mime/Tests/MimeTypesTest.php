 ...
 */
class MimeTypesTest extends \_PhpScoper2a48669dad72\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper2a48669dad72\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper2a48669dad72\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper2a48669dad72\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper2a48669dad72\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper2a48669dad72\Symfony\Component\Mime\MimeTypes();
