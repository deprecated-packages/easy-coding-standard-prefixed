 ...
 */
class MimeTypesTest extends \_PhpScoperddde3ba4aebc\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperddde3ba4aebc\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperddde3ba4aebc\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperddde3ba4aebc\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperddde3ba4aebc\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperddde3ba4aebc\Symfony\Component\Mime\MimeTypes();
