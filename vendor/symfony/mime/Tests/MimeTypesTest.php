 ...
 */
class MimeTypesTest extends \_PhpScoperd8b12759ee0d\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperd8b12759ee0d\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperd8b12759ee0d\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperd8b12759ee0d\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperd8b12759ee0d\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperd8b12759ee0d\Symfony\Component\Mime\MimeTypes();
