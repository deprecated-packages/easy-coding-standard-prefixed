 ...
 */
class MimeTypesTest extends \_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper2f75f00bf6fa\Symfony\Component\Mime\MimeTypes();
