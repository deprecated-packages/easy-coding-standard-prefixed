 ...
 */
class MimeTypesTest extends \_PhpScoperaac5f7c652e4\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperaac5f7c652e4\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperaac5f7c652e4\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperaac5f7c652e4\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperaac5f7c652e4\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperaac5f7c652e4\Symfony\Component\Mime\MimeTypes();
