 ...
 */
class MimeTypesTest extends \_PhpScoper14cb6de5473d\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper14cb6de5473d\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper14cb6de5473d\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper14cb6de5473d\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper14cb6de5473d\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper14cb6de5473d\Symfony\Component\Mime\MimeTypes();
