 ...
 */
class MimeTypesTest extends \_PhpScoper21fff473f90a\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper21fff473f90a\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper21fff473f90a\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper21fff473f90a\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper21fff473f90a\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper21fff473f90a\Symfony\Component\Mime\MimeTypes();
