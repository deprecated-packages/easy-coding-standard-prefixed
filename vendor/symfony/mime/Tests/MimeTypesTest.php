 ...
 */
class MimeTypesTest extends \_PhpScopere015d8a3273c\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScopere015d8a3273c\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScopere015d8a3273c\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScopere015d8a3273c\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScopere015d8a3273c\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScopere015d8a3273c\Symfony\Component\Mime\MimeTypes();
