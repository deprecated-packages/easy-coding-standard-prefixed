 ...
 */
class MimeTypesTest extends \_PhpScoper38a7d00685f8\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper38a7d00685f8\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper38a7d00685f8\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper38a7d00685f8\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper38a7d00685f8\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper38a7d00685f8\Symfony\Component\Mime\MimeTypes();
