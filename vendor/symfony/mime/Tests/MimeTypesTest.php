 ...
 */
class MimeTypesTest extends \_PhpScoper5ca2d8bcb02c\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper5ca2d8bcb02c\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper5ca2d8bcb02c\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper5ca2d8bcb02c\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper5ca2d8bcb02c\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper5ca2d8bcb02c\Symfony\Component\Mime\MimeTypes();
