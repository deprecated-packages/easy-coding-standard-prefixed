 ...
 */
class MimeTypesTest extends \_PhpScoperf77bffce0320\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperf77bffce0320\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperf77bffce0320\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperf77bffce0320\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperf77bffce0320\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperf77bffce0320\Symfony\Component\Mime\MimeTypes();
