 ...
 */
class MimeTypesTest extends \_PhpScoperbcc0395698f8\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperbcc0395698f8\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperbcc0395698f8\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperbcc0395698f8\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperbcc0395698f8\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperbcc0395698f8\Symfony\Component\Mime\MimeTypes();
