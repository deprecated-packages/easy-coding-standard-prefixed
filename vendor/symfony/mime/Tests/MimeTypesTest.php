 ...
 */
class MimeTypesTest extends \_PhpScoperc5bee3a837bb\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperc5bee3a837bb\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperc5bee3a837bb\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperc5bee3a837bb\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperc5bee3a837bb\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperc5bee3a837bb\Symfony\Component\Mime\MimeTypes();
