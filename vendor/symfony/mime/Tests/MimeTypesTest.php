 ...
 */
class MimeTypesTest extends \_PhpScoperaa402dd1b1f1\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperaa402dd1b1f1\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperaa402dd1b1f1\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperaa402dd1b1f1\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperaa402dd1b1f1\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperaa402dd1b1f1\Symfony\Component\Mime\MimeTypes();
