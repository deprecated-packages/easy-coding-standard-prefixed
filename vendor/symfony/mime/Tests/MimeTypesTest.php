 ...
 */
class MimeTypesTest extends \_PhpScoperfb2c402b972b\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperfb2c402b972b\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperfb2c402b972b\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperfb2c402b972b\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperfb2c402b972b\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperfb2c402b972b\Symfony\Component\Mime\MimeTypes();
