 ...
 */
class MimeTypesTest extends \_PhpScoper28ab463fc3ba\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper28ab463fc3ba\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper28ab463fc3ba\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper28ab463fc3ba\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper28ab463fc3ba\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper28ab463fc3ba\Symfony\Component\Mime\MimeTypes();
