 ...
 */
class MimeTypesTest extends \_PhpScoperc64a4ac1af35\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperc64a4ac1af35\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperc64a4ac1af35\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperc64a4ac1af35\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperc64a4ac1af35\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperc64a4ac1af35\Symfony\Component\Mime\MimeTypes();
