 ...
 */
class MimeTypesTest extends \_PhpScoperdf6a0b341030\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperdf6a0b341030\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperdf6a0b341030\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperdf6a0b341030\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperdf6a0b341030\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperdf6a0b341030\Symfony\Component\Mime\MimeTypes();
