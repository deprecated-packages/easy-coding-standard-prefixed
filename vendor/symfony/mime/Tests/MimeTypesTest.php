 ...
 */
class MimeTypesTest extends \_PhpScoperd4937ee9b515\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperd4937ee9b515\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperd4937ee9b515\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperd4937ee9b515\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperd4937ee9b515\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperd4937ee9b515\Symfony\Component\Mime\MimeTypes();
