 ...
 */
class MimeTypesTest extends \_PhpScoperd1a5bf00e83e\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperd1a5bf00e83e\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperd1a5bf00e83e\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperd1a5bf00e83e\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperd1a5bf00e83e\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperd1a5bf00e83e\Symfony\Component\Mime\MimeTypes();
