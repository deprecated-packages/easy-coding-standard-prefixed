 ...
 */
class MimeTypesTest extends \_PhpScoperc8b83ee8976a\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperc8b83ee8976a\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperc8b83ee8976a\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperc8b83ee8976a\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperc8b83ee8976a\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperc8b83ee8976a\Symfony\Component\Mime\MimeTypes();
