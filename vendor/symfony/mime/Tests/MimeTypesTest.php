 ...
 */
class MimeTypesTest extends \_PhpScoperdc8fbcd7c69d\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperdc8fbcd7c69d\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperdc8fbcd7c69d\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperdc8fbcd7c69d\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperdc8fbcd7c69d\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperdc8fbcd7c69d\Symfony\Component\Mime\MimeTypes();
