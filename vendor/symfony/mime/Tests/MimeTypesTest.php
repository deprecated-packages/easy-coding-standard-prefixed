 ...
 */
class MimeTypesTest extends \_PhpScoper08748c77fa1c\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper08748c77fa1c\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper08748c77fa1c\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper08748c77fa1c\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper08748c77fa1c\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper08748c77fa1c\Symfony\Component\Mime\MimeTypes();
