 ...
 */
class MimeTypesTest extends \_PhpScoper4a718ec9156e\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper4a718ec9156e\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper4a718ec9156e\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper4a718ec9156e\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper4a718ec9156e\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper4a718ec9156e\Symfony\Component\Mime\MimeTypes();
