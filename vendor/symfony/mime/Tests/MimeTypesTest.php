 ...
 */
class MimeTypesTest extends \_PhpScoper68a3a2539032\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper68a3a2539032\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper68a3a2539032\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper68a3a2539032\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper68a3a2539032\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper68a3a2539032\Symfony\Component\Mime\MimeTypes();
