 ...
 */
class MimeTypesTest extends \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperfd70a7e8e84f\Symfony\Component\Mime\MimeTypes();
