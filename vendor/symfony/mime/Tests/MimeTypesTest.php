 ...
 */
class MimeTypesTest extends \_PhpScoper64ca614e27fd\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper64ca614e27fd\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper64ca614e27fd\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper64ca614e27fd\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper64ca614e27fd\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper64ca614e27fd\Symfony\Component\Mime\MimeTypes();
