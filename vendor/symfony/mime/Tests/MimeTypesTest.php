 ...
 */
class MimeTypesTest extends \_PhpScoperb44a315fec16\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperb44a315fec16\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperb44a315fec16\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperb44a315fec16\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperb44a315fec16\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperb44a315fec16\Symfony\Component\Mime\MimeTypes();
