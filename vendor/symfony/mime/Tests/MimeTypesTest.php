 ...
 */
class MimeTypesTest extends \_PhpScoperdaf95aff095b\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperdaf95aff095b\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperdaf95aff095b\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperdaf95aff095b\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperdaf95aff095b\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperdaf95aff095b\Symfony\Component\Mime\MimeTypes();
