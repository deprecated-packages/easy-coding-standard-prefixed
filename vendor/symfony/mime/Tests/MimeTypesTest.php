 ...
 */
class MimeTypesTest extends \_PhpScoperef870243cfdb\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperef870243cfdb\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperef870243cfdb\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperef870243cfdb\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperef870243cfdb\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperef870243cfdb\Symfony\Component\Mime\MimeTypes();
