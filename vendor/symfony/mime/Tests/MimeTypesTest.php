 ...
 */
class MimeTypesTest extends \_PhpScoper578a67c80b2b\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper578a67c80b2b\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper578a67c80b2b\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper578a67c80b2b\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper578a67c80b2b\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper578a67c80b2b\Symfony\Component\Mime\MimeTypes();
