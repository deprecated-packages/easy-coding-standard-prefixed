 ...
 */
class MimeTypesTest extends \_PhpScoperac4e86be08e5\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperac4e86be08e5\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperac4e86be08e5\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperac4e86be08e5\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperac4e86be08e5\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperac4e86be08e5\Symfony\Component\Mime\MimeTypes();
