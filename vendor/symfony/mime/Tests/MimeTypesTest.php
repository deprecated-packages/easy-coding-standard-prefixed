 ...
 */
class MimeTypesTest extends \_PhpScopercae980ebf12d\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScopercae980ebf12d\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScopercae980ebf12d\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScopercae980ebf12d\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScopercae980ebf12d\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScopercae980ebf12d\Symfony\Component\Mime\MimeTypes();
