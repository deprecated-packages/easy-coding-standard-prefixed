 ...
 */
class MimeTypesTest extends \_PhpScoper745103eaabcd\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper745103eaabcd\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper745103eaabcd\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper745103eaabcd\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper745103eaabcd\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper745103eaabcd\Symfony\Component\Mime\MimeTypes();
