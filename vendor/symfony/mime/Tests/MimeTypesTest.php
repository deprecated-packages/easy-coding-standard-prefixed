 ...
 */
class MimeTypesTest extends \_PhpScoperd301db66c80c\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperd301db66c80c\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperd301db66c80c\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperd301db66c80c\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperd301db66c80c\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperd301db66c80c\Symfony\Component\Mime\MimeTypes();
