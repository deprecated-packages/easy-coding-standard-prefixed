 ...
 */
namespace _PhpScoper48800f361566\Symfony\Component\Mime\DependencyInjection;
 ...
 * @experimental in 4.3
 */
class AddMimeTypeGuesserPass implements \_PhpScoper48800f361566\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\_PhpScoper48800f361566\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        if ($container->has($this->mimeTypesService)) {
            ...
            foreach ($container->findTaggedServiceIds($this->mimeTypeGuesserTag, \true) as $id => $attributes) {
                $definition->addMethodCall('registerGuesser', [new \_PhpScoper48800f361566\Symfony\Component\DependencyInjection\Reference($id)]);
            }
        }
    }
}
