 ...
 */
namespace _PhpScoper64a921a5401b\Symfony\Component\Mime\DependencyInjection;
 ...
 * @experimental in 4.3
 */
class AddMimeTypeGuesserPass implements \_PhpScoper64a921a5401b\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process(\_PhpScoper64a921a5401b\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        if ($container->has($this->mimeTypesService)) {
            ...
            foreach ($container->findTaggedServiceIds($this->mimeTypeGuesserTag, \true) as $id => $attributes) {
                $definition->addMethodCall('registerGuesser', [new \_PhpScoper64a921a5401b\Symfony\Component\DependencyInjection\Reference($id)]);
            }
        }
    }
}
