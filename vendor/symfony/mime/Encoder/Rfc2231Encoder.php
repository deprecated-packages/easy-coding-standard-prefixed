 ...
 * @experimental in 4.3
 */
final class Rfc2231Encoder implements \_PhpScoperecb978830f1e\Symfony\Component\Mime\Encoder\EncoderInterface
{
    /**
    ...
    public function encodeString(string $string, ?string $charset = 'utf-8', int $firstLineOffset = 0, int $maxLineLength = 0) : string
    {
        ...
        $charStream = new \_PhpScoperecb978830f1e\Symfony\Component\Mime\CharacterStream($string, $charset);
