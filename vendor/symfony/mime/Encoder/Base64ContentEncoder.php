 ...
 * @experimental in 4.3
 */
final class Base64ContentEncoder extends \_PhpScoperba24099fc6fd\Symfony\Component\Mime\Encoder\Base64Encoder implements \_PhpScoperba24099fc6fd\Symfony\Component\Mime\Encoder\ContentEncoderInterface
{
    public function encodeByteStream($stream, int $maxLineLength = 0) : iterable
    {
        ...
        if (!\is_resource($filter)) {
            throw new \_PhpScoperba24099fc6fd\Symfony\Component\Mime\Exception\RuntimeException('Unable to set the base64 content encoder to the filter.');
        }
