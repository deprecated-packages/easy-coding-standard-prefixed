 ...
 */
class PhpProcess extends \_PhpScopercae9e6ab5cea\Symfony\Component\Process\Process
{
    /**
    ...
    {
        if (null === $php) {
            $executableFinder = new \_PhpScopercae9e6ab5cea\Symfony\Component\Process\PhpExecutableFinder();
