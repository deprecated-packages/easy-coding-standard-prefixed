 ...
 */
class PhpProcess extends \_PhpScoperef870243cfdb\Symfony\Component\Process\Process
{
    /**
     * Constructor.
     *
    ...
    public function start(callable $callback = null)
    {
        if (null === $this->getCommandLine()) {
            throw new \_PhpScoperef870243cfdb\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }
