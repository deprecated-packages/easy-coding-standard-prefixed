 ...
 */
class PhpProcess extends \_PhpScoperdaf95aff095b\Symfony\Component\Process\Process
{
    /**
     * Constructor.
     *
    ...
    public function start(callable $callback = null)
    {
        if (null === $this->getCommandLine()) {
            throw new \_PhpScoperdaf95aff095b\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }
