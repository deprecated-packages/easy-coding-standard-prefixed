 ...
 */
class PhpProcess extends \_PhpScopere205696a9dd6\Symfony\Component\Process\Process
{
    /**
     * Constructor.
     *
    ...
    {
        $executableFinder = new \_PhpScopere205696a9dd6\Symfony\Component\Process\PhpExecutableFinder();
    ...
    public function start(callable $callback = null)
    {
        if (null === $this->getCommandLine()) {
            throw new \_PhpScopere205696a9dd6\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }
