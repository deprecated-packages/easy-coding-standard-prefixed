 ...
 */
class PhpProcess extends \_PhpScoper797695bcfb1f\Symfony\Component\Process\Process
{
    /**
     * Constructor.
     *
    ...
    {
        $executableFinder = new \_PhpScoper797695bcfb1f\Symfony\Component\Process\PhpExecutableFinder();
    ...
    public function start(callable $callback = null)
    {
        if (null === $this->getCommandLine()) {
            throw new \_PhpScoper797695bcfb1f\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }
