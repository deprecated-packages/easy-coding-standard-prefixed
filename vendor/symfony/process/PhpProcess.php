 ...
 */
class PhpProcess extends \_PhpScoper2b44cb0c30af\Symfony\Component\Process\Process
{
    /**
     * Constructor.
     *
    ...
    public function start(callable $callback = null)
    {
        if (null === $this->getCommandLine()) {
            throw new \_PhpScoper2b44cb0c30af\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }
