 ...
 */
class PhpProcess extends \_PhpScoperd1a5bf00e83e\Symfony\Component\Process\Process
{
    /**
     * Constructor.
     *
    ...
    {
        $executableFinder = new \_PhpScoperd1a5bf00e83e\Symfony\Component\Process\PhpExecutableFinder();
    ...
    public function start(callable $callback = null)
    {
        if (null === $this->getCommandLine()) {
            throw new \_PhpScoperd1a5bf00e83e\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }
