 ...
 */
class PhpProcess extends \_PhpScoper08fb1f8a2f44\Symfony\Component\Process\Process
{
    /**
    ...
    {
        if (null === $php) {
            $executableFinder = new \_PhpScoper08fb1f8a2f44\Symfony\Component\Process\PhpExecutableFinder();
