 ...
 */
class PhpProcess extends \_PhpScoper967d20dce97a\Symfony\Component\Process\Process
{
    /**
     * Constructor.
     *
    ...
    {
        $executableFinder = new \_PhpScoper967d20dce97a\Symfony\Component\Process\PhpExecutableFinder();
    ...
    public function start(callable $callback = null)
    {
        if (null === $this->getCommandLine()) {
            throw new \_PhpScoper967d20dce97a\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }
