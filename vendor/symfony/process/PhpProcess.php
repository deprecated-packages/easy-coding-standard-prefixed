 ...
 */
class PhpProcess extends \_PhpScopera658fe86acec\Symfony\Component\Process\Process
{
    /**
    ...
    {
        if (null === $php) {
            $executableFinder = new \_PhpScopera658fe86acec\Symfony\Component\Process\PhpExecutableFinder();
