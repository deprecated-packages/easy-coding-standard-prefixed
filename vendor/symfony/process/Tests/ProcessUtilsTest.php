...
use _PhpScoper592524ba34f0\Symfony\Component\Process\ProcessUtils;
/**
 * @group legacy
 */
class ProcessUtilsTest extends \_PhpScoper592524ba34f0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->assertSame($result, \_PhpScoper592524ba34f0\Symfony\Component\Process\ProcessUtils::escapeArgument($argument));
    }
