...
use _PhpScoper37a255897161\Symfony\Component\Process\ProcessUtils;
/**
 * @group legacy
 */
class ProcessUtilsTest extends \_PhpScoper37a255897161\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->assertSame($result, \_PhpScoper37a255897161\Symfony\Component\Process\ProcessUtils::escapeArgument($argument));
    }
