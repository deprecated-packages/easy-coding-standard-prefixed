...
use _PhpScoperf65af7a6d9a0\Symfony\Component\Process\ExecutableFinder;
/**
 * @author Chris Smith <chris@cs278.org>
 */
class ExecutableFinderTest extends \_PhpScoperf65af7a6d9a0\PHPUnit\Framework\TestCase
{
    private $path;
    ...
    public function testFind()
    {
        ...
        $finder = new \_PhpScoperf65af7a6d9a0\Symfony\Component\Process\ExecutableFinder();
