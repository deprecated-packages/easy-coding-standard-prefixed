 ...
 */
class ProcessFailedExceptionTest extends \_PhpScoper592524ba34f0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $process = $this->getMockBuilder('_PhpScoper592524ba34f0\\Symfony\\Component\\Process\\Process')->setMethods(array('isSuccessful'))->setConstructorArgs(array('php'))->getMock();
        ...
        new \_PhpScoper592524ba34f0\Symfony\Component\Process\Exception\ProcessFailedException($process);
    }
    /**
    ...
    public function testProcessFailedExceptionPopulatesInformationFromProcessOutput()
    {
        ...
        $exception = new \_PhpScoper592524ba34f0\Symfony\Component\Process\Exception\ProcessFailedException($process);
    ...
    public function testDisabledOutputInFailedExceptionDoesNotPopulateOutput()
    {
        ...
        $exitText = 'General error';
        $workingDirectory = \getcwd();
        $process = $this->getMockBuilder('_PhpScoper592524ba34f0\\Symfony\\Component\\Process\\Process')->setMethods(array('isSuccessful', 'isOutputDisabled', 'getExitCode', 'getExitCodeText', 'getOutput', 'getErrorOutput', 'getWorkingDirectory'))->setConstructorArgs(array($cmd))->getMock();
        $process->expects($this->once())->method('isSuccessful')->will($this->returnValue(\false));
