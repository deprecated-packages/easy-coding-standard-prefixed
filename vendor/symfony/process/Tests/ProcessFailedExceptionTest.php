 ...
 */
class ProcessFailedExceptionTest extends \_PhpScoper8db4616aa69d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $process = $this->getMockBuilder('_PhpScoper8db4616aa69d\\Symfony\\Component\\Process\\Process')->setMethods(array('isSuccessful'))->setConstructorArgs(array('php'))->getMock();
        ...
        new \_PhpScoper8db4616aa69d\Symfony\Component\Process\Exception\ProcessFailedException($process);
    }
    /**
    ...
    public function testProcessFailedExceptionPopulatesInformationFromProcessOutput()
    {
        ...
        $process = $this->getMockBuilder('_PhpScoper8db4616aa69d\\Symfony\\Component\\Process\\Process')->setMethods(array('isSuccessful', 'getOutput', 'getErrorOutput', 'getExitCode', 'getExitCodeText', 'isOutputDisabled', 'getWorkingDirectory'))->setConstructorArgs(array($cmd))->getMock();
        ...
        $exception = new \_PhpScoper8db4616aa69d\Symfony\Component\Process\Exception\ProcessFailedException($process);
    ...
    public function testDisabledOutputInFailedExceptionDoesNotPopulateOutput()
    {
        ...
        $exitText = 'General error';
        $workingDirectory = \getcwd();
        $process = $this->getMockBuilder('_PhpScoper8db4616aa69d\\Symfony\\Component\\Process\\Process')->setMethods(array('isSuccessful', 'isOutputDisabled', 'getExitCode', 'getExitCodeText', 'getOutput', 'getErrorOutput', 'getWorkingDirectory'))->setConstructorArgs(array($cmd))->getMock();
        $process->expects($this->once())->method('isSuccessful')->will($this->returnValue(\false));
