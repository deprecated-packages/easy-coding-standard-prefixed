 ...
 */
class ProcessFailedExceptionTest extends \_PhpScoperfb2c402b972b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $process = $this->getMockBuilder('_PhpScoperfb2c402b972b\\Symfony\\Component\\Process\\Process')->setMethods(array('isSuccessful'))->setConstructorArgs(array('php'))->getMock();
        ...
        new \_PhpScoperfb2c402b972b\Symfony\Component\Process\Exception\ProcessFailedException($process);
    }
    /**
    ...
    public function testProcessFailedExceptionPopulatesInformationFromProcessOutput()
    {
        ...
        $process = $this->getMockBuilder('_PhpScoperfb2c402b972b\\Symfony\\Component\\Process\\Process')->setMethods(array('isSuccessful', 'getOutput', 'getErrorOutput', 'getExitCode', 'getExitCodeText', 'isOutputDisabled', 'getWorkingDirectory'))->setConstructorArgs(array($cmd))->getMock();
        ...
        $exception = new \_PhpScoperfb2c402b972b\Symfony\Component\Process\Exception\ProcessFailedException($process);
    ...
    public function testDisabledOutputInFailedExceptionDoesNotPopulateOutput()
    {
        ...
        $exitText = 'General error';
        $workingDirectory = \getcwd();
        $process = $this->getMockBuilder('_PhpScoperfb2c402b972b\\Symfony\\Component\\Process\\Process')->setMethods(array('isSuccessful', 'isOutputDisabled', 'getExitCode', 'getExitCodeText', 'getOutput', 'getErrorOutput', 'getWorkingDirectory'))->setConstructorArgs(array($cmd))->getMock();
        $process->expects($this->once())->method('isSuccessful')->will($this->returnValue(\false));
