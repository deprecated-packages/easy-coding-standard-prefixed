 ...
 */
class PhpExecutableFinderTest extends \_PhpScoperf65af7a6d9a0\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testFind()
    {
        ...
        $f = new \_PhpScoperf65af7a6d9a0\Symfony\Component\Process\PhpExecutableFinder();
        $current = \PHP_BINARY;
