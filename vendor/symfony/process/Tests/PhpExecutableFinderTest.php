 ...
 */
class PhpExecutableFinderTest extends \_PhpScoperb73f9e44f4eb\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testFind()
    {
        ...
        $f = new \_PhpScoperb73f9e44f4eb\Symfony\Component\Process\PhpExecutableFinder();
        $current = \PHP_BINARY;
