 ...
 */
class PhpExecutableFinderTest extends \_PhpScoperfabf55fef6b7\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testFind()
    {
        ...
        $f = new \_PhpScoperfabf55fef6b7\Symfony\Component\Process\PhpExecutableFinder();
        $current = \PHP_BINARY;
