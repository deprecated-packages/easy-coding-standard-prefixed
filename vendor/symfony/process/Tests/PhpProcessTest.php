...
use _PhpScopera4be459e5e3d\Symfony\Component\Process\PhpProcess;
class PhpProcessTest extends \_PhpScopera4be459e5e3d\PHPUnit\Framework\TestCase
{
    public function testNonBlockingWorks()
    {
        $expected = 'hello world!';
        $process = new \_PhpScopera4be459e5e3d\Symfony\Component\Process\PhpProcess(<<<PHP
<?php echo '{$expected}';
PHP
);
        $process->start();
