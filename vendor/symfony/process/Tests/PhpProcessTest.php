...
use _PhpScopere015d8a3273c\Symfony\Component\Process\PhpProcess;
class PhpProcessTest extends \_PhpScopere015d8a3273c\PHPUnit\Framework\TestCase
{
    public function testNonBlockingWorks()
    {
        $expected = 'hello world!';
        $process = new \_PhpScopere015d8a3273c\Symfony\Component\Process\PhpProcess(<<<PHP
<?php echo '{$expected}';
PHP
);
        $process->start();
