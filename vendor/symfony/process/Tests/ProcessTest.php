 ...
 */
namespace _PhpScoperfa521053d812\Symfony\Component\Process\Tests;

use _PhpScoperfa521053d812\PHPUnit\Framework\TestCase;
...
use _PhpScoperfa521053d812\Symfony\Component\Process\InputStream;
...
use _PhpScoperfa521053d812\Symfony\Component\Process\Process;
/**
 * @author Robert Schönthal <seroscho@googlemail.com>
 */
class ProcessTest extends \_PhpScoperfa521053d812\PHPUnit\Framework\TestCase
{
    ...
    {
        $phpBin = new \_PhpScoperfa521053d812\Symfony\Component\Process\PhpExecutableFinder();
    ...
    public function testThatProcessDoesNotThrowWarningDuringRun()
    {
        ...
        @\trigger_error('Test Error', \E_USER_NOTICE);
    ...
    public function testAllOutputIsActuallyReadOnTermination()
    {
        ...
        $expectedOutputSize = \_PhpScoperfa521053d812\Symfony\Component\Process\Pipes\PipesInterface::CHUNK_SIZE * 2 + 2;
    ...
    public function testSetInputWhileRunningThrowsAnException()
    {
        ...
        } catch (\_PhpScoperfa521053d812\Symfony\Component\Process\Exception\LogicException $e) {
        }
        $process->stop();
        throw $e;
    }
    ...
    {
        return array(array(array()), array(new \_PhpScoperfa521053d812\Symfony\Component\Process\Tests\NonStringifiable()));
    }
    /**
    ...
    {
        return array(array(null, null), array('24.5', 24.5), array('input data', 'input data'));
    }
    ...
    {
        $lock = \tempnam(\sys_get_temp_dir(), __FUNCTION__);
        $p = $this->getProcessForCode('file_put_contents($s = \'' . $uri . '\', \'foo\'); flock(fopen(' . \var_export($lock, \true) . ', \'r\'), LOCK_EX); file_put_contents($s, \'bar\');');
        $h = \fopen($lock, 'w');
        \flock($h, \LOCK_EX);
        $p->start();
    ...
    {
        return array(array('getOutput', 'getIncrementalOutput', 'php://stdout'), array('getErrorOutput', 'getIncrementalErrorOutput', 'php://stderr'));
    }
    ...
    public function testTTYCommand()
    {
        ...
        $process->wait();
        $this->assertSame(\_PhpScoperfa521053d812\Symfony\Component\Process\Process::STATUS_TERMINATED, $process->getStatus());
    }
    ...
    {
        if (!\_PhpScoperfa521053d812\Symfony\Component\Process\Process::isPtySupported()) {
    ...
    public function testStatus()
    {
        ...
        $this->assertSame(\_PhpScoperfa521053d812\Symfony\Component\Process\Process::STATUS_READY, $process->getStatus());
        $process->start();
        $this->assertTrue($process->isRunning());
        $this->assertTrue($process->isStarted());
        $this->assertFalse($process->isTerminated());
        $this->assertSame(\_PhpScoperfa521053d812\Symfony\Component\Process\Process::STATUS_STARTED, $process->getStatus());
        $process->wait();
        $this->assertFalse($process->isRunning());
        $this->assertTrue($process->isStarted());
    ...
    public function testProcessIsSignaledIfStopped()
    {
        ...
        $this->assertEquals(15, $process->getTermSignal());
        // SIGTERM
    }
    /**
     * @expectedException \Symfony\Component\Process\Exception\RuntimeException
    ...
    public function testRunProcessWithTimeout()
    {
        ...
        } catch (\_PhpScoperfa521053d812\Symfony\Component\Process\Exception\RuntimeException $e) {
        }
        $this->assertLessThan(15, \microtime(\true) - $start);
        throw $e;
    }
    ...
    public function testCheckTimeoutOnStartedProcess()
    {
        ...
        } catch (\_PhpScoperfa521053d812\Symfony\Component\Process\Exception\ProcessTimedOutException $e) {
        }
        $this->assertLessThan(15, \microtime(\true) - $start);
        throw $e;
    }
    ...
    public function testMethodsThatNeedARunningProcess($method)
    {
        ...
        if (\method_exists($this, 'expectException')) {
            $this->expectException('_PhpScoperfa521053d812\\Symfony\\Component\\Process\\Exception\\LogicException');
            $this->expectExceptionMessage(\sprintf('Process must be started before calling %s.', $method));
        } else {
            $this->setExpectedException('_PhpScoperfa521053d812\\Symfony\\Component\\Process\\Exception\\LogicException', \sprintf('Process must be started before calling %s.', $method));
        }
        $process->{$method}();
    }
    public function provideMethodsThatNeedARunningProcess()
    {
        return array(array('getOutput'), array('getIncrementalOutput'), array('getErrorOutput'), array('getIncrementalErrorOutput'), array('wait'));
    }
    /**
    ...
    {
        return array(array('hasBeenSignaled'), array('getTermSignal'), array('hasBeenStopped'), array('getStopSignal'));
    }
    /**
    ...
    {
        return array(array(-4), array('Céphalopodes'));
    }
    ...
    {
        return array(array('getOutput'), array('getIncrementalOutput'), array('getErrorOutput'), array('getIncrementalErrorOutput'));
    }
    public function testStopTerminatesProcessCleanly()
    {
        ...
        $this->assertTrue(\true, 'A call to stop() is not expected to cause wait() to throw a RuntimeException');
    }
    public function testKillSignalTerminatesProcessCleanly()
    {
        ...
        $this->assertTrue(\true, 'A call to signal() is not expected to cause wait() to throw a RuntimeException');
    }
    ...
    {
        $variations = array('fwrite(STDOUT, $in = file_get_contents(\'php://stdin\')); fwrite(STDERR, $in);', 'include \'' . __DIR__ . '/PipeStdinInStdoutStdErrStreamSelect.php\';');
        if ('\\' === \DIRECTORY_SEPARATOR) {
    ...
    public function testIncrementalOutputDoesNotRequireAnotherCall($stream, $method)
    {
        ...
        $process->start();
        $result = '';
        $limit = \microtime(\true) + 3;
        $expected = '012';
        while ($result !== $expected && \microtime(\true) < $limit) {
    ...
    {
        return array(array('php://stdout', 'getIncrementalOutput'), array('php://stderr', 'getIncrementalErrorOutput'));
    }
    ...
    {
        $input = new \_PhpScoperfa521053d812\Symfony\Component\Process\InputStream();
    ...
    public function testIteratorOutput()
    {
        ...
        $expectedOutput = array(array($process::OUT, '123'));
        ...
        $this->assertFalse($process->isRunning());
        $expectedOutput = array(array($process::OUT, '123'), array($process::ERR, '234'), array($process::OUT, '345'), array($process::ERR, '456'));
        $this->assertSame($expectedOutput, $output);
    }
    ...
    {
        $p = new \_PhpScoperfa521053d812\Symfony\Component\Process\Process(array('/usr/bin/php'));
    ...
    {
        $p = new \_PhpScoperfa521053d812\Symfony\Component\Process\Process(array(self::$phpBin, '-r', 'echo $argv[1];', $arg));
        $p->run();
    ...
    {
        $p = new \_PhpScoperfa521053d812\Symfony\Component\Process\Process(array(self::$phpBin, '-r', 'echo $argv[1];', $arg), null, array('BAR' => 'BAZ'));
    ...
    public function testEnvArgument()
    {
        ...
        $p = new \_PhpScoperfa521053d812\Symfony\Component\Process\Process($cmd, null, $env);
    ...
    {
        $process = new \_PhpScoperfa521053d812\Symfony\Component\Process\Process($commandline, $cwd, $env, $input, $timeout);
        $process->inheritEnvironmentVariables();
    ...
    private function skipIfNotEnhancedSigchild($expectException = \true)
    {
        if (self::$sigchild) {
            if (!$expectException) {
                ...
                if (\method_exists($this, 'expectException')) {
                    $this->expectException('_PhpScoperfa521053d812\\Symfony\\Component\\Process\\Exception\\RuntimeException');
                    $this->expectExceptionMessage('This PHP has been compiled with --enable-sigchild.');
                } else {
                    $this->setExpectedException('_PhpScoperfa521053d812\\Symfony\\Component\\Process\\Exception\\RuntimeException', 'This PHP has been compiled with --enable-sigchild.');
                }
            }
        }
    }
