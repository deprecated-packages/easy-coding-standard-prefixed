 ...
 */
namespace _PhpScopera238de2e9b5a\Symfony\Component\Process\Tests;
...
use _PhpScopera238de2e9b5a\Symfony\Component\Process\InputStream;
use _PhpScopera238de2e9b5a\Symfony\Component\Process\PhpExecutableFinder;
 ...
 */
class ProcessTest extends \_PhpScopera238de2e9b5a\PHPUnit\Framework\TestCase
{
    ...
    {
        $phpBin = new \_PhpScopera238de2e9b5a\Symfony\Component\Process\PhpExecutableFinder();
    ...
    public function testAllOutputIsActuallyReadOnTermination()
    {
        ...
        $expectedOutputSize = \_PhpScopera238de2e9b5a\Symfony\Component\Process\Pipes\PipesInterface::CHUNK_SIZE * 2 + 2;
    ...
    public function testSetInputWhileRunningThrowsAnException()
    {
        ...
        } catch (\_PhpScopera238de2e9b5a\Symfony\Component\Process\Exception\LogicException $e) {
        }
        $process->stop();
        throw $e;
    }
    ...
    {
        return array(array(array()), array(new \_PhpScopera238de2e9b5a\Symfony\Component\Process\Tests\NonStringifiable()));
    }
    /**
    ...
    public function testTTYCommand()
    {
        ...
        $process->wait();
        $this->assertSame(\_PhpScopera238de2e9b5a\Symfony\Component\Process\Process::STATUS_TERMINATED, $process->getStatus());
    }
    ...
    {
        if (!\_PhpScopera238de2e9b5a\Symfony\Component\Process\Process::isPtySupported()) {
    ...
    public function testStatus()
    {
        ...
        $this->assertSame(\_PhpScopera238de2e9b5a\Symfony\Component\Process\Process::STATUS_READY, $process->getStatus());
        $process->start();
        $this->assertTrue($process->isRunning());
        $this->assertTrue($process->isStarted());
        $this->assertFalse($process->isTerminated());
        $this->assertSame(\_PhpScopera238de2e9b5a\Symfony\Component\Process\Process::STATUS_STARTED, $process->getStatus());
        $process->wait();
        $this->assertFalse($process->isRunning());
        $this->assertTrue($process->isStarted());
    ...
    public function testRunProcessWithTimeout()
    {
        ...
        } catch (\_PhpScopera238de2e9b5a\Symfony\Component\Process\Exception\RuntimeException $e) {
        }
        $this->assertLessThan(15, \microtime(\true) - $start);
        throw $e;
    }
    ...
    public function testCheckTimeoutOnStartedProcess()
    {
        ...
        } catch (\_PhpScopera238de2e9b5a\Symfony\Component\Process\Exception\ProcessTimedOutException $e) {
        }
        $this->assertLessThan(15, \microtime(\true) - $start);
        throw $e;
    }
    ...
    public function testMethodsThatNeedARunningProcess($method)
    {
        ...
        if (\method_exists($this, 'expectException')) {
            $this->expectException('_PhpScopera238de2e9b5a\\Symfony\\Component\\Process\\Exception\\LogicException');
            $this->expectExceptionMessage(\sprintf('Process must be started before calling %s.', $method));
        } else {
            $this->setExpectedException('_PhpScopera238de2e9b5a\\Symfony\\Component\\Process\\Exception\\LogicException', \sprintf('Process must be started before calling %s.', $method));
        }
        $process->{$method}();
    }
    ...
    {
        $input = new \_PhpScopera238de2e9b5a\Symfony\Component\Process\InputStream();
    ...
    {
        $p = new \_PhpScopera238de2e9b5a\Symfony\Component\Process\Process(array('/usr/bin/php'));
    ...
    {
        $p = new \_PhpScopera238de2e9b5a\Symfony\Component\Process\Process(array(self::$phpBin, '-r', 'echo $argv[1];', $arg));
        $p->run();
    ...
    {
        $p = new \_PhpScopera238de2e9b5a\Symfony\Component\Process\Process(array(self::$phpBin, '-r', 'echo $argv[1];', $arg), null, array('BAR' => 'BAZ'));
    ...
    public function testEnvArgument()
    {
        ...
        $p = new \_PhpScopera238de2e9b5a\Symfony\Component\Process\Process($cmd, null, $env);
    ...
    {
        $process = new \_PhpScopera238de2e9b5a\Symfony\Component\Process\Process($commandline, $cwd, $env, $input, $timeout);
        $process->inheritEnvironmentVariables();
    ...
    private function skipIfNotEnhancedSigchild($expectException = \true)
    {
        if (self::$sigchild) {
            if (!$expectException) {
                ...
                if (\method_exists($this, 'expectException')) {
                    $this->expectException('_PhpScopera238de2e9b5a\\Symfony\\Component\\Process\\Exception\\RuntimeException');
                    $this->expectExceptionMessage('This PHP has been compiled with --enable-sigchild.');
                } else {
                    $this->setExpectedException('_PhpScopera238de2e9b5a\\Symfony\\Component\\Process\\Exception\\RuntimeException', 'This PHP has been compiled with --enable-sigchild.');
                }
            }
        }
    }
