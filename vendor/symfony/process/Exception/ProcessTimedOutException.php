 ...
 */
class ProcessTimedOutException extends \_PhpScoper61bdb485188f\Symfony\Component\Process\Exception\RuntimeException
{
    const TYPE_GENERAL = 1;
    const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\_PhpScoper61bdb485188f\Symfony\Component\Process\Process $process, $timeoutType)
    {
