 ...
 */
class ProcessTimedOutException extends \_PhpScoper8a7636b3fdaf\Symfony\Component\Process\Exception\RuntimeException
{
    public const TYPE_GENERAL = 1;
    public const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\_PhpScoper8a7636b3fdaf\Symfony\Component\Process\Process $process, int $timeoutType)
    {
