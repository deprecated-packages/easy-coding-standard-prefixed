 ...
 */
class ProcessTimedOutException extends \_PhpScoperf6b7f9bf122d\Symfony\Component\Process\Exception\RuntimeException
{
    public const TYPE_GENERAL = 1;
    public const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\_PhpScoperf6b7f9bf122d\Symfony\Component\Process\Process $process, int $timeoutType)
    {
