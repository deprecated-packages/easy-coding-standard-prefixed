 ...
 */
namespace _PhpScoper08fb1f8a2f44\Symfony\Component\Process\Pipes;
 ...
 * @internal
 */
class WindowsPipes extends \_PhpScoper08fb1f8a2f44\Symfony\Component\Process\Pipes\AbstractPipes
{
    private $files = [];
    private $fileHandles = [];
    private $lockHandles = [];
