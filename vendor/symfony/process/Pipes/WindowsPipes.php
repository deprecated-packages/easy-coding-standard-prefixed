 ...
 */
namespace _PhpScoper8a1ea80774eb\Symfony\Component\Process\Pipes;
 ...
 * @internal
 */
class WindowsPipes extends \_PhpScoper8a1ea80774eb\Symfony\Component\Process\Pipes\AbstractPipes
{
    private $files = [];
    private $fileHandles = [];
    private $lockHandles = [];
