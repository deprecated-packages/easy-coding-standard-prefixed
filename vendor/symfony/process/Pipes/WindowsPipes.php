 ...
 */
namespace _PhpScopera48d5dbb002d\Symfony\Component\Process\Pipes;
 ...
 * @internal
 */
class WindowsPipes extends \_PhpScopera48d5dbb002d\Symfony\Component\Process\Pipes\AbstractPipes
{
    private $files = [];
    private $fileHandles = [];
    private $lockHandles = [];
