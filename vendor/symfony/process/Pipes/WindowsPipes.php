 ...
 */
namespace _PhpScoper890197fe38f7\Symfony\Component\Process\Pipes;
 ...
 * @internal
 */
class WindowsPipes extends \_PhpScoper890197fe38f7\Symfony\Component\Process\Pipes\AbstractPipes
{
    private $files = [];
    private $fileHandles = [];
    private $lockHandles = [];
