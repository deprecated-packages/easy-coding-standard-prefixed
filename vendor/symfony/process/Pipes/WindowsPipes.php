 ...
 */
namespace _PhpScoperd2a667bd5a98\Symfony\Component\Process\Pipes;
 ...
 * @internal
 */
class WindowsPipes extends \_PhpScoperd2a667bd5a98\Symfony\Component\Process\Pipes\AbstractPipes
{
    private $files = [];
    private $fileHandles = [];
    private $lockHandles = [];
