...
class ProcessBuilder
{
    ...
    public function getProcess()
    {
        if (0 === \count($this->prefix) && 0 === \count($this->arguments)) {
            throw new \_PhpScoper967d20dce97a\Symfony\Component\Process\Exception\LogicException('You must add() command arguments before calling getProcess().');
        }
        $arguments = \array_merge($this->prefix, $this->arguments);
        $process = new \_PhpScoper967d20dce97a\Symfony\Component\Process\Process($arguments, $this->cwd, $this->env, $this->input, $this->timeout, $this->options);
        if ($this->inheritEnv) {
