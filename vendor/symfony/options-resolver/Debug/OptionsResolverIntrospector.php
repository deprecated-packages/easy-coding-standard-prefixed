 ...
 */
namespace _PhpScoper4f42ead57614\Symfony\Component\OptionsResolver\Debug;

use _PhpScoper4f42ead57614\Symfony\Component\OptionsResolver\Exception\NoConfigurationException;
use _PhpScoper4f42ead57614\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
use _PhpScoper4f42ead57614\Symfony\Component\OptionsResolver\OptionsResolver;
/**
...
{
    private $get;
    public function __construct(\_PhpScoper4f42ead57614\Symfony\Component\OptionsResolver\OptionsResolver $optionsResolver)
    {
        $this->get = \Closure::bind(function ($property, $option, $message) {
            /** @var OptionsResolver $this */
            if (!$this->isDefined($option)) {
                throw new \_PhpScoper4f42ead57614\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException(\sprintf('The option "%s" does not exist.', $option));
            }
            if (!\array_key_exists($option, $this->{$property})) {
                throw new \_PhpScoper4f42ead57614\Symfony\Component\OptionsResolver\Exception\NoConfigurationException($message);
            }
