 ...
 */
namespace _PhpScoper82aa0193482e\Symfony\Component\OptionsResolver\Debug;

use _PhpScoper82aa0193482e\Symfony\Component\OptionsResolver\Exception\NoConfigurationException;
...
{
    private $get;
    public function __construct(\_PhpScoper82aa0193482e\Symfony\Component\OptionsResolver\OptionsResolver $optionsResolver)
    {
        $this->get = \Closure::bind(function ($property, $option, $message) {
            /** @var OptionsResolver $this */
            if (!$this->isDefined($option)) {
                throw new \_PhpScoper82aa0193482e\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException(\sprintf('The option "%s" does not exist.', $option));
            }
            if (!\array_key_exists($option, $this->{$property})) {
                throw new \_PhpScoper82aa0193482e\Symfony\Component\OptionsResolver\Exception\NoConfigurationException($message);
            }
