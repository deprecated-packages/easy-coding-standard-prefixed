 ...
 */
namespace _PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver;

use _PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Exception\AccessException;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Exception\InvalidArgumentException;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Exception\MissingOptionsException;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Exception\NoSuchOptionException;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Exception\OptionDefinitionException;
use _PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
/**
 ...
 */
class OptionsResolver implements \_PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Options
{
    ...
    public function setDefault(string $option, $value)
    {
        ...
        if ($value instanceof \Closure) {
            ...
            if (isset($params[0]) && \_PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Options::class === $this->getParameterClassName($params[0])) {
            ...
            if (isset($params[0]) && null !== ($type = $params[0]->getType()) && self::class === $type->getName() && (!isset($params[1]) || ($type = $params[1]->getType()) instanceof \ReflectionNamedType && \_PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\Options::class === $type->getName())) {
                // Store closure for later evaluation
     ...
     */
    public function define(string $option) : \_PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\OptionConfigurator
    {
        if (isset($this->defined[$option])) {
            throw new OptionDefinitionException(\sprintf('The option "%s" is already defined.', $option));
        }
        return new \_PhpScoperc2b2a9bb0e13\Symfony\Component\OptionsResolver\OptionConfigurator($option, $this);
    }
    /**
