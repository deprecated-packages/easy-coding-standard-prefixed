 ...
 */
namespace _PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver;

use _PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Exception\AccessException;
use _PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Exception\InvalidArgumentException;
use _PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException;
use _PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Exception\MissingOptionsException;
use _PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Exception\NoSuchOptionException;
use _PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Exception\OptionDefinitionException;
use _PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
/**
 ...
 */
class OptionsResolver implements \_PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Options
{
    ...
    public function setDefault(string $option, $value)
    {
        ...
        if ($value instanceof \Closure) {
            ...
            if (isset($params[0]) && \_PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Options::class === $this->getParameterClassName($params[0])) {
            ...
            if (isset($params[0]) && null !== ($type = $params[0]->getType()) && self::class === $type->getName() && (!isset($params[1]) || ($type = $params[1]->getType()) instanceof \ReflectionNamedType && \_PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\Options::class === $type->getName())) {
                // Store closure for later evaluation
     ...
     */
    public function define(string $option) : \_PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\OptionConfigurator
    {
        if (isset($this->defined[$option])) {
            throw new OptionDefinitionException(\sprintf('The option "%s" is already defined.', $option));
        }
        return new \_PhpScoper8a1ea80774eb\Symfony\Component\OptionsResolver\OptionConfigurator($option, $this);
    }
    /**
