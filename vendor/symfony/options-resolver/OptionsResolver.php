...
use ECSPrefix20210507\Symfony\Component\OptionsResolver\Exception\InvalidArgumentException;
...
use ECSPrefix20210507\Symfony\Component\OptionsResolver\Exception\NoSuchOptionException;
use ECSPrefix20210507\Symfony\Component\OptionsResolver\Exception\OptionDefinitionException;
use ECSPrefix20210507\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
/**
...
class OptionsResolver implements \ECSPrefix20210507\Symfony\Component\OptionsResolver\Options
{
    ...
    public function setDefault(string $option, $value)
    {
        ...
        if ($value instanceof \Closure) {
            ...
            if (isset($params[0]) && \ECSPrefix20210507\Symfony\Component\OptionsResolver\Options::class === $this->getParameterClassName($params[0])) {
            ...
            if (isset($params[0]) && null !== ($type = $params[0]->getType()) && self::class === $type->getName() && (!isset($params[1]) || ($type = $params[1]->getType()) instanceof \ReflectionNamedType && \ECSPrefix20210507\Symfony\Component\OptionsResolver\Options::class === $type->getName())) {
                // Store closure for later evaluation
    ...
    public function define(string $option) : \ECSPrefix20210507\Symfony\Component\OptionsResolver\OptionConfigurator
    {
        ...
        return new \ECSPrefix20210507\Symfony\Component\OptionsResolver\OptionConfigurator($option, $this);
    }
    /**
