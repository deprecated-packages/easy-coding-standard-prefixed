 ...
 */
namespace _PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Tests;
...
use _PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\OptionsResolver;
class OptionsResolverTest extends \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_TestCase
{
    /**
     * @var OptionsResolver
     */
    ...
    {
        $this->resolver = new \_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\OptionsResolver();
    }
    ////////////////////////////////////////////////////////////////////////////
    // resolve()
    ////////////////////////////////////////////////////////////////////////////
    ...
    {
        $this->resolver->setDefault('foo', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
    ...
    {
        $this->resolver->setDefault('lazy', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
    ...
    {
        $this->assertSame($this->resolver, $this->resolver->setDefault('foo', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
        }));
    }
    ...
    public function testClosureWithoutTypeHintNotInvoked()
    {
        $closure = function ($options) {
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::fail('Should not be called');
        };
    ...
    public function testAccessPreviousDefaultValue()
    {
        ...
        // defined by subclass
        $this->resolver->setDefault('foo', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options, $previousValue) {
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertEquals('bar', $previousValue);
            return 'lazy';
        });
        $this->assertEquals(array('foo' => 'lazy'), $this->resolver->resolve());
    }
    ...
    {
        $calls = 0;
        $this->resolver->setDefault('lazy1', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) use(&$calls) {
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertSame(1, ++$calls);
            $options['lazy2'];
        });
        $this->resolver->setDefault('lazy2', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) use(&$calls) {
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertSame(2, ++$calls);
        });
        $this->resolver->resolve();
    ...
    public function testResolveFailsIfInvalidType($actualType, $allowedType, $exceptionMessage)
    {
        ...
        $this->setExpectedException('_PhpScoper6d28bdf6a7f9\\Symfony\\Component\\OptionsResolver\\Exception\\InvalidOptionsException', $exceptionMessage);
        $this->resolver->resolve(array('option' => $actualType));
    }
    public function provideInvalidTypes()
    {
        return array(array(\true, 'string', 'The option "option" with value true is expected to be of type "string", but is of type "boolean".'), array(\false, 'string', 'The option "option" with value false is expected to be of type "string", but is of type "boolean".'), array(\fopen(__FILE__, 'r'), 'string', 'The option "option" with value resource is expected to be of type "string", but is of type "resource".'), array(array(), 'string', 'The option "option" with value array is expected to be of type "string", but is of type "array".'), array(new \_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\OptionsResolver(), 'string', 'The option "option" with value Symfony\\Component\\OptionsResolver\\OptionsResolver is expected to be of type "string", but is of type "Symfony\\Component\\OptionsResolver\\OptionsResolver".'), array(42, 'string', 'The option "option" with value 42 is expected to be of type "string", but is of type "integer".'), array(null, 'string', 'The option "option" with value null is expected to be of type "string", but is of type "NULL".'), array('bar', '\\stdClass', 'The option "option" with value "bar" is expected to be of type "\\stdClass", but is of type "string".'));
    }
    ...
    public function testResolveFailsIfClosureReturnsFalse()
    {
        ...
        } catch (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException $e) {
        }
    ...
    {
        $this->resolver->setDefault('foo', 'bar');
        $this->resolver->setNormalizer('foo', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options, $value) {
    ...
    public function testNormalizerCanAccessOtherOptions()
    {
        ...
        $this->resolver->setNormalizer('norm', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            /* @var \PHPUnit_Framework_TestCase $test */
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertSame('bar', $options['default']);
            return 'normalized';
        });
    ...
    public function testNormalizerCanAccessLazyOptions()
    {
        ...
        $this->resolver->setNormalizer('norm', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            /* @var \PHPUnit_Framework_TestCase $test */
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertEquals('bar', $options['lazy']);
            return 'normalized';
        });
    ...
    public function testFailIfCyclicDependencyBetweenNormalizers()
    {
        ...
        $this->resolver->setNormalizer('norm1', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            $options['norm2'];
        });
        $this->resolver->setNormalizer('norm2', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            $options['norm1'];
        });
        $this->resolver->resolve();
    }
    ...
    public function testCatchedExceptionFromNormalizerDoesNotCrashOptionResolver()
    {
        ...
        $this->resolver->setNormalizer('catcher', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            try {
        ...
        $this->resolver->setNormalizer('thrower', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) use(&$throw) {
            if ($throw) {
                $throw = \false;
    ...
    {
        $throw = \true;
        $this->resolver->setDefault('catcher', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            try {
                return $options['thrower'];
            } catch (\Exception $e) {
                return \false;
        ...
        $this->resolver->setDefault('thrower', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) use(&$throw) {
            if ($throw) {
                $throw = \false;
                throw new \UnexpectedValueException('throwing');
            }
    ...
    public function testClearOptionAndNormalizer()
    {
        ...
        $this->resolver->setNormalizer('foo1', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            return '';
        });
        $this->resolver->setDefault('foo2', 'bar');
        $this->resolver->setNormalizer('foo2', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            return '';
        });
        $this->resolver->clear();
        $this->assertEmpty($this->resolver->resolve());
    ...
    public function testArrayAccess()
    {
        ...
        $this->resolver->setDefault('lazy1', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            return 'lazy';
        });
        $this->resolver->setDefault('lazy2', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertTrue(isset($options['default1']));
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertTrue(isset($options['default2']));
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertTrue(isset($options['required']));
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertTrue(isset($options['lazy1']));
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertTrue(isset($options['lazy2']));
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertFalse(isset($options['defined']));
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertSame(0, $options['default1']);
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertSame(42, $options['default2']);
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertSame('value', $options['required']);
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertSame('lazy', $options['lazy1']);
    ...
    public function testCount()
    {
        ...
        $this->resolver->setDefault('lazy2', function (\_PhpScoper6d28bdf6a7f9\Symfony\Component\OptionsResolver\Options $options) {
            \_PhpScoper6d28bdf6a7f9\PHPUnit_Framework_Assert::assertCount(4, $options);
        });
