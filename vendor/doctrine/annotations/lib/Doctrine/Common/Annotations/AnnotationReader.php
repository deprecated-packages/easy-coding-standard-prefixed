...
namespace _PhpScoper9385100df341\Doctrine\Common\Annotations;

use _PhpScoper9385100df341\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation;
use _PhpScoper9385100df341\Doctrine\Common\Annotations\Annotation\Target;
use ReflectionClass;
 ...
 */
class AnnotationReader implements \_PhpScoper9385100df341\Doctrine\Common\Annotations\Reader
{
    /**
     ...
     */
    private static $globalImports = ['ignoreannotation' => \_PhpScoper9385100df341\Doctrine\Common\Annotations\Annotation\IgnoreAnnotation::class];
    /**
     ...
     */
    private static $globalIgnoredNames = \_PhpScoper9385100df341\Doctrine\Common\Annotations\ImplicitlyIgnoredAnnotationNames::LIST;
    /**
     * A list with annotations that are not causing exceptions when not resolved to an annotation class.
     *
     * The names are case sensitive.
     ...
     */
    public function __construct(?\_PhpScoper9385100df341\Doctrine\Common\Annotations\DocParser $parser = null)
    {
        if (extension_loaded('Zend Optimizer+') && (ini_get('zend_optimizerplus.save_comments') === '0' || ini_get('opcache.save_comments') === '0')) {
            throw \_PhpScoper9385100df341\Doctrine\Common\Annotations\AnnotationException::optimizerPlusSaveComments();
        }
        ...
        $this->parser = $parser ?: new \_PhpScoper9385100df341\Doctrine\Common\Annotations\DocParser();
        $this->preParser = new \_PhpScoper9385100df341\Doctrine\Common\Annotations\DocParser();
        $this->preParser->setImports(self::$globalImports);
        $this->preParser->setIgnoreNotImportedAnnotations(\true);
        $this->preParser->setIgnoredAnnotationNames(self::$globalIgnoredNames);
        $this->phpParser = new \_PhpScoper9385100df341\Doctrine\Common\Annotations\PhpParser();
    }
    /**
     * {@inheritDoc}
     */
