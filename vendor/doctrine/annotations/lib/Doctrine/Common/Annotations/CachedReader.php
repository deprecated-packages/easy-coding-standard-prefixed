...
use _PhpScoper08fb1f8a2f44\Doctrine\Common\Cache\Cache;
use ReflectionClass;
 ...
 */
final class CachedReader implements \_PhpScoper08fb1f8a2f44\Doctrine\Common\Annotations\Reader
{
    /** @var Reader */
    private $delegate;
    /** @var Cache */
     ...
     * @param bool $debug
     */
    public function __construct(\_PhpScoper08fb1f8a2f44\Doctrine\Common\Annotations\Reader $reader, Cache $cache, $debug = \false)
    {
