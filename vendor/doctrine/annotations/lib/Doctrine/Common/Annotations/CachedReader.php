...
use _PhpScoperb5b1090524db\Doctrine\Common\Cache\Cache;
use ReflectionClass;
 ...
 */
final class CachedReader implements \_PhpScoperb5b1090524db\Doctrine\Common\Annotations\Reader
{
    /** @var Reader */
    private $delegate;
    /** @var Cache */
     ...
     * @param bool $debug
     */
    public function __construct(\_PhpScoperb5b1090524db\Doctrine\Common\Annotations\Reader $reader, Cache $cache, $debug = \false)
    {
