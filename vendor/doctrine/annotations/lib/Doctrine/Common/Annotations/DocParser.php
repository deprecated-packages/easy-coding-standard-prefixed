...
use _PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\Attribute;
use _PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\Attributes;
use _PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\Enum;
use _PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\NamedArgumentConstructor;
...
final class DocParser
{
     ...
     */
    private static $classIdentifiers = [\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_IDENTIFIER, \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_TRUE, \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_FALSE, \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_NULL];
    /**
     * The lexer.
     *
     * @var DocLexer
     ...
     */
    private static $annotationMetadata = [\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\Target::class => ['is_annotation' => \true, 'has_constructor' => \true, 'has_named_argument_constructor' => \false, 'properties' => [], 'targets_literal' => 'ANNOTATION_CLASS', 'targets' => Target::TARGET_CLASS, 'default_property' => 'value', 'attribute_types' => ['value' => ['required' => \false, 'type' => 'array', 'array_type' => 'string', 'value' => 'array<string>']]], \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\Attribute::class => ['is_annotation' => \true, 'has_constructor' => \false, 'has_named_argument_constructor' => \false, 'targets_literal' => 'ANNOTATION_ANNOTATION', 'targets' => Target::TARGET_ANNOTATION, 'default_property' => 'name', 'properties' => ['name' => 'name', 'type' => 'type', 'required' => 'required'], 'attribute_types' => ['value' => ['required' => \true, 'type' => 'string', 'value' => 'string'], 'type' => ['required' => \true, 'type' => 'string', 'value' => 'string'], 'required' => ['required' => \false, 'type' => 'boolean', 'value' => 'boolean']]], \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\Attributes::class => ['is_annotation' => \true, 'has_constructor' => \false, 'has_named_argument_constructor' => \false, 'targets_literal' => 'ANNOTATION_CLASS', 'targets' => Target::TARGET_CLASS, 'default_property' => 'value', 'properties' => ['value' => 'value'], 'attribute_types' => ['value' => ['type' => 'array', 'required' => \true, 'array_type' => \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\Attribute::class, 'value' => 'array<' . \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\Attribute::class . '>']]], \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\Enum::class => ['is_annotation' => \true, 'has_constructor' => \true, 'has_named_argument_constructor' => \false, 'targets_literal' => 'ANNOTATION_PROPERTY', 'targets' => Target::TARGET_PROPERTY, 'default_property' => 'value', 'properties' => ['value' => 'value'], 'attribute_types' => ['value' => ['type' => 'array', 'required' => \true], 'literal' => ['type' => 'array', 'required' => \false]]], \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\Annotation\NamedArgumentConstructor::class => ['is_annotation' => \true, 'has_constructor' => \false, 'has_named_argument_constructor' => \false, 'targets_literal' => 'ANNOTATION_CLASS', 'targets' => Target::TARGET_CLASS, 'default_property' => null, 'properties' => [], 'attribute_types' => []]];
    /**
    ...
    {
        $this->lexer = new \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer();
    }
    /**
     ...
     */
    private function syntaxError(string $expected, ?array $token = null) : \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException
    {
        if ($token === null) {
        ...
        $message .= '.';
        return \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::syntaxError($message);
    }
    /**
    ...
    private function classExists(string $fqcn) : bool
    {
        ...
        return $this->classExists[$fqcn] = \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationRegistry::loadAnnotationClass($fqcn);
    }
    /**
    ...
    private function collectAnnotationMetadata(string $name) : void
    {
        ...
        $metadata['has_named_argument_constructor'] = $metadata['has_constructor'] && $class->implementsInterface(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\NamedArgumentConstructorAnnotation::class);
    ...
    private function Annotations() : array
    {
        ...
        while ($this->lexer->lookahead !== null) {
            if ($this->lexer->lookahead['type'] !== \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_AT) {
                $this->lexer->moveNext();
                continue;
            }
            ...
            if ($peek === null || $peek['type'] !== \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_NAMESPACE_SEPARATOR && !in_array($peek['type'], self::$classIdentifiers, \true) || $peek['position'] !== $this->lexer->lookahead['position'] + 1) {
                $this->lexer->moveNext();
                continue;
            }
    ...
    {
        $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_AT);
        // check if we have an annotation
        $name = $this->Identifier();
        if ($this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_MINUS) && $this->lexer->nextTokenIsAdjacent()) {
        ...
        if ($name[0] !== '\\') {
            ...
            if (!$found) {
                ...
                throw \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::semanticalError(sprintf(<<<'EXCEPTION'
...
, $name, $this->context));
        ...
        if (!$this->classExists($name)) {
            throw \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::semanticalError(sprintf('The annotation "@%s" in %s does not exist, or could not be auto-loaded.', $name, $this->context));
        }
...
, $originalName, $this->context, self::$annotationMetadata[$name]['targets_literal']));
        ...
        if (isset(self::$annotationMetadata[$name]['enum'])) {
            ...
            foreach (self::$annotationMetadata[$name]['enum'] as $property => $enum) {
                ...
                if (isset($values[$property]) && !in_array($values[$property], $enum['value'])) {
                    throw \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::enumeratorError($property, $name, $this->context, $enum['literal'], $values[$property]);
                }
            }
        }
        // checks all declared attributes
        foreach (self::$annotationMetadata[$name]['attribute_types'] as $property => $type) {
            ...
            if (!isset($values[$property])) {
                if ($type['required']) {
                    throw \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::requiredError($property, $originalName, $this->context, 'a(n) ' . $type['value']);
                }
                continue;
            }
            if ($type['type'] === 'array') {
                ...
                if (isset($type['array_type'])) {
                    foreach ($values[$property] as $item) {
                        if (gettype($item) !== $type['array_type'] && !$item instanceof $type['array_type']) {
                            throw \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::attributeTypeError($property, $originalName, $this->context, 'either a(n) ' . $type['array_type'] . ', or an array of ' . $type['array_type'] . 's', $item);
                        }
                    }
                }
            } elseif (gettype($values[$property]) !== $type['type'] && !$values[$property] instanceof $type['type']) {
                throw \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::attributeTypeError($property, $originalName, $this->context, 'a(n) ' . $type['value'], $values[$property]);
            }
        }
        if (self::$annotationMetadata[$name]['has_named_argument_constructor']) {
            ...
            foreach ($values as $property => $value) {
                if (!isset(self::$annotationMetadata[$name]['constructor_args'][$property])) {
                    throw \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::creationError(sprintf(<<<'EXCEPTION'
...
, $originalName, $this->context, $property, implode(', ', self::$annotationMetadata[$name]['properties'])));
                ...
                if (!$property) {
                    throw \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::creationError(sprintf('The annotation @%s declared on %s does not accept any values, but got %s.', $originalName, $this->context, json_encode($values)));
                }
            }
    ...
    {
        $values = [];
        if (!$this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_OPEN_PARENTHESIS)) {
            return $values;
        }
        $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_OPEN_PARENTHESIS);
        if (!$this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_CLOSE_PARENTHESIS)) {
            $values = $this->Values();
        }
        $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_CLOSE_PARENTHESIS);
        return $values;
    }
    /**
    ...
    {
        $values = [$this->Value()];
        while ($this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_COMMA)) {
            $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_COMMA);
            if ($this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_CLOSE_PARENTHESIS)) {
                break;
            }
            $token = $this->lexer->lookahead;
    ...
    private function Constant()
    {
        ...
        if (!defined($identifier)) {
            throw \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\AnnotationException::semanticalErrorConstants($identifier, $this->context);
        }
    ...
    private function Identifier() : string
    {
        ...
        while ($this->lexer->lookahead !== null && $this->lexer->lookahead['position'] === $this->lexer->token['position'] + strlen($this->lexer->token['value']) && $this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_NAMESPACE_SEPARATOR)) {
            $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_NAMESPACE_SEPARATOR);
    ...
    {
        $peek = $this->lexer->glimpse();
        if ($peek['type'] === \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_EQUALS) {
    ...
    {
        if ($this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_OPEN_CURLY_BRACES)) {
            return $this->Arrayx();
        }
        if ($this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_AT)) {
            return $this->Annotation();
        }
        if ($this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_IDENTIFIER)) {
            return $this->Constant();
        }
        switch ($this->lexer->lookahead['type']) {
            case \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_STRING:
                $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_STRING);
                return $this->lexer->token['value'];
            case \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_INTEGER:
                $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_INTEGER);
                return (int) $this->lexer->token['value'];
            case \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_FLOAT:
                $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_FLOAT);
                return (float) $this->lexer->token['value'];
            case \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_TRUE:
                $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_TRUE);
                return \true;
            case \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_FALSE:
                $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_FALSE);
                return \false;
            case \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_NULL:
                $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_NULL);
                return null;
            default:
    ...
    {
        $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_IDENTIFIER);
        $fieldName = $this->lexer->token['value'];
        $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_EQUALS);
        $item = new stdClass();
        $item->name = $fieldName;
    ...
    {
        $array = $values = [];
        $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_OPEN_CURLY_BRACES);
        // If the array is empty, stop parsing and return.
        if ($this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_CLOSE_CURLY_BRACES)) {
            $this->match(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_CLOSE_CURLY_BRACES);
            return $array;
        }
    ...
    {
        $peek = $this->lexer->glimpse();
        if ($peek['type'] === \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_EQUALS || $peek['type'] === \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_COLON) {
            if ($this->lexer->isNextToken(\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_IDENTIFIER)) {
                $key = $this->Constant();
            } else {
                $this->matchAny([\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_INTEGER, \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_STRING]);
                $key = $this->lexer->token['value'];
            }
            $this->matchAny([\_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_EQUALS, \_PhpScoperc7a2896cc805\Doctrine\Common\Annotations\DocLexer::T_COLON]);
