 ...
 */
class FileCacheReader implements \_PhpScoper2dc059b3a969\Doctrine\Common\Annotations\Reader
{
    /** @var Reader */
    private $reader;
    /** @var string */
     ...
     */
    public function __construct(\_PhpScoper2dc059b3a969\Doctrine\Common\Annotations\Reader $reader, $cacheDir, $debug = \false, $umask = 02)
    {
        if (!is_int($umask)) {
