...
class CachedReaderTest extends \_PhpScoper5928e324b45e\Doctrine\Tests\Common\Annotations\AbstractReaderTest
{
    private $cache;
    public function testIgnoresStaleCache()
    {
        ...
        \touch($file);
        $name = '_PhpScoper5928e324b45e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Controller';
        $cacheKey = $name . '@[Annot]';
        $cache = $this->getMock('_PhpScoper5928e324b45e\\Doctrine\\Common\\Cache\\Cache');
        ...
        $reader = new \_PhpScoper5928e324b45e\Doctrine\Common\Annotations\CachedReader(new \_PhpScoper5928e324b45e\Doctrine\Common\Annotations\AnnotationReader(), $cache, \true);
        $route = new \_PhpScoper5928e324b45e\Doctrine\Tests\Common\Annotations\Fixtures\Annotation\Route();
        $route->pattern = '/someprefix';
        $this->assertEquals(array($route), $reader->getClassAnnotations(new \ReflectionClass($name)));
    }
    protected function getReader()
    {
        $this->cache = new \_PhpScoper5928e324b45e\Doctrine\Common\Cache\ArrayCache();
        return new \_PhpScoper5928e324b45e\Doctrine\Common\Annotations\CachedReader(new \_PhpScoper5928e324b45e\Doctrine\Common\Annotations\AnnotationReader(), $this->cache);
    }
}
