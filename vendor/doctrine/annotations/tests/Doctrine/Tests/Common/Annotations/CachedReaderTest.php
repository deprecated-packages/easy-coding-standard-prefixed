...
class CachedReaderTest extends \_PhpScoperc8b83ee8976a\Doctrine\Tests\Common\Annotations\AbstractReaderTest
{
    private $cache;
    public function testIgnoresStaleCache()
    {
        ...
        \touch($file);
        $name = '_PhpScoperc8b83ee8976a\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Controller';
        $cacheKey = $name . '@[Annot]';
        $cache = $this->getMock('_PhpScoperc8b83ee8976a\\Doctrine\\Common\\Cache\\Cache');
        ...
        $reader = new \_PhpScoperc8b83ee8976a\Doctrine\Common\Annotations\CachedReader(new \_PhpScoperc8b83ee8976a\Doctrine\Common\Annotations\AnnotationReader(), $cache, \true);
        $route = new \_PhpScoperc8b83ee8976a\Doctrine\Tests\Common\Annotations\Fixtures\Annotation\Route();
        $route->pattern = '/someprefix';
        $this->assertEquals(array($route), $reader->getClassAnnotations(new \ReflectionClass($name)));
    }
    protected function getReader()
    {
        $this->cache = new \_PhpScoperc8b83ee8976a\Doctrine\Common\Cache\ArrayCache();
        return new \_PhpScoperc8b83ee8976a\Doctrine\Common\Annotations\CachedReader(new \_PhpScoperc8b83ee8976a\Doctrine\Common\Annotations\AnnotationReader(), $this->cache);
    }
}
