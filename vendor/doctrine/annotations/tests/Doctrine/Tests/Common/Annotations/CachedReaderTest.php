...
class CachedReaderTest extends \_PhpScoper2b44cb0c30af\Doctrine\Tests\Common\Annotations\AbstractReaderTest
{
    private $cache;
    public function testIgnoresStaleCache()
    {
        ...
        \touch($file);
        $name = '_PhpScoper2b44cb0c30af\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Controller';
        $cacheKey = $name . '@[Annot]';
        $cache = $this->getMock('_PhpScoper2b44cb0c30af\\Doctrine\\Common\\Cache\\Cache');
        ...
        $reader = new \_PhpScoper2b44cb0c30af\Doctrine\Common\Annotations\CachedReader(new \_PhpScoper2b44cb0c30af\Doctrine\Common\Annotations\AnnotationReader(), $cache, \true);
        $route = new \_PhpScoper2b44cb0c30af\Doctrine\Tests\Common\Annotations\Fixtures\Annotation\Route();
        $route->pattern = '/someprefix';
        $this->assertEquals(array($route), $reader->getClassAnnotations(new \ReflectionClass($name)));
    }
    protected function getReader()
    {
        $this->cache = new \_PhpScoper2b44cb0c30af\Doctrine\Common\Cache\ArrayCache();
        return new \_PhpScoper2b44cb0c30af\Doctrine\Common\Annotations\CachedReader(new \_PhpScoper2b44cb0c30af\Doctrine\Common\Annotations\AnnotationReader(), $this->cache);
    }
}
