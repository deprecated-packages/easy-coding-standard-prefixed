...
use _PhpScoperf65af7a6d9a0\Doctrine\Tests\Common\Annotations\Fixtures\Controller;
use _PhpScoperf65af7a6d9a0\Doctrine\Common\Annotations\AnnotationReader;
/**
 * @group
 */
class DCOM55Test extends \_PhpScoperf65af7a6d9a0\PHPUnit_Framework_TestCase
{
    /**
