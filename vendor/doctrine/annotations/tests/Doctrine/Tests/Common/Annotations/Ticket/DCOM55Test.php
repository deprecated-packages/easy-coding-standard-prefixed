...
use _PhpScoperb6d4bd368bd9\Doctrine\Tests\Common\Annotations\Fixtures\Controller;
use _PhpScoperb6d4bd368bd9\Doctrine\Common\Annotations\AnnotationReader;
/**
 * @group
 */
class DCOM55Test extends \_PhpScoperb6d4bd368bd9\PHPUnit_Framework_TestCase
{
    /**
