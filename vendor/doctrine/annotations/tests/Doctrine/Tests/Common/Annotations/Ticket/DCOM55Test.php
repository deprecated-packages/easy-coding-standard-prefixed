...
use _PhpScoperfd70a7e8e84f\Doctrine\Tests\Common\Annotations\Fixtures\Controller;
use _PhpScoperfd70a7e8e84f\Doctrine\Common\Annotations\AnnotationReader;
/**
 * @group
 */
class DCOM55Test extends \_PhpScoperfd70a7e8e84f\PHPUnit_Framework_TestCase
{
    /**
