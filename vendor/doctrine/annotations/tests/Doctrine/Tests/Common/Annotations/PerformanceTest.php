...
use _PhpScopera37d6fb0b1ab\Doctrine\Common\Cache\ArrayCache;
use _PhpScopera37d6fb0b1ab\Doctrine\Common\Annotations\CachedReader;
...
use _PhpScopera37d6fb0b1ab\Doctrine\Common\Annotations\PhpParser;
...
class PerformanceTest extends \_PhpScopera37d6fb0b1ab\PHPUnit_Framework_TestCase
{
    /**
     * @group performance
     */
    ...
    {
        $reader = new \_PhpScopera37d6fb0b1ab\Doctrine\Common\Annotations\CachedReader(new \_PhpScopera37d6fb0b1ab\Doctrine\Common\Annotations\AnnotationReader(), new \_PhpScopera37d6fb0b1ab\Doctrine\Common\Cache\ArrayCache());
    ...
    public function testCachedReadPerformanceWithFileCache()
    {
        $method = $this->getMethod();
        // prime cache
        $reader = new \_PhpScopera37d6fb0b1ab\Doctrine\Common\Annotations\FileCacheReader(new \_PhpScopera37d6fb0b1ab\Doctrine\Common\Annotations\AnnotationReader(), \sys_get_temp_dir());
        $reader->getMethodAnnotations($method);
        $time = \microtime(\true);
        for ($i = 0, $c = 500; $i < $c; $i++) {
            $reader = new \_PhpScopera37d6fb0b1ab\Doctrine\Common\Annotations\FileCacheReader(new \_PhpScopera37d6fb0b1ab\Doctrine\Common\Annotations\AnnotationReader(), \sys_get_temp_dir());
    ...
    {
        $imports = array('ignorephpdoc' => '_PhpScopera37d6fb0b1ab\\Annotations\\Annotation\\IgnorePhpDoc', 'ignoreannotation' => '_PhpScopera37d6fb0b1ab\\Annotations\\Annotation\\IgnoreAnnotation', 'route' => '_PhpScopera37d6fb0b1ab\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Annotation\\Route', 'template' => '_PhpScopera37d6fb0b1ab\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Annotation\\Template', '__NAMESPACE__' => '_PhpScopera37d6fb0b1ab\\Doctrine\\Tests\\Common\\Annotations\\Fixtures');
    ...
    {
        $class = new \ReflectionClass('_PhpScopera37d6fb0b1ab\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\NamespacedSingleClassLOC1000');
        $time = \microtime(\true);
        for ($i = 0, $c = 500; $i < $c; $i++) {
            $parser = new \_PhpScopera37d6fb0b1ab\Doctrine\Common\Annotations\PhpParser();
    ...
    {
        return new \ReflectionMethod('_PhpScopera37d6fb0b1ab\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Controller', 'helloAction');
    }
