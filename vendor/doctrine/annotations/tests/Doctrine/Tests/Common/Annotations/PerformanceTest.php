...
use _PhpScoper21fff473f90a\Doctrine\Common\Annotations\FileCacheReader;
...
use _PhpScoper21fff473f90a\Doctrine\Common\Annotations\PhpParser;
...
class PerformanceTest extends \_PhpScoper21fff473f90a\PHPUnit_Framework_TestCase
{
    /**
     * @group performance
     */
    ...
    {
        $reader = new \_PhpScoper21fff473f90a\Doctrine\Common\Annotations\CachedReader(new \_PhpScoper21fff473f90a\Doctrine\Common\Annotations\AnnotationReader(), new \_PhpScoper21fff473f90a\Doctrine\Common\Cache\ArrayCache());
    ...
    public function testCachedReadPerformanceWithFileCache()
    {
        $method = $this->getMethod();
        // prime cache
        $reader = new \_PhpScoper21fff473f90a\Doctrine\Common\Annotations\FileCacheReader(new \_PhpScoper21fff473f90a\Doctrine\Common\Annotations\AnnotationReader(), \sys_get_temp_dir());
        $reader->getMethodAnnotations($method);
        $time = \microtime(\true);
        for ($i = 0, $c = 500; $i < $c; $i++) {
            $reader = new \_PhpScoper21fff473f90a\Doctrine\Common\Annotations\FileCacheReader(new \_PhpScoper21fff473f90a\Doctrine\Common\Annotations\AnnotationReader(), \sys_get_temp_dir());
    ...
    {
        $imports = array('ignorephpdoc' => '_PhpScoper21fff473f90a\\Annotations\\Annotation\\IgnorePhpDoc', 'ignoreannotation' => '_PhpScoper21fff473f90a\\Annotations\\Annotation\\IgnoreAnnotation', 'route' => '_PhpScoper21fff473f90a\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Annotation\\Route', 'template' => '_PhpScoper21fff473f90a\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Annotation\\Template', '__NAMESPACE__' => '_PhpScoper21fff473f90a\\Doctrine\\Tests\\Common\\Annotations\\Fixtures');
    ...
    {
        $class = new \ReflectionClass('_PhpScoper21fff473f90a\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\NamespacedSingleClassLOC1000');
        $time = \microtime(\true);
        for ($i = 0, $c = 500; $i < $c; $i++) {
            $parser = new \_PhpScoper21fff473f90a\Doctrine\Common\Annotations\PhpParser();
    ...
    {
        return new \ReflectionMethod('_PhpScoper21fff473f90a\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Controller', 'helloAction');
    }
