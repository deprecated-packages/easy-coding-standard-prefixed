...
use _PhpScoper59ccd3f8e121\Doctrine\Common\Annotations\FileCacheReader;
use _PhpScoper59ccd3f8e121\Doctrine\Common\Cache\ArrayCache;
use _PhpScoper59ccd3f8e121\Doctrine\Common\Annotations\CachedReader;
...
class PerformanceTest extends \_PhpScoper59ccd3f8e121\PHPUnit_Framework_TestCase
{
    /**
     * @group performance
     */
    ...
    {
        $reader = new \_PhpScoper59ccd3f8e121\Doctrine\Common\Annotations\CachedReader(new \_PhpScoper59ccd3f8e121\Doctrine\Common\Annotations\AnnotationReader(), new \_PhpScoper59ccd3f8e121\Doctrine\Common\Cache\ArrayCache());
    ...
    public function testCachedReadPerformanceWithFileCache()
    {
        $method = $this->getMethod();
        // prime cache
        $reader = new \_PhpScoper59ccd3f8e121\Doctrine\Common\Annotations\FileCacheReader(new \_PhpScoper59ccd3f8e121\Doctrine\Common\Annotations\AnnotationReader(), \sys_get_temp_dir());
        $reader->getMethodAnnotations($method);
        $time = \microtime(\true);
        for ($i = 0, $c = 500; $i < $c; $i++) {
            $reader = new \_PhpScoper59ccd3f8e121\Doctrine\Common\Annotations\FileCacheReader(new \_PhpScoper59ccd3f8e121\Doctrine\Common\Annotations\AnnotationReader(), \sys_get_temp_dir());
    ...
    {
        $imports = array('ignorephpdoc' => '_PhpScoper59ccd3f8e121\\Annotations\\Annotation\\IgnorePhpDoc', 'ignoreannotation' => '_PhpScoper59ccd3f8e121\\Annotations\\Annotation\\IgnoreAnnotation', 'route' => '_PhpScoper59ccd3f8e121\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Annotation\\Route', 'template' => '_PhpScoper59ccd3f8e121\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Annotation\\Template', '__NAMESPACE__' => '_PhpScoper59ccd3f8e121\\Doctrine\\Tests\\Common\\Annotations\\Fixtures');
    ...
    {
        $class = new \ReflectionClass('_PhpScoper59ccd3f8e121\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\NamespacedSingleClassLOC1000');
        $time = \microtime(\true);
        for ($i = 0, $c = 500; $i < $c; $i++) {
    ...
    {
        return new \ReflectionMethod('_PhpScoper59ccd3f8e121\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Controller', 'helloAction');
    }
