...
use _PhpScoperfa7254c25e18\Doctrine\Common\Annotations\FileCacheReader;
...
use _PhpScoperfa7254c25e18\Doctrine\Common\Annotations\PhpParser;
...
class PerformanceTest extends \_PhpScoperfa7254c25e18\PHPUnit_Framework_TestCase
{
    /**
     * @group performance
     */
    ...
    {
        $reader = new \_PhpScoperfa7254c25e18\Doctrine\Common\Annotations\CachedReader(new \_PhpScoperfa7254c25e18\Doctrine\Common\Annotations\AnnotationReader(), new \_PhpScoperfa7254c25e18\Doctrine\Common\Cache\ArrayCache());
    ...
    public function testCachedReadPerformanceWithFileCache()
    {
        $method = $this->getMethod();
        // prime cache
        $reader = new \_PhpScoperfa7254c25e18\Doctrine\Common\Annotations\FileCacheReader(new \_PhpScoperfa7254c25e18\Doctrine\Common\Annotations\AnnotationReader(), \sys_get_temp_dir());
        $reader->getMethodAnnotations($method);
        $time = \microtime(\true);
        for ($i = 0, $c = 500; $i < $c; $i++) {
            $reader = new \_PhpScoperfa7254c25e18\Doctrine\Common\Annotations\FileCacheReader(new \_PhpScoperfa7254c25e18\Doctrine\Common\Annotations\AnnotationReader(), \sys_get_temp_dir());
    ...
    {
        $imports = array('ignorephpdoc' => '_PhpScoperfa7254c25e18\\Annotations\\Annotation\\IgnorePhpDoc', 'ignoreannotation' => '_PhpScoperfa7254c25e18\\Annotations\\Annotation\\IgnoreAnnotation', 'route' => '_PhpScoperfa7254c25e18\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Annotation\\Route', 'template' => '_PhpScoperfa7254c25e18\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Annotation\\Template', '__NAMESPACE__' => '_PhpScoperfa7254c25e18\\Doctrine\\Tests\\Common\\Annotations\\Fixtures');
    ...
    {
        $class = new \ReflectionClass('_PhpScoperfa7254c25e18\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\NamespacedSingleClassLOC1000');
        $time = \microtime(\true);
        for ($i = 0, $c = 500; $i < $c; $i++) {
            $parser = new \_PhpScoperfa7254c25e18\Doctrine\Common\Annotations\PhpParser();
    ...
    {
        return new \ReflectionMethod('_PhpScoperfa7254c25e18\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Controller', 'helloAction');
    }
