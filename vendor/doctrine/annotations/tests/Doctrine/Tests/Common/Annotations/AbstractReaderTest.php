...
use _PhpScoperb383f16e851e\Doctrine\Common\Annotations\Annotation;
use _PhpScoperb383f16e851e\Doctrine\Common\Annotations\Reader;
use ReflectionClass, _PhpScoperb383f16e851e\Doctrine\Common\Annotations\AnnotationReader;
require_once __DIR__ . '/TopLevelAnnotation.php';
abstract class AbstractReaderTest extends \_PhpScoperb383f16e851e\PHPUnit_Framework_TestCase
{
    public function getReflectionClass()
    {
        $className = '_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyClass';
    ...
    public function testAnnotations()
    {
        ...
        $this->assertInstanceOf($annotName = '_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyAnnotation', $annot = $reader->getClassAnnotation($class, $annotName));
        ...
        $this->assertEquals(1, \count($propAnnots));
        $this->assertInstanceOf($annotName = '_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyJoinTable', $joinTableAnnot = $reader->getPropertyAnnotation($field2Prop, $annotName));
        $this->assertEquals(1, \count($joinTableAnnot->joinColumns));
        $this->assertEquals(1, \count($joinTableAnnot->inverseJoinColumns));
        $this->assertTrue($joinTableAnnot->joinColumns[0] instanceof \_PhpScoperb383f16e851e\Doctrine\Tests\Common\Annotations\DummyJoinColumn);
        $this->assertTrue($joinTableAnnot->inverseJoinColumns[0] instanceof \_PhpScoperb383f16e851e\Doctrine\Tests\Common\Annotations\DummyJoinColumn);
        ...
        $dummyAnnot = $reader->getMethodAnnotation($class->getMethod('getField1'), '_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyAnnotation');
        $this->assertEquals('', $dummyAnnot->dummyValue);
        $this->assertEquals(array(1, 2, 'three'), $dummyAnnot->value);
        $dummyAnnot = $reader->getPropertyAnnotation($class->getProperty('field1'), '_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyAnnotation');
        $this->assertEquals('fieldHello', $dummyAnnot->dummyValue);
        $classAnnot = $reader->getClassAnnotation($class, '_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyAnnotation');
    ...
    {
        $reader = $this->getReader();
        $class = new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithAnnotationWithVarType');
        ...
        $this->assertInstanceOf('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\AnnotationTargetAll', $barAnnot[0]->annotation);
    }
    public function testAtInDescription()
    {
        $reader = $this->getReader();
        $class = new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithAtInDescriptionAndAnnotation');
        $this->assertEquals(1, \count($fooAnnot = $reader->getPropertyAnnotations($class->getProperty('foo'))));
        $this->assertEquals(1, \count($barAnnot = $reader->getPropertyAnnotations($class->getProperty('bar'))));
        $this->assertInstanceOf('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\AnnotationTargetPropertyMethod', $fooAnnot[0]);
        $this->assertInstanceOf('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\AnnotationTargetPropertyMethod', $barAnnot[0]);
    }
    public function testClassWithWithDanglingComma()
    {
        $reader = $this->getReader();
        $annots = $reader->getClassAnnotations(new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyClassWithDanglingComma'));
    ...
    {
        $reader = $this->getReader();
        $reader->getClassAnnotations(new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithInvalidAnnotationTargetAtClass'));
    }
    public function testClassWithWithInclude()
    {
        $reader = $this->getReader();
        $annots = $reader->getClassAnnotations(new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithRequire'));
        $this->assertCount(1, $annots);
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
    ...
    {
        $reader = $this->getReader();
        $reader->getPropertyAnnotations(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithInvalidAnnotationTargetAtProperty', 'foo'));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
    ...
    {
        $reader = $this->getReader();
        $reader->getPropertyAnnotations(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithInvalidAnnotationTargetAtProperty', 'bar'));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
    ...
    {
        $reader = $this->getReader();
        $reader->getMethodAnnotations(new \ReflectionMethod('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithInvalidAnnotationTargetAtMethod', 'functionName'));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
    ...
    {
        $reader = $this->getReader();
        $reader->getClassAnnotations(new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithAnnotationWithTargetSyntaxError'));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
     * @expectedExceptionMessage Expected namespace separator or identifier, got ')' at position 24 in class @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithTargetSyntaxError.
    ...
    {
        $reader = $this->getReader();
        $reader->getPropertyAnnotations(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithAnnotationWithTargetSyntaxError', 'foo'));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
     * @expectedExceptionMessage Expected namespace separator or identifier, got ')' at position 24 in class @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationWithTargetSyntaxError.
    ...
    {
        $reader = $this->getReader();
        $reader->getMethodAnnotations(new \ReflectionMethod('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithAnnotationWithTargetSyntaxError', 'bar'));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
    ...
    {
        $reader = $this->getReader();
        $reader->getClassAnnotations(new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyClassSyntaxError'));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
    ...
    {
        $reader = $this->getReader();
        $reader->getMethodAnnotations(new \ReflectionMethod('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyClassMethodSyntaxError', 'foo'));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
    ...
    {
        $reader = $this->getReader();
        $reader->getPropertyAnnotations(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyClassPropertySyntaxError', 'foo'));
    }
    /**
     * @group regression
     */
    ...
    {
        $reader = $this->getReader();
        $annots = $reader->getPropertyAnnotations(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyClass2', 'id'));
        $this->assertEquals(3, \count($annots));
    }
    public function testNonAnnotationProblem()
    {
        $reader = $this->getReader();
        $this->assertNotNull($annot = $reader->getPropertyAnnotation(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyClassNonAnnotationProblem', 'foo'), $name = '_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyAnnotation'));
        $this->assertInstanceOf($name, $annot);
    }
    public function testIncludeIgnoreAnnotation()
    {
        $reader = $this->getReader();
        $reader->getPropertyAnnotations(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithIgnoreAnnotation', 'foo'));
        $this->assertFalse(\class_exists('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\IgnoreAnnotationClass', \false));
    }
    public function testImportWithConcreteAnnotation()
    {
        $reader = $this->getReader();
        $property = new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\TestImportWithConcreteAnnotation', 'field');
        $annotations = $reader->getPropertyAnnotations($property);
        $this->assertEquals(1, \count($annotations));
        $this->assertNotNull($reader->getPropertyAnnotation($property, '_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DummyAnnotation'));
    }
    public function testImportWithInheritance()
    {
        $reader = $this->getReader();
        $class = new \_PhpScoperb383f16e851e\Doctrine\Tests\Common\Annotations\TestParentClass();
        $ref = new \ReflectionClass($class);
        $childAnnotations = $reader->getPropertyAnnotations($ref->getProperty('child'));
        $this->assertEquals(1, \count($childAnnotations));
        $this->assertInstanceOf('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Foo\\Name', \reset($childAnnotations));
        $parentAnnotations = $reader->getPropertyAnnotations($ref->getProperty('parent'));
        $this->assertEquals(1, \count($parentAnnotations));
        $this->assertInstanceOf('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Bar\\Name', \reset($parentAnnotations));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
    ...
    {
        $reader = $this->getReader();
        $reader->getPropertyAnnotations(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\TestAnnotationNotImportedClass', 'field'));
    }
    /**
     * @expectedException \Doctrine\Common\Annotations\AnnotationException
    ...
    {
        $reader = $this->getReader();
        $reader->getPropertyAnnotations(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\TestNonExistentAnnotationClass', 'field'));
    }
    public function testTopLevelAnnotation()
    {
        $reader = $this->getReader();
        $annotations = $reader->getPropertyAnnotations(new \ReflectionProperty('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\TestTopLevelAnnotationClass', 'field'));
        $this->assertEquals(1, \count($annotations));
    ...
    {
        $reader = $this->getReader();
        $annotation = $reader->getClassAnnotation(new \ReflectionClass(new \_PhpScoperb383f16e851e\Doctrine\Tests\Common\Annotations\TestIgnoresNonAnnotationsClass()), '_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Name');
        $this->assertInstanceOf('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Name', $annotation);
    }
    ...
    public function testResetsPhpParserAfterUse()
    {
        ...
        $this->assertFalse(!self::$testResetsPhpParserAfterUseRun && \class_exists('_PhpScoperb383f16e851e\\Doctrine_Tests_Common_Annotations_Fixtures_ClassNoNamespaceNoComment'), 'Test invalid if class has already been compiled');
        ...
        $class = new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithClassAnnotationOnly');
        ...
        $annotations = $reader->getClassAnnotations(new \ReflectionClass(new \_PhpScoperb383f16e851e\Doctrine_Tests_Common_Annotations_Fixtures_ClassNoNamespaceNoComment()));
    ...
    {
        $reader = $this->getReader();
        $ref = new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\InvalidAnnotationUsageClass');
        $reader->getClassAnnotations($ref);
    }
    public function testInvalidAnnotationUsageButIgnoredClass()
    {
        $reader = $this->getReader();
        $ref = new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\InvalidAnnotationUsageButIgnoredClass');
    ...
    {
        $reader = $this->getReader();
        $class = new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassDDC1660');
        $this->assertTrue(\class_exists('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\Annotation\\Version'));
    ...
    {
        $reader = $this->getReader();
        $class = new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\ClassWithAnnotationEnum');
        ...
        $this->assertInstanceOf('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\AnnotationEnum', $bar[0]);
        $this->assertInstanceOf('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\Fixtures\\AnnotationEnum', $foo[0]);
        try {
            $reader->getPropertyAnnotations($class->getProperty('invalidProperty'));
            $this->fail();
    ...
    {
        $reader = $this->getReader();
        $ref = new \ReflectionClass('_PhpScoperb383f16e851e\\Doctrine\\Tests\\Common\\Annotations\\DCOM106');
        $reader->getClassAnnotations($ref);
    }
    /**
...
class TestParentClass extends \_PhpScoperb383f16e851e\Doctrine\Tests\Common\Annotations\TestChildClass
{
    /**
...
/** @Annotation */
class DummyId extends \_PhpScoperb383f16e851e\Doctrine\Common\Annotations\Annotation
{
}
/** @Annotation */
class DummyColumn extends \_PhpScoperb383f16e851e\Doctrine\Common\Annotations\Annotation
{
    public $type;
}
/** @Annotation */
class DummyGeneratedValue extends \_PhpScoperb383f16e851e\Doctrine\Common\Annotations\Annotation
{
}
/** @Annotation */
class DummyAnnotation extends \_PhpScoperb383f16e851e\Doctrine\Common\Annotations\Annotation
{
    public $dummyValue;
}
/**
 ...
 * @Annotation
 */
class DummyAnnotationWithIgnoredAnnotation extends \_PhpScoperb383f16e851e\Doctrine\Common\Annotations\Annotation
{
    public $dummyValue;
}
/** @Annotation */
class DummyJoinColumn extends \_PhpScoperb383f16e851e\Doctrine\Common\Annotations\Annotation
{
    public $name;
    public $referencedColumnName;
}
/** @Annotation */
class DummyJoinTable extends \_PhpScoperb383f16e851e\Doctrine\Common\Annotations\Annotation
{
    public $name;
    public $joinColumns;
...
namespace _PhpScoperb383f16e851e\Doctrine\Tests\Common\Annotations\Foo;
