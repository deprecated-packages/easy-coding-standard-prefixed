...
final class CompleteUnifiedDiffOutputBuilderFactory
{
     ...
     * @api
     */
    public function create() : \_PhpScoper4d05106cc3c0\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder
    {
        $unifiedDiffOutputBuilder = new \_PhpScoper4d05106cc3c0\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder('');
