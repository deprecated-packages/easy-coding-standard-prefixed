...
final class SetAwareConfigResolver extends \Symplify\SetConfigResolver\AbstractConfigResolver
{
     ...
     * @api
     */
    public function resolveSetFromInput(\_PhpScoper4fc0030e9d22\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
