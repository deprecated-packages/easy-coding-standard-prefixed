...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera40fc53e636b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera40fc53e636b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera40fc53e636b\Symfony\Component\Config\FileLocator());
