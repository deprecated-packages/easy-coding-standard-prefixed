...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper0f5cd390c37a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper0f5cd390c37a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper0f5cd390c37a\Symfony\Component\Config\FileLocator());
