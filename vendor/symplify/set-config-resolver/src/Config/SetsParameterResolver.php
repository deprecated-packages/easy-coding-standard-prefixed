...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera34ae19e8d40\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera34ae19e8d40\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera34ae19e8d40\Symfony\Component\Config\FileLocator());
