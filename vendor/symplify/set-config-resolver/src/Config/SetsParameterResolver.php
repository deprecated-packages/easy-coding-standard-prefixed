...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper38a7d00685f8\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper38a7d00685f8\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper38a7d00685f8\Symfony\Component\Config\FileLocator());
