...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper1103e00fb46b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper1103e00fb46b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper1103e00fb46b\Symfony\Component\Config\FileLocator());
