...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3fa05b4669af\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper3fa05b4669af\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3fa05b4669af\Symfony\Component\Config\FileLocator());
