...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper4d3fa30a680b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper4d3fa30a680b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper4d3fa30a680b\Symfony\Component\Config\FileLocator());
