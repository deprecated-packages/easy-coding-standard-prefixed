...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper7cef7256eba6\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper7cef7256eba6\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper7cef7256eba6\Symfony\Component\Config\FileLocator());
