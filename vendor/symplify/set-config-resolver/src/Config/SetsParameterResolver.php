...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper7c0f822a05e1\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper7c0f822a05e1\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper7c0f822a05e1\Symfony\Component\Config\FileLocator());
