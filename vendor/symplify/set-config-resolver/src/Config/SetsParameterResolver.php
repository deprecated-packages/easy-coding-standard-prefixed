...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper57272265e1c9\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper57272265e1c9\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper57272265e1c9\Symfony\Component\Config\FileLocator());
