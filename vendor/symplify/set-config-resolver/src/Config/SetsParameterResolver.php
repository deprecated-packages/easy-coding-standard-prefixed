...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera1f11cc38772\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera1f11cc38772\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera1f11cc38772\Symfony\Component\Config\FileLocator());
