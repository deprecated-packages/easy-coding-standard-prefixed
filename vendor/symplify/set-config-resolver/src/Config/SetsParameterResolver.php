...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera061b8a47e36\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera061b8a47e36\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera061b8a47e36\Symfony\Component\Config\FileLocator());
