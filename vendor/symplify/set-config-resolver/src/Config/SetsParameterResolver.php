...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper190659c42b56\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper190659c42b56\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper190659c42b56\Symfony\Component\Config\FileLocator());
