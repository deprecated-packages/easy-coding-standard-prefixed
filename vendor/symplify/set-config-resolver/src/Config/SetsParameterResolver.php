...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper58a0a169dcfb\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper58a0a169dcfb\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper58a0a169dcfb\Symfony\Component\Config\FileLocator());
