...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper08748c77fa1c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper08748c77fa1c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper08748c77fa1c\Symfony\Component\Config\FileLocator());
