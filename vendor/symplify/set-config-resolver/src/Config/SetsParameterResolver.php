...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper96382aaac118\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper96382aaac118\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper96382aaac118\Symfony\Component\Config\FileLocator());
