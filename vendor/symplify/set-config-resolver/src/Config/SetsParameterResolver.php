...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperda2604e33acb\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperda2604e33acb\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperda2604e33acb\Symfony\Component\Config\FileLocator());
