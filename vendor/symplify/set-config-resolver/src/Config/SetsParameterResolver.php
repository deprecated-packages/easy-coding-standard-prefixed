...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper666af036e800\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper666af036e800\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper666af036e800\Symfony\Component\Config\FileLocator());
