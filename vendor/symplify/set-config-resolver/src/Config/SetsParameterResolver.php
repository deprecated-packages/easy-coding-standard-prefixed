...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper79449c4e744b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper79449c4e744b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper79449c4e744b\Symfony\Component\Config\FileLocator());
