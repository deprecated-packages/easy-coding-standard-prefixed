...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera238de2e9b5a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera238de2e9b5a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera238de2e9b5a\Symfony\Component\Config\FileLocator());
