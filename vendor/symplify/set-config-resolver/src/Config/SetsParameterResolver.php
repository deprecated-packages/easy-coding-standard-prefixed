...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper21c6ce8bfe5d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper21c6ce8bfe5d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper21c6ce8bfe5d\Symfony\Component\Config\FileLocator());
