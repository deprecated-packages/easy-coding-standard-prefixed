...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper59558822d8c7\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper59558822d8c7\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper59558822d8c7\Symfony\Component\Config\FileLocator());
