...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper776637f3d3c3\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper776637f3d3c3\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper776637f3d3c3\Symfony\Component\Config\FileLocator());
