...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper326bba7310a2\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper326bba7310a2\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper326bba7310a2\Symfony\Component\Config\FileLocator());
