...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperc95ae4bf942a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperc95ae4bf942a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperc95ae4bf942a\Symfony\Component\Config\FileLocator());
