...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper13160cf3462c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper13160cf3462c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper13160cf3462c\Symfony\Component\Config\FileLocator());
