...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper87c77ad5700d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper87c77ad5700d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper87c77ad5700d\Symfony\Component\Config\FileLocator());
