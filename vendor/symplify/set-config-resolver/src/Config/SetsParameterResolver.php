...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper589e8c04a9ef\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper589e8c04a9ef\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper589e8c04a9ef\Symfony\Component\Config\FileLocator());
