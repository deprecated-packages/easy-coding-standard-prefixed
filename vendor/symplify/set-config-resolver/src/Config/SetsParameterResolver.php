...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper470d6df94ac0\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper470d6df94ac0\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper470d6df94ac0\Symfony\Component\Config\FileLocator());
