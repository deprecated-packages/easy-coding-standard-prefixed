...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper28ab463fc3ba\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper28ab463fc3ba\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper28ab463fc3ba\Symfony\Component\Config\FileLocator());
