...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper224ae0b86670\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper224ae0b86670\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper224ae0b86670\Symfony\Component\Config\FileLocator());
