...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperfab1bfb7ec99\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperfab1bfb7ec99\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperfab1bfb7ec99\Symfony\Component\Config\FileLocator());
