...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperf361a7d70552\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperf361a7d70552\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperf361a7d70552\Symfony\Component\Config\FileLocator());
