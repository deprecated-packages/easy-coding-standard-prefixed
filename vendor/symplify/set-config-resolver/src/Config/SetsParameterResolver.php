...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper528afa732cbd\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper528afa732cbd\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper528afa732cbd\Symfony\Component\Config\FileLocator());
