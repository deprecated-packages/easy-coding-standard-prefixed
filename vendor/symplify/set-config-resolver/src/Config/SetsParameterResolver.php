...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper6224e3b16fcc\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper6224e3b16fcc\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper6224e3b16fcc\Symfony\Component\Config\FileLocator());
