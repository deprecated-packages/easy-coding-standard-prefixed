...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopere015d8a3273c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopere015d8a3273c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopere015d8a3273c\Symfony\Component\Config\FileLocator());
