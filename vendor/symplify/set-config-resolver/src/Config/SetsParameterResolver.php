...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopereb8678af2407\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopereb8678af2407\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopereb8678af2407\Symfony\Component\Config\FileLocator());
