...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper14cb6de5473d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper14cb6de5473d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper14cb6de5473d\Symfony\Component\Config\FileLocator());
