...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperc64a4ac1af35\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperc64a4ac1af35\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperc64a4ac1af35\Symfony\Component\Config\FileLocator());
