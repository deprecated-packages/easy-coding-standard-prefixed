...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper21fff473f90a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper21fff473f90a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper21fff473f90a\Symfony\Component\Config\FileLocator());
