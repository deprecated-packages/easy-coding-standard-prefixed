...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperf3f1be0d8a30\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperf3f1be0d8a30\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperf3f1be0d8a30\Symfony\Component\Config\FileLocator());
