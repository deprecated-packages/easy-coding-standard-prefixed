...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper06c66bea2cf6\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper06c66bea2cf6\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper06c66bea2cf6\Symfony\Component\Config\FileLocator());
