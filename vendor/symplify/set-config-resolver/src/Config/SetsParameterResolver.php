...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper069ebd53a518\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper069ebd53a518\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper069ebd53a518\Symfony\Component\Config\FileLocator());
