...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopercf327c47dfc5\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopercf327c47dfc5\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopercf327c47dfc5\Symfony\Component\Config\FileLocator());
