...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper2f75f00bf6fa\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper2f75f00bf6fa\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper2f75f00bf6fa\Symfony\Component\Config\FileLocator());
