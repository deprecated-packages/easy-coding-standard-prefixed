...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper39d23eef9a06\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper39d23eef9a06\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper39d23eef9a06\Symfony\Component\Config\FileLocator());
