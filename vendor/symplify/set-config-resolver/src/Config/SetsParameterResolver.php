...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper64a921a5401b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper64a921a5401b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper64a921a5401b\Symfony\Component\Config\FileLocator());
