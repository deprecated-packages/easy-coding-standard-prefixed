...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper2a48669dad72\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper2a48669dad72\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper2a48669dad72\Symfony\Component\Config\FileLocator());
