...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper167729fa1dde\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper167729fa1dde\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper167729fa1dde\Symfony\Component\Config\FileLocator());
