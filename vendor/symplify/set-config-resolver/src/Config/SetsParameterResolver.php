...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperaad82bb90a86\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperaad82bb90a86\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperaad82bb90a86\Symfony\Component\Config\FileLocator());
