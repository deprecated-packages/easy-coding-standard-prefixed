...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3f3a54dd086f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper3f3a54dd086f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3f3a54dd086f\Symfony\Component\Config\FileLocator());
