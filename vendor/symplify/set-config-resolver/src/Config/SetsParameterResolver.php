...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3b1d73f28e67\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper3b1d73f28e67\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3b1d73f28e67\Symfony\Component\Config\FileLocator());
