...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper04022cd986ec\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper04022cd986ec\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper04022cd986ec\Symfony\Component\Config\FileLocator());
