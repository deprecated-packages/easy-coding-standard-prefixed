...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper61bdb485188f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper61bdb485188f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper61bdb485188f\Symfony\Component\Config\FileLocator());
