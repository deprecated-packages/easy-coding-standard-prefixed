...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper32136251d417\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper32136251d417\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper32136251d417\Symfony\Component\Config\FileLocator());
