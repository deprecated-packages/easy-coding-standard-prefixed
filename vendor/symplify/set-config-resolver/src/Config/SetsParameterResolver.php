...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperbcc0395698f8\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperbcc0395698f8\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperbcc0395698f8\Symfony\Component\Config\FileLocator());
