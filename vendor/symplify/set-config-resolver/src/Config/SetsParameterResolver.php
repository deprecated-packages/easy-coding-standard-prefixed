...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper908feaf49cd8\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper908feaf49cd8\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper908feaf49cd8\Symfony\Component\Config\FileLocator());
