...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper326af2119eba\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper326af2119eba\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper326af2119eba\Symfony\Component\Config\FileLocator());
