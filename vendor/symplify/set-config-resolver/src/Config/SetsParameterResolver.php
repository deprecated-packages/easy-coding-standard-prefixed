...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper065e4ba46e6d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper065e4ba46e6d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper065e4ba46e6d\Symfony\Component\Config\FileLocator());
