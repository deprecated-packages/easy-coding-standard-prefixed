...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper56c9df53a081\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper56c9df53a081\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper56c9df53a081\Symfony\Component\Config\FileLocator());
