...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper83b3b9a317c0\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper83b3b9a317c0\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper83b3b9a317c0\Symfony\Component\Config\FileLocator());
