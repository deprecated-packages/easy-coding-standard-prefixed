...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper37a255897161\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper37a255897161\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper37a255897161\Symfony\Component\Config\FileLocator());
