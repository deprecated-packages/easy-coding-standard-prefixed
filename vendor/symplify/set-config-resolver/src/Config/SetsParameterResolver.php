...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper10b1b2c5ca55\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper10b1b2c5ca55\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper10b1b2c5ca55\Symfony\Component\Config\FileLocator());
