...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper31ba553edf97\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper31ba553edf97\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper31ba553edf97\Symfony\Component\Config\FileLocator());
