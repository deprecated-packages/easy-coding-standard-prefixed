...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper269dc521b0fa\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper269dc521b0fa\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper269dc521b0fa\Symfony\Component\Config\FileLocator());
