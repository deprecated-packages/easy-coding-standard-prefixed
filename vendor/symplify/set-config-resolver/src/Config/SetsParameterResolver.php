...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper279cf54b77ad\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper279cf54b77ad\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper279cf54b77ad\Symfony\Component\Config\FileLocator());
