...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper83a475a0590e\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper83a475a0590e\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper83a475a0590e\Symfony\Component\Config\FileLocator());
