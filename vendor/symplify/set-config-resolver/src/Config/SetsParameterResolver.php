...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper229e8121cf9f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper229e8121cf9f\Symfony\Component\Config\FileLocator());
