...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper02b5d1bf8fec\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper02b5d1bf8fec\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper02b5d1bf8fec\Symfony\Component\Config\FileLocator());
