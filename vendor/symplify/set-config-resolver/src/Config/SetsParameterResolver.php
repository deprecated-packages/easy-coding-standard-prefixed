...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper75713bc3e278\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper75713bc3e278\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper75713bc3e278\Symfony\Component\Config\FileLocator());
