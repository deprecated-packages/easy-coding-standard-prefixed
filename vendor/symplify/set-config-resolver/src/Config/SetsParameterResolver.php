...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper967c4b7e296e\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper967c4b7e296e\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper967c4b7e296e\Symfony\Component\Config\FileLocator());
