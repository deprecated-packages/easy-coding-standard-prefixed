...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper13133e188f67\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper13133e188f67\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper13133e188f67\Symfony\Component\Config\FileLocator());
