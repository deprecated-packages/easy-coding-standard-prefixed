...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper63567e560066\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper63567e560066\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper63567e560066\Symfony\Component\Config\FileLocator());
