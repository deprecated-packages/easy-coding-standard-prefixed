...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper66292c14b658\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper66292c14b658\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper66292c14b658\Symfony\Component\Config\FileLocator());
