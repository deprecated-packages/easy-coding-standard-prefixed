...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper4a718ec9156e\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper4a718ec9156e\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper4a718ec9156e\Symfony\Component\Config\FileLocator());
