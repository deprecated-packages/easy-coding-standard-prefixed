...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3e1e0e5bb8ef\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper3e1e0e5bb8ef\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3e1e0e5bb8ef\Symfony\Component\Config\FileLocator());
