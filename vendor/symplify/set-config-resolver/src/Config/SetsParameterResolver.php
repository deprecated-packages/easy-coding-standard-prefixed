...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper629192f0909b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper629192f0909b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper629192f0909b\Symfony\Component\Config\FileLocator());
