...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera4be459e5e3d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera4be459e5e3d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera4be459e5e3d\Symfony\Component\Config\FileLocator());
