...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperf3dc21757def\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperf3dc21757def\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperf3dc21757def\Symfony\Component\Config\FileLocator());
