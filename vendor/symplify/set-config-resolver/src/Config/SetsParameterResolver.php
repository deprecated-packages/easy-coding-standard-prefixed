...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper9d73a84b09ad\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper9d73a84b09ad\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper9d73a84b09ad\Symfony\Component\Config\FileLocator());
