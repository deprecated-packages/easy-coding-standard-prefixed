...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper89ec3c69e67d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper89ec3c69e67d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper89ec3c69e67d\Symfony\Component\Config\FileLocator());
