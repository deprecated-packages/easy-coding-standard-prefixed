...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper836bc32aecc2\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper836bc32aecc2\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper836bc32aecc2\Symfony\Component\Config\FileLocator());
