...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera4fc793dae73\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera4fc793dae73\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera4fc793dae73\Symfony\Component\Config\FileLocator());
