...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperc4ea0f0bd23f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperc4ea0f0bd23f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperc4ea0f0bd23f\Symfony\Component\Config\FileLocator());
