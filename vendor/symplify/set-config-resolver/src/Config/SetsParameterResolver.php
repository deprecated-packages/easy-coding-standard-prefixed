...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper48b5ec5b60cf\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper48b5ec5b60cf\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper48b5ec5b60cf\Symfony\Component\Config\FileLocator());
