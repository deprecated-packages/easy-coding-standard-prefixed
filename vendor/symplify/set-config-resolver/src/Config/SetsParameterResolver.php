...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper70072c07b02b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper70072c07b02b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper70072c07b02b\Symfony\Component\Config\FileLocator());
