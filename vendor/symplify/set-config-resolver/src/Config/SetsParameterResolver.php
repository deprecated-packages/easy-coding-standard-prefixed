...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper48800f361566\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper48800f361566\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper48800f361566\Symfony\Component\Config\FileLocator());
