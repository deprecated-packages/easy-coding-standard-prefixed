...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper89c09b8e7101\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper89c09b8e7101\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper89c09b8e7101\Symfony\Component\Config\FileLocator());
