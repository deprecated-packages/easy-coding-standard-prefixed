...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper0270f1d35181\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper0270f1d35181\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper0270f1d35181\Symfony\Component\Config\FileLocator());
