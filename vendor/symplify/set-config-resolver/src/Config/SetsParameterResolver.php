...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper92597f5b42a7\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper92597f5b42a7\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper92597f5b42a7\Symfony\Component\Config\FileLocator());
