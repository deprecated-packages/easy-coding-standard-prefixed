...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper23ef26a4fb01\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper23ef26a4fb01\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper23ef26a4fb01\Symfony\Component\Config\FileLocator());
