...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper80dbed43490f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper80dbed43490f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper80dbed43490f\Symfony\Component\Config\FileLocator());
