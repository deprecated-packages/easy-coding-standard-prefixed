...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper745103eaabcd\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper745103eaabcd\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper745103eaabcd\Symfony\Component\Config\FileLocator());
