...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper11a6395266c4\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper11a6395266c4\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper11a6395266c4\Symfony\Component\Config\FileLocator());
