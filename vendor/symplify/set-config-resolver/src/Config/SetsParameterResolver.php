...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera37d6fb0b1ab\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera37d6fb0b1ab\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera37d6fb0b1ab\Symfony\Component\Config\FileLocator());
