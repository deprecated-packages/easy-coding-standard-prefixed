...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper49c742f5a4ee\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper49c742f5a4ee\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper49c742f5a4ee\Symfony\Component\Config\FileLocator());
