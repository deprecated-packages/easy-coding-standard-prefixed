...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper8db4616aa69d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper8db4616aa69d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper8db4616aa69d\Symfony\Component\Config\FileLocator());
