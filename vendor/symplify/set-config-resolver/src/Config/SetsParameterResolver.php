...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper614deab2c612\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper614deab2c612\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper614deab2c612\Symfony\Component\Config\FileLocator());
