...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera04bf8e97c06\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera04bf8e97c06\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera04bf8e97c06\Symfony\Component\Config\FileLocator());
