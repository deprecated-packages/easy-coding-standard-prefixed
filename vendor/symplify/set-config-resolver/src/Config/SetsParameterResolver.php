...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperb09c3ec8e01a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperb09c3ec8e01a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperb09c3ec8e01a\Symfony\Component\Config\FileLocator());
