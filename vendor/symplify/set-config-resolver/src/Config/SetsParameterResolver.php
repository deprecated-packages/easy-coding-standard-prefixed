...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera749ac204cd2\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera749ac204cd2\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera749ac204cd2\Symfony\Component\Config\FileLocator());
