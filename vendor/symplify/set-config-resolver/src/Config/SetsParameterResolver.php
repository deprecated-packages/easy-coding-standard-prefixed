...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperbd5c5a045153\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoperbd5c5a045153\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperbd5c5a045153\Symfony\Component\Config\FileLocator());
