...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera23ebff5477f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScopera23ebff5477f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera23ebff5477f\Symfony\Component\Config\FileLocator());
