...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper59ccd3f8e121\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper59ccd3f8e121\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper59ccd3f8e121\Symfony\Component\Config\FileLocator());
