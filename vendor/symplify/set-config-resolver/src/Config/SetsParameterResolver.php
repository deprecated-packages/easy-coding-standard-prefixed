...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper7b8580219c59\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper7b8580219c59\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper7b8580219c59\Symfony\Component\Config\FileLocator());
