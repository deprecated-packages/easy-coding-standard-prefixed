...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper64ca614e27fd\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper64ca614e27fd\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper64ca614e27fd\Symfony\Component\Config\FileLocator());
