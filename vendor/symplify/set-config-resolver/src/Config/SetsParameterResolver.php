...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3ba93baeac18\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper3ba93baeac18\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3ba93baeac18\Symfony\Component\Config\FileLocator());
