...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper9ef667a5e42c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    private function resolveSetsParameterFromPhpFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $configFileInfo) : array
    {
        ...
        $phpFileLoader = new \_PhpScoper9ef667a5e42c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper9ef667a5e42c\Symfony\Component\Config\FileLocator());
