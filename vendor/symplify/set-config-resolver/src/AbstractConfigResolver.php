...
abstract class AbstractConfigResolver
{
    ...
    public function resolveFromInput(\_PhpScoper842c7347e6be\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
     ...
     */
    public function resolveFromInputWithFallback(\_PhpScoper842c7347e6be\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
