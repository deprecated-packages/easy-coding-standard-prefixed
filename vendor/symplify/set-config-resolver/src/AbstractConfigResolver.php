...
abstract class AbstractConfigResolver
{
    ...
    public function resolveFromInput(\_PhpScoper3e8786a75afe\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
     ...
     */
    public function resolveFromInputWithFallback(\_PhpScoper3e8786a75afe\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
