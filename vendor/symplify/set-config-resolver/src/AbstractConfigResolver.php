...
abstract class AbstractConfigResolver
{
    ...
    public function resolveFromInput(\_PhpScoperb6a8e65b492c\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
     ...
     */
    public function resolveFromInputWithFallback(\_PhpScoperb6a8e65b492c\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
