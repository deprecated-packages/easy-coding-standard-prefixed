...
abstract class AbstractConfigResolver
{
    ...
    public function resolveFromInput(\_PhpScoper58a0a169dcfb\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
     ...
     */
    public function resolveFromInputWithFallback(\_PhpScoper58a0a169dcfb\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
