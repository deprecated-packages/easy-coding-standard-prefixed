...
abstract class AbstractConfigResolver
{
    ...
    public function resolveFromInput(\_PhpScoper86aebf8cf357\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
     ...
     */
    public function resolveFromInputWithFallback(\_PhpScoper86aebf8cf357\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
