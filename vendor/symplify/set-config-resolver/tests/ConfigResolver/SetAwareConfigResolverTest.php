...
final class SetAwareConfigResolverTest extends \_PhpScoper14cb6de5473d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper14cb6de5473d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper14cb6de5473d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
