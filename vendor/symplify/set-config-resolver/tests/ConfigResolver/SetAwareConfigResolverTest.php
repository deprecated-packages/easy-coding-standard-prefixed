...
final class SetAwareConfigResolverTest extends \_PhpScoper04022cd986ec\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper04022cd986ec\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper04022cd986ec\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
