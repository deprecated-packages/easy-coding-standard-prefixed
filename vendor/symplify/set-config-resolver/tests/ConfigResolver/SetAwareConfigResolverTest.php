...
final class SetAwareConfigResolverTest extends \_PhpScoper66292c14b658\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper66292c14b658\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper66292c14b658\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
