...
final class SetAwareConfigResolverTest extends \_PhpScoper83b3b9a317c0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper83b3b9a317c0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper83b3b9a317c0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
