...
final class SetAwareConfigResolverTest extends \_PhpScoperaad82bb90a86\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperaad82bb90a86\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperaad82bb90a86\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
