...
final class SetAwareConfigResolverTest extends \_PhpScopercf909b66eba8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopercf909b66eba8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopercf909b66eba8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
