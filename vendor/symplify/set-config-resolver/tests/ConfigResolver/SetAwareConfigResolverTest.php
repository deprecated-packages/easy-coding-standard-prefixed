...
final class SetAwareConfigResolverTest extends \_PhpScopera34ae19e8d40\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera34ae19e8d40\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera34ae19e8d40\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
