...
final class SetAwareConfigResolverTest extends \_PhpScoper807f8e74693b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper807f8e74693b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper807f8e74693b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
