...
final class SetAwareConfigResolverTest extends \_PhpScoper470d6df94ac0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper470d6df94ac0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper470d6df94ac0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
