...
final class SetAwareConfigResolverTest extends \_PhpScopera4be459e5e3d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera4be459e5e3d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera4be459e5e3d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
