...
final class SetAwareConfigResolverTest extends \_PhpScoper279cf54b77ad\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper279cf54b77ad\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper279cf54b77ad\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
