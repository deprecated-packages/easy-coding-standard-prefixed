...
final class SetAwareConfigResolverTest extends \_PhpScoperaba240c3d5f1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperaba240c3d5f1\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperaba240c3d5f1\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
