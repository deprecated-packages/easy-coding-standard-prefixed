...
final class SetAwareConfigResolverTest extends \_PhpScoper23ef26a4fb01\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper23ef26a4fb01\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper23ef26a4fb01\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
