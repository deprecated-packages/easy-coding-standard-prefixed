...
final class SetAwareConfigResolverTest extends \_PhpScoper2a48669dad72\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper2a48669dad72\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper2a48669dad72\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
