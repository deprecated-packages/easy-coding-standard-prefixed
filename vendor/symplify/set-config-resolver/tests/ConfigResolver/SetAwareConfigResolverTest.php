...
final class SetAwareConfigResolverTest extends \_PhpScoper21763e6c7ac4\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper21763e6c7ac4\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper21763e6c7ac4\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
