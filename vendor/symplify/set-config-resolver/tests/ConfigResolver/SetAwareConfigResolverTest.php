...
final class SetAwareConfigResolverTest extends \_PhpScoper488221d5cc83\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper488221d5cc83\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper488221d5cc83\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
