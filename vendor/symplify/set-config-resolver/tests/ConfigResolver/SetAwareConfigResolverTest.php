...
final class SetAwareConfigResolverTest extends \_PhpScoperbaf90856897c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperbaf90856897c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperbaf90856897c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
