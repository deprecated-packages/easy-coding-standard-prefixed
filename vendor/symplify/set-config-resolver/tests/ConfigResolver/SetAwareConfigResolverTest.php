...
final class SetAwareConfigResolverTest extends \_PhpScoper356bfb655d08\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper356bfb655d08\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper356bfb655d08\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
