...
final class SetAwareConfigResolverTest extends \_PhpScoper224ae0b86670\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper224ae0b86670\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper224ae0b86670\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
