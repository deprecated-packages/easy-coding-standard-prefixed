...
final class SetAwareConfigResolverTest extends \_PhpScoper592524ba34f0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper592524ba34f0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper592524ba34f0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
