...
final class SetAwareConfigResolverTest extends \_PhpScoper614deab2c612\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper614deab2c612\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper614deab2c612\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
