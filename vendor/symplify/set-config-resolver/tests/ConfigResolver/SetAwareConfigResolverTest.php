...
final class SetAwareConfigResolverTest extends \_PhpScoperaa402dd1b1f1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperaa402dd1b1f1\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperaa402dd1b1f1\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
