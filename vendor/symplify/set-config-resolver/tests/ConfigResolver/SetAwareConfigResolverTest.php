...
final class SetAwareConfigResolverTest extends \_PhpScoperea337ed74749\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperea337ed74749\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperea337ed74749\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
