...
final class SetAwareConfigResolverTest extends \_PhpScoper17bb67c99ade\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper17bb67c99ade\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper17bb67c99ade\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
