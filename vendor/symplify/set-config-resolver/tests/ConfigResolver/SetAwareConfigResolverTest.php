...
final class SetAwareConfigResolverTest extends \_PhpScopera04bf8e97c06\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera04bf8e97c06\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera04bf8e97c06\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
