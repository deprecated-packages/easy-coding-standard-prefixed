...
final class SetAwareConfigResolverTest extends \_PhpScoper80dbed43490f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper80dbed43490f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper80dbed43490f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
