...
final class SetAwareConfigResolverTest extends \_PhpScoper167729fa1dde\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper167729fa1dde\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper167729fa1dde\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
