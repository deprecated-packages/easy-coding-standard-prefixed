...
final class SetAwareConfigResolverTest extends \_PhpScoper57272265e1c9\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper57272265e1c9\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper57272265e1c9\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
