...
final class SetAwareConfigResolverTest extends \_PhpScoper21fff473f90a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper21fff473f90a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper21fff473f90a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
