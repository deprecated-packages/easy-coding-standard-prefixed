...
final class SetAwareConfigResolverTest extends \_PhpScoper6b644dbe715d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper6b644dbe715d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper6b644dbe715d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
