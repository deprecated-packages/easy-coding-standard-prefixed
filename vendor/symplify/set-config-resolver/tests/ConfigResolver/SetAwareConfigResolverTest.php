...
final class SetAwareConfigResolverTest extends \_PhpScoperad4605bb9267\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperad4605bb9267\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperad4605bb9267\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
