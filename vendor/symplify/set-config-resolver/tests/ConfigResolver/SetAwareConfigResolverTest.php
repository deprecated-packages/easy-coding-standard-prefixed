...
final class SetAwareConfigResolverTest extends \_PhpScoperdeea1786e972\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperdeea1786e972\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperdeea1786e972\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
