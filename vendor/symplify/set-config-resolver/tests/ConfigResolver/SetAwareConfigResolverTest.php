...
final class SetAwareConfigResolverTest extends \_PhpScoper48800f361566\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper48800f361566\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper48800f361566\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
