...
final class SetAwareConfigResolverTest extends \_PhpScoper45e499ef5890\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper45e499ef5890\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper45e499ef5890\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
