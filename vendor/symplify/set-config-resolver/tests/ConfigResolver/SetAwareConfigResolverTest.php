...
final class SetAwareConfigResolverTest extends \_PhpScoperb44a315fec16\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperb44a315fec16\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
