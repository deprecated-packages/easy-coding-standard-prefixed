...
final class SetAwareConfigResolverTest extends \_PhpScoper967c4b7e296e\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper967c4b7e296e\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper967c4b7e296e\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
