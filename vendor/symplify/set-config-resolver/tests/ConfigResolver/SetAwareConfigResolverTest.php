...
final class SetAwareConfigResolverTest extends \_PhpScoper75713bc3e278\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper75713bc3e278\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper75713bc3e278\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
