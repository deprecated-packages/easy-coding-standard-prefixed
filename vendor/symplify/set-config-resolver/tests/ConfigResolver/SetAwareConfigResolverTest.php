...
final class SetAwareConfigResolverTest extends \_PhpScoperf65af7a6d9a0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf65af7a6d9a0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf65af7a6d9a0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
