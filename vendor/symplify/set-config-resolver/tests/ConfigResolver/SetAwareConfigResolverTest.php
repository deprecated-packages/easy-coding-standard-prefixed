...
final class SetAwareConfigResolverTest extends \_PhpScoper10b1b2c5ca55\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper10b1b2c5ca55\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper10b1b2c5ca55\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
