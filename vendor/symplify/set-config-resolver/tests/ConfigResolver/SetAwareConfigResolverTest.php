...
final class SetAwareConfigResolverTest extends \_PhpScoper38a7d00685f8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper38a7d00685f8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper38a7d00685f8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
