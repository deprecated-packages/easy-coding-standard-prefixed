...
final class SetAwareConfigResolverTest extends \_PhpScoper967d20dce97a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper967d20dce97a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper967d20dce97a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
