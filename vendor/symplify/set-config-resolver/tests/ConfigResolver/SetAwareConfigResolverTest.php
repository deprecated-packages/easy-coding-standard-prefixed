...
final class SetAwareConfigResolverTest extends \_PhpScoper880bfa4d8b51\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper880bfa4d8b51\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper880bfa4d8b51\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
