...
final class SetAwareConfigResolverTest extends \_PhpScoper255a4eaff575\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper255a4eaff575\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper255a4eaff575\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
