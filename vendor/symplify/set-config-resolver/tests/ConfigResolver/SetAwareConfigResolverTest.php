...
final class SetAwareConfigResolverTest extends \_PhpScoperb458b528613f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperb458b528613f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperb458b528613f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
