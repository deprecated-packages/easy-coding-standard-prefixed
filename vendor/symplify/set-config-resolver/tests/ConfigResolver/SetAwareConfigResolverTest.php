...
final class SetAwareConfigResolverTest extends \_PhpScoper239b374a39c8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper239b374a39c8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper239b374a39c8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
