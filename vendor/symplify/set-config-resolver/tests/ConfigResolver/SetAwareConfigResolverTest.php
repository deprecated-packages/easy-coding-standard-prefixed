...
final class SetAwareConfigResolverTest extends \_PhpScoper39d23eef9a06\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper39d23eef9a06\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper39d23eef9a06\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
