...
final class SetAwareConfigResolverTest extends \_PhpScopera4fc793dae73\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera4fc793dae73\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera4fc793dae73\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
