...
final class SetAwareConfigResolverTest extends \_PhpScoper190659c42b56\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper190659c42b56\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper190659c42b56\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
