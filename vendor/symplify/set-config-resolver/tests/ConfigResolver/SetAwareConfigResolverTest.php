...
final class SetAwareConfigResolverTest extends \_PhpScoper06c66bea2cf6\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper06c66bea2cf6\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper06c66bea2cf6\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
