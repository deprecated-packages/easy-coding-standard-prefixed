...
final class SetAwareConfigResolverTest extends \_PhpScopera238de2e9b5a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera238de2e9b5a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera238de2e9b5a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
