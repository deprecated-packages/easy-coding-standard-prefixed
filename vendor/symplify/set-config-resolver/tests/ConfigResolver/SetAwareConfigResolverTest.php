...
final class SetAwareConfigResolverTest extends \_PhpScoper58a0a169dcfb\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper58a0a169dcfb\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper58a0a169dcfb\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
