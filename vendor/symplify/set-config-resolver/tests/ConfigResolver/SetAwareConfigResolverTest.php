...
final class SetAwareConfigResolverTest extends \_PhpScoper92feab6bddf8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper92feab6bddf8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper92feab6bddf8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
