...
final class SetAwareConfigResolverTest extends \_PhpScopera061b8a47e36\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera061b8a47e36\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera061b8a47e36\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
