...
final class SetAwareConfigResolverTest extends \_PhpScoper0ba97041430d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0ba97041430d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0ba97041430d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
