...
final class SetAwareConfigResolverTest extends \_PhpScoper836bc32aecc2\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper836bc32aecc2\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper836bc32aecc2\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
