...
final class SetAwareConfigResolverTest extends \_PhpScoper4972b76c81a2\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper4972b76c81a2\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper4972b76c81a2\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
