...
final class SetAwareConfigResolverTest extends \_PhpScopera40fc53e636b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera40fc53e636b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera40fc53e636b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
