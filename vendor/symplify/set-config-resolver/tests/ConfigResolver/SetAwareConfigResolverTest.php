...
final class SetAwareConfigResolverTest extends \_PhpScoper5465fda93cc7\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper5465fda93cc7\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper5465fda93cc7\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
