...
final class SetAwareConfigResolverTest extends \_PhpScopere015d8a3273c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopere015d8a3273c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopere015d8a3273c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
