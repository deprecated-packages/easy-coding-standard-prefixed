...
final class SetAwareConfigResolverTest extends \_PhpScoper6224e3b16fcc\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper6224e3b16fcc\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper6224e3b16fcc\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
