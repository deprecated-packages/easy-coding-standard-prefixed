...
final class SetAwareConfigResolverTest extends \_PhpScoper246d3630afdd\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper246d3630afdd\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper246d3630afdd\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
