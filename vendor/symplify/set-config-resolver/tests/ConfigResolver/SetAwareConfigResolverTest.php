...
final class SetAwareConfigResolverTest extends \_PhpScoper83a475a0590e\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper83a475a0590e\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper83a475a0590e\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
