...
final class SetAwareConfigResolverTest extends \_PhpScoper457dd3bd73ba\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper457dd3bd73ba\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper457dd3bd73ba\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
