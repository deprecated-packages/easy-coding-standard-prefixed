...
final class SetAwareConfigResolverTest extends \_PhpScoper86aa49a51982\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper86aa49a51982\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper86aa49a51982\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
