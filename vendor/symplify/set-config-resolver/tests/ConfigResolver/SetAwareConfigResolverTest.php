...
final class SetAwareConfigResolverTest extends \_PhpScoper61bdb485188f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper61bdb485188f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper61bdb485188f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
