...
final class SetAwareConfigResolverTest extends \_PhpScoperc5bee3a837bb\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperc5bee3a837bb\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperc5bee3a837bb\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
