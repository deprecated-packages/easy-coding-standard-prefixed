...
final class SetAwareConfigResolverTest extends \_PhpScoperd35c27cd4b09\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperd35c27cd4b09\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperd35c27cd4b09\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
