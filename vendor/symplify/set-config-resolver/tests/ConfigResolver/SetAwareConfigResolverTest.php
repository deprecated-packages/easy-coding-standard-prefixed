...
final class SetAwareConfigResolverTest extends \_PhpScoperc95ae4bf942a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperc95ae4bf942a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperc95ae4bf942a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
