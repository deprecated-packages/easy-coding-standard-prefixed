...
final class SetAwareConfigResolverTest extends \_PhpScoperc4ea0f0bd23f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperc4ea0f0bd23f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperc4ea0f0bd23f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
