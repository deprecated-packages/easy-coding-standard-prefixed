...
final class SetAwareConfigResolverTest extends \_PhpScoper870c18c2de74\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper870c18c2de74\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper870c18c2de74\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
