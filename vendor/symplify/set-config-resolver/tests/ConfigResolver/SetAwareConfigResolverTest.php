...
final class SetAwareConfigResolverTest extends \_PhpScoper7cef7256eba6\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper7cef7256eba6\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper7cef7256eba6\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
