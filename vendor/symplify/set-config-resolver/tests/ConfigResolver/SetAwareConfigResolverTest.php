...
final class SetAwareConfigResolverTest extends \_PhpScopera23ebff5477f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera23ebff5477f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera23ebff5477f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
