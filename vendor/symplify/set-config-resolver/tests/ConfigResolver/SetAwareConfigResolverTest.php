...
final class SetAwareConfigResolverTest extends \_PhpScopera09818bc50da\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera09818bc50da\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera09818bc50da\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
