...
final class SetAwareConfigResolverTest extends \_PhpScoperbcc0395698f8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperbcc0395698f8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperbcc0395698f8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
