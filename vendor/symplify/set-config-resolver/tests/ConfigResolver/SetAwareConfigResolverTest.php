...
final class SetAwareConfigResolverTest extends \_PhpScoper589e8c04a9ef\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper589e8c04a9ef\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper589e8c04a9ef\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
