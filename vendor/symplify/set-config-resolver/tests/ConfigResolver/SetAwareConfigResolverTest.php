...
final class SetAwareConfigResolverTest extends \_PhpScoperad4b7e2c09d8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperad4b7e2c09d8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperad4b7e2c09d8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
