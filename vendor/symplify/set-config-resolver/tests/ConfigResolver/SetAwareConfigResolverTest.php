...
final class SetAwareConfigResolverTest extends \_PhpScoperf3f1be0d8a30\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf3f1be0d8a30\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf3f1be0d8a30\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
