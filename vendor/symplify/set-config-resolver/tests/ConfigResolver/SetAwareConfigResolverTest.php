...
final class SetAwareConfigResolverTest extends \_PhpScopera1a51450b61d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera1a51450b61d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera1a51450b61d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
