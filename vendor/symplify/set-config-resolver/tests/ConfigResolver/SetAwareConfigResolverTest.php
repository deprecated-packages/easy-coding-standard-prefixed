...
final class SetAwareConfigResolverTest extends \_PhpScoper908feaf49cd8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper908feaf49cd8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper908feaf49cd8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
