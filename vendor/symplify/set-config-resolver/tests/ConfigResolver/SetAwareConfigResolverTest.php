...
final class SetAwareConfigResolverTest extends \_PhpScoper86aebf8cf357\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper86aebf8cf357\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper86aebf8cf357\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
