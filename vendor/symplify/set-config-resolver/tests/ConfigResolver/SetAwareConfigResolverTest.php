...
final class SetAwareConfigResolverTest extends \_PhpScoper842c7347e6be\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper842c7347e6be\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper842c7347e6be\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
