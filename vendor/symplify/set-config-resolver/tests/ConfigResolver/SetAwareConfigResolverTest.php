...
final class SetAwareConfigResolverTest extends \_PhpScoper70d1796231ae\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper70d1796231ae\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper70d1796231ae\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
