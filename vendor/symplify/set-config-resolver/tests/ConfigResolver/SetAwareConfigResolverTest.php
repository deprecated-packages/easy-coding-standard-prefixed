...
final class SetAwareConfigResolverTest extends \_PhpScoper21c6ce8bfe5d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper21c6ce8bfe5d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper21c6ce8bfe5d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
