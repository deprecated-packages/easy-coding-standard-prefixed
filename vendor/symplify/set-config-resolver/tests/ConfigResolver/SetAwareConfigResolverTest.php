...
final class SetAwareConfigResolverTest extends \_PhpScoperf361a7d70552\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf361a7d70552\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf361a7d70552\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
