...
final class SetAwareConfigResolverTest extends \_PhpScoper59558822d8c7\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper59558822d8c7\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper59558822d8c7\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
