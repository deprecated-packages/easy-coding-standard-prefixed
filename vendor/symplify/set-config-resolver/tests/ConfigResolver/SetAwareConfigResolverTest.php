...
final class SetAwareConfigResolverTest extends \_PhpScoper0c0702cca4ac\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0c0702cca4ac\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0c0702cca4ac\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
