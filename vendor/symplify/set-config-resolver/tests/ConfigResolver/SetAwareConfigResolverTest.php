...
final class SetAwareConfigResolverTest extends \_PhpScoperb36402634947\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperb36402634947\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperb36402634947\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
