...
final class SetAwareConfigResolverTest extends \_PhpScopera609aff833be\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera609aff833be\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera609aff833be\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
