...
final class SetAwareConfigResolverTest extends \_PhpScoper7faa8deb0d3c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper7faa8deb0d3c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper7faa8deb0d3c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
