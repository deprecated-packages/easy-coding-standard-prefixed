...
final class SetAwareConfigResolverTest extends \_PhpScoper839420027581\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper839420027581\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper839420027581\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
