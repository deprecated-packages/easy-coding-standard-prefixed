...
final class SetAwareConfigResolverTest extends \_PhpScoper992f4af8b9e0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper992f4af8b9e0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper992f4af8b9e0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
