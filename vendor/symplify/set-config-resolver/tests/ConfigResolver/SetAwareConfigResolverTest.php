...
final class SetAwareConfigResolverTest extends \_PhpScoper776637f3d3c3\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper776637f3d3c3\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper776637f3d3c3\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
