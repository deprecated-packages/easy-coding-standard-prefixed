...
final class SetAwareConfigResolverTest extends \_PhpScoperfb2c402b972b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperfb2c402b972b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperfb2c402b972b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
