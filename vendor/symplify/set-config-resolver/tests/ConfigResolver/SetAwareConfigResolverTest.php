...
final class SetAwareConfigResolverTest extends \_PhpScoper4a718ec9156e\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper4a718ec9156e\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper4a718ec9156e\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
