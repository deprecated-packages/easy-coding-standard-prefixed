...
final class SetAwareConfigResolverTest extends \_PhpScoper544eb478a6f6\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper544eb478a6f6\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper544eb478a6f6\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
