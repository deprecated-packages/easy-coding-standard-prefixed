...
final class SetAwareConfigResolverTest extends \_PhpScoper666af036e800\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper666af036e800\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper666af036e800\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
