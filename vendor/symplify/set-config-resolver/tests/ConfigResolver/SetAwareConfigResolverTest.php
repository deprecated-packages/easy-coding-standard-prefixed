...
final class SetAwareConfigResolverTest extends \_PhpScoperc64a4ac1af35\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperc64a4ac1af35\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperc64a4ac1af35\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
