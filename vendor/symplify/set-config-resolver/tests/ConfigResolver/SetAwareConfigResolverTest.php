...
final class SetAwareConfigResolverTest extends \_PhpScoperda2604e33acb\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperda2604e33acb\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperda2604e33acb\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
