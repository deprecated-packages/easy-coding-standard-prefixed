...
final class SetAwareConfigResolverTest extends \_PhpScoper02b5d1bf8fec\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper02b5d1bf8fec\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper02b5d1bf8fec\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
