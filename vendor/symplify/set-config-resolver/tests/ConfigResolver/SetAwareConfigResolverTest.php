...
final class SetAwareConfigResolverTest extends \_PhpScoper7c0f822a05e1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper7c0f822a05e1\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper7c0f822a05e1\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
