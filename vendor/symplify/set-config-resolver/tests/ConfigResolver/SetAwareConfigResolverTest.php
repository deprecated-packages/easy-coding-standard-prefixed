...
final class SetAwareConfigResolverTest extends \_PhpScoper79449c4e744b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper79449c4e744b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper79449c4e744b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
