...
final class SetAwareConfigResolverTest extends \_PhpScoper0f5cd390c37a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0f5cd390c37a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0f5cd390c37a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
