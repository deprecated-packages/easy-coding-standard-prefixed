...
final class SetAwareConfigResolverTest extends \_PhpScoper28ab463fc3ba\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper28ab463fc3ba\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper28ab463fc3ba\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
