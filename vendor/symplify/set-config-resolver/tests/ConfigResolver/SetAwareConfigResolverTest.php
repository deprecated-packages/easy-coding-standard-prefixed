...
final class SetAwareConfigResolverTest extends \_PhpScoper08686b2277af\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper08686b2277af\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper08686b2277af\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
