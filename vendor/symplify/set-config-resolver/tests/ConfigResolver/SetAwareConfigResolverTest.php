...
final class SetAwareConfigResolverTest extends \_PhpScoper4f985154d5a0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper4f985154d5a0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper4f985154d5a0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
