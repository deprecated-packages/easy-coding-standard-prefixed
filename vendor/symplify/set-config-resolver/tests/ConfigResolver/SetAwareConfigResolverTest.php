...
final class SetAwareConfigResolverTest extends \_PhpScoper578a67c80b2b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper578a67c80b2b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper578a67c80b2b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
