...
final class SetAwareConfigResolverTest extends \_PhpScoper2d2a405cc0f8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper2d2a405cc0f8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper2d2a405cc0f8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
