...
final class SetAwareConfigResolverTest extends \_PhpScoper1e80a2e03314\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper1e80a2e03314\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper1e80a2e03314\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
