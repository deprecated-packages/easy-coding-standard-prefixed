...
final class SetAwareConfigResolverTest extends \_PhpScoper68a3a2539032\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper68a3a2539032\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper68a3a2539032\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
