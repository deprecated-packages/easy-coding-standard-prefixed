...
final class SetAwareConfigResolverTest extends \_PhpScoper64e7ad844899\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper64e7ad844899\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper64e7ad844899\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
