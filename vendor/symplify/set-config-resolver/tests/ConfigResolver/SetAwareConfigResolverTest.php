...
final class SetAwareConfigResolverTest extends \_PhpScoper56c9df53a081\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper56c9df53a081\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper56c9df53a081\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
