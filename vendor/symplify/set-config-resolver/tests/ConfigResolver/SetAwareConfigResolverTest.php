...
final class SetAwareConfigResolverTest extends \_PhpScoper2a8ad010dfbd\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper2a8ad010dfbd\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper2a8ad010dfbd\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
