...
final class SetAwareConfigResolverTest extends \_PhpScoper96382aaac118\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper96382aaac118\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper96382aaac118\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
