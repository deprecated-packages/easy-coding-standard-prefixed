...
final class SetAwareConfigResolverTest extends \_PhpScoperdaf95aff095b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperdaf95aff095b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperdaf95aff095b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
