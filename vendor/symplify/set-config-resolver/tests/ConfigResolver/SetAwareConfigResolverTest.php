...
final class SetAwareConfigResolverTest extends \_PhpScoper133be48300f9\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper133be48300f9\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper133be48300f9\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
