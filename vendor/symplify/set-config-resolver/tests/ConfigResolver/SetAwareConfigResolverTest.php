...
final class SetAwareConfigResolverTest extends \_PhpScoper2b44cb0c30af\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper2b44cb0c30af\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper2b44cb0c30af\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
