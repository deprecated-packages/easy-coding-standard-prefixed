...
final class SetAwareConfigResolverTest extends \_PhpScoper37a255897161\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper37a255897161\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper37a255897161\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
