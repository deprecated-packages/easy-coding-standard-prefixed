...
final class SetAwareConfigResolverTest extends \_PhpScoperf3dc21757def\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf3dc21757def\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf3dc21757def\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
