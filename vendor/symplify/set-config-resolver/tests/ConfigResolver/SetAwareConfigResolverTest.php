...
final class SetAwareConfigResolverTest extends \_PhpScoper08748c77fa1c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper08748c77fa1c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper08748c77fa1c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
