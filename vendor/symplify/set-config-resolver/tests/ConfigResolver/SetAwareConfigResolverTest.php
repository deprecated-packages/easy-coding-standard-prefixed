...
final class SetAwareConfigResolverTest extends \_PhpScoperac4e86be08e5\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperac4e86be08e5\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperac4e86be08e5\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
