...
final class SetAwareConfigResolverTest extends \_PhpScoperf523baae4f87\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf523baae4f87\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf523baae4f87\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
