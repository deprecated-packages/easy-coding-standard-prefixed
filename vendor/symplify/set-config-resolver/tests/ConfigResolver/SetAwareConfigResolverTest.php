...
final class SetAwareConfigResolverTest extends \_PhpScoperecb978830f1e\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperecb978830f1e\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperecb978830f1e\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
