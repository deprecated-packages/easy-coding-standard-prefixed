...
final class SetAwareConfigResolverTest extends \_PhpScoper3a22e8e0bd94\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper3a22e8e0bd94\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper3a22e8e0bd94\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);
