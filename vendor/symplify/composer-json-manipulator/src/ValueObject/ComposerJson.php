...
use _PhpScoper7d3888cf4297\Nette\Utils\Arrays;
use _PhpScoper7d3888cf4297\Nette\Utils\Strings;
...
final class ComposerJson
{
    ...
    public function getShortName() : ?string
    {
        ...
        return \_PhpScoper7d3888cf4297\Nette\Utils\Strings::after($this->name, '/', -1);
    }
    /**
     * @return string[]
     */
    ...
    public function getAutoloadDirectories() : array
    {
        ...
        return \_PhpScoper7d3888cf4297\Nette\Utils\Arrays::flatten($autoloadDirectories);
    }
    /**
     * @return string[]
     */
