...
use _PhpScoper7b319b4d8e1c\Nette\Utils\Arrays;
use _PhpScoper7b319b4d8e1c\Nette\Utils\Strings;
...
final class ComposerJson
{
    ...
    public function getShortName() : ?string
    {
        ...
        return \_PhpScoper7b319b4d8e1c\Nette\Utils\Strings::after($this->name, '/', -1);
    }
    /**
     * @return string[]
     */
    ...
    public function getAutoloadDirectories() : array
    {
        ...
        return \_PhpScoper7b319b4d8e1c\Nette\Utils\Arrays::flatten($autoloadDirectories);
    }
    /**
     * @return string[]
     */
