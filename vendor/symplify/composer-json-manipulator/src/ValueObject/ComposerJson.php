...
use _PhpScoper02b5d1bf8fec\Nette\Utils\Arrays;
...
final class ComposerJson
{
    ...
    public function getShortName() : ?string
    {
        ...
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Strings::after($this->name, '/', -1);
    }
    /**
     * @return string[]
     */
    ...
    private function getAutoloadDirectories() : array
    {
        ...
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Arrays::flatten($autoloadDirectories);
    }
    /**
     * @return string[]
     */
