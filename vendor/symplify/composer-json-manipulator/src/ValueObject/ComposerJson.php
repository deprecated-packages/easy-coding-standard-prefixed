...
use _PhpScoper83b3b9a317c0\Nette\Utils\Arrays;
...
final class ComposerJson
{
    ...
    public function getShortName() : ?string
    {
        ...
        return \_PhpScoper83b3b9a317c0\Nette\Utils\Strings::after($this->name, '/', -1);
    }
    /**
     * @return string[]
     */
    ...
    private function getAutoloadDirectories() : array
    {
        ...
        return \_PhpScoper83b3b9a317c0\Nette\Utils\Arrays::flatten($autoloadDirectories);
    }
    /**
     * @return string[]
     */
