...
use _PhpScoperd8048db577a9\Nette\Utils\Arrays;
...
final class ComposerJson
{
    ...
    public function getShortName() : ?string
    {
        ...
        return \_PhpScoperd8048db577a9\Nette\Utils\Strings::after($this->name, '/', -1);
    }
    /**
     * @return string[]
     */
    ...
    public function getAutoloadDirectories() : array
    {
        ...
        return \_PhpScoperd8048db577a9\Nette\Utils\Arrays::flatten($autoloadDirectories);
    }
    /**
     * @return string[]
     */
