...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper065e4ba46e6d\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper065e4ba46e6d\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper065e4ba46e6d\Nette\Utils\Json::decode($fileContent, \_PhpScoper065e4ba46e6d\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper065e4ba46e6d\Nette\Utils\Json::encode($json, \_PhpScoper065e4ba46e6d\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
