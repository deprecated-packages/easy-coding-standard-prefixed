...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper02b5d1bf8fec\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Json::decode($fileContent, \_PhpScoper02b5d1bf8fec\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper02b5d1bf8fec\Nette\Utils\Json::encode($json, \_PhpScoper02b5d1bf8fec\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
