...
use _PhpScoper2f04ef4e8878\Nette\Utils\Json;
...
final class JsonFileManager
{
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \_PhpScoper2f04ef4e8878\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper2f04ef4e8878\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper2f04ef4e8878\Nette\Utils\Json::decode($fileContent, \_PhpScoper2f04ef4e8878\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper2f04ef4e8878\Nette\Utils\Json::encode($json, \_PhpScoper2f04ef4e8878\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
