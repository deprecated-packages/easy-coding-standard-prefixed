...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper58a0a169dcfb\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Json::decode($fileContent, \_PhpScoper58a0a169dcfb\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper58a0a169dcfb\Nette\Utils\Json::encode($json, \_PhpScoper58a0a169dcfb\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
