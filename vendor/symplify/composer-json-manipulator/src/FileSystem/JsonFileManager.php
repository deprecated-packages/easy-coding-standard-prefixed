...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperdf15f2b748e9\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperdf15f2b748e9\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperdf15f2b748e9\Nette\Utils\Json::decode($fileContent, \_PhpScoperdf15f2b748e9\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperdf15f2b748e9\Nette\Utils\Json::encode($json, \_PhpScoperdf15f2b748e9\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
