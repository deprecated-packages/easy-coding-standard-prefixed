...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera4be459e5e3d\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera4be459e5e3d\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera4be459e5e3d\Nette\Utils\Json::decode($fileContent, \_PhpScopera4be459e5e3d\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera4be459e5e3d\Nette\Utils\Json::encode($json, \_PhpScopera4be459e5e3d\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
