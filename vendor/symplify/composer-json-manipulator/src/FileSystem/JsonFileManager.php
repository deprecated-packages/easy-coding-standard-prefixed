...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera09818bc50da\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera09818bc50da\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera09818bc50da\Nette\Utils\Json::decode($fileContent, \_PhpScopera09818bc50da\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera09818bc50da\Nette\Utils\Json::encode($json, \_PhpScopera09818bc50da\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
