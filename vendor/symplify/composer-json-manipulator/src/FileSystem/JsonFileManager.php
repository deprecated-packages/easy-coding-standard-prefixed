...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperc95ae4bf942a\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperc95ae4bf942a\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperc95ae4bf942a\Nette\Utils\Json::decode($fileContent, \_PhpScoperc95ae4bf942a\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperc95ae4bf942a\Nette\Utils\Json::encode($json, \_PhpScoperc95ae4bf942a\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
