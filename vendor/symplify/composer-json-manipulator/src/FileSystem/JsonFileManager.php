...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperdc8fbcd7c69d\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperdc8fbcd7c69d\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperdc8fbcd7c69d\Nette\Utils\Json::decode($fileContent, \_PhpScoperdc8fbcd7c69d\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperdc8fbcd7c69d\Nette\Utils\Json::encode($json, \_PhpScoperdc8fbcd7c69d\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
