...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper167729fa1dde\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper167729fa1dde\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper167729fa1dde\Nette\Utils\Json::decode($fileContent, \_PhpScoper167729fa1dde\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper167729fa1dde\Nette\Utils\Json::encode($json, \_PhpScoper167729fa1dde\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
