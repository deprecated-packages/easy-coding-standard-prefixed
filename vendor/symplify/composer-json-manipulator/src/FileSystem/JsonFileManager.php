...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperda2604e33acb\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperda2604e33acb\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperda2604e33acb\Nette\Utils\Json::decode($fileContent, \_PhpScoperda2604e33acb\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperda2604e33acb\Nette\Utils\Json::encode($json, \_PhpScoperda2604e33acb\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
