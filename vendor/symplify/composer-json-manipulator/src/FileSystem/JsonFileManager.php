...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper992f4af8b9e0\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper992f4af8b9e0\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper992f4af8b9e0\Nette\Utils\Json::decode($fileContent, \_PhpScoper992f4af8b9e0\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper992f4af8b9e0\Nette\Utils\Json::encode($json, \_PhpScoper992f4af8b9e0\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
