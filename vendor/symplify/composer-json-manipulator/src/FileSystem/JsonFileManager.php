...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper79449c4e744b\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper79449c4e744b\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper79449c4e744b\Nette\Utils\Json::decode($fileContent, \_PhpScoper79449c4e744b\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper79449c4e744b\Nette\Utils\Json::encode($json, \_PhpScoper79449c4e744b\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
