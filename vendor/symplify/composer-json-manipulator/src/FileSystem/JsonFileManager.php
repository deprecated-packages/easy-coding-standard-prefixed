...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper13160cf3462c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper13160cf3462c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper13160cf3462c\Nette\Utils\Json::decode($fileContent, \_PhpScoper13160cf3462c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper13160cf3462c\Nette\Utils\Json::encode($json, \_PhpScoper13160cf3462c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
