...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperaac5f7c652e4\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperaac5f7c652e4\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperaac5f7c652e4\Nette\Utils\Json::decode($fileContent, \_PhpScoperaac5f7c652e4\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperaac5f7c652e4\Nette\Utils\Json::encode($json, \_PhpScoperaac5f7c652e4\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
