...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera4fc793dae73\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera4fc793dae73\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera4fc793dae73\Nette\Utils\Json::decode($fileContent, \_PhpScopera4fc793dae73\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera4fc793dae73\Nette\Utils\Json::encode($json, \_PhpScopera4fc793dae73\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
