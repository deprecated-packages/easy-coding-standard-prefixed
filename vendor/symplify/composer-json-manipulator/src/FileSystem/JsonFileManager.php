...
use _PhpScoper5e5ebcdbebdf\Nette\Utils\Json;
...
final class JsonFileManager
{
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \_PhpScoper5e5ebcdbebdf\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper5e5ebcdbebdf\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper5e5ebcdbebdf\Nette\Utils\Json::decode($fileContent, \_PhpScoper5e5ebcdbebdf\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper5e5ebcdbebdf\Nette\Utils\Json::encode($json, \_PhpScoper5e5ebcdbebdf\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
