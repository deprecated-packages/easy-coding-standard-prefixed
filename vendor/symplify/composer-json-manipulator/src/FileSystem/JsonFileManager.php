...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperfab1bfb7ec99\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperfab1bfb7ec99\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperfab1bfb7ec99\Nette\Utils\Json::decode($fileContent, \_PhpScoperfab1bfb7ec99\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperfab1bfb7ec99\Nette\Utils\Json::encode($json, \_PhpScoperfab1bfb7ec99\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
