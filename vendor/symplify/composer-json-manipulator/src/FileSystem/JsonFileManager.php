...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper7c0f822a05e1\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper7c0f822a05e1\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper7c0f822a05e1\Nette\Utils\Json::decode($fileContent, \_PhpScoper7c0f822a05e1\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper7c0f822a05e1\Nette\Utils\Json::encode($json, \_PhpScoper7c0f822a05e1\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
