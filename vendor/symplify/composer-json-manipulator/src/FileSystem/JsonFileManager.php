...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper64ca614e27fd\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper64ca614e27fd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper64ca614e27fd\Nette\Utils\Json::decode($fileContent, \_PhpScoper64ca614e27fd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper64ca614e27fd\Nette\Utils\Json::encode($json, \_PhpScoper64ca614e27fd\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
