...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera40fc53e636b\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera40fc53e636b\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera40fc53e636b\Nette\Utils\Json::decode($fileContent, \_PhpScopera40fc53e636b\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera40fc53e636b\Nette\Utils\Json::encode($json, \_PhpScopera40fc53e636b\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
