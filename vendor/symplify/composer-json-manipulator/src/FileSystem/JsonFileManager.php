...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper80dbed43490f\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper80dbed43490f\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper80dbed43490f\Nette\Utils\Json::decode($fileContent, \_PhpScoper80dbed43490f\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper80dbed43490f\Nette\Utils\Json::encode($json, \_PhpScoper80dbed43490f\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
