...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperac4e86be08e5\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperac4e86be08e5\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperac4e86be08e5\Nette\Utils\Json::decode($fileContent, \_PhpScoperac4e86be08e5\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperac4e86be08e5\Nette\Utils\Json::encode($json, \_PhpScoperac4e86be08e5\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
