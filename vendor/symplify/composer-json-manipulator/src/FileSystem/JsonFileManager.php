...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper68a3a2539032\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper68a3a2539032\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper68a3a2539032\Nette\Utils\Json::decode($fileContent, \_PhpScoper68a3a2539032\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper68a3a2539032\Nette\Utils\Json::encode($json, \_PhpScoper68a3a2539032\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
