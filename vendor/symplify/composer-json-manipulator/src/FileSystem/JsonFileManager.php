...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper04022cd986ec\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper04022cd986ec\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper04022cd986ec\Nette\Utils\Json::decode($fileContent, \_PhpScoper04022cd986ec\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper04022cd986ec\Nette\Utils\Json::encode($json, \_PhpScoper04022cd986ec\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
