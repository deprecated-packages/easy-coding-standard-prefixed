...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperdf6a0b341030\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperdf6a0b341030\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperdf6a0b341030\Nette\Utils\Json::decode($fileContent, \_PhpScoperdf6a0b341030\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperdf6a0b341030\Nette\Utils\Json::encode($json, \_PhpScoperdf6a0b341030\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
