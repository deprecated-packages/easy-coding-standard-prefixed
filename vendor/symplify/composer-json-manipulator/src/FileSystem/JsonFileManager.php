...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper9d73a84b09ad\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper9d73a84b09ad\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper9d73a84b09ad\Nette\Utils\Json::decode($fileContent, \_PhpScoper9d73a84b09ad\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper9d73a84b09ad\Nette\Utils\Json::encode($json, \_PhpScoper9d73a84b09ad\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
