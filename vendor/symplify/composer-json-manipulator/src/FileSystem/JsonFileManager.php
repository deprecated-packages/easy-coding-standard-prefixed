...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper326bba7310a2\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper326bba7310a2\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper326bba7310a2\Nette\Utils\Json::decode($fileContent, \_PhpScoper326bba7310a2\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper326bba7310a2\Nette\Utils\Json::encode($json, \_PhpScoper326bba7310a2\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
