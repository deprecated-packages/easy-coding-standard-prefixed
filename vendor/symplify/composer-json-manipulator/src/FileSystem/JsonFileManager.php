...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperbaf90856897c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperbaf90856897c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperbaf90856897c\Nette\Utils\Json::decode($fileContent, \_PhpScoperbaf90856897c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperbaf90856897c\Nette\Utils\Json::encode($json, \_PhpScoperbaf90856897c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
