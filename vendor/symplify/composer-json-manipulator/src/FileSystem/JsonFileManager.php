...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperb458b528613f\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperb458b528613f\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperb458b528613f\Nette\Utils\Json::decode($fileContent, \_PhpScoperb458b528613f\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperb458b528613f\Nette\Utils\Json::encode($json, \_PhpScoperb458b528613f\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
