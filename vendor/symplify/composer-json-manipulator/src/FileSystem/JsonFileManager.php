...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperd35c27cd4b09\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperd35c27cd4b09\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperd35c27cd4b09\Nette\Utils\Json::decode($fileContent, \_PhpScoperd35c27cd4b09\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperd35c27cd4b09\Nette\Utils\Json::encode($json, \_PhpScoperd35c27cd4b09\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
