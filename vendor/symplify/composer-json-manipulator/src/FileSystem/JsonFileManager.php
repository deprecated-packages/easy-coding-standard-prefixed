...
use _PhpScoper5f6e904600e7\Nette\Utils\Json;
...
final class JsonFileManager
{
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \_PhpScoper5f6e904600e7\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper5f6e904600e7\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper5f6e904600e7\Nette\Utils\Json::decode($fileContent, \_PhpScoper5f6e904600e7\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper5f6e904600e7\Nette\Utils\Json::encode($json, \_PhpScoper5f6e904600e7\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
