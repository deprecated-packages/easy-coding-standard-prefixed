...
use _PhpScoperf5c57eca8aae\Nette\Utils\Json;
...
final class JsonFileManager
{
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \_PhpScoperf5c57eca8aae\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperf5c57eca8aae\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperf5c57eca8aae\Nette\Utils\Json::decode($fileContent, \_PhpScoperf5c57eca8aae\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperf5c57eca8aae\Nette\Utils\Json::encode($json, \_PhpScoperf5c57eca8aae\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
