...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper08748c77fa1c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper08748c77fa1c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper08748c77fa1c\Nette\Utils\Json::decode($fileContent, \_PhpScoper08748c77fa1c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper08748c77fa1c\Nette\Utils\Json::encode($json, \_PhpScoper08748c77fa1c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
