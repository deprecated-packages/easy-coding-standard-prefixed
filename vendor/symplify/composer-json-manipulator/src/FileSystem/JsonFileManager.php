...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper2fe14d6302bc\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper2fe14d6302bc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper2fe14d6302bc\Nette\Utils\Json::decode($fileContent, \_PhpScoper2fe14d6302bc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper2fe14d6302bc\Nette\Utils\Json::encode($json, \_PhpScoper2fe14d6302bc\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
