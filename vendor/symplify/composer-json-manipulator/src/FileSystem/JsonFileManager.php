...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperb44a315fec16\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperb44a315fec16\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperb44a315fec16\Nette\Utils\Json::decode($fileContent, \_PhpScoperb44a315fec16\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperb44a315fec16\Nette\Utils\Json::encode($json, \_PhpScoperb44a315fec16\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
