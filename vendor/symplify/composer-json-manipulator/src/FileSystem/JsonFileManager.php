...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperad4b7e2c09d8\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperad4b7e2c09d8\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperad4b7e2c09d8\Nette\Utils\Json::decode($fileContent, \_PhpScoperad4b7e2c09d8\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperad4b7e2c09d8\Nette\Utils\Json::encode($json, \_PhpScoperad4b7e2c09d8\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
