...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper528afa732cbd\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper528afa732cbd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper528afa732cbd\Nette\Utils\Json::decode($fileContent, \_PhpScoper528afa732cbd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper528afa732cbd\Nette\Utils\Json::encode($json, \_PhpScoper528afa732cbd\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
