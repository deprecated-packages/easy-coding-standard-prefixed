...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperc753ccca5a0c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperc753ccca5a0c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperc753ccca5a0c\Nette\Utils\Json::decode($fileContent, \_PhpScoperc753ccca5a0c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperc753ccca5a0c\Nette\Utils\Json::encode($json, \_PhpScoperc753ccca5a0c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
