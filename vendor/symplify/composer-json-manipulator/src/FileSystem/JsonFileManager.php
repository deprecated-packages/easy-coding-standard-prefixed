...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperb2e2c0c42e71\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperb2e2c0c42e71\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperb2e2c0c42e71\Nette\Utils\Json::decode($fileContent, \_PhpScoperb2e2c0c42e71\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperb2e2c0c42e71\Nette\Utils\Json::encode($json, \_PhpScoperb2e2c0c42e71\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
