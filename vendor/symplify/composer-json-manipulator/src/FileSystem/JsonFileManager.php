...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperc75fd40d7a6e\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperc75fd40d7a6e\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperc75fd40d7a6e\Nette\Utils\Json::decode($fileContent, \_PhpScoperc75fd40d7a6e\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperc75fd40d7a6e\Nette\Utils\Json::encode($json, \_PhpScoperc75fd40d7a6e\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
