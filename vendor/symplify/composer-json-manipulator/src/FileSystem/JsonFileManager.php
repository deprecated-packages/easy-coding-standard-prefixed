...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper279cf54b77ad\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper279cf54b77ad\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper279cf54b77ad\Nette\Utils\Json::decode($fileContent, \_PhpScoper279cf54b77ad\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper279cf54b77ad\Nette\Utils\Json::encode($json, \_PhpScoper279cf54b77ad\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
