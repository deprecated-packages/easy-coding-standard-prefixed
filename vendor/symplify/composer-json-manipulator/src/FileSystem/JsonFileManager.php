...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera23ebff5477f\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera23ebff5477f\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera23ebff5477f\Nette\Utils\Json::decode($fileContent, \_PhpScopera23ebff5477f\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera23ebff5477f\Nette\Utils\Json::encode($json, \_PhpScopera23ebff5477f\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
