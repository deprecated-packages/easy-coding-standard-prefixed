...
use _PhpScoperd47a2fa2a77e\Nette\Utils\Json;
...
final class JsonFileManager
{
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \_PhpScoperd47a2fa2a77e\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperd47a2fa2a77e\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperd47a2fa2a77e\Nette\Utils\Json::decode($fileContent, \_PhpScoperd47a2fa2a77e\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperd47a2fa2a77e\Nette\Utils\Json::encode($json, \_PhpScoperd47a2fa2a77e\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
