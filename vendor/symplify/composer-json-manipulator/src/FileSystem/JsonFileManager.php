...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera6f918786d5c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera6f918786d5c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera6f918786d5c\Nette\Utils\Json::decode($fileContent, \_PhpScopera6f918786d5c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera6f918786d5c\Nette\Utils\Json::encode($json, \_PhpScopera6f918786d5c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
