...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper544eb478a6f6\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper544eb478a6f6\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper544eb478a6f6\Nette\Utils\Json::decode($fileContent, \_PhpScoper544eb478a6f6\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper544eb478a6f6\Nette\Utils\Json::encode($json, \_PhpScoper544eb478a6f6\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
