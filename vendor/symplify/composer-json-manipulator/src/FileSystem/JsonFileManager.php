...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperb73f9e44f4eb\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperb73f9e44f4eb\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperb73f9e44f4eb\Nette\Utils\Json::decode($fileContent, \_PhpScoperb73f9e44f4eb\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperb73f9e44f4eb\Nette\Utils\Json::encode($json, \_PhpScoperb73f9e44f4eb\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
