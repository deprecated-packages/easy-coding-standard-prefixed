...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper0f5cd390c37a\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper0f5cd390c37a\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper0f5cd390c37a\Nette\Utils\Json::decode($fileContent, \_PhpScoper0f5cd390c37a\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper0f5cd390c37a\Nette\Utils\Json::encode($json, \_PhpScoper0f5cd390c37a\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
