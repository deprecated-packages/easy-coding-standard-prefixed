...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper745103eaabcd\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper745103eaabcd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper745103eaabcd\Nette\Utils\Json::decode($fileContent, \_PhpScoper745103eaabcd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper745103eaabcd\Nette\Utils\Json::encode($json, \_PhpScoper745103eaabcd\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
