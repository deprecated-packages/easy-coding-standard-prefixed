...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperddde3ba4aebc\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperddde3ba4aebc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperddde3ba4aebc\Nette\Utils\Json::decode($fileContent, \_PhpScoperddde3ba4aebc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperddde3ba4aebc\Nette\Utils\Json::encode($json, \_PhpScoperddde3ba4aebc\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
