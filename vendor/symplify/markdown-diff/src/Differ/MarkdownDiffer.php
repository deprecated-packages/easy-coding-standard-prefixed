...
final class MarkdownDiffer
{
    ...
    public function __construct(\_PhpScoperd4937ee9b515\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \_PhpScoperd4937ee9b515\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \_PhpScoperd4937ee9b515\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX);
    }
}
