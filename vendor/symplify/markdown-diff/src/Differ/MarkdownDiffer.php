...
final class MarkdownDiffer
{
    ...
    public function __construct(\_PhpScoper58a0a169dcfb\SebastianBergmann\Diff\Differ $markdownDiffer)
    {
    ...
    {
        $diff = \_PhpScoper58a0a169dcfb\Nette\Utils\Strings::replace($diff, self::SPACE_AND_NEWLINE_REGEX, \PHP_EOL);
        return \rtrim($diff);
    }
    ...
    {
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Strings::replace($diff, self::METADATA_REGEX, '');
    }
}
