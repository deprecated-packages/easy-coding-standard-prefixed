...
return static function (\_PhpScoper470d6df94ac0\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    // markdown
    $services->set('markdownDiffOutputBuilder', \_PhpScoper470d6df94ac0\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder::class)->factory([\_PhpScoper470d6df94ac0\Symfony\Component\DependencyInjection\Loader\Configurator\ref(\Symplify\MarkdownDiff\Diff\Output\CompleteUnifiedDiffOutputBuilderFactory::class), 'create']);
    $services->set('markdownDiffer', \_PhpScoper470d6df94ac0\SebastianBergmann\Diff\Differ::class)->arg('$outputBuilder', \_PhpScoper470d6df94ac0\Symfony\Component\DependencyInjection\Loader\Configurator\ref('markdownDiffOutputBuilder'));
    $services->set(\Symplify\MarkdownDiff\Differ\MarkdownDiffer::class)->arg('$markdownDiffer', \_PhpScoper470d6df94ac0\Symfony\Component\DependencyInjection\Loader\Configurator\ref('markdownDiffer'));
};
