 ...
 */
final class SmartFileSystem extends \_PhpScoper457dd3bd73ba\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoper457dd3bd73ba\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoper457dd3bd73ba\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
