...
use _PhpScoper2a8ad010dfbd\Nette\Utils\Html;
...
final class SmartFileSystem extends \_PhpScoper2a8ad010dfbd\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoper2a8ad010dfbd\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoper2a8ad010dfbd\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX);
    }
}
