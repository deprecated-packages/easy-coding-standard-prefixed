 ...
 */
final class SmartFileSystem extends \_PhpScoper1ed8518cf1bf\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoper1ed8518cf1bf\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoper1ed8518cf1bf\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
