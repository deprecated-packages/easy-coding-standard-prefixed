...
use _PhpScoper807f8e74693b\Nette\Utils\Html;
 ...
 */
final class SmartFileSystem extends \_PhpScoper807f8e74693b\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoper807f8e74693b\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoper807f8e74693b\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
