...
use _PhpScoper745103eaabcd\Nette\Utils\Html;
...
final class SmartFileSystem extends \_PhpScoper745103eaabcd\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoper745103eaabcd\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoper745103eaabcd\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
