 ...
 */
final class SmartFileSystem extends \_PhpScoper0c0702cca4ac\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoper0c0702cca4ac\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoper0c0702cca4ac\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
