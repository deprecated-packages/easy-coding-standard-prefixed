...
use _PhpScoperdc8fbcd7c69d\Nette\Utils\Html;
...
final class SmartFileSystem extends \_PhpScoperdc8fbcd7c69d\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoperdc8fbcd7c69d\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoperdc8fbcd7c69d\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX);
    }
}
