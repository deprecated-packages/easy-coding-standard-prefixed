 ...
 */
final class SmartFileSystem extends \_PhpScopercd2fc5ef50ef\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScopercd2fc5ef50ef\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScopercd2fc5ef50ef\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
