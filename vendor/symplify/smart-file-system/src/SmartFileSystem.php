...
use _PhpScoper58a0a169dcfb\Nette\Utils\Html;
...
final class SmartFileSystem extends \_PhpScoper58a0a169dcfb\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoper58a0a169dcfb\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
