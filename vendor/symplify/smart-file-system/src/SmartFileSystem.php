 ...
 */
final class SmartFileSystem extends \_PhpScoper6ae4c4f86624\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoper6ae4c4f86624\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoper6ae4c4f86624\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
