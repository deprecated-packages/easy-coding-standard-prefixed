...
final class PathNormalizer
{
    ...
    {
        $matches = \_PhpScoperc7c7dddc9238\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
            $scheme = null;
        ...
        $path = \_PhpScoperc7c7dddc9238\Nette\Utils\Strings::replace($path, self::TWO_AND_MORE_SLASHES_REGEX, '/');
