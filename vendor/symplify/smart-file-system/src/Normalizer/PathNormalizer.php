...
final class PathNormalizer
{
    ...
    {
        $matches = \_PhpScoperf7b66f9e3817\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
            $scheme = null;
        ...
        $path = \_PhpScoperf7b66f9e3817\Nette\Utils\Strings::replace($path, self::TWO_AND_MORE_SLASHES_REGEX, '/');
