...
final class PathNormalizer
{
    ...
    {
        $matches = \_PhpScoper9885c8c176c7\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
            $scheme = null;
        ...
        $path = \_PhpScoper9885c8c176c7\Nette\Utils\Strings::replace($path, self::TWO_AND_MORE_SLASHES_REGEX, '/');
