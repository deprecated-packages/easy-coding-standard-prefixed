...
final class PathNormalizer
{
    ...
    {
        $matches = \_PhpScopera40fc53e636b\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
            $scheme = null;
        ...
        $path = \_PhpScopera40fc53e636b\Nette\Utils\Strings::replace($path, self::TWO_AND_MORE_SLASHES_REGEX, '/');
