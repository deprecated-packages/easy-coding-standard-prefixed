...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoperf6b7f9bf122d\Nette\Utils\Json::encode($jsonArray, \_PhpScoperf6b7f9bf122d\Nette\Utils\Json::PRETTY) . \PHP_EOL;
    ...
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        ...
        $newComposerJsonArray = \_PhpScoperf6b7f9bf122d\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
