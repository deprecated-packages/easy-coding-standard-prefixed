...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoper9ef667a5e42c\Nette\Utils\Json::encode($jsonArray, \_PhpScoper9ef667a5e42c\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoper9ef667a5e42c\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
