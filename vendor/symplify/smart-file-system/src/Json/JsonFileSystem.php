...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScopercd2fc5ef50ef\Nette\Utils\Json::encode($jsonArray, \_PhpScopercd2fc5ef50ef\Nette\Utils\Json::PRETTY) . \PHP_EOL;
    ...
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        ...
        $newComposerJsonArray = \_PhpScopercd2fc5ef50ef\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
