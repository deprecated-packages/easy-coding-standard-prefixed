...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoper89ec3c69e67d\Nette\Utils\Json::encode($jsonArray, \_PhpScoper89ec3c69e67d\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoper89ec3c69e67d\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
