...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoper279cf54b77ad\Nette\Utils\Json::encode($jsonArray, \_PhpScoper279cf54b77ad\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoper279cf54b77ad\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);
