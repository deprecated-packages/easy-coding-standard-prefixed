 ...
 */
final class SmartFileInfo extends \_PhpScoper2b44cb0c30af\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper2b44cb0c30af\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper2b44cb0c30af\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper2b44cb0c30af\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
