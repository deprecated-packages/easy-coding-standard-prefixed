 ...
 */
final class SmartFileInfo extends \_PhpScoper81b3ff5ab9fe\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper81b3ff5ab9fe\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper81b3ff5ab9fe\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper81b3ff5ab9fe\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper81b3ff5ab9fe\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
