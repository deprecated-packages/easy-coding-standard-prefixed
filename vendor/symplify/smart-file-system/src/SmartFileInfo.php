 ...
 */
final class SmartFileInfo extends \_PhpScoper5ca2d8bcb02c\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper5ca2d8bcb02c\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper5ca2d8bcb02c\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper5ca2d8bcb02c\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper5ca2d8bcb02c\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
