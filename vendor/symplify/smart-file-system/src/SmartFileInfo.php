 ...
 */
final class SmartFileInfo extends \_PhpScoperb73f9e44f4eb\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperb73f9e44f4eb\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperb73f9e44f4eb\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperb73f9e44f4eb\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperb73f9e44f4eb\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
