 ...
 */
final class SmartFileInfo extends \_PhpScoper745103eaabcd\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper745103eaabcd\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper745103eaabcd\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper745103eaabcd\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper745103eaabcd\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
