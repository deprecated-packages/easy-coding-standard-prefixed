 ...
 */
final class SmartFileInfo extends \_PhpScoper5e5ebcdbebdf\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct(string $filePath)
    {
        ...
        if (\_PhpScoper5e5ebcdbebdf\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper5e5ebcdbebdf\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper5e5ebcdbebdf\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper5e5ebcdbebdf\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
