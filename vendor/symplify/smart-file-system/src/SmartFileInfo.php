 ...
 */
final class SmartFileInfo extends \_PhpScoperd1a5bf00e83e\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperd1a5bf00e83e\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperd1a5bf00e83e\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperd1a5bf00e83e\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperd1a5bf00e83e\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
