 ...
 */
final class SmartFileInfo extends \_PhpScoperaa402dd1b1f1\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperaa402dd1b1f1\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperaa402dd1b1f1\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperaa402dd1b1f1\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperaa402dd1b1f1\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
