 ...
 */
final class SmartFileInfo extends \_PhpScoper48800f361566\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper48800f361566\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper48800f361566\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper48800f361566\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
