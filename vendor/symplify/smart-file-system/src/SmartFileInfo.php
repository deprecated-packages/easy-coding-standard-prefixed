 ...
 */
final class SmartFileInfo extends \_PhpScoperdc8fbcd7c69d\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperdc8fbcd7c69d\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperdc8fbcd7c69d\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperdc8fbcd7c69d\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperdc8fbcd7c69d\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
