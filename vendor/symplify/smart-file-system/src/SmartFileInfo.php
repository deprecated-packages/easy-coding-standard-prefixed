 ...
 */
final class SmartFileInfo extends \_PhpScopera4be459e5e3d\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScopera4be459e5e3d\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScopera4be459e5e3d\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScopera4be459e5e3d\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
