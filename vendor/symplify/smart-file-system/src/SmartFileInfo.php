 ...
 */
final class SmartFileInfo extends \_PhpScoper83a475a0590e\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper83a475a0590e\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper83a475a0590e\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper83a475a0590e\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
