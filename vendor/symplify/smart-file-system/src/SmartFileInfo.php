 ...
 */
final class SmartFileInfo extends \_PhpScoperfab1bfb7ec99\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperfab1bfb7ec99\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperfab1bfb7ec99\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperfab1bfb7ec99\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperfab1bfb7ec99\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
