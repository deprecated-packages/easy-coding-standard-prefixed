 ...
 */
final class SmartFileInfo extends \_PhpScoper5813f9b171f8\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper5813f9b171f8\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper5813f9b171f8\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper5813f9b171f8\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper5813f9b171f8\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
