 ...
 */
final class SmartFileInfo extends \_PhpScoper7faa8deb0d3c\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper7faa8deb0d3c\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper7faa8deb0d3c\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper7faa8deb0d3c\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper7faa8deb0d3c\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
