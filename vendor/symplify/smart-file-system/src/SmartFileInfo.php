 ...
 */
final class SmartFileInfo extends \_PhpScoperc5bee3a837bb\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperc5bee3a837bb\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperc5bee3a837bb\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperc5bee3a837bb\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
