 ...
 */
final class SmartFileInfo extends \_PhpScoper0c0702cca4ac\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct(string $filePath)
    {
        ...
        if (\_PhpScoper0c0702cca4ac\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper0c0702cca4ac\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper0c0702cca4ac\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper0c0702cca4ac\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
