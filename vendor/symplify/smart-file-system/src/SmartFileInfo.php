 ...
 */
final class SmartFileInfo extends \_PhpScoper21fff473f90a\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper21fff473f90a\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper21fff473f90a\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper21fff473f90a\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
