 ...
 */
final class SmartFileInfo extends \_PhpScoper3e1e0e5bb8ef\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper3e1e0e5bb8ef\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper3e1e0e5bb8ef\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper3e1e0e5bb8ef\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
