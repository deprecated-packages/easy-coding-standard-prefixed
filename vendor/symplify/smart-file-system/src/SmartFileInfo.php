 ...
 */
final class SmartFileInfo extends \_PhpScoperb2e2c0c42e71\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperb2e2c0c42e71\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperb2e2c0c42e71\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperb2e2c0c42e71\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperb2e2c0c42e71\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
