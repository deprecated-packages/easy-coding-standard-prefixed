 ...
 */
final class SmartFileInfo extends \_PhpScoper2a8ad010dfbd\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper2a8ad010dfbd\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper2a8ad010dfbd\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper2a8ad010dfbd\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
