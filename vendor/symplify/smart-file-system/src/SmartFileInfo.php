 ...
 */
final class SmartFileInfo extends \_PhpScoper64a921a5401b\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper64a921a5401b\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper64a921a5401b\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper64a921a5401b\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
