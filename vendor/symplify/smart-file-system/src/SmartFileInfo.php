 ...
 */
final class SmartFileInfo extends \_PhpScoper1ed8518cf1bf\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct(string $filePath)
    {
        ...
        if (\_PhpScoper1ed8518cf1bf\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper1ed8518cf1bf\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper1ed8518cf1bf\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper1ed8518cf1bf\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
