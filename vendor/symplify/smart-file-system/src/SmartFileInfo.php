 ...
 */
final class SmartFileInfo extends \_PhpScoperc75fd40d7a6e\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperc75fd40d7a6e\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperc75fd40d7a6e\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperc75fd40d7a6e\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperc75fd40d7a6e\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
