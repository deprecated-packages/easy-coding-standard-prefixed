 ...
 */
final class SmartFileInfo extends \_PhpScoper967c4b7e296e\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper967c4b7e296e\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper967c4b7e296e\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper967c4b7e296e\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
