 ...
 */
final class SmartFileInfo extends \_PhpScoperac4e86be08e5\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperac4e86be08e5\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperac4e86be08e5\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperac4e86be08e5\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
