 ...
 */
final class SmartFileInfo extends \_PhpScoperb09c3ec8e01a\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperb09c3ec8e01a\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperb09c3ec8e01a\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperb09c3ec8e01a\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
