 ...
 */
final class SmartFileInfo extends \_PhpScoper06c66bea2cf6\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper06c66bea2cf6\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper06c66bea2cf6\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper06c66bea2cf6\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
