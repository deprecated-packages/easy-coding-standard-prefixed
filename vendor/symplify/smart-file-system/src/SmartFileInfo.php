 ...
 */
final class SmartFileInfo extends \_PhpScoper2fe14d6302bc\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper2fe14d6302bc\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper2fe14d6302bc\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper2fe14d6302bc\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
