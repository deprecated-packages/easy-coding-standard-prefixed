 ...
 */
final class SmartFileInfo extends \_PhpScoper58a0a169dcfb\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper58a0a169dcfb\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
