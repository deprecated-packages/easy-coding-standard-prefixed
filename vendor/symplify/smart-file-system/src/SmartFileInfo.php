 ...
 */
final class SmartFileInfo extends \_PhpScoperc95ae4bf942a\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperc95ae4bf942a\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperc95ae4bf942a\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperc95ae4bf942a\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperc95ae4bf942a\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
