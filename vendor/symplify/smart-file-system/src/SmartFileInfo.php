 ...
 */
final class SmartFileInfo extends \_PhpScoper279cf54b77ad\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper279cf54b77ad\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper279cf54b77ad\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper279cf54b77ad\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
