 ...
 */
final class SmartFileInfo extends \_PhpScoper528afa732cbd\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper528afa732cbd\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper528afa732cbd\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper528afa732cbd\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
