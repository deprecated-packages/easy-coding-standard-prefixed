 ...
 */
final class SmartFileInfo extends \_PhpScoper224ae0b86670\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper224ae0b86670\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper224ae0b86670\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper224ae0b86670\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
