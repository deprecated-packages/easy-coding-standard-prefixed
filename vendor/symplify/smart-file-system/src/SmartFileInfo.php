 ...
 */
final class SmartFileInfo extends \_PhpScoper2f75f00bf6fa\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper2f75f00bf6fa\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper2f75f00bf6fa\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper2f75f00bf6fa\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
