 ...
 */
final class SmartFileInfo extends \_PhpScoper10b1b2c5ca55\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper10b1b2c5ca55\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper10b1b2c5ca55\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper10b1b2c5ca55\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper10b1b2c5ca55\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
