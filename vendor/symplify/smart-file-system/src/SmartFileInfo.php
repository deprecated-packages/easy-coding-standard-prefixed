 ...
 */
final class SmartFileInfo extends \_PhpScoper06c5fb6c14ed\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper06c5fb6c14ed\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper06c5fb6c14ed\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper06c5fb6c14ed\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper06c5fb6c14ed\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
