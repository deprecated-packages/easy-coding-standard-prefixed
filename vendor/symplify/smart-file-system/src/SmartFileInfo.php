 ...
 */
final class SmartFileInfo extends \_PhpScoper64ca614e27fd\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper64ca614e27fd\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper64ca614e27fd\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper64ca614e27fd\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper64ca614e27fd\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
