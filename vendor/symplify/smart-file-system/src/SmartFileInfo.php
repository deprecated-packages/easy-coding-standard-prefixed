 ...
 */
final class SmartFileInfo extends \_PhpScoper92feab6bddf8\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper92feab6bddf8\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper92feab6bddf8\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper92feab6bddf8\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
