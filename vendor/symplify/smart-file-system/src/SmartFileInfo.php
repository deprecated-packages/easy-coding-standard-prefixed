 ...
 */
final class SmartFileInfo extends \_PhpScoper544eb478a6f6\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper544eb478a6f6\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper544eb478a6f6\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper544eb478a6f6\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper544eb478a6f6\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
