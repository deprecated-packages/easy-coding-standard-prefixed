 ...
 */
final class SmartFileInfo extends \_PhpScoper70d1796231ae\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct(string $filePath)
    {
        ...
        if (\_PhpScoper70d1796231ae\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper70d1796231ae\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper70d1796231ae\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper70d1796231ae\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
