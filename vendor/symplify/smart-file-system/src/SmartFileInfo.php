 ...
 */
final class SmartFileInfo extends \_PhpScoper7cef7256eba6\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper7cef7256eba6\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper7cef7256eba6\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper7cef7256eba6\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
