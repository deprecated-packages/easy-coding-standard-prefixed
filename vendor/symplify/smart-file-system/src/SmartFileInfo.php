 ...
 */
final class SmartFileInfo extends \_PhpScopera37d6fb0b1ab\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScopera37d6fb0b1ab\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScopera37d6fb0b1ab\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScopera37d6fb0b1ab\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScopera37d6fb0b1ab\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
