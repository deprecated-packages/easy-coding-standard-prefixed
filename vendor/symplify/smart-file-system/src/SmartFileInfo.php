 ...
 */
final class SmartFileInfo extends \_PhpScoper02b5d1bf8fec\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper02b5d1bf8fec\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
