 ...
 */
final class SmartFileInfo extends \_PhpScoperd8b12759ee0d\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperd8b12759ee0d\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperd8b12759ee0d\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperd8b12759ee0d\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoperd8b12759ee0d\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
