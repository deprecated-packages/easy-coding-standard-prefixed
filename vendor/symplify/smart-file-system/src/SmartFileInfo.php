 ...
 */
final class SmartFileInfo extends \_PhpScoperdf6a0b341030\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperdf6a0b341030\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperdf6a0b341030\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperdf6a0b341030\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
