 ...
 */
final class SmartFileInfo extends \_PhpScoper38a7d00685f8\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper38a7d00685f8\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper38a7d00685f8\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper38a7d00685f8\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
