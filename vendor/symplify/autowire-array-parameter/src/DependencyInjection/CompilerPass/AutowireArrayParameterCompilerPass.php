...
use _PhpScopera04bf8e97c06\Nette\Utils\Reflection;
 ...
 */
final class AutowireArrayParameterCompilerPass implements \_PhpScopera04bf8e97c06\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['_PhpScopera04bf8e97c06\\Symfony\\Component\\Form\\FormExtensionInterface', '_PhpScopera04bf8e97c06\\Symfony\\Component\\Asset\\PackageInterface', '_PhpScopera04bf8e97c06\\Symfony\\Component\\Config\\Loader\\LoaderInterface', '_PhpScopera04bf8e97c06\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', '_PhpScopera04bf8e97c06\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', '_PhpScopera04bf8e97c06\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', '_PhpScopera04bf8e97c06\\Sonata\\Doctrine\\Adapter\\AdapterChain', '_PhpScopera04bf8e97c06\\Sonata\\Twig\\Extension\\TemplateExtension'];
    /**
    ...
    private function shouldSkipDefinition(\_PhpScopera04bf8e97c06\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \_PhpScopera04bf8e97c06\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ((bool) \_PhpScopera04bf8e97c06\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\_PhpScopera04bf8e97c06\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \_PhpScopera04bf8e97c06\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function shouldSkipParameter(\ReflectionMethod $reflectionMethod, \_PhpScopera04bf8e97c06\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionParameter $reflectionParameter) : bool
    {
    ...
    private function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $result = \_PhpScopera04bf8e97c06\Nette\Utils\Strings::match((string) $reflectionMethod->getDocComment(), $parameterDocTypeRegex);
        if ($result === null) {
            return null;
        }
        ...
        return \_PhpScopera04bf8e97c06\Nette\Utils\Reflection::expandClassName($result['type'], $reflectionMethod->getDeclaringClass());
    }
    /**
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \_PhpScopera04bf8e97c06\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
