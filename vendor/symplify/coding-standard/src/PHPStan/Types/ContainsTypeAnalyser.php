...
use _PhpScoper8de082cbb8c7\PHPStan\Type\IntersectionType;
...
final class ContainsTypeAnalyser
{
     ...
     */
    public function containsExprTypes(\_PhpScoper8de082cbb8c7\PhpParser\Node\Expr $expr, \_PhpScoper8de082cbb8c7\PHPStan\Analyser\Scope $scope, array $types) : bool
    {
    ...
    private function containsExprType(\_PhpScoper8de082cbb8c7\PhpParser\Node\Expr $expr, \_PhpScoper8de082cbb8c7\PHPStan\Analyser\Scope $scope, string $type) : bool
    {
        $exprType = $scope->getType($expr);
        if ($exprType instanceof \_PhpScoper8de082cbb8c7\PHPStan\Type\IntersectionType) {
    ...
    private function isUnionTypeWithClass(\_PhpScoper8de082cbb8c7\PHPStan\Type\Type $type, string $class) : bool
    {
        ...
        foreach ($unionedTypes as $unionedType) {
            if (!$unionedType instanceof \_PhpScoper8de082cbb8c7\PHPStan\Type\TypeWithClassName) {
                continue;
            }
    ...
    private function isArrayWithItemType(\_PhpScoper8de082cbb8c7\PHPStan\Type\Type $propertyType, string $type) : bool
    {
        if (!$propertyType instanceof \_PhpScoper8de082cbb8c7\PHPStan\Type\ArrayType) {
            return \false;
        }
        $arrayItemType = $propertyType->getItemType();
        if (!$arrayItemType instanceof \_PhpScoper8de082cbb8c7\PHPStan\Type\TypeWithClassName) {
            return \false;
        }
    ...
    {
        if ($exprType instanceof \_PhpScoper8de082cbb8c7\PHPStan\Type\TypeWithClassName) {
