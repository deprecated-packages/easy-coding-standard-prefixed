...
use ReflectionClass;
use _PhpScoper2b44cb0c30af\Symfony\Bundle\FrameworkBundle\Kernel\MicroKernelTrait;
...
final class NoProtectedElementInFinalClassRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
    ...
    {
        return [\_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\Property::class, \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\ClassMethod::class];
    }
    /**
    ...
    public function process(\_PhpScoper2b44cb0c30af\PhpParser\Node $node, \_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (!$parent instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\Class_) {
            return [];
        }
        if (!$parent->isFinal()) {
            return [];
        ...
        if ($node instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\ClassMethod) {
            return $this->processClassMethod($node, $parent, $scope);
        }
        return $this->processProperty($parent, $node);
    }
    private function isPropertyExistInTraits(\_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\Class_ $class, string $propertyName) : bool
    {
        /** @var Identifier $name */
    ...
    private function isMethodExistInTraits(\_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\Class_ $class, string $methodName) : bool
    {
        /** @var Identifier $name */
        $name = $class->namespacedName;
        $usedTraits = \class_uses($name->toString());
    ...
    private function isPropertyExistInParentClass(\_PhpScoper2b44cb0c30af\PhpParser\Node\Name $name, string $propertyName) : bool
    {
     ...
     * @return string[]
     */
    private function processClassMethod(\_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\Class_ $class, \_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : array
    {
     ...
     * @return string[]
     */
    private function processProperty(\_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\Class_ $class, \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\Property $property) : array
    {
    ...
    private function isSymfonyMicroKernelRequired(\_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\ClassMethod $classMethod, \_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : bool
    {
        return $this->classMethodTypeAnalyzer->isClassMethodOfNamesAndType($classMethod, $scope, ['configureRoutes', 'configureContainer'], \_PhpScoper2b44cb0c30af\Symfony\Bundle\FrameworkBundle\Kernel\MicroKernelTrait::class);
    }
}
