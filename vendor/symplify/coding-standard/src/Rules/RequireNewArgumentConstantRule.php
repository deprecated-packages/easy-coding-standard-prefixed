...
final class RequireNewArgumentConstantRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
    ...
    {
        $class = $node->class;
        if (!$class instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Name\FullyQualified) {
            return [];
        }
        ...
        foreach ($positions as $position) {
            if (!$args[$position]->value instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Expr\ClassConstFetch) {
