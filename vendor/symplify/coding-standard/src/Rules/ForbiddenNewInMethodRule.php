...
final class ForbiddenNewInMethodRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
     ...
     */
    public function __construct(\_PhpScoper8de082cbb8c7\PhpParser\NodeFinder $nodeFinder, array $forbiddenClassMethods = [])
    {
    ...
    private function hasNewInside(\_PhpScoper8de082cbb8c7\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        return (bool) $this->nodeFinder->findFirstInstanceOf($classMethod, \_PhpScoper8de082cbb8c7\PhpParser\Node\Expr\New_::class);
    }
}
