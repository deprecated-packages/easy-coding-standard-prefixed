...
use _PhpScoper3d04c8135695\Doctrine\ORM\EntityManagerInterface;
use _PhpScoper3d04c8135695\Jean85\PrettyVersions;
use _PhpScoper3d04c8135695\Jean85\Version;
...
final class NoFactoryInConstructorRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
     ...
     * @var string[]
     */
    private const ALLOWED_TYPES = [\Symplify\PackageBuilder\Parameter\ParameterProvider::class, \_PhpScoper3d04c8135695\Symfony\Component\DependencyInjection\ParameterBag\ParameterBagInterface::class, \_PhpScoper3d04c8135695\Doctrine\ORM\EntityManagerInterface::class, \_PhpScoper3d04c8135695\Jean85\PrettyVersions::class, \_PhpScoper3d04c8135695\Jean85\Version::class];
    /**
     * @var string[]
     */
    ...
    public function process(\_PhpScoper3d04c8135695\PhpParser\Node $node, \_PhpScoper3d04c8135695\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (!$node->var instanceof \_PhpScoper3d04c8135695\PhpParser\Node\Expr\Variable) {
            return [];
        }
        // just assign
        $parent = $node->getAttribute(\Symplify\CodingStandard\ValueObject\PHPStanAttributeKey::PARENT);
        if ($parent instanceof \_PhpScoper3d04c8135695\PhpParser\Node\Expr\ArrayDimFetch) {
            return [];
        }
    ...
    private function isAllowedType(\_PhpScoper3d04c8135695\PHPStan\Type\Type $type) : bool
    {
        if (!$type instanceof \_PhpScoper3d04c8135695\PHPStan\Type\TypeWithClassName) {
            return \false;
        }
        return $this->arrayStringAndFnMatcher->isMatch($type->getClassName(), self::ALLOWED_TYPES);
    }
    private function isInAllowedClass(\_PhpScoper3d04c8135695\PHPStan\Analyser\Scope $scope) : bool
    {
