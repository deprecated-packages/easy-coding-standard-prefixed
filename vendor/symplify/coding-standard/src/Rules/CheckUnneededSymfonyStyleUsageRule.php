...
use _PhpScoper8de082cbb8c7\PHPStan\Node\ClassMethodsNode;
...
final class CheckUnneededSymfonyStyleUsageRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
    ...
    {
        return [\_PhpScoper8de082cbb8c7\PHPStan\Node\ClassMethodsNode::class];
    }
    /**
    ...
    public function process(\_PhpScoper8de082cbb8c7\PhpParser\Node $node, \_PhpScoper8de082cbb8c7\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        foreach ($methodCalls as $methodCall) {
            ...
            if (!$methodCallNode->var instanceof \_PhpScoper8de082cbb8c7\PhpParser\Node\Expr) {
                return [];
            }
            ...
            if (!\is_a($callerType->getClassName(), \_PhpScoper8de082cbb8c7\Symfony\Component\Console\Style\SymfonyStyle::class, \true)) {
                return [];
            }
    ...
    private function hasParentClassSymfonyStyle(\_PhpScoper8de082cbb8c7\PhpParser\Node\Stmt\ClassLike $classLike) : bool
    {
        ...
        return \is_a($parentClass, \_PhpScoper8de082cbb8c7\Symfony\Component\Console\Style\SymfonyStyle::class, \true);
    }
}
