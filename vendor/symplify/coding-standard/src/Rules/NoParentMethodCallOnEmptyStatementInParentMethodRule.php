...
use _PhpScoper8de082cbb8c7\PhpParser\Node\Stmt\Nop;
...
final class NoParentMethodCallOnEmptyStatementInParentMethodRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
    ...
    private function resolveParentClassMethodStmtCount(\_PhpScoper8de082cbb8c7\PHPStan\Analyser\Scope $scope, string $methodName) : int
    {
        ...
        foreach ($parentClassMethodNodes as $stmt) {
            ...
            if ($stmt instanceof \_PhpScoper8de082cbb8c7\PhpParser\Node\Stmt\Nop) {
                continue;
            }
            ++$countStmts;
        }
