...
final class NoClassWithStaticMethodWithoutStaticNameRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
    ...
    private function shouldSkipClassName(string $classShortName) : bool
    {
        foreach (self::ALLOWED_CLASS_NAMES as $allowedClassName) {
            if (\_PhpScoper8de082cbb8c7\Nette\Utils\Strings::match($classShortName, $allowedClassName)) {
                return \true;
            }
        }
        return (bool) \_PhpScoper8de082cbb8c7\Nette\Utils\Strings::match($classShortName, self::STATIC_REGEX);
    }
    private function isStaticConstructorOfValueObject(\_PhpScoper8de082cbb8c7\PhpParser\Node\Stmt\ClassMethod $classMethod) : bool
    {
        return (bool) $this->nodeFinder->findFirst((array) $classMethod->stmts, function (\_PhpScoper8de082cbb8c7\PhpParser\Node $node) : bool {
            if (!$node instanceof \_PhpScoper8de082cbb8c7\PhpParser\Node\Stmt\Return_) {
                return \false;
            }
