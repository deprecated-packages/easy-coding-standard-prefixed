...
use _PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\MagicConst\Dir;
...
final class NoMissingDirPathRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
    ...
    {
        return [\_PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\MagicConst\Dir::class];
    }
    /**
     * @return string[]
     */
    public function process(\_PhpScoper2b44cb0c30af\PhpParser\Node $node, \_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (!$parent instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Expr\BinaryOp\Concat) {
            return [];
        }
        if (!$parent->right instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\String_) {
            return [];
        }
    ...
    private function isPartOfPHPUnit(\_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : bool
    {
        ...
        return \is_a($className, \_PhpScoper2b44cb0c30af\PHPUnit\Framework\TestCase::class, \true);
    }
    private function shouldSkip(string $relativeDirPath, \_PhpScoper2b44cb0c30af\PhpParser\Node\Expr\BinaryOp\Concat $concat, \_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : bool
    {
        // is vendor autolaod? it yet to be exist
        if (\_PhpScoper2b44cb0c30af\Nette\Utils\Strings::match($relativeDirPath, self::VENDOR_REGEX)) {
            return \true;
        }
        if (\_PhpScoper2b44cb0c30af\Nette\Utils\Strings::contains($relativeDirPath, '*')) {
            return \true;
        }
