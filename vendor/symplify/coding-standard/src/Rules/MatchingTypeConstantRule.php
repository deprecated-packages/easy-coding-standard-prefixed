...
use _PhpScoper2b44cb0c30af\PhpParser\Node\Expr\ConstFetch;
use _PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\DNumber;
...
final class MatchingTypeConstantRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
     ...
     */
    private const TYPE_NODES_TO_ACCEPTED_TYPES = [\_PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\LNumber::class => ['int'], \_PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\DNumber::class => ['float', 'double'], \_PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\String_::class => ['string'], \_PhpScoper2b44cb0c30af\PhpParser\Node\Expr\ConstFetch::class => ['bool']];
    /**
     * @var array<string, string>
     */
    private const TYPE_CLASS_TO_STRING_TYPE = [\_PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\String_::class => 'string', \_PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\LNumber::class => 'int', \_PhpScoper2b44cb0c30af\PhpParser\Node\Scalar\DNumber::class => 'float', \_PhpScoper2b44cb0c30af\PhpParser\Node\Expr\ConstFetch::class => 'bool'];
    /**
     * @return string[]
     */
    ...
    public function process(\_PhpScoper2b44cb0c30af\PhpParser\Node $node, \_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (\_PhpScoper2b44cb0c30af\Nette\Utils\Strings::endsWith($type, '[]')) {
            return [];
        }
        $constantValue = $node->consts[0]->value;
        return $this->processConstantValue($constantValue, $type);
    }
    private function shouldSkip(\_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\ClassConst $classConst) : bool
    {
    ...
    private function resolveOnlyVarAnnotationType(\_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\ClassConst $classConst) : ?string
    {
     ...
     * @return string[]
     */
    private function processConstantValue(\_PhpScoper2b44cb0c30af\PhpParser\Node\Expr $expr, string $type) : array
    {
     ...
     * @return Annotation[]
     */
    private function getVarAnnotationsForNode(\_PhpScoper2b44cb0c30af\PhpParser\Node $node) : array
    {
     ...
     */
    private function isValidConstantValue(\_PhpScoper2b44cb0c30af\PhpParser\Node\Expr $expr, string $type, array $acceptedTypes) : bool
    {
