...
final class CommentedOutCodeSniff extends \PHP_CodeSniffer\Standards\Squiz\Sniffs\PHP\CommentedOutCodeSniff implements \Symplify\RuleDocGenerator\Contract\DocumentedRuleInterface
{
     ...
     * @param int $position
     */
    public function process(\PHP_CodeSniffer\Files\File $file, $position) : void
    {
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('There should be no commented code. Git is good enough for versioning', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
// $one = 1;
// $two = 2;
// $three = 3;
CODE_SAMPLE
...
CODE_SAMPLE
     ...
     * @param mixed[] $tokens
     */
    private function shouldSkip(\PHP_CodeSniffer\Files\File $file, int $position, array $tokens) : bool
    {
