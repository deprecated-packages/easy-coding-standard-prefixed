...
final class FunctionLikeCognitiveComplexityRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
    ...
    {
        return [\_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\ClassMethod::class, \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\Function_::class];
    }
    /**
    ...
    private function resolveFunctionName(\_PhpScoper2b44cb0c30af\PhpParser\Node\FunctionLike $functionLike, \_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : string
    {
        if ($functionLike instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\Function_) {
            return $functionLike->name . '()';
        }
        if ($functionLike instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt\ClassMethod) {
            $name = '';
