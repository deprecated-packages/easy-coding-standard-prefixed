        ...
        foreach ($recodedEvents as $recodedEvent) {
            ...
            foreach ($videos as $video) {
                ...
                if ($video->getSlug() !== $slug) {
                    // operation: +1, nesting: +2
                    continue;
                }
                return $video;
            }
        }
        throw new \Symplify\CodingStandard\CognitiveComplexity\Tests\Rules\FunctionLikeCognitiveComplexityRule\Source\VideoNotFoundException($slug);
    }
}
