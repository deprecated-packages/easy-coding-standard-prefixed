...
use _PhpScoper8de082cbb8c7\PhpParser\ParserFactory;
use _PhpScoper8de082cbb8c7\PHPStan\DependencyInjection\ContainerFactory;
...
final class AstCognitiveComplexityAnalyzerTest extends \_PhpScoper8de082cbb8c7\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $phpstanContainerFactory = new \_PhpScoper8de082cbb8c7\PHPStan\DependencyInjection\ContainerFactory(\getcwd());
     ...
     */
    private function parseFileToFistFunctionLike(string $fileContent) : ?\_PhpScoper8de082cbb8c7\PhpParser\Node
    {
        $parserFactory = new \_PhpScoper8de082cbb8c7\PhpParser\ParserFactory();
        $parser = $parserFactory->create(\_PhpScoper8de082cbb8c7\PhpParser\ParserFactory::ONLY_PHP7);
        $nodes = $parser->parse($fileContent);
        $nodeFinder = new \_PhpScoper8de082cbb8c7\PhpParser\NodeFinder();
        return $nodeFinder->findFirst((array) $nodes, function (\_PhpScoper8de082cbb8c7\PhpParser\Node $node) : bool {
            return $node instanceof \_PhpScoper8de082cbb8c7\PhpParser\Node\Stmt\ClassMethod || $node instanceof \_PhpScoper8de082cbb8c7\PhpParser\Node\Stmt\Function_;
        });
    }
}
