...
use _PhpScoper3d04c8135695\PhpParser\Node\Const_;
...
use _PhpScoper3d04c8135695\PhpParser\Node\Stmt\PropertyProperty;
...
final class NoShortNameRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
    ...
    {
        return [\_PhpScoper3d04c8135695\PhpParser\Node\Stmt\ClassLike::class, \_PhpScoper3d04c8135695\PhpParser\Node\Stmt\Function_::class, \_PhpScoper3d04c8135695\PhpParser\Node\Stmt\ClassMethod::class, \_PhpScoper3d04c8135695\PhpParser\Node\Const_::class, \_PhpScoper3d04c8135695\PhpParser\Node\Stmt\PropertyProperty::class];
    }
    /**
    ...
    public function process(\_PhpScoper3d04c8135695\PhpParser\Node $node, \_PhpScoper3d04c8135695\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (\_PhpScoper3d04c8135695\Nette\Utils\Strings::length($name) >= $this->minNameLenght) {
            return [];
        }
