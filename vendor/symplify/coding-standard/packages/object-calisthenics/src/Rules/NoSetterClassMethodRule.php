...
final class NoSetterClassMethodRule extends \Symplify\CodingStandard\Rules\AbstractSymplifyRule
{
    ...
    public function process(\_PhpScoper2b44cb0c30af\PhpParser\Node $node, \_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (!\_PhpScoper2b44cb0c30af\Nette\Utils\Strings::match($methodName, self::SETTER_REGEX)) {
            return [];
        }
    ...
    private function isClassExcluded(\_PhpScoper2b44cb0c30af\PHPStan\Analyser\Scope $scope) : bool
    {
