...
use _PhpScoper2fe14d6302bc\Migrify\PhpConfigPrinter\Printer\SmartPhpConfigPrinter;
...
final class ConfiguredCodeSamplePrinter
{
    ...
    public function __construct(\Symplify\PackageBuilder\Neon\NeonPrinter $neonPrinter, \Symplify\RuleDocGenerator\Printer\MarkdownCodeWrapper $markdownCodeWrapper, \_PhpScoper2fe14d6302bc\Migrify\PhpConfigPrinter\Printer\SmartPhpConfigPrinter $smartPhpConfigPrinter)
    {
