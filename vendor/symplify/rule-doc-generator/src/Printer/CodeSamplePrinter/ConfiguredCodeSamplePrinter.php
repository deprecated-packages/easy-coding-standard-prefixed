...
use _PhpScoper8e2d8a2760d1\Migrify\PhpConfigPrinter\Printer\SmartPhpConfigPrinter;
...
final class ConfiguredCodeSamplePrinter
{
    ...
    public function __construct(\Symplify\PackageBuilder\Neon\NeonPrinter $neonPrinter, \Symplify\RuleDocGenerator\Printer\MarkdownCodeWrapper $markdownCodeWrapper, \_PhpScoper8e2d8a2760d1\Migrify\PhpConfigPrinter\Printer\SmartPhpConfigPrinter $smartPhpConfigPrinter)
    {
