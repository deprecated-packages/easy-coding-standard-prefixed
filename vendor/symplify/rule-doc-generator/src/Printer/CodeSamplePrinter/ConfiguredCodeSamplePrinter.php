...
use _PhpScopera749ac204cd2\Migrify\PhpConfigPrinter\Printer\SmartPhpConfigPrinter;
...
final class ConfiguredCodeSamplePrinter
{
    ...
    public function __construct(\Symplify\PackageBuilder\Neon\NeonPrinter $neonPrinter, \Symplify\RuleDocGenerator\Printer\MarkdownCodeWrapper $markdownCodeWrapper, \_PhpScopera749ac204cd2\Migrify\PhpConfigPrinter\Printer\SmartPhpConfigPrinter $smartPhpConfigPrinter)
    {
