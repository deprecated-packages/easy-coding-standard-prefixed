...
final class GenerateCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\RuleDocGenerator\ValueObject\Option::PATH, \_PhpScoper49c742f5a4ee\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Path to directory of your project');
        $this->addOption(\Symplify\RuleDocGenerator\ValueObject\Option::OUTPUT, null, \_PhpScoper49c742f5a4ee\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to output generated markdown file', \getcwd() . '/docs/rules_overview.md');
    }
