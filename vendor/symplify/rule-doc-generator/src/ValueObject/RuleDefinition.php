...
final class RuleDefinition
{
    ...
    {
        /** @noRector */
        return \is_a($this->ruleClass, '_PhpScoper2fe14d6302bc\\PHPStan\\Rules\\Rule', \true);
    }
    ...
    {
        return (string) \_PhpScoper2fe14d6302bc\Nette\Utils\Strings::after($this->ruleClass, '\\', -1);
    }
    /**
