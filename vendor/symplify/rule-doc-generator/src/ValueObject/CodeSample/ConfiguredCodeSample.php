...
use _PhpScoper3ba93baeac18\Rector\Core\Exception\Configuration\InvalidConfigurationException;
...
final class ConfiguredCodeSample extends \Symplify\RuleDocGenerator\ValueObject\AbstractCodeSample implements \Symplify\RuleDocGenerator\Contract\CodeSampleInterface
{
    ...
    {
        if ($configuration === []) {
            throw new \_PhpScoper3ba93baeac18\Rector\Core\Exception\Configuration\InvalidConfigurationException('Configuration cannot be empty');
        }
