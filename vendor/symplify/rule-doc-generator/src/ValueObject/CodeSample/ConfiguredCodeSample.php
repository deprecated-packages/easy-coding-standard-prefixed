...
use _PhpScoper7574e8786845\Rector\Core\Exception\Configuration\InvalidConfigurationException;
...
final class ConfiguredCodeSample extends \Symplify\RuleDocGenerator\ValueObject\AbstractCodeSample implements \Symplify\RuleDocGenerator\Contract\CodeSampleInterface
{
    ...
    {
        if ($configuration === []) {
            throw new \_PhpScoper7574e8786845\Rector\Core\Exception\Configuration\InvalidConfigurationException('Configuration cannot be empty');
        }
