...
use _PhpScoperf3f1be0d8a30\Rector\Core\Exception\Configuration\InvalidConfigurationException;
...
final class ConfiguredCodeSample extends \Symplify\RuleDocGenerator\ValueObject\AbstractCodeSample implements \Symplify\RuleDocGenerator\Contract\CodeSampleInterface
{
    ...
    {
        if ($configuration === []) {
            throw new \_PhpScoperf3f1be0d8a30\Rector\Core\Exception\Configuration\InvalidConfigurationException('Configuration cannot be empty');
        }
