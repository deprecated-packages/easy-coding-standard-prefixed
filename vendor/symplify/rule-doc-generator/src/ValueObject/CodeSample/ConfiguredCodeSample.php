...
use _PhpScoper4298f97f3cb3\Rector\Core\Exception\Configuration\InvalidConfigurationException;
...
final class ConfiguredCodeSample extends \Symplify\RuleDocGenerator\ValueObject\AbstractCodeSample implements \Symplify\RuleDocGenerator\Contract\CodeSampleInterface
{
    ...
    {
        if ($configuration === []) {
            throw new \_PhpScoper4298f97f3cb3\Rector\Core\Exception\Configuration\InvalidConfigurationException('Configuration cannot be empty');
        }
