 ...
 */
final class NamelessConsoleCommandCompilerPass implements \_PhpScoper0c0702cca4ac\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\_PhpScoper0c0702cca4ac\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \_PhpScoper0c0702cca4ac\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
