 ...
 */
final class NamelessConsoleCommandCompilerPass implements \_PhpScoper14718bfcc75e\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\_PhpScoper14718bfcc75e\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \_PhpScoper14718bfcc75e\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
