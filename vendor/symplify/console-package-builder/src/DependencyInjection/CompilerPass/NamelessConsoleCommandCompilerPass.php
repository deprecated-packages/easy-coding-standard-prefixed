 ...
 */
final class NamelessConsoleCommandCompilerPass implements \_PhpScoper4fc0030e9d22\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\_PhpScoper4fc0030e9d22\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \_PhpScoper4fc0030e9d22\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
