 ...
 */
final class NamelessConsoleCommandCompilerPass implements \_PhpScoper457dd3bd73ba\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\_PhpScoper457dd3bd73ba\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \_PhpScoper457dd3bd73ba\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
