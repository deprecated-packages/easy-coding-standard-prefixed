 ...
 */
final class NamelessConsoleCommandCompilerPass implements \_PhpScoper488221d5cc83\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\_PhpScoper488221d5cc83\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \_PhpScoper488221d5cc83\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
