 ...
 */
final class NamelessConsoleCommandCompilerPass implements \_PhpScoperb0c6500a504c\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\_PhpScoperb0c6500a504c\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \_PhpScoperb0c6500a504c\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
