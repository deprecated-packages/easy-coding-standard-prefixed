 ...
 */
final class NamelessConsoleCommandCompilerPass implements \_PhpScoper06c5fb6c14ed\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\_PhpScoper06c5fb6c14ed\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \_PhpScoper06c5fb6c14ed\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
