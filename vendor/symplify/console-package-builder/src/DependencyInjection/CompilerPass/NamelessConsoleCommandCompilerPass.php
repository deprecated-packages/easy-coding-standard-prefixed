 ...
 */
final class NamelessConsoleCommandCompilerPass implements \_PhpScoper7b319b4d8e1c\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\_PhpScoper7b319b4d8e1c\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \_PhpScoper7b319b4d8e1c\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
