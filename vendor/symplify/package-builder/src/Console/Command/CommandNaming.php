...
final class CommandNaming
{
     ...
     *  "SomeClass\SOMESuperCommand" → "some-super"
     */
    public function resolveFromCommand(\_PhpScoper9f8d5dcff860\Symfony\Component\Console\Command\Command $command) : string
    {
    ...
    public static function classToName(string $class) : string
    {
        ...
        $rawCommandName = \_PhpScoper9f8d5dcff860\Nette\Utils\Strings::substring($shortClassName, 0, -\strlen('Command'));
        // ECSCommand => ecs
        ...
        return \_PhpScoper9f8d5dcff860\Nette\Utils\Strings::replace($rawCommandName, self::BIG_LETTER_REGEX, function (array $matches) : string {
