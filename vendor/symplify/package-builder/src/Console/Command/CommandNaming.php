...
final class CommandNaming
{
     ...
     *  "SomeClass\SOMESuperCommand" → "some-super"
     */
    public function resolveFromCommand(\_PhpScoper66292c14b658\Symfony\Component\Console\Command\Command $command) : string
    {
    ...
    public static function classToName(string $class) : string
    {
        ...
        $rawCommandName = \_PhpScoper66292c14b658\Nette\Utils\Strings::substring($shortClassName, 0, -\strlen('Command'));
        // ECSCommand => ecs
        ...
        return \_PhpScoper66292c14b658\Nette\Utils\Strings::replace($rawCommandName, self::BIG_LETTER_REGEX, function (array $matches) : string {
