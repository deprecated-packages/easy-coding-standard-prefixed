...
final class SymfonyStyleFactory
{
    ...
    public function create() : \_PhpScoper8de082cbb8c7\Symfony\Component\Console\Style\SymfonyStyle
    {
        ...
        $consoleOutput = new \_PhpScoper8de082cbb8c7\Symfony\Component\Console\Output\ConsoleOutput();
        // to configure all -v, -vv, -vvv options without memory-lock to Application run() arguments
        $this->privatesCaller->callPrivateMethod(new \_PhpScoper8de082cbb8c7\Symfony\Component\Console\Application(), 'configureIO', $argvInput, $consoleOutput);
        // --debug is called
        if ($argvInput->hasParameterOption('--debug')) {
            $consoleOutput->setVerbosity(\_PhpScoper8de082cbb8c7\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_DEBUG);
        }
        return new \_PhpScoper8de082cbb8c7\Symfony\Component\Console\Style\SymfonyStyle($argvInput, $consoleOutput);
    }
}
