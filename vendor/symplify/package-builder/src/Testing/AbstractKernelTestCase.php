 ...
 */
abstract class AbstractKernelTestCase extends \_PhpScopereb8678af2407\PHPUnit\Framework\TestCase
{
    /**
     * @var KernelInterface
     */
     ...
     */
    protected function bootKernelWithConfigs(string $kernelClass, array $configs) : \_PhpScopereb8678af2407\Symfony\Component\HttpKernel\KernelInterface
    {
        ...
        if (!$kernel instanceof \_PhpScopereb8678af2407\Symfony\Component\HttpKernel\KernelInterface) {
    ...
    protected function ensureKernelShutdown() : void
    {
        if (static::$kernel !== null) {
            ...
            if ($kernel !== null) {
                ...
                if ($container instanceof \_PhpScopereb8678af2407\Symfony\Contracts\Service\ResetInterface) {
                    $container->reset();
                }
            }
        }
    ...
    private function ensureIsConfigAwareKernel(\_PhpScopereb8678af2407\Symfony\Component\HttpKernel\KernelInterface $kernel) : void
    {
    ...
    private function bootAndReturnKernel(\_PhpScopereb8678af2407\Symfony\Component\HttpKernel\KernelInterface $kernel) : \_PhpScopereb8678af2407\Symfony\Component\HttpKernel\KernelInterface
    {
        $kernel->boot();
        ...
        if (!$container instanceof \_PhpScopereb8678af2407\Symfony\Component\DependencyInjection\ContainerInterface) {
            throw new \Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        // has output? keep it silent out of tests
        if ($container->has(\_PhpScopereb8678af2407\Symfony\Component\Console\Style\SymfonyStyle::class)) {
            $symfonyStyle = $container->get(\_PhpScopereb8678af2407\Symfony\Component\Console\Style\SymfonyStyle::class);
            $symfonyStyle->setVerbosity(\_PhpScopereb8678af2407\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
