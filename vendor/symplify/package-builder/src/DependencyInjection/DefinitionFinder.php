...
final class DefinitionFinder
{
     ...
     * @return Definition[]
     */
    public function findAllByType(\_PhpScoper47644ab3aa9a\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : array
    {
        $definitions = [];
    ...
    public function getByType(\_PhpScoper47644ab3aa9a\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : \_PhpScoper47644ab3aa9a\Symfony\Component\DependencyInjection\Definition
    {
    ...
    public function getByTypeIfExists(\_PhpScoper47644ab3aa9a\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : ?\_PhpScoper47644ab3aa9a\Symfony\Component\DependencyInjection\Definition
    {
        $containerBuilderDefinitions = $containerBuilder->getDefinitions();
        foreach ($containerBuilderDefinitions as $name => $definition) {
            $class = $definition->getClass() ?: $name;
