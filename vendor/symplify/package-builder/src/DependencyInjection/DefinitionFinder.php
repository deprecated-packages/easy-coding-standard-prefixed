...
final class DefinitionFinder
{
     ...
     * @return Definition[]
     */
    public function findAllByType(\_PhpScoper7c3fefba1fb9\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : array
    {
        $definitions = [];
    ...
    public function getByType(\_PhpScoper7c3fefba1fb9\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : \_PhpScoper7c3fefba1fb9\Symfony\Component\DependencyInjection\Definition
    {
    ...
    public function getByTypeIfExists(\_PhpScoper7c3fefba1fb9\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : ?\_PhpScoper7c3fefba1fb9\Symfony\Component\DependencyInjection\Definition
    {
        $containerBuilderDefinitions = $containerBuilder->getDefinitions();
        foreach ($containerBuilderDefinitions as $name => $definition) {
            $class = $definition->getClass() ?: $name;
