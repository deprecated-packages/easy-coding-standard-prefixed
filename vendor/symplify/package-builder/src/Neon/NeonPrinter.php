...
use _PhpScoper23ef26a4fb01\Nette\Neon\Encoder;
use _PhpScoper23ef26a4fb01\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper23ef26a4fb01\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper23ef26a4fb01\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper23ef26a4fb01\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper23ef26a4fb01\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper23ef26a4fb01\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
