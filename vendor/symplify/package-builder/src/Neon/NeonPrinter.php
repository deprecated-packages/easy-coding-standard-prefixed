...
use _PhpScoper1ed8518cf1bf\Nette\Neon\Encoder;
use _PhpScoper1ed8518cf1bf\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper1ed8518cf1bf\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper1ed8518cf1bf\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper1ed8518cf1bf\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper1ed8518cf1bf\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper1ed8518cf1bf\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
