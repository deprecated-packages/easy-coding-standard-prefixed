...
use _PhpScoper58a0a169dcfb\Nette\Neon\Encoder;
use _PhpScoper58a0a169dcfb\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper58a0a169dcfb\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper58a0a169dcfb\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper58a0a169dcfb\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
