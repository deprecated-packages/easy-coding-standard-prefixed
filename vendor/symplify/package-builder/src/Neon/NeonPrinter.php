...
use _PhpScoperc95ae4bf942a\Nette\Neon\Encoder;
use _PhpScoperc95ae4bf942a\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperc95ae4bf942a\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperc95ae4bf942a\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperc95ae4bf942a\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperc95ae4bf942a\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperc95ae4bf942a\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
