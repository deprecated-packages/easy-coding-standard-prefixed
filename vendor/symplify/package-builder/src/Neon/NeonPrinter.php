...
use _PhpScoperad4b7e2c09d8\Nette\Neon\Encoder;
use _PhpScoperad4b7e2c09d8\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperad4b7e2c09d8\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperad4b7e2c09d8\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperad4b7e2c09d8\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperad4b7e2c09d8\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperad4b7e2c09d8\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
