...
use _PhpScoper10b1b2c5ca55\Nette\Neon\Encoder;
use _PhpScoper10b1b2c5ca55\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper10b1b2c5ca55\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper10b1b2c5ca55\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper10b1b2c5ca55\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper10b1b2c5ca55\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper10b1b2c5ca55\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
