...
use _PhpScopercd2fc5ef50ef\Nette\Neon\Encoder;
use _PhpScopercd2fc5ef50ef\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScopercd2fc5ef50ef\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScopercd2fc5ef50ef\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScopercd2fc5ef50ef\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScopercd2fc5ef50ef\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScopercd2fc5ef50ef\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
