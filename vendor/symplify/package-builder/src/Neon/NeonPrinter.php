...
use _PhpScoper04022cd986ec\Nette\Neon\Encoder;
use _PhpScoper04022cd986ec\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper04022cd986ec\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper04022cd986ec\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper04022cd986ec\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper04022cd986ec\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper04022cd986ec\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
