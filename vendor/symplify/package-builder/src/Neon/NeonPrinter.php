...
use _PhpScoperc75fd40d7a6e\Nette\Neon\Encoder;
use _PhpScoperc75fd40d7a6e\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperc75fd40d7a6e\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperc75fd40d7a6e\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperc75fd40d7a6e\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperc75fd40d7a6e\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperc75fd40d7a6e\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
