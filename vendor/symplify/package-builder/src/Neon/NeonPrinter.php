...
use _PhpScopera37d6fb0b1ab\Nette\Neon\Encoder;
use _PhpScopera37d6fb0b1ab\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScopera37d6fb0b1ab\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScopera37d6fb0b1ab\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScopera37d6fb0b1ab\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScopera37d6fb0b1ab\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScopera37d6fb0b1ab\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
