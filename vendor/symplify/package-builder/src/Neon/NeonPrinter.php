...
use _PhpScopera4be459e5e3d\Nette\Neon\Encoder;
use _PhpScopera4be459e5e3d\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScopera4be459e5e3d\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScopera4be459e5e3d\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScopera4be459e5e3d\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScopera4be459e5e3d\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScopera4be459e5e3d\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
