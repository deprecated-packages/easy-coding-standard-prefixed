...
use _PhpScopera609aff833be\Nette\Neon\Encoder;
use _PhpScopera609aff833be\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScopera609aff833be\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScopera609aff833be\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScopera609aff833be\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScopera609aff833be\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScopera609aff833be\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
