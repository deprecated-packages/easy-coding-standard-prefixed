...
use _PhpScoper279cf54b77ad\Nette\Neon\Encoder;
use _PhpScoper279cf54b77ad\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper279cf54b77ad\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper279cf54b77ad\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper279cf54b77ad\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper279cf54b77ad\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper279cf54b77ad\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
