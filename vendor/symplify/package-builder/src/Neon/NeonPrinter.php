...
use _PhpScoper842c7347e6be\Nette\Neon\Encoder;
use _PhpScoper842c7347e6be\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper842c7347e6be\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper842c7347e6be\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper842c7347e6be\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper842c7347e6be\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper842c7347e6be\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
