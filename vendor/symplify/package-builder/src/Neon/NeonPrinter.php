...
use _PhpScoper28ab463fc3ba\Nette\Neon\Encoder;
use _PhpScoper28ab463fc3ba\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper28ab463fc3ba\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper28ab463fc3ba\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper28ab463fc3ba\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper28ab463fc3ba\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper28ab463fc3ba\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
