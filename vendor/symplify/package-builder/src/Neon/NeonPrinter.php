...
use _PhpScoper7faa8deb0d3c\Nette\Neon\Encoder;
use _PhpScoper7faa8deb0d3c\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper7faa8deb0d3c\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper7faa8deb0d3c\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper7faa8deb0d3c\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper7faa8deb0d3c\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper7faa8deb0d3c\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
