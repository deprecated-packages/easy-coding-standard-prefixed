...
use _PhpScoper2fe14d6302bc\Nette\Neon\Encoder;
use _PhpScoper2fe14d6302bc\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper2fe14d6302bc\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper2fe14d6302bc\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper2fe14d6302bc\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper2fe14d6302bc\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper2fe14d6302bc\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
