...
use _PhpScoper86aebf8cf357\Nette\Neon\Encoder;
use _PhpScoper86aebf8cf357\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper86aebf8cf357\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper86aebf8cf357\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper86aebf8cf357\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper86aebf8cf357\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper86aebf8cf357\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
