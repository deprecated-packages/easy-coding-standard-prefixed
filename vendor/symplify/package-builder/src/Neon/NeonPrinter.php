...
use _PhpScoper0c0702cca4ac\Nette\Neon\Encoder;
use _PhpScoper0c0702cca4ac\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper0c0702cca4ac\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper0c0702cca4ac\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper0c0702cca4ac\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper0c0702cca4ac\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper0c0702cca4ac\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
