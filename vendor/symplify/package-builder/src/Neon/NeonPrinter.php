...
use _PhpScoper89ec3c69e67d\Nette\Neon\Encoder;
use _PhpScoper89ec3c69e67d\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper89ec3c69e67d\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper89ec3c69e67d\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper89ec3c69e67d\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper89ec3c69e67d\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper89ec3c69e67d\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
