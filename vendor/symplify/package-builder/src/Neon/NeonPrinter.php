...
use _PhpScoper7108c819f5c5\Nette\Neon\Encoder;
use _PhpScoper7108c819f5c5\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper7108c819f5c5\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper7108c819f5c5\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper7108c819f5c5\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper7108c819f5c5\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper7108c819f5c5\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
