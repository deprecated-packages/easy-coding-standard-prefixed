...
use _PhpScoperb458b528613f\Nette\Neon\Encoder;
use _PhpScoperb458b528613f\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperb458b528613f\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperb458b528613f\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperb458b528613f\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperb458b528613f\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperb458b528613f\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
