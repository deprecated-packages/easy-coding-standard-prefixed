...
use _PhpScoper81b3ff5ab9fe\Nette\Neon\Encoder;
use _PhpScoper81b3ff5ab9fe\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper81b3ff5ab9fe\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper81b3ff5ab9fe\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper81b3ff5ab9fe\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper81b3ff5ab9fe\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper81b3ff5ab9fe\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
