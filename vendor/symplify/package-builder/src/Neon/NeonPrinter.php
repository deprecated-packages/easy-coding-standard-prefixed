...
use _PhpScoperac4e86be08e5\Nette\Neon\Encoder;
use _PhpScoperac4e86be08e5\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperac4e86be08e5\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperac4e86be08e5\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperac4e86be08e5\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperac4e86be08e5\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperac4e86be08e5\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
