...
use _PhpScoperf3f1be0d8a30\Nette\Neon\Encoder;
use _PhpScoperf3f1be0d8a30\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperf3f1be0d8a30\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperf3f1be0d8a30\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperf3f1be0d8a30\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperf3f1be0d8a30\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperf3f1be0d8a30\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
