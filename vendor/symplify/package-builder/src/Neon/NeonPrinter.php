...
use _PhpScoperd1a5bf00e83e\Nette\Neon\Encoder;
use _PhpScoperd1a5bf00e83e\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperd1a5bf00e83e\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperd1a5bf00e83e\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperd1a5bf00e83e\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperd1a5bf00e83e\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperd1a5bf00e83e\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
