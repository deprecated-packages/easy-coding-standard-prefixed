...
use _PhpScoper2f75f00bf6fa\Nette\Neon\Encoder;
use _PhpScoper2f75f00bf6fa\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper2f75f00bf6fa\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper2f75f00bf6fa\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper2f75f00bf6fa\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper2f75f00bf6fa\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper2f75f00bf6fa\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
