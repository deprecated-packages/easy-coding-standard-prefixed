...
use _PhpScoper06c5fb6c14ed\Nette\Neon\Encoder;
use _PhpScoper06c5fb6c14ed\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper06c5fb6c14ed\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper06c5fb6c14ed\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper06c5fb6c14ed\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper06c5fb6c14ed\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper06c5fb6c14ed\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
