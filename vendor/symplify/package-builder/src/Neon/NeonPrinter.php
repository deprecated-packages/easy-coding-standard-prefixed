...
use _PhpScoper5ca2d8bcb02c\Nette\Neon\Encoder;
use _PhpScoper5ca2d8bcb02c\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper5ca2d8bcb02c\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper5ca2d8bcb02c\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper5ca2d8bcb02c\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper5ca2d8bcb02c\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper5ca2d8bcb02c\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
