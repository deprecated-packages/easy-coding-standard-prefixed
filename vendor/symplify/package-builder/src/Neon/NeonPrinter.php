...
use _PhpScopera23ebff5477f\Nette\Neon\Encoder;
use _PhpScopera23ebff5477f\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScopera23ebff5477f\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScopera23ebff5477f\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScopera23ebff5477f\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScopera23ebff5477f\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScopera23ebff5477f\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
