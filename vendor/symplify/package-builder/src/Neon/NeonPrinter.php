...
use _PhpScoper246d3630afdd\Nette\Neon\Encoder;
use _PhpScoper246d3630afdd\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper246d3630afdd\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper246d3630afdd\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper246d3630afdd\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper246d3630afdd\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper246d3630afdd\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
