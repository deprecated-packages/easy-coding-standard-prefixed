...
use _PhpScoper02b5d1bf8fec\Nette\Neon\Encoder;
use _PhpScoper02b5d1bf8fec\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper02b5d1bf8fec\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper02b5d1bf8fec\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper02b5d1bf8fec\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
