 ...
 */
abstract class AbstractKernelTestCase extends \_PhpScopera238de2e9b5a\PHPUnit\Framework\TestCase
{
    /**
     * @var KernelInterface
     */
     ...
     */
    protected function bootKernelWithConfigs(string $kernelClass, array $configs) : \_PhpScopera238de2e9b5a\Symfony\Component\HttpKernel\KernelInterface
    {
        ...
        if (!$kernel instanceof \_PhpScopera238de2e9b5a\Symfony\Component\HttpKernel\KernelInterface) {
    ...
    protected function ensureKernelShutdown() : void
    {
        if (static::$kernel !== null) {
            ...
            if ($kernel !== null) {
                ...
                if ($container instanceof \_PhpScopera238de2e9b5a\Symfony\Contracts\Service\ResetInterface) {
                    $container->reset();
                }
            }
        }
    ...
    private function ensureIsConfigAwareKernel(\_PhpScopera238de2e9b5a\Symfony\Component\HttpKernel\KernelInterface $kernel) : void
    {
    ...
    private function bootAndReturnKernel(\_PhpScopera238de2e9b5a\Symfony\Component\HttpKernel\KernelInterface $kernel) : \_PhpScopera238de2e9b5a\Symfony\Component\HttpKernel\KernelInterface
    {
        $kernel->boot();
        ...
        if (!$container instanceof \_PhpScopera238de2e9b5a\Psr\Container\ContainerInterface) {
            throw new \Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        // has output? keep it silent out of tests
        if ($container->has(\_PhpScopera238de2e9b5a\Symfony\Component\Console\Style\SymfonyStyle::class)) {
            $symfonyStyle = $container->get(\_PhpScopera238de2e9b5a\Symfony\Component\Console\Style\SymfonyStyle::class);
            $symfonyStyle->setVerbosity(\_PhpScopera238de2e9b5a\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
