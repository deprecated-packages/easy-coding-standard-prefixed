...
use _PhpScopercae9e6ab5cea\Jean85\PrettyVersions;
use _PhpScopercae9e6ab5cea\Jean85\Version;
use OutOfBoundsException;
use _PhpScopercae9e6ab5cea\PharIo\Version\InvalidVersionException;
