...
use _PhpScoper0752b31150a1\Jean85\PrettyVersions;
use _PhpScoper0752b31150a1\Jean85\Version;
use OutOfBoundsException;
use _PhpScoper0752b31150a1\PharIo\Version\InvalidVersionException;
