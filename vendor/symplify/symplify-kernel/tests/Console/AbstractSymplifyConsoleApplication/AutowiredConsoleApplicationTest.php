...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperfa521053d812\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperfa521053d812\Symfony\Component\Console\Application::class, $application);
    }
}
