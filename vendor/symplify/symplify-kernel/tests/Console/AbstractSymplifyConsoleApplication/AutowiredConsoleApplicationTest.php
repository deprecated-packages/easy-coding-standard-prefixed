...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper7b319b4d8e1c\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper7b319b4d8e1c\Symfony\Component\Console\Application::class, $application);
    }
}
