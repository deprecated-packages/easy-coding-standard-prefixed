...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper3639953bb9e5\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper3639953bb9e5\Symfony\Component\Console\Application::class, $application);
    }
}
