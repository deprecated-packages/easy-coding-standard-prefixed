...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper06c66bea2cf6\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper06c66bea2cf6\Symfony\Component\Console\Application::class, $application);
    }
}
