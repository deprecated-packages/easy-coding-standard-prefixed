...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperca8ca183ac38\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperca8ca183ac38\Symfony\Component\Console\Application::class, $application);
    }
}
