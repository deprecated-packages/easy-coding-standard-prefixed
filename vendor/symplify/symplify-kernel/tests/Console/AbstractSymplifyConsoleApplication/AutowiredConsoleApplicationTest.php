...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper4936962185e7\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper4936962185e7\Symfony\Component\Console\Application::class, $application);
    }
}
