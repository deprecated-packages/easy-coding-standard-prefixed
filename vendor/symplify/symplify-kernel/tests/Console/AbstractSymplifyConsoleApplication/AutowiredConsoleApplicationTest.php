...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperf361a7d70552\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperf361a7d70552\Symfony\Component\Console\Application::class, $application);
    }
}
