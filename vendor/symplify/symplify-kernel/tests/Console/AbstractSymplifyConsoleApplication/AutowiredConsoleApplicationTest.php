...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperab9510cd5d97\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperab9510cd5d97\Symfony\Component\Console\Application::class, $application);
    }
}
