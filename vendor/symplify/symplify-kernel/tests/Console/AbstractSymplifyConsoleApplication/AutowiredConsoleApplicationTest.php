...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper207eb8f99af3\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper207eb8f99af3\Symfony\Component\Console\Application::class, $application);
    }
}
