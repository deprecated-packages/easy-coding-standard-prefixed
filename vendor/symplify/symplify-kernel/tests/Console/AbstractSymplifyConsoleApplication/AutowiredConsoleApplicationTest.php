...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperdf6a0b341030\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperdf6a0b341030\Symfony\Component\Console\Application::class, $application);
    }
}
