...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperef870243cfdb\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperef870243cfdb\Symfony\Component\Console\Application::class, $application);
    }
}
