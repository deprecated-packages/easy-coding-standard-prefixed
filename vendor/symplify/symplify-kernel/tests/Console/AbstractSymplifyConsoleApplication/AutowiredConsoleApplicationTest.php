...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper02b5d1bf8fec\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper02b5d1bf8fec\Symfony\Component\Console\Application::class, $application);
    }
}
