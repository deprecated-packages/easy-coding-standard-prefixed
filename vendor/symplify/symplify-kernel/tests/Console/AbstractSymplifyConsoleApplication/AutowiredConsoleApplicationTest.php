...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper3e8786a75afe\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper3e8786a75afe\Symfony\Component\Console\Application::class, $application);
    }
}
