...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScopera749ac204cd2\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopera749ac204cd2\Symfony\Component\Console\Application::class, $application);
    }
}
