...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper64ca614e27fd\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper64ca614e27fd\Symfony\Component\Console\Application::class, $application);
    }
}
