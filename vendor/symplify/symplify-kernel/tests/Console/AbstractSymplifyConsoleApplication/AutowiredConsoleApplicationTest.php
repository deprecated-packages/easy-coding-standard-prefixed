...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper21763e6c7ac4\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper21763e6c7ac4\Symfony\Component\Console\Application::class, $application);
    }
}
