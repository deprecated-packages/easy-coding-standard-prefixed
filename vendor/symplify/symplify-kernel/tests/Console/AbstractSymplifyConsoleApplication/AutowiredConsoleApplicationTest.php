...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperf77bffce0320\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperf77bffce0320\Symfony\Component\Console\Application::class, $application);
    }
}
