...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper64a921a5401b\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper64a921a5401b\Symfony\Component\Console\Application::class, $application);
    }
}
