...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperc753ccca5a0c\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperc753ccca5a0c\Symfony\Component\Console\Application::class, $application);
    }
}
