...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper4f985154d5a0\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper4f985154d5a0\Symfony\Component\Console\Application::class, $application);
    }
}
