...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperf62d28230928\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperf62d28230928\Symfony\Component\Console\Application::class, $application);
    }
}
