...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper967c4b7e296e\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper967c4b7e296e\Symfony\Component\Console\Application::class, $application);
    }
}
