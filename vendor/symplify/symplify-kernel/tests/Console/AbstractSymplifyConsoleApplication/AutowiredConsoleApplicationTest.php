...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper8ca6426d4e0c\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper8ca6426d4e0c\Symfony\Component\Console\Application::class, $application);
    }
}
