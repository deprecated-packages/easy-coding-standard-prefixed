...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper1103e00fb46b\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper1103e00fb46b\Symfony\Component\Console\Application::class, $application);
    }
}
