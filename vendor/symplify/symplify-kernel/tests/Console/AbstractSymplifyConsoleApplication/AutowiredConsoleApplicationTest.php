...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScopera4be459e5e3d\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopera4be459e5e3d\Symfony\Component\Console\Application::class, $application);
    }
}
