...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperc95ae4bf942a\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperc95ae4bf942a\Symfony\Component\Console\Application::class, $application);
    }
}
