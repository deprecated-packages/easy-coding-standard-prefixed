...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperc7096eb2567d\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperc7096eb2567d\Symfony\Component\Console\Application::class, $application);
    }
}
