...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScopercb576ca159b5\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopercb576ca159b5\Symfony\Component\Console\Application::class, $application);
    }
}
