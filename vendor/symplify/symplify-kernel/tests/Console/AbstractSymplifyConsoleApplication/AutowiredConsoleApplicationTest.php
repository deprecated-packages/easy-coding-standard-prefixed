...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper967d20dce97a\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper967d20dce97a\Symfony\Component\Console\Application::class, $application);
    }
}
