...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperd3d57724c802\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperd3d57724c802\Symfony\Component\Console\Application::class, $application);
    }
}
