...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperef5048aa2573\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperef5048aa2573\Symfony\Component\Console\Application::class, $application);
    }
}
