...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperf7b66f9e3817\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperf7b66f9e3817\Symfony\Component\Console\Application::class, $application);
    }
}
