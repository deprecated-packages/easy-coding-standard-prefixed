...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper7cef7256eba6\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper7cef7256eba6\Symfony\Component\Console\Application::class, $application);
    }
}
