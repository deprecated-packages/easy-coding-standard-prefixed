...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperd1a5bf00e83e\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperd1a5bf00e83e\Symfony\Component\Console\Application::class, $application);
    }
}
