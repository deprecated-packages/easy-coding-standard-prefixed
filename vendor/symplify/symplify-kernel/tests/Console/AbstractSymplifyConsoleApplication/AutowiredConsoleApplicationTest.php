...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperfcf15c26e033\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperfcf15c26e033\Symfony\Component\Console\Application::class, $application);
    }
}
