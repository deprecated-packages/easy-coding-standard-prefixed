...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper28ab463fc3ba\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper28ab463fc3ba\Symfony\Component\Console\Application::class, $application);
    }
}
