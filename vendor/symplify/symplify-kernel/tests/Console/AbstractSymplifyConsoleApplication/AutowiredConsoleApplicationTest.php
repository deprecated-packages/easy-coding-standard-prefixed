...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScopera189153e1f79\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopera189153e1f79\Symfony\Component\Console\Application::class, $application);
    }
}
