...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperdaf95aff095b\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperdaf95aff095b\Symfony\Component\Console\Application::class, $application);
    }
}
