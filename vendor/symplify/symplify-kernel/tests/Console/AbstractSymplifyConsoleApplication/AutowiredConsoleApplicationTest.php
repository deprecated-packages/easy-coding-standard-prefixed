...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper70072c07b02b\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper70072c07b02b\Symfony\Component\Console\Application::class, $application);
    }
}
