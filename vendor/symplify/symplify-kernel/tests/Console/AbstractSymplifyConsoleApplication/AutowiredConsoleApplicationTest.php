...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperfb0714773dc5\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperfb0714773dc5\Symfony\Component\Console\Application::class, $application);
    }
}
