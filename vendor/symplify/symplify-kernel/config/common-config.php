...
use function _PhpScoper14718bfcc75e\Symfony\Component\DependencyInjection\Loader\Configurator\service;
return static function (\_PhpScoper14718bfcc75e\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper14718bfcc75e\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\_PhpScoper14718bfcc75e\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    // filesystem
    ...
    $services->set(\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\_PhpScoper14718bfcc75e\Symfony\Component\DependencyInjection\Loader\Configurator\service(\_PhpScoper14718bfcc75e\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
