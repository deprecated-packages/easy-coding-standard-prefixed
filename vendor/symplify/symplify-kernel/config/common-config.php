...
return static function (\_PhpScoper2a48669dad72\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper2a48669dad72\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\_PhpScoper2a48669dad72\Symfony\Component\DependencyInjection\Loader\Configurator\ref(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    // filesystem
    ...
    $services->set(\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\_PhpScoper2a48669dad72\Symfony\Component\DependencyInjection\Loader\Configurator\ref(\_PhpScoper2a48669dad72\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
