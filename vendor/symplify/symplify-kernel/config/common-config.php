...
return static function (\_PhpScoper0c0702cca4ac\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper0c0702cca4ac\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\_PhpScoper0c0702cca4ac\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    // filesystem
    ...
    $services->set(\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\_PhpScoper0c0702cca4ac\Symfony\Component\DependencyInjection\Loader\Configurator\service(\_PhpScoper0c0702cca4ac\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
