...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper47644ab3aa9a\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper47644ab3aa9a\Jean85\PrettyVersions::getVersion($packageName);
