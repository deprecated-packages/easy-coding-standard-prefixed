...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper59ccd3f8e121\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper59ccd3f8e121\Jean85\PrettyVersions::getVersion($packageName);
