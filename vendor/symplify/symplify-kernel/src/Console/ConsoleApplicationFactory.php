...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper4edd80b4ab80\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper4edd80b4ab80\Jean85\PrettyVersions::getVersion($packageName);
