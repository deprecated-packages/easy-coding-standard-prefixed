...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper8dd2e1c340b1\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper8dd2e1c340b1\Jean85\PrettyVersions::getVersion($packageName);
