...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper6d28bdf6a7f9\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper6d28bdf6a7f9\Jean85\PrettyVersions::getVersion($packageName);
