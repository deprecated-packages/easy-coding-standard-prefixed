...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper4d05106cc3c0\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper4d05106cc3c0\Jean85\PrettyVersions::getVersion($packageName);
