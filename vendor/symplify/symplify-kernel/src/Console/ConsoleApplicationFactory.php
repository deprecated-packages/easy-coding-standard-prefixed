...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper6a0a7eb6e565\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper6a0a7eb6e565\Jean85\PrettyVersions::getVersion($packageName);
