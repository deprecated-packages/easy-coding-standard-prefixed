...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperb6a8e65b492c\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperb6a8e65b492c\Jean85\PrettyVersions::getVersion($packageName);
