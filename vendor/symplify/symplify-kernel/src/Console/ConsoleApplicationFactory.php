...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper28ab463fc3ba\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper28ab463fc3ba\Jean85\PrettyVersions::getVersion($packageName);
