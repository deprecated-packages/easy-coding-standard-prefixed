...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScopera8f555a7493c\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScopera8f555a7493c\Jean85\PrettyVersions::getVersion($packageName);
