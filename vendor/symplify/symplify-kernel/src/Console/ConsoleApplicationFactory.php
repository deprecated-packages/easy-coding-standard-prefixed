...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperfab1bfb7ec99\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperfab1bfb7ec99\Jean85\PrettyVersions::getVersion($packageName);
