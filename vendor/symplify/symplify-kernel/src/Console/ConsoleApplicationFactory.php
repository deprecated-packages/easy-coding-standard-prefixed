...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper3e1e0e5bb8ef\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper3e1e0e5bb8ef\Jean85\PrettyVersions::getVersion($packageName);
