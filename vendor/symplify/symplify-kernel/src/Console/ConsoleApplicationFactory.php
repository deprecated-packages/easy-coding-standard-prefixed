...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperfd70a7e8e84f\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperfd70a7e8e84f\Jean85\PrettyVersions::getVersion($packageName);
