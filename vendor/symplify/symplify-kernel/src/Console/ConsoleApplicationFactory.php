...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperc8b83ee8976a\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperc8b83ee8976a\Jean85\PrettyVersions::getVersion($packageName);
