...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperb6ccec8ab642\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperb6ccec8ab642\Jean85\PrettyVersions::getVersion($packageName);
