...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper83b3b9a317c0\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper83b3b9a317c0\Jean85\PrettyVersions::getVersion($packageName);
