...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper8acb416c2f5a\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper8acb416c2f5a\Jean85\PrettyVersions::getVersion($packageName);
