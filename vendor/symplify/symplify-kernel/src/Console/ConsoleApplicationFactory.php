...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper8e2d8a2760d1\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper8e2d8a2760d1\Jean85\PrettyVersions::getVersion($packageName);
