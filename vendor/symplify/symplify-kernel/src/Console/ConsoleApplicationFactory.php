...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScopera09818bc50da\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScopera09818bc50da\Jean85\PrettyVersions::getVersion($packageName);
