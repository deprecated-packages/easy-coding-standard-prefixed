...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperc64a4ac1af35\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperc64a4ac1af35\Jean85\PrettyVersions::getVersion($packageName);
