...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper5a9febfbbe05\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper5a9febfbbe05\Jean85\PrettyVersions::getVersion($packageName);
