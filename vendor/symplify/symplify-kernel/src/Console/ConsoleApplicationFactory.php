...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperc95ae4bf942a\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperc95ae4bf942a\Jean85\PrettyVersions::getVersion($packageName);
