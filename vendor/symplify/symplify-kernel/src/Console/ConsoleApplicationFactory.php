...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperddde3ba4aebc\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperddde3ba4aebc\Jean85\PrettyVersions::getVersion($packageName);
