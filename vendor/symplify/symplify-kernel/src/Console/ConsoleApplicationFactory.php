...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScopera4be459e5e3d\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScopera4be459e5e3d\Jean85\PrettyVersions::getVersion($packageName);
