...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperbc5235eb86f3\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperbc5235eb86f3\Jean85\PrettyVersions::getVersion($packageName);
