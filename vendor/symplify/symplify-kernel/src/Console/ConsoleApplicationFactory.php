...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper7c3fefba1fb9\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper7c3fefba1fb9\Jean85\PrettyVersions::getVersion($packageName);
