...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperdc8fbcd7c69d\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperdc8fbcd7c69d\Jean85\PrettyVersions::getVersion($packageName);
