...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperf7b66f9e3817\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperf7b66f9e3817\Jean85\PrettyVersions::getVersion($packageName);
