...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper3a22e8e0bd94\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper3a22e8e0bd94\Jean85\PrettyVersions::getVersion($packageName);
