...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper23ef26a4fb01\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper23ef26a4fb01\Jean85\PrettyVersions::getVersion($packageName);
