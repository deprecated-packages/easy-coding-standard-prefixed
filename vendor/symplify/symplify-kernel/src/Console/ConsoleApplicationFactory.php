...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper6a1dd9b8a650\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper6a1dd9b8a650\Jean85\PrettyVersions::getVersion($packageName);
