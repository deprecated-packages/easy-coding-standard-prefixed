...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper06c66bea2cf6\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper06c66bea2cf6\Jean85\PrettyVersions::getVersion($packageName);
