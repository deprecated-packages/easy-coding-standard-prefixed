...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScopercf909b66eba8\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScopercf909b66eba8\Jean85\PrettyVersions::getVersion($packageName);
