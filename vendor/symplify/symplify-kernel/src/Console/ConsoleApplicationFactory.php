...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperbd5fb781fe24\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperbd5fb781fe24\Jean85\PrettyVersions::getVersion($packageName);
