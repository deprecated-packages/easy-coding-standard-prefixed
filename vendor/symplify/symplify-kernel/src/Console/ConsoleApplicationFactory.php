...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper0f5cd390c37a\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper0f5cd390c37a\Jean85\PrettyVersions::getVersion($packageName);
