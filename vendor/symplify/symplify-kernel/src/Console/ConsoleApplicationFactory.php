...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper9b9ddfd01528\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper9b9ddfd01528\Jean85\PrettyVersions::getVersion($packageName);
