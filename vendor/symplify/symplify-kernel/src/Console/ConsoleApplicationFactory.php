...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScopera23ebff5477f\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScopera23ebff5477f\Jean85\PrettyVersions::getVersion($packageName);
