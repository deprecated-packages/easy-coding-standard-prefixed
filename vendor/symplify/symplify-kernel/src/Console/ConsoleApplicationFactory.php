...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperf3f1be0d8a30\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperf3f1be0d8a30\Jean85\PrettyVersions::getVersion($packageName);
