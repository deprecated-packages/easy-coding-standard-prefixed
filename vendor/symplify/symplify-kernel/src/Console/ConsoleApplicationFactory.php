...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper49c742f5a4ee\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper49c742f5a4ee\Jean85\PrettyVersions::getVersion($packageName);
