...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper3d6b50c3ca2f\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper3d6b50c3ca2f\Jean85\PrettyVersions::getVersion($packageName);
