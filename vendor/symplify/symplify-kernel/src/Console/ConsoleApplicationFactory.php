...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperdf15f2b748e9\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperdf15f2b748e9\Jean85\PrettyVersions::getVersion($packageName);
