...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper992f4af8b9e0\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper992f4af8b9e0\Jean85\PrettyVersions::getVersion($packageName);
