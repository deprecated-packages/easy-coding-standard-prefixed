...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper6224e3b16fcc\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper6224e3b16fcc\Jean85\PrettyVersions::getVersion($packageName);
