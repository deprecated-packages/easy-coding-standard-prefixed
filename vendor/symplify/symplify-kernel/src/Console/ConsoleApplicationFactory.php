...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper4d3fa30a680b\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper4d3fa30a680b\Jean85\PrettyVersions::getVersion($packageName);
