...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperaa402dd1b1f1\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperaa402dd1b1f1\Jean85\PrettyVersions::getVersion($packageName);
