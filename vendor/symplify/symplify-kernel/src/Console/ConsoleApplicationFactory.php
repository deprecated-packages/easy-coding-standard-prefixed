...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper81b3ff5ab9fe\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper81b3ff5ab9fe\Jean85\PrettyVersions::getVersion($packageName);
