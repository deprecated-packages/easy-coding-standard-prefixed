...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper21763e6c7ac4\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper21763e6c7ac4\Jean85\PrettyVersions::getVersion($packageName);
