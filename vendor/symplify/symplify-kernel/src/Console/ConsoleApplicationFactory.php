...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper21c6ce8bfe5d\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper21c6ce8bfe5d\Jean85\PrettyVersions::getVersion($packageName);
