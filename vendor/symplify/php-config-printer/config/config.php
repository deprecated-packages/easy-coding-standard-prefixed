...
use _PhpScoperaa402dd1b1f1\PhpParser\BuilderFactory;
...
return static function (\_PhpScoperaa402dd1b1f1\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperaa402dd1b1f1\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoperaa402dd1b1f1\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoperaa402dd1b1f1\PhpParser\BuilderFactory::class);
