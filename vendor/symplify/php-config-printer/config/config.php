...
use _PhpScoper59558822d8c7\PhpParser\BuilderFactory;
use _PhpScoper59558822d8c7\PhpParser\NodeFinder;
...
return static function (\_PhpScoper59558822d8c7\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper59558822d8c7\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoper59558822d8c7\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoper59558822d8c7\PhpParser\BuilderFactory::class);
