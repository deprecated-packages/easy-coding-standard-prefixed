...
use _PhpScoper5f6e904600e7\PhpParser\BuilderFactory;
use _PhpScoper5f6e904600e7\PhpParser\NodeFinder;
...
return static function (\_PhpScoper5f6e904600e7\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper5f6e904600e7\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoper5f6e904600e7\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoper5f6e904600e7\PhpParser\BuilderFactory::class);
