...
use _PhpScoper13133e188f67\PhpParser\BuilderFactory;
use _PhpScoper13133e188f67\PhpParser\NodeFinder;
...
return static function (\_PhpScoper13133e188f67\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper13133e188f67\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoper13133e188f67\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoper13133e188f67\PhpParser\BuilderFactory::class);
