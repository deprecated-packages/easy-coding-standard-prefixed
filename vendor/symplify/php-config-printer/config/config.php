...
use _PhpScoper83b3b9a317c0\PhpParser\BuilderFactory;
...
return static function (\_PhpScoper83b3b9a317c0\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper83b3b9a317c0\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoper83b3b9a317c0\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoper83b3b9a317c0\PhpParser\BuilderFactory::class);
