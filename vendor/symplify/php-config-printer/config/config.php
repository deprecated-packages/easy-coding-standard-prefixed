...
use _PhpScoperfb0714773dc5\PhpParser\BuilderFactory;
...
return static function (\_PhpScoperfb0714773dc5\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperfb0714773dc5\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoperfb0714773dc5\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoperfb0714773dc5\PhpParser\BuilderFactory::class);
