...
use _PhpScoperf53473b45c36\PhpParser\BuilderFactory;
...
return static function (\_PhpScoperf53473b45c36\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperf53473b45c36\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoperf53473b45c36\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoperf53473b45c36\PhpParser\BuilderFactory::class);
