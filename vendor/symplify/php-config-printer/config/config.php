...
use _PhpScoperc4b135661b3a\PhpParser\BuilderFactory;
use _PhpScoperc4b135661b3a\PhpParser\NodeFinder;
...
return static function (\_PhpScoperc4b135661b3a\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperc4b135661b3a\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoperc4b135661b3a\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoperc4b135661b3a\PhpParser\BuilderFactory::class);
