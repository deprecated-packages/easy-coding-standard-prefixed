...
use _PhpScoper2a48669dad72\PhpParser\BuilderFactory;
use _PhpScoper2a48669dad72\PhpParser\NodeFinder;
...
return static function (\_PhpScoper2a48669dad72\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper2a48669dad72\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoper2a48669dad72\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoper2a48669dad72\PhpParser\BuilderFactory::class);
