...
use _PhpScoper0c0702cca4ac\PhpParser\BuilderFactory;
...
return static function (\_PhpScoper0c0702cca4ac\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper0c0702cca4ac\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoper0c0702cca4ac\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoper0c0702cca4ac\PhpParser\BuilderFactory::class);
