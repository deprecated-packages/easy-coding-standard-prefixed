...
use _PhpScoperdc8fbcd7c69d\PhpParser\BuilderFactory;
use _PhpScoperdc8fbcd7c69d\PhpParser\NodeFinder;
...
return static function (\_PhpScoperdc8fbcd7c69d\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperdc8fbcd7c69d\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoperdc8fbcd7c69d\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoperdc8fbcd7c69d\PhpParser\BuilderFactory::class);
