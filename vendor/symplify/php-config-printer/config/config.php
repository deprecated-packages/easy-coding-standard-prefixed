...
use _PhpScoper38a7d00685f8\PhpParser\BuilderFactory;
use _PhpScoper38a7d00685f8\PhpParser\NodeFinder;
...
return static function (\_PhpScoper38a7d00685f8\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper38a7d00685f8\PhpParser\NodeFinder::class);
    $services->set(\_PhpScoper38a7d00685f8\Symfony\Component\Yaml\Parser::class);
    $services->set(\_PhpScoper38a7d00685f8\PhpParser\BuilderFactory::class);
