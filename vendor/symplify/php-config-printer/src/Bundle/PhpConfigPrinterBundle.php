 ...
 */
final class PhpConfigPrinterBundle extends \_PhpScoper64e7ad844899\Symfony\Component\HttpKernel\Bundle\Bundle
{
    public function build(\_PhpScoper64e7ad844899\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        $this->registerDefaultImplementations($containerBuilder);
        $containerBuilder->addCompilerPass(new \Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass());
    }
    protected function createContainerExtension() : \Symplify\PhpConfigPrinter\DependencyInjection\Extension\PhpConfigPrinterExtension
    {
        return new \Symplify\PhpConfigPrinter\DependencyInjection\Extension\PhpConfigPrinterExtension();
    }
    private function registerDefaultImplementations(\_PhpScoper64e7ad844899\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
