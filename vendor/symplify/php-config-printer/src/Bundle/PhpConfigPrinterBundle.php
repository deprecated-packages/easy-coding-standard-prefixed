...
use _PhpScoper59ccd3f8e121\Symfony\Component\HttpKernel\Bundle\Bundle;
 ...
 */
final class PhpConfigPrinterBundle extends \_PhpScoper59ccd3f8e121\Symfony\Component\HttpKernel\Bundle\Bundle
{
    public function build(\_PhpScoper59ccd3f8e121\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        $this->registerDefaultImplementations($containerBuilder);
        $containerBuilder->addCompilerPass(new \Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass());
    }
    protected function createContainerExtension() : ?\_PhpScoper59ccd3f8e121\Symfony\Component\DependencyInjection\Extension\ExtensionInterface
    {
        return new \Symplify\PhpConfigPrinter\DependencyInjection\Extension\PhpConfigPrinterExtension();
    }
    private function registerDefaultImplementations(\_PhpScoper59ccd3f8e121\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
