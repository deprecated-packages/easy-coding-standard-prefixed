...
use _PhpScoper418afc2f157c\Symfony\Component\HttpKernel\Bundle\Bundle;
 ...
 */
final class PhpConfigPrinterBundle extends \_PhpScoper418afc2f157c\Symfony\Component\HttpKernel\Bundle\Bundle
{
    public function build(\_PhpScoper418afc2f157c\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        $this->registerDefaultImplementations($containerBuilder);
        $containerBuilder->addCompilerPass(new \Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass());
    }
    protected function createContainerExtension() : ?\_PhpScoper418afc2f157c\Symfony\Component\DependencyInjection\Extension\ExtensionInterface
    {
        return new \Symplify\PhpConfigPrinter\DependencyInjection\Extension\PhpConfigPrinterExtension();
    }
    private function registerDefaultImplementations(\_PhpScoper418afc2f157c\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
