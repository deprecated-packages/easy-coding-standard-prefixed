...
final class ConstantNodeFactory
{
     ...
     */
    public function createConstantIfValue(string $value) : ?\_PhpScoper614deab2c612\PhpParser\Node\Expr
    {
        if (\_PhpScoper614deab2c612\Nette\Utils\Strings::contains($value, '::')) {
            ...
            return new \_PhpScoper614deab2c612\PhpParser\Node\Expr\ClassConstFetch(new \_PhpScoper614deab2c612\PhpParser\Node\Name\FullyQualified($class), $constant);
        }
        ...
        foreach (\array_keys($definedConstants) as $constantName) {
            ...
            if (!\_PhpScoper614deab2c612\Nette\Utils\Strings::match($yamlContent, $constantDefinitionPattern)) {
                continue;
            }
            return new \_PhpScoper614deab2c612\PhpParser\Node\Expr\ConstFetch(new \_PhpScoper614deab2c612\PhpParser\Node\Name($constantName));
        }
        return null;
    }
}
