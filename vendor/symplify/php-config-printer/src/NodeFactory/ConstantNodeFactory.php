...
final class ConstantNodeFactory
{
     ...
     */
    public function createConstantIfValue(string $value) : ?\_PhpScoper9ef667a5e42c\PhpParser\Node\Expr
    {
        if (\_PhpScoper9ef667a5e42c\Nette\Utils\Strings::contains($value, '::')) {
            ...
            return new \_PhpScoper9ef667a5e42c\PhpParser\Node\Expr\ClassConstFetch(new \_PhpScoper9ef667a5e42c\PhpParser\Node\Name\FullyQualified($class), $constant);
        }
        ...
        foreach (\array_keys($definedConstants) as $constantName) {
            ...
            if (!\_PhpScoper9ef667a5e42c\Nette\Utils\Strings::match($yamlContent, $constantDefinitionPattern)) {
                continue;
            }
            return new \_PhpScoper9ef667a5e42c\PhpParser\Node\Expr\ConstFetch(new \_PhpScoper9ef667a5e42c\PhpParser\Node\Name($constantName));
        }
        return null;
    }
}
