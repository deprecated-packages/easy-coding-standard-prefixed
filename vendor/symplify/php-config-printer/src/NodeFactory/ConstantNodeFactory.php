...
final class ConstantNodeFactory
{
     ...
     */
    public function createConstantIfValue(string $value) : ?\_PhpScoperaa402dd1b1f1\PhpParser\Node\Expr
    {
        if (\_PhpScoperaa402dd1b1f1\Nette\Utils\Strings::contains($value, '::')) {
            ...
            return new \_PhpScoperaa402dd1b1f1\PhpParser\Node\Expr\ClassConstFetch(new \_PhpScoperaa402dd1b1f1\PhpParser\Node\Name\FullyQualified($class), $constant);
        }
        ...
        foreach (\array_keys($definedConstants) as $constantName) {
            ...
            if (!\_PhpScoperaa402dd1b1f1\Nette\Utils\Strings::match($yamlContent, $constantDefinitionPattern)) {
                continue;
            }
            return new \_PhpScoperaa402dd1b1f1\PhpParser\Node\Expr\ConstFetch(new \_PhpScoperaa402dd1b1f1\PhpParser\Node\Name($constantName));
        }
        return null;
    }
}
