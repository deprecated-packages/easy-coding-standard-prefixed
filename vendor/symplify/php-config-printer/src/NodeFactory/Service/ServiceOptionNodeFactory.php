...
final class ServiceOptionNodeFactory
{
     ...
     */
    public function convertServiceOptionsToNodes(array $servicesValues, \_PhpScoper4e2df00556a9\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoper4e2df00556a9\PhpParser\Node\Expr\MethodCall
    {
    ...
    private function shouldSkip(string $key) : bool
    {
        ...
        if (\_PhpScoper4e2df00556a9\Nette\Utils\Strings::startsWith($key, 'decoration_')) {
            return \true;
        }
        return $key === 'alias';
    }
