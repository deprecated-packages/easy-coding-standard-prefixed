...
final class ServiceOptionNodeFactory
{
     ...
     */
    public function convertServiceOptionsToNodes(array $servicesValues, \_PhpScoper4f42ead57614\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoper4f42ead57614\PhpParser\Node\Expr\MethodCall
    {
    ...
    private function shouldSkip(string $key) : bool
    {
        ...
        if (\_PhpScoper4f42ead57614\Nette\Utils\Strings::startsWith($key, 'decoration_')) {
            return \true;
        }
        return $key === 'alias';
    }
