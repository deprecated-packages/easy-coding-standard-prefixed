...
final class ServiceOptionNodeFactory
{
     ...
     */
    public function convertServiceOptionsToNodes(array $servicesValues, \_PhpScoper10b1b2c5ca55\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoper10b1b2c5ca55\PhpParser\Node\Expr\MethodCall
    {
    ...
    private function shouldSkip(string $key) : bool
    {
        ...
        if (\_PhpScoper10b1b2c5ca55\Nette\Utils\Strings::startsWith($key, 'decoration_')) {
            return \true;
        }
        return $key === 'alias';
    }
