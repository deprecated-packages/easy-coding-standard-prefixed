...
final class ServiceOptionNodeFactory
{
     ...
     */
    public function convertServiceOptionsToNodes(array $servicesValues, \_PhpScoper971ef29294dd\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoper971ef29294dd\PhpParser\Node\Expr\MethodCall
    {
    ...
    private function shouldSkip(string $key) : bool
    {
        ...
        if (\_PhpScoper971ef29294dd\Nette\Utils\Strings::startsWith($key, 'decoration_')) {
            return \true;
        }
        return $key === 'alias';
    }
