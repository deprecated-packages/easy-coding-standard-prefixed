...
final class ServiceOptionNodeFactory
{
     ...
     */
    public function convertServiceOptionsToNodes(array $servicesValues, \_PhpScoper0c0702cca4ac\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoper0c0702cca4ac\PhpParser\Node\Expr\MethodCall
    {
    ...
    private function shouldSkip(string $key) : bool
    {
        ...
        if (\_PhpScoper0c0702cca4ac\Nette\Utils\Strings::startsWith($key, 'decoration_')) {
            return \true;
        }
        return $key === 'alias';
    }
