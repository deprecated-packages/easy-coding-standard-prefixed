...
use _PhpScoper167729fa1dde\PhpParser\Node\Expr\Assign;
...
use _PhpScoper167729fa1dde\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScoper167729fa1dde\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScoper167729fa1dde\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScoper167729fa1dde\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScoper167729fa1dde\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScoper167729fa1dde\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScoper167729fa1dde\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScoper167729fa1dde\PhpParser\Node\Stmt\Expression($assign);
    }
