...
use _PhpScoperaa402dd1b1f1\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScoperaa402dd1b1f1\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScoperaa402dd1b1f1\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScoperaa402dd1b1f1\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScoperaa402dd1b1f1\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScoperaa402dd1b1f1\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScoperaa402dd1b1f1\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScoperaa402dd1b1f1\PhpParser\Node\Stmt\Expression($assign);
    }
