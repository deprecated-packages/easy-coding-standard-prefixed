...
use _PhpScoperab9510cd5d97\PhpParser\Node\Expr\Assign;
...
use _PhpScoperab9510cd5d97\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScoperab9510cd5d97\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScoperab9510cd5d97\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScoperab9510cd5d97\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScoperab9510cd5d97\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScoperab9510cd5d97\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScoperab9510cd5d97\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScoperab9510cd5d97\PhpParser\Node\Stmt\Expression($assign);
    }
