...
use _PhpScoperac4e86be08e5\PhpParser\Node\Expr\Assign;
...
use _PhpScoperac4e86be08e5\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScoperac4e86be08e5\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScoperac4e86be08e5\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScoperac4e86be08e5\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt\Expression($assign);
    }
