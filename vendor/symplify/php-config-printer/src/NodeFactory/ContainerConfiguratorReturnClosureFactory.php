...
use _PhpScopera1a51450b61d\PhpParser\Node\Expr\Assign;
...
use _PhpScopera1a51450b61d\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScopera1a51450b61d\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScopera1a51450b61d\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScopera1a51450b61d\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScopera1a51450b61d\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScopera1a51450b61d\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScopera1a51450b61d\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScopera1a51450b61d\PhpParser\Node\Stmt\Expression($assign);
    }
