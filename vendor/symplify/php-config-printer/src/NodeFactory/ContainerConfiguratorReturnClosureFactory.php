...
use _PhpScoperdaf95aff095b\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScoperdaf95aff095b\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScoperdaf95aff095b\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScoperdaf95aff095b\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScoperdaf95aff095b\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScoperdaf95aff095b\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScoperdaf95aff095b\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScoperdaf95aff095b\PhpParser\Node\Stmt\Expression($assign);
    }
