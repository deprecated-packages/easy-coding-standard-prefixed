...
use _PhpScopercae980ebf12d\PhpParser\Node\Expr\Assign;
...
use _PhpScopercae980ebf12d\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScopercae980ebf12d\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScopercae980ebf12d\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScopercae980ebf12d\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScopercae980ebf12d\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScopercae980ebf12d\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScopercae980ebf12d\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScopercae980ebf12d\PhpParser\Node\Stmt\Expression($assign);
    }
