...
use _PhpScoperad68e34a80c5\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScoperad68e34a80c5\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScoperad68e34a80c5\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScoperad68e34a80c5\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScoperad68e34a80c5\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScoperad68e34a80c5\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScoperad68e34a80c5\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScoperad68e34a80c5\PhpParser\Node\Stmt\Expression($assign);
    }
