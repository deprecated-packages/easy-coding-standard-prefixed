...
use _PhpScoperdf15f2b748e9\PhpParser\Node\Expr\Assign;
...
use _PhpScoperdf15f2b748e9\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScoperdf15f2b748e9\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScoperdf15f2b748e9\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScoperdf15f2b748e9\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScoperdf15f2b748e9\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScoperdf15f2b748e9\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScoperdf15f2b748e9\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScoperdf15f2b748e9\PhpParser\Node\Stmt\Expression($assign);
    }
