...
use _PhpScopera88a8b9f064a\PhpParser\Node\Expr\Assign;
...
use _PhpScopera88a8b9f064a\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScopera88a8b9f064a\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScopera88a8b9f064a\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScopera88a8b9f064a\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScopera88a8b9f064a\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScopera88a8b9f064a\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScopera88a8b9f064a\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScopera88a8b9f064a\PhpParser\Node\Stmt\Expression($assign);
    }
