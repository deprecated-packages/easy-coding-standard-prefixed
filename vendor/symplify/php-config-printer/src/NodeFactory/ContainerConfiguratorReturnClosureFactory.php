...
use _PhpScoperd35c27cd4b09\PhpParser\Node\Stmt\Return_;
...
final class ContainerConfiguratorReturnClosureFactory
{
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScoperd35c27cd4b09\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->configuratorClosureNodeFactory->createContainerClosureFromStmts($stmts);
        return new \_PhpScoperd35c27cd4b09\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScoperd35c27cd4b09\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScoperd35c27cd4b09\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScoperd35c27cd4b09\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScoperd35c27cd4b09\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScoperd35c27cd4b09\PhpParser\Node\Stmt\Expression($assign);
    }
