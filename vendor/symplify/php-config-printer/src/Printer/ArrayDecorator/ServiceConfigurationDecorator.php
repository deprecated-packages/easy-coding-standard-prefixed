...
final class ServiceConfigurationDecorator
{
    ...
    private function decorateValueObject(object $value) : \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Expr\FuncCall
    {
        $new = $this->newValueObjectFactory->create($value);
        $args = [new \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Arg($new)];
    ...
    private function decorateValueObjects(array $values) : \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Expr\FuncCall
    {
        $arrayItems = [];
        foreach ($values as $value) {
            $new = $this->newValueObjectFactory->create($value);
            $arrayItems[] = new \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Expr\ArrayItem($new);
        }
        $array = new \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Expr\Array_($arrayItems);
        $args = [new \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Arg($array)];
