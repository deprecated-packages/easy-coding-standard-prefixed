...
final class CheckerServiceParametersShifter
{
    ...
    public function __construct()
    {
        ...
        $reflectionClass = new \ReflectionClass(\_PhpScoper578a67c80b2b\Symfony\Component\DependencyInjection\Loader\YamlFileLoader::class);
    ...
    private function processServices(array $services) : array
    {
        foreach ($services as $serviceName => $serviceDefinition) {
            ...
            if (\_PhpScoper578a67c80b2b\Nette\Utils\Strings::endsWith($serviceName, 'Fixer')) {
                $services = $this->processFixer($services, $serviceName, $serviceDefinition);
            }
            if (\_PhpScoper578a67c80b2b\Nette\Utils\Strings::endsWith($serviceName, 'Sniff')) {
    ...
    {
        return \_PhpScoper578a67c80b2b\Nette\Utils\Strings::endsWith($checker, 'Fixer') || \_PhpScoper578a67c80b2b\Nette\Utils\Strings::endsWith($checker, 'Sniff');
    }
    /**
     * @param mixed[] $services
    ...
    private function escapeValue($value)
    {
        ...
        return \_PhpScoper578a67c80b2b\Nette\Utils\Strings::replace($value, '#^@#', '@@');
    }
}
