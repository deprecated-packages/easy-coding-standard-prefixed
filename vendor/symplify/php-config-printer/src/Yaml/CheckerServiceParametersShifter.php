...
final class CheckerServiceParametersShifter
{
    ...
    public function __construct()
    {
        ...
        $reflectionClass = new \ReflectionClass(\_PhpScopercb217fd4e736\Symfony\Component\DependencyInjection\Loader\YamlFileLoader::class);
    ...
    private function processServices(array $services) : array
    {
        foreach ($services as $serviceName => $serviceDefinition) {
            ...
            if (\_PhpScopercb217fd4e736\Nette\Utils\Strings::endsWith($serviceName, 'Fixer')) {
                $services = $this->processFixer($services, $serviceName, $serviceDefinition);
            }
            if (\_PhpScopercb217fd4e736\Nette\Utils\Strings::endsWith($serviceName, 'Sniff')) {
    ...
    {
        return \_PhpScopercb217fd4e736\Nette\Utils\Strings::endsWith($checker, 'Fixer') || \_PhpScopercb217fd4e736\Nette\Utils\Strings::endsWith($checker, 'Sniff');
    }
    /**
     * @param mixed[] $services
    ...
    private function escapeValue($value)
    {
        ...
        return \_PhpScopercb217fd4e736\Nette\Utils\Strings::replace($value, '#^@#', '@@');
    }
}
