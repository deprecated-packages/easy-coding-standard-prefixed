...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper4d3fa30a680b\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper4d3fa30a680b\PhpParser\Node\Expr\MethodCall(new \_PhpScoper4d3fa30a680b\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScoper4d3fa30a680b\Nette\Utils\Strings::startsWith($values, '@');
    }
}
