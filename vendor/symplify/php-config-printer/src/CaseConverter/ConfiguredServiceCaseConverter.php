...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper5f6e904600e7\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper5f6e904600e7\PhpParser\Node\Expr\MethodCall(new \_PhpScoper5f6e904600e7\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \_PhpScoper5f6e904600e7\Nette\Utils\Strings::startsWith($values, '@');
    }
}
