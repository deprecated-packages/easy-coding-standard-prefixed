...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScopera3425146d487\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScopera3425146d487\PhpParser\Node\Expr\MethodCall(new \_PhpScopera3425146d487\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \_PhpScopera3425146d487\Nette\Utils\Strings::startsWith($values, '@');
    }
}
