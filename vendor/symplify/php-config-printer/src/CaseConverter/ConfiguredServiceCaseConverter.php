...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper0ba97041430d\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper0ba97041430d\PhpParser\Node\Expr\MethodCall(new \_PhpScoper0ba97041430d\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \_PhpScoper0ba97041430d\Nette\Utils\Strings::startsWith($values, '@');
    }
}
