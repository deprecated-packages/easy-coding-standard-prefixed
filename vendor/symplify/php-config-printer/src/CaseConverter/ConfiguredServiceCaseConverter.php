...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper0c0702cca4ac\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper0c0702cca4ac\PhpParser\Node\Expr\MethodCall(new \_PhpScoper0c0702cca4ac\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \_PhpScoper0c0702cca4ac\Nette\Utils\Strings::startsWith($values, '@');
    }
}
