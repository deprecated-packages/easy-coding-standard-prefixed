...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperfaaf57618f34\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoperfaaf57618f34\PhpParser\Node\Expr\MethodCall(new \_PhpScoperfaaf57618f34\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScoperfaaf57618f34\Nette\Utils\Strings::startsWith($values, '@');
    }
}
