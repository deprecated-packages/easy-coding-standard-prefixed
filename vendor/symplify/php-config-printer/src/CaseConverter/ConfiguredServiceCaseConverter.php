...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScopera04bf8e97c06\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScopera04bf8e97c06\PhpParser\Node\Expr\MethodCall(new \_PhpScopera04bf8e97c06\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScopera04bf8e97c06\Nette\Utils\Strings::startsWith($values, '@');
    }
}
