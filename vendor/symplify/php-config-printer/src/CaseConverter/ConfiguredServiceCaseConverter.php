...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperd9fcac9e904f\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoperd9fcac9e904f\PhpParser\Node\Expr\MethodCall(new \_PhpScoperd9fcac9e904f\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScoperd9fcac9e904f\Nette\Utils\Strings::startsWith($values, '@');
    }
}
