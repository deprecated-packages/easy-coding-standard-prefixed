...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScopera6f918786d5c\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScopera6f918786d5c\PhpParser\Node\Expr\MethodCall(new \_PhpScopera6f918786d5c\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScopera6f918786d5c\Nette\Utils\Strings::startsWith($values, '@');
    }
}
