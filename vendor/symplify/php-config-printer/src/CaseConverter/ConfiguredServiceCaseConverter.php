...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper06c5fb6c14ed\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper06c5fb6c14ed\PhpParser\Node\Expr\MethodCall(new \_PhpScoper06c5fb6c14ed\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \_PhpScoper06c5fb6c14ed\Nette\Utils\Strings::startsWith($values, '@');
    }
}
