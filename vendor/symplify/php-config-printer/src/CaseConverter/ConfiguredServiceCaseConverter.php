...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper14cb6de5473d\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper14cb6de5473d\PhpParser\Node\Expr\MethodCall(new \_PhpScoper14cb6de5473d\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScoper14cb6de5473d\Nette\Utils\Strings::startsWith($values, '@');
    }
}
