...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper89c09b8e7101\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper89c09b8e7101\PhpParser\Node\Expr\MethodCall(new \_PhpScoper89c09b8e7101\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \_PhpScoper89c09b8e7101\Nette\Utils\Strings::startsWith($values, '@');
    }
}
