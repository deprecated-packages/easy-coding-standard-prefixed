...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperad68e34a80c5\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoperad68e34a80c5\PhpParser\Node\Expr\MethodCall(new \_PhpScoperad68e34a80c5\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScoperad68e34a80c5\Nette\Utils\Strings::startsWith($values, '@');
    }
}
