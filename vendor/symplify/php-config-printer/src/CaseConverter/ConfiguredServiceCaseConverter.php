...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper5465fda93cc7\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper5465fda93cc7\PhpParser\Node\Expr\MethodCall(new \_PhpScoper5465fda93cc7\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScoper5465fda93cc7\Nette\Utils\Strings::startsWith($values, '@');
    }
}
