...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper269dc521b0fa\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper269dc521b0fa\PhpParser\Node\Expr\MethodCall(new \_PhpScoper269dc521b0fa\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScoper269dc521b0fa\Nette\Utils\Strings::startsWith($values, '@');
    }
}
