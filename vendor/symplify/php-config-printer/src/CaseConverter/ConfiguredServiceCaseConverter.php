...
final class ConfiguredServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperd3d57724c802\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoperd3d57724c802\PhpParser\Node\Expr\MethodCall(new \_PhpScoperd3d57724c802\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
    ...
    private function isAlias($values) : bool
    {
        ...
        return \is_string($values) && \_PhpScoperd3d57724c802\Nette\Utils\Strings::startsWith($values, '@');
    }
}
