...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper47644ab3aa9a\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper47644ab3aa9a\PhpParser\Node\Expr\MethodCall(new \_PhpScoper47644ab3aa9a\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
