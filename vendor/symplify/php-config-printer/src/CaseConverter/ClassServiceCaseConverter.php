...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper68a3a2539032\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper68a3a2539032\PhpParser\Node\Expr\MethodCall(new \_PhpScoper68a3a2539032\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
