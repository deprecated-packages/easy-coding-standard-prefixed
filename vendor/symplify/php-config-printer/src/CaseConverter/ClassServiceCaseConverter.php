...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper745103eaabcd\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper745103eaabcd\PhpParser\Node\Expr\MethodCall(new \_PhpScoper745103eaabcd\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
