...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper776637f3d3c3\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper776637f3d3c3\PhpParser\Node\Expr\MethodCall(new \_PhpScoper776637f3d3c3\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
