...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper5ea36b274140\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper5ea36b274140\PhpParser\Node\Expr\MethodCall(new \_PhpScoper5ea36b274140\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
