...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper971ef29294dd\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper971ef29294dd\PhpParser\Node\Expr\MethodCall(new \_PhpScoper971ef29294dd\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
