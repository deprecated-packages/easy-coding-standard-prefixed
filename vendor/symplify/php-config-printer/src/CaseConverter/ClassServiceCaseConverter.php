...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperf361a7d70552\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoperf361a7d70552\PhpParser\Node\Expr\MethodCall(new \_PhpScoperf361a7d70552\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
