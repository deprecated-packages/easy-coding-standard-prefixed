...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper4e2df00556a9\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper4e2df00556a9\PhpParser\Node\Expr\MethodCall(new \_PhpScoper4e2df00556a9\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
