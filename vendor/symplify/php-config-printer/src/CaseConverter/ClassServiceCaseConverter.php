...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperd35c27cd4b09\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoperd35c27cd4b09\PhpParser\Node\Expr\MethodCall(new \_PhpScoperd35c27cd4b09\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
