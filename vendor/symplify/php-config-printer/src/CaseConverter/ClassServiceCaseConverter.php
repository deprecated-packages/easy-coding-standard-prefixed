...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper528afa732cbd\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper528afa732cbd\PhpParser\Node\Expr\MethodCall(new \_PhpScoper528afa732cbd\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
