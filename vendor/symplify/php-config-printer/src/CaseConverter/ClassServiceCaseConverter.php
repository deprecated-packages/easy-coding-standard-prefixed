...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper7b8580219c59\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper7b8580219c59\PhpParser\Node\Expr\MethodCall(new \_PhpScoper7b8580219c59\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
