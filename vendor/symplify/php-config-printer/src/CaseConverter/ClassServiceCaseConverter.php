...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper6a1dd9b8a650\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper6a1dd9b8a650\PhpParser\Node\Expr\MethodCall(new \_PhpScoper6a1dd9b8a650\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
