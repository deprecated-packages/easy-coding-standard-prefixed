...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper10b1b2c5ca55\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper10b1b2c5ca55\PhpParser\Node\Expr\MethodCall(new \_PhpScoper10b1b2c5ca55\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
