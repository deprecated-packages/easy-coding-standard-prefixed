...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScopera1a51450b61d\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScopera1a51450b61d\PhpParser\Node\Expr\MethodCall(new \_PhpScopera1a51450b61d\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
