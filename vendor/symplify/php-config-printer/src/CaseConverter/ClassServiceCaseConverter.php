...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperc4ea0f0bd23f\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoperc4ea0f0bd23f\PhpParser\Node\Expr\MethodCall(new \_PhpScoperc4ea0f0bd23f\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
