...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper3f3a54dd086f\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper3f3a54dd086f\PhpParser\Node\Expr\MethodCall(new \_PhpScoper3f3a54dd086f\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
