...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper21fff473f90a\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper21fff473f90a\PhpParser\Node\Expr\MethodCall(new \_PhpScoper21fff473f90a\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
