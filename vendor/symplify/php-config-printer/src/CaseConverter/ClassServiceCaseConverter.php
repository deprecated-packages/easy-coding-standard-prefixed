...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper7108c819f5c5\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper7108c819f5c5\PhpParser\Node\Expr\MethodCall(new \_PhpScoper7108c819f5c5\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
