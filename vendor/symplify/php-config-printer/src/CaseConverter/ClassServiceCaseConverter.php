...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperab9510cd5d97\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoperab9510cd5d97\PhpParser\Node\Expr\MethodCall(new \_PhpScoperab9510cd5d97\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
