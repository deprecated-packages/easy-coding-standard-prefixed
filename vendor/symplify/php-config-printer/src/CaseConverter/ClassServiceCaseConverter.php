...
final class ClassServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper2d2a405cc0f8\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper2d2a405cc0f8\PhpParser\Node\Expr\MethodCall(new \_PhpScoper2d2a405cc0f8\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
