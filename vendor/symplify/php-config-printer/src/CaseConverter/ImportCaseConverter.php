...
use _PhpScoper6625323d9c29\PhpParser\Node\Scalar\String_;
...
final class ImportCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
     ...
     */
    private function createImportMethodCall(array $arguments) : \_PhpScoper6625323d9c29\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper6625323d9c29\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, 'import', $args);
    ...
    private function replaceImportedFileSuffix($value)
    {
        ...
        return \_PhpScoper6625323d9c29\Nette\Utils\Strings::replace($value, self::INPUT_SUFFIX_REGEX, '.php');
    }
    private function resolveExpr($value) : \_PhpScoper6625323d9c29\PhpParser\Node\Expr
    {
        if (\is_bool($value)) {
        ...
        if ($value === 'not_found') {
            return new \_PhpScoper6625323d9c29\PhpParser\Node\Scalar\String_('not_found');
        }
