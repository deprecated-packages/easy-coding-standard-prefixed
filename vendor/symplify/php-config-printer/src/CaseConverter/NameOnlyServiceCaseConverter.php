...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper3b1d73f28e67\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper3b1d73f28e67\PhpParser\Node\Expr\MethodCall(new \_PhpScoper3b1d73f28e67\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper3b1d73f28e67\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper3b1d73f28e67\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
