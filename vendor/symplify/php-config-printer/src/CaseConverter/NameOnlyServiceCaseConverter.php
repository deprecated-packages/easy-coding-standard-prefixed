...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper9ef667a5e42c\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper9ef667a5e42c\PhpParser\Node\Expr\MethodCall(new \_PhpScoper9ef667a5e42c\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper9ef667a5e42c\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper9ef667a5e42c\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
