...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper08748c77fa1c\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper08748c77fa1c\PhpParser\Node\Expr\MethodCall(new \_PhpScoper08748c77fa1c\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper08748c77fa1c\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper08748c77fa1c\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
