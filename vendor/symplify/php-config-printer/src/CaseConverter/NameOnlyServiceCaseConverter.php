...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper06c5fb6c14ed\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper06c5fb6c14ed\PhpParser\Node\Expr\MethodCall(new \_PhpScoper06c5fb6c14ed\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper06c5fb6c14ed\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper06c5fb6c14ed\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
