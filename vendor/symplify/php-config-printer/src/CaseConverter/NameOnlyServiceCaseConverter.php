...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper065e4ba46e6d\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper065e4ba46e6d\PhpParser\Node\Expr\MethodCall(new \_PhpScoper065e4ba46e6d\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper065e4ba46e6d\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper065e4ba46e6d\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
