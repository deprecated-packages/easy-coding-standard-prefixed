...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperf3dc21757def\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoperf3dc21757def\PhpParser\Node\Expr\MethodCall(new \_PhpScoperf3dc21757def\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoperf3dc21757def\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoperf3dc21757def\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
