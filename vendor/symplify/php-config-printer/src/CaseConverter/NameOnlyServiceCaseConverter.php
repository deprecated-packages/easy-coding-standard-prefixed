...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper56c9df53a081\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper56c9df53a081\PhpParser\Node\Expr\MethodCall(new \_PhpScoper56c9df53a081\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper56c9df53a081\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper56c9df53a081\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
