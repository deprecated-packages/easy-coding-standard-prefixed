...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper64e7ad844899\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper64e7ad844899\PhpParser\Node\Expr\MethodCall(new \_PhpScoper64e7ad844899\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper64e7ad844899\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper64e7ad844899\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
