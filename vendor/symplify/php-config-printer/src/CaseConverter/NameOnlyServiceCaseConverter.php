...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper64ca614e27fd\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper64ca614e27fd\PhpParser\Node\Expr\MethodCall(new \_PhpScoper64ca614e27fd\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper64ca614e27fd\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper64ca614e27fd\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
