...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper3f3a54dd086f\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper3f3a54dd086f\PhpParser\Node\Expr\MethodCall(new \_PhpScoper3f3a54dd086f\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper3f3a54dd086f\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper3f3a54dd086f\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
