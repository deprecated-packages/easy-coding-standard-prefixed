...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperb458b528613f\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoperb458b528613f\PhpParser\Node\Expr\MethodCall(new \_PhpScoperb458b528613f\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoperb458b528613f\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoperb458b528613f\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
