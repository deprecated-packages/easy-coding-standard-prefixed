...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoperac4e86be08e5\PhpParser\Node\Expr\MethodCall(new \_PhpScoperac4e86be08e5\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoperac4e86be08e5\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
