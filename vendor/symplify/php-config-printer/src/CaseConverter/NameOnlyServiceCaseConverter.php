...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper992f4af8b9e0\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper992f4af8b9e0\PhpParser\Node\Expr\MethodCall(new \_PhpScoper992f4af8b9e0\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper992f4af8b9e0\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper992f4af8b9e0\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
