...
final class NameOnlyServiceCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper14cb6de5473d\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper14cb6de5473d\PhpParser\Node\Expr\MethodCall(new \_PhpScoper14cb6de5473d\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper14cb6de5473d\PhpParser\Node\Arg($classConstFetch)]);
        return new \_PhpScoper14cb6de5473d\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
