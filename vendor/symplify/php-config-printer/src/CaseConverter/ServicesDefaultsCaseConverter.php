...
final class ServicesDefaultsCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    {
        $methodCall = new \_PhpScoperdeea1786e972\PhpParser\Node\Expr\MethodCall($this->createServicesVariable(), \Symplify\PhpConfigPrinter\ValueObject\MethodName::DEFAULTS);
    ...
    private function createServicesVariable() : \_PhpScoperdeea1786e972\PhpParser\Node\Expr\Variable
    {
        return new \_PhpScoperdeea1786e972\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES);
    }
}
