...
final class ServicesDefaultsCaseConverter implements \Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    ...
    {
        $methodCall = new \_PhpScoper31ba553edf97\PhpParser\Node\Expr\MethodCall($this->createServicesVariable(), \Symplify\PhpConfigPrinter\ValueObject\MethodName::DEFAULTS);
    ...
    private function createServicesVariable() : \_PhpScoper31ba553edf97\PhpParser\Node\Expr\Variable
    {
        return new \_PhpScoper31ba553edf97\PhpParser\Node\Expr\Variable(\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES);
    }
}
