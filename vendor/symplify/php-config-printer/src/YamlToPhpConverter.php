...
final class YamlToPhpConverter
{
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \_PhpScoper04022cd986ec\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \_PhpScoper04022cd986ec\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
