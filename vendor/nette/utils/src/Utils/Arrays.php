...
class Arrays
{
    ...
    {
        return \_PhpScoperc2b2a9bb0e13\Nette\Utils\Helpers::falseToNull(\array_search(self::toKey($key), \array_keys($array), \true));
    }
    /**
    ...
    {
        return \_PhpScoperc2b2a9bb0e13\Nette\Utils\Strings::pcre('preg_grep', [$pattern, $array, $flags]);
    }
    /**
