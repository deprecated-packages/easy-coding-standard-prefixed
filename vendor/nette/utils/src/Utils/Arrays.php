...
class Arrays
{
    ...
    {
        return \_PhpScoper4fedb9aa1e5f\Nette\Utils\Helpers::falseToNull(\array_search(self::toKey($key), \array_keys($array), \true));
    }
    /**
    ...
    {
        return \_PhpScoper4fedb9aa1e5f\Nette\Utils\Strings::pcre('preg_grep', [$pattern, $array, $flags]);
    }
    /**
