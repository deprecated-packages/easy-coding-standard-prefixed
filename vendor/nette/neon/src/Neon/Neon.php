...
final class Neon
{
    public const BLOCK = \_PhpScopere7e518ee6a5b\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \_PhpScopere7e518ee6a5b\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \_PhpScopere7e518ee6a5b\Nette\Neon\Decoder();
