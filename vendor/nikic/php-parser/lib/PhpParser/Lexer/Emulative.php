...
namespace _PhpScoper21763e6c7ac4\PhpParser\Lexer;

use _PhpScoper21763e6c7ac4\PhpParser\Error;
use _PhpScoper21763e6c7ac4\PhpParser\ErrorHandler;
use _PhpScoper21763e6c7ac4\PhpParser\Lexer;
use _PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use _PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use _PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use _PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use _PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use _PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\TokenEmulatorInterface;
use _PhpScoper21763e6c7ac4\PhpParser\Parser\Tokens;
class Emulative extends \_PhpScoper21763e6c7ac4\PhpParser\Lexer
{
...
REGEX;
    ...
    {
        $this->targetPhpVersion = $options['phpVersion'] ?? \_PhpScoper21763e6c7ac4\PhpParser\Lexer\Emulative::PHP_8_0;
        unset($options['phpVersion']);
        parent::__construct($options);
        $this->tokenEmulators[] = new \_PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\FnTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator();
        $this->tokenEmulators[] = new \_PhpScoper21763e6c7ac4\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator();
    }
    public function startLexing(string $code, \_PhpScoper21763e6c7ac4\PhpParser\ErrorHandler $errorHandler = null)
    {
        $this->patches = [];
        ...
        $collector = new \_PhpScoper21763e6c7ac4\PhpParser\ErrorHandler\Collecting();
