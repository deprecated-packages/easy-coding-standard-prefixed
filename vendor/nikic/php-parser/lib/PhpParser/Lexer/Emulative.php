...
namespace _PhpScoper0270f1d35181\PhpParser\Lexer;

use _PhpScoper0270f1d35181\PhpParser\Error;
use _PhpScoper0270f1d35181\PhpParser\ErrorHandler;
use _PhpScoper0270f1d35181\PhpParser\Lexer;
use _PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use _PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use _PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use _PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use _PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use _PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\TokenEmulatorInterface;
use _PhpScoper0270f1d35181\PhpParser\Parser\Tokens;
class Emulative extends \_PhpScoper0270f1d35181\PhpParser\Lexer
{
...
REGEX;
    ...
    {
        $this->targetPhpVersion = $options['phpVersion'] ?? \_PhpScoper0270f1d35181\PhpParser\Lexer\Emulative::PHP_8_0;
        unset($options['phpVersion']);
        parent::__construct($options);
        $this->tokenEmulators[] = new \_PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\FnTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator();
        $this->tokenEmulators[] = new \_PhpScoper0270f1d35181\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator();
    }
    public function startLexing(string $code, \_PhpScoper0270f1d35181\PhpParser\ErrorHandler $errorHandler = null)
    {
        $this->patches = [];
        ...
        $collector = new \_PhpScoper0270f1d35181\PhpParser\ErrorHandler\Collecting();
