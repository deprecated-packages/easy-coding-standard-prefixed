...
namespace _PhpScoper70072c07b02b\PhpParser\Lexer;

use _PhpScoper70072c07b02b\PhpParser\Error;
use _PhpScoper70072c07b02b\PhpParser\ErrorHandler;
use _PhpScoper70072c07b02b\PhpParser\Lexer;
use _PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use _PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use _PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use _PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use _PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use _PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\TokenEmulatorInterface;
use _PhpScoper70072c07b02b\PhpParser\Parser\Tokens;
class Emulative extends \_PhpScoper70072c07b02b\PhpParser\Lexer
{
...
REGEX;
    ...
    {
        $this->targetPhpVersion = $options['phpVersion'] ?? \_PhpScoper70072c07b02b\PhpParser\Lexer\Emulative::PHP_8_0;
        unset($options['phpVersion']);
        parent::__construct($options);
        $this->tokenEmulators[] = new \_PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\FnTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator();
        $this->tokenEmulators[] = new \_PhpScoper70072c07b02b\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator();
    }
    public function startLexing(string $code, \_PhpScoper70072c07b02b\PhpParser\ErrorHandler $errorHandler = null)
    {
        $this->patches = [];
        ...
        $collector = new \_PhpScoper70072c07b02b\PhpParser\ErrorHandler\Collecting();
