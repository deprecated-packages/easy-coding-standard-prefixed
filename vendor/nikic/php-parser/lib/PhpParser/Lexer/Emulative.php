...
namespace _PhpScoper6207116d4311\PhpParser\Lexer;

use _PhpScoper6207116d4311\PhpParser\Error;
use _PhpScoper6207116d4311\PhpParser\ErrorHandler;
use _PhpScoper6207116d4311\PhpParser\Lexer;
use _PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use _PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use _PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use _PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use _PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use _PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\TokenEmulatorInterface;
use _PhpScoper6207116d4311\PhpParser\Parser\Tokens;
class Emulative extends \_PhpScoper6207116d4311\PhpParser\Lexer
{
...
REGEX;
    ...
    {
        $this->targetPhpVersion = $options['phpVersion'] ?? \_PhpScoper6207116d4311\PhpParser\Lexer\Emulative::PHP_8_0;
        unset($options['phpVersion']);
        parent::__construct($options);
        $this->tokenEmulators[] = new \_PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\FnTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator();
        $this->tokenEmulators[] = new \_PhpScoper6207116d4311\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator();
    }
    public function startLexing(string $code, \_PhpScoper6207116d4311\PhpParser\ErrorHandler $errorHandler = null)
    {
        $this->patches = [];
        ...
        $collector = new \_PhpScoper6207116d4311\PhpParser\ErrorHandler\Collecting();
