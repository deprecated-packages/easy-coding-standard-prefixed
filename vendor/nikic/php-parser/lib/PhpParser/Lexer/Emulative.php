...
namespace _PhpScopera4be459e5e3d\PhpParser\Lexer;

use _PhpScopera4be459e5e3d\PhpParser\Error;
use _PhpScopera4be459e5e3d\PhpParser\ErrorHandler;
use _PhpScopera4be459e5e3d\PhpParser\Lexer;
use _PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use _PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use _PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use _PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use _PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use _PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\TokenEmulatorInterface;
use _PhpScopera4be459e5e3d\PhpParser\Parser\Tokens;
class Emulative extends \_PhpScopera4be459e5e3d\PhpParser\Lexer
{
...
REGEX;
    ...
    {
        $this->targetPhpVersion = $options['phpVersion'] ?? \_PhpScopera4be459e5e3d\PhpParser\Lexer\Emulative::PHP_8_0;
        unset($options['phpVersion']);
        parent::__construct($options);
        $this->tokenEmulators[] = new \_PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\FnTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator();
        $this->tokenEmulators[] = new \_PhpScopera4be459e5e3d\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator();
    }
    public function startLexing(string $code, \_PhpScopera4be459e5e3d\PhpParser\ErrorHandler $errorHandler = null)
    {
        $this->patches = [];
        ...
        $collector = new \_PhpScopera4be459e5e3d\PhpParser\ErrorHandler\Collecting();
