...
namespace _PhpScoper279cf54b77ad\PhpParser\Lexer;

use _PhpScoper279cf54b77ad\PhpParser\Error;
use _PhpScoper279cf54b77ad\PhpParser\ErrorHandler;
use _PhpScoper279cf54b77ad\PhpParser\Lexer;
use _PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use _PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use _PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use _PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use _PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use _PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\TokenEmulatorInterface;
use _PhpScoper279cf54b77ad\PhpParser\Parser\Tokens;
class Emulative extends \_PhpScoper279cf54b77ad\PhpParser\Lexer
{
...
REGEX;
    ...
    {
        $this->targetPhpVersion = $options['phpVersion'] ?? \_PhpScoper279cf54b77ad\PhpParser\Lexer\Emulative::PHP_8_0;
        unset($options['phpVersion']);
        parent::__construct($options);
        $this->tokenEmulators[] = new \_PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\FnTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator();
        $this->tokenEmulators[] = new \_PhpScoper279cf54b77ad\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator();
    }
    public function startLexing(string $code, \_PhpScoper279cf54b77ad\PhpParser\ErrorHandler $errorHandler = null)
    {
        $this->patches = [];
        ...
        $collector = new \_PhpScoper279cf54b77ad\PhpParser\ErrorHandler\Collecting();
