...
namespace _PhpScoperad4b7e2c09d8\PhpParser\Lexer;

use _PhpScoperad4b7e2c09d8\PhpParser\Error;
use _PhpScoperad4b7e2c09d8\PhpParser\ErrorHandler;
use _PhpScoperad4b7e2c09d8\PhpParser\Lexer;
use _PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use _PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use _PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use _PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use _PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use _PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\TokenEmulatorInterface;
use _PhpScoperad4b7e2c09d8\PhpParser\Parser\Tokens;
class Emulative extends \_PhpScoperad4b7e2c09d8\PhpParser\Lexer
{
...
REGEX;
    ...
    {
        $this->targetPhpVersion = $options['phpVersion'] ?? \_PhpScoperad4b7e2c09d8\PhpParser\Lexer\Emulative::PHP_8_0;
        unset($options['phpVersion']);
        parent::__construct($options);
        $this->tokenEmulators[] = new \_PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\FnTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator();
        $this->tokenEmulators[] = new \_PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator();
        $this->tokenEmulators[] = new \_PhpScoperad4b7e2c09d8\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator();
    }
    public function startLexing(string $code, \_PhpScoperad4b7e2c09d8\PhpParser\ErrorHandler $errorHandler = null)
    {
        $this->patches = [];
        ...
        $collector = new \_PhpScoperad4b7e2c09d8\PhpParser\ErrorHandler\Collecting();
