 ...
 * a filter callback.
 */
class FirstFindingVisitor extends \_PhpScoper544eb478a6f6\PhpParser\NodeVisitorAbstract
{
    ...
    public function enterNode(\_PhpScoper544eb478a6f6\PhpParser\Node $node)
    {
        ...
        if ($filterCallback($node)) {
            $this->foundNode = $node;
            return \_PhpScoper544eb478a6f6\PhpParser\NodeTraverser::STOP_TRAVERSAL;
        }
        return null;
    }
}
