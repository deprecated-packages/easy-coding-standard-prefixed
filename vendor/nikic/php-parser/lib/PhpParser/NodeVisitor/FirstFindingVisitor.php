 ...
 * a filter callback.
 */
class FirstFindingVisitor extends \_PhpScoper58a0a169dcfb\PhpParser\NodeVisitorAbstract
{
    ...
    public function enterNode(\_PhpScoper58a0a169dcfb\PhpParser\Node $node)
    {
        ...
        if ($filterCallback($node)) {
            $this->foundNode = $node;
            return \_PhpScoper58a0a169dcfb\PhpParser\NodeTraverser::STOP_TRAVERSAL;
        }
        return null;
    }
}
