...
class Namespace_ extends \_PhpScoper32136251d417\PhpParser\Builder\Declaration
{
    private $name;
    private $stmts = [];
    /**
    ...
    {
        return new \_PhpScoper32136251d417\PhpParser\Node\Stmt\Namespace_($this->name, $this->stmts, $this->attributes);
    }
}
