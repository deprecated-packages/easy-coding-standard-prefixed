...
class Use_ implements \_PhpScoperdeea1786e972\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \_PhpScoperdeea1786e972\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \_PhpScoperdeea1786e972\PhpParser\Node\Stmt\Use_([new \_PhpScoperdeea1786e972\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
