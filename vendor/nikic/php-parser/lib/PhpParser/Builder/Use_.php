...
class Use_ implements \_PhpScoper81b3ff5ab9fe\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \_PhpScoper81b3ff5ab9fe\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \_PhpScoper81b3ff5ab9fe\PhpParser\Node\Stmt\Use_([new \_PhpScoper81b3ff5ab9fe\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
