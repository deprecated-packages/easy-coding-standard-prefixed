...
class Use_ implements \_PhpScoper5928e324b45e\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \_PhpScoper5928e324b45e\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \_PhpScoper5928e324b45e\PhpParser\Node\Stmt\Use_([new \_PhpScoper5928e324b45e\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
