...
class Use_ implements \_PhpScoperac4e86be08e5\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \_PhpScoperac4e86be08e5\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt\Use_([new \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
