...
class Use_ implements \_PhpScoperaad82bb90a86\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \_PhpScoperaad82bb90a86\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \_PhpScoperaad82bb90a86\PhpParser\Node\Stmt\Use_([new \_PhpScoperaad82bb90a86\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
