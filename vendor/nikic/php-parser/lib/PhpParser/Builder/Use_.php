...
class Use_ implements \_PhpScoper167729fa1dde\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \_PhpScoper167729fa1dde\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \_PhpScoper167729fa1dde\PhpParser\Node\Stmt\Use_([new \_PhpScoper167729fa1dde\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
