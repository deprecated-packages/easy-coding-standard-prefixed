...
class Use_ implements \_PhpScoper4d05106cc3c0\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \_PhpScoper4d05106cc3c0\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \_PhpScoper4d05106cc3c0\PhpParser\Node\Stmt\Use_([new \_PhpScoper4d05106cc3c0\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
