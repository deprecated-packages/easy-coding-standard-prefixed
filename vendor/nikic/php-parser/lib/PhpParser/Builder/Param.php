...
class Param implements \_PhpScoper23ef26a4fb01\PhpParser\Builder
{
    protected $name;
    ...
    {
        return new \_PhpScoper23ef26a4fb01\PhpParser\Node\Param(new \_PhpScoper23ef26a4fb01\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic);
    }
}
