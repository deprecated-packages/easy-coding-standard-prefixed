...
class Param implements \_PhpScoperdf15f2b748e9\PhpParser\Builder
{
    protected $name;
    ...
    {
        return new \_PhpScoperdf15f2b748e9\PhpParser\Node\Param(new \_PhpScoperdf15f2b748e9\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic);
    }
}
