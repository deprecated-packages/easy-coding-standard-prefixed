...
class Property implements \_PhpScoperb09c3ec8e01a\PhpParser\Builder
{
    protected $name;
    protected $flags = 0;
    ...
    {
        $this->default = \_PhpScoperb09c3ec8e01a\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        $this->type = \_PhpScoperb09c3ec8e01a\PhpParser\BuilderHelpers::normalizeType($type);
        return $this;
    }
    /**
    ...
    {
        return new \_PhpScoperb09c3ec8e01a\PhpParser\Node\Stmt\Property($this->flags !== 0 ? $this->flags : \_PhpScoperb09c3ec8e01a\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC, [new \_PhpScoperb09c3ec8e01a\PhpParser\Node\Stmt\PropertyProperty($this->name, $this->default)], $this->attributes, $this->type);
    }
}
