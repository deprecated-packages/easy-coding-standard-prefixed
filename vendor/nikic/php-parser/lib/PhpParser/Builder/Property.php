...
class Property implements \_PhpScoper3e1e0e5bb8ef\PhpParser\Builder
{
    protected $name;
    protected $flags = 0;
    ...
    {
        $this->default = \_PhpScoper3e1e0e5bb8ef\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        $this->attributes = ['comments' => [\_PhpScoper3e1e0e5bb8ef\PhpParser\BuilderHelpers::normalizeDocComment($docComment)]];
        return $this;
    }
    /**
    ...
    {
        $this->type = \_PhpScoper3e1e0e5bb8ef\PhpParser\BuilderHelpers::normalizeType($type);
        return $this;
    }
    /**
    ...
    {
        return new \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Stmt\Property($this->flags !== 0 ? $this->flags : \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC, [new \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Stmt\PropertyProperty($this->name, $this->default)], $this->attributes, $this->type);
    }
}
