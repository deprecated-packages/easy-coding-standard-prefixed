...
use _PhpScopera34ae19e8d40\PhpParser\NodeVisitor\FindingVisitor;
use _PhpScopera34ae19e8d40\PhpParser\NodeVisitor\FirstFindingVisitor;
class NodeFinder
{
    /**
    ...
    public function find($nodes, callable $filter) : array
    {
        ...
        $visitor = new \_PhpScopera34ae19e8d40\PhpParser\NodeVisitor\FindingVisitor($filter);
    ...
    public function findFirst($nodes, callable $filter)
    {
        ...
        $visitor = new \_PhpScopera34ae19e8d40\PhpParser\NodeVisitor\FirstFindingVisitor($filter);
        $traverser = new \_PhpScopera34ae19e8d40\PhpParser\NodeTraverser();
        $traverser->addVisitor($visitor);
        $traverser->traverse($nodes);
