 ...
 */
class Const_ extends \_PhpScoper224ae0b86670\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper224ae0b86670\PhpParser\Node\Expr $value, array $attributes = [])
    {
