 ...
 */
class Const_ extends \_PhpScoperd675aaf00c76\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperd675aaf00c76\PhpParser\Node\Expr $value, array $attributes = [])
    {
