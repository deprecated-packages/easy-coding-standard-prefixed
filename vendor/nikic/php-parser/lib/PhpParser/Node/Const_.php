 ...
 */
class Const_ extends \_PhpScoper89c09b8e7101\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper89c09b8e7101\PhpParser\Node\Expr $value, array $attributes = [])
    {
