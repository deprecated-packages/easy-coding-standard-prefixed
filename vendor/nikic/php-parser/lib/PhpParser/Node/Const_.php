 ...
 */
class Const_ extends \_PhpScoperd35c27cd4b09\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperd35c27cd4b09\PhpParser\Node\Expr $value, array $attributes = [])
    {
