 ...
 */
class Const_ extends \_PhpScoper1e80a2e03314\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper1e80a2e03314\PhpParser\Node\Expr $value, array $attributes = [])
    {
