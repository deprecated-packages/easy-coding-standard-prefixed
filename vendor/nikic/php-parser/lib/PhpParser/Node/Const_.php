 ...
 */
class Const_ extends \_PhpScoper4a718ec9156e\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper4a718ec9156e\PhpParser\Node\Expr $value, array $attributes = [])
    {
