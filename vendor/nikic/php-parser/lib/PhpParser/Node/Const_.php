 ...
 */
class Const_ extends \_PhpScoperbcc0395698f8\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperbcc0395698f8\PhpParser\Node\Expr $value, array $attributes = [])
    {
