 ...
 */
class Const_ extends \_PhpScoperaba240c3d5f1\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperaba240c3d5f1\PhpParser\Node\Expr $value, array $attributes = [])
    {
