 ...
 */
class Const_ extends \_PhpScoper3e1e0e5bb8ef\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Expr $value, array $attributes = [])
    {
