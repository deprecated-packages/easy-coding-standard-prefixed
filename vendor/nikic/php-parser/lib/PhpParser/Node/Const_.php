 ...
 */
class Const_ extends \_PhpScoperda2604e33acb\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperda2604e33acb\PhpParser\Node\Expr $value, array $attributes = [])
    {
