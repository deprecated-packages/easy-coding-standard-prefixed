 ...
 */
class Const_ extends \_PhpScoper4d3fa30a680b\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper4d3fa30a680b\PhpParser\Node\Expr $value, array $attributes = [])
    {
