 ...
 */
class Const_ extends \_PhpScoper418afc2f157c\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper418afc2f157c\PhpParser\Node\Expr $value, array $attributes = [])
    {
