 ...
 */
class Const_ extends \_PhpScopercae980ebf12d\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScopercae980ebf12d\PhpParser\Node\Expr $value, array $attributes = [])
    {
