 ...
 */
class Const_ extends \_PhpScoper13160cf3462c\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper13160cf3462c\PhpParser\Node\Expr $value, array $attributes = [])
    {
