 ...
 */
class Const_ extends \_PhpScoperfcee700af3df\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperfcee700af3df\PhpParser\Node\Expr $value, array $attributes = [])
    {
