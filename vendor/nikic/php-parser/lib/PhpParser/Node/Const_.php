 ...
 */
class Const_ extends \_PhpScopere205696a9dd6\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScopere205696a9dd6\PhpParser\Node\Expr $value, array $attributes = [])
    {
