 ...
 */
class Const_ extends \_PhpScoperbaf90856897c\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperbaf90856897c\PhpParser\Node\Expr $value, array $attributes = [])
    {
