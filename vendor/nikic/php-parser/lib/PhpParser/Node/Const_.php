 ...
 */
class Const_ extends \_PhpScoper3b1d73f28e67\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper3b1d73f28e67\PhpParser\Node\Expr $value, array $attributes = [])
    {
