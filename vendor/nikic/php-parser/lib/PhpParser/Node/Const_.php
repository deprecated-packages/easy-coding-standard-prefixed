 ...
 */
class Const_ extends \_PhpScoper21fff473f90a\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper21fff473f90a\PhpParser\Node\Expr $value, array $attributes = [])
    {
