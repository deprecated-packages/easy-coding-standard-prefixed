 ...
 */
class Const_ extends \_PhpScopera23ebff5477f\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScopera23ebff5477f\PhpParser\Node\Expr $value, array $attributes = [])
    {
