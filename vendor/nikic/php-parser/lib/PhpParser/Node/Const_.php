 ...
 */
class Const_ extends \_PhpScopera4be459e5e3d\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScopera4be459e5e3d\PhpParser\Node\Expr $value, array $attributes = [])
    {
