 ...
 */
class Const_ extends \_PhpScoper8dd2e1c340b1\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper8dd2e1c340b1\PhpParser\Node\Expr $value, array $attributes = [])
    {
