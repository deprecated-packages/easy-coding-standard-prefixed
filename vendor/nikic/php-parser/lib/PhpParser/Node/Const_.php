 ...
 */
class Const_ extends \_PhpScoperd4c5032f0671\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperd4c5032f0671\PhpParser\Node\Expr $value, array $attributes = [])
    {
