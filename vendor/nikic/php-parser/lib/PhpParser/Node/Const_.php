 ...
 */
class Const_ extends \_PhpScoper065e4ba46e6d\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper065e4ba46e6d\PhpParser\Node\Expr $value, array $attributes = [])
    {
