 ...
 */
class Const_ extends \_PhpScopera9d6b451df71\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScopera9d6b451df71\PhpParser\Node\Expr $value, array $attributes = [])
    {
