 ...
 */
class Const_ extends \_PhpScoperc95ae4bf942a\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperc95ae4bf942a\PhpParser\Node\Expr $value, array $attributes = [])
    {
