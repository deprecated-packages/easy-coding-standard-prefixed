 ...
 */
class Const_ extends \_PhpScoper0f5cd390c37a\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper0f5cd390c37a\PhpParser\Node\Expr $value, array $attributes = [])
    {
