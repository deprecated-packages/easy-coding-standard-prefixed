 ...
 */
class Const_ extends \_PhpScopera4fc793dae73\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScopera4fc793dae73\PhpParser\Node\Expr $value, array $attributes = [])
    {
