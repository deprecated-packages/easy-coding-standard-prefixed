 ...
 */
class Const_ extends \_PhpScoper4fc0030e9d22\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper4fc0030e9d22\PhpParser\Node\Expr $value, array $attributes = [])
    {
