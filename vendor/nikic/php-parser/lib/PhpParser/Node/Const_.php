 ...
 */
class Const_ extends \_PhpScoperfacc742d2745\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperfacc742d2745\PhpParser\Node\Expr $value, array $attributes = [])
    {
