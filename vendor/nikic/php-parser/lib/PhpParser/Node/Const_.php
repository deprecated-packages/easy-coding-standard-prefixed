 ...
 */
class Const_ extends \_PhpScoperdc8fbcd7c69d\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Expr $value, array $attributes = [])
    {
