 ...
 */
class Const_ extends \_PhpScoper8db4616aa69d\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper8db4616aa69d\PhpParser\Node\Expr $value, array $attributes = [])
    {
