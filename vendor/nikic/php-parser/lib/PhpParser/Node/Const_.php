 ...
 */
class Const_ extends \_PhpScoper9ef667a5e42c\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper9ef667a5e42c\PhpParser\Node\Expr $value, array $attributes = [])
    {
