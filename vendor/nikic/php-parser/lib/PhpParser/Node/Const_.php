 ...
 */
class Const_ extends \_PhpScoperc75fd40d7a6e\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperc75fd40d7a6e\PhpParser\Node\Expr $value, array $attributes = [])
    {
