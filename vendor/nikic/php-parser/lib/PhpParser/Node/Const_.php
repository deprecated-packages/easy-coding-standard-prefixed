 ...
 */
class Const_ extends \_PhpScoperd8b12759ee0d\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperd8b12759ee0d\PhpParser\Node\Expr $value, array $attributes = [])
    {
