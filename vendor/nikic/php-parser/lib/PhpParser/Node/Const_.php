 ...
 */
class Const_ extends \_PhpScoperb6d4bd368bd9\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperb6d4bd368bd9\PhpParser\Node\Expr $value, array $attributes = [])
    {
