 ...
 */
class Const_ extends \_PhpScoperc8fea59b0cb1\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperc8fea59b0cb1\PhpParser\Node\Expr $value, array $attributes = [])
    {
