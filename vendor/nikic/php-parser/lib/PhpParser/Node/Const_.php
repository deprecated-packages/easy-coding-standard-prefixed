 ...
 */
class Const_ extends \_PhpScoperddde3ba4aebc\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperddde3ba4aebc\PhpParser\Node\Expr $value, array $attributes = [])
    {
