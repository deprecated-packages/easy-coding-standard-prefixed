 ...
 */
class Const_ extends \_PhpScoperc4ea0f0bd23f\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperc4ea0f0bd23f\PhpParser\Node\Expr $value, array $attributes = [])
    {
