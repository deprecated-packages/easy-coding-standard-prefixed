 ...
 */
class Const_ extends \_PhpScoper5ca2d8bcb02c\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper5ca2d8bcb02c\PhpParser\Node\Expr $value, array $attributes = [])
    {
