 ...
 */
class Const_ extends \_PhpScoper78af57a363a0\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoper78af57a363a0\PhpParser\Node\Expr $value, array $attributes = [])
    {
