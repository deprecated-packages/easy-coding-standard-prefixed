 ...
 */
class Const_ extends \_PhpScoperf3db63c305b2\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScoperf3db63c305b2\PhpParser\Node\Expr $value, array $attributes = [])
    {
