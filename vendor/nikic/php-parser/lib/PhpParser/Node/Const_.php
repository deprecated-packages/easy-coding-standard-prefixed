 ...
 */
class Const_ extends \_PhpScopercb576ca159b5\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \_PhpScopercb576ca159b5\PhpParser\Node\Expr $value, array $attributes = [])
    {
