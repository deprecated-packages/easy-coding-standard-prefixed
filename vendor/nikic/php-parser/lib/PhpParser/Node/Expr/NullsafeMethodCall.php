...
class NullsafeMethodCall extends \_PhpScoperef870243cfdb\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperef870243cfdb\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
