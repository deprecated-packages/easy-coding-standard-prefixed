...
class NullsafeMethodCall extends \_PhpScoper80dbed43490f\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper80dbed43490f\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
