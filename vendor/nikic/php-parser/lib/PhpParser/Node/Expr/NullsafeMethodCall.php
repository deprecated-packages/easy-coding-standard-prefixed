...
class NullsafeMethodCall extends \_PhpScoperf7b66f9e3817\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperf7b66f9e3817\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
