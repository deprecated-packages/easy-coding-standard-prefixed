...
class NullsafeMethodCall extends \_PhpScoper4fc0030e9d22\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper4fc0030e9d22\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
