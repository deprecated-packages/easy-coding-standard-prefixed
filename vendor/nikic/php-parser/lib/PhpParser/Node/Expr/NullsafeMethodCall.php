...
class NullsafeMethodCall extends \_PhpScoper06c5fb6c14ed\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper06c5fb6c14ed\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
