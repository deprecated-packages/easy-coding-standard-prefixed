...
class NullsafeMethodCall extends \_PhpScoperdf6a0b341030\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperdf6a0b341030\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
