...
class NullsafeMethodCall extends \_PhpScoperda2604e33acb\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperda2604e33acb\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
