...
class NullsafeMethodCall extends \_PhpScoper4d3fa30a680b\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper4d3fa30a680b\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
