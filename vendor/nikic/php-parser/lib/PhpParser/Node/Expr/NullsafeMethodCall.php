...
class NullsafeMethodCall extends \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
