...
class NullsafeMethodCall extends \_PhpScoperfab1bfb7ec99\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperfab1bfb7ec99\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
