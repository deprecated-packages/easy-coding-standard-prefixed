...
class NullsafeMethodCall extends \_PhpScoper5ca2d8bcb02c\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper5ca2d8bcb02c\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
