...
class NullsafeMethodCall extends \_PhpScoper0ba97041430d\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper0ba97041430d\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
