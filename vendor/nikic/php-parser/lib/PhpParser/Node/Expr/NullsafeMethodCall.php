...
class NullsafeMethodCall extends \_PhpScoper9ef667a5e42c\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper9ef667a5e42c\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
