...
class NullsafeMethodCall extends \_PhpScoperd35c27cd4b09\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperd35c27cd4b09\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
