...
class NullsafeMethodCall extends \_PhpScopera4be459e5e3d\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScopera4be459e5e3d\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
