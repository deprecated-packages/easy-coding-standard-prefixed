...
class NullsafeMethodCall extends \_PhpScoperc753ccca5a0c\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperc753ccca5a0c\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
