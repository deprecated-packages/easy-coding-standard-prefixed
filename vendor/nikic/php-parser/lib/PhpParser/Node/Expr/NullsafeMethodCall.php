...
class NullsafeMethodCall extends \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperdc8fbcd7c69d\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
