...
class NullsafeMethodCall extends \_PhpScoper967c4b7e296e\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper967c4b7e296e\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
