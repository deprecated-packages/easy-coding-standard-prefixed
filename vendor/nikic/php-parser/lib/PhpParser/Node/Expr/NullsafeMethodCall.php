...
class NullsafeMethodCall extends \_PhpScoper065e4ba46e6d\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper065e4ba46e6d\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
