...
class NullsafeMethodCall extends \_PhpScoper64a921a5401b\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper64a921a5401b\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
