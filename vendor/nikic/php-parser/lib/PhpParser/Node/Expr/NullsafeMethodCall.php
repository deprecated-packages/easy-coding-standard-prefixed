...
class NullsafeMethodCall extends \_PhpScoper89c09b8e7101\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper89c09b8e7101\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
