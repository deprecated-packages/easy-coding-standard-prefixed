...
class NullsafeMethodCall extends \_PhpScoperd675aaf00c76\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperd675aaf00c76\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
