...
class NullsafeMethodCall extends \_PhpScoper167729fa1dde\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper167729fa1dde\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
