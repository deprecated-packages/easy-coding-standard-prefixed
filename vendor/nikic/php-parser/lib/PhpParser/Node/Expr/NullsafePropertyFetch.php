...
class NullsafePropertyFetch extends \_PhpScoper842c7347e6be\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper842c7347e6be\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
