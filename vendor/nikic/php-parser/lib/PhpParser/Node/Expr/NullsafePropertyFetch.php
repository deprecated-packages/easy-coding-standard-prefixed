...
class NullsafePropertyFetch extends \_PhpScoperac4e86be08e5\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperac4e86be08e5\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
