...
class NullsafePropertyFetch extends \_PhpScoperb36402634947\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperb36402634947\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
