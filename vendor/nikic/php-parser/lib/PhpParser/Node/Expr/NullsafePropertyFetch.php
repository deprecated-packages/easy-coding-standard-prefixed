...
class NullsafePropertyFetch extends \_PhpScoperd301db66c80c\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperd301db66c80c\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
