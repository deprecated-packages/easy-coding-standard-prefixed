...
class NullsafePropertyFetch extends \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
