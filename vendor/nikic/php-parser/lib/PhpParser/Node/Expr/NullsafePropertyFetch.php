...
class NullsafePropertyFetch extends \_PhpScoperbcc0395698f8\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperbcc0395698f8\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
