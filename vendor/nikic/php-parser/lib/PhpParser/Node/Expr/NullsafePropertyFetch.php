...
class NullsafePropertyFetch extends \_PhpScoperb458b528613f\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperb458b528613f\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
