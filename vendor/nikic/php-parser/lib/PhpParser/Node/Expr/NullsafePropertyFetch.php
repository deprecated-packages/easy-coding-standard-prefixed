...
class NullsafePropertyFetch extends \_PhpScoperddde3ba4aebc\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperddde3ba4aebc\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
