...
class NullsafePropertyFetch extends \_PhpScoper58a0a169dcfb\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper58a0a169dcfb\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
