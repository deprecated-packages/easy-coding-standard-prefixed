...
class NullsafePropertyFetch extends \_PhpScoper2f75f00bf6fa\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper2f75f00bf6fa\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
