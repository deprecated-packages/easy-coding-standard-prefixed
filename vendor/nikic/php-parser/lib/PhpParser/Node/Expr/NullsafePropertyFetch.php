...
class NullsafePropertyFetch extends \_PhpScoper0f5cd390c37a\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoper0f5cd390c37a\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
