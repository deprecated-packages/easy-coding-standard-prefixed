...
class NullsafePropertyFetch extends \_PhpScoperbaf90856897c\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperbaf90856897c\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
