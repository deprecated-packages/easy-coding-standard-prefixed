...
class NullsafePropertyFetch extends \_PhpScoperfcee700af3df\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\_PhpScoperfcee700af3df\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
