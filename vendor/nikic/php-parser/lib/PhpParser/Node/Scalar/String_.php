...
namespace _PhpScoperddde3ba4aebc\PhpParser\Node\Scalar;

use _PhpScoperddde3ba4aebc\PhpParser\Error;
use _PhpScoperddde3ba4aebc\PhpParser\Node\Scalar;
class String_ extends \_PhpScoperddde3ba4aebc\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperddde3ba4aebc\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
