...
namespace _PhpScoper5a9febfbbe05\PhpParser\Node\Scalar;

use _PhpScoper5a9febfbbe05\PhpParser\Error;
use _PhpScoper5a9febfbbe05\PhpParser\Node\Scalar;
class String_ extends \_PhpScoper5a9febfbbe05\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper5a9febfbbe05\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
