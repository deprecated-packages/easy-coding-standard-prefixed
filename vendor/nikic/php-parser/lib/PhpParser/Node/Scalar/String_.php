...
namespace _PhpScoper0f5cd390c37a\PhpParser\Node\Scalar;

use _PhpScoper0f5cd390c37a\PhpParser\Error;
use _PhpScoper0f5cd390c37a\PhpParser\Node\Scalar;
class String_ extends \_PhpScoper0f5cd390c37a\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper0f5cd390c37a\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
