...
namespace _PhpScoper7faa8deb0d3c\PhpParser\Node\Scalar;

use _PhpScoper7faa8deb0d3c\PhpParser\Error;
use _PhpScoper7faa8deb0d3c\PhpParser\Node\Scalar;
class String_ extends \_PhpScoper7faa8deb0d3c\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper7faa8deb0d3c\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
