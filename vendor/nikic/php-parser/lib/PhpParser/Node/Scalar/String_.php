...
class String_ extends \_PhpScopera37d6fb0b1ab\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScopera37d6fb0b1ab\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
