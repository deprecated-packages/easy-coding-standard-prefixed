...
namespace _PhpScoperf3dc21757def\PhpParser\Node\Scalar;

use _PhpScoperf3dc21757def\PhpParser\Error;
use _PhpScoperf3dc21757def\PhpParser\Node\Scalar;
class String_ extends \_PhpScoperf3dc21757def\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperf3dc21757def\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
