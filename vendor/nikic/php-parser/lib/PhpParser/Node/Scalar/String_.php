...
namespace _PhpScoper80dbed43490f\PhpParser\Node\Scalar;

use _PhpScoper80dbed43490f\PhpParser\Error;
use _PhpScoper80dbed43490f\PhpParser\Node\Scalar;
class String_ extends \_PhpScoper80dbed43490f\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper80dbed43490f\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
