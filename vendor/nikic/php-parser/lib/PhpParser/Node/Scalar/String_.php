...
namespace _PhpScopera23ebff5477f\PhpParser\Node\Scalar;

use _PhpScopera23ebff5477f\PhpParser\Error;
use _PhpScopera23ebff5477f\PhpParser\Node\Scalar;
class String_ extends \_PhpScopera23ebff5477f\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScopera23ebff5477f\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
