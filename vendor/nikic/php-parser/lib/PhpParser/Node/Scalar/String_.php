...
namespace _PhpScoperb6d4bd368bd9\PhpParser\Node\Scalar;

use _PhpScoperb6d4bd368bd9\PhpParser\Error;
use _PhpScoperb6d4bd368bd9\PhpParser\Node\Scalar;
class String_ extends \_PhpScoperb6d4bd368bd9\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperb6d4bd368bd9\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
