...
class String_ extends \_PhpScoper4f985154d5a0\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper4f985154d5a0\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
