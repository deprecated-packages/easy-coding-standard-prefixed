...
namespace _PhpScopercf909b66eba8\PhpParser\Node\Scalar;

use _PhpScopercf909b66eba8\PhpParser\Error;
use _PhpScopercf909b66eba8\PhpParser\Node\Scalar;
class String_ extends \_PhpScopercf909b66eba8\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScopercf909b66eba8\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
