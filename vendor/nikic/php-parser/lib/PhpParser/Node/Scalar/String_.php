...
namespace _PhpScoperaba240c3d5f1\PhpParser\Node\Scalar;

use _PhpScoperaba240c3d5f1\PhpParser\Error;
use _PhpScoperaba240c3d5f1\PhpParser\Node\Scalar;
class String_ extends \_PhpScoperaba240c3d5f1\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperaba240c3d5f1\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
