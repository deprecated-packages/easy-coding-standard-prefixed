...
class String_ extends \_PhpScoper58a0a169dcfb\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper58a0a169dcfb\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
