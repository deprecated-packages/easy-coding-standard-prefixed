...
namespace _PhpScoperbaf90856897c\PhpParser\Node\Scalar;

use _PhpScoperbaf90856897c\PhpParser\Error;
use _PhpScoperbaf90856897c\PhpParser\Node\Scalar;
class String_ extends \_PhpScoperbaf90856897c\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperbaf90856897c\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
