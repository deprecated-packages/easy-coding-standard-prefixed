...
class String_ extends \_PhpScoperdf6a0b341030\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperdf6a0b341030\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
