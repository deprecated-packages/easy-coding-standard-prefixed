...
class String_ extends \_PhpScoperfab1bfb7ec99\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperfab1bfb7ec99\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
