...
namespace _PhpScoperf77bffce0320\PhpParser\Node\Scalar;

use _PhpScoperf77bffce0320\PhpParser\Error;
use _PhpScoperf77bffce0320\PhpParser\Node\Scalar;
class String_ extends \_PhpScoperf77bffce0320\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperf77bffce0320\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
