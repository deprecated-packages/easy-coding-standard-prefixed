...
namespace _PhpScoper836bc32aecc2\PhpParser\Node\Scalar;

use _PhpScoper836bc32aecc2\PhpParser\Error;
use _PhpScoper836bc32aecc2\PhpParser\Node\Scalar;
class String_ extends \_PhpScoper836bc32aecc2\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper836bc32aecc2\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
