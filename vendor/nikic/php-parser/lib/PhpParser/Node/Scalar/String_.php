...
namespace _PhpScopera189153e1f79\PhpParser\Node\Scalar;

use _PhpScopera189153e1f79\PhpParser\Error;
use _PhpScopera189153e1f79\PhpParser\Node\Scalar;
class String_ extends \_PhpScopera189153e1f79\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScopera189153e1f79\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
