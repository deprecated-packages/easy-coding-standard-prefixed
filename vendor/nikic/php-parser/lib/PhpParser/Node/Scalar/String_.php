...
namespace _PhpScoperba24099fc6fd\PhpParser\Node\Scalar;

use _PhpScoperba24099fc6fd\PhpParser\Error;
use _PhpScoperba24099fc6fd\PhpParser\Node\Scalar;
class String_ extends \_PhpScoperba24099fc6fd\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperba24099fc6fd\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
