...
namespace _PhpScoper2d2a405cc0f8\PhpParser\Node\Scalar;

use _PhpScoper2d2a405cc0f8\PhpParser\Error;
use _PhpScoper2d2a405cc0f8\PhpParser\Node\Scalar;
class String_ extends \_PhpScoper2d2a405cc0f8\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper2d2a405cc0f8\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
