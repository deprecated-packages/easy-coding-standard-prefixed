...
namespace _PhpScoper5ca2d8bcb02c\PhpParser\Node\Scalar;

use _PhpScoper5ca2d8bcb02c\PhpParser\Error;
use _PhpScoper5ca2d8bcb02c\PhpParser\Node\Scalar;
class String_ extends \_PhpScoper5ca2d8bcb02c\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper5ca2d8bcb02c\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
