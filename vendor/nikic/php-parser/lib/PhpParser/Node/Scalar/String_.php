...
class String_ extends \_PhpScoperad4b7e2c09d8\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoperad4b7e2c09d8\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
