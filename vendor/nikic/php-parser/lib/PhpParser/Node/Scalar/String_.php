...
namespace _PhpScoper2a8ad010dfbd\PhpParser\Node\Scalar;

use _PhpScoper2a8ad010dfbd\PhpParser\Error;
use _PhpScoper2a8ad010dfbd\PhpParser\Node\Scalar;
class String_ extends \_PhpScoper2a8ad010dfbd\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \_PhpScoper2a8ad010dfbd\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
