...
class PropertyProperty extends \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Stmt
{
     ...
     */
    public function __construct($name, \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Expr $default = null, array $attributes = [])
    {
