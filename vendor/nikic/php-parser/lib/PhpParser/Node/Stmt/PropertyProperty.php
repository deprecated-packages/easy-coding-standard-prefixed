...
class PropertyProperty extends \_PhpScopera4be459e5e3d\PhpParser\Node\Stmt
{
     ...
     */
    public function __construct($name, \_PhpScopera4be459e5e3d\PhpParser\Node\Expr $default = null, array $attributes = [])
    {
