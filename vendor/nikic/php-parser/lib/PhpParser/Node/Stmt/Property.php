...
use _PhpScoper3ba93baeac18\PhpParser\Node\UnionType;
class Property extends \_PhpScoper3ba93baeac18\PhpParser\Node\Stmt
{
    /** @var int Modifiers */
    public $flags;
    ...
    public function __construct(int $flags, array $props, array $attributes = [], $type = null, array $attrGroups = [])
    {
        ...
        $this->flags = $flags;
        $this->props = $props;
        $this->type = \is_string($type) ? new \_PhpScoper3ba93baeac18\PhpParser\Node\Identifier($type) : $type;
