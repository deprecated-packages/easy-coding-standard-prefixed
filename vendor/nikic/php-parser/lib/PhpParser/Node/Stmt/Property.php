...
use _PhpScoperb6d4bd368bd9\PhpParser\Node\UnionType;
class Property extends \_PhpScoperb6d4bd368bd9\PhpParser\Node\Stmt
{
    /** @var int Modifiers */
    public $flags;
    ...
    public function __construct(int $flags, array $props, array $attributes = [], $type = null)
    {
        ...
        $this->flags = $flags;
        $this->props = $props;
        $this->type = \is_string($type) ? new \_PhpScoperb6d4bd368bd9\PhpParser\Node\Identifier($type) : $type;
    }
