...
class Precedence extends \_PhpScoperd301db66c80c\PhpParser\Node\Stmt\TraitUseAdaptation
{
     ...
     */
    public function __construct(\_PhpScoperd301db66c80c\PhpParser\Node\Name $trait, $method, array $insteadof, array $attributes = [])
    {
