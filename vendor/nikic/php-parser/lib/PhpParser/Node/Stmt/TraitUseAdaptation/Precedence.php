...
class Precedence extends \_PhpScoperddde3ba4aebc\PhpParser\Node\Stmt\TraitUseAdaptation
{
     ...
     */
    public function __construct(\_PhpScoperddde3ba4aebc\PhpParser\Node\Name $trait, $method, array $insteadof, array $attributes = [])
    {
