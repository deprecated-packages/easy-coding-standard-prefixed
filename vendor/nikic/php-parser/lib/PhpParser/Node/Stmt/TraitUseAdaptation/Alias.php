...
class Alias extends \_PhpScoper47644ab3aa9a\PhpParser\Node\Stmt\TraitUseAdaptation
{
    ...
    public function __construct($trait, $method, $newModifier, $newName, array $attributes = [])
    {
        ...
        $this->newName = \is_string($newName) ? new \_PhpScoper47644ab3aa9a\PhpParser\Node\Identifier($newName) : $newName;
    }
