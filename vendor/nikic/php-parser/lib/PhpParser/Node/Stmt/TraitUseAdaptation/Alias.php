...
class Alias extends \_PhpScoperbcc0395698f8\PhpParser\Node\Stmt\TraitUseAdaptation
{
    ...
    public function __construct($trait, $method, $newModifier, $newName, array $attributes = [])
    {
        ...
        $this->newName = \is_string($newName) ? new \_PhpScoperbcc0395698f8\PhpParser\Node\Identifier($newName) : $newName;
    }
