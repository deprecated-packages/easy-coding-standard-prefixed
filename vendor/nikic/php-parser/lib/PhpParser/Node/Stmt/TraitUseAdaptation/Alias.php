...
class Alias extends \_PhpScoper1103e00fb46b\PhpParser\Node\Stmt\TraitUseAdaptation
{
    ...
    public function __construct($trait, $method, $newModifier, $newName, array $attributes = [])
    {
        ...
        $this->newName = \is_string($newName) ? new \_PhpScoper1103e00fb46b\PhpParser\Node\Identifier($newName) : $newName;
    }
