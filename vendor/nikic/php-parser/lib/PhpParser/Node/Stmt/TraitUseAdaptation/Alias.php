...
class Alias extends \_PhpScoperaac5f7c652e4\PhpParser\Node\Stmt\TraitUseAdaptation
{
    ...
    public function __construct($trait, $method, $newModifier, $newName, array $attributes = [])
    {
        ...
        $this->newName = \is_string($newName) ? new \_PhpScoperaac5f7c652e4\PhpParser\Node\Identifier($newName) : $newName;
    }
