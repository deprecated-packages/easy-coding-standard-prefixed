...
use _PhpScoper0c0702cca4ac\PhpParser\Node\FunctionLike;
class ClassMethod extends \_PhpScoper0c0702cca4ac\PhpParser\Node\Stmt implements \_PhpScoper0c0702cca4ac\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \_PhpScoper0c0702cca4ac\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \_PhpScoper0c0702cca4ac\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScoper0c0702cca4ac\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
