...
class ClassMethod extends \_PhpScoperc753ccca5a0c\PhpParser\Node\Stmt implements \_PhpScoperc753ccca5a0c\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    {
        return (bool) ($this->flags & \_PhpScoperc753ccca5a0c\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScoperc753ccca5a0c\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScoperc753ccca5a0c\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC);
    }
    /**
