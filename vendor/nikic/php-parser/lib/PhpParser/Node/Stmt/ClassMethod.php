...
use _PhpScoperb6d4bd368bd9\PhpParser\Node\FunctionLike;
class ClassMethod extends \_PhpScoperb6d4bd368bd9\PhpParser\Node\Stmt implements \_PhpScoperb6d4bd368bd9\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \_PhpScoperb6d4bd368bd9\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \_PhpScoperb6d4bd368bd9\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScoperb6d4bd368bd9\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScoperb6d4bd368bd9\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC);
    }
    /**
