...
use _PhpScoperedc2e0c967db\PhpParser\Node\FunctionLike;
class ClassMethod extends \_PhpScoperedc2e0c967db\PhpParser\Node\Stmt implements \_PhpScoperedc2e0c967db\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \_PhpScoperedc2e0c967db\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \_PhpScoperedc2e0c967db\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScoperedc2e0c967db\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
