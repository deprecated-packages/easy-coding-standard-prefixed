...
use _PhpScopera6f918786d5c\PhpParser\Node\FunctionLike;
class ClassMethod extends \_PhpScopera6f918786d5c\PhpParser\Node\Stmt implements \_PhpScopera6f918786d5c\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \_PhpScopera6f918786d5c\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \_PhpScopera6f918786d5c\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScopera6f918786d5c\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
