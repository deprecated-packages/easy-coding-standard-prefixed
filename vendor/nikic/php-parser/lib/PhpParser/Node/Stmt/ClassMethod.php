...
use _PhpScoper3e1e0e5bb8ef\PhpParser\Node\FunctionLike;
class ClassMethod extends \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Stmt implements \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScoper3e1e0e5bb8ef\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
