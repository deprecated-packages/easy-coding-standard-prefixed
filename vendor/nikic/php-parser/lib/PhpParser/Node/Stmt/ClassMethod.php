...
use _PhpScoper2f75f00bf6fa\PhpParser\Node\FunctionLike;
class ClassMethod extends \_PhpScoper2f75f00bf6fa\PhpParser\Node\Stmt implements \_PhpScoper2f75f00bf6fa\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \_PhpScoper2f75f00bf6fa\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \_PhpScoper2f75f00bf6fa\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \_PhpScoper2f75f00bf6fa\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
