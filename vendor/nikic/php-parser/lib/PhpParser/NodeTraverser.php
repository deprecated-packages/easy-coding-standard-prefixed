...
class NodeTraverser implements \_PhpScoper04022cd986ec\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper04022cd986ec\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper04022cd986ec\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper04022cd986ec\PhpParser\Node $node) : \_PhpScoper04022cd986ec\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper04022cd986ec\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper04022cd986ec\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper04022cd986ec\PhpParser\Node\Stmt && $new instanceof \_PhpScoper04022cd986ec\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper04022cd986ec\PhpParser\Node\Expr && $new instanceof \_PhpScoper04022cd986ec\PhpParser\Node\Stmt) {
