...
class NodeTraverser implements \_PhpScopera6f918786d5c\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera6f918786d5c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera6f918786d5c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera6f918786d5c\PhpParser\Node $node) : \_PhpScopera6f918786d5c\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera6f918786d5c\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera6f918786d5c\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera6f918786d5c\PhpParser\Node\Stmt && $new instanceof \_PhpScopera6f918786d5c\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera6f918786d5c\PhpParser\Node\Expr && $new instanceof \_PhpScopera6f918786d5c\PhpParser\Node\Stmt) {
