...
class NodeTraverser implements \_PhpScoperecb978830f1e\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperecb978830f1e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperecb978830f1e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperecb978830f1e\PhpParser\Node $node) : \_PhpScoperecb978830f1e\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperecb978830f1e\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperecb978830f1e\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperecb978830f1e\PhpParser\Node\Stmt && $new instanceof \_PhpScoperecb978830f1e\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperecb978830f1e\PhpParser\Node\Expr && $new instanceof \_PhpScoperecb978830f1e\PhpParser\Node\Stmt) {
