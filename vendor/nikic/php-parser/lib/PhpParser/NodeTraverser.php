...
class NodeTraverser implements \_PhpScoperef5048aa2573\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoperef5048aa2573\PhpParser\Node $node) : \_PhpScoperef5048aa2573\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperef5048aa2573\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperef5048aa2573\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperef5048aa2573\PhpParser\Node\Stmt && $new instanceof \_PhpScoperef5048aa2573\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperef5048aa2573\PhpParser\Node\Expr && $new instanceof \_PhpScoperef5048aa2573\PhpParser\Node\Stmt) {
