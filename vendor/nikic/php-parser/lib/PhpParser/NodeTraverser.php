...
class NodeTraverser implements \_PhpScoperd675aaf00c76\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperd675aaf00c76\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperd675aaf00c76\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperd675aaf00c76\PhpParser\Node $node) : \_PhpScoperd675aaf00c76\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperd675aaf00c76\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperd675aaf00c76\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperd675aaf00c76\PhpParser\Node\Stmt && $new instanceof \_PhpScoperd675aaf00c76\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperd675aaf00c76\PhpParser\Node\Expr && $new instanceof \_PhpScoperd675aaf00c76\PhpParser\Node\Stmt) {
