...
class NodeTraverser implements \_PhpScoper4a718ec9156e\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper4a718ec9156e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper4a718ec9156e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper4a718ec9156e\PhpParser\Node $node) : \_PhpScoper4a718ec9156e\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper4a718ec9156e\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper4a718ec9156e\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper4a718ec9156e\PhpParser\Node\Stmt && $new instanceof \_PhpScoper4a718ec9156e\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper4a718ec9156e\PhpParser\Node\Expr && $new instanceof \_PhpScoper4a718ec9156e\PhpParser\Node\Stmt) {
