...
class NodeTraverser implements \_PhpScoper80dbed43490f\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper80dbed43490f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper80dbed43490f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper80dbed43490f\PhpParser\Node $node) : \_PhpScoper80dbed43490f\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper80dbed43490f\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper80dbed43490f\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper80dbed43490f\PhpParser\Node\Stmt && $new instanceof \_PhpScoper80dbed43490f\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper80dbed43490f\PhpParser\Node\Expr && $new instanceof \_PhpScoper80dbed43490f\PhpParser\Node\Stmt) {
