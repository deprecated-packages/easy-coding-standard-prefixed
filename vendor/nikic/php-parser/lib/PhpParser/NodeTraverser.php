...
class NodeTraverser implements \_PhpScoper167729fa1dde\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper167729fa1dde\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper167729fa1dde\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper167729fa1dde\PhpParser\Node $node) : \_PhpScoper167729fa1dde\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper167729fa1dde\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper167729fa1dde\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper167729fa1dde\PhpParser\Node\Stmt && $new instanceof \_PhpScoper167729fa1dde\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper167729fa1dde\PhpParser\Node\Expr && $new instanceof \_PhpScoper167729fa1dde\PhpParser\Node\Stmt) {
