...
class NodeTraverser implements \_PhpScoperc5bee3a837bb\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperc5bee3a837bb\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperc5bee3a837bb\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperc5bee3a837bb\PhpParser\Node $node) : \_PhpScoperc5bee3a837bb\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperc5bee3a837bb\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperc5bee3a837bb\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperc5bee3a837bb\PhpParser\Node\Stmt && $new instanceof \_PhpScoperc5bee3a837bb\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperc5bee3a837bb\PhpParser\Node\Expr && $new instanceof \_PhpScoperc5bee3a837bb\PhpParser\Node\Stmt) {
