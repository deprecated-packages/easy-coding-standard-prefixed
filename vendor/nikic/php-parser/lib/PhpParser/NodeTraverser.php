...
class NodeTraverser implements \_PhpScoper326bba7310a2\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper326bba7310a2\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper326bba7310a2\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper326bba7310a2\PhpParser\Node $node) : \_PhpScoper326bba7310a2\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper326bba7310a2\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper326bba7310a2\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper326bba7310a2\PhpParser\Node\Stmt && $new instanceof \_PhpScoper326bba7310a2\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper326bba7310a2\PhpParser\Node\Expr && $new instanceof \_PhpScoper326bba7310a2\PhpParser\Node\Stmt) {
