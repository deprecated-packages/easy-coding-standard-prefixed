...
class NodeTraverser implements \_PhpScopera40fc53e636b\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera40fc53e636b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera40fc53e636b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera40fc53e636b\PhpParser\Node $node) : \_PhpScopera40fc53e636b\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera40fc53e636b\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera40fc53e636b\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera40fc53e636b\PhpParser\Node\Stmt && $new instanceof \_PhpScopera40fc53e636b\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera40fc53e636b\PhpParser\Node\Expr && $new instanceof \_PhpScopera40fc53e636b\PhpParser\Node\Stmt) {
