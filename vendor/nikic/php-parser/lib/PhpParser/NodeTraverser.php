...
class NodeTraverser implements \_PhpScoperbaf90856897c\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperbaf90856897c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperbaf90856897c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperbaf90856897c\PhpParser\Node $node) : \_PhpScoperbaf90856897c\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperbaf90856897c\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperbaf90856897c\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperbaf90856897c\PhpParser\Node\Stmt && $new instanceof \_PhpScoperbaf90856897c\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperbaf90856897c\PhpParser\Node\Expr && $new instanceof \_PhpScoperbaf90856897c\PhpParser\Node\Stmt) {
