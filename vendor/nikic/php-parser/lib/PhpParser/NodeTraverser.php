...
class NodeTraverser implements \_PhpScoperaa402dd1b1f1\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperaa402dd1b1f1\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperaa402dd1b1f1\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperaa402dd1b1f1\PhpParser\Node $node) : \_PhpScoperaa402dd1b1f1\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperaa402dd1b1f1\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperaa402dd1b1f1\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperaa402dd1b1f1\PhpParser\Node\Stmt && $new instanceof \_PhpScoperaa402dd1b1f1\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperaa402dd1b1f1\PhpParser\Node\Expr && $new instanceof \_PhpScoperaa402dd1b1f1\PhpParser\Node\Stmt) {
