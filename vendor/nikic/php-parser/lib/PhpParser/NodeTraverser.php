...
class NodeTraverser implements \_PhpScopera4fc793dae73\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera4fc793dae73\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera4fc793dae73\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera4fc793dae73\PhpParser\Node $node) : \_PhpScopera4fc793dae73\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera4fc793dae73\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera4fc793dae73\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera4fc793dae73\PhpParser\Node\Stmt && $new instanceof \_PhpScopera4fc793dae73\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera4fc793dae73\PhpParser\Node\Expr && $new instanceof \_PhpScopera4fc793dae73\PhpParser\Node\Stmt) {
