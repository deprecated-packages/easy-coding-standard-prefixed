...
class NodeTraverser implements \_PhpScopera061b8a47e36\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera061b8a47e36\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera061b8a47e36\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera061b8a47e36\PhpParser\Node $node) : \_PhpScopera061b8a47e36\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera061b8a47e36\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera061b8a47e36\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera061b8a47e36\PhpParser\Node\Stmt && $new instanceof \_PhpScopera061b8a47e36\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera061b8a47e36\PhpParser\Node\Expr && $new instanceof \_PhpScopera061b8a47e36\PhpParser\Node\Stmt) {
