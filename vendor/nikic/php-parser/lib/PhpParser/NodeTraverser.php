...
class NodeTraverser implements \_PhpScoper0f5cd390c37a\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper0f5cd390c37a\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper0f5cd390c37a\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper0f5cd390c37a\PhpParser\Node $node) : \_PhpScoper0f5cd390c37a\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper0f5cd390c37a\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper0f5cd390c37a\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper0f5cd390c37a\PhpParser\Node\Stmt && $new instanceof \_PhpScoper0f5cd390c37a\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper0f5cd390c37a\PhpParser\Node\Expr && $new instanceof \_PhpScoper0f5cd390c37a\PhpParser\Node\Stmt) {
