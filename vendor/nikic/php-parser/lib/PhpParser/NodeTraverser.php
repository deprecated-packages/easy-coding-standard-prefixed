...
class NodeTraverser implements \_PhpScopera1a51450b61d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScopera1a51450b61d\PhpParser\Node $node) : \_PhpScopera1a51450b61d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera1a51450b61d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera1a51450b61d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera1a51450b61d\PhpParser\Node\Stmt && $new instanceof \_PhpScopera1a51450b61d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera1a51450b61d\PhpParser\Node\Expr && $new instanceof \_PhpScopera1a51450b61d\PhpParser\Node\Stmt) {
