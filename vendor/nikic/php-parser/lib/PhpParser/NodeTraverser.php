...
class NodeTraverser implements \_PhpScoperdf6a0b341030\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperdf6a0b341030\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperdf6a0b341030\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperdf6a0b341030\PhpParser\Node $node) : \_PhpScoperdf6a0b341030\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperdf6a0b341030\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperdf6a0b341030\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperdf6a0b341030\PhpParser\Node\Stmt && $new instanceof \_PhpScoperdf6a0b341030\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperdf6a0b341030\PhpParser\Node\Expr && $new instanceof \_PhpScoperdf6a0b341030\PhpParser\Node\Stmt) {
