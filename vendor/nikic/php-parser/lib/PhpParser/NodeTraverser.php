...
class NodeTraverser implements \_PhpScoper745103eaabcd\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper745103eaabcd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper745103eaabcd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper745103eaabcd\PhpParser\Node $node) : \_PhpScoper745103eaabcd\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper745103eaabcd\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper745103eaabcd\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper745103eaabcd\PhpParser\Node\Stmt && $new instanceof \_PhpScoper745103eaabcd\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper745103eaabcd\PhpParser\Node\Expr && $new instanceof \_PhpScoper745103eaabcd\PhpParser\Node\Stmt) {
