...
class NodeTraverser implements \_PhpScoper37a255897161\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper37a255897161\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper37a255897161\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper37a255897161\PhpParser\Node $node) : \_PhpScoper37a255897161\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper37a255897161\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper37a255897161\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper37a255897161\PhpParser\Node\Stmt && $new instanceof \_PhpScoper37a255897161\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper37a255897161\PhpParser\Node\Expr && $new instanceof \_PhpScoper37a255897161\PhpParser\Node\Stmt) {
