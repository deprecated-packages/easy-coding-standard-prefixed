...
class NodeTraverser implements \_PhpScopercb217fd4e736\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopercb217fd4e736\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopercb217fd4e736\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopercb217fd4e736\PhpParser\Node $node) : \_PhpScopercb217fd4e736\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopercb217fd4e736\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopercb217fd4e736\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopercb217fd4e736\PhpParser\Node\Stmt && $new instanceof \_PhpScopercb217fd4e736\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopercb217fd4e736\PhpParser\Node\Expr && $new instanceof \_PhpScopercb217fd4e736\PhpParser\Node\Stmt) {
