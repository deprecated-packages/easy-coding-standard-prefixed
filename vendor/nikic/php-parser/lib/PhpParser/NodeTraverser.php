...
class NodeTraverser implements \_PhpScoperdeea1786e972\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperdeea1786e972\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperdeea1786e972\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperdeea1786e972\PhpParser\Node $node) : \_PhpScoperdeea1786e972\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperdeea1786e972\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperdeea1786e972\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperdeea1786e972\PhpParser\Node\Stmt && $new instanceof \_PhpScoperdeea1786e972\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperdeea1786e972\PhpParser\Node\Expr && $new instanceof \_PhpScoperdeea1786e972\PhpParser\Node\Stmt) {
