...
class NodeTraverser implements \_PhpScoper64a921a5401b\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper64a921a5401b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper64a921a5401b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper64a921a5401b\PhpParser\Node $node) : \_PhpScoper64a921a5401b\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper64a921a5401b\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper64a921a5401b\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper64a921a5401b\PhpParser\Node\Stmt && $new instanceof \_PhpScoper64a921a5401b\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper64a921a5401b\PhpParser\Node\Expr && $new instanceof \_PhpScoper64a921a5401b\PhpParser\Node\Stmt) {
