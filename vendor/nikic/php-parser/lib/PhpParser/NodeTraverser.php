...
class NodeTraverser implements \_PhpScoper06c5fb6c14ed\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoper06c5fb6c14ed\PhpParser\Node $node) : \_PhpScoper06c5fb6c14ed\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper06c5fb6c14ed\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper06c5fb6c14ed\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper06c5fb6c14ed\PhpParser\Node\Stmt && $new instanceof \_PhpScoper06c5fb6c14ed\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper06c5fb6c14ed\PhpParser\Node\Expr && $new instanceof \_PhpScoper06c5fb6c14ed\PhpParser\Node\Stmt) {
