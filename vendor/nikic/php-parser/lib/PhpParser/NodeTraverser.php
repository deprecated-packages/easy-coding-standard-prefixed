...
class NodeTraverser implements \_PhpScoper28ab463fc3ba\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper28ab463fc3ba\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper28ab463fc3ba\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper28ab463fc3ba\PhpParser\Node $node) : \_PhpScoper28ab463fc3ba\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper28ab463fc3ba\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper28ab463fc3ba\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper28ab463fc3ba\PhpParser\Node\Stmt && $new instanceof \_PhpScoper28ab463fc3ba\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper28ab463fc3ba\PhpParser\Node\Expr && $new instanceof \_PhpScoper28ab463fc3ba\PhpParser\Node\Stmt) {
