...
class NodeTraverser implements \_PhpScoper2a8ad010dfbd\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper2a8ad010dfbd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper2a8ad010dfbd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper2a8ad010dfbd\PhpParser\Node $node) : \_PhpScoper2a8ad010dfbd\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper2a8ad010dfbd\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper2a8ad010dfbd\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper2a8ad010dfbd\PhpParser\Node\Stmt && $new instanceof \_PhpScoper2a8ad010dfbd\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper2a8ad010dfbd\PhpParser\Node\Expr && $new instanceof \_PhpScoper2a8ad010dfbd\PhpParser\Node\Stmt) {
