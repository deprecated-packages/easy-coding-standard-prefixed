...
class NodeTraverser implements \_PhpScoper908feaf49cd8\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper908feaf49cd8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper908feaf49cd8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper908feaf49cd8\PhpParser\Node $node) : \_PhpScoper908feaf49cd8\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper908feaf49cd8\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper908feaf49cd8\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper908feaf49cd8\PhpParser\Node\Stmt && $new instanceof \_PhpScoper908feaf49cd8\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper908feaf49cd8\PhpParser\Node\Expr && $new instanceof \_PhpScoper908feaf49cd8\PhpParser\Node\Stmt) {
