...
class NodeTraverser implements \_PhpScoperaba240c3d5f1\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperaba240c3d5f1\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperaba240c3d5f1\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperaba240c3d5f1\PhpParser\Node $node) : \_PhpScoperaba240c3d5f1\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperaba240c3d5f1\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperaba240c3d5f1\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperaba240c3d5f1\PhpParser\Node\Stmt && $new instanceof \_PhpScoperaba240c3d5f1\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperaba240c3d5f1\PhpParser\Node\Expr && $new instanceof \_PhpScoperaba240c3d5f1\PhpParser\Node\Stmt) {
