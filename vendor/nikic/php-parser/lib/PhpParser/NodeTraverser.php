...
class NodeTraverser implements \_PhpScopercf909b66eba8\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopercf909b66eba8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopercf909b66eba8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopercf909b66eba8\PhpParser\Node $node) : \_PhpScopercf909b66eba8\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopercf909b66eba8\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopercf909b66eba8\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopercf909b66eba8\PhpParser\Node\Stmt && $new instanceof \_PhpScopercf909b66eba8\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopercf909b66eba8\PhpParser\Node\Expr && $new instanceof \_PhpScopercf909b66eba8\PhpParser\Node\Stmt) {
