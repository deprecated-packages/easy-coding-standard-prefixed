...
class NodeTraverser implements \_PhpScoper967c4b7e296e\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper967c4b7e296e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper967c4b7e296e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper967c4b7e296e\PhpParser\Node $node) : \_PhpScoper967c4b7e296e\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper967c4b7e296e\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper967c4b7e296e\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper967c4b7e296e\PhpParser\Node\Stmt && $new instanceof \_PhpScoper967c4b7e296e\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper967c4b7e296e\PhpParser\Node\Expr && $new instanceof \_PhpScoper967c4b7e296e\PhpParser\Node\Stmt) {
