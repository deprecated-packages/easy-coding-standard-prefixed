...
class NodeTraverser implements \_PhpScoper6250f8d25076\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper6250f8d25076\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper6250f8d25076\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper6250f8d25076\PhpParser\Node $node) : \_PhpScoper6250f8d25076\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper6250f8d25076\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper6250f8d25076\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper6250f8d25076\PhpParser\Node\Stmt && $new instanceof \_PhpScoper6250f8d25076\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper6250f8d25076\PhpParser\Node\Expr && $new instanceof \_PhpScoper6250f8d25076\PhpParser\Node\Stmt) {
