...
class NodeTraverser implements \_PhpScoper89ec3c69e67d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper89ec3c69e67d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper89ec3c69e67d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper89ec3c69e67d\PhpParser\Node $node) : \_PhpScoper89ec3c69e67d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper89ec3c69e67d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper89ec3c69e67d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper89ec3c69e67d\PhpParser\Node\Stmt && $new instanceof \_PhpScoper89ec3c69e67d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper89ec3c69e67d\PhpParser\Node\Expr && $new instanceof \_PhpScoper89ec3c69e67d\PhpParser\Node\Stmt) {
