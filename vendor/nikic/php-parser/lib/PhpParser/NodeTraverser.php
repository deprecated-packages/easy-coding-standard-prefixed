...
class NodeTraverser implements \_PhpScoper7faa8deb0d3c\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper7faa8deb0d3c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper7faa8deb0d3c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper7faa8deb0d3c\PhpParser\Node $node) : \_PhpScoper7faa8deb0d3c\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper7faa8deb0d3c\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper7faa8deb0d3c\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper7faa8deb0d3c\PhpParser\Node\Stmt && $new instanceof \_PhpScoper7faa8deb0d3c\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper7faa8deb0d3c\PhpParser\Node\Expr && $new instanceof \_PhpScoper7faa8deb0d3c\PhpParser\Node\Stmt) {
