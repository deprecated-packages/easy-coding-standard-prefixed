...
class NodeTraverser implements \_PhpScoperc64a4ac1af35\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperc64a4ac1af35\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperc64a4ac1af35\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperc64a4ac1af35\PhpParser\Node $node) : \_PhpScoperc64a4ac1af35\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperc64a4ac1af35\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperc64a4ac1af35\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperc64a4ac1af35\PhpParser\Node\Stmt && $new instanceof \_PhpScoperc64a4ac1af35\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperc64a4ac1af35\PhpParser\Node\Expr && $new instanceof \_PhpScoperc64a4ac1af35\PhpParser\Node\Stmt) {
