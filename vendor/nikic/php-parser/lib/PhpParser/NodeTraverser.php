...
class NodeTraverser implements \_PhpScoperf53473b45c36\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperf53473b45c36\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperf53473b45c36\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperf53473b45c36\PhpParser\Node $node) : \_PhpScoperf53473b45c36\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperf53473b45c36\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperf53473b45c36\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperf53473b45c36\PhpParser\Node\Stmt && $new instanceof \_PhpScoperf53473b45c36\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperf53473b45c36\PhpParser\Node\Expr && $new instanceof \_PhpScoperf53473b45c36\PhpParser\Node\Stmt) {
