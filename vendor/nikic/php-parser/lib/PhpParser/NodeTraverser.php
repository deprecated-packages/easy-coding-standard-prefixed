...
class NodeTraverser implements \_PhpScoper1e80a2e03314\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper1e80a2e03314\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper1e80a2e03314\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper1e80a2e03314\PhpParser\Node $node) : \_PhpScoper1e80a2e03314\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper1e80a2e03314\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper1e80a2e03314\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper1e80a2e03314\PhpParser\Node\Stmt && $new instanceof \_PhpScoper1e80a2e03314\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper1e80a2e03314\PhpParser\Node\Expr && $new instanceof \_PhpScoper1e80a2e03314\PhpParser\Node\Stmt) {
