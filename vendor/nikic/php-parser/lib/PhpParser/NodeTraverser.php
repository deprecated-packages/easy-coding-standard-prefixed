...
class NodeTraverser implements \_PhpScoperac4e86be08e5\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperac4e86be08e5\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperac4e86be08e5\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperac4e86be08e5\PhpParser\Node $node) : \_PhpScoperac4e86be08e5\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperac4e86be08e5\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperac4e86be08e5\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt && $new instanceof \_PhpScoperac4e86be08e5\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperac4e86be08e5\PhpParser\Node\Expr && $new instanceof \_PhpScoperac4e86be08e5\PhpParser\Node\Stmt) {
