...
class NodeTraverser implements \_PhpScoper89c09b8e7101\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper89c09b8e7101\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper89c09b8e7101\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper89c09b8e7101\PhpParser\Node $node) : \_PhpScoper89c09b8e7101\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper89c09b8e7101\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper89c09b8e7101\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper89c09b8e7101\PhpParser\Node\Stmt && $new instanceof \_PhpScoper89c09b8e7101\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper89c09b8e7101\PhpParser\Node\Expr && $new instanceof \_PhpScoper89c09b8e7101\PhpParser\Node\Stmt) {
