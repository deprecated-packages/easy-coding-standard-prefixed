...
class NodeTraverser implements \_PhpScoper08748c77fa1c\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper08748c77fa1c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper08748c77fa1c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper08748c77fa1c\PhpParser\Node $node) : \_PhpScoper08748c77fa1c\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper08748c77fa1c\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper08748c77fa1c\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper08748c77fa1c\PhpParser\Node\Stmt && $new instanceof \_PhpScoper08748c77fa1c\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper08748c77fa1c\PhpParser\Node\Expr && $new instanceof \_PhpScoper08748c77fa1c\PhpParser\Node\Stmt) {
