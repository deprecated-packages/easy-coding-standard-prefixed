...
class NodeTraverser implements \_PhpScoper246d7c16d32f\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper246d7c16d32f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper246d7c16d32f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper246d7c16d32f\PhpParser\Node $node) : \_PhpScoper246d7c16d32f\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper246d7c16d32f\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper246d7c16d32f\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper246d7c16d32f\PhpParser\Node\Stmt && $new instanceof \_PhpScoper246d7c16d32f\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper246d7c16d32f\PhpParser\Node\Expr && $new instanceof \_PhpScoper246d7c16d32f\PhpParser\Node\Stmt) {
