...
class NodeTraverser implements \_PhpScoperbcc0395698f8\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperbcc0395698f8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperbcc0395698f8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperbcc0395698f8\PhpParser\Node $node) : \_PhpScoperbcc0395698f8\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperbcc0395698f8\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperbcc0395698f8\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperbcc0395698f8\PhpParser\Node\Stmt && $new instanceof \_PhpScoperbcc0395698f8\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperbcc0395698f8\PhpParser\Node\Expr && $new instanceof \_PhpScoperbcc0395698f8\PhpParser\Node\Stmt) {
