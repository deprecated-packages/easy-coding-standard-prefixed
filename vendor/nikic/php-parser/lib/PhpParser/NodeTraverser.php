...
class NodeTraverser implements \_PhpScoperaac5f7c652e4\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperaac5f7c652e4\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperaac5f7c652e4\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperaac5f7c652e4\PhpParser\Node $node) : \_PhpScoperaac5f7c652e4\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperaac5f7c652e4\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperaac5f7c652e4\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperaac5f7c652e4\PhpParser\Node\Stmt && $new instanceof \_PhpScoperaac5f7c652e4\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperaac5f7c652e4\PhpParser\Node\Expr && $new instanceof \_PhpScoperaac5f7c652e4\PhpParser\Node\Stmt) {
