...
class NodeTraverser implements \_PhpScoper2fe14d6302bc\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper2fe14d6302bc\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper2fe14d6302bc\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper2fe14d6302bc\PhpParser\Node $node) : \_PhpScoper2fe14d6302bc\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper2fe14d6302bc\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper2fe14d6302bc\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper2fe14d6302bc\PhpParser\Node\Stmt && $new instanceof \_PhpScoper2fe14d6302bc\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper2fe14d6302bc\PhpParser\Node\Expr && $new instanceof \_PhpScoper2fe14d6302bc\PhpParser\Node\Stmt) {
