...
class NodeTraverser implements \_PhpScopera37d6fb0b1ab\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera37d6fb0b1ab\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera37d6fb0b1ab\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera37d6fb0b1ab\PhpParser\Node $node) : \_PhpScopera37d6fb0b1ab\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera37d6fb0b1ab\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera37d6fb0b1ab\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera37d6fb0b1ab\PhpParser\Node\Stmt && $new instanceof \_PhpScopera37d6fb0b1ab\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera37d6fb0b1ab\PhpParser\Node\Expr && $new instanceof \_PhpScopera37d6fb0b1ab\PhpParser\Node\Stmt) {
