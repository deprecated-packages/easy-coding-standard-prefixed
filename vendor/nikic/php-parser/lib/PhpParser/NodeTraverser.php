...
class NodeTraverser implements \_PhpScoperaad82bb90a86\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperaad82bb90a86\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperaad82bb90a86\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperaad82bb90a86\PhpParser\Node $node) : \_PhpScoperaad82bb90a86\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperaad82bb90a86\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperaad82bb90a86\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperaad82bb90a86\PhpParser\Node\Stmt && $new instanceof \_PhpScoperaad82bb90a86\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperaad82bb90a86\PhpParser\Node\Expr && $new instanceof \_PhpScoperaad82bb90a86\PhpParser\Node\Stmt) {
