...
class NodeTraverser implements \_PhpScoperbd5c5a045153\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperbd5c5a045153\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperbd5c5a045153\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperbd5c5a045153\PhpParser\Node $node) : \_PhpScoperbd5c5a045153\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperbd5c5a045153\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperbd5c5a045153\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperbd5c5a045153\PhpParser\Node\Stmt && $new instanceof \_PhpScoperbd5c5a045153\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperbd5c5a045153\PhpParser\Node\Expr && $new instanceof \_PhpScoperbd5c5a045153\PhpParser\Node\Stmt) {
