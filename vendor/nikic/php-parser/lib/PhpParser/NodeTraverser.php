...
class NodeTraverser implements \_PhpScoperc4ea0f0bd23f\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperc4ea0f0bd23f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperc4ea0f0bd23f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperc4ea0f0bd23f\PhpParser\Node $node) : \_PhpScoperc4ea0f0bd23f\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperc4ea0f0bd23f\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperc4ea0f0bd23f\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperc4ea0f0bd23f\PhpParser\Node\Stmt && $new instanceof \_PhpScoperc4ea0f0bd23f\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperc4ea0f0bd23f\PhpParser\Node\Expr && $new instanceof \_PhpScoperc4ea0f0bd23f\PhpParser\Node\Stmt) {
