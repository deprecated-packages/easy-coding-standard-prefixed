...
class NodeTraverser implements \_PhpScoperb2e2c0c42e71\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperb2e2c0c42e71\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperb2e2c0c42e71\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperb2e2c0c42e71\PhpParser\Node $node) : \_PhpScoperb2e2c0c42e71\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperb2e2c0c42e71\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperb2e2c0c42e71\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperb2e2c0c42e71\PhpParser\Node\Stmt && $new instanceof \_PhpScoperb2e2c0c42e71\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperb2e2c0c42e71\PhpParser\Node\Expr && $new instanceof \_PhpScoperb2e2c0c42e71\PhpParser\Node\Stmt) {
