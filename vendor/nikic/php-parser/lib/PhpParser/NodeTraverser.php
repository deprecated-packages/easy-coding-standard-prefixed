...
class NodeTraverser implements \_PhpScoperad4b7e2c09d8\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperad4b7e2c09d8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperad4b7e2c09d8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperad4b7e2c09d8\PhpParser\Node $node) : \_PhpScoperad4b7e2c09d8\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperad4b7e2c09d8\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperad4b7e2c09d8\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperad4b7e2c09d8\PhpParser\Node\Stmt && $new instanceof \_PhpScoperad4b7e2c09d8\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperad4b7e2c09d8\PhpParser\Node\Expr && $new instanceof \_PhpScoperad4b7e2c09d8\PhpParser\Node\Stmt) {
