...
class NodeTraverser implements \_PhpScoper0ba97041430d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper0ba97041430d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper0ba97041430d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper0ba97041430d\PhpParser\Node $node) : \_PhpScoper0ba97041430d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper0ba97041430d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper0ba97041430d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper0ba97041430d\PhpParser\Node\Stmt && $new instanceof \_PhpScoper0ba97041430d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper0ba97041430d\PhpParser\Node\Expr && $new instanceof \_PhpScoper0ba97041430d\PhpParser\Node\Stmt) {
