...
class NodeTraverser implements \_PhpScoper81b3ff5ab9fe\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper81b3ff5ab9fe\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper81b3ff5ab9fe\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper81b3ff5ab9fe\PhpParser\Node $node) : \_PhpScoper81b3ff5ab9fe\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper81b3ff5ab9fe\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper81b3ff5ab9fe\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper81b3ff5ab9fe\PhpParser\Node\Stmt && $new instanceof \_PhpScoper81b3ff5ab9fe\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper81b3ff5ab9fe\PhpParser\Node\Expr && $new instanceof \_PhpScoper81b3ff5ab9fe\PhpParser\Node\Stmt) {
