...
class NodeTraverser implements \_PhpScoper57272265e1c9\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper57272265e1c9\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper57272265e1c9\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper57272265e1c9\PhpParser\Node $node) : \_PhpScoper57272265e1c9\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper57272265e1c9\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper57272265e1c9\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper57272265e1c9\PhpParser\Node\Stmt && $new instanceof \_PhpScoper57272265e1c9\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper57272265e1c9\PhpParser\Node\Expr && $new instanceof \_PhpScoper57272265e1c9\PhpParser\Node\Stmt) {
