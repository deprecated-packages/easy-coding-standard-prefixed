...
class NodeTraverser implements \_PhpScoper3e8786a75afe\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper3e8786a75afe\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper3e8786a75afe\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper3e8786a75afe\PhpParser\Node $node) : \_PhpScoper3e8786a75afe\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper3e8786a75afe\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper3e8786a75afe\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper3e8786a75afe\PhpParser\Node\Stmt && $new instanceof \_PhpScoper3e8786a75afe\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper3e8786a75afe\PhpParser\Node\Expr && $new instanceof \_PhpScoper3e8786a75afe\PhpParser\Node\Stmt) {
