...
class NodeTraverser implements \_PhpScoper14cb6de5473d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper14cb6de5473d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper14cb6de5473d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper14cb6de5473d\PhpParser\Node $node) : \_PhpScoper14cb6de5473d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper14cb6de5473d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper14cb6de5473d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper14cb6de5473d\PhpParser\Node\Stmt && $new instanceof \_PhpScoper14cb6de5473d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper14cb6de5473d\PhpParser\Node\Expr && $new instanceof \_PhpScoper14cb6de5473d\PhpParser\Node\Stmt) {
