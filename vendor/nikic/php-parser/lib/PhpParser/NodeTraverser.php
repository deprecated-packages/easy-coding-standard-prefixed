...
class NodeTraverser implements \_PhpScopera09818bc50da\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera09818bc50da\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera09818bc50da\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera09818bc50da\PhpParser\Node $node) : \_PhpScopera09818bc50da\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera09818bc50da\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera09818bc50da\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera09818bc50da\PhpParser\Node\Stmt && $new instanceof \_PhpScopera09818bc50da\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera09818bc50da\PhpParser\Node\Expr && $new instanceof \_PhpScopera09818bc50da\PhpParser\Node\Stmt) {
