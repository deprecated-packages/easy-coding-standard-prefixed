...
class NodeTraverser implements \_PhpScoperedc2e0c967db\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperedc2e0c967db\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperedc2e0c967db\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperedc2e0c967db\PhpParser\Node $node) : \_PhpScoperedc2e0c967db\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperedc2e0c967db\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperedc2e0c967db\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperedc2e0c967db\PhpParser\Node\Stmt && $new instanceof \_PhpScoperedc2e0c967db\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperedc2e0c967db\PhpParser\Node\Expr && $new instanceof \_PhpScoperedc2e0c967db\PhpParser\Node\Stmt) {
