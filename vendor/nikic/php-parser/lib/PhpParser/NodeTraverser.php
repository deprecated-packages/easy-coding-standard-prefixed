...
class NodeTraverser implements \_PhpScoper7c0f822a05e1\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper7c0f822a05e1\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper7c0f822a05e1\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper7c0f822a05e1\PhpParser\Node $node) : \_PhpScoper7c0f822a05e1\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper7c0f822a05e1\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper7c0f822a05e1\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper7c0f822a05e1\PhpParser\Node\Stmt && $new instanceof \_PhpScoper7c0f822a05e1\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper7c0f822a05e1\PhpParser\Node\Expr && $new instanceof \_PhpScoper7c0f822a05e1\PhpParser\Node\Stmt) {
