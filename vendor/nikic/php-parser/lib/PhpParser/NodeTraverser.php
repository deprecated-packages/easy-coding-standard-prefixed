...
class NodeTraverser implements \_PhpScoper0c0702cca4ac\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper0c0702cca4ac\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper0c0702cca4ac\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper0c0702cca4ac\PhpParser\Node $node) : \_PhpScoper0c0702cca4ac\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper0c0702cca4ac\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper0c0702cca4ac\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper0c0702cca4ac\PhpParser\Node\Stmt && $new instanceof \_PhpScoper0c0702cca4ac\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper0c0702cca4ac\PhpParser\Node\Expr && $new instanceof \_PhpScoper0c0702cca4ac\PhpParser\Node\Stmt) {
