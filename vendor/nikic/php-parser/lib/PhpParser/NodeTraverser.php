...
class NodeTraverser implements \_PhpScoperf62d28230928\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoperf62d28230928\PhpParser\Node $node) : \_PhpScoperf62d28230928\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperf62d28230928\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperf62d28230928\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperf62d28230928\PhpParser\Node\Stmt && $new instanceof \_PhpScoperf62d28230928\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperf62d28230928\PhpParser\Node\Expr && $new instanceof \_PhpScoperf62d28230928\PhpParser\Node\Stmt) {
