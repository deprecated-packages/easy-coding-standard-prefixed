...
class NodeTraverser implements \_PhpScoper66292c14b658\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper66292c14b658\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper66292c14b658\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper66292c14b658\PhpParser\Node $node) : \_PhpScoper66292c14b658\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper66292c14b658\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper66292c14b658\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper66292c14b658\PhpParser\Node\Stmt && $new instanceof \_PhpScoper66292c14b658\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper66292c14b658\PhpParser\Node\Expr && $new instanceof \_PhpScoper66292c14b658\PhpParser\Node\Stmt) {
