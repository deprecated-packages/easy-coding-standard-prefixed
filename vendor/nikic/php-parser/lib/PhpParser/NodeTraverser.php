...
class NodeTraverser implements \_PhpScopereb8678af2407\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopereb8678af2407\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopereb8678af2407\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopereb8678af2407\PhpParser\Node $node) : \_PhpScopereb8678af2407\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopereb8678af2407\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopereb8678af2407\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopereb8678af2407\PhpParser\Node\Stmt && $new instanceof \_PhpScopereb8678af2407\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopereb8678af2407\PhpParser\Node\Expr && $new instanceof \_PhpScopereb8678af2407\PhpParser\Node\Stmt) {
