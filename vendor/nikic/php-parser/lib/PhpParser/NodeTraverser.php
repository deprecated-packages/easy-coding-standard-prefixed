...
class NodeTraverser implements \_PhpScoper3fa05b4669af\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper3fa05b4669af\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper3fa05b4669af\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper3fa05b4669af\PhpParser\Node $node) : \_PhpScoper3fa05b4669af\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper3fa05b4669af\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper3fa05b4669af\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper3fa05b4669af\PhpParser\Node\Stmt && $new instanceof \_PhpScoper3fa05b4669af\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper3fa05b4669af\PhpParser\Node\Expr && $new instanceof \_PhpScoper3fa05b4669af\PhpParser\Node\Stmt) {
