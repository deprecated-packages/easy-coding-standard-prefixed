...
class NodeTraverser implements \_PhpScoper224ae0b86670\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper224ae0b86670\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper224ae0b86670\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper224ae0b86670\PhpParser\Node $node) : \_PhpScoper224ae0b86670\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper224ae0b86670\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper224ae0b86670\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper224ae0b86670\PhpParser\Node\Stmt && $new instanceof \_PhpScoper224ae0b86670\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper224ae0b86670\PhpParser\Node\Expr && $new instanceof \_PhpScoper224ae0b86670\PhpParser\Node\Stmt) {
