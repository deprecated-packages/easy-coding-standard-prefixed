...
class NodeTraverser implements \_PhpScoperf3dc21757def\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperf3dc21757def\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperf3dc21757def\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperf3dc21757def\PhpParser\Node $node) : \_PhpScoperf3dc21757def\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperf3dc21757def\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperf3dc21757def\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperf3dc21757def\PhpParser\Node\Stmt && $new instanceof \_PhpScoperf3dc21757def\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperf3dc21757def\PhpParser\Node\Expr && $new instanceof \_PhpScoperf3dc21757def\PhpParser\Node\Stmt) {
