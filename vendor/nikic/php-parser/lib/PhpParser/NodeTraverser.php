...
class NodeTraverser implements \_PhpScoper6224e3b16fcc\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper6224e3b16fcc\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper6224e3b16fcc\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper6224e3b16fcc\PhpParser\Node $node) : \_PhpScoper6224e3b16fcc\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper6224e3b16fcc\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper6224e3b16fcc\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper6224e3b16fcc\PhpParser\Node\Stmt && $new instanceof \_PhpScoper6224e3b16fcc\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper6224e3b16fcc\PhpParser\Node\Expr && $new instanceof \_PhpScoper6224e3b16fcc\PhpParser\Node\Stmt) {
