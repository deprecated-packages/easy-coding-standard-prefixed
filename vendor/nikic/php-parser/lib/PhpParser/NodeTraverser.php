...
class NodeTraverser implements \_PhpScopera34ae19e8d40\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera34ae19e8d40\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera34ae19e8d40\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera34ae19e8d40\PhpParser\Node $node) : \_PhpScopera34ae19e8d40\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera34ae19e8d40\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera34ae19e8d40\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera34ae19e8d40\PhpParser\Node\Stmt && $new instanceof \_PhpScopera34ae19e8d40\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera34ae19e8d40\PhpParser\Node\Expr && $new instanceof \_PhpScopera34ae19e8d40\PhpParser\Node\Stmt) {
