...
class NodeTraverser implements \_PhpScoper11a6395266c4\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper11a6395266c4\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper11a6395266c4\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper11a6395266c4\PhpParser\Node $node) : \_PhpScoper11a6395266c4\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper11a6395266c4\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper11a6395266c4\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper11a6395266c4\PhpParser\Node\Stmt && $new instanceof \_PhpScoper11a6395266c4\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper11a6395266c4\PhpParser\Node\Expr && $new instanceof \_PhpScoper11a6395266c4\PhpParser\Node\Stmt) {
