...
class NodeTraverser implements \_PhpScoperfab1bfb7ec99\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperfab1bfb7ec99\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperfab1bfb7ec99\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperfab1bfb7ec99\PhpParser\Node $node) : \_PhpScoperfab1bfb7ec99\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperfab1bfb7ec99\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperfab1bfb7ec99\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperfab1bfb7ec99\PhpParser\Node\Stmt && $new instanceof \_PhpScoperfab1bfb7ec99\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperfab1bfb7ec99\PhpParser\Node\Expr && $new instanceof \_PhpScoperfab1bfb7ec99\PhpParser\Node\Stmt) {
