...
class NodeTraverser implements \_PhpScopera9d6b451df71\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera9d6b451df71\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera9d6b451df71\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera9d6b451df71\PhpParser\Node $node) : \_PhpScopera9d6b451df71\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera9d6b451df71\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera9d6b451df71\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera9d6b451df71\PhpParser\Node\Stmt && $new instanceof \_PhpScopera9d6b451df71\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera9d6b451df71\PhpParser\Node\Expr && $new instanceof \_PhpScopera9d6b451df71\PhpParser\Node\Stmt) {
