...
class NodeTraverser implements \_PhpScoperfb0714773dc5\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperfb0714773dc5\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperfb0714773dc5\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperfb0714773dc5\PhpParser\Node $node) : \_PhpScoperfb0714773dc5\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperfb0714773dc5\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperfb0714773dc5\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperfb0714773dc5\PhpParser\Node\Stmt && $new instanceof \_PhpScoperfb0714773dc5\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperfb0714773dc5\PhpParser\Node\Expr && $new instanceof \_PhpScoperfb0714773dc5\PhpParser\Node\Stmt) {
