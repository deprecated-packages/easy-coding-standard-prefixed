...
class NodeTraverser implements \_PhpScoper02b5d1bf8fec\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper02b5d1bf8fec\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper02b5d1bf8fec\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper02b5d1bf8fec\PhpParser\Node $node) : \_PhpScoper02b5d1bf8fec\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper02b5d1bf8fec\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper02b5d1bf8fec\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper02b5d1bf8fec\PhpParser\Node\Stmt && $new instanceof \_PhpScoper02b5d1bf8fec\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper02b5d1bf8fec\PhpParser\Node\Expr && $new instanceof \_PhpScoper02b5d1bf8fec\PhpParser\Node\Stmt) {
