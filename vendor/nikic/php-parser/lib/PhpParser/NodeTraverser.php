...
class NodeTraverser implements \_PhpScoper3ba93baeac18\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper3ba93baeac18\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper3ba93baeac18\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper3ba93baeac18\PhpParser\Node $node) : \_PhpScoper3ba93baeac18\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper3ba93baeac18\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper3ba93baeac18\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper3ba93baeac18\PhpParser\Node\Stmt && $new instanceof \_PhpScoper3ba93baeac18\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper3ba93baeac18\PhpParser\Node\Expr && $new instanceof \_PhpScoper3ba93baeac18\PhpParser\Node\Stmt) {
