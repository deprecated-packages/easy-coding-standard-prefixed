...
class NodeTraverser implements \_PhpScoper5c006f5f032f\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper5c006f5f032f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper5c006f5f032f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper5c006f5f032f\PhpParser\Node $node) : \_PhpScoper5c006f5f032f\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper5c006f5f032f\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper5c006f5f032f\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper5c006f5f032f\PhpParser\Node\Stmt && $new instanceof \_PhpScoper5c006f5f032f\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper5c006f5f032f\PhpParser\Node\Expr && $new instanceof \_PhpScoper5c006f5f032f\PhpParser\Node\Stmt) {
