...
class NodeTraverser implements \_PhpScopera04bf8e97c06\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera04bf8e97c06\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera04bf8e97c06\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera04bf8e97c06\PhpParser\Node $node) : \_PhpScopera04bf8e97c06\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera04bf8e97c06\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera04bf8e97c06\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera04bf8e97c06\PhpParser\Node\Stmt && $new instanceof \_PhpScopera04bf8e97c06\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera04bf8e97c06\PhpParser\Node\Expr && $new instanceof \_PhpScopera04bf8e97c06\PhpParser\Node\Stmt) {
