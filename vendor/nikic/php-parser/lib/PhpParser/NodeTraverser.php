...
class NodeTraverser implements \_PhpScoperb458b528613f\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperb458b528613f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperb458b528613f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperb458b528613f\PhpParser\Node $node) : \_PhpScoperb458b528613f\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperb458b528613f\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperb458b528613f\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperb458b528613f\PhpParser\Node\Stmt && $new instanceof \_PhpScoperb458b528613f\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperb458b528613f\PhpParser\Node\Expr && $new instanceof \_PhpScoperb458b528613f\PhpParser\Node\Stmt) {
