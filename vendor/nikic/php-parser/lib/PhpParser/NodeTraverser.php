...
class NodeTraverser implements \_PhpScoper2f75f00bf6fa\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper2f75f00bf6fa\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper2f75f00bf6fa\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper2f75f00bf6fa\PhpParser\Node $node) : \_PhpScoper2f75f00bf6fa\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper2f75f00bf6fa\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper2f75f00bf6fa\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper2f75f00bf6fa\PhpParser\Node\Stmt && $new instanceof \_PhpScoper2f75f00bf6fa\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper2f75f00bf6fa\PhpParser\Node\Expr && $new instanceof \_PhpScoper2f75f00bf6fa\PhpParser\Node\Stmt) {
