...
class NodeTraverser implements \_PhpScoper56c9df53a081\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper56c9df53a081\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper56c9df53a081\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper56c9df53a081\PhpParser\Node $node) : \_PhpScoper56c9df53a081\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper56c9df53a081\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper56c9df53a081\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper56c9df53a081\PhpParser\Node\Stmt && $new instanceof \_PhpScoper56c9df53a081\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper56c9df53a081\PhpParser\Node\Expr && $new instanceof \_PhpScoper56c9df53a081\PhpParser\Node\Stmt) {
