...
class NodeTraverser implements \_PhpScoperdf15f2b748e9\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoperdf15f2b748e9\PhpParser\Node $node) : \_PhpScoperdf15f2b748e9\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperdf15f2b748e9\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperdf15f2b748e9\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperdf15f2b748e9\PhpParser\Node\Stmt && $new instanceof \_PhpScoperdf15f2b748e9\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperdf15f2b748e9\PhpParser\Node\Expr && $new instanceof \_PhpScoperdf15f2b748e9\PhpParser\Node\Stmt) {
