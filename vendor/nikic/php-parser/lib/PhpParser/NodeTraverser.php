...
class NodeTraverser implements \_PhpScoper2b44cb0c30af\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper2b44cb0c30af\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper2b44cb0c30af\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper2b44cb0c30af\PhpParser\Node $node) : \_PhpScoper2b44cb0c30af\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt && $new instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Expr && $new instanceof \_PhpScoper2b44cb0c30af\PhpParser\Node\Stmt) {
