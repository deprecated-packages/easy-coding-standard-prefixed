...
class NodeTraverser implements \_PhpScoper8e2d8a2760d1\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper8e2d8a2760d1\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper8e2d8a2760d1\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper8e2d8a2760d1\PhpParser\Node $node) : \_PhpScoper8e2d8a2760d1\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper8e2d8a2760d1\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper8e2d8a2760d1\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper8e2d8a2760d1\PhpParser\Node\Stmt && $new instanceof \_PhpScoper8e2d8a2760d1\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper8e2d8a2760d1\PhpParser\Node\Expr && $new instanceof \_PhpScoper8e2d8a2760d1\PhpParser\Node\Stmt) {
