...
class NodeTraverser implements \_PhpScoper64ca614e27fd\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper64ca614e27fd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper64ca614e27fd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper64ca614e27fd\PhpParser\Node $node) : \_PhpScoper64ca614e27fd\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper64ca614e27fd\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper64ca614e27fd\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper64ca614e27fd\PhpParser\Node\Stmt && $new instanceof \_PhpScoper64ca614e27fd\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper64ca614e27fd\PhpParser\Node\Expr && $new instanceof \_PhpScoper64ca614e27fd\PhpParser\Node\Stmt) {
