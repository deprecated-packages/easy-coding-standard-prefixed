...
class NodeTraverser implements \_PhpScoper971ef29294dd\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper971ef29294dd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper971ef29294dd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper971ef29294dd\PhpParser\Node $node) : \_PhpScoper971ef29294dd\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper971ef29294dd\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper971ef29294dd\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper971ef29294dd\PhpParser\Node\Stmt && $new instanceof \_PhpScoper971ef29294dd\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper971ef29294dd\PhpParser\Node\Expr && $new instanceof \_PhpScoper971ef29294dd\PhpParser\Node\Stmt) {
