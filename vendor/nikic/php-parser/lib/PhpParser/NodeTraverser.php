...
class NodeTraverser implements \_PhpScoperd35c27cd4b09\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperd35c27cd4b09\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperd35c27cd4b09\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperd35c27cd4b09\PhpParser\Node $node) : \_PhpScoperd35c27cd4b09\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperd35c27cd4b09\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperd35c27cd4b09\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperd35c27cd4b09\PhpParser\Node\Stmt && $new instanceof \_PhpScoperd35c27cd4b09\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperd35c27cd4b09\PhpParser\Node\Expr && $new instanceof \_PhpScoperd35c27cd4b09\PhpParser\Node\Stmt) {
