...
class NodeTraverser implements \_PhpScoper83a475a0590e\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper83a475a0590e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper83a475a0590e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper83a475a0590e\PhpParser\Node $node) : \_PhpScoper83a475a0590e\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper83a475a0590e\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper83a475a0590e\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper83a475a0590e\PhpParser\Node\Stmt && $new instanceof \_PhpScoper83a475a0590e\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper83a475a0590e\PhpParser\Node\Expr && $new instanceof \_PhpScoper83a475a0590e\PhpParser\Node\Stmt) {
