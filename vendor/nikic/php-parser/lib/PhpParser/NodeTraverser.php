...
class NodeTraverser implements \_PhpScoper4d05106cc3c0\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper4d05106cc3c0\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper4d05106cc3c0\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper4d05106cc3c0\PhpParser\Node $node) : \_PhpScoper4d05106cc3c0\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper4d05106cc3c0\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper4d05106cc3c0\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper4d05106cc3c0\PhpParser\Node\Stmt && $new instanceof \_PhpScoper4d05106cc3c0\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper4d05106cc3c0\PhpParser\Node\Expr && $new instanceof \_PhpScoper4d05106cc3c0\PhpParser\Node\Stmt) {
