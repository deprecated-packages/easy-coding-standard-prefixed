...
class NodeTraverser implements \_PhpScoper21763e6c7ac4\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper21763e6c7ac4\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper21763e6c7ac4\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper21763e6c7ac4\PhpParser\Node $node) : \_PhpScoper21763e6c7ac4\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper21763e6c7ac4\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper21763e6c7ac4\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper21763e6c7ac4\PhpParser\Node\Stmt && $new instanceof \_PhpScoper21763e6c7ac4\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper21763e6c7ac4\PhpParser\Node\Expr && $new instanceof \_PhpScoper21763e6c7ac4\PhpParser\Node\Stmt) {
