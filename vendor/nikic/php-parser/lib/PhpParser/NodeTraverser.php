...
class NodeTraverser implements \_PhpScoper279cf54b77ad\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper279cf54b77ad\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper279cf54b77ad\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper279cf54b77ad\PhpParser\Node $node) : \_PhpScoper279cf54b77ad\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper279cf54b77ad\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper279cf54b77ad\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper279cf54b77ad\PhpParser\Node\Stmt && $new instanceof \_PhpScoper279cf54b77ad\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper279cf54b77ad\PhpParser\Node\Expr && $new instanceof \_PhpScoper279cf54b77ad\PhpParser\Node\Stmt) {
