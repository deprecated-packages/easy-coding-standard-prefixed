...
class NodeTraverser implements \_PhpScoperdc8fbcd7c69d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperdc8fbcd7c69d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperdc8fbcd7c69d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperdc8fbcd7c69d\PhpParser\Node $node) : \_PhpScoperdc8fbcd7c69d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperdc8fbcd7c69d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperdc8fbcd7c69d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Stmt && $new instanceof \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Expr && $new instanceof \_PhpScoperdc8fbcd7c69d\PhpParser\Node\Stmt) {
