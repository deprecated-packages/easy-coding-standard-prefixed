...
class NodeTraverser implements \_PhpScoper68a3a2539032\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper68a3a2539032\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper68a3a2539032\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper68a3a2539032\PhpParser\Node $node) : \_PhpScoper68a3a2539032\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper68a3a2539032\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper68a3a2539032\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper68a3a2539032\PhpParser\Node\Stmt && $new instanceof \_PhpScoper68a3a2539032\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper68a3a2539032\PhpParser\Node\Expr && $new instanceof \_PhpScoper68a3a2539032\PhpParser\Node\Stmt) {
