...
class NodeTraverser implements \_PhpScoper239b374a39c8\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper239b374a39c8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper239b374a39c8\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper239b374a39c8\PhpParser\Node $node) : \_PhpScoper239b374a39c8\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper239b374a39c8\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper239b374a39c8\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper239b374a39c8\PhpParser\Node\Stmt && $new instanceof \_PhpScoper239b374a39c8\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper239b374a39c8\PhpParser\Node\Expr && $new instanceof \_PhpScoper239b374a39c8\PhpParser\Node\Stmt) {
