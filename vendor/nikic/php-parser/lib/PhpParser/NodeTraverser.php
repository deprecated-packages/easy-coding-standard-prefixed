...
class NodeTraverser implements \_PhpScoper842c7347e6be\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoper842c7347e6be\PhpParser\Node $node) : \_PhpScoper842c7347e6be\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper842c7347e6be\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper842c7347e6be\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper842c7347e6be\PhpParser\Node\Stmt && $new instanceof \_PhpScoper842c7347e6be\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper842c7347e6be\PhpParser\Node\Expr && $new instanceof \_PhpScoper842c7347e6be\PhpParser\Node\Stmt) {
