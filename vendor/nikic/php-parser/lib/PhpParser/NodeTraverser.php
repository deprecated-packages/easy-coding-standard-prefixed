...
class NodeTraverser implements \_PhpScoper13160cf3462c\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper13160cf3462c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper13160cf3462c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper13160cf3462c\PhpParser\Node $node) : \_PhpScoper13160cf3462c\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper13160cf3462c\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper13160cf3462c\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper13160cf3462c\PhpParser\Node\Stmt && $new instanceof \_PhpScoper13160cf3462c\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper13160cf3462c\PhpParser\Node\Expr && $new instanceof \_PhpScoper13160cf3462c\PhpParser\Node\Stmt) {
