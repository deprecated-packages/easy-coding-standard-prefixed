...
class NodeTraverser implements \_PhpScoper776637f3d3c3\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper776637f3d3c3\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper776637f3d3c3\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper776637f3d3c3\PhpParser\Node $node) : \_PhpScoper776637f3d3c3\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper776637f3d3c3\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper776637f3d3c3\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper776637f3d3c3\PhpParser\Node\Stmt && $new instanceof \_PhpScoper776637f3d3c3\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper776637f3d3c3\PhpParser\Node\Expr && $new instanceof \_PhpScoper776637f3d3c3\PhpParser\Node\Stmt) {
