...
class NodeTraverser implements \_PhpScoper8db4616aa69d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper8db4616aa69d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper8db4616aa69d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper8db4616aa69d\PhpParser\Node $node) : \_PhpScoper8db4616aa69d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper8db4616aa69d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper8db4616aa69d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper8db4616aa69d\PhpParser\Node\Stmt && $new instanceof \_PhpScoper8db4616aa69d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper8db4616aa69d\PhpParser\Node\Expr && $new instanceof \_PhpScoper8db4616aa69d\PhpParser\Node\Stmt) {
