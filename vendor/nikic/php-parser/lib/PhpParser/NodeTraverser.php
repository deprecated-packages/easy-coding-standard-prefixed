...
class NodeTraverser implements \_PhpScoper6db4fde00cda\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoper6db4fde00cda\PhpParser\Node $node) : \_PhpScoper6db4fde00cda\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper6db4fde00cda\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper6db4fde00cda\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper6db4fde00cda\PhpParser\Node\Stmt && $new instanceof \_PhpScoper6db4fde00cda\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper6db4fde00cda\PhpParser\Node\Expr && $new instanceof \_PhpScoper6db4fde00cda\PhpParser\Node\Stmt) {
