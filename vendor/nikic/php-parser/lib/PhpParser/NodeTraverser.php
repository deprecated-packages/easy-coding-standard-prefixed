...
class NodeTraverser implements \_PhpScoper8a0112f19f39\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper8a0112f19f39\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper8a0112f19f39\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper8a0112f19f39\PhpParser\Node $node) : \_PhpScoper8a0112f19f39\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper8a0112f19f39\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper8a0112f19f39\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper8a0112f19f39\PhpParser\Node\Stmt && $new instanceof \_PhpScoper8a0112f19f39\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper8a0112f19f39\PhpParser\Node\Expr && $new instanceof \_PhpScoper8a0112f19f39\PhpParser\Node\Stmt) {
