...
class NodeTraverser implements \_PhpScoper17bb67c99ade\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper17bb67c99ade\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper17bb67c99ade\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper17bb67c99ade\PhpParser\Node $node) : \_PhpScoper17bb67c99ade\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper17bb67c99ade\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper17bb67c99ade\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper17bb67c99ade\PhpParser\Node\Stmt && $new instanceof \_PhpScoper17bb67c99ade\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper17bb67c99ade\PhpParser\Node\Expr && $new instanceof \_PhpScoper17bb67c99ade\PhpParser\Node\Stmt) {
