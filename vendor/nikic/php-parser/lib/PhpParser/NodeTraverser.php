...
class NodeTraverser implements \_PhpScoper578a67c80b2b\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper578a67c80b2b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper578a67c80b2b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper578a67c80b2b\PhpParser\Node $node) : \_PhpScoper578a67c80b2b\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper578a67c80b2b\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper578a67c80b2b\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper578a67c80b2b\PhpParser\Node\Stmt && $new instanceof \_PhpScoper578a67c80b2b\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper578a67c80b2b\PhpParser\Node\Expr && $new instanceof \_PhpScoper578a67c80b2b\PhpParser\Node\Stmt) {
