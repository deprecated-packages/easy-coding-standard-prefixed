...
class NodeTraverser implements \_PhpScoper9d73a84b09ad\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper9d73a84b09ad\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper9d73a84b09ad\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper9d73a84b09ad\PhpParser\Node $node) : \_PhpScoper9d73a84b09ad\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper9d73a84b09ad\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper9d73a84b09ad\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper9d73a84b09ad\PhpParser\Node\Stmt && $new instanceof \_PhpScoper9d73a84b09ad\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper9d73a84b09ad\PhpParser\Node\Expr && $new instanceof \_PhpScoper9d73a84b09ad\PhpParser\Node\Stmt) {
