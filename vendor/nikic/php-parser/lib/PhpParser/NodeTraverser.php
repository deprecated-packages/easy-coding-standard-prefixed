...
class NodeTraverser implements \_PhpScoper06c66bea2cf6\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper06c66bea2cf6\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper06c66bea2cf6\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper06c66bea2cf6\PhpParser\Node $node) : \_PhpScoper06c66bea2cf6\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper06c66bea2cf6\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper06c66bea2cf6\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper06c66bea2cf6\PhpParser\Node\Stmt && $new instanceof \_PhpScoper06c66bea2cf6\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper06c66bea2cf6\PhpParser\Node\Expr && $new instanceof \_PhpScoper06c66bea2cf6\PhpParser\Node\Stmt) {
