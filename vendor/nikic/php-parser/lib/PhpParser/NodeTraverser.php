...
class NodeTraverser implements \_PhpScoper3b1d73f28e67\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoper3b1d73f28e67\PhpParser\Node $node) : \_PhpScoper3b1d73f28e67\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper3b1d73f28e67\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper3b1d73f28e67\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper3b1d73f28e67\PhpParser\Node\Stmt && $new instanceof \_PhpScoper3b1d73f28e67\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper3b1d73f28e67\PhpParser\Node\Expr && $new instanceof \_PhpScoper3b1d73f28e67\PhpParser\Node\Stmt) {
