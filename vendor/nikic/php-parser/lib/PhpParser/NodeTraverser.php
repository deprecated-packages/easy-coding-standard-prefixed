...
class NodeTraverser implements \_PhpScoperb36402634947\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperb36402634947\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperb36402634947\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperb36402634947\PhpParser\Node $node) : \_PhpScoperb36402634947\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperb36402634947\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperb36402634947\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperb36402634947\PhpParser\Node\Stmt && $new instanceof \_PhpScoperb36402634947\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperb36402634947\PhpParser\Node\Expr && $new instanceof \_PhpScoperb36402634947\PhpParser\Node\Stmt) {
