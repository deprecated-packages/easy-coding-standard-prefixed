...
class NodeTraverser implements \_PhpScoperda2604e33acb\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperda2604e33acb\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperda2604e33acb\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperda2604e33acb\PhpParser\Node $node) : \_PhpScoperda2604e33acb\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperda2604e33acb\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperda2604e33acb\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperda2604e33acb\PhpParser\Node\Stmt && $new instanceof \_PhpScoperda2604e33acb\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperda2604e33acb\PhpParser\Node\Expr && $new instanceof \_PhpScoperda2604e33acb\PhpParser\Node\Stmt) {
