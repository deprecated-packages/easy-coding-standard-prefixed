...
class NodeTraverser implements \_PhpScoperf7b66f9e3817\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperf7b66f9e3817\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperf7b66f9e3817\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperf7b66f9e3817\PhpParser\Node $node) : \_PhpScoperf7b66f9e3817\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperf7b66f9e3817\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperf7b66f9e3817\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperf7b66f9e3817\PhpParser\Node\Stmt && $new instanceof \_PhpScoperf7b66f9e3817\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperf7b66f9e3817\PhpParser\Node\Expr && $new instanceof \_PhpScoperf7b66f9e3817\PhpParser\Node\Stmt) {
