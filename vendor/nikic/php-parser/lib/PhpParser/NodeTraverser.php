...
class NodeTraverser implements \_PhpScoperea337ed74749\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperea337ed74749\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperea337ed74749\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperea337ed74749\PhpParser\Node $node) : \_PhpScoperea337ed74749\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperea337ed74749\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperea337ed74749\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperea337ed74749\PhpParser\Node\Stmt && $new instanceof \_PhpScoperea337ed74749\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperea337ed74749\PhpParser\Node\Expr && $new instanceof \_PhpScoperea337ed74749\PhpParser\Node\Stmt) {
