...
class NodeTraverser implements \_PhpScoper807f8e74693b\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoper807f8e74693b\PhpParser\Node $node) : \_PhpScoper807f8e74693b\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper807f8e74693b\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper807f8e74693b\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper807f8e74693b\PhpParser\Node\Stmt && $new instanceof \_PhpScoper807f8e74693b\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper807f8e74693b\PhpParser\Node\Expr && $new instanceof \_PhpScoper807f8e74693b\PhpParser\Node\Stmt) {
