...
class NodeTraverser implements \_PhpScoper6c2f17c43d2d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper6c2f17c43d2d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper6c2f17c43d2d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper6c2f17c43d2d\PhpParser\Node $node) : \_PhpScoper6c2f17c43d2d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper6c2f17c43d2d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper6c2f17c43d2d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper6c2f17c43d2d\PhpParser\Node\Stmt && $new instanceof \_PhpScoper6c2f17c43d2d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper6c2f17c43d2d\PhpParser\Node\Expr && $new instanceof \_PhpScoper6c2f17c43d2d\PhpParser\Node\Stmt) {
