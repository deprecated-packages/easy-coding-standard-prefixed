...
class NodeTraverser implements \_PhpScopercda2b863d098\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopercda2b863d098\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopercda2b863d098\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopercda2b863d098\PhpParser\Node $node) : \_PhpScopercda2b863d098\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopercda2b863d098\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopercda2b863d098\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopercda2b863d098\PhpParser\Node\Stmt && $new instanceof \_PhpScopercda2b863d098\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopercda2b863d098\PhpParser\Node\Expr && $new instanceof \_PhpScopercda2b863d098\PhpParser\Node\Stmt) {
