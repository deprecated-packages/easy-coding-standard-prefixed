...
class NodeTraverser implements \_PhpScoper5ca2d8bcb02c\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper5ca2d8bcb02c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper5ca2d8bcb02c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper5ca2d8bcb02c\PhpParser\Node $node) : \_PhpScoper5ca2d8bcb02c\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper5ca2d8bcb02c\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper5ca2d8bcb02c\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper5ca2d8bcb02c\PhpParser\Node\Stmt && $new instanceof \_PhpScoper5ca2d8bcb02c\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper5ca2d8bcb02c\PhpParser\Node\Expr && $new instanceof \_PhpScoper5ca2d8bcb02c\PhpParser\Node\Stmt) {
