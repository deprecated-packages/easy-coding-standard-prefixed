...
class NodeTraverser implements \_PhpScoper839420027581\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper839420027581\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper839420027581\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper839420027581\PhpParser\Node $node) : \_PhpScoper839420027581\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper839420027581\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper839420027581\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper839420027581\PhpParser\Node\Stmt && $new instanceof \_PhpScoper839420027581\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper839420027581\PhpParser\Node\Expr && $new instanceof \_PhpScoper839420027581\PhpParser\Node\Stmt) {
