...
class NodeTraverser implements \_PhpScoperad68e34a80c5\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperad68e34a80c5\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperad68e34a80c5\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperad68e34a80c5\PhpParser\Node $node) : \_PhpScoperad68e34a80c5\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperad68e34a80c5\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperad68e34a80c5\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperad68e34a80c5\PhpParser\Node\Stmt && $new instanceof \_PhpScoperad68e34a80c5\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperad68e34a80c5\PhpParser\Node\Expr && $new instanceof \_PhpScoperad68e34a80c5\PhpParser\Node\Stmt) {
