...
class NodeTraverser implements \_PhpScoper3d6b50c3ca2f\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper3d6b50c3ca2f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper3d6b50c3ca2f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper3d6b50c3ca2f\PhpParser\Node $node) : \_PhpScoper3d6b50c3ca2f\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper3d6b50c3ca2f\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper3d6b50c3ca2f\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper3d6b50c3ca2f\PhpParser\Node\Stmt && $new instanceof \_PhpScoper3d6b50c3ca2f\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper3d6b50c3ca2f\PhpParser\Node\Expr && $new instanceof \_PhpScoper3d6b50c3ca2f\PhpParser\Node\Stmt) {
