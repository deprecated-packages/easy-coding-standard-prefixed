...
class NodeTraverser implements \_PhpScoper13133e188f67\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper13133e188f67\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper13133e188f67\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper13133e188f67\PhpParser\Node $node) : \_PhpScoper13133e188f67\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper13133e188f67\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper13133e188f67\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper13133e188f67\PhpParser\Node\Stmt && $new instanceof \_PhpScoper13133e188f67\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper13133e188f67\PhpParser\Node\Expr && $new instanceof \_PhpScoper13133e188f67\PhpParser\Node\Stmt) {
