...
class NodeTraverser implements \_PhpScoper4d3fa30a680b\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper4d3fa30a680b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper4d3fa30a680b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper4d3fa30a680b\PhpParser\Node $node) : \_PhpScoper4d3fa30a680b\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper4d3fa30a680b\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper4d3fa30a680b\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper4d3fa30a680b\PhpParser\Node\Stmt && $new instanceof \_PhpScoper4d3fa30a680b\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper4d3fa30a680b\PhpParser\Node\Expr && $new instanceof \_PhpScoper4d3fa30a680b\PhpParser\Node\Stmt) {
