...
class NodeTraverser implements \_PhpScoper833c56a97273\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper833c56a97273\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper833c56a97273\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper833c56a97273\PhpParser\Node $node) : \_PhpScoper833c56a97273\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper833c56a97273\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper833c56a97273\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper833c56a97273\PhpParser\Node\Stmt && $new instanceof \_PhpScoper833c56a97273\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper833c56a97273\PhpParser\Node\Expr && $new instanceof \_PhpScoper833c56a97273\PhpParser\Node\Stmt) {
