...
class NodeTraverser implements \_PhpScoper326af2119eba\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper326af2119eba\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper326af2119eba\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper326af2119eba\PhpParser\Node $node) : \_PhpScoper326af2119eba\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper326af2119eba\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper326af2119eba\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper326af2119eba\PhpParser\Node\Stmt && $new instanceof \_PhpScoper326af2119eba\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper326af2119eba\PhpParser\Node\Expr && $new instanceof \_PhpScoper326af2119eba\PhpParser\Node\Stmt) {
