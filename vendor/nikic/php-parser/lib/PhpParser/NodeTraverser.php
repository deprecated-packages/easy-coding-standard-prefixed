...
class NodeTraverser implements \_PhpScoper10b1b2c5ca55\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoper10b1b2c5ca55\PhpParser\Node $node) : \_PhpScoper10b1b2c5ca55\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper10b1b2c5ca55\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper10b1b2c5ca55\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper10b1b2c5ca55\PhpParser\Node\Stmt && $new instanceof \_PhpScoper10b1b2c5ca55\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper10b1b2c5ca55\PhpParser\Node\Expr && $new instanceof \_PhpScoper10b1b2c5ca55\PhpParser\Node\Stmt) {
