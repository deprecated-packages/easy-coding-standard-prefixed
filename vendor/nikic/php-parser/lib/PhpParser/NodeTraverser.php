...
class NodeTraverser implements \_PhpScoper9ef667a5e42c\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper9ef667a5e42c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper9ef667a5e42c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper9ef667a5e42c\PhpParser\Node $node) : \_PhpScoper9ef667a5e42c\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper9ef667a5e42c\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper9ef667a5e42c\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper9ef667a5e42c\PhpParser\Node\Stmt && $new instanceof \_PhpScoper9ef667a5e42c\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper9ef667a5e42c\PhpParser\Node\Expr && $new instanceof \_PhpScoper9ef667a5e42c\PhpParser\Node\Stmt) {
