...
class NodeTraverser implements \_PhpScoper23ef26a4fb01\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper23ef26a4fb01\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper23ef26a4fb01\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper23ef26a4fb01\PhpParser\Node $node) : \_PhpScoper23ef26a4fb01\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper23ef26a4fb01\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper23ef26a4fb01\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper23ef26a4fb01\PhpParser\Node\Stmt && $new instanceof \_PhpScoper23ef26a4fb01\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper23ef26a4fb01\PhpParser\Node\Expr && $new instanceof \_PhpScoper23ef26a4fb01\PhpParser\Node\Stmt) {
