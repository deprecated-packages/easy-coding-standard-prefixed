...
class NodeTraverser implements \_PhpScoper58a0a169dcfb\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper58a0a169dcfb\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper58a0a169dcfb\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper58a0a169dcfb\PhpParser\Node $node) : \_PhpScoper58a0a169dcfb\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper58a0a169dcfb\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper58a0a169dcfb\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper58a0a169dcfb\PhpParser\Node\Stmt && $new instanceof \_PhpScoper58a0a169dcfb\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper58a0a169dcfb\PhpParser\Node\Expr && $new instanceof \_PhpScoper58a0a169dcfb\PhpParser\Node\Stmt) {
