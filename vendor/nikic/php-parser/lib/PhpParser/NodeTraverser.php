...
class NodeTraverser implements \_PhpScoper47644ab3aa9a\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper47644ab3aa9a\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper47644ab3aa9a\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper47644ab3aa9a\PhpParser\Node $node) : \_PhpScoper47644ab3aa9a\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper47644ab3aa9a\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper47644ab3aa9a\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper47644ab3aa9a\PhpParser\Node\Stmt && $new instanceof \_PhpScoper47644ab3aa9a\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper47644ab3aa9a\PhpParser\Node\Expr && $new instanceof \_PhpScoper47644ab3aa9a\PhpParser\Node\Stmt) {
