...
class NodeTraverser implements \_PhpScoperc753ccca5a0c\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperc753ccca5a0c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperc753ccca5a0c\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperc753ccca5a0c\PhpParser\Node $node) : \_PhpScoperc753ccca5a0c\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperc753ccca5a0c\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperc753ccca5a0c\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperc753ccca5a0c\PhpParser\Node\Stmt && $new instanceof \_PhpScoperc753ccca5a0c\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperc753ccca5a0c\PhpParser\Node\Expr && $new instanceof \_PhpScoperc753ccca5a0c\PhpParser\Node\Stmt) {
