...
class NodeTraverser implements \_PhpScoper79449c4e744b\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper79449c4e744b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper79449c4e744b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper79449c4e744b\PhpParser\Node $node) : \_PhpScoper79449c4e744b\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper79449c4e744b\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper79449c4e744b\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper79449c4e744b\PhpParser\Node\Stmt && $new instanceof \_PhpScoper79449c4e744b\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper79449c4e744b\PhpParser\Node\Expr && $new instanceof \_PhpScoper79449c4e744b\PhpParser\Node\Stmt) {
