...
class NodeTraverser implements \_PhpScoper528afa732cbd\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper528afa732cbd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper528afa732cbd\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper528afa732cbd\PhpParser\Node $node) : \_PhpScoper528afa732cbd\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper528afa732cbd\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper528afa732cbd\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper528afa732cbd\PhpParser\Node\Stmt && $new instanceof \_PhpScoper528afa732cbd\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper528afa732cbd\PhpParser\Node\Expr && $new instanceof \_PhpScoper528afa732cbd\PhpParser\Node\Stmt) {
