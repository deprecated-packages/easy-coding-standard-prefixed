...
class NodeTraverser implements \_PhpScopera1f11cc38772\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera1f11cc38772\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera1f11cc38772\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera1f11cc38772\PhpParser\Node $node) : \_PhpScopera1f11cc38772\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera1f11cc38772\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera1f11cc38772\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera1f11cc38772\PhpParser\Node\Stmt && $new instanceof \_PhpScopera1f11cc38772\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera1f11cc38772\PhpParser\Node\Expr && $new instanceof \_PhpScopera1f11cc38772\PhpParser\Node\Stmt) {
