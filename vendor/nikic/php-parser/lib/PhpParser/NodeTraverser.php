...
class NodeTraverser implements \_PhpScoper2637e9a72c68\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper2637e9a72c68\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper2637e9a72c68\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper2637e9a72c68\PhpParser\Node $node) : \_PhpScoper2637e9a72c68\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper2637e9a72c68\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper2637e9a72c68\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper2637e9a72c68\PhpParser\Node\Stmt && $new instanceof \_PhpScoper2637e9a72c68\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper2637e9a72c68\PhpParser\Node\Expr && $new instanceof \_PhpScoper2637e9a72c68\PhpParser\Node\Stmt) {
