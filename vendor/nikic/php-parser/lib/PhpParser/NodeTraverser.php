...
class NodeTraverser implements \_PhpScoperd1a5bf00e83e\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperd1a5bf00e83e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperd1a5bf00e83e\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperd1a5bf00e83e\PhpParser\Node $node) : \_PhpScoperd1a5bf00e83e\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperd1a5bf00e83e\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperd1a5bf00e83e\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperd1a5bf00e83e\PhpParser\Node\Stmt && $new instanceof \_PhpScoperd1a5bf00e83e\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperd1a5bf00e83e\PhpParser\Node\Expr && $new instanceof \_PhpScoperd1a5bf00e83e\PhpParser\Node\Stmt) {
