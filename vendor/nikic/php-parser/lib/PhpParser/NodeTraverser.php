...
class NodeTraverser implements \_PhpScoper269dc521b0fa\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper269dc521b0fa\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper269dc521b0fa\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper269dc521b0fa\PhpParser\Node $node) : \_PhpScoper269dc521b0fa\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper269dc521b0fa\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper269dc521b0fa\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper269dc521b0fa\PhpParser\Node\Stmt && $new instanceof \_PhpScoper269dc521b0fa\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper269dc521b0fa\PhpParser\Node\Expr && $new instanceof \_PhpScoper269dc521b0fa\PhpParser\Node\Stmt) {
