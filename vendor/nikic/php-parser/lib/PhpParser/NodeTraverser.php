...
class NodeTraverser implements \_PhpScoperf65af7a6d9a0\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperf65af7a6d9a0\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperf65af7a6d9a0\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperf65af7a6d9a0\PhpParser\Node $node) : \_PhpScoperf65af7a6d9a0\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperf65af7a6d9a0\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperf65af7a6d9a0\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperf65af7a6d9a0\PhpParser\Node\Stmt && $new instanceof \_PhpScoperf65af7a6d9a0\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperf65af7a6d9a0\PhpParser\Node\Expr && $new instanceof \_PhpScoperf65af7a6d9a0\PhpParser\Node\Stmt) {
