...
class NodeTraverser implements \_PhpScopera4be459e5e3d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera4be459e5e3d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera4be459e5e3d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera4be459e5e3d\PhpParser\Node $node) : \_PhpScopera4be459e5e3d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera4be459e5e3d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera4be459e5e3d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera4be459e5e3d\PhpParser\Node\Stmt && $new instanceof \_PhpScopera4be459e5e3d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera4be459e5e3d\PhpParser\Node\Expr && $new instanceof \_PhpScopera4be459e5e3d\PhpParser\Node\Stmt) {
