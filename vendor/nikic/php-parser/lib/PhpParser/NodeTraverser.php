...
class NodeTraverser implements \_PhpScoper065e4ba46e6d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\_PhpScoper065e4ba46e6d\PhpParser\Node $node) : \_PhpScoper065e4ba46e6d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper065e4ba46e6d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper065e4ba46e6d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper065e4ba46e6d\PhpParser\Node\Stmt && $new instanceof \_PhpScoper065e4ba46e6d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper065e4ba46e6d\PhpParser\Node\Expr && $new instanceof \_PhpScoper065e4ba46e6d\PhpParser\Node\Stmt) {
