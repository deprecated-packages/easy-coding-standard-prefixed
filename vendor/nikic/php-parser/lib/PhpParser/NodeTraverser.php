...
class NodeTraverser implements \_PhpScopera23ebff5477f\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScopera23ebff5477f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScopera23ebff5477f\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScopera23ebff5477f\PhpParser\Node $node) : \_PhpScopera23ebff5477f\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScopera23ebff5477f\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScopera23ebff5477f\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScopera23ebff5477f\PhpParser\Node\Stmt && $new instanceof \_PhpScopera23ebff5477f\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScopera23ebff5477f\PhpParser\Node\Expr && $new instanceof \_PhpScopera23ebff5477f\PhpParser\Node\Stmt) {
