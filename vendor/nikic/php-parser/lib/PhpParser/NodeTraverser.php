...
class NodeTraverser implements \_PhpScoper1103e00fb46b\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper1103e00fb46b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper1103e00fb46b\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper1103e00fb46b\PhpParser\Node $node) : \_PhpScoper1103e00fb46b\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper1103e00fb46b\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper1103e00fb46b\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper1103e00fb46b\PhpParser\Node\Stmt && $new instanceof \_PhpScoper1103e00fb46b\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper1103e00fb46b\PhpParser\Node\Expr && $new instanceof \_PhpScoper1103e00fb46b\PhpParser\Node\Stmt) {
