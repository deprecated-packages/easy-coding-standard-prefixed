...
class NodeTraverser implements \_PhpScoper9613f3fac51d\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoper9613f3fac51d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoper9613f3fac51d\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoper9613f3fac51d\PhpParser\Node $node) : \_PhpScoper9613f3fac51d\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoper9613f3fac51d\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoper9613f3fac51d\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoper9613f3fac51d\PhpParser\Node\Stmt && $new instanceof \_PhpScoper9613f3fac51d\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoper9613f3fac51d\PhpParser\Node\Expr && $new instanceof \_PhpScoper9613f3fac51d\PhpParser\Node\Stmt) {
