...
class NodeTraverser implements \_PhpScoperfacc742d2745\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperfacc742d2745\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperfacc742d2745\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperfacc742d2745\PhpParser\Node $node) : \_PhpScoperfacc742d2745\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperfacc742d2745\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperfacc742d2745\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperfacc742d2745\PhpParser\Node\Stmt && $new instanceof \_PhpScoperfacc742d2745\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperfacc742d2745\PhpParser\Node\Expr && $new instanceof \_PhpScoperfacc742d2745\PhpParser\Node\Stmt) {
