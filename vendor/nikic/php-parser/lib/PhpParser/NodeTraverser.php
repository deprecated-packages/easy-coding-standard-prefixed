...
class NodeTraverser implements \_PhpScoperc83f84c90b60\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\_PhpScoperc83f84c90b60\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\_PhpScoperc83f84c90b60\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\_PhpScoperc83f84c90b60\PhpParser\Node $node) : \_PhpScoperc83f84c90b60\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \_PhpScoperc83f84c90b60\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \_PhpScoperc83f84c90b60\PhpParser\Node) {
    ...
    {
        if ($old instanceof \_PhpScoperc83f84c90b60\PhpParser\Node\Stmt && $new instanceof \_PhpScoperc83f84c90b60\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \_PhpScoperc83f84c90b60\PhpParser\Node\Expr && $new instanceof \_PhpScoperc83f84c90b60\PhpParser\Node\Stmt) {
