...
final class DecoratesServiceOptionKeyYamlToPhpFactory implements \_PhpScoper4936962185e7\Migrify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoper4936962185e7\Migrify\PhpConfigPrinter\NodeFactory\ArgsNodeFactory $argsNodeFactory, \_PhpScoper4936962185e7\Migrify\PhpConfigPrinter\Sorter\YamlArgumentSorter $yamlArgumentSorter, \_PhpScoper4936962185e7\Migrify\PhpConfigPrinter\NodeFactory\CommonNodeFactory $commonNodeFactory)
    {
    ...
    public function decorateServiceMethodCall($key, $yaml, $values, \_PhpScoper4936962185e7\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoper4936962185e7\PhpParser\Node\Expr\MethodCall
    {
        ...
        return new \_PhpScoper4936962185e7\PhpParser\Node\Expr\MethodCall($methodCall, 'decorate', $args);
    }
    public function isMatch($key, $values) : bool
    {
        return $key === \_PhpScoper4936962185e7\Migrify\PhpConfigPrinter\ValueObject\YamlServiceKey::DECORATES;
    }
}
