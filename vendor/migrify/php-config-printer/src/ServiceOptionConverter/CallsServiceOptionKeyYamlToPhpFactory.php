...
final class CallsServiceOptionKeyYamlToPhpFactory implements \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
    ...
    {
        return $key === \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\ValueObject\YamlServiceKey::CALLS;
    }
}
