...
final class FactoryConfiguratorServiceOptionKeyYamlToPhpFactory implements \_PhpScoper4d05106cc3c0\Migrify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    public function decorateServiceMethodCall($key, $yaml, $values, \_PhpScoper4d05106cc3c0\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoper4d05106cc3c0\PhpParser\Node\Expr\MethodCall
    {
        ...
        return new \_PhpScoper4d05106cc3c0\PhpParser\Node\Expr\MethodCall($methodCall, 'factory', $args);
    }
    public function isMatch($key, $values) : bool
    {
        return \in_array($key, [\_PhpScoper4d05106cc3c0\Migrify\PhpConfigPrinter\ValueObject\YamlKey::FACTORY, \_PhpScoper4d05106cc3c0\Migrify\PhpConfigPrinter\ValueObject\YamlKey::CONFIGURATOR], \true);
    }
}
