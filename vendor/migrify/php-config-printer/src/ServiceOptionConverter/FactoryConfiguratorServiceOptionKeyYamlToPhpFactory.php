...
final class FactoryConfiguratorServiceOptionKeyYamlToPhpFactory implements \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    public function decorateServiceMethodCall($key, $yaml, $values, \_PhpScoper5a9febfbbe05\PhpParser\Node\Expr\MethodCall $methodCall) : \_PhpScoper5a9febfbbe05\PhpParser\Node\Expr\MethodCall
    {
        ...
        return new \_PhpScoper5a9febfbbe05\PhpParser\Node\Expr\MethodCall($methodCall, 'factory', $args);
    }
    public function isMatch($key, $values) : bool
    {
        return \in_array($key, [\_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\ValueObject\YamlKey::FACTORY, \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\ValueObject\YamlKey::CONFIGURATOR], \true);
    }
}
