 ...
 *         class: Other <---
 */
final class ClassServiceCaseConverter implements \_PhpScoper06c66bea2cf6\Migrify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var ArgsNodeFactory
     */
    ...
    {
        $args = $this->argsNodeFactory->createFromValues([$key, $values[\_PhpScoper06c66bea2cf6\Migrify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]]);
        $setMethodCall = new \_PhpScoper06c66bea2cf6\PhpParser\Node\Expr\MethodCall(new \_PhpScoper06c66bea2cf6\PhpParser\Node\Expr\Variable(\_PhpScoper06c66bea2cf6\Migrify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \_PhpScoper06c66bea2cf6\Migrify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
        unset($values[\_PhpScoper06c66bea2cf6\Migrify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]);
    ...
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return isset($values[\_PhpScoper06c66bea2cf6\Migrify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]) && !isset($values[\_PhpScoper06c66bea2cf6\Migrify\PhpConfigPrinter\ValueObject\YamlKey::ALIAS]);
    }
}
