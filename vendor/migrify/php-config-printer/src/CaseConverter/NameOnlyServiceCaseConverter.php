 ...
 */
final class NameOnlyServiceCaseConverter implements \_PhpScoper4f985154d5a0\Migrify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper4f985154d5a0\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper4f985154d5a0\PhpParser\Node\Expr\MethodCall(new \_PhpScoper4f985154d5a0\PhpParser\Node\Expr\Variable(\_PhpScoper4f985154d5a0\Migrify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper4f985154d5a0\PhpParser\Node\Arg($classConstFetch)]);
