 ...
 */
final class NameOnlyServiceCaseConverter implements \_PhpScoper207eb8f99af3\Migrify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper207eb8f99af3\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper207eb8f99af3\PhpParser\Node\Expr\MethodCall(new \_PhpScoper207eb8f99af3\PhpParser\Node\Expr\Variable(\_PhpScoper207eb8f99af3\Migrify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper207eb8f99af3\PhpParser\Node\Arg($classConstFetch)]);
