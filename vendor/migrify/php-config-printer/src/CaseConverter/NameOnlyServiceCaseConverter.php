 ...
 */
final class NameOnlyServiceCaseConverter implements \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper5a9febfbbe05\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \_PhpScoper5a9febfbbe05\PhpParser\Node\Expr\MethodCall(new \_PhpScoper5a9febfbbe05\PhpParser\Node\Expr\Variable(\_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \_PhpScoper5a9febfbbe05\PhpParser\Node\Arg($classConstFetch)]);
