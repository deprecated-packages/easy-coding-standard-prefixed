 ...
 *     _instanceof: <---
 */
final class InstanceOfNestedCaseConverter implements \_PhpScoper0270f1d35181\Migrify\PhpConfigPrinter\Contract\NestedCaseConverterInterface
{
    /**
    ...
    public function __construct(\_PhpScoper0270f1d35181\Migrify\PhpConfigPrinter\NodeFactory\CommonNodeFactory $commonNodeFactory, \_PhpScoper0270f1d35181\Migrify\PhpConfigPrinter\NodeFactory\Service\ServiceOptionNodeFactory $serviceOptionNodeFactory)
    {
    ...
    public function convertToMethodCall($key, $values) : \_PhpScoper0270f1d35181\PhpParser\Node\Stmt\Expression
    {
        ...
        $args = [new \_PhpScoper0270f1d35181\PhpParser\Node\Arg($classConstFetch)];
        $instanceofMethodCall = new \_PhpScoper0270f1d35181\PhpParser\Node\Expr\MethodCall($servicesVariable, \_PhpScoper0270f1d35181\Migrify\PhpConfigPrinter\ValueObject\MethodName::INSTANCEOF, $args);
        $instanceofMethodCall = $this->serviceOptionNodeFactory->convertServiceOptionsToNodes($values, $instanceofMethodCall);
        $expression = new \_PhpScoper0270f1d35181\PhpParser\Node\Stmt\Expression($instanceofMethodCall);
    ...
    public function match(string $rootKey, $subKey) : bool
    {
        ...
        return $subKey === \_PhpScoper0270f1d35181\Migrify\PhpConfigPrinter\ValueObject\YamlKey::_INSTANCEOF;
    }
}
