...
use _PhpScoper470d6df94ac0\Migrify\PhpConfigPrinter\PhpParser\NodeFactory\ConfiguratorClosureNodeFactory;
use _PhpScoper470d6df94ac0\PhpParser\Node;
use _PhpScoper470d6df94ac0\PhpParser\Node\Stmt\Return_;
final class RoutingConfiguratorReturnClosureFactory
{
     ...
     */
    public function __construct(\_PhpScoper470d6df94ac0\Migrify\PhpConfigPrinter\PhpParser\NodeFactory\ConfiguratorClosureNodeFactory $containerConfiguratorClosureNodeFactory, array $routingCaseConverters)
    {
    ...
    public function createFromArrayData(array $arrayData) : \_PhpScoper470d6df94ac0\PhpParser\Node\Stmt\Return_
    {
        $stmts = $this->createClosureStmts($arrayData);
        $closure = $this->containerConfiguratorClosureNodeFactory->createRoutingClosureFromStmts($stmts);
        return new \_PhpScoper470d6df94ac0\PhpParser\Node\Stmt\Return_($closure);
    }
    /**
     * @return Node[]
     */
