...
final class ContainerConfiguratorReturnClosureFactory
{
     ...
     */
    public function __construct(\_PhpScopercb576ca159b5\Migrify\PhpConfigPrinter\PhpParser\NodeFactory\ConfiguratorClosureNodeFactory $configuratorClosureNodeFactory, array $caseConverters, array $nestedCaseConverters)
    {
    ...
    public function createFromYamlArray(array $arrayData) : \_PhpScopercb576ca159b5\PhpParser\Node\Stmt\Return_
    {
    ...
    private function createInitializeAssign(string $variableName, string $methodName) : \_PhpScopercb576ca159b5\PhpParser\Node\Stmt\Expression
    {
        $servicesVariable = new \_PhpScopercb576ca159b5\PhpParser\Node\Expr\Variable($variableName);
        ...
        $assign = new \_PhpScopercb576ca159b5\PhpParser\Node\Expr\Assign($servicesVariable, new \_PhpScopercb576ca159b5\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, $methodName));
        return new \_PhpScopercb576ca159b5\PhpParser\Node\Stmt\Expression($assign);
    }
    private function createInitializeNode(string $key, array $nodes) : array
    {
        if ($key === \_PhpScopercb576ca159b5\Migrify\PhpConfigPrinter\ValueObject\YamlKey::SERVICES) {
            $nodes[] = $this->createInitializeAssign(\_PhpScopercb576ca159b5\Migrify\PhpConfigPrinter\ValueObject\VariableName::SERVICES, \_PhpScopercb576ca159b5\Migrify\PhpConfigPrinter\ValueObject\MethodName::SERVICES);
        }
        if ($key === \_PhpScopercb576ca159b5\Migrify\PhpConfigPrinter\ValueObject\YamlKey::PARAMETERS) {
            $nodes[] = $this->createInitializeAssign(\_PhpScopercb576ca159b5\Migrify\PhpConfigPrinter\ValueObject\VariableName::PARAMETERS, \_PhpScopercb576ca159b5\Migrify\PhpConfigPrinter\ValueObject\MethodName::PARAMETERS);
        }
        return $nodes;
    }
}
