...
namespace _PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter;

use _PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface;
use _PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory;
use _PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory;
use _PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter;
use _PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter;
...
final class YamlToPhpConverter
{
    ...
    public function __construct(\_PhpScopera4be459e5e3d\Symfony\Component\Yaml\Parser $yamlParser, \_PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter $phpParserPhpConfigPrinter, \_PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory $returnClosureNodesFactory, \_PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory $routingConfiguratorReturnClosureFactory, \_PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider, \_PhpScopera4be459e5e3d\Migrify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter $checkerServiceParametersShifter)
    {
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \_PhpScopera4be459e5e3d\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \_PhpScopera4be459e5e3d\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
