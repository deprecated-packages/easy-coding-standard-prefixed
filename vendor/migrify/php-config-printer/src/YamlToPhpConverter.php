...
namespace _PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter;

use _PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface;
use _PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory;
use _PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory;
use _PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter;
use _PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter;
...
final class YamlToPhpConverter
{
    ...
    public function __construct(\_PhpScoper5a9febfbbe05\Symfony\Component\Yaml\Parser $yamlParser, \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter $phpParserPhpConfigPrinter, \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory $returnClosureNodesFactory, \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory $routingConfiguratorReturnClosureFactory, \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider, \_PhpScoper5a9febfbbe05\Migrify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter $checkerServiceParametersShifter)
    {
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \_PhpScoper5a9febfbbe05\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \_PhpScoper5a9febfbbe05\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
