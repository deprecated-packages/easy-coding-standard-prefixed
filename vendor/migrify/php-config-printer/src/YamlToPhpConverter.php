...
namespace _PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter;

use _PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface;
use _PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory;
use _PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory;
use _PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter;
use _PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter;
...
final class YamlToPhpConverter
{
    ...
    public function __construct(\_PhpScoper49c742f5a4ee\Symfony\Component\Yaml\Parser $yamlParser, \_PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter $phpParserPhpConfigPrinter, \_PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory $returnClosureNodesFactory, \_PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\NodeFactory\RoutingConfiguratorReturnClosureFactory $routingConfiguratorReturnClosureFactory, \_PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface $yamlFileContentProvider, \_PhpScoper49c742f5a4ee\Migrify\PhpConfigPrinter\Yaml\CheckerServiceParametersShifter $checkerServiceParametersShifter)
    {
    ...
    public function convert(string $yaml) : string
    {
        ...
        $yamlArray = $this->yamlParser->parse($yaml, \_PhpScoper49c742f5a4ee\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS | \_PhpScoper49c742f5a4ee\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
        if ($yamlArray === null) {
            return '';
        }
