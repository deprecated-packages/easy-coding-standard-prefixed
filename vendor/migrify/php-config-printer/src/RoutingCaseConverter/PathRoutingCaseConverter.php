...
final class PathRoutingCaseConverter implements \_PhpScoper239b374a39c8\Migrify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface
{
    /**
     * @var string[]
     */
    ...
    public function convertToMethodCall(string $key, $values) : \_PhpScoper239b374a39c8\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScoper239b374a39c8\PhpParser\Node\Expr\MethodCall($variable, 'add', $args);
        foreach (self::NESTED_KEYS as $nestedKey) {
            ...
            $methodCall = new \_PhpScoper239b374a39c8\PhpParser\Node\Expr\MethodCall($methodCall, $nestedKey, $args);
        }
