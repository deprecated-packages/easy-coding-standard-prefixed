...
final class ImportRoutingCaseConverter implements \_PhpScopercda2b863d098\Migrify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface
{
    /**
     * @var string[]
     */
    ...
    public function convertToMethodCall(string $key, $values) : \_PhpScopercda2b863d098\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \_PhpScopercda2b863d098\PhpParser\Node\Expr\MethodCall($variable, 'import', $args);
        ...
        if (isset($values[self::PREFIX])) {
            ...
            $methodCall = new \_PhpScopercda2b863d098\PhpParser\Node\Expr\MethodCall($methodCall, self::PREFIX, $args);
        }
        foreach (self::NESTED_KEYS as $nestedKey) {
            ...
            $methodCall = new \_PhpScopercda2b863d098\PhpParser\Node\Expr\MethodCall($methodCall, $name, $args);
        }
