...
namespace _PhpScoperddde3ba4aebc\Migrify\MigrifyKernel\Bootstrap;

use _PhpScoperddde3ba4aebc\Migrify\MigrifyKernel\Exception\BootException;
...
final class KernelBootAndApplicationRun
{
    ...
    private function createKernel() : \_PhpScoperddde3ba4aebc\Symfony\Component\HttpKernel\KernelInterface
    {
    ...
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\_PhpScoperddde3ba4aebc\Symfony\Component\Console\Application::class);
        if ($application === null) {
            $message = \sprintf('Application class %s was not found. Make it public in the config.', \_PhpScoperddde3ba4aebc\Symfony\Component\Console\Application::class);
            throw new \_PhpScoperddde3ba4aebc\Migrify\MigrifyKernel\Exception\BootException($message);
        }
        exit($application->run());
    }
    private function setExtraConfigs(\_PhpScoperddde3ba4aebc\Symfony\Component\HttpKernel\KernelInterface $kernel, string $kernelClass) : void
    {
    ...
    {
        if (!\is_a($kernelClass, \_PhpScoperddde3ba4aebc\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            $message = \sprintf('Class "%s" must by type of "%s"', $kernelClass, \_PhpScoperddde3ba4aebc\Symfony\Component\HttpKernel\KernelInterface::class);
            throw new \_PhpScoperddde3ba4aebc\Migrify\MigrifyKernel\Exception\BootException($message);
        }
