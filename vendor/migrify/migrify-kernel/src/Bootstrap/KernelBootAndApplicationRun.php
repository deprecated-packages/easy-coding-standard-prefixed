...
namespace _PhpScopercda2b863d098\Migrify\MigrifyKernel\Bootstrap;

use _PhpScopercda2b863d098\Migrify\MigrifyKernel\Exception\BootException;
...
final class KernelBootAndApplicationRun
{
    ...
    private function createKernel() : \_PhpScopercda2b863d098\Symfony\Component\HttpKernel\KernelInterface
    {
    ...
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\_PhpScopercda2b863d098\Symfony\Component\Console\Application::class);
        if ($application === null) {
            $message = \sprintf('Application class %s was not found. Make it public in the config.', \_PhpScopercda2b863d098\Symfony\Component\Console\Application::class);
            throw new \_PhpScopercda2b863d098\Migrify\MigrifyKernel\Exception\BootException($message);
        }
        exit($application->run());
    }
    private function setExtraConfigs(\_PhpScopercda2b863d098\Symfony\Component\HttpKernel\KernelInterface $kernel, string $kernelClass) : void
    {
    ...
    {
        if (!\is_a($kernelClass, \_PhpScopercda2b863d098\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            $message = \sprintf('Class "%s" must by type of "%s"', $kernelClass, \_PhpScopercda2b863d098\Symfony\Component\HttpKernel\KernelInterface::class);
            throw new \_PhpScopercda2b863d098\Migrify\MigrifyKernel\Exception\BootException($message);
        }
