...
use _PhpScoper7cef7256eba6\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication;
...
return static function (\_PhpScoper7cef7256eba6\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper7cef7256eba6\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication::class)->public();
    $services->alias(\_PhpScoper7cef7256eba6\Symfony\Component\Console\Application::class, \_PhpScoper7cef7256eba6\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication::class);
    // symfony style
