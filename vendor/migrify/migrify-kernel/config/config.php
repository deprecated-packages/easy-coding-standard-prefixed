...
use _PhpScoper229e8121cf9f\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication;
...
return static function (\_PhpScoper229e8121cf9f\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper229e8121cf9f\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication::class)->public();
    $services->alias(\_PhpScoper229e8121cf9f\Symfony\Component\Console\Application::class, \_PhpScoper229e8121cf9f\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication::class);
    // symfony style
