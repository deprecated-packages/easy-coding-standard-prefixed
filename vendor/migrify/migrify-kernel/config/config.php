...
use _PhpScoper666af036e800\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication;
...
return static function (\_PhpScoper666af036e800\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper666af036e800\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication::class)->public();
    $services->alias(\_PhpScoper666af036e800\Symfony\Component\Console\Application::class, \_PhpScoper666af036e800\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication::class);
    // symfony style
