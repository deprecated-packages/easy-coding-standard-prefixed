...
use _PhpScoper2fe14d6302bc\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication;
...
return static function (\_PhpScoper2fe14d6302bc\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper2fe14d6302bc\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication::class)->public();
    $services->alias(\_PhpScoper2fe14d6302bc\Symfony\Component\Console\Application::class, \_PhpScoper2fe14d6302bc\Migrify\MigrifyKernel\Console\CommandAwareConsoleApplication::class);
    // symfony style
    $services->set(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class);
    $services->set(\_PhpScoper2fe14d6302bc\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\_PhpScoper2fe14d6302bc\Symfony\Component\DependencyInjection\Loader\Configurator\ref(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    // filesystem
