...
use _PhpScoper7c1f54fd2f3a\PHPUnit\Framework\Constraint\IsIdentical as PhpUnitIsIdentical;
/**
 * @internal
 *
...
trait IsIdenticalConstraint
{
    ...
    {
        foreach ([\PhpCsFixer\PhpunitConstraintIsIdenticalString\Constraint\IsIdenticalString::class, \_PhpScoper7c1f54fd2f3a\PHPUnit\Framework\Constraint\IsIdentical::class, 'PHPUnit_Framework_Constraint_IsIdentical'] as $className) {
