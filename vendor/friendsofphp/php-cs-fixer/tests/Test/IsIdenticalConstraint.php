...
use _PhpScoper6d28bdf6a7f9\PHPUnit\Framework\Constraint\IsIdentical as PhpUnitIsIdentical;
/**
 * @internal
 *
...
trait IsIdenticalConstraint
{
    ...
    {
        foreach ([\PhpCsFixer\PhpunitConstraintIsIdenticalString\Constraint\IsIdenticalString::class, \_PhpScoper6d28bdf6a7f9\PHPUnit\Framework\Constraint\IsIdentical::class, 'PHPUnit_Framework_Constraint_IsIdentical'] as $className) {
