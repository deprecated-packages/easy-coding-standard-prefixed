...
use _PhpScoper757c066053f8\PHPUnit\Framework\Constraint\IsIdentical as PhpUnitIsIdentical;
/**
 * @internal
 *
...
trait IsIdenticalConstraint
{
    ...
    {
        foreach ([IsIdenticalString::class, PhpUnitIsIdentical::class, 'PHPUnit_Framework_Constraint_IsIdentical'] as $className) {
