...
use _PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo;
/**
...
abstract class AbstractIntegrationCaseFactory implements \PhpCsFixer\Tests\Test\IntegrationCaseFactoryInterface
{
     ...
     */
    public function create(\_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo $file)
    {
        try {
            if (!\preg_match('/^
                            --TEST--           \\r?\\n(?<title>          .*?)
     ...
     * @return array
     */
    protected function determineConfig(\_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return array
     */
    protected function determineRequirements(\_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return RuleSet
     */
    protected function determineRuleset(\_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return string
     */
    protected function determineTitle(\_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
        return $config;
    }
    /**
     ...
     * @return array
     */
    protected function determineSettings(\_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return string
     */
    protected function determineExpectedCode(\_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo $file, $code)
    {
     ...
     * @return null|string
     */
    protected function determineInputCode(\_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo $file, $code)
    {
     ...
     * @return null|string
     */
    private function determineCode(\_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo $file, $code, $suffix)
    {
        if (null !== $code) {
            return $code;
        }
        $candidateFile = new \_PhpScoper13133e188f67\Symfony\Component\Finder\SplFileInfo($file->getPathname() . $suffix, '', '');
