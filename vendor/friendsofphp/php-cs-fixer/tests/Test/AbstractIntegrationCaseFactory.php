...
use _PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo;
/**
...
abstract class AbstractIntegrationCaseFactory implements \PhpCsFixer\Tests\Test\IntegrationCaseFactoryInterface
{
     ...
     */
    public function create(\_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo $file)
    {
        try {
            if (!\preg_match('/^
                            --TEST--           \\r?\\n(?<title>          .*?)
     ...
     * @return array
     */
    protected function determineConfig(\_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return array
     */
    protected function determineRequirements(\_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return RuleSet
     */
    protected function determineRuleset(\_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return string
     */
    protected function determineTitle(\_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
        return $config;
    }
    /**
     ...
     * @return array
     */
    protected function determineSettings(\_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return string
     */
    protected function determineExpectedCode(\_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo $file, $code)
    {
     ...
     * @return null|string
     */
    protected function determineInputCode(\_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo $file, $code)
    {
     ...
     * @return null|string
     */
    private function determineCode(\_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo $file, $code, $suffix)
    {
        if (null !== $code) {
            return $code;
        }
        $candidateFile = new \_PhpScopera9d6b451df71\Symfony\Component\Finder\SplFileInfo($file->getPathname() . $suffix, '', '');
