...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper96c81c3c1716\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper96c81c3c1716\Symfony\Component\EventDispatcher\Event
    {
    }
}
