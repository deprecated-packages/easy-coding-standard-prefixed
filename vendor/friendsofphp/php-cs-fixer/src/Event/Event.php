...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper32abeec2fe5a\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper32abeec2fe5a\Symfony\Component\EventDispatcher\Event
    {
    }
}
