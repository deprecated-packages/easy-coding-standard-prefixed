...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper2dc059b3a969\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper2dc059b3a969\Symfony\Component\EventDispatcher\Event
    {
    }
}
