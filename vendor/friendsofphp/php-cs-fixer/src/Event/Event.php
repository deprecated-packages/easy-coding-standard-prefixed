...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper5f836821822a\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper5f836821822a\Symfony\Component\EventDispatcher\Event
    {
    }
}
