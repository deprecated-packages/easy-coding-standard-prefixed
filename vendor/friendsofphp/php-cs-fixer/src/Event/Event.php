...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper917c99b6aa4c\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper917c99b6aa4c\Symfony\Component\EventDispatcher\Event
    {
    }
}
