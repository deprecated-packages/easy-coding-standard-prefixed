...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper8a1ea80774eb\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper8a1ea80774eb\Symfony\Component\EventDispatcher\Event
    {
    }
}
