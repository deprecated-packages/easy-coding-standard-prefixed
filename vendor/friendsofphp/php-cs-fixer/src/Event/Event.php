...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper45e1bde0f567\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper45e1bde0f567\Symfony\Component\EventDispatcher\Event
    {
    }
}
