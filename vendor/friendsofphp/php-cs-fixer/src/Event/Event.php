...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper2737ffe13a7b\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper2737ffe13a7b\Symfony\Component\EventDispatcher\Event
    {
    }
}
