...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScopera22bb3f4d7b7\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScopera22bb3f4d7b7\Symfony\Component\EventDispatcher\Event
    {
    }
}
