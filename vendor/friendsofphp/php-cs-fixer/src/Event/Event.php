...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper22e359cd1ab0\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper22e359cd1ab0\Symfony\Component\EventDispatcher\Event
    {
    }
}
