...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper0c575b5c37d7\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper0c575b5c37d7\Symfony\Component\EventDispatcher\Event
    {
    }
}
