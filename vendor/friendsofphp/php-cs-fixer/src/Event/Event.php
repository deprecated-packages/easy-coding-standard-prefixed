...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper8a8080b03ed6\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper8a8080b03ed6\Symfony\Component\EventDispatcher\Event
    {
    }
}
