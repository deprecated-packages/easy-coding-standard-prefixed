...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper1ddca3f92d7d\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper1ddca3f92d7d\Symfony\Component\EventDispatcher\Event
    {
    }
}
