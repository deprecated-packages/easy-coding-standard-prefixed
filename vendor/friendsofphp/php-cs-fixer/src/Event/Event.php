...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper1b2f8b9c0339\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper1b2f8b9c0339\Symfony\Component\EventDispatcher\Event
    {
    }
}
