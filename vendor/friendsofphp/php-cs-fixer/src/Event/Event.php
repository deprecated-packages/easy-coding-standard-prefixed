...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoperd232d3743ab9\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoperd232d3743ab9\Symfony\Component\EventDispatcher\Event
    {
    }
}
