...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper2d11f18408ea\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper2d11f18408ea\Symfony\Component\EventDispatcher\Event
    {
    }
}
