...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper130a9a1cd4a2\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper130a9a1cd4a2\Symfony\Component\EventDispatcher\Event
    {
    }
}
