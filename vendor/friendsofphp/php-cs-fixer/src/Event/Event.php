...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScopera658fe86acec\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScopera658fe86acec\Symfony\Component\EventDispatcher\Event
    {
    }
}
