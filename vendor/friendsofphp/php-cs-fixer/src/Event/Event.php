...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper4f608e7525a4\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper4f608e7525a4\Symfony\Component\EventDispatcher\Event
    {
    }
}
