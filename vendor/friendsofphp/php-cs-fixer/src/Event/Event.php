...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoperb5b1090524db\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoperb5b1090524db\Symfony\Component\EventDispatcher\Event
    {
    }
}
