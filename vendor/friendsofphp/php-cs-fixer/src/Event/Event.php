...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper3fd2fa23bf53\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper3fd2fa23bf53\Symfony\Component\EventDispatcher\Event
    {
    }
}
