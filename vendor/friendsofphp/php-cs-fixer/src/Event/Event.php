...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoperc5e9eb67638f\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoperc5e9eb67638f\Symfony\Component\EventDispatcher\Event
    {
    }
}
