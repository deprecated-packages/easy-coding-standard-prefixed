...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScopere72a8aaba560\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScopere72a8aaba560\Symfony\Component\EventDispatcher\Event
    {
    }
}
