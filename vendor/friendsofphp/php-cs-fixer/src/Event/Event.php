...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper3c44535fe75f\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper3c44535fe75f\Symfony\Component\EventDispatcher\Event
    {
    }
}
