...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper4fedb9aa1e5f\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper4fedb9aa1e5f\Symfony\Component\EventDispatcher\Event
    {
    }
}
