...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper91c59a2f52e1\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper91c59a2f52e1\Symfony\Component\EventDispatcher\Event
    {
    }
}
