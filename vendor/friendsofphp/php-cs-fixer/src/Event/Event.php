...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoperd2a667bd5a98\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoperd2a667bd5a98\Symfony\Component\EventDispatcher\Event
    {
    }
}
