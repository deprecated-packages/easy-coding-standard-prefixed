...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoperff1e514762b4\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoperff1e514762b4\Symfony\Component\EventDispatcher\Event
    {
    }
}
