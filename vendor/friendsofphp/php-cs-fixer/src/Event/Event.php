...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoperd51690aa3091\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoperd51690aa3091\Symfony\Component\EventDispatcher\Event
    {
    }
}
