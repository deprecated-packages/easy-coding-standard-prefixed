...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScopera9d6a31d814c\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScopera9d6a31d814c\Symfony\Component\EventDispatcher\Event
    {
    }
}
