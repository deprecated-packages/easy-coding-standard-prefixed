...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper1c0f546920a5\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper1c0f546920a5\Symfony\Component\EventDispatcher\Event
    {
    }
}
