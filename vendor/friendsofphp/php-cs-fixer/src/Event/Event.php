...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper27cac5a8b4ab\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper27cac5a8b4ab\Symfony\Component\EventDispatcher\Event
    {
    }
}
