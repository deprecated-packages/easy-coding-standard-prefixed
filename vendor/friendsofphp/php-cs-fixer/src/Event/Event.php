...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper6b1da46bea54\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper6b1da46bea54\Symfony\Component\EventDispatcher\Event
    {
    }
}
