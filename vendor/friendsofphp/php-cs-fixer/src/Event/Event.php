...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper9907e2e69ce3\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper9907e2e69ce3\Symfony\Component\EventDispatcher\Event
    {
    }
}
