...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper8b3c9ad56565\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper8b3c9ad56565\Symfony\Component\EventDispatcher\Event
    {
    }
}
