...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScoper855b7fb41c61\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScoper855b7fb41c61\Symfony\Component\EventDispatcher\Event
    {
    }
}
