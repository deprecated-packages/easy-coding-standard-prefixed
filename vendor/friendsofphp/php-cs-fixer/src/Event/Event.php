...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScopereb9508917a55\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScopereb9508917a55\Symfony\Component\EventDispatcher\Event
    {
    }
}
