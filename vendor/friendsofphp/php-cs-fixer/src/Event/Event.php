...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \_PhpScopera46128941588\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \_PhpScopera46128941588\Symfony\Component\EventDispatcher\Event
    {
    }
}
