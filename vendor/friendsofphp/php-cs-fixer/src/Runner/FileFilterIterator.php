...
final class FileFilterIterator extends \FilterIterator
{
    ...
    public function __construct(\Traversable $iterator, \_PhpScoper64ca614e27fd\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null, \PhpCsFixer\Cache\CacheManagerInterface $cacheManager)
    {
    ...
    private function dispatchEvent($name, \PhpCsFixer\Event\Event $event)
    {
        ...
        if (!$this->eventDispatcher instanceof \_PhpScoper64ca614e27fd\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
