...
final class FileFilterIterator extends \FilterIterator
{
    ...
    public function __construct(\Traversable $iterator, \_PhpScoper32136251d417\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null, \PhpCsFixer\Cache\CacheManagerInterface $cacheManager)
    {
    ...
    private function dispatchEvent($name, \PhpCsFixer\Event\Event $event)
    {
        ...
        if (!$this->eventDispatcher instanceof \_PhpScoper32136251d417\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
