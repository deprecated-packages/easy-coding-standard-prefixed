...
final class FileFilterIterator extends \FilterIterator
{
    ...
    public function __construct(\Iterator $iterator, \_PhpScoper4848279dba07\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null, \PhpCsFixer\Cache\CacheManagerInterface $cacheManager)
    {
     ...
     * @param string $name
     */
    private function dispatchEvent($name, \_PhpScoper4848279dba07\Symfony\Component\EventDispatcher\Event $event)
    {
        if (null === $this->eventDispatcher) {
            return;
        }
        // BC compatibility < Sf 4.3
        if (!$this->eventDispatcher instanceof \_PhpScoper4848279dba07\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
