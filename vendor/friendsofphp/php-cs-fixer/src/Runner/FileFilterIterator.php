...
final class FileFilterIterator extends \FilterIterator
{
    ...
    public function __construct(\Traversable $iterator, \_PhpScoper13160cf3462c\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null, \PhpCsFixer\Cache\CacheManagerInterface $cacheManager)
    {
    ...
    private function dispatchEvent($name, \PhpCsFixer\Event\Event $event)
    {
        ...
        if (!$this->eventDispatcher instanceof \_PhpScoper13160cf3462c\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
