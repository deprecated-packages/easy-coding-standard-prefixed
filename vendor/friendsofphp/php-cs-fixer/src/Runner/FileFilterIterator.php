...
use _PhpScoper890197fe38f7\Symfony\Contracts\EventDispatcher\Event;
/**
...
final class FileFilterIterator extends \FilterIterator
{
    ...
    private function dispatchEvent(string $name, Event $event) : void
    {
        ...
        if (!$this->eventDispatcher instanceof \_PhpScoper890197fe38f7\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
