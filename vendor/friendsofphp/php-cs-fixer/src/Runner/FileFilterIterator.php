...
final class FileFilterIterator extends \FilterIterator
{
    ...
    public function __construct(\Traversable $iterator, \_PhpScoper842c7347e6be\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null, \PhpCsFixer\Cache\CacheManagerInterface $cacheManager)
    {
    ...
    private function dispatchEvent($name, \PhpCsFixer\Event\Event $event)
    {
        ...
        if (!$this->eventDispatcher instanceof \_PhpScoper842c7347e6be\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
