...
final class FileFilterIterator extends \FilterIterator
{
    ...
    public function __construct(\Iterator $iterator, \_PhpScoperd79d87c3336e\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null, \PhpCsFixer\Cache\CacheManagerInterface $cacheManager)
    {
     ...
     * @param string $name
     */
    private function dispatchEvent($name, \_PhpScoperd79d87c3336e\Symfony\Component\EventDispatcher\Event $event)
    {
        if (null === $this->eventDispatcher) {
            return;
        }
        // BC compatibility < Sf 4.3
        if (!$this->eventDispatcher instanceof \_PhpScoperd79d87c3336e\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
