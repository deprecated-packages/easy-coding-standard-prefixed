 ...
 * @internal
 */
final class CheckstyleReporter implements \PhpCsFixer\Report\ReporterInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    public function generate(\PhpCsFixer\Report\ReportSummary $reportSummary)
    {
        ...
        return $reportSummary->isDecoratedOutput() ? \_PhpScoper64a921a5401b\Symfony\Component\Console\Formatter\OutputFormatter::escape($dom->saveXML()) : $dom->saveXML();
    }
    /**
