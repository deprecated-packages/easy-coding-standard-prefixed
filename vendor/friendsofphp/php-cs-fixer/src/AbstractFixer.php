...
use _PhpScoper68a3a2539032\Symfony\Component\OptionsResolver\Exception\ExceptionInterface;
...
abstract class AbstractFixer implements \PhpCsFixer\Fixer\FixerInterface, \PhpCsFixer\Fixer\DefinedFixerInterface
{
    ...
    public function configure(array $configuration = null)
    {
        ...
        } catch (\_PhpScoper68a3a2539032\Symfony\Component\OptionsResolver\Exception\MissingOptionsException $exception) {
        ...
        } catch (\_PhpScoper68a3a2539032\Symfony\Component\OptionsResolver\Exception\ExceptionInterface $exception) {
