...
use _PhpScoperca8ca183ac38\Symfony\Component\OptionsResolver\Exception\ExceptionInterface;
...
abstract class AbstractFixer implements \PhpCsFixer\Fixer\FixerInterface, \PhpCsFixer\Fixer\DefinedFixerInterface
{
    ...
    public function configure(array $configuration = null)
    {
        ...
        } catch (\_PhpScoperca8ca183ac38\Symfony\Component\OptionsResolver\Exception\MissingOptionsException $exception) {
        ...
        } catch (\_PhpScoperca8ca183ac38\Symfony\Component\OptionsResolver\Exception\ExceptionInterface $exception) {
