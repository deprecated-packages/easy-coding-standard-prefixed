...
use _PhpScoper3e8786a75afe\Symfony\Component\OptionsResolver\Exception\ExceptionInterface;
...
abstract class AbstractFixer implements \PhpCsFixer\Fixer\FixerInterface, \PhpCsFixer\Fixer\DefinedFixerInterface
{
    ...
    public function configure(array $configuration = null)
    {
        ...
        } catch (\_PhpScoper3e8786a75afe\Symfony\Component\OptionsResolver\Exception\MissingOptionsException $exception) {
        ...
        } catch (\_PhpScoper3e8786a75afe\Symfony\Component\OptionsResolver\Exception\ExceptionInterface $exception) {
