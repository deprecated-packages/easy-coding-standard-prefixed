...
use _PhpScopere66f4b626446\Symfony\Component\OptionsResolver\Exception\ExceptionInterface;
...
abstract class AbstractFixer implements \PhpCsFixer\Fixer\FixerInterface, \PhpCsFixer\Fixer\DefinedFixerInterface
{
    ...
    public function configure(array $configuration = null)
    {
        ...
        } catch (\_PhpScopere66f4b626446\Symfony\Component\OptionsResolver\Exception\MissingOptionsException $exception) {
        ...
        } catch (\_PhpScopere66f4b626446\Symfony\Component\OptionsResolver\Exception\ExceptionInterface $exception) {
