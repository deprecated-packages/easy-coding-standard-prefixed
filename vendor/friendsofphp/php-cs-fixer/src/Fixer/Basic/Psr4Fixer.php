 ...
 */
final class Psr4Fixer extends \PhpCsFixer\AbstractPsrAutoloadingFixer
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return new \PhpCsFixer\FixerDefinition\FixerDefinition('Class names should match the file name.', [new \PhpCsFixer\FixerDefinition\FileSpecificCodeSample('<?php
namespace PhpCsFixer\\FIXER\\Basic;
class InvalidName {}
