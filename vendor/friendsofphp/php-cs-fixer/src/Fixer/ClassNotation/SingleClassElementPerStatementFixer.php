...
', ['elements' => ['property']])]);
     ...
     * @param int $index
     */
    private function fixElement($tokens, $type, $index)
    {
     ...
     * @param int $endIndex
     */
    private function expandElement($tokens, $type, $startIndex, $endIndex)
    {
     ...
     * @param int $endIndex
     */
    private function getModifiersSequences($tokens, $type, $startIndex, $endIndex)
    {
        if ('property' === $type) {
