    ...
    private function getElements(\PhpCsFixer\Tokenizer\Tokens $tokens, $startIndex)
    {
        ...
        while (\true) {
            ...
            for ($i = $startIndex;; ++$i) {
                ...
                } elseif (\in_array($element['type'], ['use_trait', 'constant', 'method', 'magic'], \true)) {
