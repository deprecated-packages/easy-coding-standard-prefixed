 ...
 */
final class PhpUnitDedicateAssertInternalTypeFixer extends \PhpCsFixer\AbstractFixer implements \PhpCsFixer\Fixer\ConfigurationDefinitionFixerInterface
{
    /**
     * @var array
     */
...
')], null, 'Risky when PHPUnit methods are overridden or when project has PHPUnit incompatibilities.');
     ...
     * @param int $endIndex
     */
    private function updateAssertInternalTypeMethods(\PhpCsFixer\Tokenizer\Tokens $tokens, $startIndex, $endIndex)
    {
