...
final class CompactNullableTypehintFixer extends AbstractFixer
{
    ...
    {
        return new FixerDefinition('Remove extra spaces in a nullable typehint.', [new VersionSpecificCodeSample("<?php\nfunction sample(? string \$str): ? string\n{}\n", new VersionSpecification(70100))], 'Rule is applied only in a PHP 7.1+ environment.');
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        static $typehintKinds = [CT::T_ARRAY_TYPEHINT, \T_CALLABLE, \T_NS_SEPARATOR, \T_STRING];
