...
')]);
    ...
    {
        $inlineNormalizerFixer = new \PhpCsFixer\Fixer\Phpdoc\PhpdocInlineTagNormalizerFixer();
        $renameFixer = new \PhpCsFixer\Fixer\Phpdoc\GeneralPhpdocTagRenameFixer();
        ...
        $tagTypeFixer = new \PhpCsFixer\Fixer\Phpdoc\PhpdocTagTypeFixer();
