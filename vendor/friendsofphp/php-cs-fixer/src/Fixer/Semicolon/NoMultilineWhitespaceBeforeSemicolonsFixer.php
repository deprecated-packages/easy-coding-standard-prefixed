...
')]);
    ...
    {
        $fixer = new \PhpCsFixer\Fixer\Semicolon\MultilineWhitespaceBeforeSemicolonsFixer();
        $fixer->configure(['strategy' => \PhpCsFixer\Fixer\Semicolon\MultilineWhitespaceBeforeSemicolonsFixer::STRATEGY_NO_MULTI_LINE]);
        return [$fixer];
    }
}
