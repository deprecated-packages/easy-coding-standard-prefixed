...
final class DoctrineAnnotationArrayAssignmentFixer extends \PhpCsFixer\AbstractDoctrineAnnotationFixer
{
    ...
    protected function fixAnnotations(\PhpCsFixer\Doctrine\Annotation\Tokens $tokens)
    {
        ...
        foreach ($tokens as $token) {
            ...
            if ($token->isType(\_PhpScoper2b44cb0c30af\Doctrine\Common\Annotations\DocLexer::T_OPEN_CURLY_BRACES)) {
                $scopes[] = 'array';
                continue;
            }
            ...
            if ('array' === \end($scopes) && $token->isType([\_PhpScoper2b44cb0c30af\Doctrine\Common\Annotations\DocLexer::T_EQUALS, \_PhpScoper2b44cb0c30af\Doctrine\Common\Annotations\DocLexer::T_COLON])) {
