...
use _PhpScoperddde3ba4aebc\Symfony\Component\Filesystem\Filesystem;
use _PhpScoperddde3ba4aebc\Symfony\Component\Finder\Finder as SymfonyFinder;
/**
...
final class ConfigurationResolver
{
    ...
    public function getDirectory()
    {
        if (null === $this->directory) {
            ...
            $filesystem = new \_PhpScoperddde3ba4aebc\Symfony\Component\Filesystem\Filesystem();
    ...
    public function getProgress()
    {
        if (null === $this->progress) {
            if (\_PhpScoperddde3ba4aebc\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE <= $this->options['verbosity'] && 'txt' === $this->getFormat()) {
    ...
    private function resolveFinder()
    {
        ...
        if ($currentFinder instanceof \_PhpScoperddde3ba4aebc\Symfony\Component\Finder\Finder && null === $nestedFinder) {
