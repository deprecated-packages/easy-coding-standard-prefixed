...
use _PhpScoperb6ccec8ab642\Symfony\Component\Filesystem\Filesystem;
use _PhpScoperb6ccec8ab642\Symfony\Component\Finder\Finder as SymfonyFinder;
/**
...
final class ConfigurationResolver
{
    ...
    public function getDirectory()
    {
        if (null === $this->directory) {
            ...
            $filesystem = new \_PhpScoperb6ccec8ab642\Symfony\Component\Filesystem\Filesystem();
    ...
    public function getProgress()
    {
        if (null === $this->progress) {
            if (\_PhpScoperb6ccec8ab642\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE <= $this->options['verbosity'] && 'txt' === $this->getFormat()) {
    ...
    private function resolveFinder()
    {
        ...
        if ($currentFinder instanceof \_PhpScoperb6ccec8ab642\Symfony\Component\Finder\Finder && null === $nestedFinder) {
