...
use _PhpScoper5928e324b45e\Symfony\Component\Filesystem\Filesystem;
use _PhpScoper5928e324b45e\Symfony\Component\Finder\Finder as SymfonyFinder;
/**
...
final class ConfigurationResolver
{
    ...
    public function getDirectory()
    {
        if (null === $this->directory) {
            ...
            $filesystem = new \_PhpScoper5928e324b45e\Symfony\Component\Filesystem\Filesystem();
    ...
    public function getProgress()
    {
        if (null === $this->progress) {
            if (\_PhpScoper5928e324b45e\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE <= $this->options['verbosity'] && 'txt' === $this->getFormat()) {
    ...
    private function resolveFinder()
    {
        ...
        if ($currentFinder instanceof \_PhpScoper5928e324b45e\Symfony\Component\Finder\Finder && null === $nestedFinder) {
