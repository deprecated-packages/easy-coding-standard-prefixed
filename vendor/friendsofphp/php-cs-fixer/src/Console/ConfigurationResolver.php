...
use _PhpScoperc7c7dddc9238\Symfony\Component\Filesystem\Filesystem;
use _PhpScoperc7c7dddc9238\Symfony\Component\Finder\Finder as SymfonyFinder;
/**
...
final class ConfigurationResolver
{
    ...
    public function getDirectory()
    {
        if (null === $this->directory) {
            ...
            $filesystem = new \_PhpScoperc7c7dddc9238\Symfony\Component\Filesystem\Filesystem();
    ...
    public function getProgress()
    {
        if (null === $this->progress) {
            if (\_PhpScoperc7c7dddc9238\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE <= $this->options['verbosity'] && 'txt' === $this->getFormat()) {
    ...
    private function resolveFinder()
    {
        ...
        if ($currentFinder instanceof \_PhpScoperc7c7dddc9238\Symfony\Component\Finder\Finder && null === $nestedFinder) {
