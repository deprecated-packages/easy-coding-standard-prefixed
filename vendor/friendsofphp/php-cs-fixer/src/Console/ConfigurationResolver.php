...
use _PhpScoperd35c27cd4b09\Symfony\Component\Finder\Finder as SymfonyFinder;
/**
...
final class ConfigurationResolver
{
    ...
    public function getProgress()
    {
        if (null === $this->progress) {
            if (\_PhpScoperd35c27cd4b09\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE <= $this->options['verbosity'] && 'txt' === $this->getFormat()) {
    ...
    private function resolveFinder()
    {
        ...
        if ($currentFinder instanceof \_PhpScoperd35c27cd4b09\Symfony\Component\Finder\Finder && null === $nestedFinder) {
