...
use _PhpScoper3ba93baeac18\Symfony\Component\Filesystem\Filesystem;
use _PhpScoper3ba93baeac18\Symfony\Component\Finder\Finder as SymfonyFinder;
/**
...
final class ConfigurationResolver
{
    ...
    public function getDirectory()
    {
        if (null === $this->directory) {
            ...
            $filesystem = new \_PhpScoper3ba93baeac18\Symfony\Component\Filesystem\Filesystem();
    ...
    public function getProgress()
    {
        if (null === $this->progress) {
            if (\_PhpScoper3ba93baeac18\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE <= $this->options['verbosity'] && 'txt' === $this->getFormat()) {
    ...
    private function resolveFinder()
    {
        ...
        if ($currentFinder instanceof \_PhpScoper3ba93baeac18\Symfony\Component\Finder\Finder && null === $nestedFinder) {
