...
use _PhpScoper6a0a7eb6e565\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \_PhpScoper6a0a7eb6e565\Symfony\Component\Console\Application
{
    ...
    {
        $stdErr = $output instanceof \_PhpScoper6a0a7eb6e565\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \_PhpScoper6a0a7eb6e565\Symfony\Component\Console\Command\ListCommand()];
    }
}
