...
use _PhpScoperfd70a7e8e84f\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \_PhpScoperfd70a7e8e84f\Symfony\Component\Console\Application
{
    ...
    {
        $stdErr = $output instanceof \_PhpScoperfd70a7e8e84f\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \_PhpScoperfd70a7e8e84f\Symfony\Component\Console\Command\ListCommand()];
    }
}
