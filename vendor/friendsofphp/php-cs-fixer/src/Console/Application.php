...
use _PhpScopere015d8a3273c\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \_PhpScopere015d8a3273c\Symfony\Component\Console\Application
{
    ...
    {
        $stdErr = $output instanceof \_PhpScopere015d8a3273c\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \_PhpScopere015d8a3273c\Symfony\Component\Console\Command\ListCommand()];
    }
}
