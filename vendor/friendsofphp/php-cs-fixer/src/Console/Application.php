...
use _PhpScoper64a921a5401b\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \_PhpScoper64a921a5401b\Symfony\Component\Console\Application
{
    ...
    {
        $stdErr = $output instanceof \_PhpScoper64a921a5401b\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \_PhpScoper64a921a5401b\Symfony\Component\Console\Command\ListCommand()];
    }
}
