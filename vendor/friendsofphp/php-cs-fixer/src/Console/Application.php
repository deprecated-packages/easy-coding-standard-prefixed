...
use _PhpScoperdf15f2b748e9\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \_PhpScoperdf15f2b748e9\Symfony\Component\Console\Application
{
    ...
    {
        $stdErr = $output instanceof \_PhpScoperdf15f2b748e9\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \_PhpScoperdf15f2b748e9\Symfony\Component\Console\Command\ListCommand()];
    }
}
