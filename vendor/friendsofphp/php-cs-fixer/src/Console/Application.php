...
use _PhpScopera04bf8e97c06\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \_PhpScopera04bf8e97c06\Symfony\Component\Console\Application
{
    ...
    {
        $stdErr = $output instanceof \_PhpScopera04bf8e97c06\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \_PhpScopera04bf8e97c06\Symfony\Component\Console\Command\ListCommand()];
    }
}
