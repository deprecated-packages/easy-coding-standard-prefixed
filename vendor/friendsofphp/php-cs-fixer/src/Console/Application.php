...
use _PhpScoperddde3ba4aebc\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \_PhpScoperddde3ba4aebc\Symfony\Component\Console\Application
{
    ...
    {
        $stdErr = $output instanceof \_PhpScoperddde3ba4aebc\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \_PhpScoperddde3ba4aebc\Symfony\Component\Console\Command\ListCommand()];
    }
}
