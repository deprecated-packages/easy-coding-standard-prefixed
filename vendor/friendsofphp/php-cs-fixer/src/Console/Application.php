...
use _PhpScoper87c77ad5700d\Symfony\Component\Console\Application as BaseApplication;
 ...
 * @internal
 */
final class Application extends \_PhpScoper87c77ad5700d\Symfony\Component\Console\Application
{
    ...
    {
        $stdErr = $output instanceof \_PhpScoper87c77ad5700d\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ($input->hasParameterOption('--format', \true) && 'txt' !== $input->getParameterOption('--format', null, \true) ? null : $output);
        if (null !== $stdErr) {
    ...
    {
        return [new \PhpCsFixer\Console\Command\HelpCommand(), new \_PhpScoper87c77ad5700d\Symfony\Component\Console\Command\ListCommand()];
    }
}
