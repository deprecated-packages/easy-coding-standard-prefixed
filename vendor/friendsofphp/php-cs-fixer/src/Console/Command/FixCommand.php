...
use _PhpScoperd79d87c3336e\Symfony\Component\EventDispatcher\EventDispatcher;
use _PhpScoperd79d87c3336e\Symfony\Component\EventDispatcher\EventDispatcherInterface;
use _PhpScoperd79d87c3336e\Symfony\Component\Stopwatch\Stopwatch;
/**
 ...
 * @internal
 */
final class FixCommand extends \_PhpScoperd79d87c3336e\Symfony\Component\Console\Command\Command
{
    ...
    public function __construct(\PhpCsFixer\ToolInfoInterface $toolInfo)
    {
        ...
        $this->eventDispatcher = new \_PhpScoperd79d87c3336e\Symfony\Component\EventDispatcher\EventDispatcher();
        $this->stopwatch = new \_PhpScoperd79d87c3336e\Symfony\Component\Stopwatch\Stopwatch();
    ...
    {
        $this->setDefinition([new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputArgument('path', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'The path.'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('path-mode', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Specify path mode (can be override or intersection).', 'override'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('allow-risky', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Are risky fixers allowed (can be yes or no).'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('config', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The path to a .php_cs file.'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('dry-run', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Only shows which files would have been modified.'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('rules', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The rules.'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('using-cache', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Does cache should be used (can be yes or no).'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('cache-file', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The path to the cache file.'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('diff', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Also produce diff for each file.'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('diff-format', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Specify diff format.'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('format', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'To output results in other formats.'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('stop-on-violation', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Stop execution on first violation.'), new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption('show-progress', '', \_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Type of progress indicator (none, run-in, estimating, estimating-max or dots).')])->setDescription('Fixes a directory or a file.');
    }
    /**
     * {@inheritdoc}
     */
    protected function execute(\_PhpScoperd79d87c3336e\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoperd79d87c3336e\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        $stdErr = $output instanceof \_PhpScoperd79d87c3336e\Symfony\Component\Console\Output\ConsoleOutputInterface ? $output->getErrorOutput() : ('txt' === $reporter->getFormat() ? $output : null);
        if (null !== $stdErr) {
        ...
        if ('none' === $progressType || null === $stdErr) {
            ...
            $progressOutput = new \PhpCsFixer\Console\Output\ProcessOutput($stdErr, $this->eventDispatcher, 'estimating' !== $progressType ? (new \_PhpScoperd79d87c3336e\Symfony\Component\Console\Terminal())->getWidth() : null, \count($finder));
        }
        ...
        $reportSummary = new \PhpCsFixer\Report\ReportSummary($changed, $fixEvent->getDuration(), $fixEvent->getMemory(), \_PhpScoperd79d87c3336e\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE <= $output->getVerbosity(), $resolver->isDryRun(), $output->isDecorated());
        $output->isDecorated() ? $output->write($reporter->generate($reportSummary)) : $output->write($reporter->generate($reportSummary), \false, \_PhpScoperd79d87c3336e\Symfony\Component\Console\Output\OutputInterface::OUTPUT_RAW);
