...
use _PhpScoper6d28bdf6a7f9\Symfony\Component\Console\Command\HelpCommand as BaseHelpCommand;
 ...
 * @internal
 */
final class HelpCommand extends \_PhpScoper6d28bdf6a7f9\Symfony\Component\Console\Command\HelpCommand
{
...
EOF;
    ...
    {
        $output->getFormatter()->setStyle('url', new \_PhpScoper6d28bdf6a7f9\Symfony\Component\Console\Formatter\OutputFormatterStyle('blue'));
    }
    /**
     * @return null|string
     */
            ...
            if ($fixer instanceof \PhpCsFixer\Fixer\ConfigurationDefinitionFixerInterface) {
                ...
                if (\count($configurationDefinitionOptions)) {
                    ...
                    foreach ($configurationDefinitionOptions as $option) {
                        ...
                        $line .= ': ' . \PhpCsFixer\Preg::replace('/(`.+?`)/', '<info>$1</info>', \lcfirst(\PhpCsFixer\Preg::replace('/\\.$/', '', \_PhpScoper6d28bdf6a7f9\Symfony\Component\Console\Formatter\OutputFormatter::escape($option->getDescription())))) . '; ';
                        ...
                        if ($option instanceof \PhpCsFixer\FixerConfiguration\DeprecatedFixerOption) {
                            $line .= '. DEPRECATED: ' . \PhpCsFixer\Preg::replace('/(`.+?`)/', '<info>$1</info>', \lcfirst(\PhpCsFixer\Preg::replace('/\\.$/', '', \_PhpScoper6d28bdf6a7f9\Symfony\Component\Console\Formatter\OutputFormatter::escape($option->getDeprecationMessage()))));
                        }
