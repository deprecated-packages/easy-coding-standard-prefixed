 ...
 * @internal
 */
final class SelfUpdateCommand extends \_PhpScoper3d04c8135695\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \_PhpScoper3d04c8135695\Symfony\Component\Console\Input\InputOption('--force', '-f', \_PhpScoper3d04c8135695\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
