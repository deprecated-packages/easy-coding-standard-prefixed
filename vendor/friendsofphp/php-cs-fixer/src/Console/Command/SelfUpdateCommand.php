 ...
 * @internal
 */
final class SelfUpdateCommand extends \_PhpScoper49c742f5a4ee\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \_PhpScoper49c742f5a4ee\Symfony\Component\Console\Input\InputOption('--force', '-f', \_PhpScoper49c742f5a4ee\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
