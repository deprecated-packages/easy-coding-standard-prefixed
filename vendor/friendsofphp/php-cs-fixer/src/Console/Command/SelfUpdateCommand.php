 ...
 * @internal
 */
final class SelfUpdateCommand extends \_PhpScoperd35c27cd4b09\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \_PhpScoperd35c27cd4b09\Symfony\Component\Console\Input\InputOption('--force', '-f', \_PhpScoperd35c27cd4b09\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
