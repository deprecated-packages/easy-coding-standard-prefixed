 ...
 * @internal
 */
final class SelfUpdateCommand extends \_PhpScoper14cb6de5473d\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \_PhpScoper14cb6de5473d\Symfony\Component\Console\Input\InputOption('--force', '-f', \_PhpScoper14cb6de5473d\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
