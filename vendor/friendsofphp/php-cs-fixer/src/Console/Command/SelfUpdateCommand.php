 ...
 * @internal
 */
final class SelfUpdateCommand extends \_PhpScoper578a67c80b2b\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \_PhpScoper578a67c80b2b\Symfony\Component\Console\Input\InputOption('--force', '-f', \_PhpScoper578a67c80b2b\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
