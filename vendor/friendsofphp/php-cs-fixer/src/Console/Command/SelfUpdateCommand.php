 ...
 * @internal
 */
final class SelfUpdateCommand extends \_PhpScoper7c1f54fd2f3a\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \_PhpScoper7c1f54fd2f3a\Symfony\Component\Console\Input\InputOption('--force', '-f', \_PhpScoper7c1f54fd2f3a\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
