...
use _PhpScoperfcee700af3df\Symfony\Component\Filesystem\Filesystem;
use _PhpScoperfcee700af3df\Symfony\Component\Finder\Finder;
use _PhpScoperfcee700af3df\Symfony\Component\Finder\SplFileInfo;
/**
 * @internal
 */
final class DocumentationCommand extends \_PhpScoperfcee700af3df\Symfony\Component\Console\Command\Command
{
    ...
    {
        $filesystem = new \_PhpScoperfcee700af3df\Symfony\Component\Filesystem\Filesystem();
        ...
        foreach ((new \_PhpScoperfcee700af3df\Symfony\Component\Finder\Finder())->files()->in($this->generator->getFixersDocumentationDirectoryPath())->notPath($docForFixerRelativePaths) as $file) {
    ...
    private function generateRuleSetsDocs(array $fixers)
    {
        $filesystem = new \_PhpScoperfcee700af3df\Symfony\Component\Filesystem\Filesystem();
        /** @var SplFileInfo $file */
        foreach ((new \_PhpScoperfcee700af3df\Symfony\Component\Finder\Finder())->files()->in($this->generator->getRuleSetsDocumentationDirectoryPath()) as $file) {
            $filesystem->remove($file->getPathname());
        }
