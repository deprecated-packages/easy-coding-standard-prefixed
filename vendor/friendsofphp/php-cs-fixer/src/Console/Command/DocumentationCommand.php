...
use _PhpScopera51a90153f58\Symfony\Component\Filesystem\Filesystem;
 ...
 * @internal
 */
final class DocumentationCommand extends \_PhpScopera51a90153f58\Symfony\Component\Console\Command\Command
{
    ...
    {
        $filesystem = new \_PhpScopera51a90153f58\Symfony\Component\Filesystem\Filesystem();
        ...
        foreach ((new \_PhpScopera51a90153f58\Symfony\Component\Finder\Finder())->files()->in($this->generator->getFixersDocumentationDirectoryPath())->notPath($docForFixerRelativePaths) as $file) {
    ...
    private function generateRuleSetsDocs(array $fixers)
    {
        $filesystem = new \_PhpScopera51a90153f58\Symfony\Component\Filesystem\Filesystem();
        /** @var SplFileInfo $file */
        foreach ((new \_PhpScopera51a90153f58\Symfony\Component\Finder\Finder())->files()->in($this->generator->getRuleSetsDocumentationDirectoryPath()) as $file) {
            $filesystem->remove($file->getPathname());
        }
