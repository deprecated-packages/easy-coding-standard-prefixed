...
use _PhpScoperfb0714773dc5\Symfony\Component\Filesystem\Filesystem;
use _PhpScoperfb0714773dc5\Symfony\Component\Finder\Finder;
use _PhpScoperfb0714773dc5\Symfony\Component\Finder\SplFileInfo;
/**
 * @internal
 */
final class DocumentationCommand extends \_PhpScoperfb0714773dc5\Symfony\Component\Console\Command\Command
{
    ...
    {
        $filesystem = new \_PhpScoperfb0714773dc5\Symfony\Component\Filesystem\Filesystem();
        ...
        foreach ((new \_PhpScoperfb0714773dc5\Symfony\Component\Finder\Finder())->files()->in($this->generator->getFixersDocumentationDirectoryPath())->notPath($docForFixerRelativePaths) as $file) {
    ...
    private function generateRuleSetsDocs(array $fixers)
    {
        $filesystem = new \_PhpScoperfb0714773dc5\Symfony\Component\Filesystem\Filesystem();
        /** @var SplFileInfo $file */
        foreach ((new \_PhpScoperfb0714773dc5\Symfony\Component\Finder\Finder())->files()->in($this->generator->getRuleSetsDocumentationDirectoryPath()) as $file) {
            $filesystem->remove($file->getPathname());
        }
