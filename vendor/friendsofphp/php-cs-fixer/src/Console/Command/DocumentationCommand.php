...
use _PhpScoperf6b7f9bf122d\Symfony\Component\Filesystem\Filesystem;
use _PhpScoperf6b7f9bf122d\Symfony\Component\Finder\Finder;
use _PhpScoperf6b7f9bf122d\Symfony\Component\Finder\SplFileInfo;
/**
 * @internal
 */
final class DocumentationCommand extends \_PhpScoperf6b7f9bf122d\Symfony\Component\Console\Command\Command
{
    ...
    {
        $filesystem = new \_PhpScoperf6b7f9bf122d\Symfony\Component\Filesystem\Filesystem();
        ...
        foreach ((new \_PhpScoperf6b7f9bf122d\Symfony\Component\Finder\Finder())->files()->in($this->generator->getFixersDocumentationDirectoryPath())->notPath($docForFixerRelativePaths) as $file) {
    ...
    private function generateRuleSetsDocs(array $fixers)
    {
        $filesystem = new \_PhpScoperf6b7f9bf122d\Symfony\Component\Filesystem\Filesystem();
        /** @var SplFileInfo $file */
        foreach ((new \_PhpScoperf6b7f9bf122d\Symfony\Component\Finder\Finder())->files()->in($this->generator->getRuleSetsDocumentationDirectoryPath()) as $file) {
            $filesystem->remove($file->getPathname());
        }
