...
use _PhpScoperd3d57724c802\Symfony\Component\Filesystem\Filesystem;
 ...
 * @internal
 */
final class DocumentationCommand extends \_PhpScoperd3d57724c802\Symfony\Component\Console\Command\Command
{
    ...
    {
        $filesystem = new \_PhpScoperd3d57724c802\Symfony\Component\Filesystem\Filesystem();
        ...
        foreach ((new \_PhpScoperd3d57724c802\Symfony\Component\Finder\Finder())->files()->in($this->generator->getFixersDocumentationDirectoryPath())->notPath($docForFixerRelativePaths) as $file) {
    ...
    private function generateRuleSetsDocs(array $fixers)
    {
        $filesystem = new \_PhpScoperd3d57724c802\Symfony\Component\Filesystem\Filesystem();
        /** @var SplFileInfo $file */
        foreach ((new \_PhpScoperd3d57724c802\Symfony\Component\Finder\Finder())->files()->in($this->generator->getRuleSetsDocumentationDirectoryPath()) as $file) {
            $filesystem->remove($file->getPathname());
        }
