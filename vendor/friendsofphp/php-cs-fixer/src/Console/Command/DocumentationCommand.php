...
use _PhpScoperf53473b45c36\Symfony\Component\Filesystem\Filesystem;
use _PhpScoperf53473b45c36\Symfony\Component\Finder\Finder;
use _PhpScoperf53473b45c36\Symfony\Component\Finder\SplFileInfo;
/**
 * @internal
 */
final class DocumentationCommand extends \_PhpScoperf53473b45c36\Symfony\Component\Console\Command\Command
{
    ...
    {
        $filesystem = new \_PhpScoperf53473b45c36\Symfony\Component\Filesystem\Filesystem();
        ...
        foreach ((new \_PhpScoperf53473b45c36\Symfony\Component\Finder\Finder())->files()->in($this->generator->getFixersDocumentationDirectoryPath())->notPath($docForFixerRelativePaths) as $file) {
    ...
    private function generateRuleSetsDocs(array $fixers)
    {
        $filesystem = new \_PhpScoperf53473b45c36\Symfony\Component\Filesystem\Filesystem();
        /** @var SplFileInfo $file */
        foreach ((new \_PhpScoperf53473b45c36\Symfony\Component\Finder\Finder())->files()->in($this->generator->getRuleSetsDocumentationDirectoryPath()) as $file) {
            $filesystem->remove($file->getPathname());
        }
