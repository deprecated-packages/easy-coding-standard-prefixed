...
final class ProcessOutput implements \PhpCsFixer\Console\Output\ProcessOutputInterface
{
     ...
     */
    public function __construct(\_PhpScoperdf6a0b341030\Symfony\Component\Console\Output\OutputInterface $output, \_PhpScoperdf6a0b341030\Symfony\Component\EventDispatcher\EventDispatcherInterface $dispatcher, $width, $nbFiles)
    {
        $this->output = $output;
