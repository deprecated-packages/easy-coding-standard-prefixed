 ...
 */
final class FixerConfigurationResolverRootless implements \PhpCsFixer\FixerConfiguration\FixerConfigurationResolverInterface
{
    /**
    ...
    {
        $this->resolver = new \PhpCsFixer\FixerConfiguration\FixerConfigurationResolver($options);
