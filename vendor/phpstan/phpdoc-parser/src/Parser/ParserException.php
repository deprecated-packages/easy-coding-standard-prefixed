...
class ParserException extends \Exception
{
    ...
    public function __construct(string $currentTokenValue, int $currentTokenType, int $currentOffset, ?int $expectedTokenType, ?string $expectedTokenValue = null)
    {
        ...
        if ($expectedTokenType !== null) {
            parent::__construct(\sprintf('Unexpected token %s, expected %s at offset %d', $json, \_PhpScoper5ea36b274140\PHPStan\PhpDocParser\Lexer\Lexer::TOKEN_LABELS[$expectedTokenType], $currentOffset));
