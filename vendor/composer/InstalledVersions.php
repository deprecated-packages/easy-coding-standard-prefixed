...
namespace _PhpScoper86aebf8cf357\Composer;

use _PhpScoper86aebf8cf357\Composer\Autoload\ClassLoader;
use _PhpScoper86aebf8cf357\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper86aebf8cf357\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper86aebf8cf357\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper86aebf8cf357\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper86aebf8cf357\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
