...
namespace _PhpScoperfde42a25c345\Composer;

use _PhpScoperfde42a25c345\Composer\Autoload\ClassLoader;
use _PhpScoperfde42a25c345\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperfde42a25c345\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoperfde42a25c345\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
