...
namespace _PhpScoperff1e514762b4\Composer;

use _PhpScoperff1e514762b4\Composer\Autoload\ClassLoader;
use _PhpScoperff1e514762b4\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperff1e514762b4\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoperff1e514762b4\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
