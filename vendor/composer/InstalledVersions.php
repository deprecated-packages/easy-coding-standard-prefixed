...
namespace _PhpScoper8a1ea80774eb\Composer;

use _PhpScoper8a1ea80774eb\Composer\Autoload\ClassLoader;
use _PhpScoper8a1ea80774eb\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper8a1ea80774eb\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper8a1ea80774eb\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
