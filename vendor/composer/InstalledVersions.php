...
namespace _PhpScoper8b3c9ad56565\Composer;

use _PhpScoper8b3c9ad56565\Composer\Autoload\ClassLoader;
use _PhpScoper8b3c9ad56565\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper8b3c9ad56565\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper8b3c9ad56565\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
