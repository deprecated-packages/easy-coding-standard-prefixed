...
namespace _PhpScoper64e7ad844899\Composer;

use _PhpScoper64e7ad844899\Composer\Autoload\ClassLoader;
use _PhpScoper64e7ad844899\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper64e7ad844899\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper64e7ad844899\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper64e7ad844899\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
