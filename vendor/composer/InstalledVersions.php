...
namespace _PhpScoper457dd3bd73ba\Composer;

use _PhpScoper457dd3bd73ba\Composer\Autoload\ClassLoader;
use _PhpScoper457dd3bd73ba\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper457dd3bd73ba\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper457dd3bd73ba\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper457dd3bd73ba\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper457dd3bd73ba\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
