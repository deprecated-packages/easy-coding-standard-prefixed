...
namespace _PhpScoper255a4eaff575\Composer;

use _PhpScoper255a4eaff575\Composer\Autoload\ClassLoader;
use _PhpScoper255a4eaff575\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper255a4eaff575\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper255a4eaff575\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper255a4eaff575\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper255a4eaff575\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
