...
namespace _PhpScoper4575b9150b52\Composer;

use _PhpScoper4575b9150b52\Composer\Autoload\ClassLoader;
use _PhpScoper4575b9150b52\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper4575b9150b52\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper4575b9150b52\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
