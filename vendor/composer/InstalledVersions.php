...
namespace _PhpScopercae9e6ab5cea\Composer;

use _PhpScopercae9e6ab5cea\Composer\Autoload\ClassLoader;
use _PhpScopercae9e6ab5cea\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScopercae9e6ab5cea\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScopercae9e6ab5cea\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
