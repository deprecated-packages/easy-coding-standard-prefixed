...
namespace _PhpScoper0a055416a443\Composer;

use _PhpScoper0a055416a443\Composer\Autoload\ClassLoader;
use _PhpScoper0a055416a443\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper0a055416a443\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper0a055416a443\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
