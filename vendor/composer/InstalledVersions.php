...
namespace _PhpScoper6b644dbe715d\Composer;

use _PhpScoper6b644dbe715d\Composer\Autoload\ClassLoader;
use _PhpScoper6b644dbe715d\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper6b644dbe715d\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper6b644dbe715d\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper6b644dbe715d\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper6b644dbe715d\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
