...
namespace _PhpScopere72a8aaba560\Composer;

use _PhpScopere72a8aaba560\Composer\Autoload\ClassLoader;
use _PhpScopere72a8aaba560\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScopere72a8aaba560\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScopere72a8aaba560\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
