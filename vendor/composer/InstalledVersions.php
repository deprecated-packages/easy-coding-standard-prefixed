...
namespace _PhpScopera48d5dbb002d\Composer;

use _PhpScopera48d5dbb002d\Composer\Autoload\ClassLoader;
use _PhpScopera48d5dbb002d\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScopera48d5dbb002d\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScopera48d5dbb002d\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
