...
namespace _PhpScoper757c066053f8\Composer;

use _PhpScoper757c066053f8\Composer\Autoload\ClassLoader;
use _PhpScoper757c066053f8\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper757c066053f8\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper757c066053f8\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
