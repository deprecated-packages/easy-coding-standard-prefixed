...
namespace _PhpScoper2dc059b3a969\Composer;

use _PhpScoper2dc059b3a969\Composer\Autoload\ClassLoader;
use _PhpScoper2dc059b3a969\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper2dc059b3a969\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper2dc059b3a969\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
