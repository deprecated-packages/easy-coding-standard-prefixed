...
namespace _PhpScoper971ef29294dd\Composer;

use _PhpScoper971ef29294dd\Composer\Autoload\ClassLoader;
use _PhpScoper971ef29294dd\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper971ef29294dd\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper971ef29294dd\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper971ef29294dd\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
