...
namespace _PhpScoper0261263ca84f\Composer;

use _PhpScoper0261263ca84f\Composer\Autoload\ClassLoader;
use _PhpScoper0261263ca84f\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper0261263ca84f\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper0261263ca84f\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
