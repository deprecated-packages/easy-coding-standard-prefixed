...
namespace _PhpScopera658fe86acec\Composer;

use _PhpScopera658fe86acec\Composer\Autoload\ClassLoader;
use _PhpScopera658fe86acec\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScopera658fe86acec\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScopera658fe86acec\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
