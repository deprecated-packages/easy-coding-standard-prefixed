...
namespace _PhpScoper890197fe38f7\Composer;

use _PhpScoper890197fe38f7\Composer\Autoload\ClassLoader;
use _PhpScoper890197fe38f7\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper890197fe38f7\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper890197fe38f7\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
