...
namespace _PhpScopera22bb3f4d7b7\Composer;

use _PhpScopera22bb3f4d7b7\Composer\Autoload\ClassLoader;
use _PhpScopera22bb3f4d7b7\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScopera22bb3f4d7b7\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScopera22bb3f4d7b7\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
