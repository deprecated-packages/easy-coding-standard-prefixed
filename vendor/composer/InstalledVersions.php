...
namespace _PhpScoper5686a261d89c\Composer;

use _PhpScoper5686a261d89c\Composer\Autoload\ClassLoader;
use _PhpScoper5686a261d89c\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper5686a261d89c\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper5686a261d89c\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
