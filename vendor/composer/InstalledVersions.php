...
namespace _PhpScoper000f93dc572d\Composer;

use _PhpScoper000f93dc572d\Composer\Autoload\ClassLoader;
use _PhpScoper000f93dc572d\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper000f93dc572d\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper000f93dc572d\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
