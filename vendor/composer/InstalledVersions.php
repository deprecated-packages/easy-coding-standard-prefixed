...
namespace _PhpScoper2dcc760f8ff8\Composer;

use _PhpScoper2dcc760f8ff8\Composer\Autoload\ClassLoader;
use _PhpScoper2dcc760f8ff8\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper2dcc760f8ff8\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper2dcc760f8ff8\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
