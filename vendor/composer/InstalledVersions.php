...
namespace _PhpScopere050faf861e6\Composer;

use _PhpScopere050faf861e6\Composer\Autoload\ClassLoader;
use _PhpScopere050faf861e6\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScopere050faf861e6\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScopere050faf861e6\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScopere050faf861e6\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
