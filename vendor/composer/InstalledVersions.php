...
namespace _PhpScoper14718bfcc75e\Composer;

use _PhpScoper14718bfcc75e\Composer\Autoload\ClassLoader;
use _PhpScoper14718bfcc75e\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper14718bfcc75e\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper14718bfcc75e\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper14718bfcc75e\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper14718bfcc75e\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
