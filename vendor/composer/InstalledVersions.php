...
namespace _PhpScoper0b185984cfb7\Composer;

use _PhpScoper0b185984cfb7\Composer\Autoload\ClassLoader;
use _PhpScoper0b185984cfb7\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper0b185984cfb7\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper0b185984cfb7\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper0b185984cfb7\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
