...
namespace _PhpScoperdb89411b20b4\Composer;

use _PhpScoperdb89411b20b4\Composer\Autoload\ClassLoader;
use _PhpScoperdb89411b20b4\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperdb89411b20b4\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoperdb89411b20b4\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
