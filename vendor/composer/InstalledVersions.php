...
namespace _PhpScoper0ba97041430d\Composer;

use _PhpScoper0ba97041430d\Composer\Autoload\ClassLoader;
use _PhpScoper0ba97041430d\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper0ba97041430d\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper0ba97041430d\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper0ba97041430d\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
