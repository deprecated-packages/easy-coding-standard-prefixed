...
namespace _PhpScoper653866602a9e\Composer;

use _PhpScoper653866602a9e\Composer\Autoload\ClassLoader;
use _PhpScoper653866602a9e\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper653866602a9e\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper653866602a9e\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
