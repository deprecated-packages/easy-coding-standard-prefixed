...
namespace _PhpScoper27cac5a8b4ab\Composer;

use _PhpScoper27cac5a8b4ab\Composer\Autoload\ClassLoader;
use _PhpScoper27cac5a8b4ab\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper27cac5a8b4ab\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper27cac5a8b4ab\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
