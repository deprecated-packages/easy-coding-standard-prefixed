...
namespace _PhpScoper842c7347e6be\Composer;

use _PhpScoper842c7347e6be\Composer\Autoload\ClassLoader;
use _PhpScoper842c7347e6be\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper842c7347e6be\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper842c7347e6be\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper842c7347e6be\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
