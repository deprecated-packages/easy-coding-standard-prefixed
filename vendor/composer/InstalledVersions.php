...
namespace _PhpScoper1ed8518cf1bf\Composer;

use _PhpScoper1ed8518cf1bf\Composer\Autoload\ClassLoader;
use _PhpScoper1ed8518cf1bf\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper1ed8518cf1bf\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper1ed8518cf1bf\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper1ed8518cf1bf\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper1ed8518cf1bf\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
