...
namespace _PhpScoper57c79939064b\Composer;

use _PhpScoper57c79939064b\Composer\Autoload\ClassLoader;
use _PhpScoper57c79939064b\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper57c79939064b\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper57c79939064b\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper57c79939064b\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper57c79939064b\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
