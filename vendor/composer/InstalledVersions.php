...
namespace _PhpScoper446d16070175\Composer;

use _PhpScoper446d16070175\Composer\Autoload\ClassLoader;
use _PhpScoper446d16070175\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper446d16070175\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper446d16070175\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
