...
namespace _PhpScoper855b7fb41c61\Composer;

use _PhpScoper855b7fb41c61\Composer\Autoload\ClassLoader;
use _PhpScoper855b7fb41c61\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper855b7fb41c61\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper855b7fb41c61\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
