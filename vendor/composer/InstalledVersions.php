...
namespace _PhpScoperd51690aa3091\Composer;

use _PhpScoperd51690aa3091\Composer\Autoload\ClassLoader;
use _PhpScoperd51690aa3091\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperd51690aa3091\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoperd51690aa3091\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
