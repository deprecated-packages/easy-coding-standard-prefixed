...
namespace _PhpScoper45e1bde0f567\Composer;

use _PhpScoper45e1bde0f567\Composer\Autoload\ClassLoader;
use _PhpScoper45e1bde0f567\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper45e1bde0f567\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper45e1bde0f567\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
