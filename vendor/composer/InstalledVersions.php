...
namespace _PhpScoper7b319b4d8e1c\Composer;

use _PhpScoper7b319b4d8e1c\Composer\Autoload\ClassLoader;
use _PhpScoper7b319b4d8e1c\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper7b319b4d8e1c\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper7b319b4d8e1c\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper7b319b4d8e1c\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper7b319b4d8e1c\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
