...
namespace _PhpScoper2f04ef4e8878\Composer;

use _PhpScoper2f04ef4e8878\Composer\Autoload\ClassLoader;
use _PhpScoper2f04ef4e8878\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper2f04ef4e8878\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper2f04ef4e8878\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper2f04ef4e8878\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper2f04ef4e8878\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
