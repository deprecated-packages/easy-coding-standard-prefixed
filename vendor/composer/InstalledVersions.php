...
namespace _PhpScoper82a1412fb847\Composer;

use _PhpScoper82a1412fb847\Composer\Autoload\ClassLoader;
use _PhpScoper82a1412fb847\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper82a1412fb847\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper82a1412fb847\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
