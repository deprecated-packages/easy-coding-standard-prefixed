...
namespace _PhpScoperc5e9eb67638f\Composer;

use _PhpScoperc5e9eb67638f\Composer\Autoload\ClassLoader;
use _PhpScoperc5e9eb67638f\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperc5e9eb67638f\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoperc5e9eb67638f\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
