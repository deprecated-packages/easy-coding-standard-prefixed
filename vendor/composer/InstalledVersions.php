...
namespace _PhpScopere7e518ee6a5b\Composer;

use _PhpScopere7e518ee6a5b\Composer\Autoload\ClassLoader;
use _PhpScopere7e518ee6a5b\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScopere7e518ee6a5b\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScopere7e518ee6a5b\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
