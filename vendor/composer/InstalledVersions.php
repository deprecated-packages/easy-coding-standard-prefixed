...
namespace _PhpScoper917c99b6aa4c\Composer;

use _PhpScoper917c99b6aa4c\Composer\Autoload\ClassLoader;
use _PhpScoper917c99b6aa4c\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper917c99b6aa4c\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper917c99b6aa4c\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
