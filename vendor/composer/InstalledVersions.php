...
namespace _PhpScoper89c09b8e7101\Composer;

use _PhpScoper89c09b8e7101\Composer\Autoload\ClassLoader;
use _PhpScoper89c09b8e7101\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper89c09b8e7101\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper89c09b8e7101\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper89c09b8e7101\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
