...
namespace _PhpScoperef2f7aa3581e\Composer;

use _PhpScoperef2f7aa3581e\Composer\Autoload\ClassLoader;
use _PhpScoperef2f7aa3581e\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperef2f7aa3581e\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoperef2f7aa3581e\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
