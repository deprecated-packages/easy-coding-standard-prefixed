...
namespace _PhpScoperfb0714773dc5\Composer;

use _PhpScoperfb0714773dc5\Composer\Autoload\ClassLoader;
use _PhpScoperfb0714773dc5\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoperfb0714773dc5\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperfb0714773dc5\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoperfb0714773dc5\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
