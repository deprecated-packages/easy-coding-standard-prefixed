...
namespace _PhpScoperf5c57eca8aae\Composer;

use _PhpScoperf5c57eca8aae\Composer\Autoload\ClassLoader;
use _PhpScoperf5c57eca8aae\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoperf5c57eca8aae\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperf5c57eca8aae\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoperf5c57eca8aae\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoperf5c57eca8aae\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
