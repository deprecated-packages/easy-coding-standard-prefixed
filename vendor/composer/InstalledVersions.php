...
namespace _PhpScoper5f6e904600e7\Composer;

use _PhpScoper5f6e904600e7\Composer\Autoload\ClassLoader;
use _PhpScoper5f6e904600e7\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper5f6e904600e7\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper5f6e904600e7\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper5f6e904600e7\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
