...
namespace _PhpScopera9d6a31d814c\Composer;

use _PhpScopera9d6a31d814c\Composer\Autoload\ClassLoader;
use _PhpScopera9d6a31d814c\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScopera9d6a31d814c\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScopera9d6a31d814c\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
