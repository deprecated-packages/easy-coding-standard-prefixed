...
namespace _PhpScoper514703a076a2\Composer;

use _PhpScoper514703a076a2\Composer\Autoload\ClassLoader;
use _PhpScoper514703a076a2\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper514703a076a2\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper514703a076a2\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
