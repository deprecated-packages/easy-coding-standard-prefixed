...
namespace _PhpScoper7239e3eaf11a\Composer;

use _PhpScoper7239e3eaf11a\Composer\Autoload\ClassLoader;
use _PhpScoper7239e3eaf11a\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper7239e3eaf11a\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper7239e3eaf11a\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
