...
namespace _PhpScoperf6b7f9bf122d\Composer;

use _PhpScoperf6b7f9bf122d\Composer\Autoload\ClassLoader;
use _PhpScoperf6b7f9bf122d\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoperf6b7f9bf122d\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperf6b7f9bf122d\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoperf6b7f9bf122d\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoperf6b7f9bf122d\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
