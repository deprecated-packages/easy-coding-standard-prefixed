...
namespace _PhpScoper0c0702cca4ac\Composer;

use _PhpScoper0c0702cca4ac\Composer\Autoload\ClassLoader;
use _PhpScoper0c0702cca4ac\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper0c0702cca4ac\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper0c0702cca4ac\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper0c0702cca4ac\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
