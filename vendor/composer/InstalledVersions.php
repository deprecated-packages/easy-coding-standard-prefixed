...
namespace _PhpScoper1ddca3f92d7d\Composer;

use _PhpScoper1ddca3f92d7d\Composer\Autoload\ClassLoader;
use _PhpScoper1ddca3f92d7d\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper1ddca3f92d7d\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper1ddca3f92d7d\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
