...
namespace _PhpScoper246d3630afdd\Composer;

use _PhpScoper246d3630afdd\Composer\Autoload\ClassLoader;
use _PhpScoper246d3630afdd\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper246d3630afdd\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper246d3630afdd\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper246d3630afdd\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
