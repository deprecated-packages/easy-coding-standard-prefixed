...
namespace _PhpScoper91c59a2f52e1\Composer;

use _PhpScoper91c59a2f52e1\Composer\Autoload\ClassLoader;
use _PhpScoper91c59a2f52e1\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper91c59a2f52e1\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper91c59a2f52e1\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
