...
namespace _PhpScoper22e359cd1ab0\Composer;

use _PhpScoper22e359cd1ab0\Composer\Autoload\ClassLoader;
use _PhpScoper22e359cd1ab0\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper22e359cd1ab0\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper22e359cd1ab0\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
