...
namespace _PhpScoper2d11f18408ea\Composer;

use _PhpScoper2d11f18408ea\Composer\Autoload\ClassLoader;
use _PhpScoper2d11f18408ea\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper2d11f18408ea\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper2d11f18408ea\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
