...
namespace _PhpScoper4fedb9aa1e5f\Composer;

use _PhpScoper4fedb9aa1e5f\Composer\Autoload\ClassLoader;
use _PhpScoper4fedb9aa1e5f\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper4fedb9aa1e5f\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper4fedb9aa1e5f\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
