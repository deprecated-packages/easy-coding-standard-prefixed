...
namespace _PhpScoper9385100df341\Composer;

use _PhpScoper9385100df341\Composer\Autoload\ClassLoader;
use _PhpScoper9385100df341\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper9385100df341\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper9385100df341\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
