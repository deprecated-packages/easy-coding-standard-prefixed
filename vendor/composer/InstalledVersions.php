...
namespace _PhpScoper3f3a54dd086f\Composer;

use _PhpScoper3f3a54dd086f\Composer\Autoload\ClassLoader;
use _PhpScoper3f3a54dd086f\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper3f3a54dd086f\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper3f3a54dd086f\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper3f3a54dd086f\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
