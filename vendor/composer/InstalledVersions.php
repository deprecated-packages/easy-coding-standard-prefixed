...
namespace _PhpScoper9907e2e69ce3\Composer;

use _PhpScoper9907e2e69ce3\Composer\Autoload\ClassLoader;
use _PhpScoper9907e2e69ce3\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper9907e2e69ce3\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper9907e2e69ce3\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
