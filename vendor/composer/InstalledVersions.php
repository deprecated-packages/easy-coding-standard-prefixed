...
namespace _PhpScoper53db80252f28\Composer;

use _PhpScoper53db80252f28\Composer\Autoload\ClassLoader;
use _PhpScoper53db80252f28\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper53db80252f28\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper53db80252f28\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
