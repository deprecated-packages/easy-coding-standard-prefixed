...
namespace _PhpScoper1b2f8b9c0339\Composer;

use _PhpScoper1b2f8b9c0339\Composer\Autoload\ClassLoader;
use _PhpScoper1b2f8b9c0339\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper1b2f8b9c0339\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper1b2f8b9c0339\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
