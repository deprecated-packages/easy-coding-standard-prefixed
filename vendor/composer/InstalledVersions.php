...
namespace _PhpScoper0752b31150a1\Composer;

use _PhpScoper0752b31150a1\Composer\Autoload\ClassLoader;
use _PhpScoper0752b31150a1\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper0752b31150a1\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper0752b31150a1\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
