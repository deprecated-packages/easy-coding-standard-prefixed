...
namespace _PhpScoper0c575b5c37d7\Composer;

use _PhpScoper0c575b5c37d7\Composer\Autoload\ClassLoader;
use _PhpScoper0c575b5c37d7\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper0c575b5c37d7\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper0c575b5c37d7\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
