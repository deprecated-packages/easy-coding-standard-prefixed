...
namespace _PhpScoperf361a7d70552\Composer;

use _PhpScoperf361a7d70552\Composer\Autoload\ClassLoader;
use _PhpScoperf361a7d70552\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoperf361a7d70552\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperf361a7d70552\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoperf361a7d70552\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
