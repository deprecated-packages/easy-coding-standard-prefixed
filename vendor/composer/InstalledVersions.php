...
namespace _PhpScoper4e2df00556a9\Composer;

use _PhpScoper4e2df00556a9\Composer\Autoload\ClassLoader;
use _PhpScoper4e2df00556a9\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper4e2df00556a9\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper4e2df00556a9\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper4e2df00556a9\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
