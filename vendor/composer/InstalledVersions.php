...
namespace _PhpScopera1f11cc38772\Composer;

use _PhpScopera1f11cc38772\Composer\Autoload\ClassLoader;
use _PhpScopera1f11cc38772\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScopera1f11cc38772\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScopera1f11cc38772\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScopera1f11cc38772\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
