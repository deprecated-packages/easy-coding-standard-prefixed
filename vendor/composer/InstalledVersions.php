...
namespace _PhpScoper6b1da46bea54\Composer;

use _PhpScoper6b1da46bea54\Composer\Autoload\ClassLoader;
use _PhpScoper6b1da46bea54\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper6b1da46bea54\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper6b1da46bea54\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
