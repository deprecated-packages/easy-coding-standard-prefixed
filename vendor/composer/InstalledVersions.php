...
namespace _PhpScoper1c0f546920a5\Composer;

use _PhpScoper1c0f546920a5\Composer\Autoload\ClassLoader;
use _PhpScoper1c0f546920a5\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper1c0f546920a5\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper1c0f546920a5\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
