...
namespace _PhpScoper91fe47cd7f25\Composer;

use _PhpScoper91fe47cd7f25\Composer\Autoload\ClassLoader;
use _PhpScoper91fe47cd7f25\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper91fe47cd7f25\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper91fe47cd7f25\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
