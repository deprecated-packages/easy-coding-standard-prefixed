...
namespace _PhpScoper3c4e863e8a34\Composer;

use _PhpScoper3c4e863e8a34\Composer\Autoload\ClassLoader;
use _PhpScoper3c4e863e8a34\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper3c4e863e8a34\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper3c4e863e8a34\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
