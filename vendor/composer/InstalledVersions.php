...
namespace _PhpScoper9a024705919c\Composer;

use _PhpScoper9a024705919c\Composer\Autoload\ClassLoader;
use _PhpScoper9a024705919c\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper9a024705919c\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper9a024705919c\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\_PhpScoper9a024705919c\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
...
\class_alias('_PhpScoper9a024705919c\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
