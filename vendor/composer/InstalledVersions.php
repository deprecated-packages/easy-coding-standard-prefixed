...
namespace _PhpScoperd2a667bd5a98\Composer;

use _PhpScoperd2a667bd5a98\Composer\Autoload\ClassLoader;
use _PhpScoperd2a667bd5a98\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoperd2a667bd5a98\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoperd2a667bd5a98\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
