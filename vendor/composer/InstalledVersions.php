...
namespace _PhpScoper8a8080b03ed6\Composer;

use _PhpScoper8a8080b03ed6\Composer\Autoload\ClassLoader;
use _PhpScoper8a8080b03ed6\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper8a8080b03ed6\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper8a8080b03ed6\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
