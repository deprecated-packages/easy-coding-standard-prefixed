...
namespace _PhpScoper08fb1f8a2f44\Composer;

use _PhpScoper08fb1f8a2f44\Composer\Autoload\ClassLoader;
use _PhpScoper08fb1f8a2f44\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper08fb1f8a2f44\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper08fb1f8a2f44\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
