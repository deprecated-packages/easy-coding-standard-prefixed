...
namespace _PhpScoper5f836821822a\Composer;

use _PhpScoper5f836821822a\Composer\Autoload\ClassLoader;
use _PhpScoper5f836821822a\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper5f836821822a\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper5f836821822a\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
