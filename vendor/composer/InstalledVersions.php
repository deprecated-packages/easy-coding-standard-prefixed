...
namespace _PhpScoper2737ffe13a7b\Composer;

use _PhpScoper2737ffe13a7b\Composer\Autoload\ClassLoader;
use _PhpScoper2737ffe13a7b\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper2737ffe13a7b\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
...
\class_alias('_PhpScoper2737ffe13a7b\\Composer\\InstalledVersions', 'Composer\\InstalledVersions', \false);
