...
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoperf3f1be0d8a30\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
