 ...
 */
namespace _PhpScoperc7a2896cc805\Composer\XdebugHandler;
...
class PhpConfig
{
    ...
    {
        if ($data = \_PhpScoperc7a2896cc805\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \_PhpScoperc7a2896cc805\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
