...
class Status
{
    ...
    public function __construct($envAllowXdebug, $debug)
    {
        ...
        \_PhpScoper08fb1f8a2f44\Composer\XdebugHandler\Process::setEnv(self::ENV_RESTART);
    ...
    {
        $this->output($this->getLoadedMessage());
        \_PhpScoper08fb1f8a2f44\Composer\XdebugHandler\Process::setEnv(self::ENV_RESTART, (string) \microtime(\true));
    }
