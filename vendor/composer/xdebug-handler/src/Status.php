...
class Status
{
    ...
    public function __construct($envAllowXdebug, $debug)
    {
        ...
        \_PhpScopercfeba9d8ad31\Composer\XdebugHandler\Process::setEnv(self::ENV_RESTART);
    ...
    {
        $this->output($this->getLoadedMessage());
        \_PhpScopercfeba9d8ad31\Composer\XdebugHandler\Process::setEnv(self::ENV_RESTART, (string) \microtime(\true));
    }
