...
use _PhpScoper246d3630afdd\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper246d3630afdd\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper246d3630afdd\Composer\InstalledVersions::class, \false) || !\_PhpScoper246d3630afdd\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper246d3630afdd\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper246d3630afdd\Composer\InstalledVersions::class, \false) && \_PhpScoper246d3630afdd\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper246d3630afdd\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper246d3630afdd\Composer\InstalledVersions::getReference($packageName);
        }
