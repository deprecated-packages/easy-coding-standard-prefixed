...
\class_exists(\_PhpScopera1f11cc38772\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScopera1f11cc38772\Composer\InstalledVersions::class, \false) || !\_PhpScopera1f11cc38772\Composer\InstalledVersions::getRawData()) {
    ...
    {
        if (\class_exists(\_PhpScopera1f11cc38772\Composer\InstalledVersions::class, \false) && \_PhpScopera1f11cc38772\Composer\InstalledVersions::getRawData()) {
            return \_PhpScopera1f11cc38772\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScopera1f11cc38772\Composer\InstalledVersions::getReference($packageName);
        }
