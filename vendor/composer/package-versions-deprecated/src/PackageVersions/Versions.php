...
use _PhpScoper3f3a54dd086f\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper3f3a54dd086f\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper3f3a54dd086f\Composer\InstalledVersions::class, \false) || !\_PhpScoper3f3a54dd086f\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper3f3a54dd086f\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper3f3a54dd086f\Composer\InstalledVersions::class, \false) && \_PhpScoper3f3a54dd086f\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper3f3a54dd086f\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper3f3a54dd086f\Composer\InstalledVersions::getReference($packageName);
        }
