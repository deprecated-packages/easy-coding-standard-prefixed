...
use _PhpScoper356bfb655d08\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper356bfb655d08\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper356bfb655d08\Composer\InstalledVersions::class, \false) || !\_PhpScoper356bfb655d08\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper356bfb655d08\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper356bfb655d08\Composer\InstalledVersions::class, \false) && \_PhpScoper356bfb655d08\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper356bfb655d08\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper356bfb655d08\Composer\InstalledVersions::getReference($packageName);
        }
