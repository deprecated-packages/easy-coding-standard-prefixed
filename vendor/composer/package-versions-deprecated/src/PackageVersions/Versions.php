...
\class_exists(\_PhpScoper64e7ad844899\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper64e7ad844899\Composer\InstalledVersions::class, \false) || !\_PhpScoper64e7ad844899\Composer\InstalledVersions::getRawData()) {
    ...
    {
        if (\class_exists(\_PhpScoper64e7ad844899\Composer\InstalledVersions::class, \false) && \_PhpScoper64e7ad844899\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper64e7ad844899\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper64e7ad844899\Composer\InstalledVersions::getReference($packageName);
        }
