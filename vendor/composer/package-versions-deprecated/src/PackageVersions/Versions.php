...
use _PhpScoperc4ea0f0bd23f\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoperc4ea0f0bd23f\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoperc4ea0f0bd23f\Composer\InstalledVersions::class, \false) || !\_PhpScoperc4ea0f0bd23f\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoperc4ea0f0bd23f\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoperc4ea0f0bd23f\Composer\InstalledVersions::class, \false) && \_PhpScoperc4ea0f0bd23f\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoperc4ea0f0bd23f\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoperc4ea0f0bd23f\Composer\InstalledVersions::getReference($packageName);
        }
