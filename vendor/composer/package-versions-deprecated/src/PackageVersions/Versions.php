...
use _PhpScopere24d949bf310\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScopere24d949bf310\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScopere24d949bf310\Composer\InstalledVersions::class, \false) || !\_PhpScopere24d949bf310\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScopere24d949bf310\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScopere24d949bf310\Composer\InstalledVersions::class, \false) && \_PhpScopere24d949bf310\Composer\InstalledVersions::getRawData()) {
            return \_PhpScopere24d949bf310\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScopere24d949bf310\Composer\InstalledVersions::getReference($packageName);
        }
