...
\class_exists(\_PhpScoper8163b0b2b8f3\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper8163b0b2b8f3\Composer\InstalledVersions::class, \false) || !\_PhpScoper8163b0b2b8f3\Composer\InstalledVersions::getRawData()) {
    ...
    {
        if (\class_exists(\_PhpScoper8163b0b2b8f3\Composer\InstalledVersions::class, \false) && \_PhpScoper8163b0b2b8f3\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper8163b0b2b8f3\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper8163b0b2b8f3\Composer\InstalledVersions::getReference($packageName);
        }
