...
use _PhpScoper70e3784a2d21\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper70e3784a2d21\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper70e3784a2d21\Composer\InstalledVersions::class, \false) || !\_PhpScoper70e3784a2d21\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper70e3784a2d21\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper70e3784a2d21\Composer\InstalledVersions::class, \false) && \_PhpScoper70e3784a2d21\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper70e3784a2d21\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper70e3784a2d21\Composer\InstalledVersions::getReference($packageName);
        }
