...
use _PhpScoper35ec99c463ee\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper35ec99c463ee\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper35ec99c463ee\Composer\InstalledVersions::class, \false) || !\_PhpScoper35ec99c463ee\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper35ec99c463ee\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper35ec99c463ee\Composer\InstalledVersions::class, \false) && \_PhpScoper35ec99c463ee\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper35ec99c463ee\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper35ec99c463ee\Composer\InstalledVersions::getReference($packageName);
        }
