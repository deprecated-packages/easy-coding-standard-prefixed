...
use _PhpScoper8583deb8ab74\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper8583deb8ab74\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper8583deb8ab74\Composer\InstalledVersions::class, \false) || !\_PhpScoper8583deb8ab74\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper8583deb8ab74\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper8583deb8ab74\Composer\InstalledVersions::class, \false) && \_PhpScoper8583deb8ab74\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper8583deb8ab74\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper8583deb8ab74\Composer\InstalledVersions::getReference($packageName);
        }
