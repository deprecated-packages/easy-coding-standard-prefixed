...
use _PhpScoperb0c6500a504c\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoperb0c6500a504c\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoperb0c6500a504c\Composer\InstalledVersions::class, \false) || !\_PhpScoperb0c6500a504c\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoperb0c6500a504c\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoperb0c6500a504c\Composer\InstalledVersions::class, \false) && \_PhpScoperb0c6500a504c\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoperb0c6500a504c\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoperb0c6500a504c\Composer\InstalledVersions::getReference($packageName);
        }
