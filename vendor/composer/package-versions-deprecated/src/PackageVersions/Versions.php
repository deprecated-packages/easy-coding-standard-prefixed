...
\class_exists(\_PhpScoper8a7636b3fdaf\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper8a7636b3fdaf\Composer\InstalledVersions::class, \false) || !\_PhpScoper8a7636b3fdaf\Composer\InstalledVersions::getRawData()) {
    ...
    {
        if (\class_exists(\_PhpScoper8a7636b3fdaf\Composer\InstalledVersions::class, \false) && \_PhpScoper8a7636b3fdaf\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper8a7636b3fdaf\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper8a7636b3fdaf\Composer\InstalledVersions::getReference($packageName);
        }
