...
use _PhpScoper7faa8deb0d3c\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper7faa8deb0d3c\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper7faa8deb0d3c\Composer\InstalledVersions::class, \false) || !\_PhpScoper7faa8deb0d3c\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper7faa8deb0d3c\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper7faa8deb0d3c\Composer\InstalledVersions::class, \false) && \_PhpScoper7faa8deb0d3c\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper7faa8deb0d3c\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper7faa8deb0d3c\Composer\InstalledVersions::getReference($packageName);
        }
