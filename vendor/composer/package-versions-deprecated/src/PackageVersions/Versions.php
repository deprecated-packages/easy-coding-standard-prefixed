...
use _PhpScoper842c7347e6be\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper842c7347e6be\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper842c7347e6be\Composer\InstalledVersions::class, \false) || !\_PhpScoper842c7347e6be\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper842c7347e6be\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper842c7347e6be\Composer\InstalledVersions::class, \false) && \_PhpScoper842c7347e6be\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper842c7347e6be\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper842c7347e6be\Composer\InstalledVersions::getReference($packageName);
        }
