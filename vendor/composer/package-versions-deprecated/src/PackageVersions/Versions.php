...
use _PhpScoper0c0702cca4ac\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper0c0702cca4ac\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper0c0702cca4ac\Composer\InstalledVersions::class, \false) || !\_PhpScoper0c0702cca4ac\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper0c0702cca4ac\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper0c0702cca4ac\Composer\InstalledVersions::class, \false) && \_PhpScoper0c0702cca4ac\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper0c0702cca4ac\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper0c0702cca4ac\Composer\InstalledVersions::getReference($packageName);
        }
