...
use _PhpScoper8ca6426d4e0c\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper8ca6426d4e0c\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper8ca6426d4e0c\Composer\InstalledVersions::class, \false) || !\_PhpScoper8ca6426d4e0c\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper8ca6426d4e0c\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper8ca6426d4e0c\Composer\InstalledVersions::class, \false) && \_PhpScoper8ca6426d4e0c\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper8ca6426d4e0c\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper8ca6426d4e0c\Composer\InstalledVersions::getReference($packageName);
        }
