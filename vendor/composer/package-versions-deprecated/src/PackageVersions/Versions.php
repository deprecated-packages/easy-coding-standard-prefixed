...
use _PhpScoper870c18c2de74\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoper870c18c2de74\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoper870c18c2de74\Composer\InstalledVersions::class, \false) || !\_PhpScoper870c18c2de74\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoper870c18c2de74\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoper870c18c2de74\Composer\InstalledVersions::class, \false) && \_PhpScoper870c18c2de74\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoper870c18c2de74\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoper870c18c2de74\Composer\InstalledVersions::getReference($packageName);
        }
