...
use _PhpScopera609aff833be\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScopera609aff833be\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScopera609aff833be\Composer\InstalledVersions::class, \false) || !\_PhpScopera609aff833be\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScopera609aff833be\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScopera609aff833be\Composer\InstalledVersions::class, \false) && \_PhpScopera609aff833be\Composer\InstalledVersions::getRawData()) {
            return \_PhpScopera609aff833be\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScopera609aff833be\Composer\InstalledVersions::getReference($packageName);
        }
