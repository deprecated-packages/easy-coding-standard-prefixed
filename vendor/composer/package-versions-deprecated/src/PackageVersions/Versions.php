...
use _PhpScoperf53473b45c36\Composer\InstalledVersions;
use OutOfBoundsException;
\class_exists(\_PhpScoperf53473b45c36\Composer\InstalledVersions::class);
/**
...
final class Versions
{
    ...
    {
        if (!\class_exists(\_PhpScoperf53473b45c36\Composer\InstalledVersions::class, \false) || !\_PhpScoperf53473b45c36\Composer\InstalledVersions::getRawData()) {
            return self::ROOT_PACKAGE_NAME;
        }
        return \_PhpScoperf53473b45c36\Composer\InstalledVersions::getRootPackage()['name'];
    }
    /**
    ...
    {
        if (\class_exists(\_PhpScoperf53473b45c36\Composer\InstalledVersions::class, \false) && \_PhpScoperf53473b45c36\Composer\InstalledVersions::getRawData()) {
            return \_PhpScoperf53473b45c36\Composer\InstalledVersions::getPrettyVersion($packageName) . '@' . \_PhpScoperf53473b45c36\Composer\InstalledVersions::getReference($packageName);
        }
