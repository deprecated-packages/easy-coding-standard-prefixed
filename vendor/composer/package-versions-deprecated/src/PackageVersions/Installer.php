...
use _PhpScoper797695bcfb1f\Composer\Config;
...
use _PhpScoper797695bcfb1f\Composer\Package\Locker;
...
final class Installer implements \_PhpScoper797695bcfb1f\Composer\Plugin\PluginInterface, \_PhpScoper797695bcfb1f\Composer\EventDispatcher\EventSubscriberInterface
{
...
PHP;
    ...
    {
        return [\_PhpScoper797695bcfb1f\Composer\Script\ScriptEvents::POST_AUTOLOAD_DUMP => 'dumpVersionsClass'];
    }
    /**
     * @throws RuntimeException
     */
    public static function dumpVersionsClass(\_PhpScoper797695bcfb1f\Composer\Script\Event $composerEvent)
    {
     ...
     * @throws RuntimeException
     */
    private static function writeVersionClassToFile(string $versionClassSource, \_PhpScoper797695bcfb1f\Composer\Composer $composer, \_PhpScoper797695bcfb1f\Composer\IO\IOInterface $io)
    {
        ...
        if (\version_compare(\_PhpScoper797695bcfb1f\Composer\Plugin\PluginInterface::PLUGIN_API_VERSION, '2.0.0', '>=')) {
     ...
     * @throws RuntimeException
     */
    private static function locateRootPackageInstallPath(\_PhpScoper797695bcfb1f\Composer\Config $composerConfig, \_PhpScoper797695bcfb1f\Composer\Package\RootPackageInterface $rootPackage) : string
    {
    ...
    private static function getRootPackageAlias(\_PhpScoper797695bcfb1f\Composer\Package\RootPackageInterface $rootPackage) : \_PhpScoper797695bcfb1f\Composer\Package\PackageInterface
    {
        $package = $rootPackage;
        while ($package instanceof \_PhpScoper797695bcfb1f\Composer\Package\AliasPackage) {
     ...
     */
    private static function getVersions(\_PhpScoper797695bcfb1f\Composer\Package\Locker $locker, \_PhpScoper797695bcfb1f\Composer\Package\RootPackageInterface $rootPackage) : \Generator
    {
