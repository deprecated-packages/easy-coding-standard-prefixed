...
use _PhpScopera88a8b9f064a\Composer\Config;
...
use _PhpScopera88a8b9f064a\Composer\Package\Locker;
...
final class Installer implements \_PhpScopera88a8b9f064a\Composer\Plugin\PluginInterface, \_PhpScopera88a8b9f064a\Composer\EventDispatcher\EventSubscriberInterface
{
...
PHP;
    ...
    {
        return [\_PhpScopera88a8b9f064a\Composer\Script\ScriptEvents::POST_AUTOLOAD_DUMP => 'dumpVersionsClass'];
    }
    /**
     * @throws RuntimeException
     */
    public static function dumpVersionsClass(\_PhpScopera88a8b9f064a\Composer\Script\Event $composerEvent)
    {
     ...
     * @throws RuntimeException
     */
    private static function writeVersionClassToFile(string $versionClassSource, \_PhpScopera88a8b9f064a\Composer\Composer $composer, \_PhpScopera88a8b9f064a\Composer\IO\IOInterface $io)
    {
        ...
        if (\version_compare(\_PhpScopera88a8b9f064a\Composer\Plugin\PluginInterface::PLUGIN_API_VERSION, '2.0.0', '>=')) {
     ...
     * @throws RuntimeException
     */
    private static function locateRootPackageInstallPath(\_PhpScopera88a8b9f064a\Composer\Config $composerConfig, \_PhpScopera88a8b9f064a\Composer\Package\RootPackageInterface $rootPackage) : string
    {
    ...
    private static function getRootPackageAlias(\_PhpScopera88a8b9f064a\Composer\Package\RootPackageInterface $rootPackage) : \_PhpScopera88a8b9f064a\Composer\Package\PackageInterface
    {
        $package = $rootPackage;
        while ($package instanceof \_PhpScopera88a8b9f064a\Composer\Package\AliasPackage) {
     ...
     */
    private static function getVersions(\_PhpScopera88a8b9f064a\Composer\Package\Locker $locker, \_PhpScopera88a8b9f064a\Composer\Package\RootPackageInterface $rootPackage) : \Generator
    {
