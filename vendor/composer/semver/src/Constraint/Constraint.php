 ...
 */
class Constraint implements \_PhpScoper6a1dd9b8a650\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper6a1dd9b8a650\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
