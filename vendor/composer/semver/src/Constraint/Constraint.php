 ...
 */
class Constraint implements \_PhpScoper8e2d8a2760d1\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper8e2d8a2760d1\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
