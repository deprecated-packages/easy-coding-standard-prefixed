 ...
 */
class Constraint implements \_PhpScopera4be459e5e3d\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScopera4be459e5e3d\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
