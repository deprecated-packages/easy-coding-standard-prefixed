 ...
 */
class Constraint implements \_PhpScoper58a0a169dcfb\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper58a0a169dcfb\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
