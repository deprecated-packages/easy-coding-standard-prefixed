 ...
 */
class Constraint implements \_PhpScoperfd70a7e8e84f\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoperfd70a7e8e84f\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
