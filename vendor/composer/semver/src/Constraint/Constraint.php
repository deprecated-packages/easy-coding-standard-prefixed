 ...
 */
class Constraint implements \_PhpScoper6db4fde00cda\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper6db4fde00cda\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
