 ...
 */
class Constraint implements \_PhpScoper68a3a2539032\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper68a3a2539032\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
