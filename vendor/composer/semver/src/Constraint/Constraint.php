 ...
 */
class Constraint implements \_PhpScoper8a0112f19f39\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper8a0112f19f39\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
