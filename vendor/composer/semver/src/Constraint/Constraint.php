 ...
 */
class Constraint implements \_PhpScoper908feaf49cd8\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper908feaf49cd8\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
