 ...
 */
class Constraint implements \_PhpScoperbd5fb781fe24\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoperbd5fb781fe24\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
