 ...
 */
class Constraint implements \_PhpScoper6a0a7eb6e565\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper6a0a7eb6e565\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
