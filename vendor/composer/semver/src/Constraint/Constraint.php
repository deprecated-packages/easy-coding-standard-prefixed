 ...
 */
class Constraint implements \_PhpScoperb6d4bd368bd9\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoperb6d4bd368bd9\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
