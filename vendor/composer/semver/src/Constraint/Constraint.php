 ...
 */
class Constraint implements \_PhpScoperc64a4ac1af35\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoperc64a4ac1af35\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
