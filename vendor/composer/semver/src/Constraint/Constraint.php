 ...
 */
class Constraint implements \_PhpScoper8db4616aa69d\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper8db4616aa69d\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
