...
class Bound
{
     ...
     * @return bool
     */
    public function compareTo(\_PhpScopere24d949bf310\Composer\Semver\Constraint\Bound $other, $operator)
    {
    ...
    {
        return new \_PhpScopere24d949bf310\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \true);
    }
    /**
     * @return self
     */
    ...
    {
        return new \_PhpScopere24d949bf310\Composer\Semver\Constraint\Bound(\PHP_INT_MAX . '.0.0.0', \false);
    }
}
