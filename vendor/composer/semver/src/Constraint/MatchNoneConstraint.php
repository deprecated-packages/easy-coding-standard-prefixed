 ...
 */
class MatchNoneConstraint implements \_PhpScoper91fe47cd7f25\Composer\Semver\Constraint\ConstraintInterface
{
    /** @var string|null */
    ...
    {
        return new \_PhpScoper91fe47cd7f25\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \false);
    }
    /**
     * {@inheritDoc}
     */
