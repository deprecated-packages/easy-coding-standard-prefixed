 ...
 */
class MatchNoneConstraint implements \_PhpScoper9385100df341\Composer\Semver\Constraint\ConstraintInterface
{
    /** @var string|null */
    ...
    {
        return new \_PhpScoper9385100df341\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \false);
    }
    /**
     * {@inheritDoc}
     */
