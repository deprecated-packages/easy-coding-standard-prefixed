 ...
 */
final class ChunkTest extends \_PhpScoperbaf90856897c\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperbaf90856897c\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperbaf90856897c\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperbaf90856897c\SebastianBergmann\Diff\Line(\_PhpScoperbaf90856897c\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperbaf90856897c\SebastianBergmann\Diff\Line(\_PhpScoperbaf90856897c\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
