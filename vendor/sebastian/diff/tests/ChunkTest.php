 ...
 */
final class ChunkTest extends \_PhpScoper38a7d00685f8\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper38a7d00685f8\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper38a7d00685f8\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper38a7d00685f8\SebastianBergmann\Diff\Line(\_PhpScoper38a7d00685f8\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper38a7d00685f8\SebastianBergmann\Diff\Line(\_PhpScoper38a7d00685f8\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
