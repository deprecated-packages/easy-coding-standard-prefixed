 ...
 */
final class ChunkTest extends \_PhpScoper5a9febfbbe05\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper5a9febfbbe05\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper5a9febfbbe05\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper5a9febfbbe05\SebastianBergmann\Diff\Line(\_PhpScoper5a9febfbbe05\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper5a9febfbbe05\SebastianBergmann\Diff\Line(\_PhpScoper5a9febfbbe05\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
