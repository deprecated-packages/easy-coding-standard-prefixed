 ...
 */
final class ChunkTest extends \_PhpScoper61bdb485188f\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper61bdb485188f\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper61bdb485188f\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper61bdb485188f\SebastianBergmann\Diff\Line(\_PhpScoper61bdb485188f\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper61bdb485188f\SebastianBergmann\Diff\Line(\_PhpScoper61bdb485188f\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
