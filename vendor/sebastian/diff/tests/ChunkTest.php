 ...
 */
final class ChunkTest extends \_PhpScopera749ac204cd2\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera749ac204cd2\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera749ac204cd2\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera749ac204cd2\SebastianBergmann\Diff\Line(\_PhpScopera749ac204cd2\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera749ac204cd2\SebastianBergmann\Diff\Line(\_PhpScopera749ac204cd2\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
