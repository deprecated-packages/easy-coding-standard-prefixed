 ...
 */
final class ChunkTest extends \_PhpScoperad4b7e2c09d8\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperad4b7e2c09d8\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperad4b7e2c09d8\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperad4b7e2c09d8\SebastianBergmann\Diff\Line(\_PhpScoperad4b7e2c09d8\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperad4b7e2c09d8\SebastianBergmann\Diff\Line(\_PhpScoperad4b7e2c09d8\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
