 ...
 */
final class ChunkTest extends \_PhpScoper133be48300f9\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper133be48300f9\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper133be48300f9\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper133be48300f9\SebastianBergmann\Diff\Line(\_PhpScoper133be48300f9\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper133be48300f9\SebastianBergmann\Diff\Line(\_PhpScoper133be48300f9\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
