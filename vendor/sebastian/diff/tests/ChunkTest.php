 ...
 */
final class ChunkTest extends \_PhpScoper0d0ee1ba46d4\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper0d0ee1ba46d4\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper0d0ee1ba46d4\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper0d0ee1ba46d4\SebastianBergmann\Diff\Line(\_PhpScoper0d0ee1ba46d4\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper0d0ee1ba46d4\SebastianBergmann\Diff\Line(\_PhpScoper0d0ee1ba46d4\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
