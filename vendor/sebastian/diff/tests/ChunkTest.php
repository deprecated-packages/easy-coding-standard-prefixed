 ...
 */
final class ChunkTest extends \_PhpScopera04bf8e97c06\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera04bf8e97c06\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera04bf8e97c06\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera04bf8e97c06\SebastianBergmann\Diff\Line(\_PhpScopera04bf8e97c06\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera04bf8e97c06\SebastianBergmann\Diff\Line(\_PhpScopera04bf8e97c06\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
