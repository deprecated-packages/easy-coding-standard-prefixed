 ...
 */
final class ChunkTest extends \_PhpScoper4a718ec9156e\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper4a718ec9156e\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper4a718ec9156e\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper4a718ec9156e\SebastianBergmann\Diff\Line(\_PhpScoper4a718ec9156e\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper4a718ec9156e\SebastianBergmann\Diff\Line(\_PhpScoper4a718ec9156e\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
