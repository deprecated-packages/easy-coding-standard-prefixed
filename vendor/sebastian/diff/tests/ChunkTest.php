 ...
 */
final class ChunkTest extends \_PhpScoperddde3ba4aebc\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperddde3ba4aebc\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperddde3ba4aebc\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperddde3ba4aebc\SebastianBergmann\Diff\Line(\_PhpScoperddde3ba4aebc\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperddde3ba4aebc\SebastianBergmann\Diff\Line(\_PhpScoperddde3ba4aebc\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
