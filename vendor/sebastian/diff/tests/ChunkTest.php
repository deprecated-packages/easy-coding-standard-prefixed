 ...
 */
final class ChunkTest extends \_PhpScoper4848279dba07\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper4848279dba07\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper4848279dba07\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper4848279dba07\SebastianBergmann\Diff\Line(\_PhpScoper4848279dba07\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper4848279dba07\SebastianBergmann\Diff\Line(\_PhpScoper4848279dba07\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
