 ...
 */
final class ChunkTest extends \_PhpScoperdc8fbcd7c69d\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperdc8fbcd7c69d\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperdc8fbcd7c69d\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperdc8fbcd7c69d\SebastianBergmann\Diff\Line(\_PhpScoperdc8fbcd7c69d\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperdc8fbcd7c69d\SebastianBergmann\Diff\Line(\_PhpScoperdc8fbcd7c69d\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
