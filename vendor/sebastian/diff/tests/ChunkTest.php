 ...
 */
final class ChunkTest extends \_PhpScopera4be459e5e3d\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera4be459e5e3d\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera4be459e5e3d\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera4be459e5e3d\SebastianBergmann\Diff\Line(\_PhpScopera4be459e5e3d\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera4be459e5e3d\SebastianBergmann\Diff\Line(\_PhpScopera4be459e5e3d\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
