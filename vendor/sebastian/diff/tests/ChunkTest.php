 ...
 */
final class ChunkTest extends \_PhpScoperfd70a7e8e84f\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperfd70a7e8e84f\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperfd70a7e8e84f\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperfd70a7e8e84f\SebastianBergmann\Diff\Line(\_PhpScoperfd70a7e8e84f\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperfd70a7e8e84f\SebastianBergmann\Diff\Line(\_PhpScoperfd70a7e8e84f\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
