 ...
 */
final class ChunkTest extends \_PhpScoperb6d4bd368bd9\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperb6d4bd368bd9\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperb6d4bd368bd9\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperb6d4bd368bd9\SebastianBergmann\Diff\Line(\_PhpScoperb6d4bd368bd9\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperb6d4bd368bd9\SebastianBergmann\Diff\Line(\_PhpScoperb6d4bd368bd9\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
