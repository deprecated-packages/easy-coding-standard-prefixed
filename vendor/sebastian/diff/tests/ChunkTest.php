 ...
 */
final class ChunkTest extends \_PhpScoper7cef7256eba6\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper7cef7256eba6\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper7cef7256eba6\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper7cef7256eba6\SebastianBergmann\Diff\Line(\_PhpScoper7cef7256eba6\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper7cef7256eba6\SebastianBergmann\Diff\Line(\_PhpScoper7cef7256eba6\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
