 ...
 */
final class ChunkTest extends \_PhpScopera1a51450b61d\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera1a51450b61d\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera1a51450b61d\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera1a51450b61d\SebastianBergmann\Diff\Line(\_PhpScopera1a51450b61d\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera1a51450b61d\SebastianBergmann\Diff\Line(\_PhpScopera1a51450b61d\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
