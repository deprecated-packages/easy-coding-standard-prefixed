 ...
 */
final class ChunkTest extends \_PhpScoper1103e00fb46b\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper1103e00fb46b\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper1103e00fb46b\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper1103e00fb46b\SebastianBergmann\Diff\Line(\_PhpScoper1103e00fb46b\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper1103e00fb46b\SebastianBergmann\Diff\Line(\_PhpScoper1103e00fb46b\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
