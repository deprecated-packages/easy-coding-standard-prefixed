 ...
 */
final class ChunkTest extends \_PhpScoperb458b528613f\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperb458b528613f\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperb458b528613f\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperb458b528613f\SebastianBergmann\Diff\Line(\_PhpScoperb458b528613f\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperb458b528613f\SebastianBergmann\Diff\Line(\_PhpScoperb458b528613f\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
