 ...
 */
final class ChunkTest extends \_PhpScoper246d7c16d32f\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper246d7c16d32f\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper246d7c16d32f\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper246d7c16d32f\SebastianBergmann\Diff\Line(\_PhpScoper246d7c16d32f\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper246d7c16d32f\SebastianBergmann\Diff\Line(\_PhpScoper246d7c16d32f\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
