 ...
 */
final class ChunkTest extends \_PhpScoper8e2d8a2760d1\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper8e2d8a2760d1\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper8e2d8a2760d1\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper8e2d8a2760d1\SebastianBergmann\Diff\Line(\_PhpScoper8e2d8a2760d1\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper8e2d8a2760d1\SebastianBergmann\Diff\Line(\_PhpScoper8e2d8a2760d1\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
