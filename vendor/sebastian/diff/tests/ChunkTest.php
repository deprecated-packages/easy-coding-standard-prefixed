 ...
 */
final class ChunkTest extends \_PhpScoperb6ccec8ab642\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperb6ccec8ab642\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperb6ccec8ab642\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperb6ccec8ab642\SebastianBergmann\Diff\Line(\_PhpScoperb6ccec8ab642\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperb6ccec8ab642\SebastianBergmann\Diff\Line(\_PhpScoperb6ccec8ab642\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
