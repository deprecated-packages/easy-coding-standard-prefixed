 ...
 */
final class ChunkTest extends \_PhpScoper167729fa1dde\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper167729fa1dde\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper167729fa1dde\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper167729fa1dde\SebastianBergmann\Diff\Line(\_PhpScoper167729fa1dde\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper167729fa1dde\SebastianBergmann\Diff\Line(\_PhpScoper167729fa1dde\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
