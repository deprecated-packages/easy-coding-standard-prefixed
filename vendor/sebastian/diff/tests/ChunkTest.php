 ...
 */
final class ChunkTest extends \_PhpScopera09818bc50da\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera09818bc50da\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera09818bc50da\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera09818bc50da\SebastianBergmann\Diff\Line(\_PhpScopera09818bc50da\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera09818bc50da\SebastianBergmann\Diff\Line(\_PhpScopera09818bc50da\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
