 ...
 */
final class ChunkTest extends \_PhpScoperac4e86be08e5\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperac4e86be08e5\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperac4e86be08e5\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperac4e86be08e5\SebastianBergmann\Diff\Line(\_PhpScoperac4e86be08e5\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperac4e86be08e5\SebastianBergmann\Diff\Line(\_PhpScoperac4e86be08e5\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
