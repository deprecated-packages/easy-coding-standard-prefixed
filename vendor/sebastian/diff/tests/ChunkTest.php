 ...
 */
final class ChunkTest extends \_PhpScopera238de2e9b5a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera238de2e9b5a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera238de2e9b5a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera238de2e9b5a\SebastianBergmann\Diff\Line(\_PhpScopera238de2e9b5a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera238de2e9b5a\SebastianBergmann\Diff\Line(\_PhpScopera238de2e9b5a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
