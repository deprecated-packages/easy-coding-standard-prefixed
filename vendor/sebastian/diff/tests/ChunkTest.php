 ...
 */
final class ChunkTest extends \_PhpScoperdf6a0b341030\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperdf6a0b341030\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperdf6a0b341030\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperdf6a0b341030\SebastianBergmann\Diff\Line(\_PhpScoperdf6a0b341030\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperdf6a0b341030\SebastianBergmann\Diff\Line(\_PhpScoperdf6a0b341030\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
