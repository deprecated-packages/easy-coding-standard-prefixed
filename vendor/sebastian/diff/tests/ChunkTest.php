 ...
 */
final class ChunkTest extends \_PhpScoper02b5d1bf8fec\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper02b5d1bf8fec\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper02b5d1bf8fec\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper02b5d1bf8fec\SebastianBergmann\Diff\Line(\_PhpScoper02b5d1bf8fec\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper02b5d1bf8fec\SebastianBergmann\Diff\Line(\_PhpScoper02b5d1bf8fec\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
