 ...
 */
final class ChunkTest extends \_PhpScoperf3f1be0d8a30\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperf3f1be0d8a30\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperf3f1be0d8a30\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperf3f1be0d8a30\SebastianBergmann\Diff\Line(\_PhpScoperf3f1be0d8a30\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperf3f1be0d8a30\SebastianBergmann\Diff\Line(\_PhpScoperf3f1be0d8a30\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
