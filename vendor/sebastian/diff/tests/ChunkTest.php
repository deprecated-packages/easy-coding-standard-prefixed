 ...
 */
final class ChunkTest extends \_PhpScoperaa402dd1b1f1\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperaa402dd1b1f1\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperaa402dd1b1f1\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperaa402dd1b1f1\SebastianBergmann\Diff\Line(\_PhpScoperaa402dd1b1f1\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperaa402dd1b1f1\SebastianBergmann\Diff\Line(\_PhpScoperaa402dd1b1f1\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
