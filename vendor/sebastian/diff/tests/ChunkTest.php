 ...
 */
final class ChunkTest extends \_PhpScoperc4b135661b3a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperc4b135661b3a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperc4b135661b3a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperc4b135661b3a\SebastianBergmann\Diff\Line(\_PhpScoperc4b135661b3a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperc4b135661b3a\SebastianBergmann\Diff\Line(\_PhpScoperc4b135661b3a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
