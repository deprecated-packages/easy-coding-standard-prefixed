 ...
 */
final class ChunkTest extends \_PhpScoper2fe14d6302bc\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Line(\_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Line(\_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
