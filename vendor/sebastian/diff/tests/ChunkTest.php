 ...
 */
final class ChunkTest extends \_PhpScoper06c66bea2cf6\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper06c66bea2cf6\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper06c66bea2cf6\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper06c66bea2cf6\SebastianBergmann\Diff\Line(\_PhpScoper06c66bea2cf6\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper06c66bea2cf6\SebastianBergmann\Diff\Line(\_PhpScoper06c66bea2cf6\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
