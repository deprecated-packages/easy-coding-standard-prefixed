 ...
 */
final class ChunkTest extends \_PhpScoperca8ca183ac38\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperca8ca183ac38\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperca8ca183ac38\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperca8ca183ac38\SebastianBergmann\Diff\Line(\_PhpScoperca8ca183ac38\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperca8ca183ac38\SebastianBergmann\Diff\Line(\_PhpScoperca8ca183ac38\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
