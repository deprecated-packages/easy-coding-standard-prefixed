 ...
 */
final class ChunkTest extends \_PhpScoper836bc32aecc2\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper836bc32aecc2\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper836bc32aecc2\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper836bc32aecc2\SebastianBergmann\Diff\Line(\_PhpScoper836bc32aecc2\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper836bc32aecc2\SebastianBergmann\Diff\Line(\_PhpScoper836bc32aecc2\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
