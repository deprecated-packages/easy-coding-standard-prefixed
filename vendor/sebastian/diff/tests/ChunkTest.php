 ...
 */
final class ChunkTest extends \_PhpScoper6db4fde00cda\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper6db4fde00cda\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper6db4fde00cda\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper6db4fde00cda\SebastianBergmann\Diff\Line(\_PhpScoper6db4fde00cda\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper6db4fde00cda\SebastianBergmann\Diff\Line(\_PhpScoper6db4fde00cda\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
