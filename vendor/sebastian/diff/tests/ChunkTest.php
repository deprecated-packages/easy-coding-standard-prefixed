 ...
 */
final class ChunkTest extends \_PhpScoper6dbb854503f8\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper6dbb854503f8\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper6dbb854503f8\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper6dbb854503f8\SebastianBergmann\Diff\Line(\_PhpScoper6dbb854503f8\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper6dbb854503f8\SebastianBergmann\Diff\Line(\_PhpScoper6dbb854503f8\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
