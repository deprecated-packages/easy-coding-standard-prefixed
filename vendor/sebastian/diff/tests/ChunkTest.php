 ...
 */
final class ChunkTest extends \_PhpScoperb09c3ec8e01a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperb09c3ec8e01a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperb09c3ec8e01a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperb09c3ec8e01a\SebastianBergmann\Diff\Line(\_PhpScoperb09c3ec8e01a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperb09c3ec8e01a\SebastianBergmann\Diff\Line(\_PhpScoperb09c3ec8e01a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
