 ...
 */
final class ChunkTest extends \_PhpScoper2a8ad010dfbd\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Line(\_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Line(\_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
