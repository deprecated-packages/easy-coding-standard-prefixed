 ...
 */
final class ChunkTest extends \_PhpScoper470d6df94ac0\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper470d6df94ac0\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper470d6df94ac0\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper470d6df94ac0\SebastianBergmann\Diff\Line(\_PhpScoper470d6df94ac0\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper470d6df94ac0\SebastianBergmann\Diff\Line(\_PhpScoper470d6df94ac0\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
