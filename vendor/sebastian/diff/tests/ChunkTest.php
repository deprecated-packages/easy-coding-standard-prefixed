 ...
 */
final class ChunkTest extends \_PhpScoperfabf55fef6b7\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperfabf55fef6b7\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperfabf55fef6b7\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperfabf55fef6b7\SebastianBergmann\Diff\Line(\_PhpScoperfabf55fef6b7\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperfabf55fef6b7\SebastianBergmann\Diff\Line(\_PhpScoperfabf55fef6b7\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
