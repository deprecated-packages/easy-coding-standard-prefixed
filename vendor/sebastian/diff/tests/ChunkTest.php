 ...
 */
final class ChunkTest extends \_PhpScoper3e1e0e5bb8ef\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper3e1e0e5bb8ef\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper3e1e0e5bb8ef\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper3e1e0e5bb8ef\SebastianBergmann\Diff\Line(\_PhpScoper3e1e0e5bb8ef\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper3e1e0e5bb8ef\SebastianBergmann\Diff\Line(\_PhpScoper3e1e0e5bb8ef\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
