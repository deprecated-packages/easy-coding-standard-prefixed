 ...
 */
final class ChunkTest extends \_PhpScoperbd5fb781fe24\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperbd5fb781fe24\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperbd5fb781fe24\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperbd5fb781fe24\SebastianBergmann\Diff\Line(\_PhpScoperbd5fb781fe24\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperbd5fb781fe24\SebastianBergmann\Diff\Line(\_PhpScoperbd5fb781fe24\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
