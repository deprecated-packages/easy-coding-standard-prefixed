 ...
 */
final class ChunkTest extends \_PhpScoper21fff473f90a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper21fff473f90a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper21fff473f90a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper21fff473f90a\SebastianBergmann\Diff\Line(\_PhpScoper21fff473f90a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper21fff473f90a\SebastianBergmann\Diff\Line(\_PhpScoper21fff473f90a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
