 ...
 */
final class ChunkTest extends \_PhpScoper21c6ce8bfe5d\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Line(\_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Line(\_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
