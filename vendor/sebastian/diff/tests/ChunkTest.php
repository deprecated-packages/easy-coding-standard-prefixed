 ...
 */
final class ChunkTest extends \_PhpScoper776637f3d3c3\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Line(\_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Line(\_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
