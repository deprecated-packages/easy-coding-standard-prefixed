 ...
 */
final class ChunkTest extends \_PhpScoper92feab6bddf8\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper92feab6bddf8\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper92feab6bddf8\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper92feab6bddf8\SebastianBergmann\Diff\Line(\_PhpScoper92feab6bddf8\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper92feab6bddf8\SebastianBergmann\Diff\Line(\_PhpScoper92feab6bddf8\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
