 ...
 */
final class ChunkTest extends \_PhpScoperaba240c3d5f1\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperaba240c3d5f1\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperaba240c3d5f1\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperaba240c3d5f1\SebastianBergmann\Diff\Line(\_PhpScoperaba240c3d5f1\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperaba240c3d5f1\SebastianBergmann\Diff\Line(\_PhpScoperaba240c3d5f1\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
