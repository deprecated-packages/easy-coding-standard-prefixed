 ...
 */
final class ChunkTest extends \_PhpScopere5e7dca8c031\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Line(\_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Line(\_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
