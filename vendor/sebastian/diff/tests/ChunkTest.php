 ...
 */
final class ChunkTest extends \_PhpScoper2d2a405cc0f8\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper2d2a405cc0f8\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper2d2a405cc0f8\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper2d2a405cc0f8\SebastianBergmann\Diff\Line(\_PhpScoper2d2a405cc0f8\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper2d2a405cc0f8\SebastianBergmann\Diff\Line(\_PhpScoper2d2a405cc0f8\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
