 ...
 */
final class ChunkTest extends \_PhpScoper3a22e8e0bd94\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper3a22e8e0bd94\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper3a22e8e0bd94\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper3a22e8e0bd94\SebastianBergmann\Diff\Line(\_PhpScoper3a22e8e0bd94\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper3a22e8e0bd94\SebastianBergmann\Diff\Line(\_PhpScoper3a22e8e0bd94\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
