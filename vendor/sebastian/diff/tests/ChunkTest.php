 ...
 */
final class ChunkTest extends \_PhpScoper528afa732cbd\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper528afa732cbd\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper528afa732cbd\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper528afa732cbd\SebastianBergmann\Diff\Line(\_PhpScoper528afa732cbd\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper528afa732cbd\SebastianBergmann\Diff\Line(\_PhpScoper528afa732cbd\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
