 ...
 */
final class ChunkTest extends \_PhpScoper4972b76c81a2\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper4972b76c81a2\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper4972b76c81a2\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper4972b76c81a2\SebastianBergmann\Diff\Line(\_PhpScoper4972b76c81a2\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper4972b76c81a2\SebastianBergmann\Diff\Line(\_PhpScoper4972b76c81a2\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
