 ...
 */
final class ChunkTest extends \_PhpScoperedc2e0c967db\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperedc2e0c967db\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperedc2e0c967db\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperedc2e0c967db\SebastianBergmann\Diff\Line(\_PhpScoperedc2e0c967db\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperedc2e0c967db\SebastianBergmann\Diff\Line(\_PhpScoperedc2e0c967db\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
