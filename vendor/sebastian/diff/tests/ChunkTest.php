 ...
 */
final class ChunkTest extends \_PhpScoperb36402634947\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperb36402634947\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperb36402634947\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperb36402634947\SebastianBergmann\Diff\Line(\_PhpScoperb36402634947\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperb36402634947\SebastianBergmann\Diff\Line(\_PhpScoperb36402634947\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
