 ...
 */
final class ChunkTest extends \_PhpScoper4cd05b62e9f1\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper4cd05b62e9f1\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper4cd05b62e9f1\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper4cd05b62e9f1\SebastianBergmann\Diff\Line(\_PhpScoper4cd05b62e9f1\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper4cd05b62e9f1\SebastianBergmann\Diff\Line(\_PhpScoper4cd05b62e9f1\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
