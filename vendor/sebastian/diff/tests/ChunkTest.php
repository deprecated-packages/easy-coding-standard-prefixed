 ...
 */
final class ChunkTest extends \_PhpScoperf65af7a6d9a0\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperf65af7a6d9a0\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperf65af7a6d9a0\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperf65af7a6d9a0\SebastianBergmann\Diff\Line(\_PhpScoperf65af7a6d9a0\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperf65af7a6d9a0\SebastianBergmann\Diff\Line(\_PhpScoperf65af7a6d9a0\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
