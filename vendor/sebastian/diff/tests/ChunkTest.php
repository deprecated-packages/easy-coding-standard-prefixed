 ...
 */
final class ChunkTest extends \_PhpScoperc83f84c90b60\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Line(\_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Line(\_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
