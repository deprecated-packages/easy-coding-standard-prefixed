 ...
 */
final class ChunkTest extends \_PhpScoper08748c77fa1c\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper08748c77fa1c\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper08748c77fa1c\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper08748c77fa1c\SebastianBergmann\Diff\Line(\_PhpScoper08748c77fa1c\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper08748c77fa1c\SebastianBergmann\Diff\Line(\_PhpScoper08748c77fa1c\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
