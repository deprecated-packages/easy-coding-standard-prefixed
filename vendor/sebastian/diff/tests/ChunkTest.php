 ...
 */
final class ChunkTest extends \_PhpScoperc95ae4bf942a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperc95ae4bf942a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperc95ae4bf942a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperc95ae4bf942a\SebastianBergmann\Diff\Line(\_PhpScoperc95ae4bf942a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperc95ae4bf942a\SebastianBergmann\Diff\Line(\_PhpScoperc95ae4bf942a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
