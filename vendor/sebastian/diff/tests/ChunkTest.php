 ...
 */
final class ChunkTest extends \_PhpScoper967c4b7e296e\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper967c4b7e296e\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper967c4b7e296e\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper967c4b7e296e\SebastianBergmann\Diff\Line(\_PhpScoper967c4b7e296e\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper967c4b7e296e\SebastianBergmann\Diff\Line(\_PhpScoper967c4b7e296e\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
