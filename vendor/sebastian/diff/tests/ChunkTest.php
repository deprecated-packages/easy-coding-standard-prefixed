 ...
 */
final class ChunkTest extends \_PhpScoperd675aaf00c76\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperd675aaf00c76\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperd675aaf00c76\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperd675aaf00c76\SebastianBergmann\Diff\Line(\_PhpScoperd675aaf00c76\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperd675aaf00c76\SebastianBergmann\Diff\Line(\_PhpScoperd675aaf00c76\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
