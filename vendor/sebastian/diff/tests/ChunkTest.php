 ...
 */
final class ChunkTest extends \_PhpScoper8de082cbb8c7\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Line(\_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Line(\_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
