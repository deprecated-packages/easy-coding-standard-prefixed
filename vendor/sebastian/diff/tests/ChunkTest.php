 ...
 */
final class ChunkTest extends \_PhpScoperbcc0395698f8\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperbcc0395698f8\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperbcc0395698f8\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperbcc0395698f8\SebastianBergmann\Diff\Line(\_PhpScoperbcc0395698f8\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperbcc0395698f8\SebastianBergmann\Diff\Line(\_PhpScoperbcc0395698f8\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
