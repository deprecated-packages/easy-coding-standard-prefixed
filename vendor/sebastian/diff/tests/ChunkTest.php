 ...
 */
final class ChunkTest extends \_PhpScoper908feaf49cd8\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper908feaf49cd8\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper908feaf49cd8\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper908feaf49cd8\SebastianBergmann\Diff\Line(\_PhpScoper908feaf49cd8\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper908feaf49cd8\SebastianBergmann\Diff\Line(\_PhpScoper908feaf49cd8\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
