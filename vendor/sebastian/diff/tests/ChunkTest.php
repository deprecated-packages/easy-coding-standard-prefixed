 ...
 */
final class ChunkTest extends \_PhpScoperc753ccca5a0c\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperc753ccca5a0c\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperc753ccca5a0c\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperc753ccca5a0c\SebastianBergmann\Diff\Line(\_PhpScoperc753ccca5a0c\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperc753ccca5a0c\SebastianBergmann\Diff\Line(\_PhpScoperc753ccca5a0c\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
