 ...
 */
final class ChunkTest extends \_PhpScoperc8b83ee8976a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperc8b83ee8976a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperc8b83ee8976a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperc8b83ee8976a\SebastianBergmann\Diff\Line(\_PhpScoperc8b83ee8976a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperc8b83ee8976a\SebastianBergmann\Diff\Line(\_PhpScoperc8b83ee8976a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
