 ...
 */
final class ChunkTest extends \_PhpScoper0f5cd390c37a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper0f5cd390c37a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper0f5cd390c37a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper0f5cd390c37a\SebastianBergmann\Diff\Line(\_PhpScoper0f5cd390c37a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper0f5cd390c37a\SebastianBergmann\Diff\Line(\_PhpScoper0f5cd390c37a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
