 ...
 */
final class ChunkTest extends \_PhpScopercae980ebf12d\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopercae980ebf12d\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopercae980ebf12d\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopercae980ebf12d\SebastianBergmann\Diff\Line(\_PhpScopercae980ebf12d\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopercae980ebf12d\SebastianBergmann\Diff\Line(\_PhpScopercae980ebf12d\SebastianBergmann\Diff\Line::REMOVED, 'removed')];
