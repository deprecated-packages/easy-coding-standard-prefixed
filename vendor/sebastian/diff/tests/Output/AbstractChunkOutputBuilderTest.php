 ...
 */
final class AbstractChunkOutputBuilderTest extends \_PhpScoper48800f361566\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $output = new class extends \_PhpScoper48800f361566\SebastianBergmann\Diff\Output\AbstractChunkOutputBuilder
        {
        ...
        $this->assertSame($expected, $output->getChunks((new \_PhpScoper48800f361566\SebastianBergmann\Diff\Differ())->diffToArray($from, $to), $lineThreshold));
    }
