 ...
 */
final class AbstractChunkOutputBuilderTest extends \_PhpScoper58a0a169dcfb\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $output = new class extends \_PhpScoper58a0a169dcfb\SebastianBergmann\Diff\Output\AbstractChunkOutputBuilder
        {
        ...
        $this->assertSame($expected, $output->getChunks((new \_PhpScoper58a0a169dcfb\SebastianBergmann\Diff\Differ())->diffToArray($from, $to), $lineThreshold));
    }
