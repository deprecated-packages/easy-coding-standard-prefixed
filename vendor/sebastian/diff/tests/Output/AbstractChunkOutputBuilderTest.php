 ...
 */
final class AbstractChunkOutputBuilderTest extends \_PhpScoper224ae0b86670\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $output = new class extends \_PhpScoper224ae0b86670\SebastianBergmann\Diff\Output\AbstractChunkOutputBuilder
        {
        ...
        $this->assertSame($expected, $output->getChunks((new \_PhpScoper224ae0b86670\SebastianBergmann\Diff\Differ())->diffToArray($from, $to), $lineThreshold));
    }
