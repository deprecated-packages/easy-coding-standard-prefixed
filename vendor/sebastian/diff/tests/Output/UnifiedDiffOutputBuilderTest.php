 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoper21c6ce8bfe5d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Differ(new \_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Differ(new \_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoper21c6ce8bfe5d\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}
