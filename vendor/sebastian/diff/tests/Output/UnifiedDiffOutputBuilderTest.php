 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoper6a0a7eb6e565\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper6a0a7eb6e565\SebastianBergmann\Diff\Differ(new \_PhpScoper6a0a7eb6e565\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoper6a0a7eb6e565\SebastianBergmann\Diff\Differ(new \_PhpScoper6a0a7eb6e565\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoper6a0a7eb6e565\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}
