 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScopera23ebff5477f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScopera23ebff5477f\SebastianBergmann\Diff\Differ(new \_PhpScopera23ebff5477f\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScopera23ebff5477f\SebastianBergmann\Diff\Differ(new \_PhpScopera23ebff5477f\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScopera23ebff5477f\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}
