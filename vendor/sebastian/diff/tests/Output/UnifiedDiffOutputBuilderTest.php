 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoper776637f3d3c3\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Differ(new \_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Differ(new \_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoper776637f3d3c3\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}
