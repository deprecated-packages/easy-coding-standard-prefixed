 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoperfaaf57618f34\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoperfaaf57618f34\SebastianBergmann\Diff\Differ(new \_PhpScoperfaaf57618f34\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoperfaaf57618f34\SebastianBergmann\Diff\Differ(new \_PhpScoperfaaf57618f34\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoperfaaf57618f34\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}
