 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoperc83f84c90b60\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Differ(new \_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Differ(new \_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoperc83f84c90b60\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}
