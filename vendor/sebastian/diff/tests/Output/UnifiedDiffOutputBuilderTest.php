 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoper8de082cbb8c7\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Differ(new \_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Differ(new \_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoper8de082cbb8c7\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}
