 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScopere5e7dca8c031\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Differ(new \_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Differ(new \_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScopere5e7dca8c031\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}
