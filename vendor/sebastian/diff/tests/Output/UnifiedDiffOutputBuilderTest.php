 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoper2fe14d6302bc\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Differ(new \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Differ(new \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}
