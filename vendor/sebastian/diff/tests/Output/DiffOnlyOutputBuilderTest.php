 ...
 */
final class DiffOnlyOutputBuilderTest extends \_PhpScoperf3f1be0d8a30\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoperf3f1be0d8a30\SebastianBergmann\Diff\Differ(new \_PhpScoperf3f1be0d8a30\SebastianBergmann\Diff\Output\DiffOnlyOutputBuilder($header));
