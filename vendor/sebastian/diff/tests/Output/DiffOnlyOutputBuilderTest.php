 ...
 */
final class DiffOnlyOutputBuilderTest extends \_PhpScopera238de2e9b5a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScopera238de2e9b5a\SebastianBergmann\Diff\Differ(new \_PhpScopera238de2e9b5a\SebastianBergmann\Diff\Output\DiffOnlyOutputBuilder($header));
