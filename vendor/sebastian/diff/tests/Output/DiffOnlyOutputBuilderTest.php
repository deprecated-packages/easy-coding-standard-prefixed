 ...
 */
final class DiffOnlyOutputBuilderTest extends \_PhpScoper2fe14d6302bc\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Differ(new \_PhpScoper2fe14d6302bc\SebastianBergmann\Diff\Output\DiffOnlyOutputBuilder($header));
