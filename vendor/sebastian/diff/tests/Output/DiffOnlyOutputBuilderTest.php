 ...
 */
final class DiffOnlyOutputBuilderTest extends \_PhpScopera4be459e5e3d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScopera4be459e5e3d\SebastianBergmann\Diff\Differ(new \_PhpScopera4be459e5e3d\SebastianBergmann\Diff\Output\DiffOnlyOutputBuilder($header));
