 ...
 */
final class DiffOnlyOutputBuilderTest extends \_PhpScoper58a0a169dcfb\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper58a0a169dcfb\SebastianBergmann\Diff\Differ(new \_PhpScoper58a0a169dcfb\SebastianBergmann\Diff\Output\DiffOnlyOutputBuilder($header));
