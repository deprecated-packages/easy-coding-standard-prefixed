 ...
 */
final class DiffOnlyOutputBuilderTest extends \_PhpScoperf65af7a6d9a0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoperf65af7a6d9a0\SebastianBergmann\Diff\Differ(new \_PhpScoperf65af7a6d9a0\SebastianBergmann\Diff\Output\DiffOnlyOutputBuilder($header));
