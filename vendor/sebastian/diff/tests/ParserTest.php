 ...
 */
final class ParserTest extends \_PhpScoper2a8ad010dfbd\PHPUnit\Framework\TestCase
{
    /**
     * @var Parser
     */
    ...
    {
        $this->parser = new \_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Parser();
    }
    public function testParse() : void
    {
        $content = \_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Utils\FileUtils::getFileContent(__DIR__ . '/fixtures/patch.txt');
        $diffs = $this->parser->parse($content);
        $this->assertContainsOnlyInstancesOf(\_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Diff::class, $diffs);
        $this->assertCount(1, $diffs);
        $chunks = $diffs[0]->getChunks();
        $this->assertContainsOnlyInstancesOf(\_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Chunk::class, $chunks);
    ...
    {
        $content = \_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Utils\FileUtils::getFileContent(__DIR__ . '/fixtures/patch2.txt');
        $diffs = $this->parser->parse($content);
        $this->assertCount(1, $diffs);
        $chunks = $diffs[0]->getChunks();
...
END;
        ...
        $this->assertContainsOnlyInstancesOf(\_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Line::class, $lines);
        $this->assertCount(2, $lines);
        /** @var Line $line */
        $line = $lines[0];
        $this->assertSame('A', $line->getContent());
        $this->assertSame(\_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Line::UNCHANGED, $line->getType());
        $line = $lines[1];
        $this->assertSame('B', $line->getContent());
        $this->assertSame(\_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Line::REMOVED, $line->getType());
    }
...
END;
    ...
    {
        return [["--- old.txt\t2014-11-04 08:51:02.661868729 +0300\n+++ new.txt\t2014-11-04 08:51:02.665868730 +0300\n@@ -1,3 +1,4 @@\n+2222111\n 1111111\n 1111111\n 1111111\n@@ -5,10 +6,8 @@\n 1111111\n 1111111\n 1111111\n +1121211\n 1111111\n -1111111\n -1111111\n -2222222\n 2222222\n 2222222\n 2222222\n@@ -17,5 +16,6 @@\n 2222222\n 2222222\n 2222222\n +2122212\n 2222222\n 2222222\n", \unserialize(\_PhpScoper2a8ad010dfbd\SebastianBergmann\Diff\Utils\FileUtils::getFileContent(__DIR__ . '/fixtures/serialized_diff.bin'))]];
    }
}
