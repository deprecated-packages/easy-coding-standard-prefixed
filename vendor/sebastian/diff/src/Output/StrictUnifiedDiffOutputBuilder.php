 ...
 */
namespace _PhpScopercae9e6ab5cea\SebastianBergmann\Diff\Output;
...
use function substr;
use _PhpScopercae9e6ab5cea\SebastianBergmann\Diff\ConfigurationException;
use _PhpScopercae9e6ab5cea\SebastianBergmann\Diff\Differ;
/**
 * Strict Unified diff output builder.
 *
 * Generates (strict) Unified diff's (unidiffs) with hunks.
 */
final class StrictUnifiedDiffOutputBuilder implements \_PhpScopercae9e6ab5cea\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface
{
