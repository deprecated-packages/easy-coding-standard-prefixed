 ...
 */
namespace _PhpScoper32abeec2fe5a\SebastianBergmann\Diff\Output;
...
use function substr;
use _PhpScoper32abeec2fe5a\SebastianBergmann\Diff\ConfigurationException;
use _PhpScoper32abeec2fe5a\SebastianBergmann\Diff\Differ;
/**
 * Strict Unified diff output builder.
 *
 * Generates (strict) Unified diff's (unidiffs) with hunks.
 */
final class StrictUnifiedDiffOutputBuilder implements \_PhpScoper32abeec2fe5a\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface
{
