 ...
 */
namespace _PhpScoper6ffa0951a2e9\SebastianBergmann\Diff\Output;
...
use function substr;
use _PhpScoper6ffa0951a2e9\SebastianBergmann\Diff\ConfigurationException;
use _PhpScoper6ffa0951a2e9\SebastianBergmann\Diff\Differ;
/**
 * Strict Unified diff output builder.
 *
 * Generates (strict) Unified diff's (unidiffs) with hunks.
 */
final class StrictUnifiedDiffOutputBuilder implements \_PhpScoper6ffa0951a2e9\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface
{
