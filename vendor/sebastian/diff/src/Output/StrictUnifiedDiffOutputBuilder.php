 ...
 */
namespace _PhpScoperd2a667bd5a98\SebastianBergmann\Diff\Output;
...
use function substr;
use _PhpScoperd2a667bd5a98\SebastianBergmann\Diff\ConfigurationException;
use _PhpScoperd2a667bd5a98\SebastianBergmann\Diff\Differ;
/**
 * Strict Unified diff output builder.
 *
 * Generates (strict) Unified diff's (unidiffs) with hunks.
 */
final class StrictUnifiedDiffOutputBuilder implements \_PhpScoperd2a667bd5a98\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface
{
