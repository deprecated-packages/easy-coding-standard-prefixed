...
use function max;
final class MemoryEfficientLongestCommonSubsequenceCalculator implements \_PhpScoper7b319b4d8e1c\SebastianBergmann\Diff\LongestCommonSubsequenceCalculator
{
    /**
     * {@inheritdoc}
     */
