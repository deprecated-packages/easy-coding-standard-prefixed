...
use function max;
final class MemoryEfficientLongestCommonSubsequenceCalculator implements \_PhpScoper5e5ebcdbebdf\SebastianBergmann\Diff\LongestCommonSubsequenceCalculator
{
    /**
     * {@inheritdoc}
     */
