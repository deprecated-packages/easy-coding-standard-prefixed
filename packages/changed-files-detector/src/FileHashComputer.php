...
final class FileHashComputer
{
    ...
    private function createLoader(string $filePath, \_PhpScopercd2fc5ef50ef\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \_PhpScopercd2fc5ef50ef\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \_PhpScopercd2fc5ef50ef\Symfony\Component\Config\FileLocator([\dirname($filePath)]);
        $loaders = [new \_PhpScopercd2fc5ef50ef\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
