...
final class FileHashComputer
{
    ...
    private function createLoader(string $filePath, \_PhpScoperf53473b45c36\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \_PhpScoperf53473b45c36\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \_PhpScoperf53473b45c36\Symfony\Component\Config\FileLocator([\dirname($filePath)]);
        $loaders = [new \_PhpScoperf53473b45c36\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
