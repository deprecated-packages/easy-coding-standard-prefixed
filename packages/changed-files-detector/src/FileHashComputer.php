...
final class FileHashComputer
{
    ...
    {
        $containerBuilder = new \_PhpScoper7b8580219c59\Symfony\Component\DependencyInjection\ContainerBuilder();
    ...
    private function createLoader(string $filePath, \_PhpScoper7b8580219c59\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \_PhpScoper7b8580219c59\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \_PhpScoper7b8580219c59\Symfony\Component\Config\FileLocator([\dirname($filePath)]);
        $loaders = [new \_PhpScoper7b8580219c59\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
