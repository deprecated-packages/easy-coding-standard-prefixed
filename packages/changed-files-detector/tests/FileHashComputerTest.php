...
use _PhpScoper6207116d4311\Migrify\PhpConfigPrinter\YamlToPhpConverter;
...
final class FileHashComputerTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->yamlToPhpConverter = self::$container->get(\_PhpScoper6207116d4311\Migrify\PhpConfigPrinter\YamlToPhpConverter::class);
    }
