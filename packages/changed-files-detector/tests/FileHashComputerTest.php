...
use _PhpScoper229e8121cf9f\Migrify\PhpConfigPrinter\YamlToPhpConverter;
...
final class FileHashComputerTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->yamlToPhpConverter = self::$container->get(\_PhpScoper229e8121cf9f\Migrify\PhpConfigPrinter\YamlToPhpConverter::class);
    }
