...
use _PhpScoper92feab6bddf8\Migrify\PhpConfigPrinter\YamlToPhpConverter;
...
final class FileHashComputerTest extends \Symplify\PackageBuilder\Tests\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->yamlToPhpConverter = self::$container->get(\_PhpScoper92feab6bddf8\Migrify\PhpConfigPrinter\YamlToPhpConverter::class);
    }
