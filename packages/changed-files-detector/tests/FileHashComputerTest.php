...
use _PhpScoper7cef7256eba6\Migrify\PhpConfigPrinter\YamlToPhpConverter;
...
final class FileHashComputerTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->yamlToPhpConverter = self::$container->get(\_PhpScoper7cef7256eba6\Migrify\PhpConfigPrinter\YamlToPhpConverter::class);
    }
