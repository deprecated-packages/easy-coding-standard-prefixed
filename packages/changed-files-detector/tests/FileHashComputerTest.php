...
use _PhpScoper8e2d8a2760d1\Migrify\PhpConfigPrinter\YamlToPhpConverter;
...
final class FileHashComputerTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->yamlToPhpConverter = self::$container->get(\_PhpScoper8e2d8a2760d1\Migrify\PhpConfigPrinter\YamlToPhpConverter::class);
    }
