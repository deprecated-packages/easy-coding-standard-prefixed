...
use _PhpScoperaad82bb90a86\Migrify\PhpConfigPrinter\YamlToPhpConverter;
...
final class FileHashComputerTest extends \Symplify\PackageBuilder\Tests\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->yamlToPhpConverter = self::$container->get(\_PhpScoperaad82bb90a86\Migrify\PhpConfigPrinter\YamlToPhpConverter::class);
    }
