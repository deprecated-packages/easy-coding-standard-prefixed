...
use _PhpScoper133be48300f9\Migrify\PhpConfigPrinter\YamlToPhpConverter;
...
final class FileHashComputerTest extends \Symplify\PackageBuilder\Tests\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->yamlToPhpConverter = self::$container->get(\_PhpScoper133be48300f9\Migrify\PhpConfigPrinter\YamlToPhpConverter::class);
    }
