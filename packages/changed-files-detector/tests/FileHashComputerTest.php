...
use _PhpScoperd4937ee9b515\Migrify\PhpConfigPrinter\YamlToPhpConverter;
...
final class FileHashComputerTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->yamlToPhpConverter = self::$container->get(\_PhpScoperd4937ee9b515\Migrify\PhpConfigPrinter\YamlToPhpConverter::class);
    }
