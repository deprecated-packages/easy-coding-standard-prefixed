...
abstract class AbstractSnippetFormatterCommand extends \Symplify\EasyCodingStandard\Console\Command\AbstractCheckCommand
{
    ...
    protected function doExecuteSnippetFormatterWithFileNamesAndSnippetPattern(\_PhpScoper224ae0b86670\Symfony\Component\Console\Input\InputInterface $input, string $fileNames, string $snippetPattern, string $kind) : int
    {
