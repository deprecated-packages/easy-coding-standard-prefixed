...
final class CheckHeredocNowdocCommand extends AbstractCheckCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        return $this->snippetFormatterApplication->processFileInfosWithSnippetPattern($this->configuration, $phpFileInfos, SnippetPattern::HERENOWDOC_SNIPPET_REGEX, 'heredocnowdox');
    }
}
